...
cat(int fd)
{
  ...
  4d:	c7 44 24 04 42 09 00 	movl   $0x942,0x4(%esp)
  54:	00 
...
main(int argc, char *argv[])
{
  ...
  c9:	c7 44 24 04 53 09 00 	movl   $0x953,0x4(%esp)
  d0:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	0f b6 90 28 0c 00 00 	movzbl 0xc28(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5e9:	75 27                	jne    612 <printf+0x11f>
          s = "(null)";
 5eb:	c7 45 f4 68 09 00 00 	movl   $0x968,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b7:	a1 48 0c 00 00       	mov    0xc48,%eax
...
free(void *ap)
{
 ...
 778:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 77d:	c9                   	leave  
 77e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7cb:	e8 d8 fe ff ff       	call   6a8 <free>
  return freep;
 7d0:	a1 48 0c 00 00       	mov    0xc48,%eax
}
 7d5:	c9                   	leave  
 7d6:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7e9:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7ec:	a1 48 0c 00 00       	mov    0xc48,%eax
 7f1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7f4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7f8:	75 23                	jne    81d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7fa:	c7 45 f0 40 0c 00 00 	movl   $0xc40,-0x10(%ebp)
 801:	8b 45 f0             	mov    -0x10(%ebp),%eax
 804:	a3 48 0c 00 00       	mov    %eax,0xc48
 809:	a1 48 0c 00 00       	mov    0xc48,%eax
 80e:	a3 40 0c 00 00       	mov    %eax,0xc40
    base.s.size = 0;
 813:	c7 05 44 0c 00 00 00 	movl   $0x0,0xc44
 81a:	00 00 00 
  }
 ...
 870:	a3 48 0c 00 00       	mov    %eax,0xc48
      return (void*)(p + 1);
 ...
 87b:	eb 38                	jmp    8b5 <malloc+0xde>
    ...
    if(p == freep)
 87d:	a1 48 0c 00 00       	mov    0xc48,%eax
...
void parent(void) {
 ...
 8bb:	53                   	push   %ebx
 8bc:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 8bf:	e8 a8 fa ff ff       	call   36c <fork>
 8c4:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8c7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 8cb:	79 16                	jns    8e3 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 8cd:	c7 44 24 04 6f 09 00 	movl   $0x96f,0x4(%esp)
 8d4:	00 
 8d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 8dc:	e8 12 fc ff ff       	call   4f3 <printf>
 8e1:	eb 59                	jmp    93c <parent+0x84>
        }else if(retval > 0){
 8e3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 8e7:	7e 2b                	jle    914 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 8e9:	e8 06 fb ff ff       	call   3f4 <getpid>
 8ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
 8f1:	89 54 24 0c          	mov    %edx,0xc(%esp)
 8f5:	89 44 24 08          	mov    %eax,0x8(%esp)
 8f9:	c7 44 24 04 7e 09 00 	movl   $0x97e,0x4(%esp)
 900:	00 
 901:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 908:	e8 e6 fb ff ff       	call   4f3 <printf>
                wait();
 90d:	e8 6a fa ff ff       	call   37c <wait>
 912:	eb 28                	jmp    93c <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 914:	e8 fb fa ff ff       	call   414 <getppid>
 919:	89 c3                	mov    %eax,%ebx
 91b:	e8 d4 fa ff ff       	call   3f4 <getpid>
 920:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 924:	89 44 24 08          	mov    %eax,0x8(%esp)
 928:	c7 44 24 04 92 09 00 	movl   $0x992,0x4(%esp)
 92f:	00 
 930:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 937:	e8 b7 fb ff ff       	call   4f3 <printf>
        }

}
 93c:	83 c4 24             	add    $0x24,%esp
 93f:	5b                   	pop    %ebx
 940:	5d                   	pop    %ebp
 941:	c3                   	ret    
