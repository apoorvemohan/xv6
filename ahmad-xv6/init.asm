...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 49 09 00 00 	movl   $0x949,(%esp)
  ...
  30:	00 
  31:	c7 04 24 49 09 00 00 	movl   $0x949,(%esp)
  38:	e8 83 03 00 00       	call   3c0 <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 49 09 00 00 	movl   $0x949,(%esp)
  ...
  6c:	c7 44 24 04 51 09 00 	movl   $0x951,0x4(%esp)
  73:	00 
  ...
  90:	c7 44 24 04 64 09 00 	movl   $0x964,0x4(%esp)
  97:	00 
  ...
  ae:	75 41                	jne    f1 <main+0xf1>
      exec("sh", argv);
  b0:	c7 44 24 04 38 0c 00 	movl   $0xc38,0x4(%esp)
  b7:	00 
  b8:	c7 04 24 46 09 00 00 	movl   $0x946,(%esp)
  bf:	e8 ec 02 00 00       	call   3b0 <exec>
      printf(1, "init: exec sh failed\n");
  c4:	c7 44 24 04 77 09 00 	movl   $0x977,0x4(%esp)
  cb:	00 
  ...
  d8:	e8 9b 02 00 00       	call   378 <exit>
    ...
    while((wpid=wait()) >= 0 && wpid != pid)
      printf(1, "zombie!\n");
  dd:	c7 44 24 04 8d 09 00 	movl   $0x98d,0x4(%esp)
  e4:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48e:	0f b6 90 40 0c 00 00 	movzbl 0xc40(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5ed:	75 27                	jne    616 <printf+0x11f>
          s = "(null)";
 5ef:	c7 45 f4 96 09 00 00 	movl   $0x996,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6bb:	a1 5c 0c 00 00       	mov    0xc5c,%eax
...
free(void *ap)
{
 ...
 77c:	a3 5c 0c 00 00       	mov    %eax,0xc5c
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7cf:	e8 d8 fe ff ff       	call   6ac <free>
  return freep;
 7d4:	a1 5c 0c 00 00       	mov    0xc5c,%eax
}
 7d9:	c9                   	leave  
 7da:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ed:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7f0:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 7f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7f8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7fc:	75 23                	jne    821 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7fe:	c7 45 f0 54 0c 00 00 	movl   $0xc54,-0x10(%ebp)
 805:	8b 45 f0             	mov    -0x10(%ebp),%eax
 808:	a3 5c 0c 00 00       	mov    %eax,0xc5c
 80d:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 812:	a3 54 0c 00 00       	mov    %eax,0xc54
    base.s.size = 0;
 817:	c7 05 58 0c 00 00 00 	movl   $0x0,0xc58
 81e:	00 00 00 
  }
 ...
 874:	a3 5c 0c 00 00       	mov    %eax,0xc5c
      return (void*)(p + 1);
...
void parent(void) {
 ...
 8bf:	53                   	push   %ebx
 8c0:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 8c3:	e8 a8 fa ff ff       	call   370 <fork>
 8c8:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8cb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 8cf:	79 16                	jns    8e7 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 8d1:	c7 44 24 04 9d 09 00 	movl   $0x99d,0x4(%esp)
 8d8:	00 
 8d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 8e0:	e8 12 fc ff ff       	call   4f7 <printf>
 8e5:	eb 59                	jmp    940 <parent+0x84>
        }else if(retval > 0){
 8e7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 8eb:	7e 2b                	jle    918 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 8ed:	e8 06 fb ff ff       	call   3f8 <getpid>
 8f2:	8b 55 f4             	mov    -0xc(%ebp),%edx
 8f5:	89 54 24 0c          	mov    %edx,0xc(%esp)
 8f9:	89 44 24 08          	mov    %eax,0x8(%esp)
 8fd:	c7 44 24 04 ac 09 00 	movl   $0x9ac,0x4(%esp)
 904:	00 
 905:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 90c:	e8 e6 fb ff ff       	call   4f7 <printf>
                wait();
 911:	e8 6a fa ff ff       	call   380 <wait>
 916:	eb 28                	jmp    940 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 918:	e8 fb fa ff ff       	call   418 <getppid>
 91d:	89 c3                	mov    %eax,%ebx
 91f:	e8 d4 fa ff ff       	call   3f8 <getpid>
 924:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 928:	89 44 24 08          	mov    %eax,0x8(%esp)
 92c:	c7 44 24 04 c0 09 00 	movl   $0x9c0,0x4(%esp)
 933:	00 
 934:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 93b:	e8 b7 fb ff ff       	call   4f7 <printf>
        }

}
 940:	83 c4 24             	add    $0x24,%esp
 943:	5b                   	pop    %ebx
 944:	5d                   	pop    %ebp
 945:	c3                   	ret    
