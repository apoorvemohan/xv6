...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 ae 08 00 	movl   $0x8ae,0x4(%esp)
  16:	00 
  ...
  60:	c7 44 24 04 c1 08 00 	movl   $0x8c1,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f6:	0f b6 90 74 0b 00 00 	movzbl 0xb74(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 555:	75 27                	jne    57e <printf+0x11f>
          s = "(null)";
 557:	c7 45 f4 d5 08 00 00 	movl   $0x8d5,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 623:	a1 90 0b 00 00       	mov    0xb90,%eax
...
free(void *ap)
{
 ...
 6e4:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 6e9:	c9                   	leave  
 6ea:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 737:	e8 d8 fe ff ff       	call   614 <free>
  return freep;
 73c:	a1 90 0b 00 00       	mov    0xb90,%eax
}
 741:	c9                   	leave  
 742:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 755:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 758:	a1 90 0b 00 00       	mov    0xb90,%eax
 75d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 760:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 764:	75 23                	jne    789 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 766:	c7 45 f0 88 0b 00 00 	movl   $0xb88,-0x10(%ebp)
 76d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 770:	a3 90 0b 00 00       	mov    %eax,0xb90
 775:	a1 90 0b 00 00       	mov    0xb90,%eax
 77a:	a3 88 0b 00 00       	mov    %eax,0xb88
    base.s.size = 0;
 77f:	c7 05 8c 0b 00 00 00 	movl   $0x0,0xb8c
 786:	00 00 00 
  }
 ...
 7dc:	a3 90 0b 00 00       	mov    %eax,0xb90
      return (void*)(p + 1);
 ...
 7e7:	eb 38                	jmp    821 <malloc+0xde>
    ...
    if(p == freep)
 7e9:	a1 90 0b 00 00       	mov    0xb90,%eax
...
void parent(void) {
 ...
 827:	53                   	push   %ebx
 828:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 82b:	e8 a8 fa ff ff       	call   2d8 <fork>
 830:	89 45 f4             	mov    %eax,-0xc(%ebp)
 833:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 837:	79 16                	jns    84f <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 839:	c7 44 24 04 dc 08 00 	movl   $0x8dc,0x4(%esp)
 840:	00 
 841:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 848:	e8 12 fc ff ff       	call   45f <printf>
 84d:	eb 59                	jmp    8a8 <parent+0x84>
        }else if(retval > 0){
 84f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 853:	7e 2b                	jle    880 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 855:	e8 06 fb ff ff       	call   360 <getpid>
 85a:	8b 55 f4             	mov    -0xc(%ebp),%edx
 85d:	89 54 24 0c          	mov    %edx,0xc(%esp)
 861:	89 44 24 08          	mov    %eax,0x8(%esp)
 865:	c7 44 24 04 eb 08 00 	movl   $0x8eb,0x4(%esp)
 86c:	00 
 86d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 874:	e8 e6 fb ff ff       	call   45f <printf>
                wait();
 879:	e8 6a fa ff ff       	call   2e8 <wait>
 87e:	eb 28                	jmp    8a8 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 880:	e8 fb fa ff ff       	call   380 <getppid>
 885:	89 c3                	mov    %eax,%ebx
 887:	e8 d4 fa ff ff       	call   360 <getpid>
 88c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 890:	89 44 24 08          	mov    %eax,0x8(%esp)
 894:	c7 44 24 04 ff 08 00 	movl   $0x8ff,0x4(%esp)
 89b:	00 
 89c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 8a3:	e8 b7 fb ff ff       	call   45f <printf>
        }

}
 8a8:	83 c4 24             	add    $0x24,%esp
 8ab:	5b                   	pop    %ebx
 8ac:	5d                   	pop    %ebp
 8ad:	c3                   	ret    
