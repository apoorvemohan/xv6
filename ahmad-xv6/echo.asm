...
main(int argc, char *argv[])
{
  ...
  1f:	b8 9a 08 00 00       	mov    $0x89a,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 9c 08 00 00       	mov    $0x89c,%eax
  ...
  3f:	c7 44 24 04 9e 08 00 	movl   $0x89e,0x4(%esp)
  46:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	0f b6 90 44 0b 00 00 	movzbl 0xb44(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 541:	75 27                	jne    56a <printf+0x11f>
          s = "(null)";
 543:	c7 45 f4 a3 08 00 00 	movl   $0x8a3,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 60f:	a1 60 0b 00 00       	mov    0xb60,%eax
...
free(void *ap)
{
 ...
 6d0:	a3 60 0b 00 00       	mov    %eax,0xb60
}
 6d5:	c9                   	leave  
 6d6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 723:	e8 d8 fe ff ff       	call   600 <free>
  return freep;
 728:	a1 60 0b 00 00       	mov    0xb60,%eax
}
 72d:	c9                   	leave  
 72e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 752:	c7 45 f0 58 0b 00 00 	movl   $0xb58,-0x10(%ebp)
 759:	8b 45 f0             	mov    -0x10(%ebp),%eax
 75c:	a3 60 0b 00 00       	mov    %eax,0xb60
 761:	a1 60 0b 00 00       	mov    0xb60,%eax
 766:	a3 58 0b 00 00       	mov    %eax,0xb58
    base.s.size = 0;
 76b:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 772:	00 00 00 
  }
 ...
 7c8:	a3 60 0b 00 00       	mov    %eax,0xb60
      return (void*)(p + 1);
...
void parent(void) {
 ...
 814:	83 ec 24             	sub    $0x24,%esp
	...
	int retval;
        ...
        if((retval = fork()) < 0){
 817:	e8 a8 fa ff ff       	call   2c4 <fork>
 81c:	89 45 f4             	mov    %eax,-0xc(%ebp)
 81f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 823:	79 16                	jns    83b <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 825:	c7 44 24 04 aa 08 00 	movl   $0x8aa,0x4(%esp)
 82c:	00 
 82d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 834:	e8 12 fc ff ff       	call   44b <printf>
 839:	eb 59                	jmp    894 <parent+0x84>
        }else if(retval > 0){
 83b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 83f:	7e 2b                	jle    86c <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 841:	e8 06 fb ff ff       	call   34c <getpid>
 846:	8b 55 f4             	mov    -0xc(%ebp),%edx
 849:	89 54 24 0c          	mov    %edx,0xc(%esp)
 84d:	89 44 24 08          	mov    %eax,0x8(%esp)
 851:	c7 44 24 04 b9 08 00 	movl   $0x8b9,0x4(%esp)
 858:	00 
 859:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 860:	e8 e6 fb ff ff       	call   44b <printf>
                wait();
 865:	e8 6a fa ff ff       	call   2d4 <wait>
 86a:	eb 28                	jmp    894 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 86c:	e8 fb fa ff ff       	call   36c <getppid>
 871:	89 c3                	mov    %eax,%ebx
 873:	e8 d4 fa ff ff       	call   34c <getpid>
 878:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 87c:	89 44 24 08          	mov    %eax,0x8(%esp)
 880:	c7 44 24 04 cd 08 00 	movl   $0x8cd,0x4(%esp)
 887:	00 
 888:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 88f:	e8 b7 fb ff ff       	call   44b <printf>
        }

}
 894:	83 c4 24             	add    $0x24,%esp
 897:	5b                   	pop    %ebx
 898:	5d                   	pop    %ebp
 899:	c3                   	ret    
