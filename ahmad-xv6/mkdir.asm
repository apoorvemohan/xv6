...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 cc 08 00 	movl   $0x8cc,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	0f b6 90 88 0b 00 00 	movzbl 0xb88(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 565:	75 27                	jne    58e <printf+0x11f>
          s = "(null)";
 567:	c7 45 f4 e8 08 00 00 	movl   $0x8e8,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 633:	a1 a4 0b 00 00       	mov    0xba4,%eax
...
free(void *ap)
{
 ...
 6f4:	a3 a4 0b 00 00       	mov    %eax,0xba4
}
 6f9:	c9                   	leave  
 6fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 747:	e8 d8 fe ff ff       	call   624 <free>
  return freep;
 74c:	a1 a4 0b 00 00       	mov    0xba4,%eax
}
 751:	c9                   	leave  
 752:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 765:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 768:	a1 a4 0b 00 00       	mov    0xba4,%eax
 76d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 770:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 774:	75 23                	jne    799 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 776:	c7 45 f0 9c 0b 00 00 	movl   $0xb9c,-0x10(%ebp)
 77d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 780:	a3 a4 0b 00 00       	mov    %eax,0xba4
 785:	a1 a4 0b 00 00       	mov    0xba4,%eax
 78a:	a3 9c 0b 00 00       	mov    %eax,0xb9c
    base.s.size = 0;
 78f:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 796:	00 00 00 
  }
 ...
 7ec:	a3 a4 0b 00 00       	mov    %eax,0xba4
      return (void*)(p + 1);
 ...
 7f7:	eb 38                	jmp    831 <malloc+0xde>
    ...
    if(p == freep)
 7f9:	a1 a4 0b 00 00       	mov    0xba4,%eax
...
void *wrapper(qthread_func_ptr_t func, void *arg) {
 ...
 843:	ff d0                	call   *%eax
    exit();
 845:	e8 9e fa ff ff       	call   2e8 <exit>

0000084a <qthread_create>:
...
int qthread_create(qthread_t *thread, qthread_func_ptr_t my_func, void *arg) {
 ...
 850:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 857:	e8 f7 fe ff ff       	call   753 <malloc>
...
int qthread_join(qthread_t thread, void **retval){
 ...
 8a1:	89 54 24 04          	mov    %edx,0x4(%esp)
 8a5:	89 04 24             	mov    %eax,(%esp)
 8a8:	e8 e3 fa ff ff       	call   390 <kthread_join>
