...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 fa 08 00 	movl   $0x8fa,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	0f b6 90 e0 0b 00 00 	movzbl 0xbe0(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 565:	75 27                	jne    58e <printf+0x11f>
          s = "(null)";
 567:	c7 45 f4 16 09 00 00 	movl   $0x916,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 633:	a1 fc 0b 00 00       	mov    0xbfc,%eax
...
free(void *ap)
{
 ...
 6f4:	a3 fc 0b 00 00       	mov    %eax,0xbfc
}
 6f9:	c9                   	leave  
 6fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 747:	e8 d8 fe ff ff       	call   624 <free>
  return freep;
 74c:	a1 fc 0b 00 00       	mov    0xbfc,%eax
}
 751:	c9                   	leave  
 752:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 765:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 768:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 76d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 770:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 774:	75 23                	jne    799 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 776:	c7 45 f0 f4 0b 00 00 	movl   $0xbf4,-0x10(%ebp)
 77d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 780:	a3 fc 0b 00 00       	mov    %eax,0xbfc
 785:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 78a:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    base.s.size = 0;
 78f:	c7 05 f8 0b 00 00 00 	movl   $0x0,0xbf8
 796:	00 00 00 
  }
 ...
 7ec:	a3 fc 0b 00 00       	mov    %eax,0xbfc
      return (void*)(p + 1);
 ...
 7f7:	eb 38                	jmp    831 <malloc+0xde>
    ...
    if(p == freep)
 7f9:	a1 fc 0b 00 00       	mov    0xbfc,%eax
...
void parent(void) {
 ...
 849:	c7 44 24 04 1d 09 00 	movl   $0x91d,0x4(%esp)
 850:	00 
 ...
 875:	c7 44 24 04 2c 09 00 	movl   $0x92c,0x4(%esp)
 87c:	00 
 ...
 8a4:	c7 44 24 04 40 09 00 	movl   $0x940,0x4(%esp)
 8ab:	00 
...
void ct(void){
 ...
 8cd:	c7 44 24 04 55 09 00 	movl   $0x955,0x4(%esp)
 8d4:	00 
