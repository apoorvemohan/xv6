...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 cd 08 00 	movl   $0x8cd,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fe:	0f b6 90 88 0b 00 00 	movzbl 0xb88(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 55d:	75 27                	jne    586 <printf+0x11f>
          s = "(null)";
 55f:	c7 45 f4 e9 08 00 00 	movl   $0x8e9,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62b:	a1 a4 0b 00 00       	mov    0xba4,%eax
...
free(void *ap)
{
 ...
 6ec:	a3 a4 0b 00 00       	mov    %eax,0xba4
}
 6f1:	c9                   	leave  
 6f2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73f:	e8 d8 fe ff ff       	call   61c <free>
  return freep;
 744:	a1 a4 0b 00 00       	mov    0xba4,%eax
}
 749:	c9                   	leave  
 74a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7e4:	a3 a4 0b 00 00       	mov    %eax,0xba4
      return (void*)(p + 1);
 ...
 7ef:	eb 38                	jmp    829 <malloc+0xde>
    ...
    if(p == freep)
 7f1:	a1 a4 0b 00 00       	mov    0xba4,%eax
...
void parent(void) {
 ...
 841:	c7 44 24 04 f0 08 00 	movl   $0x8f0,0x4(%esp)
 848:	00 
 ...
 86d:	c7 44 24 04 ff 08 00 	movl   $0x8ff,0x4(%esp)
 874:	00 
 ...
 89c:	c7 44 24 04 13 09 00 	movl   $0x913,0x4(%esp)
 8a3:	00 
