...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 31 0a 00 	movl   $0xa31,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 470:	0f b6 80 40 0e 00 00 	movzbl 0xe40(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5cd:	75 09                	jne    5d8 <printf+0x101>
          s = "(null)";
 5cf:	c7 45 f4 4d 0a 00 00 	movl   $0xa4d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 699:	a1 5c 0e 00 00       	mov    0xe5c,%eax
...
free(void *ap)
{
 ...
 764:	a3 5c 0e 00 00       	mov    %eax,0xe5c
}
 769:	c9                   	leave  
 76a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7b7:	e8 ce fe ff ff       	call   68a <free>
  return freep;
 7bc:	a1 5c 0e 00 00       	mov    0xe5c,%eax
}
 7c1:	c9                   	leave  
 7c2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7d5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7d8:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 7dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7e4:	75 23                	jne    809 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 45 f0 54 0e 00 00 	movl   $0xe54,-0x10(%ebp)
 7ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7f0:	a3 5c 0e 00 00       	mov    %eax,0xe5c
 7f5:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 7fa:	a3 54 0e 00 00       	mov    %eax,0xe54
    base.s.size = 0;
 ...
 85c:	a3 5c 0e 00 00       	mov    %eax,0xe5c
      return (void*)(p + 1);
 ...
 867:	eb 38                	jmp    8a1 <malloc+0xde>
    ...
    if(p == freep)
 869:	a1 5c 0e 00 00       	mov    0xe5c,%eax
