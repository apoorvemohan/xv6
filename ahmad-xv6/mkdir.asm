...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 8b 09 00 	movl   $0x98b,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	0f b6 90 e8 0c 00 00 	movzbl 0xce8(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 565:	75 27                	jne    58e <printf+0x11f>
          s = "(null)";
 567:	c7 45 f4 a7 09 00 00 	movl   $0x9a7,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 633:	a1 04 0d 00 00       	mov    0xd04,%eax
...
free(void *ap)
{
 ...
 6f4:	a3 04 0d 00 00       	mov    %eax,0xd04
}
 6f9:	c9                   	leave  
 6fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 747:	e8 d8 fe ff ff       	call   624 <free>
  return freep;
 74c:	a1 04 0d 00 00       	mov    0xd04,%eax
}
 751:	c9                   	leave  
 752:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 765:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 768:	a1 04 0d 00 00       	mov    0xd04,%eax
 76d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 770:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 774:	75 23                	jne    799 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 776:	c7 45 f0 fc 0c 00 00 	movl   $0xcfc,-0x10(%ebp)
 77d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 780:	a3 04 0d 00 00       	mov    %eax,0xd04
 785:	a1 04 0d 00 00       	mov    0xd04,%eax
 78a:	a3 fc 0c 00 00       	mov    %eax,0xcfc
    base.s.size = 0;
 78f:	c7 05 00 0d 00 00 00 	movl   $0x0,0xd00
 796:	00 00 00 
  }
 ...
 7ec:	a3 04 0d 00 00       	mov    %eax,0xd04
      return (void*)(p + 1);
 ...
 7f7:	eb 38                	jmp    831 <malloc+0xde>
    ...
    if(p == freep)
 7f9:	a1 04 0d 00 00       	mov    0xd04,%eax
...
void hello(){
 ...
 8c4:	c7 44 24 04 e8 09 00 	movl   $0x9e8,0x4(%esp)
 8cb:	00 
 8cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 8d3:	e8 97 fb ff ff       	call   46f <printf>
	printf(1, "I am Child\n");
 8d8:	c7 44 24 04 f8 09 00 	movl   $0x9f8,0x4(%esp)
 8df:	00 
...
*/
	printf(1, "In Parent!!!\n");
 91d:	c7 44 24 04 04 0a 00 	movl   $0xa04,0x4(%esp)
 924:	00 
 ...
 938:	c7 44 24 04 12 0a 00 	movl   $0xa12,0x4(%esp)
 93f:	00 
 ...
 95d:	c7 44 24 04 20 0a 00 	movl   $0xa20,0x4(%esp)
 964:	00 
