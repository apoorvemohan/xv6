...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
   ...
   f:	c7 44 24 04 96 08 00 	movl   $0x896,0x4(%esp)
  16:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	0f b6 90 4c 0b 00 00 	movzbl 0xb4c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 53d:	75 27                	jne    566 <printf+0x11f>
          s = "(null)";
 53f:	c7 45 f4 aa 08 00 00 	movl   $0x8aa,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 60b:	a1 68 0b 00 00       	mov    0xb68,%eax
...
free(void *ap)
{
 ...
 6cc:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 6d1:	c9                   	leave  
 6d2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 71f:	e8 d8 fe ff ff       	call   5fc <free>
  return freep;
 724:	a1 68 0b 00 00       	mov    0xb68,%eax
}
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7c4:	a3 68 0b 00 00       	mov    %eax,0xb68
      return (void*)(p + 1);
...
void parent(void) {
 ...
 80f:	53                   	push   %ebx
 810:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 813:	e8 a8 fa ff ff       	call   2c0 <fork>
 818:	89 45 f4             	mov    %eax,-0xc(%ebp)
 81b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 81f:	79 16                	jns    837 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 821:	c7 44 24 04 b1 08 00 	movl   $0x8b1,0x4(%esp)
 828:	00 
 829:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 830:	e8 12 fc ff ff       	call   447 <printf>
 835:	eb 59                	jmp    890 <parent+0x84>
        }else if(retval > 0){
 837:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 83b:	7e 2b                	jle    868 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 83d:	e8 06 fb ff ff       	call   348 <getpid>
 842:	8b 55 f4             	mov    -0xc(%ebp),%edx
 845:	89 54 24 0c          	mov    %edx,0xc(%esp)
 849:	89 44 24 08          	mov    %eax,0x8(%esp)
 84d:	c7 44 24 04 c0 08 00 	movl   $0x8c0,0x4(%esp)
 854:	00 
 855:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 85c:	e8 e6 fb ff ff       	call   447 <printf>
                wait();
 861:	e8 6a fa ff ff       	call   2d0 <wait>
 866:	eb 28                	jmp    890 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 868:	e8 fb fa ff ff       	call   368 <getppid>
 86d:	89 c3                	mov    %eax,%ebx
 86f:	e8 d4 fa ff ff       	call   348 <getpid>
 874:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 878:	89 44 24 08          	mov    %eax,0x8(%esp)
 87c:	c7 44 24 04 d4 08 00 	movl   $0x8d4,0x4(%esp)
 883:	00 
 884:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 88b:	e8 b7 fb ff ff       	call   447 <printf>
        }

}
 890:	83 c4 24             	add    $0x24,%esp
 893:	5b                   	pop    %ebx
 894:	5d                   	pop    %ebp
 895:	c3                   	ret    
