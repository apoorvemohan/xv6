...
8010003a:	c7 44 24 04 58 83 10 	movl   $0x80108358,0x4(%esp)
80100041:	80 
...
801000bd:	e8 19 4c 00 00       	call   80104cdb <acquire>
...
80100104:	e8 34 4c 00 00       	call   80104d3d <release>
        return b;
...
8010011f:	e8 d0 48 00 00       	call   801049f4 <sleep>
      goto loop;
...
8010017c:	e8 bc 4b 00 00       	call   80104d3d <release>
      return b;
...
80100198:	c7 04 24 5f 83 10 80 	movl   $0x8010835f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 70 83 10 80 	movl   $0x80108370,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 77 83 10 80 	movl   $0x80108377,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 9a 4a 00 00       	call   80104cdb <acquire>
...
8010029d:	e8 2e 48 00 00       	call   80104ad0 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 8f 4a 00 00       	call   80104d3d <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 1a 49 00 00       	call   80104cdb <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 7e 83 10 80 	movl   $0x8010837e,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 87 83 10 80 	movl   $0x80108387,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 02 48 00 00       	call   80104d3d <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 8e 83 10 80 	movl   $0x8010838e,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 9d 83 10 80 	movl   $0x8010839d,(%esp)
...
80100592:	e8 f5 47 00 00       	call   80104d8c <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 9f 83 10 80 	movl   $0x8010839f,(%esp)
...
801006b2:	e8 46 49 00 00       	call   80104ffd <memmove>
    pos -= 80;
...
801006e1:	e8 44 48 00 00       	call   80104f2a <memset>
  }
...
80100776:	e8 2e 62 00 00       	call   801069a9 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 22 62 00 00       	call   801069a9 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 16 62 00 00       	call   801069a9 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 09 62 00 00       	call   801069a9 <uartputc>
  cgaputc(c);
...
801007ba:	e8 1c 45 00 00       	call   80104cdb <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 87 43 00 00       	call   80104b76 <procdump>
      break;
...
801008f7:	e8 d4 41 00 00       	call   80104ad0 <wakeup>
        }
      }
      break;
...
8010091e:	e8 1a 44 00 00       	call   80104d3d <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 93 43 00 00       	call   80104cdb <acquire>
  while(n > 0){
...
80100961:	e8 d7 43 00 00       	call   80104d3d <release>
        ilock(ip);
...
8010098a:	e8 65 40 00 00       	call   801049f4 <sleep>
...
80100a08:	e8 30 43 00 00       	call   80104d3d <release>
  ilock(ip);
...
80100a3e:	e8 98 42 00 00       	call   80104cdb <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 c0 42 00 00       	call   80104d3d <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 a3 83 10 	movl   $0x801083a3,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100aa2:	e8 13 42 00 00       	call   80104cba <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 ab 83 10 	movl   $0x801083ab,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 80 07 11 80 	movl   $0x80110780,(%esp)
80100ab6:	e8 ff 41 00 00       	call   80104cba <initlock>
...
80100b78:	0f 85 44 03 00 00    	jne    80100ec2 <exec+0x3c6>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 6a 6f 00 00       	call   80107aed <setupkvm>
...
80100c17:	e8 a3 72 00 00       	call   80107ebf <allocuvm>
...
80100c54:	e8 77 71 00 00       	call   80107dd0 <loaduvm>
...
80100cc4:	e8 f6 71 00 00       	call   80107ebf <allocuvm>
...
80100ce8:	e8 f6 73 00 00       	call   801080e3 <clearpteu>
  sp = sz;
...
80100d17:	e8 8c 44 00 00       	call   801051a8 <strlen>
...
80100d35:	e8 6e 44 00 00       	call   801051a8 <strlen>
...
80100d5f:	e8 44 75 00 00       	call   801082a8 <copyout>
...
80100dff:	e8 a4 74 00 00       	call   801082a8 <copyout>
...
80100e56:	e8 ff 42 00 00       	call   8010515a <safestrcpy>
...
80100ea8:	e8 31 6d 00 00       	call   80107bde <switchuvm>
  freevm(oldpgdir);
80100ead:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eb0:	89 04 24             	mov    %eax,(%esp)
80100eb3:	e8 9d 71 00 00       	call   80108055 <freevm>
  return 0;
...
80100eea:	e8 66 71 00 00       	call   80108055 <freevm>
  if(ip){
...
80100f12:	c7 44 24 04 b1 83 10 	movl   $0x801083b1,0x4(%esp)
80100f19:	80 
80100f1a:	c7 04 24 40 08 11 80 	movl   $0x80110840,(%esp)
80100f21:	e8 94 3d 00 00       	call   80104cba <initlock>
}
80100f26:	c9                   	leave  
80100f27:	c3                   	ret    
...
80100f35:	e8 a1 3d 00 00       	call   80104cdb <acquire>
...
80100f5e:	e8 da 3d 00 00       	call   80104d3d <release>
      return f;
...
80100f7c:	e8 bc 3d 00 00       	call   80104d3d <release>
  return 0;
...
80100f95:	e8 41 3d 00 00       	call   80104cdb <acquire>
  if(f->ref < 1)
...
80100fa2:	7f 0c                	jg     80100fb0 <filedup+0x28>
    panic("filedup");
80100fa4:	c7 04 24 b8 83 10 80 	movl   $0x801083b8,(%esp)
...
80100fc6:	e8 72 3d 00 00       	call   80104d3d <release>
  return f;
...
80100fdd:	e8 f9 3c 00 00       	call   80104cdb <acquire>
  if(f->ref < 1)
...
80100fea:	7f 0c                	jg     80100ff8 <fileclose+0x28>
    panic("fileclose");
80100fec:	c7 04 24 c0 83 10 80 	movl   $0x801083c0,(%esp)
...
80101018:	e8 20 3d 00 00       	call   80104d3d <release>
    return;
...
80101062:	e8 d6 3c 00 00       	call   80104d3d <release>
...
801011a1:	eb 0c                	jmp    801011af <fileread+0xba>
  ...
  panic("fileread");
801011a3:	c7 04 24 ca 83 10 80 	movl   $0x801083ca,(%esp)
...
801012af:	c7 04 24 d3 83 10 80 	movl   $0x801083d3,(%esp)
...
801012e2:	eb 0c                	jmp    801012f0 <filewrite+0x13f>
  ...
  panic("filewrite");
801012e4:	c7 04 24 e3 83 10 80 	movl   $0x801083e3,(%esp)
...
8010132c:	e8 cc 3c 00 00       	call   80104ffd <memmove>
  brelse(bp);
...
80101372:	e8 b3 3b 00 00       	call   80104f2a <memset>
  log_write(bp);
...
801014d4:	0f 82 e1 fe ff ff    	jb     801013bb <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014da:	c7 04 24 ed 83 10 80 	movl   $0x801083ed,(%esp)
...
80101571:	c7 04 24 03 84 10 80 	movl   $0x80108403,(%esp)
...
801015c5:	c7 44 24 04 16 84 10 	movl   $0x80108416,0x4(%esp)
801015cc:	80 
801015cd:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801015d4:	e8 e1 36 00 00       	call   80104cba <initlock>
}
801015d9:	c9                   	leave  
801015da:	c3                   	ret    
...
80101656:	e8 cf 38 00 00       	call   80104f2a <memset>
      dip->type = type;
...
801016a6:	0f 82 5a ff ff ff    	jb     80101606 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016ac:	c7 04 24 1d 84 10 80 	movl   $0x8010841d,(%esp)
...
80101753:	e8 a5 38 00 00       	call   80104ffd <memmove>
  log_write(bp);
...
8010177d:	e8 59 35 00 00       	call   80104cdb <acquire>
...
801017c7:	e8 71 35 00 00       	call   80104d3d <release>
      return ip;
...
801017fa:	c7 04 24 2f 84 10 80 	movl   $0x8010842f,(%esp)
...
80101838:	e8 00 35 00 00       	call   80104d3d <release>
...
8010184f:	e8 87 34 00 00       	call   80104cdb <acquire>
  ip->ref++;
...
8010186a:	e8 ce 34 00 00       	call   80104d3d <release>
  return ip;
...
80101888:	7f 0c                	jg     80101896 <ilock+0x22>
    panic("ilock");
8010188a:	c7 04 24 3f 84 10 80 	movl   $0x8010843f,(%esp)
80101891:	e8 a7 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101896:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
8010189d:	e8 39 34 00 00       	call   80104cdb <acquire>
...
801018b2:	e8 3d 31 00 00       	call   801049f4 <sleep>
...
801018dc:	e8 5c 34 00 00       	call   80104d3d <release>
...
80101987:	e8 71 36 00 00       	call   80104ffd <memmove>
    brelse(bp);
...
801019b2:	75 0c                	jne    801019c0 <ilock+0x14c>
      panic("ilock: no type");
801019b4:	c7 04 24 45 84 10 80 	movl   $0x80108445,(%esp)
...
801019e3:	7f 0c                	jg     801019f1 <iunlock+0x2f>
    panic("iunlock");
801019e5:	c7 04 24 54 84 10 80 	movl   $0x80108454,(%esp)
801019ec:	e8 4c eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019f1:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
801019f8:	e8 de 32 00 00       	call   80104cdb <acquire>
  ip->flags &= ~I_BUSY;
...
80101a14:	e8 b7 30 00 00       	call   80104ad0 <wakeup>
  release(&icache.lock);
80101a19:	c7 04 24 40 12 11 80 	movl   $0x80111240,(%esp)
80101a20:	e8 18 33 00 00       	call   80104d3d <release>
}
80101a25:	c9                   	leave  
80101a26:	c3                   	ret    
...
80101a34:	e8 a2 32 00 00       	call   80104cdb <acquire>
...
80101a70:	74 0c                	je     80101a7e <iput+0x57>
      panic("iput busy");
80101a72:	c7 04 24 5c 84 10 80 	movl   $0x8010845c,(%esp)
...
80101a96:	e8 a2 32 00 00       	call   80104d3d <release>
    itrunc(ip);
...
80101ac1:	e8 15 32 00 00       	call   80104cdb <acquire>
    ip->flags = 0;
...
80101ad6:	e8 f5 2f 00 00       	call   80104ad0 <wakeup>
  }
  ip->ref--;
...
80101af1:	e8 47 32 00 00       	call   80104d3d <release>
}
80101af6:	c9                   	leave  
80101af7:	c3                   	ret    
...
80101c06:	c7 04 24 66 84 10 80 	movl   $0x80108466,(%esp)
...
80101e9e:	e8 5a 31 00 00       	call   80104ffd <memmove>
    brelse(bp);
...
80102004:	e8 f4 2f 00 00       	call   80104ffd <memmove>
    log_write(bp);
...
80102086:	e8 16 30 00 00       	call   801050a1 <strncmp>
}
8010208b:	c9                   	leave  
8010208c:	c3                   	ret    
...
801020a0:	c7 04 24 79 84 10 80 	movl   $0x80108479,(%esp)
...
801020dc:	74 0c                	je     801020ea <dirlookup+0x5d>
      panic("dirlink read");
801020de:	c7 04 24 8b 84 10 80 	movl   $0x8010848b,(%esp)
...
801021c0:	74 0c                	je     801021ce <dirlink+0x79>
      panic("dirlink read");
801021c2:	c7 04 24 8b 84 10 80 	movl   $0x8010848b,(%esp)
...
80102208:	e8 ec 2e 00 00       	call   801050f9 <strncpy>
  de.inum = inum;
...
80102238:	74 0c                	je     80102246 <dirlink+0xf1>
    panic("dirlink");
8010223a:	c7 04 24 98 84 10 80 	movl   $0x80108498,(%esp)
...
801022c1:	e8 37 2d 00 00       	call   80104ffd <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022dc:	e8 1c 2d 00 00       	call   80104ffd <memmove>
    name[len] = 0;
...
80102538:	c7 44 24 04 a0 84 10 	movl   $0x801084a0,0x4(%esp)
8010253f:	80 
80102540:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102547:	e8 6e 27 00 00       	call   80104cba <initlock>
  picenable(IRQ_IDE);
...
801025e2:	75 0c                	jne    801025f0 <idestart+0x18>
    panic("idestart");
801025e4:	c7 04 24 a4 84 10 80 	movl   $0x801084a4,(%esp)
...
8010270a:	e8 cc 25 00 00       	call   80104cdb <acquire>
  if((b = idequeue) == 0){
...
80102724:	e8 14 26 00 00       	call   80104d3d <release>
...
80102797:	e8 34 23 00 00       	call   80104ad0 <wakeup>
...
801027b9:	e8 7f 25 00 00       	call   80104d3d <release>
}
801027be:	c9                   	leave  
801027bf:	c3                   	ret    
...
801027d2:	c7 04 24 ad 84 10 80 	movl   $0x801084ad,(%esp)
...
801027eb:	c7 04 24 c1 84 10 80 	movl   $0x801084c1,(%esp)
...
80102876:	e8 79 21 00 00       	call   801049f4 <sleep>
...
80102892:	e8 a6 24 00 00       	call   80104d3d <release>
}
80102897:	c9                   	leave  
80102898:	c3                   	ret    
...
80102922:	c7 04 24 f4 84 10 80 	movl   $0x801084f4,(%esp)
...
801029e3:	c7 44 24 04 26 85 10 	movl   $0x80108526,0x4(%esp)
801029ea:	80 
801029eb:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
801029f2:	e8 c3 22 00 00       	call   80104cba <initlock>
  kmem.use_lock = 0;
...
80102a84:	81 7d 08 3c 55 11 80 	cmpl   $0x8011553c,0x8(%ebp)
...
80102a9d:	76 0c                	jbe    80102aab <kfree+0x39>
    panic("kfree");
80102a9f:	c7 04 24 2b 85 10 80 	movl   $0x8010852b,(%esp)
...
80102ac1:	e8 64 24 00 00       	call   80104f2a <memset>
...
80102ad6:	e8 00 22 00 00       	call   80104cdb <acquire>
  r = (struct run*)v;
...
80102b04:	e8 34 22 00 00       	call   80104d3d <release>
}
80102b09:	c9                   	leave  
80102b0a:	c3                   	ret    
...
80102b21:	e8 b5 21 00 00       	call   80104cdb <acquire>
  r = kmem.freelist;
...
80102b4e:	e8 ea 21 00 00       	call   80104d3d <release>
  return (char*)r;
...
80102eca:	c7 04 24 34 85 10 80 	movl   $0x80108534,(%esp)
...
80103022:	c7 44 24 04 60 85 10 	movl   $0x80108560,0x4(%esp)
80103029:	80 
8010302a:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80103031:	e8 84 1c 00 00       	call   80104cba <initlock>
  readsb(ROOTDEV, &sb);
...
801030e4:	e8 14 1f 00 00       	call   80104ffd <memmove>
...
80103236:	e8 a0 1a 00 00       	call   80104cdb <acquire>
  while(1){
    if(log.committing){
...
80103253:	e8 9c 17 00 00       	call   801049f4 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
80103287:	e8 68 17 00 00       	call   801049f4 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
801032a2:	e8 96 1a 00 00       	call   80104d3d <release>
      break;
801032a7:	90                   	nop
    }
  }
...
801032be:	e8 18 1a 00 00       	call   80104cdb <acquire>
  log.outstanding -= 1;
...
801032d9:	c7 04 24 64 85 10 80 	movl   $0x80108564,(%esp)
...
80103308:	e8 c3 17 00 00       	call   80104ad0 <wakeup>
  }
  release(&log.lock);
8010330d:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80103314:	e8 24 1a 00 00       	call   80104d3d <release>
...
801033c5:	e8 33 1c 00 00       	call   80104ffd <memmove>
...
80103450:	c7 04 24 73 85 10 80 	movl   $0x80108573,(%esp)
...
80103465:	c7 04 24 89 85 10 80 	movl   $0x80108589,(%esp)
...
80103560:	c7 04 24 a4 85 10 80 	movl   $0x801085a4,(%esp)
...
8010357b:	e8 18 33 00 00       	call   80106898 <uartinit>
  pinit();         // process table
80103580:	e8 8e 0b 00 00       	call   80104113 <pinit>
  tvinit();        // trap vectors
80103585:	e8 b1 2e 00 00       	call   8010643b <tvinit>
  binit();         // buffer cache
...
801035a7:	e8 d2 2d 00 00       	call   8010637e <timerinit>
...
801035d2:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801035d5:	e8 e7 45 00 00       	call   80107bc1 <switchkvm>
  seginit();
801035da:	e8 6e 3f 00 00       	call   8010754d <seginit>
  lapicinit();
...
801035ff:	c7 04 24 bb 85 10 80 	movl   $0x801085bb,(%esp)
80103606:	e8 96 cd ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
8010360b:	e8 9f 2f 00 00       	call   801065af <idtinit>
...
8010362b:	e8 18 12 00 00       	call   80104848 <scheduler>
...
8010365d:	e8 9b 19 00 00       	call   80104ffd <memmove>
...
801037eb:	00 
801037ec:	c7 44 24 04 cc 85 10 	movl   $0x801085cc,0x4(%esp)
801037f3:	80 
801037f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801037f7:	89 04 24             	mov    %eax,(%esp)
801037fa:	e8 a2 17 00 00       	call   80104fa1 <memcmp>
...
8010392c:	00 
8010392d:	c7 44 24 04 d1 85 10 	movl   $0x801085d1,0x4(%esp)
80103934:	80 
80103935:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103938:	89 04 24             	mov    %eax,(%esp)
8010393b:	e8 61 16 00 00       	call   80104fa1 <memcmp>
...
80103a06:	8b 04 85 14 86 10 80 	mov    -0x7fef79ec(,%eax,4),%eax
...
80103a3f:	c7 04 24 d6 85 10 80 	movl   $0x801085d6,(%esp)
...
80103ad2:	c7 04 24 f4 85 10 80 	movl   $0x801085f4,(%esp)
...
80103dd7:	c7 44 24 04 28 86 10 	movl   $0x80108628,0x4(%esp)
80103dde:	80 
80103ddf:	89 04 24             	mov    %eax,(%esp)
80103de2:	e8 d3 0e 00 00       	call   80104cba <initlock>
  (*f0)->type = FD_PIPE;
...
80103e8f:	e8 47 0e 00 00       	call   80104cdb <acquire>
  if(writable){
...
80103eb2:	e8 19 0c 00 00       	call   80104ad0 <wakeup>
...
80103ed1:	e8 fa 0b 00 00       	call   80104ad0 <wakeup>
  }
...
80103ef6:	e8 42 0e 00 00       	call   80104d3d <release>
    kfree((char*)p);
...
80103f0e:	e8 2a 0e 00 00       	call   80104d3d <release>
}
80103f13:	c9                   	leave  
80103f14:	c3                   	ret    
...
80103f22:	e8 b4 0d 00 00       	call   80104cdb <acquire>
  for(i = 0; i < n; i++){
...
80103f53:	e8 e5 0d 00 00       	call   80104d3d <release>
        return -1;
...
80103f6d:	e8 5e 0b 00 00       	call   80104ad0 <wakeup>
...
80103f85:	e8 6a 0a 00 00       	call   801049f4 <sleep>
...
80103fec:	e8 df 0a 00 00       	call   80104ad0 <wakeup>
  release(&p->lock);
80103ff1:	8b 45 08             	mov    0x8(%ebp),%eax
80103ff4:	89 04 24             	mov    %eax,(%esp)
80103ff7:	e8 41 0d 00 00       	call   80104d3d <release>
  return n;
...
80104012:	e8 c4 0c 00 00       	call   80104cdb <acquire>
...
8010402c:	e8 0c 0d 00 00       	call   80104d3d <release>
      return -1;
...
8010404e:	e8 a1 09 00 00       	call   801049f4 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801040de:	e8 ed 09 00 00       	call   80104ad0 <wakeup>
  release(&p->lock);
801040e3:	8b 45 08             	mov    0x8(%ebp),%eax
801040e6:	89 04 24             	mov    %eax,(%esp)
801040e9:	e8 4f 0c 00 00       	call   80104d3d <release>
  return i;
...
80104119:	c7 44 24 04 2d 86 10 	movl   $0x8010862d,0x4(%esp)
80104120:	80 
80104121:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104128:	e8 8d 0b 00 00       	call   80104cba <initlock>
}
8010412d:	c9                   	leave  
8010412e:	c3                   	ret    
...
8010413c:	e8 9a 0b 00 00       	call   80104cdb <acquire>
...
80104152:	74 26                	je     8010417a <allocproc+0x4b>
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104154:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
8010415b:	81 7d f4 94 4c 11 80 	cmpl   $0x80114c94,-0xc(%ebp)
80104162:	72 e6                	jb     8010414a <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104164:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
8010416b:	e8 cd 0b 00 00       	call   80104d3d <release>
  return 0;
...
8010419f:	e8 99 0b 00 00       	call   80104d3d <release>
...
801041e9:	ba f0 63 10 80       	mov    $0x801063f0,%edx
...
80104219:	e8 0c 0d 00 00       	call   80104f2a <memset>
  p->context->eip = (uint)forkret;
8010421e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104221:	8b 40 1c             	mov    0x1c(%eax),%eax
80104224:	ba c8 49 10 80       	mov    $0x801049c8,%edx
...
80104247:	e8 a1 38 00 00       	call   80107aed <setupkvm>
...
8010425c:	c7 04 24 34 86 10 80 	movl   $0x80108634,(%esp)
...
80104282:	e8 be 3a 00 00       	call   80107d45 <inituvm>
  p->sz = PGSIZE;
...
801042a9:	e8 7c 0c 00 00       	call   80104f2a <memset>
...
80104322:	00 
80104323:	c7 44 24 04 4d 86 10 	movl   $0x8010864d,0x4(%esp)
8010432a:	80 
8010432b:	89 04 24             	mov    %eax,(%esp)
8010432e:	e8 27 0e 00 00       	call   8010515a <safestrcpy>
  p->cwd = namei("/");
80104333:	c7 04 24 56 86 10 80 	movl   $0x80108656,(%esp)
...
80104387:	e8 33 3b 00 00       	call   80107ebf <allocuvm>
...
801043c1:	e8 d3 3b 00 00       	call   80107f99 <deallocuvm>
...
801043ea:	e8 ef 37 00 00       	call   80107bde <switchuvm>
  return 0;
...
80104412:	e9 d5 01 00 00       	jmp    801045ec <fork+0x1f6>
...
8010445a:	e8 ca 3c 00 00       	call   80108129 <copyuvm>
...
80104496:	e9 51 01 00 00       	jmp    801045ec <fork+0x1f6>
    }
...
801044b3:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
801044b5:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801044bc:	8b 45 e0             	mov    -0x20(%ebp),%eax
801044bf:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
801044c2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801044c5:	8b 50 18             	mov    0x18(%eax),%edx
801044c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044ce:	8b 40 18             	mov    0x18(%eax),%eax
801044d1:	89 c3                	mov    %eax,%ebx
801044d3:	b8 13 00 00 00       	mov    $0x13,%eax
801044d8:	89 d7                	mov    %edx,%edi
801044da:	89 de                	mov    %ebx,%esi
801044dc:	89 c1                	mov    %eax,%ecx
801044de:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)


if(proc->ctFlag){
801044e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044e6:	8b 40 7c             	mov    0x7c(%eax),%eax
801044e9:	85 c0                	test   %eax,%eax
801044eb:	74 3e                	je     8010452b <fork+0x135>
...
801044fa:	8b 92 84 00 00 00    	mov    0x84(%edx),%edx
80104500:	89 50 38             	mov    %edx,0x38(%eax)
  uint *sp = (uint*)proc->cStack;
80104503:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104509:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
8010450f:	89 45 dc             	mov    %eax,-0x24(%ebp)
  
  *(--sp) = 0;
80104512:	83 6d dc 04          	subl   $0x4,-0x24(%ebp)
...
80104525:	8b 55 dc             	mov    -0x24(%ebp),%edx
80104528:	89 50 44             	mov    %edx,0x44(%eax)
...
80104531:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)


  for(i = 0; i < NOFILE; i++)
80104538:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010453f:	eb 3d                	jmp    8010457e <fork+0x188>
    if(proc->ofile[i])
...
80104553:	74 25                	je     8010457a <fork+0x184>
      np->ofile[i] = filedup(proc->ofile[i]);
80104555:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010455b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010455e:	83 c2 08             	add    $0x8,%edx
80104561:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104565:	89 04 24             	mov    %eax,(%esp)
80104568:	e8 1b ca ff ff       	call   80100f88 <filedup>
8010456d:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104570:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104573:	83 c1 08             	add    $0x8,%ecx
80104576:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  ...
  for(i = 0; i < NOFILE; i++)
8010457a:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
8010457e:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104582:	7e bd                	jle    80104541 <fork+0x14b>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
80104590:	e8 ad d2 ff ff       	call   80101842 <idup>
80104595:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104598:	89 42 68             	mov    %eax,0x68(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
8010459b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045a1:	8d 50 6c             	lea    0x6c(%eax),%edx
801045a4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045a7:	83 c0 6c             	add    $0x6c,%eax
801045aa:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801045b1:	00 
801045b2:	89 54 24 04          	mov    %edx,0x4(%esp)
801045b6:	89 04 24             	mov    %eax,(%esp)
801045b9:	e8 9c 0b 00 00       	call   8010515a <safestrcpy>
 
  pid = np->pid;
801045be:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045c1:	8b 40 10             	mov    0x10(%eax),%eax
801045c4:	89 45 d8             	mov    %eax,-0x28(%ebp)

  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
801045c7:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801045ce:	e8 08 07 00 00       	call   80104cdb <acquire>
  np->state = RUNNABLE;
801045d3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801045d6:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
801045dd:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801045e4:	e8 54 07 00 00       	call   80104d3d <release>

  return pid;
801045e9:	8b 45 d8             	mov    -0x28(%ebp),%eax

}
801045ec:	83 c4 2c             	add    $0x2c,%esp
801045ef:	5b                   	pop    %ebx
801045f0:	5e                   	pop    %esi
801045f1:	5f                   	pop    %edi
801045f2:	5d                   	pop    %ebp
...
801045f7:	83 ec 28             	sub    $0x28,%esp
  ...
  if(proc == initproc)
801045fa:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104601:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104606:	39 c2                	cmp    %eax,%edx
80104608:	75 0c                	jne    80104616 <exit+0x22>
    panic("init exiting");
8010460a:	c7 04 24 58 86 10 80 	movl   $0x80108658,(%esp)
80104611:	e8 27 bf ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104616:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010461d:	eb 44                	jmp    80104663 <exit+0x6f>
    if(proc->ofile[fd]){
8010461f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104625:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104628:	83 c2 08             	add    $0x8,%edx
8010462b:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010462f:	85 c0                	test   %eax,%eax
80104631:	74 2c                	je     8010465f <exit+0x6b>
      fileclose(proc->ofile[fd]);
80104633:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104639:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010463c:	83 c2 08             	add    $0x8,%edx
8010463f:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104643:	89 04 24             	mov    %eax,(%esp)
80104646:	e8 85 c9 ff ff       	call   80100fd0 <fileclose>
      proc->ofile[fd] = 0;
8010464b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104651:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104654:	83 c2 08             	add    $0x8,%edx
80104657:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010465e:	00 
...
80104667:	7e b6                	jle    8010461f <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80104669:	e8 bb eb ff ff       	call   80103229 <begin_op>
  iput(proc->cwd);
8010466e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104674:	8b 40 68             	mov    0x68(%eax),%eax
80104677:	89 04 24             	mov    %eax,(%esp)
8010467a:	e8 a8 d3 ff ff       	call   80101a27 <iput>
  end_op();
8010467f:	e8 26 ec ff ff       	call   801032aa <end_op>
  proc->cwd = 0;
80104684:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010468a:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104691:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104698:	e8 3e 06 00 00       	call   80104cdb <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
8010469d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046a3:	8b 40 14             	mov    0x14(%eax),%eax
801046a6:	89 04 24             	mov    %eax,(%esp)
801046a9:	e8 e1 03 00 00       	call   80104a8f <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046ae:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
801046b5:	eb 3b                	jmp    801046f2 <exit+0xfe>
    if(p->parent == proc){
801046b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046ba:	8b 50 14             	mov    0x14(%eax),%edx
801046bd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046c3:	39 c2                	cmp    %eax,%edx
801046c5:	75 24                	jne    801046eb <exit+0xf7>
      p->parent = initproc;
801046c7:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
...
801046d9:	83 f8 05             	cmp    $0x5,%eax
801046dc:	75 0d                	jne    801046eb <exit+0xf7>
        wakeup1(initproc);
801046de:	a1 48 b6 10 80       	mov    0x8010b648,%eax
801046e3:	89 04 24             	mov    %eax,(%esp)
801046e6:	e8 a4 03 00 00       	call   80104a8f <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046eb:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
801046f2:	81 7d f4 94 4c 11 80 	cmpl   $0x80114c94,-0xc(%ebp)
801046f9:	72 bc                	jb     801046b7 <exit+0xc3>
        wakeup1(initproc);
    }
  }
...
80104701:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104708:	e8 d7 01 00 00       	call   801048e4 <sched>
  panic("zombie exit");
8010470d:	c7 04 24 65 86 10 80 	movl   $0x80108665,(%esp)
80104714:	e8 24 be ff ff       	call   8010053d <panic>
...
8010471c:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010471f:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104726:	e8 b0 05 00 00       	call   80104cdb <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
8010472b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104732:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
80104739:	e9 ba 00 00 00       	jmp    801047f8 <wait+0xdf>
      if(p->parent != proc)
8010473e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104741:	8b 50 14             	mov    0x14(%eax),%edx
80104744:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010474a:	39 c2                	cmp    %eax,%edx
8010474c:	0f 85 9e 00 00 00    	jne    801047f0 <wait+0xd7>
        continue;
      havekids = 1;
80104752:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104759:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010475c:	8b 40 0c             	mov    0xc(%eax),%eax
8010475f:	83 f8 05             	cmp    $0x5,%eax
80104762:	0f 85 89 00 00 00    	jne    801047f1 <wait+0xd8>
        // Found one.
        pid = p->pid;
80104768:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010476b:	8b 40 10             	mov    0x10(%eax),%eax
8010476e:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
80104771:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104774:	8b 40 08             	mov    0x8(%eax),%eax
80104777:	89 04 24             	mov    %eax,(%esp)
8010477a:	e8 f3 e2 ff ff       	call   80102a72 <kfree>
        p->kstack = 0;
...
8010478c:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104792:	85 c0                	test   %eax,%eax
80104794:	75 10                	jne    801047a6 <wait+0x8d>
           freevm(p->pgdir);
80104796:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104799:	8b 40 04             	mov    0x4(%eax),%eax
8010479c:	89 04 24             	mov    %eax,(%esp)
8010479f:	e8 b1 38 00 00       	call   80108055 <freevm>
801047a4:	eb 0a                	jmp    801047b0 <wait+0x97>
	else
		p->pgdir = 0;
801047a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047a9:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
...
801047d8:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
801047df:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801047e6:	e8 52 05 00 00       	call   80104d3d <release>
        return pid;
801047eb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801047ee:	eb 56                	jmp    80104846 <wait+0x12d>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801047f0:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047f1:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
801047f8:	81 7d f4 94 4c 11 80 	cmpl   $0x80114c94,-0xc(%ebp)
801047ff:	0f 82 39 ff ff ff    	jb     8010473e <wait+0x25>
        return pid;
      }
    }
...
80104805:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104809:	74 0d                	je     80104818 <wait+0xff>
8010480b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104811:	8b 40 24             	mov    0x24(%eax),%eax
80104814:	85 c0                	test   %eax,%eax
80104816:	74 13                	je     8010482b <wait+0x112>
      release(&ptable.lock);
80104818:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
8010481f:	e8 19 05 00 00       	call   80104d3d <release>
      return -1;
80104824:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104829:	eb 1b                	jmp    80104846 <wait+0x12d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010482b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104831:	c7 44 24 04 60 29 11 	movl   $0x80112960,0x4(%esp)
80104838:	80 
80104839:	89 04 24             	mov    %eax,(%esp)
8010483c:	e8 b3 01 00 00       	call   801049f4 <sleep>
  }
80104841:	e9 e5 fe ff ff       	jmp    8010472b <wait+0x12>
}
80104846:	c9                   	leave  
80104847:	c3                   	ret    
...
8010484b:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
8010484e:	e8 ba f8 ff ff       	call   8010410d <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104853:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
8010485a:	e8 7c 04 00 00       	call   80104cdb <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010485f:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
80104866:	eb 62                	jmp    801048ca <scheduler+0x82>
      if(p->state != RUNNABLE)
80104868:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010486b:	8b 40 0c             	mov    0xc(%eax),%eax
8010486e:	83 f8 03             	cmp    $0x3,%eax
80104871:	75 4f                	jne    801048c2 <scheduler+0x7a>
        continue;
...
80104876:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
8010487c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010487f:	89 04 24             	mov    %eax,(%esp)
80104882:	e8 57 33 00 00       	call   80107bde <switchuvm>
      p->state = RUNNING;
80104887:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010488a:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
80104891:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104897:	8b 40 1c             	mov    0x1c(%eax),%eax
8010489a:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801048a1:	83 c2 04             	add    $0x4,%edx
801048a4:	89 44 24 04          	mov    %eax,0x4(%esp)
801048a8:	89 14 24             	mov    %edx,(%esp)
801048ab:	e8 20 09 00 00       	call   801051d0 <swtch>
      switchkvm();
801048b0:	e8 0c 33 00 00       	call   80107bc1 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
801048b5:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801048bc:	00 00 00 00 
801048c0:	eb 01                	jmp    801048c3 <scheduler+0x7b>
...
801048c2:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048c3:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
801048ca:	81 7d f4 94 4c 11 80 	cmpl   $0x80114c94,-0xc(%ebp)
801048d1:	72 95                	jb     80104868 <scheduler+0x20>
...
801048da:	e8 5e 04 00 00       	call   80104d3d <release>

  }
801048df:	e9 6a ff ff ff       	jmp    8010484e <scheduler+0x6>
...
801048ea:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801048f1:	e8 03 05 00 00       	call   80104df9 <holding>
801048f6:	85 c0                	test   %eax,%eax
801048f8:	75 0c                	jne    80104906 <sched+0x22>
    panic("sched ptable.lock");
801048fa:	c7 04 24 71 86 10 80 	movl   $0x80108671,(%esp)
80104901:	e8 37 bc ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80104906:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010490c:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104912:	83 f8 01             	cmp    $0x1,%eax
80104915:	74 0c                	je     80104923 <sched+0x3f>
    panic("sched locks");
80104917:	c7 04 24 83 86 10 80 	movl   $0x80108683,(%esp)
...
8010492f:	75 0c                	jne    8010493d <sched+0x59>
    panic("sched running");
80104931:	c7 04 24 8f 86 10 80 	movl   $0x8010868f,(%esp)
80104938:	e8 00 bc ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
8010493d:	e8 b6 f7 ff ff       	call   801040f8 <readeflags>
80104942:	25 00 02 00 00       	and    $0x200,%eax
80104947:	85 c0                	test   %eax,%eax
80104949:	74 0c                	je     80104957 <sched+0x73>
    panic("sched interruptible");
8010494b:	c7 04 24 9d 86 10 80 	movl   $0x8010869d,(%esp)
80104952:	e8 e6 bb ff ff       	call   8010053d <panic>
  intena = cpu->intena;
80104957:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010495d:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104963:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104966:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010496c:	8b 40 04             	mov    0x4(%eax),%eax
8010496f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104976:	83 c2 1c             	add    $0x1c,%edx
80104979:	89 44 24 04          	mov    %eax,0x4(%esp)
8010497d:	89 14 24             	mov    %edx,(%esp)
80104980:	e8 4b 08 00 00       	call   801051d0 <swtch>
  cpu->intena = intena;
80104985:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010498b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010498e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104994:	c9                   	leave  
80104995:	c3                   	ret    
...
8010499c:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801049a3:	e8 33 03 00 00       	call   80104cdb <acquire>
  proc->state = RUNNABLE;
801049a8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049ae:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
801049b5:	e8 2a ff ff ff       	call   801048e4 <sched>
  release(&ptable.lock);
801049ba:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801049c1:	e8 77 03 00 00       	call   80104d3d <release>
}
801049c6:	c9                   	leave  
801049c7:	c3                   	ret    
...
801049cb:	83 ec 18             	sub    $0x18,%esp
  static int first = 1;
  // Still holding ptable.lock from scheduler.
  release(&ptable.lock);
801049ce:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
801049d5:	e8 63 03 00 00       	call   80104d3d <release>

  if (first) {
801049da:	a1 20 b0 10 80       	mov    0x8010b020,%eax
801049df:	85 c0                	test   %eax,%eax
801049e1:	74 0f                	je     801049f2 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
801049e3:	c7 05 20 b0 10 80 00 	movl   $0x0,0x8010b020
801049ea:	00 00 00 
    initlog();
801049ed:	e8 2a e6 ff ff       	call   8010301c <initlog>
  }
...
80104a02:	75 0c                	jne    80104a10 <sleep+0x1c>
    panic("sleep");
80104a04:	c7 04 24 b1 86 10 80 	movl   $0x801086b1,(%esp)
80104a0b:	e8 2d bb ff ff       	call   8010053d <panic>

  if(lk == 0)
80104a10:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104a14:	75 0c                	jne    80104a22 <sleep+0x2e>
    panic("sleep without lk");
80104a16:	c7 04 24 b7 86 10 80 	movl   $0x801086b7,(%esp)
80104a1d:	e8 1b bb ff ff       	call   8010053d <panic>
...
80104a22:	81 7d 0c 60 29 11 80 	cmpl   $0x80112960,0xc(%ebp)
80104a29:	74 17                	je     80104a42 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104a2b:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104a32:	e8 a4 02 00 00       	call   80104cdb <acquire>
    release(lk);
80104a37:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a3a:	89 04 24             	mov    %eax,(%esp)
80104a3d:	e8 fb 02 00 00       	call   80104d3d <release>
  }
...
80104a4b:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104a4e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a54:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104a5b:	e8 84 fe ff ff       	call   801048e4 <sched>
...
80104a6d:	81 7d 0c 60 29 11 80 	cmpl   $0x80112960,0xc(%ebp)
80104a74:	74 17                	je     80104a8d <sleep+0x99>
    release(&ptable.lock);
80104a76:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104a7d:	e8 bb 02 00 00       	call   80104d3d <release>
    acquire(lk);
80104a82:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a85:	89 04 24             	mov    %eax,(%esp)
80104a88:	e8 4e 02 00 00       	call   80104cdb <acquire>
  }
}
80104a8d:	c9                   	leave  
80104a8e:	c3                   	ret    
...
80104a92:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104a95:	c7 45 fc 94 29 11 80 	movl   $0x80112994,-0x4(%ebp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104abe:	81 45 fc 8c 00 00 00 	addl   $0x8c,-0x4(%ebp)
80104ac5:	81 7d fc 94 4c 11 80 	cmpl   $0x80114c94,-0x4(%ebp)
...
80104ad3:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104ad6:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104add:	e8 f9 01 00 00       	call   80104cdb <acquire>
  wakeup1(chan);
80104ae2:	8b 45 08             	mov    0x8(%ebp),%eax
80104ae5:	89 04 24             	mov    %eax,(%esp)
80104ae8:	e8 a2 ff ff ff       	call   80104a8f <wakeup1>
  release(&ptable.lock);
80104aed:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104af4:	e8 44 02 00 00       	call   80104d3d <release>
}
80104af9:	c9                   	leave  
80104afa:	c3                   	ret    
...
80104afe:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104b01:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104b08:	e8 ce 01 00 00       	call   80104cdb <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b0d:	c7 45 f4 94 29 11 80 	movl   $0x80112994,-0xc(%ebp)
...
80104b47:	e8 f1 01 00 00       	call   80104d3d <release>
      return 0;
...
80104b5a:	81 7d f4 94 4c 11 80 	cmpl   $0x80114c94,-0xc(%ebp)
80104b61:	72 b3                	jb     80104b16 <kill+0x1b>
  ...
  release(&ptable.lock);
80104b63:	c7 04 24 60 29 11 80 	movl   $0x80112960,(%esp)
80104b6a:	e8 ce 01 00 00       	call   80104d3d <release>
  return -1;
...
80104b79:	83 ec 58             	sub    $0x58,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b7c:	c7 45 f0 94 29 11 80 	movl   $0x80112994,-0x10(%ebp)
80104b83:	e9 db 00 00 00       	jmp    80104c63 <procdump+0xed>
    if(p->state == UNUSED)
80104b88:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104b8b:	8b 40 0c             	mov    0xc(%eax),%eax
80104b8e:	85 c0                	test   %eax,%eax
80104b90:	0f 84 c5 00 00 00    	je     80104c5b <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104b96:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104b99:	8b 40 0c             	mov    0xc(%eax),%eax
80104b9c:	83 f8 05             	cmp    $0x5,%eax
80104b9f:	77 23                	ja     80104bc4 <procdump+0x4e>
80104ba1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ba4:	8b 40 0c             	mov    0xc(%eax),%eax
80104ba7:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104bae:	85 c0                	test   %eax,%eax
80104bb0:	74 12                	je     80104bc4 <procdump+0x4e>
      state = states[p->state];
80104bb2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bb5:	8b 40 0c             	mov    0xc(%eax),%eax
80104bb8:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104bbf:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104bc2:	eb 07                	jmp    80104bcb <procdump+0x55>
    else
      state = "???";
80104bc4:	c7 45 ec c8 86 10 80 	movl   $0x801086c8,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104bcb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bce:	8d 50 6c             	lea    0x6c(%eax),%edx
80104bd1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bd4:	8b 40 10             	mov    0x10(%eax),%eax
80104bd7:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104bdb:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104bde:	89 54 24 08          	mov    %edx,0x8(%esp)
80104be2:	89 44 24 04          	mov    %eax,0x4(%esp)
80104be6:	c7 04 24 cc 86 10 80 	movl   $0x801086cc,(%esp)
80104bed:	e8 af b7 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104bf2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bf5:	8b 40 0c             	mov    0xc(%eax),%eax
80104bf8:	83 f8 02             	cmp    $0x2,%eax
80104bfb:	75 50                	jne    80104c4d <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104bfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c00:	8b 40 1c             	mov    0x1c(%eax),%eax
80104c03:	8b 40 0c             	mov    0xc(%eax),%eax
80104c06:	83 c0 08             	add    $0x8,%eax
80104c09:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104c0c:	89 54 24 04          	mov    %edx,0x4(%esp)
80104c10:	89 04 24             	mov    %eax,(%esp)
80104c13:	e8 74 01 00 00       	call   80104d8c <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104c18:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104c1f:	eb 1b                	jmp    80104c3c <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104c21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c24:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104c28:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c2c:	c7 04 24 d5 86 10 80 	movl   $0x801086d5,(%esp)
80104c33:	e8 69 b7 ff ff       	call   801003a1 <cprintf>
    ...
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104c38:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104c3c:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104c40:	7f 0b                	jg     80104c4d <procdump+0xd7>
80104c42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c45:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104c49:	85 c0                	test   %eax,%eax
80104c4b:	75 d4                	jne    80104c21 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104c4d:	c7 04 24 d9 86 10 80 	movl   $0x801086d9,(%esp)
80104c54:	e8 48 b7 ff ff       	call   801003a1 <cprintf>
80104c59:	eb 01                	jmp    80104c5c <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104c5b:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c5c:	81 45 f0 8c 00 00 00 	addl   $0x8c,-0x10(%ebp)
80104c63:	81 7d f0 94 4c 11 80 	cmpl   $0x80114c94,-0x10(%ebp)
80104c6a:	0f 82 18 ff ff ff    	jb     80104b88 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104c7b:	9c                   	pushf  
80104c7c:	5b                   	pop    %ebx
80104c7d:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
80104c9f:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80104ca2:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104ca9:	f0 87 02             	lock xchg %eax,(%edx)
80104cac:	89 c3                	mov    %eax,%ebx
80104cae:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104cb1:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104ce1:	e8 3d 01 00 00       	call   80104e23 <pushcli>
  if(holding(lk))
80104ce6:	8b 45 08             	mov    0x8(%ebp),%eax
80104ce9:	89 04 24             	mov    %eax,(%esp)
80104cec:	e8 08 01 00 00       	call   80104df9 <holding>
80104cf1:	85 c0                	test   %eax,%eax
80104cf3:	74 0c                	je     80104d01 <acquire+0x26>
    panic("acquire");
80104cf5:	c7 04 24 05 87 10 80 	movl   $0x80108705,(%esp)
80104cfc:	e8 3c b8 ff ff       	call   8010053d <panic>
...
80104d05:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104d0c:	00 
80104d0d:	89 04 24             	mov    %eax,(%esp)
80104d10:	e8 80 ff ff ff       	call   80104c95 <xchg>
80104d15:	85 c0                	test   %eax,%eax
80104d17:	75 e9                	jne    80104d02 <acquire+0x27>
    ;
...
80104d23:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104d26:	8b 45 08             	mov    0x8(%ebp),%eax
80104d29:	83 c0 0c             	add    $0xc,%eax
80104d2c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d30:	8d 45 08             	lea    0x8(%ebp),%eax
80104d33:	89 04 24             	mov    %eax,(%esp)
80104d36:	e8 51 00 00 00       	call   80104d8c <getcallerpcs>
}
80104d3b:	c9                   	leave  
80104d3c:	c3                   	ret    
...
80104d49:	e8 ab 00 00 00       	call   80104df9 <holding>
80104d4e:	85 c0                	test   %eax,%eax
80104d50:	75 0c                	jne    80104d5e <release+0x21>
    panic("release");
80104d52:	c7 04 24 0d 87 10 80 	movl   $0x8010870d,(%esp)
80104d59:	e8 df b7 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
80104d5e:	8b 45 08             	mov    0x8(%ebp),%eax
80104d61:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104d68:	8b 45 08             	mov    0x8(%ebp),%eax
80104d6b:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104d75:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104d7c:	00 
80104d7d:	89 04 24             	mov    %eax,(%esp)
80104d80:	e8 10 ff ff ff       	call   80104c95 <xchg>

  popcli();
80104d85:	e8 e1 00 00 00       	call   80104e6b <popcli>
}
80104d8a:	c9                   	leave  
80104d8b:	c3                   	ret    

80104d8c <getcallerpcs>:
...
80104d8f:	83 ec 10             	sub    $0x10,%esp
  uint *ebp;
  int i;
  
  ebp = (uint*)v - 2;
80104d92:	8b 45 08             	mov    0x8(%ebp),%eax
80104d95:	83 e8 08             	sub    $0x8,%eax
80104d98:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104d9b:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104da2:	eb 32                	jmp    80104dd6 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104da4:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104da8:	74 47                	je     80104df1 <getcallerpcs+0x65>
80104daa:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104db1:	76 3e                	jbe    80104df1 <getcallerpcs+0x65>
80104db3:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104db7:	74 38                	je     80104df1 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104db9:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104dbc:	c1 e0 02             	shl    $0x2,%eax
80104dbf:	03 45 0c             	add    0xc(%ebp),%eax
80104dc2:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104dc5:	8b 52 04             	mov    0x4(%edx),%edx
80104dc8:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
80104dca:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104dcd:	8b 00                	mov    (%eax),%eax
80104dcf:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104dd2:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104dd6:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104dda:	7e c8                	jle    80104da4 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104ddc:	eb 13                	jmp    80104df1 <getcallerpcs+0x65>
    pcs[i] = 0;
80104dde:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104de1:	c1 e0 02             	shl    $0x2,%eax
80104de4:	03 45 0c             	add    0xc(%ebp),%eax
80104de7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104ded:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104df1:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104df5:	7e e7                	jle    80104dde <getcallerpcs+0x52>
    pcs[i] = 0;
}
80104df7:	c9                   	leave  
80104df8:	c3                   	ret    
...
80104e03:	74 17                	je     80104e1c <holding+0x23>
80104e05:	8b 45 08             	mov    0x8(%ebp),%eax
80104e08:	8b 50 08             	mov    0x8(%eax),%edx
80104e0b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e11:	39 c2                	cmp    %eax,%edx
80104e13:	75 07                	jne    80104e1c <holding+0x23>
80104e15:	b8 01 00 00 00       	mov    $0x1,%eax
80104e1a:	eb 05                	jmp    80104e21 <holding+0x28>
...
80104e26:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104e29:	e8 46 fe ff ff       	call   80104c74 <readeflags>
80104e2e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104e31:	e8 53 fe ff ff       	call   80104c89 <cli>
  if(cpu->ncli++ == 0)
80104e36:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e3c:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104e42:	85 d2                	test   %edx,%edx
80104e44:	0f 94 c1             	sete   %cl
80104e47:	83 c2 01             	add    $0x1,%edx
80104e4a:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104e50:	84 c9                	test   %cl,%cl
80104e52:	74 15                	je     80104e69 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80104e54:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e5a:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104e5d:	81 e2 00 02 00 00    	and    $0x200,%edx
80104e63:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104e69:	c9                   	leave  
80104e6a:	c3                   	ret    
...
80104e6e:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104e71:	e8 fe fd ff ff       	call   80104c74 <readeflags>
80104e76:	25 00 02 00 00       	and    $0x200,%eax
80104e7b:	85 c0                	test   %eax,%eax
80104e7d:	74 0c                	je     80104e8b <popcli+0x20>
    panic("popcli - interruptible");
80104e7f:	c7 04 24 15 87 10 80 	movl   $0x80108715,(%esp)
80104e86:	e8 b2 b6 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80104e8b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e91:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104e97:	83 ea 01             	sub    $0x1,%edx
80104e9a:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104ea0:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104ea6:	85 c0                	test   %eax,%eax
80104ea8:	79 0c                	jns    80104eb6 <popcli+0x4b>
    panic("popcli");
80104eaa:	c7 04 24 2c 87 10 80 	movl   $0x8010872c,(%esp)
80104eb1:	e8 87 b6 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104eb6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ebc:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104ec2:	85 c0                	test   %eax,%eax
80104ec4:	75 15                	jne    80104edb <popcli+0x70>
80104ec6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ecc:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104ed2:	85 c0                	test   %eax,%eax
80104ed4:	74 05                	je     80104edb <popcli+0x70>
    sti();
80104ed6:	e8 b4 fd ff ff       	call   80104c8f <sti>
}
80104edb:	c9                   	leave  
80104edc:	c3                   	ret    
...
80104fdd:	eb 1c                	jmp    80104ffb <memcmp+0x5a>
    s1++, s2++;
80104fdf:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104fe3:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
80105006:	89 45 fc             	mov    %eax,-0x4(%ebp)
  d = dst;
80105009:	8b 45 08             	mov    0x8(%ebp),%eax
8010500c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
8010500f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105012:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105015:	73 54                	jae    8010506b <memmove+0x6e>
80105017:	8b 45 10             	mov    0x10(%ebp),%eax
8010501a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010501d:	01 d0                	add    %edx,%eax
8010501f:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105022:	76 47                	jbe    8010506b <memmove+0x6e>
    s += n;
80105024:	8b 45 10             	mov    0x10(%ebp),%eax
80105027:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010502a:	8b 45 10             	mov    0x10(%ebp),%eax
8010502d:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105030:	eb 13                	jmp    80105045 <memmove+0x48>
      *--d = *--s;
80105032:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105036:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
8010503a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010503d:	0f b6 10             	movzbl (%eax),%edx
80105040:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105043:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
80105049:	0f 95 c0             	setne  %al
8010504c:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105050:	84 c0                	test   %al,%al
80105052:	75 de                	jne    80105032 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105054:	eb 25                	jmp    8010507b <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
8010505f:	88 10                	mov    %dl,(%eax)
80105061:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105065:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105069:	eb 01                	jmp    8010506c <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105070:	0f 95 c0             	setne  %al
80105073:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105077:	84 c0                	test   %al,%al
80105079:	75 db                	jne    80105056 <memmove+0x59>
      *d++ = *s++;
...
80105089:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010509a:	e8 5e ff ff ff       	call   80104ffd <memmove>
}
8010509f:	c9                   	leave  
801050a0:	c3                   	ret    
...
801050a2:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801050a4:	eb 0c                	jmp    801050b2 <strncmp+0x11>
    n--, p++, q++;
801050a6:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801050aa:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801050ae:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801050b6:	74 1a                	je     801050d2 <strncmp+0x31>
801050b8:	8b 45 08             	mov    0x8(%ebp),%eax
801050bb:	0f b6 00             	movzbl (%eax),%eax
801050be:	84 c0                	test   %al,%al
801050c0:	74 10                	je     801050d2 <strncmp+0x31>
801050c2:	8b 45 08             	mov    0x8(%ebp),%eax
801050c5:	0f b6 10             	movzbl (%eax),%edx
801050c8:	8b 45 0c             	mov    0xc(%ebp),%eax
801050cb:	0f b6 00             	movzbl (%eax),%eax
801050ce:	38 c2                	cmp    %al,%dl
801050d0:	74 d4                	je     801050a6 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801050d2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801050d6:	75 07                	jne    801050df <strncmp+0x3e>
    return 0;
801050d8:	b8 00 00 00 00       	mov    $0x0,%eax
801050dd:	eb 18                	jmp    801050f7 <strncmp+0x56>
...
8010510a:	0f 9f c0             	setg   %al
8010510d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105111:	84 c0                	test   %al,%al
80105113:	74 30                	je     80105145 <strncpy+0x4c>
80105115:	8b 45 0c             	mov    0xc(%ebp),%eax
80105118:	0f b6 10             	movzbl (%eax),%edx
8010511b:	8b 45 08             	mov    0x8(%ebp),%eax
8010511e:	88 10                	mov    %dl,(%eax)
80105120:	8b 45 08             	mov    0x8(%ebp),%eax
80105123:	0f b6 00             	movzbl (%eax),%eax
80105126:	84 c0                	test   %al,%al
80105128:	0f 95 c0             	setne  %al
8010512b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010512f:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105133:	84 c0                	test   %al,%al
80105135:	75 cf                	jne    80105106 <strncpy+0xd>
    ;
  while(n-- > 0)
80105137:	eb 0c                	jmp    80105145 <strncpy+0x4c>
    *s++ = 0;
80105139:	8b 45 08             	mov    0x8(%ebp),%eax
8010513c:	c6 00 00             	movb   $0x0,(%eax)
8010513f:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105143:	eb 01                	jmp    80105146 <strncpy+0x4d>
  char *os;
...
8010514a:	0f 9f c0             	setg   %al
8010514d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105151:	84 c0                	test   %al,%al
80105153:	75 e4                	jne    80105139 <strncpy+0x40>
    *s++ = 0;
  return os;
...
80105163:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105166:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010516a:	7f 05                	jg     80105171 <safestrcpy+0x17>
    return os;
8010516c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010516f:	eb 35                	jmp    801051a6 <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105171:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105175:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105179:	7e 22                	jle    8010519d <safestrcpy+0x43>
8010517b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010517e:	0f b6 10             	movzbl (%eax),%edx
80105181:	8b 45 08             	mov    0x8(%ebp),%eax
80105184:	88 10                	mov    %dl,(%eax)
80105186:	8b 45 08             	mov    0x8(%ebp),%eax
80105189:	0f b6 00             	movzbl (%eax),%eax
8010518c:	84 c0                	test   %al,%al
8010518e:	0f 95 c0             	setne  %al
80105191:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105195:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105199:	84 c0                	test   %al,%al
8010519b:	75 d4                	jne    80105171 <safestrcpy+0x17>
    ;
  *s = 0;
...
801051ab:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
801051ae:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801051b5:	eb 04                	jmp    801051bb <strlen+0x13>
801051b7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801051bb:	8b 45 fc             	mov    -0x4(%ebp),%eax
801051be:	03 45 08             	add    0x8(%ebp),%eax
801051c1:	0f b6 00             	movzbl (%eax),%eax
801051c4:	84 c0                	test   %al,%al
801051c6:	75 ef                	jne    801051b7 <strlen+0xf>
    ;
  return n;
...
8010527a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
...
80105319:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
8010531c:	8d 45 fc             	lea    -0x4(%ebp),%eax
8010531f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105323:	8b 45 08             	mov    0x8(%ebp),%eax
80105326:	89 04 24             	mov    %eax,(%esp)
80105329:	e8 58 ff ff ff       	call   80105286 <argint>
8010532e:	85 c0                	test   %eax,%eax
80105330:	79 07                	jns    80105339 <argstr+0x23>
    return -1;
80105332:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105337:	eb 12                	jmp    8010534b <argstr+0x35>
  return fetchstr(addr, pp);
80105339:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010533c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010533f:	89 54 24 04          	mov    %edx,0x4(%esp)
80105343:	89 04 24             	mov    %eax,(%esp)
80105346:	e8 d7 fe ff ff       	call   80105222 <fetchstr>
}
8010534b:	c9                   	leave  
8010534c:	c3                   	ret    
...
80105351:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105354:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010535a:	8b 40 18             	mov    0x18(%eax),%eax
8010535d:	8b 40 1c             	mov    0x1c(%eax),%eax
80105360:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105363:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105367:	7e 30                	jle    80105399 <syscall+0x4c>
80105369:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010536c:	83 f8 17             	cmp    $0x17,%eax
8010536f:	77 28                	ja     80105399 <syscall+0x4c>
80105371:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105374:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010537b:	85 c0                	test   %eax,%eax
8010537d:	74 1a                	je     80105399 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
8010537f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105385:	8b 58 18             	mov    0x18(%eax),%ebx
80105388:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010538b:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105392:	ff d0                	call   *%eax
80105394:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105397:	eb 3d                	jmp    801053d6 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105399:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010539f:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
801053df:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
801053ef:	e8 92 fe ff ff       	call   80105286 <argint>
801053f4:	85 c0                	test   %eax,%eax
801053f6:	79 07                	jns    801053ff <argfd+0x23>
    return -1;
801053f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801053fd:	eb 50                	jmp    8010544f <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801053ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105402:	85 c0                	test   %eax,%eax
80105404:	78 21                	js     80105427 <argfd+0x4b>
80105406:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105409:	83 f8 0f             	cmp    $0xf,%eax
8010540c:	7f 19                	jg     80105427 <argfd+0x4b>
...
80105421:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105425:	75 07                	jne    8010542e <argfd+0x52>
    return -1;
80105427:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010542c:	eb 21                	jmp    8010544f <argfd+0x73>
  if(pfd)
8010542e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105432:	74 08                	je     8010543c <argfd+0x60>
    *pfd = fd;
...
80105440:	74 08                	je     8010544a <argfd+0x6e>
    *pf = f;
...
80105454:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105457:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010545e:	eb 30                	jmp    80105490 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105460:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105466:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105469:	83 c2 08             	add    $0x8,%edx
8010546c:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105470:	85 c0                	test   %eax,%eax
80105472:	75 18                	jne    8010548c <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105474:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010547a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010547d:	8d 4a 08             	lea    0x8(%edx),%ecx
80105480:	8b 55 08             	mov    0x8(%ebp),%edx
80105483:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105487:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010548a:	eb 0f                	jmp    8010549b <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010548c:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105490:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105494:	7e ca                	jle    80105460 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
801054a0:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
801054a3:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054a6:	89 44 24 08          	mov    %eax,0x8(%esp)
801054aa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801054b1:	00 
801054b2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054b9:	e8 1e ff ff ff       	call   801053dc <argfd>
801054be:	85 c0                	test   %eax,%eax
801054c0:	79 07                	jns    801054c9 <sys_dup+0x2c>
    return -1;
801054c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054c7:	eb 29                	jmp    801054f2 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801054c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054cc:	89 04 24             	mov    %eax,(%esp)
801054cf:	e8 7d ff ff ff       	call   80105451 <fdalloc>
801054d4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801054d7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801054db:	79 07                	jns    801054e4 <sys_dup+0x47>
    return -1;
801054dd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054e2:	eb 0e                	jmp    801054f2 <sys_dup+0x55>
  filedup(f);
801054e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054e7:	89 04 24             	mov    %eax,(%esp)
801054ea:	e8 99 ba ff ff       	call   80100f88 <filedup>
  return fd;
...
80105510:	e8 c7 fe ff ff       	call   801053dc <argfd>
80105515:	85 c0                	test   %eax,%eax
80105517:	78 35                	js     8010554e <sys_read+0x5a>
80105519:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010551c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105520:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105527:	e8 5a fd ff ff       	call   80105286 <argint>
8010552c:	85 c0                	test   %eax,%eax
8010552e:	78 1e                	js     8010554e <sys_read+0x5a>
...
80105545:	e8 6a fd ff ff       	call   801052b4 <argptr>
8010554a:	85 c0                	test   %eax,%eax
8010554c:	79 07                	jns    80105555 <sys_read+0x61>
    return -1;
8010554e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105553:	eb 19                	jmp    8010556e <sys_read+0x7a>
...
80105569:	e8 87 bb ff ff       	call   801010f5 <fileread>
}
8010556e:	c9                   	leave  
8010556f:	c3                   	ret    
...
8010557d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105584:	00 
80105585:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010558c:	e8 4b fe ff ff       	call   801053dc <argfd>
80105591:	85 c0                	test   %eax,%eax
80105593:	78 35                	js     801055ca <sys_write+0x5a>
80105595:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105598:	89 44 24 04          	mov    %eax,0x4(%esp)
8010559c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801055a3:	e8 de fc ff ff       	call   80105286 <argint>
801055a8:	85 c0                	test   %eax,%eax
801055aa:	78 1e                	js     801055ca <sys_write+0x5a>
801055ac:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055af:	89 44 24 08          	mov    %eax,0x8(%esp)
801055b3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801055b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801055ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801055c1:	e8 ee fc ff ff       	call   801052b4 <argptr>
801055c6:	85 c0                	test   %eax,%eax
801055c8:	79 07                	jns    801055d1 <sys_write+0x61>
    return -1;
801055ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055cf:	eb 19                	jmp    801055ea <sys_write+0x7a>
  return filewrite(f, p, n);
801055d1:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801055d4:	8b 55 ec             	mov    -0x14(%ebp),%edx
801055d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055da:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801055de:	89 54 24 04          	mov    %edx,0x4(%esp)
801055e2:	89 04 24             	mov    %eax,(%esp)
801055e5:	e8 c7 bb ff ff       	call   801011b1 <filewrite>
}
801055ea:	c9                   	leave  
801055eb:	c3                   	ret    
...
80105600:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105607:	e8 d0 fd ff ff       	call   801053dc <argfd>
8010560c:	85 c0                	test   %eax,%eax
8010560e:	79 07                	jns    80105617 <sys_close+0x2b>
    return -1;
80105610:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105615:	eb 24                	jmp    8010563b <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105617:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010561d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105620:	83 c2 08             	add    $0x8,%edx
80105623:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010562a:	00 
  fileclose(f);
8010562b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010562e:	89 04 24             	mov    %eax,(%esp)
80105631:	e8 9a b9 ff ff       	call   80100fd0 <fileclose>
  return 0;
...
80105643:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105646:	89 44 24 08          	mov    %eax,0x8(%esp)
8010564a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105651:	00 
80105652:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105659:	e8 7e fd ff ff       	call   801053dc <argfd>
8010565e:	85 c0                	test   %eax,%eax
80105660:	78 1f                	js     80105681 <sys_fstat+0x44>
80105662:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105669:	00 
8010566a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010566d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105671:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105678:	e8 37 fc ff ff       	call   801052b4 <argptr>
8010567d:	85 c0                	test   %eax,%eax
8010567f:	79 07                	jns    80105688 <sys_fstat+0x4b>
    return -1;
80105681:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105686:	eb 12                	jmp    8010569a <sys_fstat+0x5d>
...
80105695:	e8 0c ba ff ff       	call   801010a6 <filestat>
}
8010569a:	c9                   	leave  
8010569b:	c3                   	ret    
...
8010569f:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801056a2:	8d 45 d8             	lea    -0x28(%ebp),%eax
801056a5:	89 44 24 04          	mov    %eax,0x4(%esp)
801056a9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056b0:	e8 61 fc ff ff       	call   80105316 <argstr>
801056b5:	85 c0                	test   %eax,%eax
801056b7:	78 17                	js     801056d0 <sys_link+0x34>
801056b9:	8d 45 dc             	lea    -0x24(%ebp),%eax
801056bc:	89 44 24 04          	mov    %eax,0x4(%esp)
801056c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801056c7:	e8 4a fc ff ff       	call   80105316 <argstr>
801056cc:	85 c0                	test   %eax,%eax
801056ce:	79 0a                	jns    801056da <sys_link+0x3e>
    return -1;
801056d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056d5:	e9 41 01 00 00       	jmp    8010581b <sys_link+0x17f>

  begin_op();
801056da:	e8 4a db ff ff       	call   80103229 <begin_op>
  if((ip = namei(old)) == 0){
801056df:	8b 45 d8             	mov    -0x28(%ebp),%eax
801056e2:	89 04 24             	mov    %eax,(%esp)
801056e5:	e8 2c cd ff ff       	call   80102416 <namei>
801056ea:	89 45 f4             	mov    %eax,-0xc(%ebp)
801056ed:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801056f1:	75 0f                	jne    80105702 <sys_link+0x66>
    end_op();
801056f3:	e8 b2 db ff ff       	call   801032aa <end_op>
    return -1;
801056f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056fd:	e9 19 01 00 00       	jmp    8010581b <sys_link+0x17f>
  }

  ilock(ip);
80105702:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105705:	89 04 24             	mov    %eax,(%esp)
80105708:	e8 67 c1 ff ff       	call   80101874 <ilock>
  if(ip->type == T_DIR){
8010570d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105710:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105714:	66 83 f8 01          	cmp    $0x1,%ax
80105718:	75 1a                	jne    80105734 <sys_link+0x98>
    iunlockput(ip);
8010571a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010571d:	89 04 24             	mov    %eax,(%esp)
80105720:	e8 d3 c3 ff ff       	call   80101af8 <iunlockput>
    end_op();
80105725:	e8 80 db ff ff       	call   801032aa <end_op>
    return -1;
8010572a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010572f:	e9 e7 00 00 00       	jmp    8010581b <sys_link+0x17f>
  }

  ip->nlink++;
80105734:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105737:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010573b:	8d 50 01             	lea    0x1(%eax),%edx
8010573e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105741:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105745:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105748:	89 04 24             	mov    %eax,(%esp)
8010574b:	e8 68 bf ff ff       	call   801016b8 <iupdate>
  iunlock(ip);
80105750:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105753:	89 04 24             	mov    %eax,(%esp)
80105756:	e8 67 c2 ff ff       	call   801019c2 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010575b:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010575e:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105761:	89 54 24 04          	mov    %edx,0x4(%esp)
80105765:	89 04 24             	mov    %eax,(%esp)
80105768:	e8 cb cc ff ff       	call   80102438 <nameiparent>
8010576d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105770:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105774:	74 68                	je     801057de <sys_link+0x142>
    goto bad;
  ilock(dp);
80105776:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105779:	89 04 24             	mov    %eax,(%esp)
8010577c:	e8 f3 c0 ff ff       	call   80101874 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105781:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105784:	8b 10                	mov    (%eax),%edx
80105786:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105789:	8b 00                	mov    (%eax),%eax
8010578b:	39 c2                	cmp    %eax,%edx
8010578d:	75 20                	jne    801057af <sys_link+0x113>
8010578f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105792:	8b 40 04             	mov    0x4(%eax),%eax
80105795:	89 44 24 08          	mov    %eax,0x8(%esp)
80105799:	8d 45 e2             	lea    -0x1e(%ebp),%eax
8010579c:	89 44 24 04          	mov    %eax,0x4(%esp)
801057a0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057a3:	89 04 24             	mov    %eax,(%esp)
801057a6:	e8 aa c9 ff ff       	call   80102155 <dirlink>
801057ab:	85 c0                	test   %eax,%eax
801057ad:	79 0d                	jns    801057bc <sys_link+0x120>
    iunlockput(dp);
801057af:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057b2:	89 04 24             	mov    %eax,(%esp)
801057b5:	e8 3e c3 ff ff       	call   80101af8 <iunlockput>
    goto bad;
801057ba:	eb 23                	jmp    801057df <sys_link+0x143>
  }
  iunlockput(dp);
801057bc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057bf:	89 04 24             	mov    %eax,(%esp)
801057c2:	e8 31 c3 ff ff       	call   80101af8 <iunlockput>
  iput(ip);
801057c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ca:	89 04 24             	mov    %eax,(%esp)
801057cd:	e8 55 c2 ff ff       	call   80101a27 <iput>

  end_op();
801057d2:	e8 d3 da ff ff       	call   801032aa <end_op>

  return 0;
801057d7:	b8 00 00 00 00       	mov    $0x0,%eax
801057dc:	eb 3d                	jmp    8010581b <sys_link+0x17f>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
801057e5:	e8 8a c0 ff ff       	call   80101874 <ilock>
  ip->nlink--;
801057ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ed:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801057f1:	8d 50 ff             	lea    -0x1(%eax),%edx
801057f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057f7:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801057fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057fe:	89 04 24             	mov    %eax,(%esp)
80105801:	e8 b2 be ff ff       	call   801016b8 <iupdate>
  iunlockput(ip);
80105806:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105809:	89 04 24             	mov    %eax,(%esp)
8010580c:	e8 e7 c2 ff ff       	call   80101af8 <iunlockput>
  end_op();
80105811:	e8 94 da ff ff       	call   801032aa <end_op>
  return -1;
...
80105820:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105823:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
8010582a:	eb 4b                	jmp    80105877 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010582c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010582f:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105836:	00 
80105837:	89 44 24 08          	mov    %eax,0x8(%esp)
8010583b:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010583e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105842:	8b 45 08             	mov    0x8(%ebp),%eax
80105845:	89 04 24             	mov    %eax,(%esp)
80105848:	e8 1d c5 ff ff       	call   80101d6a <readi>
8010584d:	83 f8 10             	cmp    $0x10,%eax
80105850:	74 0c                	je     8010585e <isdirempty+0x41>
      panic("isdirempty: readi");
80105852:	c7 04 24 4f 87 10 80 	movl   $0x8010874f,(%esp)
80105859:	e8 df ac ff ff       	call   8010053d <panic>
    if(de.inum != 0)
8010585e:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105862:	66 85 c0             	test   %ax,%ax
80105865:	74 07                	je     8010586e <isdirempty+0x51>
      return 0;
80105867:	b8 00 00 00 00       	mov    $0x0,%eax
8010586c:	eb 1b                	jmp    80105889 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105871:	83 c0 10             	add    $0x10,%eax
...
80105882:	72 a8                	jb     8010582c <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80105884:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105889:	c9                   	leave  
8010588a:	c3                   	ret    
...
8010588e:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105891:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105894:	89 44 24 04          	mov    %eax,0x4(%esp)
80105898:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010589f:	e8 72 fa ff ff       	call   80105316 <argstr>
801058a4:	85 c0                	test   %eax,%eax
801058a6:	79 0a                	jns    801058b2 <sys_unlink+0x27>
    return -1;
801058a8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058ad:	e9 af 01 00 00       	jmp    80105a61 <sys_unlink+0x1d6>

  begin_op();
801058b2:	e8 72 d9 ff ff       	call   80103229 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801058b7:	8b 45 cc             	mov    -0x34(%ebp),%eax
801058ba:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801058bd:	89 54 24 04          	mov    %edx,0x4(%esp)
801058c1:	89 04 24             	mov    %eax,(%esp)
801058c4:	e8 6f cb ff ff       	call   80102438 <nameiparent>
801058c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058cc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058d0:	75 0f                	jne    801058e1 <sys_unlink+0x56>
    end_op();
801058d2:	e8 d3 d9 ff ff       	call   801032aa <end_op>
    return -1;
801058d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058dc:	e9 80 01 00 00       	jmp    80105a61 <sys_unlink+0x1d6>
  }

  ilock(dp);
801058e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058e4:	89 04 24             	mov    %eax,(%esp)
801058e7:	e8 88 bf ff ff       	call   80101874 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801058ec:	c7 44 24 04 61 87 10 	movl   $0x80108761,0x4(%esp)
801058f3:	80 
801058f4:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801058f7:	89 04 24             	mov    %eax,(%esp)
801058fa:	e8 6c c7 ff ff       	call   8010206b <namecmp>
801058ff:	85 c0                	test   %eax,%eax
80105901:	0f 84 45 01 00 00    	je     80105a4c <sys_unlink+0x1c1>
80105907:	c7 44 24 04 63 87 10 	movl   $0x80108763,0x4(%esp)
8010590e:	80 
8010590f:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105912:	89 04 24             	mov    %eax,(%esp)
80105915:	e8 51 c7 ff ff       	call   8010206b <namecmp>
8010591a:	85 c0                	test   %eax,%eax
8010591c:	0f 84 2a 01 00 00    	je     80105a4c <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105922:	8d 45 c8             	lea    -0x38(%ebp),%eax
...
80105936:	e8 52 c7 ff ff       	call   8010208d <dirlookup>
8010593b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010593e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105942:	0f 84 03 01 00 00    	je     80105a4b <sys_unlink+0x1c0>
    goto bad;
  ilock(ip);
80105948:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010594b:	89 04 24             	mov    %eax,(%esp)
8010594e:	e8 21 bf ff ff       	call   80101874 <ilock>

  if(ip->nlink < 1)
80105953:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105956:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010595a:	66 85 c0             	test   %ax,%ax
8010595d:	7f 0c                	jg     8010596b <sys_unlink+0xe0>
    panic("unlink: nlink < 1");
8010595f:	c7 04 24 66 87 10 80 	movl   $0x80108766,(%esp)
80105966:	e8 d2 ab ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010596b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010596e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105972:	66 83 f8 01          	cmp    $0x1,%ax
80105976:	75 1f                	jne    80105997 <sys_unlink+0x10c>
80105978:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010597b:	89 04 24             	mov    %eax,(%esp)
8010597e:	e8 9a fe ff ff       	call   8010581d <isdirempty>
80105983:	85 c0                	test   %eax,%eax
80105985:	75 10                	jne    80105997 <sys_unlink+0x10c>
    iunlockput(ip);
80105987:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010598a:	89 04 24             	mov    %eax,(%esp)
8010598d:	e8 66 c1 ff ff       	call   80101af8 <iunlockput>
    goto bad;
80105992:	e9 b5 00 00 00       	jmp    80105a4c <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105997:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010599e:	00 
8010599f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801059a6:	00 
801059a7:	8d 45 e0             	lea    -0x20(%ebp),%eax
801059aa:	89 04 24             	mov    %eax,(%esp)
801059ad:	e8 78 f5 ff ff       	call   80104f2a <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801059b2:	8b 45 c8             	mov    -0x38(%ebp),%eax
801059b5:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801059bc:	00 
801059bd:	89 44 24 08          	mov    %eax,0x8(%esp)
801059c1:	8d 45 e0             	lea    -0x20(%ebp),%eax
801059c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801059c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059cb:	89 04 24             	mov    %eax,(%esp)
801059ce:	e8 02 c5 ff ff       	call   80101ed5 <writei>
801059d3:	83 f8 10             	cmp    $0x10,%eax
801059d6:	74 0c                	je     801059e4 <sys_unlink+0x159>
    panic("unlink: writei");
801059d8:	c7 04 24 78 87 10 80 	movl   $0x80108778,(%esp)
801059df:	e8 59 ab ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
801059e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059e7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801059eb:	66 83 f8 01          	cmp    $0x1,%ax
801059ef:	75 1c                	jne    80105a0d <sys_unlink+0x182>
    dp->nlink--;
...
80105a08:	e8 ab bc ff ff       	call   801016b8 <iupdate>
  }
  iunlockput(dp);
80105a0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a10:	89 04 24             	mov    %eax,(%esp)
80105a13:	e8 e0 c0 ff ff       	call   80101af8 <iunlockput>

  ip->nlink--;
80105a18:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a1b:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105a1f:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105a2f:	e8 84 bc ff ff       	call   801016b8 <iupdate>
  iunlockput(ip);
80105a34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a37:	89 04 24             	mov    %eax,(%esp)
80105a3a:	e8 b9 c0 ff ff       	call   80101af8 <iunlockput>

  end_op();
80105a3f:	e8 66 d8 ff ff       	call   801032aa <end_op>

  return 0;
80105a44:	b8 00 00 00 00       	mov    $0x0,%eax
80105a49:	eb 16                	jmp    80105a61 <sys_unlink+0x1d6>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105a52:	e8 a1 c0 ff ff       	call   80101af8 <iunlockput>
  end_op();
80105a57:	e8 4e d8 ff ff       	call   801032aa <end_op>
  return -1;
...
80105a66:	83 ec 48             	sub    $0x48,%esp
80105a69:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105a6c:	8b 55 10             	mov    0x10(%ebp),%edx
80105a6f:	8b 45 14             	mov    0x14(%ebp),%eax
80105a72:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105a76:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105a7a:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105a7e:	8d 45 de             	lea    -0x22(%ebp),%eax
80105a81:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a85:	8b 45 08             	mov    0x8(%ebp),%eax
80105a88:	89 04 24             	mov    %eax,(%esp)
80105a8b:	e8 a8 c9 ff ff       	call   80102438 <nameiparent>
80105a90:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a93:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a97:	75 0a                	jne    80105aa3 <create+0x40>
    return 0;
80105a99:	b8 00 00 00 00       	mov    $0x0,%eax
80105a9e:	e9 7e 01 00 00       	jmp    80105c21 <create+0x1be>
  ilock(dp);
80105aa3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105aa6:	89 04 24             	mov    %eax,(%esp)
80105aa9:	e8 c6 bd ff ff       	call   80101874 <ilock>
...
80105ac2:	e8 c6 c5 ff ff       	call   8010208d <dirlookup>
80105ac7:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105aca:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ace:	74 47                	je     80105b17 <create+0xb4>
    iunlockput(dp);
80105ad0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ad3:	89 04 24             	mov    %eax,(%esp)
80105ad6:	e8 1d c0 ff ff       	call   80101af8 <iunlockput>
    ilock(ip);
80105adb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ade:	89 04 24             	mov    %eax,(%esp)
80105ae1:	e8 8e bd ff ff       	call   80101874 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105ae6:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105aeb:	75 15                	jne    80105b02 <create+0x9f>
80105aed:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105af0:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105af4:	66 83 f8 02          	cmp    $0x2,%ax
80105af8:	75 08                	jne    80105b02 <create+0x9f>
      return ip;
80105afa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105afd:	e9 1f 01 00 00       	jmp    80105c21 <create+0x1be>
    iunlockput(ip);
80105b02:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b05:	89 04 24             	mov    %eax,(%esp)
80105b08:	e8 eb bf ff ff       	call   80101af8 <iunlockput>
    return 0;
80105b0d:	b8 00 00 00 00       	mov    $0x0,%eax
80105b12:	e9 0a 01 00 00       	jmp    80105c21 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105b17:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105b1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b1e:	8b 00                	mov    (%eax),%eax
80105b20:	89 54 24 04          	mov    %edx,0x4(%esp)
80105b24:	89 04 24             	mov    %eax,(%esp)
80105b27:	e8 af ba ff ff       	call   801015db <ialloc>
80105b2c:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b2f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b33:	75 0c                	jne    80105b41 <create+0xde>
    panic("create: ialloc");
80105b35:	c7 04 24 87 87 10 80 	movl   $0x80108787,(%esp)
80105b3c:	e8 fc a9 ff ff       	call   8010053d <panic>

  ilock(ip);
80105b41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b44:	89 04 24             	mov    %eax,(%esp)
80105b47:	e8 28 bd ff ff       	call   80101874 <ilock>
  ip->major = major;
80105b4c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b4f:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105b53:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105b57:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b5a:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105b5e:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105b62:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b65:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105b6b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b6e:	89 04 24             	mov    %eax,(%esp)
80105b71:	e8 42 bb ff ff       	call   801016b8 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105b76:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105b7b:	75 6a                	jne    80105be7 <create+0x184>
    dp->nlink++;  // for ".."
80105b7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b80:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80105b94:	e8 1f bb ff ff       	call   801016b8 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105b99:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b9c:	8b 40 04             	mov    0x4(%eax),%eax
80105b9f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ba3:	c7 44 24 04 61 87 10 	movl   $0x80108761,0x4(%esp)
80105baa:	80 
80105bab:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bae:	89 04 24             	mov    %eax,(%esp)
80105bb1:	e8 9f c5 ff ff       	call   80102155 <dirlink>
80105bb6:	85 c0                	test   %eax,%eax
80105bb8:	78 21                	js     80105bdb <create+0x178>
80105bba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bbd:	8b 40 04             	mov    0x4(%eax),%eax
80105bc0:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bc4:	c7 44 24 04 63 87 10 	movl   $0x80108763,0x4(%esp)
80105bcb:	80 
80105bcc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bcf:	89 04 24             	mov    %eax,(%esp)
80105bd2:	e8 7e c5 ff ff       	call   80102155 <dirlink>
80105bd7:	85 c0                	test   %eax,%eax
80105bd9:	79 0c                	jns    80105be7 <create+0x184>
      panic("create dots");
80105bdb:	c7 04 24 96 87 10 80 	movl   $0x80108796,(%esp)
80105be2:	e8 56 a9 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105be7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bea:	8b 40 04             	mov    0x4(%eax),%eax
80105bed:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bf1:	8d 45 de             	lea    -0x22(%ebp),%eax
80105bf4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bf8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bfb:	89 04 24             	mov    %eax,(%esp)
80105bfe:	e8 52 c5 ff ff       	call   80102155 <dirlink>
80105c03:	85 c0                	test   %eax,%eax
80105c05:	79 0c                	jns    80105c13 <create+0x1b0>
    panic("create: dirlink");
80105c07:	c7 04 24 a2 87 10 80 	movl   $0x801087a2,(%esp)
80105c0e:	e8 2a a9 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80105c13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c16:	89 04 24             	mov    %eax,(%esp)
80105c19:	e8 da be ff ff       	call   80101af8 <iunlockput>
...
80105c26:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105c29:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105c2c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c30:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c37:	e8 da f6 ff ff       	call   80105316 <argstr>
80105c3c:	85 c0                	test   %eax,%eax
80105c3e:	78 17                	js     80105c57 <sys_open+0x34>
80105c40:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105c43:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c47:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105c4e:	e8 33 f6 ff ff       	call   80105286 <argint>
80105c53:	85 c0                	test   %eax,%eax
80105c55:	79 0a                	jns    80105c61 <sys_open+0x3e>
    return -1;
80105c57:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c5c:	e9 5a 01 00 00       	jmp    80105dbb <sys_open+0x198>

  begin_op();
80105c61:	e8 c3 d5 ff ff       	call   80103229 <begin_op>

  if(omode & O_CREATE){
80105c66:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105c69:	25 00 02 00 00       	and    $0x200,%eax
80105c6e:	85 c0                	test   %eax,%eax
80105c70:	74 3b                	je     80105cad <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105c72:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105c75:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105c7c:	00 
80105c7d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105c84:	00 
80105c85:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105c8c:	00 
80105c8d:	89 04 24             	mov    %eax,(%esp)
80105c90:	e8 ce fd ff ff       	call   80105a63 <create>
80105c95:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105c98:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c9c:	75 6b                	jne    80105d09 <sys_open+0xe6>
      end_op();
80105c9e:	e8 07 d6 ff ff       	call   801032aa <end_op>
      return -1;
80105ca3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ca8:	e9 0e 01 00 00       	jmp    80105dbb <sys_open+0x198>
    }
  } else {
    if((ip = namei(path)) == 0){
80105cad:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105cb0:	89 04 24             	mov    %eax,(%esp)
80105cb3:	e8 5e c7 ff ff       	call   80102416 <namei>
80105cb8:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105cbb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105cbf:	75 0f                	jne    80105cd0 <sys_open+0xad>
      end_op();
80105cc1:	e8 e4 d5 ff ff       	call   801032aa <end_op>
      return -1;
80105cc6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ccb:	e9 eb 00 00 00       	jmp    80105dbb <sys_open+0x198>
    }
    ilock(ip);
80105cd0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd3:	89 04 24             	mov    %eax,(%esp)
80105cd6:	e8 99 bb ff ff       	call   80101874 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105cdb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cde:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ce2:	66 83 f8 01          	cmp    $0x1,%ax
80105ce6:	75 21                	jne    80105d09 <sys_open+0xe6>
80105ce8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ceb:	85 c0                	test   %eax,%eax
80105ced:	74 1a                	je     80105d09 <sys_open+0xe6>
      iunlockput(ip);
80105cef:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cf2:	89 04 24             	mov    %eax,(%esp)
80105cf5:	e8 fe bd ff ff       	call   80101af8 <iunlockput>
      end_op();
80105cfa:	e8 ab d5 ff ff       	call   801032aa <end_op>
      return -1;
80105cff:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d04:	e9 b2 00 00 00       	jmp    80105dbb <sys_open+0x198>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105d09:	e8 1a b2 ff ff       	call   80100f28 <filealloc>
80105d0e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d11:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d15:	74 14                	je     80105d2b <sys_open+0x108>
80105d17:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d1a:	89 04 24             	mov    %eax,(%esp)
80105d1d:	e8 2f f7 ff ff       	call   80105451 <fdalloc>
80105d22:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105d25:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105d29:	79 28                	jns    80105d53 <sys_open+0x130>
    if(f)
80105d2b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d2f:	74 0b                	je     80105d3c <sys_open+0x119>
      fileclose(f);
80105d31:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d34:	89 04 24             	mov    %eax,(%esp)
80105d37:	e8 94 b2 ff ff       	call   80100fd0 <fileclose>
    iunlockput(ip);
80105d3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d3f:	89 04 24             	mov    %eax,(%esp)
80105d42:	e8 b1 bd ff ff       	call   80101af8 <iunlockput>
    end_op();
80105d47:	e8 5e d5 ff ff       	call   801032aa <end_op>
    return -1;
80105d4c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d51:	eb 68                	jmp    80105dbb <sys_open+0x198>
  }
  iunlock(ip);
80105d53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d56:	89 04 24             	mov    %eax,(%esp)
80105d59:	e8 64 bc ff ff       	call   801019c2 <iunlock>
  end_op();
80105d5e:	e8 47 d5 ff ff       	call   801032aa <end_op>

  f->type = FD_INODE;
80105d63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d66:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105d6c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d6f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105d72:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105d75:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d78:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105d7f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d82:	83 e0 01             	and    $0x1,%eax
80105d85:	85 c0                	test   %eax,%eax
80105d87:	0f 94 c2             	sete   %dl
80105d8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d8d:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105d90:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d93:	83 e0 01             	and    $0x1,%eax
80105d96:	84 c0                	test   %al,%al
80105d98:	75 0a                	jne    80105da4 <sys_open+0x181>
80105d9a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d9d:	83 e0 02             	and    $0x2,%eax
80105da0:	85 c0                	test   %eax,%eax
80105da2:	74 07                	je     80105dab <sys_open+0x188>
80105da4:	b8 01 00 00 00       	mov    $0x1,%eax
80105da9:	eb 05                	jmp    80105db0 <sys_open+0x18d>
80105dab:	b8 00 00 00 00       	mov    $0x0,%eax
80105db0:	89 c2                	mov    %eax,%edx
80105db2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105db5:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105db8:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105dbb:	c9                   	leave  
80105dbc:	c3                   	ret    
...
80105dc0:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105dc3:	e8 61 d4 ff ff       	call   80103229 <begin_op>
...
80105dd6:	e8 3b f5 ff ff       	call   80105316 <argstr>
80105ddb:	85 c0                	test   %eax,%eax
80105ddd:	78 2c                	js     80105e0b <sys_mkdir+0x4e>
80105ddf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de2:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105de9:	00 
80105dea:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105df1:	00 
80105df2:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105df9:	00 
80105dfa:	89 04 24             	mov    %eax,(%esp)
80105dfd:	e8 61 fc ff ff       	call   80105a63 <create>
80105e02:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e05:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e09:	75 0c                	jne    80105e17 <sys_mkdir+0x5a>
    end_op();
80105e0b:	e8 9a d4 ff ff       	call   801032aa <end_op>
    return -1;
80105e10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e15:	eb 15                	jmp    80105e2c <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105e17:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e1a:	89 04 24             	mov    %eax,(%esp)
80105e1d:	e8 d6 bc ff ff       	call   80101af8 <iunlockput>
  end_op();
80105e22:	e8 83 d4 ff ff       	call   801032aa <end_op>
  return 0;
...
80105e31:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
80105e6a:	78 47                	js     80105eb3 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105e6c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e6f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e73:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105e7a:	e8 07 f4 ff ff       	call   80105286 <argint>
  int len;
  int major, minor;
...
80105e81:	78 30                	js     80105eb3 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105e83:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e86:	0f bf c8             	movswl %ax,%ecx
80105e89:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e8c:	0f bf d0             	movswl %ax,%edx
80105e8f:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105e92:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105e96:	89 54 24 08          	mov    %edx,0x8(%esp)
80105e9a:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105ea1:	00 
80105ea2:	89 04 24             	mov    %eax,(%esp)
80105ea5:	e8 b9 fb ff ff       	call   80105a63 <create>
80105eaa:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105ead:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105eb1:	75 0c                	jne    80105ebf <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80105eb3:	e8 f2 d3 ff ff       	call   801032aa <end_op>
    return -1;
80105eb8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ebd:	eb 15                	jmp    80105ed4 <sys_mknod+0xa6>
  }
  iunlockput(ip);
...
80105ed9:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;
...
80105eef:	e8 22 f4 ff ff       	call   80105316 <argstr>
80105ef4:	85 c0                	test   %eax,%eax
80105ef6:	78 14                	js     80105f0c <sys_chdir+0x36>
80105ef8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105efb:	89 04 24             	mov    %eax,(%esp)
80105efe:	e8 13 c5 ff ff       	call   80102416 <namei>
80105f03:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f06:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f0a:	75 0c                	jne    80105f18 <sys_chdir+0x42>
    end_op();
80105f0c:	e8 99 d3 ff ff       	call   801032aa <end_op>
    return -1;
80105f11:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f16:	eb 61                	jmp    80105f79 <sys_chdir+0xa3>
  }
  ilock(ip);
80105f18:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f1b:	89 04 24             	mov    %eax,(%esp)
80105f1e:	e8 51 b9 ff ff       	call   80101874 <ilock>
  if(ip->type != T_DIR){
80105f23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f26:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f2a:	66 83 f8 01          	cmp    $0x1,%ax
80105f2e:	74 17                	je     80105f47 <sys_chdir+0x71>
    iunlockput(ip);
80105f30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f33:	89 04 24             	mov    %eax,(%esp)
80105f36:	e8 bd bb ff ff       	call   80101af8 <iunlockput>
    end_op();
80105f3b:	e8 6a d3 ff ff       	call   801032aa <end_op>
    return -1;
80105f40:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f45:	eb 32                	jmp    80105f79 <sys_chdir+0xa3>
  }
  iunlock(ip);
80105f47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f4a:	89 04 24             	mov    %eax,(%esp)
80105f4d:	e8 70 ba ff ff       	call   801019c2 <iunlock>
  iput(proc->cwd);
80105f52:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105f58:	8b 40 68             	mov    0x68(%eax),%eax
80105f5b:	89 04 24             	mov    %eax,(%esp)
80105f5e:	e8 c4 ba ff ff       	call   80101a27 <iput>
  end_op();
80105f63:	e8 42 d3 ff ff       	call   801032aa <end_op>
  proc->cwd = ip;
80105f68:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105f6e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f71:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80105f7e:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80105f92:	e8 7f f3 ff ff       	call   80105316 <argstr>
80105f97:	85 c0                	test   %eax,%eax
80105f99:	78 1a                	js     80105fb5 <sys_exec+0x3a>
80105f9b:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80105fa1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fa5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105fac:	e8 d5 f2 ff ff       	call   80105286 <argint>
80105fb1:	85 c0                	test   %eax,%eax
80105fb3:	79 0a                	jns    80105fbf <sys_exec+0x44>
    return -1;
80105fb5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fba:	e9 cc 00 00 00       	jmp    8010608b <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
80105fbf:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105fc6:	00 
80105fc7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105fce:	00 
80105fcf:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80105fd5:	89 04 24             	mov    %eax,(%esp)
80105fd8:	e8 4d ef ff ff       	call   80104f2a <memset>
  for(i=0;; i++){
80105fdd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80105fe4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe7:	83 f8 1f             	cmp    $0x1f,%eax
80105fea:	76 0a                	jbe    80105ff6 <sys_exec+0x7b>
      return -1;
80105fec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ff1:	e9 95 00 00 00       	jmp    8010608b <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105ff6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ff9:	c1 e0 02             	shl    $0x2,%eax
80105ffc:	89 c2                	mov    %eax,%edx
80105ffe:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80106004:	01 c2                	add    %eax,%edx
80106006:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
8010600c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106010:	89 14 24             	mov    %edx,(%esp)
80106013:	e8 d0 f1 ff ff       	call   801051e8 <fetchint>
80106018:	85 c0                	test   %eax,%eax
8010601a:	79 07                	jns    80106023 <sys_exec+0xa8>
      return -1;
8010601c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106021:	eb 68                	jmp    8010608b <sys_exec+0x110>
    if(uarg == 0){
80106023:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106029:	85 c0                	test   %eax,%eax
8010602b:	75 26                	jne    80106053 <sys_exec+0xd8>
      argv[i] = 0;
8010602d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106030:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106037:	00 00 00 00 
      break;
8010603b:	90                   	nop
    }
...
8010603f:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106045:	89 54 24 04          	mov    %edx,0x4(%esp)
80106049:	89 04 24             	mov    %eax,(%esp)
8010604c:	e8 ab aa ff ff       	call   80100afc <exec>
80106051:	eb 38                	jmp    8010608b <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106056:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010605d:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106063:	01 c2                	add    %eax,%edx
80106065:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010606b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010606f:	89 04 24             	mov    %eax,(%esp)
80106072:	e8 ab f1 ff ff       	call   80105222 <fetchstr>
80106077:	85 c0                	test   %eax,%eax
80106079:	79 07                	jns    80106082 <sys_exec+0x107>
      return -1;
8010607b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106080:	eb 09                	jmp    8010608b <sys_exec+0x110>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106082:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80106086:	e9 59 ff ff ff       	jmp    80105fe4 <sys_exec+0x69>
  return exec(path, argv);
}
8010608b:	c9                   	leave  
8010608c:	c3                   	ret    
...
80106090:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106093:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
8010609a:	00 
8010609b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010609e:	89 44 24 04          	mov    %eax,0x4(%esp)
801060a2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801060a9:	e8 06 f2 ff ff       	call   801052b4 <argptr>
801060ae:	85 c0                	test   %eax,%eax
801060b0:	79 0a                	jns    801060bc <sys_pipe+0x2f>
    return -1;
801060b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060b7:	e9 9b 00 00 00       	jmp    80106157 <sys_pipe+0xca>
...
801060c9:	e8 72 dc ff ff       	call   80103d40 <pipealloc>
801060ce:	85 c0                	test   %eax,%eax
801060d0:	79 07                	jns    801060d9 <sys_pipe+0x4c>
    return -1;
801060d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060d7:	eb 7e                	jmp    80106157 <sys_pipe+0xca>
  fd0 = -1;
801060d9:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801060e0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801060e3:	89 04 24             	mov    %eax,(%esp)
801060e6:	e8 66 f3 ff ff       	call   80105451 <fdalloc>
801060eb:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060ee:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060f2:	78 14                	js     80106108 <sys_pipe+0x7b>
801060f4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801060f7:	89 04 24             	mov    %eax,(%esp)
801060fa:	e8 52 f3 ff ff       	call   80105451 <fdalloc>
801060ff:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106102:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106106:	79 37                	jns    8010613f <sys_pipe+0xb2>
    if(fd0 >= 0)
80106108:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010610c:	78 14                	js     80106122 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010610e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106114:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106117:	83 c2 08             	add    $0x8,%edx
8010611a:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106121:	00 
    fileclose(rf);
80106122:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106125:	89 04 24             	mov    %eax,(%esp)
80106128:	e8 a3 ae ff ff       	call   80100fd0 <fileclose>
    fileclose(wf);
8010612d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106130:	89 04 24             	mov    %eax,(%esp)
80106133:	e8 98 ae ff ff       	call   80100fd0 <fileclose>
    return -1;
80106138:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010613d:	eb 18                	jmp    80106157 <sys_pipe+0xca>
  }
  fd[0] = fd0;
...
8010614a:	8d 50 04             	lea    0x4(%eax),%edx
8010614d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106150:	89 02                	mov    %eax,(%edx)
  return 0;
80106152:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106157:	c9                   	leave  
80106158:	c3                   	ret    
80106159:	00 00                	add    %al,(%eax)
	...
...
8010615f:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106162:	e8 8f e2 ff ff       	call   801043f6 <fork>
}
80106167:	c9                   	leave  
80106168:	c3                   	ret    
...
8010616c:	83 ec 08             	sub    $0x8,%esp
  exit();
8010616f:	e8 80 e4 ff ff       	call   801045f4 <exit>
...
8010617e:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106181:	e8 93 e5 ff ff       	call   80104719 <wait>
}
80106186:	c9                   	leave  
80106187:	c3                   	ret    
...
8010618b:	83 ec 28             	sub    $0x28,%esp
  int pid;

  if(argint(0, &pid) < 0)
8010618e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106191:	89 44 24 04          	mov    %eax,0x4(%esp)
80106195:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010619c:	e8 e5 f0 ff ff       	call   80105286 <argint>
801061a1:	85 c0                	test   %eax,%eax
801061a3:	79 07                	jns    801061ac <sys_kill+0x24>
    return -1;
801061a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061aa:	eb 0b                	jmp    801061b7 <sys_kill+0x2f>
  return kill(pid);
801061ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061af:	89 04 24             	mov    %eax,(%esp)
801061b2:	e8 44 e9 ff ff       	call   80104afb <kill>
}
801061b7:	c9                   	leave  
801061b8:	c3                   	ret    
...
801061c2:	8b 40 10             	mov    0x10(%eax),%eax
}
801061c5:	5d                   	pop    %ebp
801061c6:	c3                   	ret    
...
801061ca:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
801061cd:	8d 45 f0             	lea    -0x10(%ebp),%eax
801061d0:	89 44 24 04          	mov    %eax,0x4(%esp)
801061d4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061db:	e8 a6 f0 ff ff       	call   80105286 <argint>
801061e0:	85 c0                	test   %eax,%eax
801061e2:	79 07                	jns    801061eb <sys_sbrk+0x24>
    return -1;
801061e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061e9:	eb 24                	jmp    8010620f <sys_sbrk+0x48>
  addr = proc->sz;
801061eb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
801061fc:	e8 50 e1 ff ff       	call   80104351 <growproc>
80106201:	85 c0                	test   %eax,%eax
80106203:	79 07                	jns    8010620c <sys_sbrk+0x45>
    return -1;
80106205:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010620a:	eb 03                	jmp    8010620f <sys_sbrk+0x48>
  return addr;
...
80106225:	e8 5c f0 ff ff       	call   80105286 <argint>
8010622a:	85 c0                	test   %eax,%eax
8010622c:	79 07                	jns    80106235 <sys_sleep+0x24>
    return -1;
8010622e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106233:	eb 6c                	jmp    801062a1 <sys_sleep+0x90>
  acquire(&tickslock);
80106235:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
8010623c:	e8 9a ea ff ff       	call   80104cdb <acquire>
  ticks0 = ticks;
80106241:	a1 e0 54 11 80       	mov    0x801154e0,%eax
80106246:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106249:	eb 34                	jmp    8010627f <sys_sleep+0x6e>
    if(proc->killed){
8010624b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106251:	8b 40 24             	mov    0x24(%eax),%eax
80106254:	85 c0                	test   %eax,%eax
80106256:	74 13                	je     8010626b <sys_sleep+0x5a>
      release(&tickslock);
80106258:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
8010625f:	e8 d9 ea ff ff       	call   80104d3d <release>
      return -1;
80106264:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106269:	eb 36                	jmp    801062a1 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
8010626b:	c7 44 24 04 a0 4c 11 	movl   $0x80114ca0,0x4(%esp)
80106272:	80 
80106273:	c7 04 24 e0 54 11 80 	movl   $0x801154e0,(%esp)
8010627a:	e8 75 e7 ff ff       	call   801049f4 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010627f:	a1 e0 54 11 80       	mov    0x801154e0,%eax
80106284:	89 c2                	mov    %eax,%edx
80106286:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106289:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010628c:	39 c2                	cmp    %eax,%edx
8010628e:	72 bb                	jb     8010624b <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106290:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
80106297:	e8 a1 ea ff ff       	call   80104d3d <release>
  return 0;
...
801062a6:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801062a9:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
801062b0:	e8 26 ea ff ff       	call   80104cdb <acquire>
  xticks = ticks;
801062b5:	a1 e0 54 11 80       	mov    0x801154e0,%eax
801062ba:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801062bd:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
801062c4:	e8 74 ea ff ff       	call   80104d3d <release>
  return xticks;
...
801062d7:	8b 40 14             	mov    0x14(%eax),%eax
801062da:	85 c0                	test   %eax,%eax
801062dc:	75 07                	jne    801062e5 <sys_getppid+0x17>
		return 0;
801062de:	b8 00 00 00 00       	mov    $0x0,%eax
801062e3:	eb 0c                	jmp    801062f1 <sys_getppid+0x23>
...
801062f6:	83 ec 28             	sub    $0x28,%esp
	...
	int addr = 0;
801062f9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int addr1 = 0;
80106300:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

	argint(0, &addr);
80106307:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010630a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010630e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106315:	e8 6c ef ff ff       	call   80105286 <argint>
	argint(1, &addr1);
8010631a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010631d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106321:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106328:	e8 59 ef ff ff       	call   80105286 <argint>

	proc->cStack = (char*)addr;
8010632d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106333:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106336:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
	proc->wrapper = (uint)addr1;
8010633c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106342:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106345:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)

	proc->ctFlag = 1;
8010634b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106351:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
	return fork();
80106358:	e8 99 e0 ff ff       	call   801043f6 <fork>
}
8010635d:	c9                   	leave  
8010635e:	c3                   	ret    
	...
...
8010636c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
...
80106384:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
8010638b:	00 
8010638c:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106393:	e8 c8 ff ff ff       	call   80106360 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106398:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
8010639f:	00 
801063a0:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801063a7:	e8 b4 ff ff ff       	call   80106360 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801063ac:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801063b3:	00 
801063b4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801063bb:	e8 a0 ff ff ff       	call   80106360 <outb>
  picenable(IRQ_TIMER);
801063c0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063c7:	e8 fd d7 ff ff       	call   80103bc9 <picenable>
}
801063cc:	c9                   	leave  
801063cd:	c3                   	ret    
	...
...
801063d1:	06                   	push   %es
  pushl %fs
801063d2:	0f a0                	push   %fs
  pushl %gs
801063d4:	0f a8                	push   %gs
  pushal
801063d6:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801063d7:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801063db:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801063dd:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801063df:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801063e3:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801063e5:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801063e7:	54                   	push   %esp
  call trap
801063e8:	e8 de 01 00 00       	call   801065cb <trap>
  addl $4, %esp
801063ed:	83 c4 04             	add    $0x4,%esp
...
801063f0:	61                   	popa   
  popl %gs
801063f1:	0f a9                	pop    %gs
  popl %fs
801063f3:	0f a1                	pop    %fs
  popl %es
801063f5:	07                   	pop    %es
  popl %ds
801063f6:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801063f7:	83 c4 08             	add    $0x8,%esp
  iret
801063fa:	cf                   	iret   
	...
...
801063ff:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106402:	8b 45 0c             	mov    0xc(%ebp),%eax
80106405:	83 e8 01             	sub    $0x1,%eax
80106408:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010640c:	8b 45 08             	mov    0x8(%ebp),%eax
8010640f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106413:	8b 45 08             	mov    0x8(%ebp),%eax
80106416:	c1 e8 10             	shr    $0x10,%eax
80106419:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
8010641d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106420:	0f 01 18             	lidtl  (%eax)
}
80106423:	c9                   	leave  
80106424:	c3                   	ret    
...
80106429:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
8010642c:	0f 20 d3             	mov    %cr2,%ebx
8010642f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106432:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106448:	e9 c3 00 00 00       	jmp    80106510 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010644d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106450:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
80106457:	89 c2                	mov    %eax,%edx
80106459:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010645c:	66 89 14 c5 e0 4c 11 	mov    %dx,-0x7feeb320(,%eax,8)
80106463:	80 
80106464:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106467:	66 c7 04 c5 e2 4c 11 	movw   $0x8,-0x7feeb31e(,%eax,8)
8010646e:	80 08 00 
80106471:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106474:	0f b6 14 c5 e4 4c 11 	movzbl -0x7feeb31c(,%eax,8),%edx
8010647b:	80 
8010647c:	83 e2 e0             	and    $0xffffffe0,%edx
8010647f:	88 14 c5 e4 4c 11 80 	mov    %dl,-0x7feeb31c(,%eax,8)
80106486:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106489:	0f b6 14 c5 e4 4c 11 	movzbl -0x7feeb31c(,%eax,8),%edx
80106490:	80 
80106491:	83 e2 1f             	and    $0x1f,%edx
80106494:	88 14 c5 e4 4c 11 80 	mov    %dl,-0x7feeb31c(,%eax,8)
8010649b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010649e:	0f b6 14 c5 e5 4c 11 	movzbl -0x7feeb31b(,%eax,8),%edx
801064a5:	80 
801064a6:	83 e2 f0             	and    $0xfffffff0,%edx
801064a9:	83 ca 0e             	or     $0xe,%edx
801064ac:	88 14 c5 e5 4c 11 80 	mov    %dl,-0x7feeb31b(,%eax,8)
801064b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064b6:	0f b6 14 c5 e5 4c 11 	movzbl -0x7feeb31b(,%eax,8),%edx
801064bd:	80 
801064be:	83 e2 ef             	and    $0xffffffef,%edx
801064c1:	88 14 c5 e5 4c 11 80 	mov    %dl,-0x7feeb31b(,%eax,8)
801064c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064cb:	0f b6 14 c5 e5 4c 11 	movzbl -0x7feeb31b(,%eax,8),%edx
801064d2:	80 
801064d3:	83 e2 9f             	and    $0xffffff9f,%edx
801064d6:	88 14 c5 e5 4c 11 80 	mov    %dl,-0x7feeb31b(,%eax,8)
801064dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e0:	0f b6 14 c5 e5 4c 11 	movzbl -0x7feeb31b(,%eax,8),%edx
801064e7:	80 
801064e8:	83 ca 80             	or     $0xffffff80,%edx
801064eb:	88 14 c5 e5 4c 11 80 	mov    %dl,-0x7feeb31b(,%eax,8)
801064f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f5:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
801064fc:	c1 e8 10             	shr    $0x10,%eax
801064ff:	89 c2                	mov    %eax,%edx
80106501:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106504:	66 89 14 c5 e6 4c 11 	mov    %dx,-0x7feeb31a(,%eax,8)
8010650b:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
8010650c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106510:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106517:	0f 8e 30 ff ff ff    	jle    8010644d <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010651d:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
80106522:	66 a3 e0 4e 11 80    	mov    %ax,0x80114ee0
80106528:	66 c7 05 e2 4e 11 80 	movw   $0x8,0x80114ee2
8010652f:	08 00 
80106531:	0f b6 05 e4 4e 11 80 	movzbl 0x80114ee4,%eax
80106538:	83 e0 e0             	and    $0xffffffe0,%eax
8010653b:	a2 e4 4e 11 80       	mov    %al,0x80114ee4
80106540:	0f b6 05 e4 4e 11 80 	movzbl 0x80114ee4,%eax
80106547:	83 e0 1f             	and    $0x1f,%eax
8010654a:	a2 e4 4e 11 80       	mov    %al,0x80114ee4
8010654f:	0f b6 05 e5 4e 11 80 	movzbl 0x80114ee5,%eax
80106556:	83 c8 0f             	or     $0xf,%eax
80106559:	a2 e5 4e 11 80       	mov    %al,0x80114ee5
8010655e:	0f b6 05 e5 4e 11 80 	movzbl 0x80114ee5,%eax
80106565:	83 e0 ef             	and    $0xffffffef,%eax
80106568:	a2 e5 4e 11 80       	mov    %al,0x80114ee5
8010656d:	0f b6 05 e5 4e 11 80 	movzbl 0x80114ee5,%eax
80106574:	83 c8 60             	or     $0x60,%eax
80106577:	a2 e5 4e 11 80       	mov    %al,0x80114ee5
8010657c:	0f b6 05 e5 4e 11 80 	movzbl 0x80114ee5,%eax
80106583:	83 c8 80             	or     $0xffffff80,%eax
80106586:	a2 e5 4e 11 80       	mov    %al,0x80114ee5
8010658b:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
80106590:	c1 e8 10             	shr    $0x10,%eax
80106593:	66 a3 e6 4e 11 80    	mov    %ax,0x80114ee6
  
  initlock(&tickslock, "time");
80106599:	c7 44 24 04 b4 87 10 	movl   $0x801087b4,0x4(%esp)
801065a0:	80 
801065a1:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
801065a8:	e8 0d e7 ff ff       	call   80104cba <initlock>
}
801065ad:	c9                   	leave  
801065ae:	c3                   	ret    
...
801065b2:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801065b5:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801065bc:	00 
801065bd:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
801065c4:	e8 33 fe ff ff       	call   801063fc <lidt>
}
801065c9:	c9                   	leave  
801065ca:	c3                   	ret    
...
801065d1:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801065d4:	8b 45 08             	mov    0x8(%ebp),%eax
801065d7:	8b 40 30             	mov    0x30(%eax),%eax
801065da:	83 f8 40             	cmp    $0x40,%eax
801065dd:	75 3e                	jne    8010661d <trap+0x52>
    if(proc->killed)
801065df:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065e5:	8b 40 24             	mov    0x24(%eax),%eax
801065e8:	85 c0                	test   %eax,%eax
801065ea:	74 05                	je     801065f1 <trap+0x26>
      exit();
801065ec:	e8 03 e0 ff ff       	call   801045f4 <exit>
    proc->tf = tf;
801065f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065f7:	8b 55 08             	mov    0x8(%ebp),%edx
801065fa:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801065fd:	e8 4b ed ff ff       	call   8010534d <syscall>
    if(proc->killed)
80106602:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106608:	8b 40 24             	mov    0x24(%eax),%eax
8010660b:	85 c0                	test   %eax,%eax
8010660d:	0f 84 34 02 00 00    	je     80106847 <trap+0x27c>
      exit();
80106613:	e8 dc df ff ff       	call   801045f4 <exit>
    return;
80106618:	e9 2a 02 00 00       	jmp    80106847 <trap+0x27c>
  }
...
80106629:	0f 87 bc 00 00 00    	ja     801066eb <trap+0x120>
8010662f:	8b 04 85 5c 88 10 80 	mov    -0x7fef77a4(,%eax,4),%eax
80106636:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106638:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010663e:	0f b6 00             	movzbl (%eax),%eax
80106641:	84 c0                	test   %al,%al
80106643:	75 31                	jne    80106676 <trap+0xab>
      acquire(&tickslock);
80106645:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
8010664c:	e8 8a e6 ff ff       	call   80104cdb <acquire>
      ticks++;
80106651:	a1 e0 54 11 80       	mov    0x801154e0,%eax
80106656:	83 c0 01             	add    $0x1,%eax
80106659:	a3 e0 54 11 80       	mov    %eax,0x801154e0
      wakeup(&ticks);
8010665e:	c7 04 24 e0 54 11 80 	movl   $0x801154e0,(%esp)
80106665:	e8 66 e4 ff ff       	call   80104ad0 <wakeup>
      release(&tickslock);
8010666a:	c7 04 24 a0 4c 11 80 	movl   $0x80114ca0,(%esp)
80106671:	e8 c7 e6 ff ff       	call   80104d3d <release>
    }
    lapiceoi();
80106676:	e8 7a c8 ff ff       	call   80102ef5 <lapiceoi>
    break;
8010667b:	e9 41 01 00 00       	jmp    801067c1 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106680:	e8 78 c0 ff ff       	call   801026fd <ideintr>
    lapiceoi();
80106685:	e8 6b c8 ff ff       	call   80102ef5 <lapiceoi>
    break;
8010668a:	e9 32 01 00 00       	jmp    801067c1 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010668f:	e8 3f c6 ff ff       	call   80102cd3 <kbdintr>
    lapiceoi();
80106694:	e8 5c c8 ff ff       	call   80102ef5 <lapiceoi>
    break;
80106699:	e9 23 01 00 00       	jmp    801067c1 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010669e:	e8 a9 03 00 00       	call   80106a4c <uartintr>
    lapiceoi();
801066a3:	e8 4d c8 ff ff       	call   80102ef5 <lapiceoi>
    break;
801066a8:	e9 14 01 00 00       	jmp    801067c1 <trap+0x1f6>
  case T_IRQ0 + 7:
...
801066ad:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066b0:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
801066b6:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066ba:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
801066c3:	0f b6 00             	movzbl (%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801066c6:	0f b6 c0             	movzbl %al,%eax
801066c9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801066cd:	89 54 24 08          	mov    %edx,0x8(%esp)
801066d1:	89 44 24 04          	mov    %eax,0x4(%esp)
801066d5:	c7 04 24 bc 87 10 80 	movl   $0x801087bc,(%esp)
801066dc:	e8 c0 9c ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801066e1:	e8 0f c8 ff ff       	call   80102ef5 <lapiceoi>
    break;
801066e6:	e9 d6 00 00 00       	jmp    801067c1 <trap+0x1f6>
...
801066f3:	74 11                	je     80106706 <trap+0x13b>
801066f5:	8b 45 08             	mov    0x8(%ebp),%eax
801066f8:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801066fc:	0f b7 c0             	movzwl %ax,%eax
801066ff:	83 e0 03             	and    $0x3,%eax
80106702:	85 c0                	test   %eax,%eax
80106704:	75 46                	jne    8010674c <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106706:	e8 1a fd ff ff       	call   80106425 <rcr2>
...
8010670b:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010670e:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106711:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106718:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010671b:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010671e:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106721:	8b 52 30             	mov    0x30(%edx),%edx
80106724:	89 44 24 10          	mov    %eax,0x10(%esp)
80106728:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010672c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106730:	89 54 24 04          	mov    %edx,0x4(%esp)
80106734:	c7 04 24 e0 87 10 80 	movl   $0x801087e0,(%esp)
8010673b:	e8 61 9c ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106740:	c7 04 24 12 88 10 80 	movl   $0x80108812,(%esp)
80106747:	e8 f1 9d ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010674c:	e8 d4 fc ff ff       	call   80106425 <rcr2>
...
80106753:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106756:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
8010675f:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106762:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106765:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106768:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010676b:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010676e:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106771:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106777:	83 c0 6c             	add    $0x6c,%eax
8010677a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010677d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106783:	8b 40 10             	mov    0x10(%eax),%eax
80106786:	89 54 24 1c          	mov    %edx,0x1c(%esp)
8010678a:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010678e:	89 74 24 14          	mov    %esi,0x14(%esp)
80106792:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106796:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010679a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010679d:	89 54 24 08          	mov    %edx,0x8(%esp)
801067a1:	89 44 24 04          	mov    %eax,0x4(%esp)
801067a5:	c7 04 24 18 88 10 80 	movl   $0x80108818,(%esp)
801067ac:	e8 f0 9b ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801067b1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067b7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801067be:	eb 01                	jmp    801067c1 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801067c9:	74 24                	je     801067ef <trap+0x224>
801067cb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067d1:	8b 40 24             	mov    0x24(%eax),%eax
801067d4:	85 c0                	test   %eax,%eax
801067d6:	74 17                	je     801067ef <trap+0x224>
801067d8:	8b 45 08             	mov    0x8(%ebp),%eax
801067db:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801067df:	0f b7 c0             	movzwl %ax,%eax
801067e2:	83 e0 03             	and    $0x3,%eax
801067e5:	83 f8 03             	cmp    $0x3,%eax
801067e8:	75 05                	jne    801067ef <trap+0x224>
    exit();
801067ea:	e8 05 de ff ff       	call   801045f4 <exit>
...
801067f7:	74 1e                	je     80106817 <trap+0x24c>
801067f9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067ff:	8b 40 0c             	mov    0xc(%eax),%eax
80106802:	83 f8 04             	cmp    $0x4,%eax
80106805:	75 10                	jne    80106817 <trap+0x24c>
80106807:	8b 45 08             	mov    0x8(%ebp),%eax
8010680a:	8b 40 30             	mov    0x30(%eax),%eax
8010680d:	83 f8 20             	cmp    $0x20,%eax
80106810:	75 05                	jne    80106817 <trap+0x24c>
    yield();
80106812:	e8 7f e1 ff ff       	call   80104996 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106817:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010681d:	85 c0                	test   %eax,%eax
8010681f:	74 27                	je     80106848 <trap+0x27d>
80106821:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106827:	8b 40 24             	mov    0x24(%eax),%eax
8010682a:	85 c0                	test   %eax,%eax
8010682c:	74 1a                	je     80106848 <trap+0x27d>
...
8010683b:	83 f8 03             	cmp    $0x3,%eax
8010683e:	75 08                	jne    80106848 <trap+0x27d>
    exit();
80106840:	e8 af dd ff ff       	call   801045f4 <exit>
80106845:	eb 01                	jmp    80106848 <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106848:	83 c4 3c             	add    $0x3c,%esp
8010684b:	5b                   	pop    %ebx
8010684c:	5e                   	pop    %esi
8010684d:	5f                   	pop    %edi
8010684e:	5d                   	pop    %ebp
...
8010685a:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010685e:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106862:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106866:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
8010686a:	ec                   	in     (%dx),%al
8010686b:	89 c3                	mov    %eax,%ebx
8010686d:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106870:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80106874:	83 c4 14             	add    $0x14,%esp
80106877:	5b                   	pop    %ebx
80106878:	5d                   	pop    %ebp
80106879:	c3                   	ret    
...
80106931:	e8 1a ff ff ff       	call   80106850 <inb>
80106936:	3c ff                	cmp    $0xff,%al
80106938:	74 6c                	je     801069a6 <uartinit+0x10e>
    return;
  uart = 1;
8010693a:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106941:	00 00 00 
...
8010694b:	e8 00 ff ff ff       	call   80106850 <inb>
  inb(COM1+0);
80106950:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106957:	e8 f4 fe ff ff       	call   80106850 <inb>
  picenable(IRQ_COM1);
8010695c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106963:	e8 61 d2 ff ff       	call   80103bc9 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106968:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010696f:	00 
80106970:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106977:	e8 06 c0 ff ff       	call   80102982 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010697c:	c7 45 f4 dc 88 10 80 	movl   $0x801088dc,-0xc(%ebp)
80106983:	eb 15                	jmp    8010699a <uartinit+0x102>
    uartputc(*p);
80106985:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106988:	0f b6 00             	movzbl (%eax),%eax
8010698b:	0f be c0             	movsbl %al,%eax
8010698e:	89 04 24             	mov    %eax,(%esp)
80106991:	e8 13 00 00 00       	call   801069a9 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106996:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010699a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010699d:	0f b6 00             	movzbl (%eax),%eax
801069a0:	84 c0                	test   %al,%al
801069a2:	75 e1                	jne    80106985 <uartinit+0xed>
801069a4:	eb 01                	jmp    801069a7 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
801069ac:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801069af:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
801069b4:	85 c0                	test   %eax,%eax
801069b6:	74 4d                	je     80106a05 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801069b8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801069bf:	eb 10                	jmp    801069d1 <uartputc+0x28>
    microdelay(10);
801069c1:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801069c8:	e8 4d c5 ff ff       	call   80102f1a <microdelay>
{
  int i;
...
801069d1:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801069d5:	7f 16                	jg     801069ed <uartputc+0x44>
801069d7:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069de:	e8 6d fe ff ff       	call   80106850 <inb>
801069e3:	0f b6 c0             	movzbl %al,%eax
801069e6:	83 e0 20             	and    $0x20,%eax
801069e9:	85 c0                	test   %eax,%eax
801069eb:	74 d4                	je     801069c1 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
801069ed:	8b 45 08             	mov    0x8(%ebp),%eax
801069f0:	0f b6 c0             	movzbl %al,%eax
801069f3:	89 44 24 04          	mov    %eax,0x4(%esp)
801069f7:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069fe:	e8 77 fe ff ff       	call   8010687a <outb>
80106a03:	eb 01                	jmp    80106a06 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80106a0b:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106a0e:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106a13:	85 c0                	test   %eax,%eax
80106a15:	75 07                	jne    80106a1e <uartgetc+0x16>
    return -1;
80106a17:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a1c:	eb 2c                	jmp    80106a4a <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106a1e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a25:	e8 26 fe ff ff       	call   80106850 <inb>
80106a2a:	0f b6 c0             	movzbl %al,%eax
80106a2d:	83 e0 01             	and    $0x1,%eax
80106a30:	85 c0                	test   %eax,%eax
80106a32:	75 07                	jne    80106a3b <uartgetc+0x33>
    return -1;
80106a34:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a39:	eb 0f                	jmp    80106a4a <uartgetc+0x42>
  return inb(COM1+0);
80106a3b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106a42:	e8 09 fe ff ff       	call   80106850 <inb>
80106a47:	0f b6 c0             	movzbl %al,%eax
}
80106a4a:	c9                   	leave  
80106a4b:	c3                   	ret    
...
80106a52:	c7 04 24 08 6a 10 80 	movl   $0x80106a08,(%esp)
80106a59:	e8 4f 9d ff ff       	call   801007ad <consoleintr>
}
80106a5e:	c9                   	leave  
80106a5f:	c3                   	ret    
...
80106a62:	6a 00                	push   $0x0
  jmp alltraps
80106a64:	e9 67 f9 ff ff       	jmp    801063d0 <alltraps>
...
80106a69:	6a 00                	push   $0x0
  pushl $1
80106a6b:	6a 01                	push   $0x1
  jmp alltraps
80106a6d:	e9 5e f9 ff ff       	jmp    801063d0 <alltraps>
...
80106a72:	6a 00                	push   $0x0
  pushl $2
80106a74:	6a 02                	push   $0x2
  jmp alltraps
80106a76:	e9 55 f9 ff ff       	jmp    801063d0 <alltraps>
...
80106a7b:	6a 00                	push   $0x0
  pushl $3
80106a7d:	6a 03                	push   $0x3
  jmp alltraps
80106a7f:	e9 4c f9 ff ff       	jmp    801063d0 <alltraps>
...
80106a86:	6a 04                	push   $0x4
  jmp alltraps
80106a88:	e9 43 f9 ff ff       	jmp    801063d0 <alltraps>
...
80106a8d:	6a 00                	push   $0x0
  pushl $5
80106a8f:	6a 05                	push   $0x5
  jmp alltraps
80106a91:	e9 3a f9 ff ff       	jmp    801063d0 <alltraps>
...
80106a96:	6a 00                	push   $0x0
  pushl $6
80106a98:	6a 06                	push   $0x6
  jmp alltraps
80106a9a:	e9 31 f9 ff ff       	jmp    801063d0 <alltraps>
...
80106a9f:	6a 00                	push   $0x0
  pushl $7
80106aa1:	6a 07                	push   $0x7
  jmp alltraps
80106aa3:	e9 28 f9 ff ff       	jmp    801063d0 <alltraps>

80106aa8 <vector8>:
.globl vector8
vector8:
  pushl $8
80106aa8:	6a 08                	push   $0x8
  jmp alltraps
80106aaa:	e9 21 f9 ff ff       	jmp    801063d0 <alltraps>
...
80106aaf:	6a 00                	push   $0x0
  pushl $9
80106ab1:	6a 09                	push   $0x9
  jmp alltraps
80106ab3:	e9 18 f9 ff ff       	jmp    801063d0 <alltraps>

80106ab8 <vector10>:
.globl vector10
vector10:
  pushl $10
80106ab8:	6a 0a                	push   $0xa
  jmp alltraps
80106aba:	e9 11 f9 ff ff       	jmp    801063d0 <alltraps>

80106abf <vector11>:
.globl vector11
vector11:
  pushl $11
80106abf:	6a 0b                	push   $0xb
  jmp alltraps
80106ac1:	e9 0a f9 ff ff       	jmp    801063d0 <alltraps>

80106ac6 <vector12>:
.globl vector12
vector12:
  pushl $12
80106ac6:	6a 0c                	push   $0xc
  jmp alltraps
80106ac8:	e9 03 f9 ff ff       	jmp    801063d0 <alltraps>

80106acd <vector13>:
.globl vector13
vector13:
  pushl $13
80106acd:	6a 0d                	push   $0xd
  jmp alltraps
80106acf:	e9 fc f8 ff ff       	jmp    801063d0 <alltraps>

80106ad4 <vector14>:
.globl vector14
vector14:
  pushl $14
80106ad4:	6a 0e                	push   $0xe
  jmp alltraps
80106ad6:	e9 f5 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106adb:	6a 00                	push   $0x0
  pushl $15
80106add:	6a 0f                	push   $0xf
  jmp alltraps
80106adf:	e9 ec f8 ff ff       	jmp    801063d0 <alltraps>
...
80106ae4:	6a 00                	push   $0x0
  pushl $16
80106ae6:	6a 10                	push   $0x10
  jmp alltraps
80106ae8:	e9 e3 f8 ff ff       	jmp    801063d0 <alltraps>

80106aed <vector17>:
.globl vector17
vector17:
  pushl $17
80106aed:	6a 11                	push   $0x11
  jmp alltraps
80106aef:	e9 dc f8 ff ff       	jmp    801063d0 <alltraps>
...
80106af4:	6a 00                	push   $0x0
  pushl $18
80106af6:	6a 12                	push   $0x12
  jmp alltraps
80106af8:	e9 d3 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106afd:	6a 00                	push   $0x0
  pushl $19
80106aff:	6a 13                	push   $0x13
  jmp alltraps
80106b01:	e9 ca f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b06:	6a 00                	push   $0x0
  pushl $20
80106b08:	6a 14                	push   $0x14
  jmp alltraps
80106b0a:	e9 c1 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b0f:	6a 00                	push   $0x0
  pushl $21
80106b11:	6a 15                	push   $0x15
  jmp alltraps
80106b13:	e9 b8 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b18:	6a 00                	push   $0x0
  pushl $22
80106b1a:	6a 16                	push   $0x16
  jmp alltraps
80106b1c:	e9 af f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b21:	6a 00                	push   $0x0
  pushl $23
80106b23:	6a 17                	push   $0x17
  jmp alltraps
80106b25:	e9 a6 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b2a:	6a 00                	push   $0x0
  pushl $24
80106b2c:	6a 18                	push   $0x18
  jmp alltraps
80106b2e:	e9 9d f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b33:	6a 00                	push   $0x0
  pushl $25
80106b35:	6a 19                	push   $0x19
  jmp alltraps
80106b37:	e9 94 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b3c:	6a 00                	push   $0x0
  pushl $26
80106b3e:	6a 1a                	push   $0x1a
  jmp alltraps
80106b40:	e9 8b f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b45:	6a 00                	push   $0x0
  pushl $27
80106b47:	6a 1b                	push   $0x1b
  jmp alltraps
80106b49:	e9 82 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b4e:	6a 00                	push   $0x0
  pushl $28
80106b50:	6a 1c                	push   $0x1c
  jmp alltraps
80106b52:	e9 79 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b57:	6a 00                	push   $0x0
  pushl $29
80106b59:	6a 1d                	push   $0x1d
  jmp alltraps
80106b5b:	e9 70 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b60:	6a 00                	push   $0x0
  pushl $30
80106b62:	6a 1e                	push   $0x1e
  jmp alltraps
80106b64:	e9 67 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b69:	6a 00                	push   $0x0
  pushl $31
80106b6b:	6a 1f                	push   $0x1f
  jmp alltraps
80106b6d:	e9 5e f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b72:	6a 00                	push   $0x0
  pushl $32
80106b74:	6a 20                	push   $0x20
  jmp alltraps
80106b76:	e9 55 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b7b:	6a 00                	push   $0x0
  pushl $33
80106b7d:	6a 21                	push   $0x21
  jmp alltraps
80106b7f:	e9 4c f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b84:	6a 00                	push   $0x0
  pushl $34
80106b86:	6a 22                	push   $0x22
  jmp alltraps
80106b88:	e9 43 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b8d:	6a 00                	push   $0x0
  pushl $35
80106b8f:	6a 23                	push   $0x23
  jmp alltraps
80106b91:	e9 3a f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b96:	6a 00                	push   $0x0
  pushl $36
80106b98:	6a 24                	push   $0x24
  jmp alltraps
80106b9a:	e9 31 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106b9f:	6a 00                	push   $0x0
  pushl $37
80106ba1:	6a 25                	push   $0x25
  jmp alltraps
80106ba3:	e9 28 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106ba8:	6a 00                	push   $0x0
  pushl $38
80106baa:	6a 26                	push   $0x26
  jmp alltraps
80106bac:	e9 1f f8 ff ff       	jmp    801063d0 <alltraps>
...
80106bb1:	6a 00                	push   $0x0
  pushl $39
80106bb3:	6a 27                	push   $0x27
  jmp alltraps
80106bb5:	e9 16 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106bba:	6a 00                	push   $0x0
  pushl $40
80106bbc:	6a 28                	push   $0x28
  jmp alltraps
80106bbe:	e9 0d f8 ff ff       	jmp    801063d0 <alltraps>
...
80106bc3:	6a 00                	push   $0x0
  pushl $41
80106bc5:	6a 29                	push   $0x29
  jmp alltraps
80106bc7:	e9 04 f8 ff ff       	jmp    801063d0 <alltraps>
...
80106bcc:	6a 00                	push   $0x0
  pushl $42
80106bce:	6a 2a                	push   $0x2a
  jmp alltraps
80106bd0:	e9 fb f7 ff ff       	jmp    801063d0 <alltraps>
...
80106bd5:	6a 00                	push   $0x0
  pushl $43
80106bd7:	6a 2b                	push   $0x2b
  jmp alltraps
80106bd9:	e9 f2 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106bde:	6a 00                	push   $0x0
  pushl $44
80106be0:	6a 2c                	push   $0x2c
  jmp alltraps
80106be2:	e9 e9 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106be7:	6a 00                	push   $0x0
  pushl $45
80106be9:	6a 2d                	push   $0x2d
  jmp alltraps
80106beb:	e9 e0 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106bf0:	6a 00                	push   $0x0
  pushl $46
80106bf2:	6a 2e                	push   $0x2e
  jmp alltraps
80106bf4:	e9 d7 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106bf9:	6a 00                	push   $0x0
  pushl $47
80106bfb:	6a 2f                	push   $0x2f
  jmp alltraps
80106bfd:	e9 ce f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c02:	6a 00                	push   $0x0
  pushl $48
80106c04:	6a 30                	push   $0x30
  jmp alltraps
80106c06:	e9 c5 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c0b:	6a 00                	push   $0x0
  pushl $49
80106c0d:	6a 31                	push   $0x31
  jmp alltraps
80106c0f:	e9 bc f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c14:	6a 00                	push   $0x0
  pushl $50
80106c16:	6a 32                	push   $0x32
  jmp alltraps
80106c18:	e9 b3 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c1d:	6a 00                	push   $0x0
  pushl $51
80106c1f:	6a 33                	push   $0x33
  jmp alltraps
80106c21:	e9 aa f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c26:	6a 00                	push   $0x0
  pushl $52
80106c28:	6a 34                	push   $0x34
  jmp alltraps
80106c2a:	e9 a1 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c2f:	6a 00                	push   $0x0
  pushl $53
80106c31:	6a 35                	push   $0x35
  jmp alltraps
80106c33:	e9 98 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c38:	6a 00                	push   $0x0
  pushl $54
80106c3a:	6a 36                	push   $0x36
  jmp alltraps
80106c3c:	e9 8f f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c41:	6a 00                	push   $0x0
  pushl $55
80106c43:	6a 37                	push   $0x37
  jmp alltraps
80106c45:	e9 86 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c4a:	6a 00                	push   $0x0
  pushl $56
80106c4c:	6a 38                	push   $0x38
  jmp alltraps
80106c4e:	e9 7d f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c53:	6a 00                	push   $0x0
  pushl $57
80106c55:	6a 39                	push   $0x39
  jmp alltraps
80106c57:	e9 74 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c5c:	6a 00                	push   $0x0
  pushl $58
80106c5e:	6a 3a                	push   $0x3a
  jmp alltraps
80106c60:	e9 6b f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c65:	6a 00                	push   $0x0
  pushl $59
80106c67:	6a 3b                	push   $0x3b
  jmp alltraps
80106c69:	e9 62 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c6e:	6a 00                	push   $0x0
  pushl $60
80106c70:	6a 3c                	push   $0x3c
  jmp alltraps
80106c72:	e9 59 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c77:	6a 00                	push   $0x0
  pushl $61
80106c79:	6a 3d                	push   $0x3d
  jmp alltraps
80106c7b:	e9 50 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c80:	6a 00                	push   $0x0
  pushl $62
80106c82:	6a 3e                	push   $0x3e
  jmp alltraps
80106c84:	e9 47 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c89:	6a 00                	push   $0x0
  pushl $63
80106c8b:	6a 3f                	push   $0x3f
  jmp alltraps
80106c8d:	e9 3e f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c92:	6a 00                	push   $0x0
  pushl $64
80106c94:	6a 40                	push   $0x40
  jmp alltraps
80106c96:	e9 35 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106c9b:	6a 00                	push   $0x0
  pushl $65
80106c9d:	6a 41                	push   $0x41
  jmp alltraps
80106c9f:	e9 2c f7 ff ff       	jmp    801063d0 <alltraps>
...
80106ca4:	6a 00                	push   $0x0
  pushl $66
80106ca6:	6a 42                	push   $0x42
  jmp alltraps
80106ca8:	e9 23 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106cad:	6a 00                	push   $0x0
  pushl $67
80106caf:	6a 43                	push   $0x43
  jmp alltraps
80106cb1:	e9 1a f7 ff ff       	jmp    801063d0 <alltraps>
...
80106cb6:	6a 00                	push   $0x0
  pushl $68
80106cb8:	6a 44                	push   $0x44
  jmp alltraps
80106cba:	e9 11 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106cbf:	6a 00                	push   $0x0
  pushl $69
80106cc1:	6a 45                	push   $0x45
  jmp alltraps
80106cc3:	e9 08 f7 ff ff       	jmp    801063d0 <alltraps>
...
80106cc8:	6a 00                	push   $0x0
  pushl $70
80106cca:	6a 46                	push   $0x46
  jmp alltraps
80106ccc:	e9 ff f6 ff ff       	jmp    801063d0 <alltraps>
...
80106cd1:	6a 00                	push   $0x0
  pushl $71
80106cd3:	6a 47                	push   $0x47
  jmp alltraps
80106cd5:	e9 f6 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106cda:	6a 00                	push   $0x0
  pushl $72
80106cdc:	6a 48                	push   $0x48
  jmp alltraps
80106cde:	e9 ed f6 ff ff       	jmp    801063d0 <alltraps>
...
80106ce3:	6a 00                	push   $0x0
  pushl $73
80106ce5:	6a 49                	push   $0x49
  jmp alltraps
80106ce7:	e9 e4 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106cec:	6a 00                	push   $0x0
  pushl $74
80106cee:	6a 4a                	push   $0x4a
  jmp alltraps
80106cf0:	e9 db f6 ff ff       	jmp    801063d0 <alltraps>
...
80106cf5:	6a 00                	push   $0x0
  pushl $75
80106cf7:	6a 4b                	push   $0x4b
  jmp alltraps
80106cf9:	e9 d2 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106cfe:	6a 00                	push   $0x0
  pushl $76
80106d00:	6a 4c                	push   $0x4c
  jmp alltraps
80106d02:	e9 c9 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d07:	6a 00                	push   $0x0
  pushl $77
80106d09:	6a 4d                	push   $0x4d
  jmp alltraps
80106d0b:	e9 c0 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d10:	6a 00                	push   $0x0
  pushl $78
80106d12:	6a 4e                	push   $0x4e
  jmp alltraps
80106d14:	e9 b7 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d19:	6a 00                	push   $0x0
  pushl $79
80106d1b:	6a 4f                	push   $0x4f
  jmp alltraps
80106d1d:	e9 ae f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d22:	6a 00                	push   $0x0
  pushl $80
80106d24:	6a 50                	push   $0x50
  jmp alltraps
80106d26:	e9 a5 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d2b:	6a 00                	push   $0x0
  pushl $81
80106d2d:	6a 51                	push   $0x51
  jmp alltraps
80106d2f:	e9 9c f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d34:	6a 00                	push   $0x0
  pushl $82
80106d36:	6a 52                	push   $0x52
  jmp alltraps
80106d38:	e9 93 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d3d:	6a 00                	push   $0x0
  pushl $83
80106d3f:	6a 53                	push   $0x53
  jmp alltraps
80106d41:	e9 8a f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d46:	6a 00                	push   $0x0
  pushl $84
80106d48:	6a 54                	push   $0x54
  jmp alltraps
80106d4a:	e9 81 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d4f:	6a 00                	push   $0x0
  pushl $85
80106d51:	6a 55                	push   $0x55
  jmp alltraps
80106d53:	e9 78 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d58:	6a 00                	push   $0x0
  pushl $86
80106d5a:	6a 56                	push   $0x56
  jmp alltraps
80106d5c:	e9 6f f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d61:	6a 00                	push   $0x0
  pushl $87
80106d63:	6a 57                	push   $0x57
  jmp alltraps
80106d65:	e9 66 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d6a:	6a 00                	push   $0x0
  pushl $88
80106d6c:	6a 58                	push   $0x58
  jmp alltraps
80106d6e:	e9 5d f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d73:	6a 00                	push   $0x0
  pushl $89
80106d75:	6a 59                	push   $0x59
  jmp alltraps
80106d77:	e9 54 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d7c:	6a 00                	push   $0x0
  pushl $90
80106d7e:	6a 5a                	push   $0x5a
  jmp alltraps
80106d80:	e9 4b f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d85:	6a 00                	push   $0x0
  pushl $91
80106d87:	6a 5b                	push   $0x5b
  jmp alltraps
80106d89:	e9 42 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d8e:	6a 00                	push   $0x0
  pushl $92
80106d90:	6a 5c                	push   $0x5c
  jmp alltraps
80106d92:	e9 39 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106d97:	6a 00                	push   $0x0
  pushl $93
80106d99:	6a 5d                	push   $0x5d
  jmp alltraps
80106d9b:	e9 30 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106da0:	6a 00                	push   $0x0
  pushl $94
80106da2:	6a 5e                	push   $0x5e
  jmp alltraps
80106da4:	e9 27 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106da9:	6a 00                	push   $0x0
  pushl $95
80106dab:	6a 5f                	push   $0x5f
  jmp alltraps
80106dad:	e9 1e f6 ff ff       	jmp    801063d0 <alltraps>
...
80106db2:	6a 00                	push   $0x0
  pushl $96
80106db4:	6a 60                	push   $0x60
  jmp alltraps
80106db6:	e9 15 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106dbb:	6a 00                	push   $0x0
  pushl $97
80106dbd:	6a 61                	push   $0x61
  jmp alltraps
80106dbf:	e9 0c f6 ff ff       	jmp    801063d0 <alltraps>
...
80106dc4:	6a 00                	push   $0x0
  pushl $98
80106dc6:	6a 62                	push   $0x62
  jmp alltraps
80106dc8:	e9 03 f6 ff ff       	jmp    801063d0 <alltraps>
...
80106dcd:	6a 00                	push   $0x0
  pushl $99
80106dcf:	6a 63                	push   $0x63
  jmp alltraps
80106dd1:	e9 fa f5 ff ff       	jmp    801063d0 <alltraps>
...
80106dd6:	6a 00                	push   $0x0
  pushl $100
80106dd8:	6a 64                	push   $0x64
  jmp alltraps
80106dda:	e9 f1 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106ddf:	6a 00                	push   $0x0
  pushl $101
80106de1:	6a 65                	push   $0x65
  jmp alltraps
80106de3:	e9 e8 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106de8:	6a 00                	push   $0x0
  pushl $102
80106dea:	6a 66                	push   $0x66
  jmp alltraps
80106dec:	e9 df f5 ff ff       	jmp    801063d0 <alltraps>
...
80106df1:	6a 00                	push   $0x0
  pushl $103
80106df3:	6a 67                	push   $0x67
  jmp alltraps
80106df5:	e9 d6 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106dfa:	6a 00                	push   $0x0
  pushl $104
80106dfc:	6a 68                	push   $0x68
  jmp alltraps
80106dfe:	e9 cd f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e03:	6a 00                	push   $0x0
  pushl $105
80106e05:	6a 69                	push   $0x69
  jmp alltraps
80106e07:	e9 c4 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e0c:	6a 00                	push   $0x0
  pushl $106
80106e0e:	6a 6a                	push   $0x6a
  jmp alltraps
80106e10:	e9 bb f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e15:	6a 00                	push   $0x0
  pushl $107
80106e17:	6a 6b                	push   $0x6b
  jmp alltraps
80106e19:	e9 b2 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e1e:	6a 00                	push   $0x0
  pushl $108
80106e20:	6a 6c                	push   $0x6c
  jmp alltraps
80106e22:	e9 a9 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e27:	6a 00                	push   $0x0
  pushl $109
80106e29:	6a 6d                	push   $0x6d
  jmp alltraps
80106e2b:	e9 a0 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e30:	6a 00                	push   $0x0
  pushl $110
80106e32:	6a 6e                	push   $0x6e
  jmp alltraps
80106e34:	e9 97 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e39:	6a 00                	push   $0x0
  pushl $111
80106e3b:	6a 6f                	push   $0x6f
  jmp alltraps
80106e3d:	e9 8e f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e42:	6a 00                	push   $0x0
  pushl $112
80106e44:	6a 70                	push   $0x70
  jmp alltraps
80106e46:	e9 85 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e4b:	6a 00                	push   $0x0
  pushl $113
80106e4d:	6a 71                	push   $0x71
  jmp alltraps
80106e4f:	e9 7c f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e54:	6a 00                	push   $0x0
  pushl $114
80106e56:	6a 72                	push   $0x72
  jmp alltraps
80106e58:	e9 73 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e5d:	6a 00                	push   $0x0
  pushl $115
80106e5f:	6a 73                	push   $0x73
  jmp alltraps
80106e61:	e9 6a f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e66:	6a 00                	push   $0x0
  pushl $116
80106e68:	6a 74                	push   $0x74
  jmp alltraps
80106e6a:	e9 61 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e6f:	6a 00                	push   $0x0
  pushl $117
80106e71:	6a 75                	push   $0x75
  jmp alltraps
80106e73:	e9 58 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e78:	6a 00                	push   $0x0
  pushl $118
80106e7a:	6a 76                	push   $0x76
  jmp alltraps
80106e7c:	e9 4f f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e81:	6a 00                	push   $0x0
  pushl $119
80106e83:	6a 77                	push   $0x77
  jmp alltraps
80106e85:	e9 46 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e8a:	6a 00                	push   $0x0
  pushl $120
80106e8c:	6a 78                	push   $0x78
  jmp alltraps
80106e8e:	e9 3d f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e93:	6a 00                	push   $0x0
  pushl $121
80106e95:	6a 79                	push   $0x79
  jmp alltraps
80106e97:	e9 34 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106e9c:	6a 00                	push   $0x0
  pushl $122
80106e9e:	6a 7a                	push   $0x7a
  jmp alltraps
80106ea0:	e9 2b f5 ff ff       	jmp    801063d0 <alltraps>
...
80106ea5:	6a 00                	push   $0x0
  pushl $123
80106ea7:	6a 7b                	push   $0x7b
  jmp alltraps
80106ea9:	e9 22 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106eae:	6a 00                	push   $0x0
  pushl $124
80106eb0:	6a 7c                	push   $0x7c
  jmp alltraps
80106eb2:	e9 19 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106eb7:	6a 00                	push   $0x0
  pushl $125
80106eb9:	6a 7d                	push   $0x7d
  jmp alltraps
80106ebb:	e9 10 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106ec0:	6a 00                	push   $0x0
  pushl $126
80106ec2:	6a 7e                	push   $0x7e
  jmp alltraps
80106ec4:	e9 07 f5 ff ff       	jmp    801063d0 <alltraps>
...
80106ec9:	6a 00                	push   $0x0
  pushl $127
80106ecb:	6a 7f                	push   $0x7f
  jmp alltraps
80106ecd:	e9 fe f4 ff ff       	jmp    801063d0 <alltraps>
...
80106ed4:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106ed9:	e9 f2 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106ede:	6a 00                	push   $0x0
  pushl $129
80106ee0:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106ee5:	e9 e6 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106eea:	6a 00                	push   $0x0
  pushl $130
80106eec:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106ef1:	e9 da f4 ff ff       	jmp    801063d0 <alltraps>
...
80106ef6:	6a 00                	push   $0x0
  pushl $131
80106ef8:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106efd:	e9 ce f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f02:	6a 00                	push   $0x0
  pushl $132
80106f04:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106f09:	e9 c2 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f0e:	6a 00                	push   $0x0
  pushl $133
80106f10:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106f15:	e9 b6 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f1a:	6a 00                	push   $0x0
  pushl $134
80106f1c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106f21:	e9 aa f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f26:	6a 00                	push   $0x0
  pushl $135
80106f28:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106f2d:	e9 9e f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f32:	6a 00                	push   $0x0
  pushl $136
80106f34:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106f39:	e9 92 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f3e:	6a 00                	push   $0x0
  pushl $137
80106f40:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106f45:	e9 86 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f4a:	6a 00                	push   $0x0
  pushl $138
80106f4c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106f51:	e9 7a f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f56:	6a 00                	push   $0x0
  pushl $139
80106f58:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106f5d:	e9 6e f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f62:	6a 00                	push   $0x0
  pushl $140
80106f64:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106f69:	e9 62 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f6e:	6a 00                	push   $0x0
  pushl $141
80106f70:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106f75:	e9 56 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f7a:	6a 00                	push   $0x0
  pushl $142
80106f7c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106f81:	e9 4a f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f86:	6a 00                	push   $0x0
  pushl $143
80106f88:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106f8d:	e9 3e f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f92:	6a 00                	push   $0x0
  pushl $144
80106f94:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106f99:	e9 32 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106f9e:	6a 00                	push   $0x0
  pushl $145
80106fa0:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106fa5:	e9 26 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106faa:	6a 00                	push   $0x0
  pushl $146
80106fac:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106fb1:	e9 1a f4 ff ff       	jmp    801063d0 <alltraps>
...
80106fb6:	6a 00                	push   $0x0
  pushl $147
80106fb8:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106fbd:	e9 0e f4 ff ff       	jmp    801063d0 <alltraps>
...
80106fc2:	6a 00                	push   $0x0
  pushl $148
80106fc4:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106fc9:	e9 02 f4 ff ff       	jmp    801063d0 <alltraps>
...
80106fce:	6a 00                	push   $0x0
  pushl $149
80106fd0:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106fd5:	e9 f6 f3 ff ff       	jmp    801063d0 <alltraps>
...
80106fda:	6a 00                	push   $0x0
  pushl $150
80106fdc:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106fe1:	e9 ea f3 ff ff       	jmp    801063d0 <alltraps>
...
80106fe6:	6a 00                	push   $0x0
  pushl $151
80106fe8:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106fed:	e9 de f3 ff ff       	jmp    801063d0 <alltraps>
...
80106ff2:	6a 00                	push   $0x0
  pushl $152
80106ff4:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106ff9:	e9 d2 f3 ff ff       	jmp    801063d0 <alltraps>
...
80106ffe:	6a 00                	push   $0x0
  pushl $153
80107000:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107005:	e9 c6 f3 ff ff       	jmp    801063d0 <alltraps>
...
8010700a:	6a 00                	push   $0x0
  pushl $154
8010700c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107011:	e9 ba f3 ff ff       	jmp    801063d0 <alltraps>
...
80107016:	6a 00                	push   $0x0
  pushl $155
80107018:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010701d:	e9 ae f3 ff ff       	jmp    801063d0 <alltraps>
...
80107022:	6a 00                	push   $0x0
  pushl $156
80107024:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107029:	e9 a2 f3 ff ff       	jmp    801063d0 <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $157
80107030:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107035:	e9 96 f3 ff ff       	jmp    801063d0 <alltraps>
...
8010703a:	6a 00                	push   $0x0
  pushl $158
8010703c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107041:	e9 8a f3 ff ff       	jmp    801063d0 <alltraps>
...
80107046:	6a 00                	push   $0x0
  pushl $159
80107048:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010704d:	e9 7e f3 ff ff       	jmp    801063d0 <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $160
80107054:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107059:	e9 72 f3 ff ff       	jmp    801063d0 <alltraps>
...
8010705e:	6a 00                	push   $0x0
  pushl $161
80107060:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107065:	e9 66 f3 ff ff       	jmp    801063d0 <alltraps>
...
8010706a:	6a 00                	push   $0x0
  pushl $162
8010706c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107071:	e9 5a f3 ff ff       	jmp    801063d0 <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $163
80107078:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010707d:	e9 4e f3 ff ff       	jmp    801063d0 <alltraps>
...
80107082:	6a 00                	push   $0x0
  pushl $164
80107084:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107089:	e9 42 f3 ff ff       	jmp    801063d0 <alltraps>
...
8010708e:	6a 00                	push   $0x0
  pushl $165
80107090:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107095:	e9 36 f3 ff ff       	jmp    801063d0 <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $166
8010709c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801070a1:	e9 2a f3 ff ff       	jmp    801063d0 <alltraps>
...
801070a6:	6a 00                	push   $0x0
  pushl $167
801070a8:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801070ad:	e9 1e f3 ff ff       	jmp    801063d0 <alltraps>
...
801070b2:	6a 00                	push   $0x0
  pushl $168
801070b4:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801070b9:	e9 12 f3 ff ff       	jmp    801063d0 <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $169
801070c0:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801070c5:	e9 06 f3 ff ff       	jmp    801063d0 <alltraps>
...
801070ca:	6a 00                	push   $0x0
  pushl $170
801070cc:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801070d1:	e9 fa f2 ff ff       	jmp    801063d0 <alltraps>
...
801070d6:	6a 00                	push   $0x0
  pushl $171
801070d8:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801070dd:	e9 ee f2 ff ff       	jmp    801063d0 <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $172
801070e4:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801070e9:	e9 e2 f2 ff ff       	jmp    801063d0 <alltraps>
...
801070ee:	6a 00                	push   $0x0
  pushl $173
801070f0:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801070f5:	e9 d6 f2 ff ff       	jmp    801063d0 <alltraps>
...
801070fa:	6a 00                	push   $0x0
  pushl $174
801070fc:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107101:	e9 ca f2 ff ff       	jmp    801063d0 <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $175
80107108:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010710d:	e9 be f2 ff ff       	jmp    801063d0 <alltraps>
...
80107112:	6a 00                	push   $0x0
  pushl $176
80107114:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107119:	e9 b2 f2 ff ff       	jmp    801063d0 <alltraps>
...
8010711e:	6a 00                	push   $0x0
  pushl $177
80107120:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107125:	e9 a6 f2 ff ff       	jmp    801063d0 <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $178
8010712c:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107131:	e9 9a f2 ff ff       	jmp    801063d0 <alltraps>
...
80107136:	6a 00                	push   $0x0
  pushl $179
80107138:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010713d:	e9 8e f2 ff ff       	jmp    801063d0 <alltraps>
...
80107142:	6a 00                	push   $0x0
  pushl $180
80107144:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107149:	e9 82 f2 ff ff       	jmp    801063d0 <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $181
80107150:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107155:	e9 76 f2 ff ff       	jmp    801063d0 <alltraps>
...
8010715a:	6a 00                	push   $0x0
  pushl $182
8010715c:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107161:	e9 6a f2 ff ff       	jmp    801063d0 <alltraps>
...
80107166:	6a 00                	push   $0x0
  pushl $183
80107168:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010716d:	e9 5e f2 ff ff       	jmp    801063d0 <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $184
80107174:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107179:	e9 52 f2 ff ff       	jmp    801063d0 <alltraps>
...
8010717e:	6a 00                	push   $0x0
  pushl $185
80107180:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107185:	e9 46 f2 ff ff       	jmp    801063d0 <alltraps>
...
8010718a:	6a 00                	push   $0x0
  pushl $186
8010718c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107191:	e9 3a f2 ff ff       	jmp    801063d0 <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $187
80107198:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010719d:	e9 2e f2 ff ff       	jmp    801063d0 <alltraps>
...
801071a2:	6a 00                	push   $0x0
  pushl $188
801071a4:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801071a9:	e9 22 f2 ff ff       	jmp    801063d0 <alltraps>
...
801071ae:	6a 00                	push   $0x0
  pushl $189
801071b0:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801071b5:	e9 16 f2 ff ff       	jmp    801063d0 <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $190
801071bc:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801071c1:	e9 0a f2 ff ff       	jmp    801063d0 <alltraps>
...
801071c6:	6a 00                	push   $0x0
  pushl $191
801071c8:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801071cd:	e9 fe f1 ff ff       	jmp    801063d0 <alltraps>
...
801071d2:	6a 00                	push   $0x0
  pushl $192
801071d4:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801071d9:	e9 f2 f1 ff ff       	jmp    801063d0 <alltraps>
...
801071de:	6a 00                	push   $0x0
  pushl $193
801071e0:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801071e5:	e9 e6 f1 ff ff       	jmp    801063d0 <alltraps>
...
801071ea:	6a 00                	push   $0x0
  pushl $194
801071ec:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801071f1:	e9 da f1 ff ff       	jmp    801063d0 <alltraps>
...
801071f6:	6a 00                	push   $0x0
  pushl $195
801071f8:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801071fd:	e9 ce f1 ff ff       	jmp    801063d0 <alltraps>
...
80107202:	6a 00                	push   $0x0
  pushl $196
80107204:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107209:	e9 c2 f1 ff ff       	jmp    801063d0 <alltraps>
...
8010720e:	6a 00                	push   $0x0
  pushl $197
80107210:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107215:	e9 b6 f1 ff ff       	jmp    801063d0 <alltraps>
...
8010721a:	6a 00                	push   $0x0
  pushl $198
8010721c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107221:	e9 aa f1 ff ff       	jmp    801063d0 <alltraps>
...
80107226:	6a 00                	push   $0x0
  pushl $199
80107228:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010722d:	e9 9e f1 ff ff       	jmp    801063d0 <alltraps>
...
80107232:	6a 00                	push   $0x0
  pushl $200
80107234:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107239:	e9 92 f1 ff ff       	jmp    801063d0 <alltraps>
...
8010723e:	6a 00                	push   $0x0
  pushl $201
80107240:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107245:	e9 86 f1 ff ff       	jmp    801063d0 <alltraps>
...
8010724a:	6a 00                	push   $0x0
  pushl $202
8010724c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107251:	e9 7a f1 ff ff       	jmp    801063d0 <alltraps>
...
80107256:	6a 00                	push   $0x0
  pushl $203
80107258:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010725d:	e9 6e f1 ff ff       	jmp    801063d0 <alltraps>
...
80107262:	6a 00                	push   $0x0
  pushl $204
80107264:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107269:	e9 62 f1 ff ff       	jmp    801063d0 <alltraps>
...
8010726e:	6a 00                	push   $0x0
  pushl $205
80107270:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107275:	e9 56 f1 ff ff       	jmp    801063d0 <alltraps>
...
8010727a:	6a 00                	push   $0x0
  pushl $206
8010727c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107281:	e9 4a f1 ff ff       	jmp    801063d0 <alltraps>
...
80107286:	6a 00                	push   $0x0
  pushl $207
80107288:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010728d:	e9 3e f1 ff ff       	jmp    801063d0 <alltraps>
...
80107292:	6a 00                	push   $0x0
  pushl $208
80107294:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107299:	e9 32 f1 ff ff       	jmp    801063d0 <alltraps>
...
8010729e:	6a 00                	push   $0x0
  pushl $209
801072a0:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801072a5:	e9 26 f1 ff ff       	jmp    801063d0 <alltraps>
...
801072aa:	6a 00                	push   $0x0
  pushl $210
801072ac:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801072b1:	e9 1a f1 ff ff       	jmp    801063d0 <alltraps>
...
801072b6:	6a 00                	push   $0x0
  pushl $211
801072b8:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801072bd:	e9 0e f1 ff ff       	jmp    801063d0 <alltraps>
...
801072c2:	6a 00                	push   $0x0
  pushl $212
801072c4:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801072c9:	e9 02 f1 ff ff       	jmp    801063d0 <alltraps>
...
801072ce:	6a 00                	push   $0x0
  pushl $213
801072d0:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801072d5:	e9 f6 f0 ff ff       	jmp    801063d0 <alltraps>
...
801072da:	6a 00                	push   $0x0
  pushl $214
801072dc:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801072e1:	e9 ea f0 ff ff       	jmp    801063d0 <alltraps>
...
801072e6:	6a 00                	push   $0x0
  pushl $215
801072e8:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801072ed:	e9 de f0 ff ff       	jmp    801063d0 <alltraps>
...
801072f2:	6a 00                	push   $0x0
  pushl $216
801072f4:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801072f9:	e9 d2 f0 ff ff       	jmp    801063d0 <alltraps>
...
801072fe:	6a 00                	push   $0x0
  pushl $217
80107300:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107305:	e9 c6 f0 ff ff       	jmp    801063d0 <alltraps>
...
8010730a:	6a 00                	push   $0x0
  pushl $218
8010730c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107311:	e9 ba f0 ff ff       	jmp    801063d0 <alltraps>
...
80107316:	6a 00                	push   $0x0
  pushl $219
80107318:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010731d:	e9 ae f0 ff ff       	jmp    801063d0 <alltraps>
...
80107322:	6a 00                	push   $0x0
  pushl $220
80107324:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107329:	e9 a2 f0 ff ff       	jmp    801063d0 <alltraps>
...
8010732e:	6a 00                	push   $0x0
  pushl $221
80107330:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107335:	e9 96 f0 ff ff       	jmp    801063d0 <alltraps>
...
8010733a:	6a 00                	push   $0x0
  pushl $222
8010733c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107341:	e9 8a f0 ff ff       	jmp    801063d0 <alltraps>
...
80107346:	6a 00                	push   $0x0
  pushl $223
80107348:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010734d:	e9 7e f0 ff ff       	jmp    801063d0 <alltraps>
...
80107352:	6a 00                	push   $0x0
  pushl $224
80107354:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107359:	e9 72 f0 ff ff       	jmp    801063d0 <alltraps>
...
8010735e:	6a 00                	push   $0x0
  pushl $225
80107360:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107365:	e9 66 f0 ff ff       	jmp    801063d0 <alltraps>
...
8010736a:	6a 00                	push   $0x0
  pushl $226
8010736c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107371:	e9 5a f0 ff ff       	jmp    801063d0 <alltraps>
...
80107376:	6a 00                	push   $0x0
  pushl $227
80107378:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010737d:	e9 4e f0 ff ff       	jmp    801063d0 <alltraps>
...
80107382:	6a 00                	push   $0x0
  pushl $228
80107384:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107389:	e9 42 f0 ff ff       	jmp    801063d0 <alltraps>
...
8010738e:	6a 00                	push   $0x0
  pushl $229
80107390:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107395:	e9 36 f0 ff ff       	jmp    801063d0 <alltraps>
...
8010739a:	6a 00                	push   $0x0
  pushl $230
8010739c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801073a1:	e9 2a f0 ff ff       	jmp    801063d0 <alltraps>
...
801073a6:	6a 00                	push   $0x0
  pushl $231
801073a8:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801073ad:	e9 1e f0 ff ff       	jmp    801063d0 <alltraps>
...
801073b2:	6a 00                	push   $0x0
  pushl $232
801073b4:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801073b9:	e9 12 f0 ff ff       	jmp    801063d0 <alltraps>
...
801073be:	6a 00                	push   $0x0
  pushl $233
801073c0:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801073c5:	e9 06 f0 ff ff       	jmp    801063d0 <alltraps>
...
801073ca:	6a 00                	push   $0x0
  pushl $234
801073cc:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801073d1:	e9 fa ef ff ff       	jmp    801063d0 <alltraps>
...
801073d6:	6a 00                	push   $0x0
  pushl $235
801073d8:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801073dd:	e9 ee ef ff ff       	jmp    801063d0 <alltraps>
...
801073e2:	6a 00                	push   $0x0
  pushl $236
801073e4:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801073e9:	e9 e2 ef ff ff       	jmp    801063d0 <alltraps>
...
801073ee:	6a 00                	push   $0x0
  pushl $237
801073f0:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801073f5:	e9 d6 ef ff ff       	jmp    801063d0 <alltraps>
...
801073fa:	6a 00                	push   $0x0
  pushl $238
801073fc:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107401:	e9 ca ef ff ff       	jmp    801063d0 <alltraps>
...
80107406:	6a 00                	push   $0x0
  pushl $239
80107408:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010740d:	e9 be ef ff ff       	jmp    801063d0 <alltraps>
...
80107412:	6a 00                	push   $0x0
  pushl $240
80107414:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107419:	e9 b2 ef ff ff       	jmp    801063d0 <alltraps>
...
8010741e:	6a 00                	push   $0x0
  pushl $241
80107420:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107425:	e9 a6 ef ff ff       	jmp    801063d0 <alltraps>
...
8010742a:	6a 00                	push   $0x0
  pushl $242
8010742c:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107431:	e9 9a ef ff ff       	jmp    801063d0 <alltraps>
...
80107436:	6a 00                	push   $0x0
  pushl $243
80107438:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010743d:	e9 8e ef ff ff       	jmp    801063d0 <alltraps>
...
80107442:	6a 00                	push   $0x0
  pushl $244
80107444:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107449:	e9 82 ef ff ff       	jmp    801063d0 <alltraps>
...
8010744e:	6a 00                	push   $0x0
  pushl $245
80107450:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107455:	e9 76 ef ff ff       	jmp    801063d0 <alltraps>
...
8010745a:	6a 00                	push   $0x0
  pushl $246
8010745c:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107461:	e9 6a ef ff ff       	jmp    801063d0 <alltraps>
...
80107466:	6a 00                	push   $0x0
  pushl $247
80107468:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010746d:	e9 5e ef ff ff       	jmp    801063d0 <alltraps>
...
80107472:	6a 00                	push   $0x0
  pushl $248
80107474:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107479:	e9 52 ef ff ff       	jmp    801063d0 <alltraps>
...
8010747e:	6a 00                	push   $0x0
  pushl $249
80107480:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107485:	e9 46 ef ff ff       	jmp    801063d0 <alltraps>
...
8010748a:	6a 00                	push   $0x0
  pushl $250
8010748c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107491:	e9 3a ef ff ff       	jmp    801063d0 <alltraps>
...
80107496:	6a 00                	push   $0x0
  pushl $251
80107498:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010749d:	e9 2e ef ff ff       	jmp    801063d0 <alltraps>
...
801074a2:	6a 00                	push   $0x0
  pushl $252
801074a4:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801074a9:	e9 22 ef ff ff       	jmp    801063d0 <alltraps>
...
801074ae:	6a 00                	push   $0x0
  pushl $253
801074b0:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801074b5:	e9 16 ef ff ff       	jmp    801063d0 <alltraps>
...
801074ba:	6a 00                	push   $0x0
  pushl $254
801074bc:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801074c1:	e9 0a ef ff ff       	jmp    801063d0 <alltraps>
...
801074c6:	6a 00                	push   $0x0
  pushl $255
801074c8:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801074cd:	e9 fe ee ff ff       	jmp    801063d0 <alltraps>
	...
...
801074dd:	83 e8 01             	sub    $0x1,%eax
801074e0:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
...
801074f1:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801074f5:	8d 45 fa             	lea    -0x6(%ebp),%eax
801074f8:	0f 01 10             	lgdtl  (%eax)
}
801074fb:	c9                   	leave  
801074fc:	c3                   	ret    
...
8010751c:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107520:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107524:	8e e8                	mov    %eax,%gs
}
80107526:	c9                   	leave  
80107527:	c3                   	ret    
...
80107546:	05 00 00 00 80       	add    $0x80000000,%eax
8010754b:	5d                   	pop    %ebp
8010754c:	c3                   	ret    
...
80107551:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107554:	e8 40 b9 ff ff       	call   80102e99 <cpunum>
80107559:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
8010755f:	05 60 23 11 80       	add    $0x80112360,%eax
80107564:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107567:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010756a:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107570:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107573:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107579:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010757c:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107580:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107583:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107587:	83 e2 f0             	and    $0xfffffff0,%edx
8010758a:	83 ca 0a             	or     $0xa,%edx
8010758d:	88 50 7d             	mov    %dl,0x7d(%eax)
80107590:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107593:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
801075a4:	83 e2 9f             	and    $0xffffff9f,%edx
...
801075fb:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801075ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107602:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107609:	ff ff 
8010760b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010760e:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107615:	00 00 
80107617:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010761a:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107621:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107624:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010762b:	83 e2 f0             	and    $0xfffffff0,%edx
8010762e:	83 ca 02             	or     $0x2,%edx
80107631:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107637:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010763a:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107641:	83 ca 10             	or     $0x10,%edx
80107644:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010764a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010764d:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107654:	83 e2 9f             	and    $0xffffff9f,%edx
80107657:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
8010765d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107660:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107667:	83 ca 80             	or     $0xffffff80,%edx
8010766a:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107670:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107673:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010767a:	83 ca 0f             	or     $0xf,%edx
8010767d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107683:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107686:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
8010768d:	83 e2 ef             	and    $0xffffffef,%edx
80107690:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107696:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107699:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801076a0:	83 e2 df             	and    $0xffffffdf,%edx
801076a3:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801076a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076ac:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801076b3:	83 ca 40             	or     $0x40,%edx
801076b6:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801076bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076bf:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
801076c6:	83 ca 80             	or     $0xffffff80,%edx
801076c9:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
801076cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076d2:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801076d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076dc:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801076e3:	ff ff 
801076e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076e8:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801076ef:	00 00 
801076f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076f4:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801076fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076fe:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107705:	83 e2 f0             	and    $0xfffffff0,%edx
80107708:	83 ca 0a             	or     $0xa,%edx
8010770b:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107711:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107714:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010771b:	83 ca 10             	or     $0x10,%edx
8010771e:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107724:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107727:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010772e:	83 ca 60             	or     $0x60,%edx
...
8010774d:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107754:	83 ca 0f             	or     $0xf,%edx
80107757:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
8010775d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107760:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107767:	83 e2 ef             	and    $0xffffffef,%edx
8010776a:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
...
801077a0:	83 ca 80             	or     $0xffffff80,%edx
801077a3:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
801077a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ac:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801077b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b6:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801077bd:	ff ff 
801077bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c2:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801077c9:	00 00 
801077cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ce:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801077d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d8:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801077df:	83 e2 f0             	and    $0xfffffff0,%edx
801077e2:	83 ca 02             	or     $0x2,%edx
801077e5:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801077eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ee:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801077f5:	83 ca 10             	or     $0x10,%edx
801077f8:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801077fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107801:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107808:	83 ca 60             	or     $0x60,%edx
8010780b:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107811:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107814:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010781b:	83 ca 80             	or     $0xffffff80,%edx
8010781e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107824:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107827:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010782e:	83 ca 0f             	or     $0xf,%edx
80107831:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107837:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010783a:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107841:	83 e2 ef             	and    $0xffffffef,%edx
80107844:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010784a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010784d:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107854:	83 e2 df             	and    $0xffffffdf,%edx
80107857:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010785d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107860:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107867:	83 ca 40             	or     $0x40,%edx
8010786a:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107870:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107873:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010787a:	83 ca 80             	or     $0xffffff80,%edx
8010787d:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107883:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107886:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010788d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107890:	05 b4 00 00 00       	add    $0xb4,%eax
80107895:	89 c3                	mov    %eax,%ebx
80107897:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010789a:	05 b4 00 00 00       	add    $0xb4,%eax
8010789f:	c1 e8 10             	shr    $0x10,%eax
801078a2:	89 c1                	mov    %eax,%ecx
801078a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a7:	05 b4 00 00 00       	add    $0xb4,%eax
801078ac:	c1 e8 18             	shr    $0x18,%eax
801078af:	89 c2                	mov    %eax,%edx
801078b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078b4:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801078bb:	00 00 
801078bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078c0:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801078c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078ca:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801078d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d3:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801078da:	83 e1 f0             	and    $0xfffffff0,%ecx
801078dd:	83 c9 02             	or     $0x2,%ecx
801078e0:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801078e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e9:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801078f0:	83 c9 10             	or     $0x10,%ecx
801078f3:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801078f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078fc:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107903:	83 e1 9f             	and    $0xffffff9f,%ecx
80107906:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010790c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010790f:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107916:	83 c9 80             	or     $0xffffff80,%ecx
80107919:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010791f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107922:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107929:	83 e1 f0             	and    $0xfffffff0,%ecx
8010792c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107932:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107935:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010793c:	83 e1 ef             	and    $0xffffffef,%ecx
8010793f:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107945:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107948:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010794f:	83 e1 df             	and    $0xffffffdf,%ecx
80107952:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107958:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010795b:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107962:	83 c9 40             	or     $0x40,%ecx
80107965:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010796b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010796e:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107975:	83 c9 80             	or     $0xffffff80,%ecx
80107978:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010797e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107981:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107987:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010798a:	83 c0 70             	add    $0x70,%eax
8010798d:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107994:	00 
80107995:	89 04 24             	mov    %eax,(%esp)
80107998:	e8 37 fb ff ff       	call   801074d4 <lgdt>
  loadgs(SEG_KCPU << 3);
8010799d:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801079a4:	e8 6a fb ff ff       	call   80107513 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801079a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ac:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801079b2:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801079b9:	00 00 00 00 
}
801079bd:	83 c4 24             	add    $0x24,%esp
801079c0:	5b                   	pop    %ebx
801079c1:	5d                   	pop    %ebp
801079c2:	c3                   	ret    
...
801079c6:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801079c9:	8b 45 0c             	mov    0xc(%ebp),%eax
801079cc:	c1 e8 16             	shr    $0x16,%eax
801079cf:	c1 e0 02             	shl    $0x2,%eax
801079d2:	03 45 08             	add    0x8(%ebp),%eax
801079d5:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801079d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079db:	8b 00                	mov    (%eax),%eax
801079dd:	83 e0 01             	and    $0x1,%eax
801079e0:	84 c0                	test   %al,%al
801079e2:	74 17                	je     801079fb <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
801079e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801079e7:	8b 00                	mov    (%eax),%eax
801079e9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801079ee:	89 04 24             	mov    %eax,(%esp)
801079f1:	e8 4a fb ff ff       	call   80107540 <p2v>
801079f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801079f9:	eb 4b                	jmp    80107a46 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801079fb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801079ff:	74 0e                	je     80107a0f <walkpgdir+0x4c>
80107a01:	e8 05 b1 ff ff       	call   80102b0b <kalloc>
80107a06:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a09:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107a0d:	75 07                	jne    80107a16 <walkpgdir+0x53>
      return 0;
80107a0f:	b8 00 00 00 00       	mov    $0x0,%eax
80107a14:	eb 41                	jmp    80107a57 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107a16:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107a1d:	00 
80107a1e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107a25:	00 
80107a26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a29:	89 04 24             	mov    %eax,(%esp)
80107a2c:	e8 f9 d4 ff ff       	call   80104f2a <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = v2p(pgtab) | PTE_P | PTE_W | PTE_U;
80107a31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a34:	89 04 24             	mov    %eax,(%esp)
80107a37:	e8 f7 fa ff ff       	call   80107533 <v2p>
80107a3c:	89 c2                	mov    %eax,%edx
80107a3e:	83 ca 07             	or     $0x7,%edx
80107a41:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a44:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107a46:	8b 45 0c             	mov    0xc(%ebp),%eax
80107a49:	c1 e8 0c             	shr    $0xc,%eax
80107a4c:	25 ff 03 00 00       	and    $0x3ff,%eax
80107a51:	c1 e0 02             	shl    $0x2,%eax
80107a54:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107a57:	c9                   	leave  
80107a58:	c3                   	ret    
...
80107a5c:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107a6d:	03 45 10             	add    0x10(%ebp),%eax
80107a70:	83 e8 01             	sub    $0x1,%eax
80107a73:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107a78:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107a7b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107a82:	00 
80107a83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a86:	89 44 24 04          	mov    %eax,0x4(%esp)
80107a8a:	8b 45 08             	mov    0x8(%ebp),%eax
80107a8d:	89 04 24             	mov    %eax,(%esp)
80107a90:	e8 2e ff ff ff       	call   801079c3 <walkpgdir>
80107a95:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107a98:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107a9c:	75 07                	jne    80107aa5 <mappages+0x4c>
      return -1;
80107a9e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107aa3:	eb 46                	jmp    80107aeb <mappages+0x92>
    if(*pte & PTE_P)
80107aa5:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107aa8:	8b 00                	mov    (%eax),%eax
80107aaa:	83 e0 01             	and    $0x1,%eax
80107aad:	84 c0                	test   %al,%al
80107aaf:	74 0c                	je     80107abd <mappages+0x64>
      panic("remap");
80107ab1:	c7 04 24 e4 88 10 80 	movl   $0x801088e4,(%esp)
80107ab8:	e8 80 8a ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80107abd:	8b 45 18             	mov    0x18(%ebp),%eax
80107ac0:	0b 45 14             	or     0x14(%ebp),%eax
80107ac3:	89 c2                	mov    %eax,%edx
80107ac5:	83 ca 01             	or     $0x1,%edx
80107ac8:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107acb:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107acd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ad0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107ad3:	74 10                	je     80107ae5 <mappages+0x8c>
      break;
    a += PGSIZE;
...
80107ae3:	eb 96                	jmp    80107a7b <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80107af0:	53                   	push   %ebx
80107af1:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107af4:	e8 12 b0 ff ff       	call   80102b0b <kalloc>
80107af9:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107afc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107b00:	75 0a                	jne    80107b0c <setupkvm+0x1f>
    return 0;
80107b02:	b8 00 00 00 00       	mov    $0x0,%eax
80107b07:	e9 98 00 00 00       	jmp    80107ba4 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107b0c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107b13:	00 
80107b14:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107b1b:	00 
80107b1c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b1f:	89 04 24             	mov    %eax,(%esp)
80107b22:	e8 03 d4 ff ff       	call   80104f2a <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107b27:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107b2e:	e8 0d fa ff ff       	call   80107540 <p2v>
80107b33:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107b38:	76 0c                	jbe    80107b46 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107b3a:	c7 04 24 ea 88 10 80 	movl   $0x801088ea,(%esp)
80107b41:	e8 f7 89 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107b46:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107b4d:	eb 49                	jmp    80107b98 <setupkvm+0xab>
...
80107b4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107b52:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80107b55:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107b58:	8b 50 04             	mov    0x4(%eax),%edx
80107b5b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b5e:	8b 58 08             	mov    0x8(%eax),%ebx
80107b61:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b64:	8b 40 04             	mov    0x4(%eax),%eax
80107b67:	29 c3                	sub    %eax,%ebx
80107b69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b6c:	8b 00                	mov    (%eax),%eax
80107b6e:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107b72:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107b76:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107b7a:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b7e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b81:	89 04 24             	mov    %eax,(%esp)
80107b84:	e8 d0 fe ff ff       	call   80107a59 <mappages>
80107b89:	85 c0                	test   %eax,%eax
80107b8b:	79 07                	jns    80107b94 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107b8d:	b8 00 00 00 00       	mov    $0x0,%eax
80107b92:	eb 10                	jmp    80107ba4 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107b94:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107b98:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107b9f:	72 ae                	jb     80107b4f <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107ba4:	83 c4 34             	add    $0x34,%esp
80107ba7:	5b                   	pop    %ebx
80107ba8:	5d                   	pop    %ebp
80107ba9:	c3                   	ret    
...
80107bad:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107bb0:	e8 38 ff ff ff       	call   80107aed <setupkvm>
80107bb5:	a3 38 55 11 80       	mov    %eax,0x80115538
  switchkvm();
80107bba:	e8 02 00 00 00       	call   80107bc1 <switchkvm>
}
80107bbf:	c9                   	leave  
80107bc0:	c3                   	ret    
...
80107bc7:	a1 38 55 11 80       	mov    0x80115538,%eax
80107bcc:	89 04 24             	mov    %eax,(%esp)
80107bcf:	e8 5f f9 ff ff       	call   80107533 <v2p>
80107bd4:	89 04 24             	mov    %eax,(%esp)
80107bd7:	e8 4c f9 ff ff       	call   80107528 <lcr3>
}
80107bdc:	c9                   	leave  
80107bdd:	c3                   	ret    
...
80107be1:	53                   	push   %ebx
80107be2:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107be5:	e8 39 d2 ff ff       	call   80104e23 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107bea:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107bf0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107bf7:	83 c2 08             	add    $0x8,%edx
80107bfa:	89 d3                	mov    %edx,%ebx
80107bfc:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c03:	83 c2 08             	add    $0x8,%edx
80107c06:	c1 ea 10             	shr    $0x10,%edx
80107c09:	89 d1                	mov    %edx,%ecx
80107c0b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c12:	83 c2 08             	add    $0x8,%edx
80107c15:	c1 ea 18             	shr    $0x18,%edx
80107c18:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107c1f:	67 00 
80107c21:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107c28:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107c2e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107c35:	83 e1 f0             	and    $0xfffffff0,%ecx
80107c38:	83 c9 09             	or     $0x9,%ecx
80107c3b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107c41:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107c48:	83 c9 10             	or     $0x10,%ecx
80107c4b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107c51:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107c58:	83 e1 9f             	and    $0xffffff9f,%ecx
80107c5b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107c61:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107c68:	83 c9 80             	or     $0xffffff80,%ecx
80107c6b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107c71:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107c78:	83 e1 f0             	and    $0xfffffff0,%ecx
80107c7b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107c81:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107c88:	83 e1 ef             	and    $0xffffffef,%ecx
80107c8b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107c91:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107c98:	83 e1 df             	and    $0xffffffdf,%ecx
80107c9b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ca1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ca8:	83 c9 40             	or     $0x40,%ecx
80107cab:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107cb1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107cb8:	83 e1 7f             	and    $0x7f,%ecx
80107cbb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107cc1:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107cc7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ccd:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107cd4:	83 e2 ef             	and    $0xffffffef,%edx
80107cd7:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107cdd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ce3:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107ce9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107cef:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107cf6:	8b 52 08             	mov    0x8(%edx),%edx
80107cf9:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107cff:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107d02:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107d09:	e8 ef f7 ff ff       	call   801074fd <ltr>
  if(p->pgdir == 0)
80107d0e:	8b 45 08             	mov    0x8(%ebp),%eax
80107d11:	8b 40 04             	mov    0x4(%eax),%eax
80107d14:	85 c0                	test   %eax,%eax
80107d16:	75 0c                	jne    80107d24 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107d18:	c7 04 24 fb 88 10 80 	movl   $0x801088fb,(%esp)
80107d1f:	e8 19 88 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107d24:	8b 45 08             	mov    0x8(%ebp),%eax
80107d27:	8b 40 04             	mov    0x4(%eax),%eax
80107d2a:	89 04 24             	mov    %eax,(%esp)
80107d2d:	e8 01 f8 ff ff       	call   80107533 <v2p>
80107d32:	89 04 24             	mov    %eax,(%esp)
80107d35:	e8 ee f7 ff ff       	call   80107528 <lcr3>
  popcli();
80107d3a:	e8 2c d1 ff ff       	call   80104e6b <popcli>
}
80107d3f:	83 c4 14             	add    $0x14,%esp
80107d42:	5b                   	pop    %ebx
80107d43:	5d                   	pop    %ebp
80107d44:	c3                   	ret    
...
80107d48:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107d4b:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107d52:	76 0c                	jbe    80107d60 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107d54:	c7 04 24 0f 89 10 80 	movl   $0x8010890f,(%esp)
80107d5b:	e8 dd 87 ff ff       	call   8010053d <panic>
  mem = kalloc();
80107d60:	e8 a6 ad ff ff       	call   80102b0b <kalloc>
...
80107d7e:	e8 a7 d1 ff ff       	call   80104f2a <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107d83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d86:	89 04 24             	mov    %eax,(%esp)
80107d89:	e8 a5 f7 ff ff       	call   80107533 <v2p>
80107d8e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107d95:	00 
80107d96:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107d9a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107da1:	00 
80107da2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107da9:	00 
80107daa:	8b 45 08             	mov    0x8(%ebp),%eax
80107dad:	89 04 24             	mov    %eax,(%esp)
80107db0:	e8 a4 fc ff ff       	call   80107a59 <mappages>
  memmove(mem, init, sz);
80107db5:	8b 45 10             	mov    0x10(%ebp),%eax
80107db8:	89 44 24 08          	mov    %eax,0x8(%esp)
80107dbc:	8b 45 0c             	mov    0xc(%ebp),%eax
80107dbf:	89 44 24 04          	mov    %eax,0x4(%esp)
80107dc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc6:	89 04 24             	mov    %eax,(%esp)
80107dc9:	e8 2f d2 ff ff       	call   80104ffd <memmove>
}
80107dce:	c9                   	leave  
80107dcf:	c3                   	ret    
...
80107dd4:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107dd7:	8b 45 0c             	mov    0xc(%ebp),%eax
80107dda:	25 ff 0f 00 00       	and    $0xfff,%eax
80107ddf:	85 c0                	test   %eax,%eax
80107de1:	74 0c                	je     80107def <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107de3:	c7 04 24 2c 89 10 80 	movl   $0x8010892c,(%esp)
80107dea:	e8 4e 87 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107def:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107df6:	e9 ad 00 00 00       	jmp    80107ea8 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107dfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dfe:	8b 55 0c             	mov    0xc(%ebp),%edx
80107e01:	01 d0                	add    %edx,%eax
80107e03:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107e0a:	00 
80107e0b:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e0f:	8b 45 08             	mov    0x8(%ebp),%eax
80107e12:	89 04 24             	mov    %eax,(%esp)
80107e15:	e8 a9 fb ff ff       	call   801079c3 <walkpgdir>
80107e1a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107e1d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107e21:	75 0c                	jne    80107e2f <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107e23:	c7 04 24 4f 89 10 80 	movl   $0x8010894f,(%esp)
80107e2a:	e8 0e 87 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
80107e3f:	8b 55 18             	mov    0x18(%ebp),%edx
80107e42:	89 d1                	mov    %edx,%ecx
80107e44:	29 c1                	sub    %eax,%ecx
80107e46:	89 c8                	mov    %ecx,%eax
80107e48:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107e4d:	77 11                	ja     80107e60 <loaduvm+0x90>
      n = sz - i;
80107e4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e52:	8b 55 18             	mov    0x18(%ebp),%edx
80107e55:	89 d1                	mov    %edx,%ecx
80107e57:	29 c1                	sub    %eax,%ecx
80107e59:	89 c8                	mov    %ecx,%eax
80107e5b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107e5e:	eb 07                	jmp    80107e67 <loaduvm+0x97>
    else
      n = PGSIZE;
80107e60:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107e67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e6a:	8b 55 14             	mov    0x14(%ebp),%edx
80107e6d:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107e70:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107e73:	89 04 24             	mov    %eax,(%esp)
80107e76:	e8 c5 f6 ff ff       	call   80107540 <p2v>
80107e7b:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107e7e:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107e82:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107e86:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e8a:	8b 45 10             	mov    0x10(%ebp),%eax
80107e8d:	89 04 24             	mov    %eax,(%esp)
80107e90:	e8 d5 9e ff ff       	call   80101d6a <readi>
80107e95:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107e98:	74 07                	je     80107ea1 <loaduvm+0xd1>
      return -1;
80107e9a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107e9f:	eb 18                	jmp    80107eb9 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
...
80107eab:	3b 45 18             	cmp    0x18(%ebp),%eax
80107eae:	0f 82 47 ff ff ff    	jb     80107dfb <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80107ec2:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
80107ec5:	8b 45 10             	mov    0x10(%ebp),%eax
80107ec8:	85 c0                	test   %eax,%eax
80107eca:	79 0a                	jns    80107ed6 <allocuvm+0x17>
    return 0;
80107ecc:	b8 00 00 00 00       	mov    $0x0,%eax
80107ed1:	e9 c1 00 00 00       	jmp    80107f97 <allocuvm+0xd8>
  if(newsz < oldsz)
80107ed6:	8b 45 10             	mov    0x10(%ebp),%eax
80107ed9:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107edc:	73 08                	jae    80107ee6 <allocuvm+0x27>
    return oldsz;
80107ede:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ee1:	e9 b1 00 00 00       	jmp    80107f97 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107ee6:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ee9:	05 ff 0f 00 00       	add    $0xfff,%eax
80107eee:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ef3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107ef6:	e9 8d 00 00 00       	jmp    80107f88 <allocuvm+0xc9>
    mem = kalloc();
80107efb:	e8 0b ac ff ff       	call   80102b0b <kalloc>
80107f00:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107f03:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107f07:	75 2c                	jne    80107f35 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107f09:	c7 04 24 6d 89 10 80 	movl   $0x8010896d,(%esp)
80107f10:	e8 8c 84 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107f15:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f18:	89 44 24 08          	mov    %eax,0x8(%esp)
80107f1c:	8b 45 10             	mov    0x10(%ebp),%eax
80107f1f:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f23:	8b 45 08             	mov    0x8(%ebp),%eax
80107f26:	89 04 24             	mov    %eax,(%esp)
80107f29:	e8 6b 00 00 00       	call   80107f99 <deallocuvm>
      return 0;
80107f2e:	b8 00 00 00 00       	mov    $0x0,%eax
80107f33:	eb 62                	jmp    80107f97 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
...
80107f4b:	e8 da cf ff ff       	call   80104f2a <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107f50:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f53:	89 04 24             	mov    %eax,(%esp)
80107f56:	e8 d8 f5 ff ff       	call   80107533 <v2p>
80107f5b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107f5e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107f65:	00 
80107f66:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80107f7c:	e8 d8 fa ff ff       	call   80107a59 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80107f8b:	3b 45 10             	cmp    0x10(%ebp),%eax
80107f8e:	0f 82 67 ff ff ff    	jb     80107efb <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80107f9c:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
80107fa5:	72 08                	jb     80107faf <deallocuvm+0x16>
    return oldsz;
80107fa7:	8b 45 0c             	mov    0xc(%ebp),%eax
80107faa:	e9 a4 00 00 00       	jmp    80108053 <deallocuvm+0xba>
...
80107fbf:	e9 80 00 00 00       	jmp    80108044 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80107fc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107fce:	00 
80107fcf:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fd3:	8b 45 08             	mov    0x8(%ebp),%eax
80107fd6:	89 04 24             	mov    %eax,(%esp)
80107fd9:	e8 e5 f9 ff ff       	call   801079c3 <walkpgdir>
80107fde:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80107fe1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107fe5:	75 09                	jne    80107ff0 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80107fe7:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80107fee:	eb 4d                	jmp    8010803d <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80107ff0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ff3:	8b 00                	mov    (%eax),%eax
80107ff5:	83 e0 01             	and    $0x1,%eax
80107ff8:	84 c0                	test   %al,%al
80107ffa:	74 41                	je     8010803d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80107ffc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fff:	8b 00                	mov    (%eax),%eax
80108001:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108006:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108009:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010800d:	75 0c                	jne    8010801b <deallocuvm+0x82>
        panic("kfree");
8010800f:	c7 04 24 85 89 10 80 	movl   $0x80108985,(%esp)
80108016:	e8 22 85 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
8010801b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010801e:	89 04 24             	mov    %eax,(%esp)
80108021:	e8 1a f5 ff ff       	call   80107540 <p2v>
80108026:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108029:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010802c:	89 04 24             	mov    %eax,(%esp)
8010802f:	e8 3e aa ff ff       	call   80102a72 <kfree>
      *pte = 0;
80108034:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108037:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80108047:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010804a:	0f 82 74 ff ff ff    	jb     80107fc4 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108058:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
8010805b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010805f:	75 0c                	jne    8010806d <freevm+0x18>
    panic("freevm: no pgdir");
80108061:	c7 04 24 8b 89 10 80 	movl   $0x8010898b,(%esp)
80108068:	e8 d0 84 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010806d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108074:	00 
80108075:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010807c:	80 
8010807d:	8b 45 08             	mov    0x8(%ebp),%eax
80108080:	89 04 24             	mov    %eax,(%esp)
80108083:	e8 11 ff ff ff       	call   80107f99 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108088:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010808f:	eb 3c                	jmp    801080cd <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108091:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108094:	c1 e0 02             	shl    $0x2,%eax
80108097:	03 45 08             	add    0x8(%ebp),%eax
8010809a:	8b 00                	mov    (%eax),%eax
8010809c:	83 e0 01             	and    $0x1,%eax
8010809f:	84 c0                	test   %al,%al
801080a1:	74 26                	je     801080c9 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801080a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080a6:	c1 e0 02             	shl    $0x2,%eax
801080a9:	03 45 08             	add    0x8(%ebp),%eax
801080ac:	8b 00                	mov    (%eax),%eax
801080ae:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801080b3:	89 04 24             	mov    %eax,(%esp)
801080b6:	e8 85 f4 ff ff       	call   80107540 <p2v>
801080bb:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801080be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080c1:	89 04 24             	mov    %eax,(%esp)
801080c4:	e8 a9 a9 ff ff       	call   80102a72 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801080c9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801080cd:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801080d4:	76 bb                	jbe    80108091 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801080dc:	e8 91 a9 ff ff       	call   80102a72 <kfree>
}
801080e1:	c9                   	leave  
801080e2:	c3                   	ret    
...
801080e6:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801080e9:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801080f0:	00 
...
801080fe:	e8 c0 f8 ff ff       	call   801079c3 <walkpgdir>
80108103:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108106:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010810a:	75 0c                	jne    80108118 <clearpteu+0x35>
    panic("clearpteu");
8010810c:	c7 04 24 9c 89 10 80 	movl   $0x8010899c,(%esp)
...
8010811f:	83 e2 fb             	and    $0xfffffffb,%edx
80108122:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108125:	89 10                	mov    %edx,(%eax)
}
80108127:	c9                   	leave  
80108128:	c3                   	ret    
...
8010812d:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108130:	e8 b8 f9 ff ff       	call   80107aed <setupkvm>
80108135:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108138:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010813c:	75 0a                	jne    80108148 <copyuvm+0x1f>
    return 0;
8010813e:	b8 00 00 00 00       	mov    $0x0,%eax
80108143:	e9 fd 00 00 00       	jmp    80108245 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108148:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010814f:	e9 cc 00 00 00       	jmp    80108220 <copyuvm+0xf7>
...
80108169:	e8 55 f8 ff ff       	call   801079c3 <walkpgdir>
8010816e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108171:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108175:	75 0c                	jne    80108183 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108177:	c7 04 24 a6 89 10 80 	movl   $0x801089a6,(%esp)
8010817e:	e8 ba 83 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108183:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108186:	8b 00                	mov    (%eax),%eax
80108188:	83 e0 01             	and    $0x1,%eax
8010818b:	85 c0                	test   %eax,%eax
8010818d:	75 0c                	jne    8010819b <copyuvm+0x72>
      panic("copyuvm: page not present");
8010818f:	c7 04 24 c0 89 10 80 	movl   $0x801089c0,(%esp)
80108196:	e8 a2 83 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
801081ad:	25 ff 0f 00 00       	and    $0xfff,%eax
801081b2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801081b5:	e8 51 a9 ff ff       	call   80102b0b <kalloc>
801081ba:	89 45 e0             	mov    %eax,-0x20(%ebp)
801081bd:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801081c1:	74 6e                	je     80108231 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801081c3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801081c6:	89 04 24             	mov    %eax,(%esp)
801081c9:	e8 72 f3 ff ff       	call   80107540 <p2v>
801081ce:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081d5:	00 
801081d6:	89 44 24 04          	mov    %eax,0x4(%esp)
801081da:	8b 45 e0             	mov    -0x20(%ebp),%eax
801081dd:	89 04 24             	mov    %eax,(%esp)
801081e0:	e8 18 ce ff ff       	call   80104ffd <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801081e5:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801081e8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801081eb:	89 04 24             	mov    %eax,(%esp)
801081ee:	e8 40 f3 ff ff       	call   80107533 <v2p>
801081f3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801081f6:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801081fa:	89 44 24 0c          	mov    %eax,0xc(%esp)
801081fe:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108205:	00 
80108206:	89 54 24 04          	mov    %edx,0x4(%esp)
8010820a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010820d:	89 04 24             	mov    %eax,(%esp)
80108210:	e8 44 f8 ff ff       	call   80107a59 <mappages>
80108215:	85 c0                	test   %eax,%eax
80108217:	78 1b                	js     80108234 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
...
80108226:	0f 82 28 ff ff ff    	jb     80108154 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010822f:	eb 14                	jmp    80108245 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108231:	90                   	nop
80108232:	eb 01                	jmp    80108235 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108234:	90                   	nop
...
8010823b:	e8 15 fe ff ff       	call   80108055 <freevm>
  return 0;
80108240:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108245:	83 c4 44             	add    $0x44,%esp
80108248:	5b                   	pop    %ebx
80108249:	5d                   	pop    %ebp
8010824a:	c3                   	ret    
...
8010824e:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108251:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108258:	00 
...
80108266:	e8 58 f7 ff ff       	call   801079c3 <walkpgdir>
...
801082a1:	e8 9a f2 ff ff       	call   80107540 <p2v>
}
801082a6:	c9                   	leave  
801082a7:	c3                   	ret    
...
801082b1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801082b4:	e9 8b 00 00 00       	jmp    80108344 <copyout+0x9c>
...
801082d1:	e8 75 ff ff ff       	call   8010824b <uva2ka>
801082d6:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801082d9:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801082dd:	75 07                	jne    801082e6 <copyout+0x3e>
      return -1;
801082df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801082e4:	eb 6d                	jmp    80108353 <copyout+0xab>
    n = PGSIZE - (va - va0);
801082e6:	8b 45 0c             	mov    0xc(%ebp),%eax
801082e9:	8b 55 ec             	mov    -0x14(%ebp),%edx
801082ec:	89 d1                	mov    %edx,%ecx
801082ee:	29 c1                	sub    %eax,%ecx
801082f0:	89 c8                	mov    %ecx,%eax
801082f2:	05 00 10 00 00       	add    $0x1000,%eax
801082f7:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801082fa:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082fd:	3b 45 14             	cmp    0x14(%ebp),%eax
80108300:	76 06                	jbe    80108308 <copyout+0x60>
      n = len;
80108302:	8b 45 14             	mov    0x14(%ebp),%eax
80108305:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108308:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010830b:	8b 55 0c             	mov    0xc(%ebp),%edx
8010830e:	89 d1                	mov    %edx,%ecx
80108310:	29 c1                	sub    %eax,%ecx
80108312:	89 c8                	mov    %ecx,%eax
80108314:	03 45 e8             	add    -0x18(%ebp),%eax
80108317:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010831a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010831e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108321:	89 54 24 04          	mov    %edx,0x4(%esp)
80108325:	89 04 24             	mov    %eax,(%esp)
80108328:	e8 d0 cc ff ff       	call   80104ffd <memmove>
    len -= n;
8010832d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108330:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108333:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108336:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108339:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010833c:	05 00 10 00 00       	add    $0x1000,%eax
80108341:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108344:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108348:	0f 85 6b ff ff ff    	jne    801082b9 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
