...
80100028:	bc 90 c6 10 80       	mov    $0x8010c690,%esp
  ...
  # for a direct jump.
  mov $main, %eax
8010002d:	b8 d4 34 10 80       	mov    $0x801034d4,%eax
  jmp *%eax
...
8010003a:	c7 44 24 04 a4 87 10 	movl   $0x801087a4,0x4(%esp)
80100041:	80 
...
8010004e:	c7 05 b0 05 11 80 a4 	movl   $0x801105a4,0x801105b0
80100055:	05 11 80 
  bcache.head.next = &bcache.head;
80100058:	c7 05 b4 05 11 80 a4 	movl   $0x801105a4,0x801105b4
8010005f:	05 11 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
80100062:	c7 45 f4 d4 c6 10 80 	movl   $0x8010c6d4,-0xc(%ebp)
80100069:	eb 3a                	jmp    801000a5 <binit+0x71>
    b->next = bcache.head.next;
8010006b:	8b 15 b4 05 11 80    	mov    0x801105b4,%edx
80100071:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100074:	89 50 10             	mov    %edx,0x10(%eax)
    b->prev = &bcache.head;
80100077:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010007a:	c7 40 0c a4 05 11 80 	movl   $0x801105a4,0xc(%eax)
    b->dev = -1;
80100081:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100084:	c7 40 04 ff ff ff ff 	movl   $0xffffffff,0x4(%eax)
    bcache.head.next->prev = b;
8010008b:	a1 b4 05 11 80       	mov    0x801105b4,%eax
80100090:	8b 55 f4             	mov    -0xc(%ebp),%edx
80100093:	89 50 0c             	mov    %edx,0xc(%eax)
    bcache.head.next = b;
80100096:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100099:	a3 b4 05 11 80       	mov    %eax,0x801105b4
...
801000a5:	81 7d f4 a4 05 11 80 	cmpl   $0x801105a4,-0xc(%ebp)
...
801000bd:	e8 b5 4c 00 00       	call   80104d77 <acquire>

 loop:
  // Is the sector already cached?
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000c2:	a1 b4 05 11 80       	mov    0x801105b4,%eax
...
80100104:	e8 d0 4c 00 00       	call   80104dd9 <release>
        return b;
...
8010011f:	e8 80 49 00 00       	call   80104aa4 <sleep>
      goto loop;
...
8010012f:	81 7d f4 a4 05 11 80 	cmpl   $0x801105a4,-0xc(%ebp)
...
80100138:	a1 b0 05 11 80       	mov    0x801105b0,%eax
...
8010017c:	e8 58 4c 00 00       	call   80104dd9 <release>
      return b;
...
8010018f:	81 7d f4 a4 05 11 80 	cmpl   $0x801105a4,-0xc(%ebp)
...
80100198:	c7 04 24 ab 87 10 80 	movl   $0x801087ab,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 bc 87 10 80 	movl   $0x801087bc,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 c3 87 10 80 	movl   $0x801087c3,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
8010023c:	e8 36 4b 00 00       	call   80104d77 <acquire>
...
8010025c:	89 50 10             	mov    %edx,0x10(%eax)
  b->next = bcache.head.next;
8010025f:	8b 15 b4 05 11 80    	mov    0x801105b4,%edx
80100265:	8b 45 08             	mov    0x8(%ebp),%eax
80100268:	89 50 10             	mov    %edx,0x10(%eax)
  b->prev = &bcache.head;
8010026b:	8b 45 08             	mov    0x8(%ebp),%eax
8010026e:	c7 40 0c a4 05 11 80 	movl   $0x801105a4,0xc(%eax)
  bcache.head.next->prev = b;
80100275:	a1 b4 05 11 80       	mov    0x801105b4,%eax
8010027a:	8b 55 08             	mov    0x8(%ebp),%edx
8010027d:	89 50 0c             	mov    %edx,0xc(%eax)
  bcache.head.next = b;
80100280:	8b 45 08             	mov    0x8(%ebp),%eax
80100283:	a3 b4 05 11 80       	mov    %eax,0x801105b4
...
8010029d:	e8 de 48 00 00       	call   80104b80 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 a0 c6 10 80 	movl   $0x8010c6a0,(%esp)
801002a9:	e8 2b 4b 00 00       	call   80104dd9 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003a6:	a1 34 b6 10 80       	mov    0x8010b634,%eax
801003ab:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(locking)
801003ae:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801003b2:	74 0c                	je     801003c0 <cprintf+0x20>
    acquire(&cons.lock);
801003b4:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
801003bb:	e8 b7 49 00 00       	call   80104d77 <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 ca 87 10 80 	movl   $0x801087ca,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec d3 87 10 80 	movl   $0x801087d3,-0x14(%ebp)
      for(; *s; s++)
...
8010052a:	74 0c                	je     80100538 <cprintf+0x198>
    release(&cons.lock);
8010052c:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80100533:	e8 a1 48 00 00       	call   80104dd9 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
80100540:	e8 a6 fd ff ff       	call   801002eb <cli>
  cons.locking = 0;
80100545:	c7 05 34 b6 10 80 00 	movl   $0x0,0x8010b634
8010054c:	00 00 00 
...
8010055f:	c7 04 24 da 87 10 80 	movl   $0x801087da,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 e9 87 10 80 	movl   $0x801087e9,(%esp)
...
8010058f:	e8 94 48 00 00       	call   80104e28 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 eb 87 10 80 	movl   $0x801087eb,(%esp)
...
801005be:	c7 05 e0 b5 10 80 01 	movl   $0x1,0x8010b5e0
801005c5:	00 00 00 
  for(;;)
    ;
...
801006b2:	e8 e3 49 00 00       	call   8010509a <memmove>
    pos -= 80;
...
801006e1:	e8 e5 48 00 00       	call   80104fcb <memset>
  }
...
80100753:	83 ec 18             	sub    $0x18,%esp
  if(panicked){
80100756:	a1 e0 b5 10 80       	mov    0x8010b5e0,%eax
...
80100776:	e8 69 66 00 00       	call   80106de4 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 5d 66 00 00       	call   80106de4 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 51 66 00 00       	call   80106de4 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 44 66 00 00       	call   80106de4 <uartputc>
  cgaputc(c);
...
801007b0:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&input.lock);
801007b3:	c7 04 24 c0 07 11 80 	movl   $0x801107c0,(%esp)
801007ba:	e8 b8 45 00 00       	call   80104d77 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 37 44 00 00       	call   80104c26 <procdump>
      break;
801007ef:	e9 07 01 00 00       	jmp    801008fb <consoleintr+0x14e>
    case C('U'):  // Kill line.
      while(input.e != input.w &&
        ...
        input.e--;
801007f4:	a1 7c 08 11 80       	mov    0x8011087c,%eax
801007f9:	83 e8 01             	sub    $0x1,%eax
801007fc:	a3 7c 08 11 80       	mov    %eax,0x8011087c
        consputc(BACKSPACE);
...
8010080d:	eb 01                	jmp    80100810 <consoleintr+0x63>
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
8010080f:	90                   	nop
80100810:	8b 15 7c 08 11 80    	mov    0x8011087c,%edx
80100816:	a1 78 08 11 80       	mov    0x80110878,%eax
8010081b:	39 c2                	cmp    %eax,%edx
8010081d:	74 16                	je     80100835 <consoleintr+0x88>
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
8010081f:	a1 7c 08 11 80       	mov    0x8011087c,%eax
80100824:	83 e8 01             	sub    $0x1,%eax
80100827:	83 e0 7f             	and    $0x7f,%eax
8010082a:	0f b6 80 f4 07 11 80 	movzbl -0x7feef80c(%eax),%eax
    switch(c){
    case C('P'):  // Process listing.
      procdump();
      break;
...
80100835:	e9 c1 00 00 00       	jmp    801008fb <consoleintr+0x14e>
    case C('H'): case '\x7f':  // Backspace
      if(input.e != input.w){
8010083a:	8b 15 7c 08 11 80    	mov    0x8011087c,%edx
80100840:	a1 78 08 11 80       	mov    0x80110878,%eax
80100845:	39 c2                	cmp    %eax,%edx
80100847:	74 1e                	je     80100867 <consoleintr+0xba>
        input.e--;
80100849:	a1 7c 08 11 80       	mov    0x8011087c,%eax
8010084e:	83 e8 01             	sub    $0x1,%eax
80100851:	a3 7c 08 11 80       	mov    %eax,0x8011087c
        consputc(BACKSPACE);
...
80100876:	8b 15 7c 08 11 80    	mov    0x8011087c,%edx
8010087c:	a1 74 08 11 80       	mov    0x80110874,%eax
...
8010089d:	a1 7c 08 11 80       	mov    0x8011087c,%eax
801008a2:	8d 50 01             	lea    0x1(%eax),%edx
801008a5:	89 15 7c 08 11 80    	mov    %edx,0x8011087c
801008ab:	83 e0 7f             	and    $0x7f,%eax
801008ae:	89 c2                	mov    %eax,%edx
801008b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801008b3:	88 82 f4 07 11 80    	mov    %al,-0x7feef80c(%edx)
        consputc(c);
...
801008d0:	a1 7c 08 11 80       	mov    0x8011087c,%eax
801008d5:	8b 15 74 08 11 80    	mov    0x80110874,%edx
801008db:	83 ea 80             	sub    $0xffffff80,%edx
801008de:	39 d0                	cmp    %edx,%eax
801008e0:	75 18                	jne    801008fa <consoleintr+0x14d>
          input.w = input.e;
801008e2:	a1 7c 08 11 80       	mov    0x8011087c,%eax
801008e7:	a3 78 08 11 80       	mov    %eax,0x80110878
          wakeup(&input.r);
801008ec:	c7 04 24 74 08 11 80 	movl   $0x80110874,(%esp)
801008f3:	e8 88 42 00 00       	call   80104b80 <wakeup>
        }
      }
      break;
...
80100907:	0f 89 b7 fe ff ff    	jns    801007c4 <consoleintr+0x17>
  ...
  release(&input.lock);
8010090d:	c7 04 24 c0 07 11 80 	movl   $0x801107c0,(%esp)
80100914:	e8 c0 44 00 00       	call   80104dd9 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
8010092f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  acquire(&input.lock);
80100932:	c7 04 24 c0 07 11 80 	movl   $0x801107c0,(%esp)
80100939:	e8 39 44 00 00       	call   80104d77 <acquire>
  while(n > 0){
...
80100950:	74 21                	je     80100973 <consoleread+0x58>
        release(&input.lock);
80100952:	c7 04 24 c0 07 11 80 	movl   $0x801107c0,(%esp)
80100959:	e8 7b 44 00 00       	call   80104dd9 <release>
        ilock(ip);
...
80100973:	c7 44 24 04 c0 07 11 	movl   $0x801107c0,0x4(%esp)
8010097a:	80 
8010097b:	c7 04 24 74 08 11 80 	movl   $0x80110874,(%esp)
80100982:	e8 1d 41 00 00       	call   80104aa4 <sleep>
  ...
  while(n > 0){
    while(input.r == input.w){
80100987:	8b 15 74 08 11 80    	mov    0x80110874,%edx
8010098d:	a1 78 08 11 80       	mov    0x80110878,%eax
...
80100996:	a1 74 08 11 80       	mov    0x80110874,%eax
8010099b:	8d 50 01             	lea    0x1(%eax),%edx
8010099e:	89 15 74 08 11 80    	mov    %edx,0x80110874
801009a4:	83 e0 7f             	and    $0x7f,%eax
801009a7:	0f b6 80 f4 07 11 80 	movzbl -0x7feef80c(%eax),%eax
...
801009c0:	73 0f                	jae    801009d1 <consoleread+0xb6>
        ...
        input.r--;
801009c2:	a1 74 08 11 80       	mov    0x80110874,%eax
801009c7:	83 e8 01             	sub    $0x1,%eax
801009ca:	a3 74 08 11 80       	mov    %eax,0x80110874
      }
      break;
...
801009f1:	0f 8f 4c ff ff ff    	jg     80100943 <consoleread+0x28>
  ...
  release(&input.lock);
801009f7:	c7 04 24 c0 07 11 80 	movl   $0x801107c0,(%esp)
801009fe:	e8 d6 43 00 00       	call   80104dd9 <release>
  ilock(ip);
...
80100a26:	e8 7e 0f 00 00       	call   801019a9 <iunlock>
  acquire(&cons.lock);
80100a2b:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80100a32:	e8 40 43 00 00       	call   80104d77 <acquire>
  for(i = 0; i < n; i++)
...
80100a63:	7c db                	jl     80100a40 <consolewrite+0x26>
    consputc(buf[i] & 0xff);
  release(&cons.lock);
80100a65:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80100a6c:	e8 68 43 00 00       	call   80104dd9 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 ef 87 10 	movl   $0x801087ef,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80100a96:	e8 bb 42 00 00       	call   80104d56 <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 f7 87 10 	movl   $0x801087f7,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 c0 07 11 80 	movl   $0x801107c0,(%esp)
80100aaa:	e8 a7 42 00 00       	call   80104d56 <initlock>

  devsw[CONSOLE].write = consolewrite;
80100aaf:	c7 05 2c 12 11 80 1a 	movl   $0x80100a1a,0x8011122c
80100ab6:	0a 10 80 
  devsw[CONSOLE].read = consoleread;
80100ab9:	c7 05 28 12 11 80 1b 	movl   $0x8010091b,0x80111228
80100ac0:	09 10 80 
  cons.locking = 1;
80100ac3:	c7 05 34 b6 10 80 01 	movl   $0x1,0x8010b634
80100aca:	00 00 00 

  picenable(IRQ_KBD);
80100acd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80100ad4:	e8 98 30 00 00       	call   80103b71 <picenable>
...
80100af2:	81 ec 38 01 00 00    	sub    $0x138,%esp
  ...
  begin_op();
80100af8:	e8 e8 26 00 00       	call   801031e5 <begin_op>
  if((ip = namei(path)) == 0){
...
80100b0f:	75 0f                	jne    80100b20 <exec+0x31>
    end_op();
80100b11:	e8 53 27 00 00       	call   80103269 <end_op>
    return -1;
...
80100b6e:	e9 69 03 00 00       	jmp    80100edc <exec+0x3ed>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 bd 73 00 00       	call   80107f35 <setupkvm>
...
80100c14:	e8 ea 76 00 00       	call   80108303 <allocuvm>
...
80100c52:	e8 c1 75 00 00       	call   80108218 <loaduvm>
...
80100c86:	e8 54 0e 00 00       	call   80101adf <iunlockput>
  end_op();
80100c8b:	e8 d9 25 00 00       	call   80103269 <end_op>
  ip = 0;
...
80100cc0:	e8 3e 76 00 00       	call   80108303 <allocuvm>
...
80100ce5:	e8 49 78 00 00       	call   80108533 <clearpteu>
  sp = sz;
...
80100d1b:	e8 15 45 00 00       	call   80105235 <strlen>
...
80100d44:	e8 ec 44 00 00       	call   80105235 <strlen>
...
80100d74:	e8 7f 79 00 00       	call   801086f8 <copyout>
...
80100e1b:	e8 d8 78 00 00       	call   801086f8 <copyout>
...
80100e73:	e8 73 43 00 00       	call   801051eb <safestrcpy>
...
80100ec5:	e8 5c 71 00 00       	call   80108026 <switchuvm>
  freevm(oldpgdir);
80100eca:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ecd:	89 04 24             	mov    %eax,(%esp)
80100ed0:	e8 c4 75 00 00       	call   80108499 <freevm>
  return 0;
...
80100ee8:	e8 ac 75 00 00       	call   80108499 <freevm>
  if(ip){
...
80100ef9:	e8 e1 0b 00 00       	call   80101adf <iunlockput>
    end_op();
80100efe:	e8 66 23 00 00       	call   80103269 <end_op>
  }
  return -1;
...
80100f10:	c7 44 24 04 fd 87 10 	movl   $0x801087fd,0x4(%esp)
80100f17:	80 
80100f18:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80100f1f:	e8 32 3e 00 00       	call   80104d56 <initlock>
}
80100f24:	c9                   	leave  
80100f25:	c3                   	ret    
...
80100f29:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ftable.lock);
80100f2c:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80100f33:	e8 3f 3e 00 00       	call   80104d77 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80100f38:	c7 45 f4 b4 08 11 80 	movl   $0x801108b4,-0xc(%ebp)
...
80100f4e:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
      release(&ftable.lock);
80100f55:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80100f5c:	e8 78 3e 00 00       	call   80104dd9 <release>
      return f;
...
80100f6a:	81 7d f4 14 12 11 80 	cmpl   $0x80111214,-0xc(%ebp)
80100f71:	72 ce                	jb     80100f41 <filealloc+0x1b>
  ...
  release(&ftable.lock);
80100f73:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80100f7a:	e8 5a 3e 00 00       	call   80104dd9 <release>
  return 0;
...
80100f89:	83 ec 18             	sub    $0x18,%esp
  acquire(&ftable.lock);
80100f8c:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80100f93:	e8 df 3d 00 00       	call   80104d77 <acquire>
  if(f->ref < 1)
...
80100fa0:	7f 0c                	jg     80100fae <filedup+0x28>
    panic("filedup");
80100fa2:	c7 04 24 04 88 10 80 	movl   $0x80108804,(%esp)
...
80100fba:	89 50 04             	mov    %edx,0x4(%eax)
  release(&ftable.lock);
80100fbd:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80100fc4:	e8 10 3e 00 00       	call   80104dd9 <release>
  return f;
...
80100fd1:	83 ec 38             	sub    $0x38,%esp
  ...
  acquire(&ftable.lock);
80100fd4:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80100fdb:	e8 97 3d 00 00       	call   80104d77 <acquire>
  if(f->ref < 1)
...
80100fe8:	7f 0c                	jg     80100ff6 <fileclose+0x28>
    panic("fileclose");
80100fea:	c7 04 24 0c 88 10 80 	movl   $0x8010880c,(%esp)
...
8010100d:	7e 11                	jle    80101020 <fileclose+0x52>
    release(&ftable.lock);
8010100f:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80101016:	e8 be 3d 00 00       	call   80104dd9 <release>
...
80101053:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  release(&ftable.lock);
80101059:	c7 04 24 80 08 11 80 	movl   $0x80110880,(%esp)
80101060:	e8 74 3d 00 00       	call   80104dd9 <release>
...
8010107e:	e8 9e 2d 00 00       	call   80103e21 <pipeclose>
...
8010112f:	e8 6e 2e 00 00       	call   80103fa2 <piperead>
...
8010119f:	eb 0c                	jmp    801011ad <fileread+0xba>
  ...
  panic("fileread");
801011a1:	c7 04 24 16 88 10 80 	movl   $0x80108816,(%esp)
...
801011ec:	e8 c2 2c 00 00       	call   80103eb3 <pipewrite>
...
8010122f:	89 45 f0             	mov    %eax,-0x10(%ebp)
      ...
      begin_op();
80101232:	e8 ae 1f 00 00       	call   801031e5 <begin_op>
      ilock(f->ip);
...
80101293:	e8 11 07 00 00       	call   801019a9 <iunlock>
      end_op();
80101298:	e8 cc 1f 00 00       	call   80103269 <end_op>
...
801012ad:	c7 04 24 1f 88 10 80 	movl   $0x8010881f,(%esp)
...
801012dd:	eb 0c                	jmp    801012eb <filewrite+0x13c>
  ...
  panic("filewrite");
801012df:	c7 04 24 2f 88 10 80 	movl   $0x8010882f,(%esp)
...
80101325:	e8 70 3d 00 00       	call   8010509a <memmove>
  brelse(bp);
...
8010136b:	e8 5b 3c 00 00       	call   80104fcb <memset>
  log_write(bp);
80101370:	8b 45 f4             	mov    -0xc(%ebp),%eax
80101373:	89 04 24             	mov    %eax,(%esp)
80101376:	e8 75 20 00 00       	call   801033f0 <log_write>
  brelse(bp);
...
80101455:	e8 96 1f 00 00       	call   801033f0 <log_write>
        brelse(bp);
...
801014c8:	c7 04 24 39 88 10 80 	movl   $0x80108839,(%esp)
...
8010155a:	c7 04 24 4f 88 10 80 	movl   $0x8010884f,(%esp)
...
80101592:	e8 59 1e 00 00       	call   801033f0 <log_write>
  brelse(bp);
...
801015aa:	c7 44 24 04 62 88 10 	movl   $0x80108862,0x4(%esp)
801015b1:	80 
801015b2:	c7 04 24 80 12 11 80 	movl   $0x80111280,(%esp)
801015b9:	e8 98 37 00 00       	call   80104d56 <initlock>
}
801015be:	c9                   	leave  
801015bf:	c3                   	ret    
...
8010163b:	e8 8b 39 00 00       	call   80104fcb <memset>
      dip->type = type;
...
80101650:	e8 9b 1d 00 00       	call   801033f0 <log_write>
      brelse(bp);
...
80101691:	c7 04 24 69 88 10 80 	movl   $0x80108869,(%esp)
...
8010173a:	e8 5b 39 00 00       	call   8010509a <memmove>
  log_write(bp);
8010173f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80101742:	89 04 24             	mov    %eax,(%esp)
80101745:	e8 a6 1c 00 00       	call   801033f0 <log_write>
  brelse(bp);
...
80101764:	e8 0e 36 00 00       	call   80104d77 <acquire>
...
801017ae:	e8 26 36 00 00       	call   80104dd9 <release>
      return ip;
...
801017e1:	c7 04 24 7b 88 10 80 	movl   $0x8010887b,(%esp)
...
8010181f:	e8 b5 35 00 00       	call   80104dd9 <release>
...
80101836:	e8 3c 35 00 00       	call   80104d77 <acquire>
  ip->ref++;
...
80101851:	e8 83 35 00 00       	call   80104dd9 <release>
  return ip;
...
8010186f:	7f 0c                	jg     8010187d <ilock+0x22>
    panic("ilock");
80101871:	c7 04 24 8b 88 10 80 	movl   $0x8010888b,(%esp)
80101878:	e8 bd ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
8010187d:	c7 04 24 80 12 11 80 	movl   $0x80111280,(%esp)
80101884:	e8 ee 34 00 00       	call   80104d77 <acquire>
...
80101899:	e8 06 32 00 00       	call   80104aa4 <sleep>
...
801018c3:	e8 11 35 00 00       	call   80104dd9 <release>
...
8010196e:	e8 27 37 00 00       	call   8010509a <memmove>
    brelse(bp);
...
80101999:	75 0c                	jne    801019a7 <ilock+0x14c>
      panic("ilock: no type");
8010199b:	c7 04 24 91 88 10 80 	movl   $0x80108891,(%esp)
...
801019ca:	7f 0c                	jg     801019d8 <iunlock+0x2f>
    panic("iunlock");
801019cc:	c7 04 24 a0 88 10 80 	movl   $0x801088a0,(%esp)
801019d3:	e8 62 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019d8:	c7 04 24 80 12 11 80 	movl   $0x80111280,(%esp)
801019df:	e8 93 33 00 00       	call   80104d77 <acquire>
  ip->flags &= ~I_BUSY;
...
801019fb:	e8 80 31 00 00       	call   80104b80 <wakeup>
  release(&icache.lock);
80101a00:	c7 04 24 80 12 11 80 	movl   $0x80111280,(%esp)
80101a07:	e8 cd 33 00 00       	call   80104dd9 <release>
}
80101a0c:	c9                   	leave  
80101a0d:	c3                   	ret    
...
80101a1b:	e8 57 33 00 00       	call   80104d77 <acquire>
...
80101a57:	74 0c                	je     80101a65 <iput+0x57>
      panic("iput busy");
80101a59:	c7 04 24 a8 88 10 80 	movl   $0x801088a8,(%esp)
...
80101a7d:	e8 57 33 00 00       	call   80104dd9 <release>
    itrunc(ip);
...
80101aa8:	e8 ca 32 00 00       	call   80104d77 <acquire>
    ip->flags = 0;
...
80101abd:	e8 be 30 00 00       	call   80104b80 <wakeup>
  }
  ip->ref--;
...
80101ad8:	e8 fc 32 00 00       	call   80104dd9 <release>
}
80101add:	c9                   	leave  
80101ade:	c3                   	ret    
...
80101be3:	e8 08 18 00 00       	call   801033f0 <log_write>
    }
    brelse(bp);
...
80101bf8:	c7 04 24 b2 88 10 80 	movl   $0x801088b2,(%esp)
...
80101d9b:	98                   	cwtl   
80101d9c:	8b 04 c5 20 12 11 80 	mov    -0x7feeede0(,%eax,8),%eax
...
80101db8:	98                   	cwtl   
80101db9:	8b 04 c5 20 12 11 80 	mov    -0x7feeede0(,%eax,8),%eax
...
80101e99:	e8 fc 31 00 00       	call   8010509a <memmove>
    brelse(bp);
...
80101eff:	98                   	cwtl   
80101f00:	8b 04 c5 24 12 11 80 	mov    -0x7feeeddc(,%eax,8),%eax
...
80101f1c:	98                   	cwtl   
80101f1d:	8b 04 c5 24 12 11 80 	mov    -0x7feeeddc(,%eax,8),%eax
...
80101ff8:	e8 9d 30 00 00       	call   8010509a <memmove>
    log_write(bp);
80101ffd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80102000:	89 04 24             	mov    %eax,(%esp)
80102003:	e8 e8 13 00 00       	call   801033f0 <log_write>
    brelse(bp);
...
80102076:	e8 c2 30 00 00       	call   8010513d <strncmp>
}
8010207b:	c9                   	leave  
8010207c:	c3                   	ret    
...
80102090:	c7 04 24 c5 88 10 80 	movl   $0x801088c5,(%esp)
...
801020cc:	74 0c                	je     801020da <dirlookup+0x5d>
      panic("dirlink read");
801020ce:	c7 04 24 d7 88 10 80 	movl   $0x801088d7,(%esp)
...
801021b1:	74 0c                	je     801021bf <dirlink+0x79>
      panic("dirlink read");
801021b3:	c7 04 24 d7 88 10 80 	movl   $0x801088d7,(%esp)
...
801021f8:	e8 96 2f 00 00       	call   80105193 <strncpy>
  de.inum = inum;
...
80102228:	74 0c                	je     80102236 <dirlink+0xf0>
    panic("dirlink");
8010222a:	c7 04 24 e4 88 10 80 	movl   $0x801088e4,(%esp)
...
801022af:	e8 e6 2d 00 00       	call   8010509a <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022ca:	e8 cb 2d 00 00       	call   8010509a <memmove>
    name[len] = 0;
...
80102519:	c7 44 24 04 ec 88 10 	movl   $0x801088ec,0x4(%esp)
80102520:	80 
80102521:	c7 04 24 40 b6 10 80 	movl   $0x8010b640,(%esp)
80102528:	e8 29 28 00 00       	call   80104d56 <initlock>
  picenable(IRQ_IDE);
8010252d:	c7 04 24 0e 00 00 00 	movl   $0xe,(%esp)
80102534:	e8 38 16 00 00       	call   80103b71 <picenable>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102539:	a1 80 29 11 80       	mov    0x80112980,%eax
...
80102588:	74 0c                	je     80102596 <ideinit+0x83>
      havedisk1 = 1;
8010258a:	c7 05 78 b6 10 80 01 	movl   $0x1,0x8010b678
80102591:	00 00 00 
      break;
...
801025c3:	75 0c                	jne    801025d1 <idestart+0x18>
    panic("idestart");
801025c5:	c7 04 24 f0 88 10 80 	movl   $0x801088f0,(%esp)
...
801026e1:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&idelock);
801026e4:	c7 04 24 40 b6 10 80 	movl   $0x8010b640,(%esp)
801026eb:	e8 87 26 00 00       	call   80104d77 <acquire>
  if((b = idequeue) == 0){
801026f0:	a1 74 b6 10 80       	mov    0x8010b674,%eax
801026f5:	89 45 f4             	mov    %eax,-0xc(%ebp)
801026f8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801026fc:	75 11                	jne    8010270f <ideintr+0x31>
    release(&idelock);
801026fe:	c7 04 24 40 b6 10 80 	movl   $0x8010b640,(%esp)
80102705:	e8 cf 26 00 00       	call   80104dd9 <release>
...
80102715:	a3 74 b6 10 80       	mov    %eax,0x8010b674
...
80102778:	e8 03 24 00 00       	call   80104b80 <wakeup>
  
  // Start disk on next buf in queue.
  if(idequeue != 0)
8010277d:	a1 74 b6 10 80       	mov    0x8010b674,%eax
80102782:	85 c0                	test   %eax,%eax
80102784:	74 0d                	je     80102793 <ideintr+0xb5>
    idestart(idequeue);
80102786:	a1 74 b6 10 80       	mov    0x8010b674,%eax
8010278b:	89 04 24             	mov    %eax,(%esp)
8010278e:	e8 26 fe ff ff       	call   801025b9 <idestart>

  release(&idelock);
80102793:	c7 04 24 40 b6 10 80 	movl   $0x8010b640,(%esp)
8010279a:	e8 3a 26 00 00       	call   80104dd9 <release>
}
8010279f:	c9                   	leave  
801027a0:	c3                   	ret    
...
801027b3:	c7 04 24 f9 88 10 80 	movl   $0x801088f9,(%esp)
...
801027cc:	c7 04 24 0d 89 10 80 	movl   $0x8010890d,(%esp)
...
801027e2:	a1 78 b6 10 80       	mov    0x8010b678,%eax
801027e7:	85 c0                	test   %eax,%eax
801027e9:	75 0c                	jne    801027f7 <iderw+0x56>
    panic("iderw: ide disk 1 not present");
801027eb:	c7 04 24 22 89 10 80 	movl   $0x80108922,(%esp)
801027f2:	e8 43 dd ff ff       	call   8010053a <panic>

  acquire(&idelock);  //DOC:acquire-lock
801027f7:	c7 04 24 40 b6 10 80 	movl   $0x8010b640,(%esp)
801027fe:	e8 74 25 00 00       	call   80104d77 <acquire>
...
8010280d:	c7 45 f4 74 b6 10 80 	movl   $0x8010b674,-0xc(%ebp)
...
80102830:	89 10                	mov    %edx,(%eax)
  ...
  if(idequeue == b)
80102832:	a1 74 b6 10 80       	mov    0x8010b674,%eax
...
80102849:	eb 13                	jmp    8010285e <iderw+0xbd>
    sleep(b, &idelock);
8010284b:	c7 44 24 04 40 b6 10 	movl   $0x8010b640,0x4(%esp)
80102852:	80 
80102853:	8b 45 08             	mov    0x8(%ebp),%eax
80102856:	89 04 24             	mov    %eax,(%esp)
80102859:	e8 46 22 00 00       	call   80104aa4 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102869:	75 e0                	jne    8010284b <iderw+0xaa>
  ...
  release(&idelock);
8010286b:	c7 04 24 40 b6 10 80 	movl   $0x8010b640,(%esp)
80102872:	e8 62 25 00 00       	call   80104dd9 <release>
}
80102877:	c9                   	leave  
80102878:	c3                   	ret    
...
8010287a:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
8010287c:	a1 54 22 11 80       	mov    0x80112254,%eax
80102881:	8b 55 08             	mov    0x8(%ebp),%edx
80102884:	89 10                	mov    %edx,(%eax)
  return ioapic->data;
80102886:	a1 54 22 11 80       	mov    0x80112254,%eax
...
80102891:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
80102893:	a1 54 22 11 80       	mov    0x80112254,%eax
80102898:	8b 55 08             	mov    0x8(%ebp),%edx
8010289b:	89 10                	mov    %edx,(%eax)
  ioapic->data = data;
8010289d:	a1 54 22 11 80       	mov    0x80112254,%eax
...
801028ad:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!ismp)
801028b0:	a1 84 23 11 80       	mov    0x80112384,%eax
...
801028be:	c7 05 54 22 11 80 00 	movl   $0xfec00000,0x80112254
801028c5:	00 c0 fe 
...
80102960:	83 ec 08             	sub    $0x8,%esp
  if(!ismp)
80102963:	a1 84 23 11 80       	mov    0x80112384,%eax
...
801029ba:	c7 44 24 04 72 89 10 	movl   $0x80108972,0x4(%esp)
801029c1:	80 
801029c2:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
801029c9:	e8 88 23 00 00       	call   80104d56 <initlock>
  kmem.use_lock = 0;
801029ce:	c7 05 94 22 11 80 00 	movl   $0x0,0x80112294
801029d5:	00 00 00 
...
801029ff:	e8 0c 00 00 00       	call   80102a10 <freerange>
  kmem.use_lock = 1;
80102a04:	c7 05 94 22 11 80 01 	movl   $0x1,0x80112294
80102a0b:	00 00 00 
}
80102a0e:	c9                   	leave  
80102a0f:	c3                   	ret    
...
80102a5b:	81 7d 08 7c 86 11 80 	cmpl   $0x8011867c,0x8(%ebp)
...
80102a74:	76 0c                	jbe    80102a82 <kfree+0x39>
    panic("kfree");
80102a76:	c7 04 24 77 89 10 80 	movl   $0x80108977,(%esp)
...
80102a98:	e8 2e 25 00 00       	call   80104fcb <memset>

  if(kmem.use_lock)
80102a9d:	a1 94 22 11 80       	mov    0x80112294,%eax
80102aa2:	85 c0                	test   %eax,%eax
80102aa4:	74 0c                	je     80102ab2 <kfree+0x69>
    acquire(&kmem.lock);
80102aa6:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80102aad:	e8 c5 22 00 00       	call   80104d77 <acquire>
  r = (struct run*)v;
80102ab2:	8b 45 08             	mov    0x8(%ebp),%eax
80102ab5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  r->next = kmem.freelist;
80102ab8:	8b 15 98 22 11 80    	mov    0x80112298,%edx
80102abe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102ac1:	89 10                	mov    %edx,(%eax)
  kmem.freelist = r;
80102ac3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102ac6:	a3 98 22 11 80       	mov    %eax,0x80112298
  if(kmem.use_lock)
80102acb:	a1 94 22 11 80       	mov    0x80112294,%eax
80102ad0:	85 c0                	test   %eax,%eax
80102ad2:	74 0c                	je     80102ae0 <kfree+0x97>
    release(&kmem.lock);
80102ad4:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80102adb:	e8 f9 22 00 00       	call   80104dd9 <release>
}
80102ae0:	c9                   	leave  
80102ae1:	c3                   	ret    
...
80102ae5:	83 ec 28             	sub    $0x28,%esp
  ...
  if(kmem.use_lock)
80102ae8:	a1 94 22 11 80       	mov    0x80112294,%eax
80102aed:	85 c0                	test   %eax,%eax
80102aef:	74 0c                	je     80102afd <kalloc+0x1b>
    acquire(&kmem.lock);
80102af1:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80102af8:	e8 7a 22 00 00       	call   80104d77 <acquire>
  r = kmem.freelist;
80102afd:	a1 98 22 11 80       	mov    0x80112298,%eax
...
80102b10:	a3 98 22 11 80       	mov    %eax,0x80112298
  if(kmem.use_lock)
80102b15:	a1 94 22 11 80       	mov    0x80112294,%eax
80102b1a:	85 c0                	test   %eax,%eax
80102b1c:	74 0c                	je     80102b2a <kalloc+0x48>
    release(&kmem.lock);
80102b1e:	c7 04 24 60 22 11 80 	movl   $0x80112260,(%esp)
80102b25:	e8 af 22 00 00       	call   80104dd9 <release>
  return (char*)r;
...
80102b91:	75 17                	jne    80102baa <kbdgetc+0x5e>
    shift |= E0ESC;
80102b93:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
80102b98:	83 c8 40             	or     $0x40,%eax
80102b9b:	a3 7c b6 10 80       	mov    %eax,0x8010b67c
    return 0;
...
80102bb6:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
...
80102be5:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
80102bea:	21 d0                	and    %edx,%eax
80102bec:	a3 7c b6 10 80       	mov    %eax,0x8010b67c
    return 0;
80102bf1:	b8 00 00 00 00       	mov    $0x0,%eax
80102bf6:	e9 a2 00 00 00       	jmp    80102c9d <kbdgetc+0x151>
  } else if(shift & E0ESC){
80102bfb:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
...
80102c07:	81 4d fc 80 00 00 00 	orl    $0x80,-0x4(%ebp)
    shift &= ~E0ESC;
80102c0e:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
80102c13:	83 e0 bf             	and    $0xffffffbf,%eax
80102c16:	a3 7c b6 10 80       	mov    %eax,0x8010b67c
  }
...
80102c29:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
80102c2e:	09 d0                	or     %edx,%eax
80102c30:	a3 7c b6 10 80       	mov    %eax,0x8010b67c
...
80102c43:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
80102c48:	31 d0                	xor    %edx,%eax
80102c4a:	a3 7c b6 10 80       	mov    %eax,0x8010b67c
  c = charcode[shift & (CTL | SHIFT)][data];
80102c4f:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
...
80102c69:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(shift & CAPSLOCK){
80102c6c:	a1 7c b6 10 80       	mov    0x8010b67c,%eax
...
80102ce2:	89 e5                	mov    %esp,%ebp
  lapic[index] = value;
80102ce4:	a1 9c 22 11 80       	mov    0x8011229c,%eax
...
80102cf6:	a1 9c 22 11 80       	mov    0x8011229c,%eax
...
80102d05:	83 ec 08             	sub    $0x8,%esp
  if(!lapic) 
80102d08:	a1 9c 22 11 80       	mov    0x8011229c,%eax
...
80102d8e:	a1 9c 22 11 80       	mov    0x8011229c,%eax
...
80102e2f:	90                   	nop
80102e30:	a1 9c 22 11 80       	mov    0x8011229c,%eax
...
80102e6d:	74 25                	je     80102e94 <cpunum+0x39>
    static int n;
    if(n++ == 0)
80102e6f:	a1 80 b6 10 80       	mov    0x8010b680,%eax
80102e74:	8d 50 01             	lea    0x1(%eax),%edx
80102e77:	89 15 80 b6 10 80    	mov    %edx,0x8010b680
...
80102e88:	c7 04 24 80 89 10 80 	movl   $0x80108980,(%esp)
80102e8f:	e8 0c d5 ff ff       	call   801003a0 <cprintf>
        __builtin_return_address(0));
  }

  if(lapic)
80102e94:	a1 9c 22 11 80       	mov    0x8011229c,%eax
80102e99:	85 c0                	test   %eax,%eax
80102e9b:	74 0f                	je     80102eac <cpunum+0x51>
    return lapic[ID]>>24;
80102e9d:	a1 9c 22 11 80       	mov    0x8011229c,%eax
...
80102eb6:	83 ec 08             	sub    $0x8,%esp
  if(lapic)
80102eb9:	a1 9c 22 11 80       	mov    0x8011229c,%eax
...
80102fdd:	c7 44 24 04 ac 89 10 	movl   $0x801089ac,0x4(%esp)
80102fe4:	80 
80102fe5:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80102fec:	e8 65 1d 00 00       	call   80104d56 <initlock>
  readsb(ROOTDEV, &sb);
...
8010300e:	a3 d4 22 11 80       	mov    %eax,0x801122d4
  log.size = sb.nlog;
80103013:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103016:	a3 d8 22 11 80       	mov    %eax,0x801122d8
  log.dev = ROOTDEV;
8010301b:	c7 05 e4 22 11 80 01 	movl   $0x1,0x801122e4
80103022:	00 00 00 
  recover_from_log();
...
80103068:	8b 04 85 ac 22 11 80 	mov    -0x7feedd54(,%eax,4),%eax
8010306f:	89 c2                	mov    %eax,%edx
80103071:	a1 e4 22 11 80       	mov    0x801122e4,%eax
...
801030a0:	e8 f5 1f 00 00       	call   8010509a <memmove>
...
801030ca:	a1 e8 22 11 80       	mov    0x801122e8,%eax
...
801030e0:	a1 d4 22 11 80       	mov    0x801122d4,%eax
801030e5:	89 c2                	mov    %eax,%edx
801030e7:	a1 e4 22 11 80       	mov    0x801122e4,%eax
...
80103109:	a3 e8 22 11 80       	mov    %eax,0x801122e8
...
80103127:	89 04 95 ac 22 11 80 	mov    %eax,-0x7feedd54(,%edx,4)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80103132:	a1 e8 22 11 80       	mov    0x801122e8,%eax
...
8010314c:	83 ec 28             	sub    $0x28,%esp
  struct buf *buf = bread(log.dev, log.start);
8010314f:	a1 d4 22 11 80       	mov    0x801122d4,%eax
80103154:	89 c2                	mov    %eax,%edx
80103156:	a1 e4 22 11 80       	mov    0x801122e4,%eax
...
80103170:	89 45 ec             	mov    %eax,-0x14(%ebp)
  int i;
  hb->n = log.lh.n;
80103173:	8b 15 e8 22 11 80    	mov    0x801122e8,%edx
...
8010318d:	8b 0c 85 ac 22 11 80 	mov    -0x7feedd54(,%eax,4),%ecx
...
801031a2:	a1 e8 22 11 80       	mov    0x801122e8,%eax
...
801031cf:	e8 58 fe ff ff       	call   8010302c <install_trans>
  log.lh.n = 0;
801031d4:	c7 05 e8 22 11 80 00 	movl   $0x0,0x801122e8
801031db:	00 00 00 
...
801031e8:	83 ec 18             	sub    $0x18,%esp
  acquire(&log.lock);
801031eb:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801031f2:	e8 80 1b 00 00       	call   80104d77 <acquire>
  while(1){
    if(log.committing){
801031f7:	a1 e0 22 11 80       	mov    0x801122e0,%eax
801031fc:	85 c0                	test   %eax,%eax
801031fe:	74 16                	je     80103216 <begin_op+0x31>
      sleep(&log, &log.lock);
80103200:	c7 44 24 04 a0 22 11 	movl   $0x801122a0,0x4(%esp)
80103207:	80 
80103208:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010320f:	e8 90 18 00 00       	call   80104aa4 <sleep>
80103214:	eb 4f                	jmp    80103265 <begin_op+0x80>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80103216:	8b 0d e8 22 11 80    	mov    0x801122e8,%ecx
8010321c:	a1 dc 22 11 80       	mov    0x801122dc,%eax
80103221:	8d 50 01             	lea    0x1(%eax),%edx
80103224:	89 d0                	mov    %edx,%eax
80103226:	c1 e0 02             	shl    $0x2,%eax
80103229:	01 d0                	add    %edx,%eax
8010322b:	01 c0                	add    %eax,%eax
8010322d:	01 c8                	add    %ecx,%eax
8010322f:	83 f8 1e             	cmp    $0x1e,%eax
80103232:	7e 16                	jle    8010324a <begin_op+0x65>
      // this op might exhaust log space; wait for commit.
      sleep(&log, &log.lock);
80103234:	c7 44 24 04 a0 22 11 	movl   $0x801122a0,0x4(%esp)
8010323b:	80 
8010323c:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80103243:	e8 5c 18 00 00       	call   80104aa4 <sleep>
80103248:	eb 1b                	jmp    80103265 <begin_op+0x80>
    } else {
      log.outstanding += 1;
8010324a:	a1 dc 22 11 80       	mov    0x801122dc,%eax
8010324f:	83 c0 01             	add    $0x1,%eax
80103252:	a3 dc 22 11 80       	mov    %eax,0x801122dc
      release(&log.lock);
80103257:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010325e:	e8 76 1b 00 00       	call   80104dd9 <release>
      break;
80103263:	eb 02                	jmp    80103267 <begin_op+0x82>
    }
  }
80103265:	eb 90                	jmp    801031f7 <begin_op+0x12>
}
80103267:	c9                   	leave  
80103268:	c3                   	ret    
...
8010326f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  ...
  acquire(&log.lock);
80103276:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010327d:	e8 f5 1a 00 00       	call   80104d77 <acquire>
  log.outstanding -= 1;
80103282:	a1 dc 22 11 80       	mov    0x801122dc,%eax
80103287:	83 e8 01             	sub    $0x1,%eax
8010328a:	a3 dc 22 11 80       	mov    %eax,0x801122dc
  if(log.committing)
8010328f:	a1 e0 22 11 80       	mov    0x801122e0,%eax
80103294:	85 c0                	test   %eax,%eax
80103296:	74 0c                	je     801032a4 <end_op+0x3b>
    panic("log.committing");
80103298:	c7 04 24 b0 89 10 80 	movl   $0x801089b0,(%esp)
8010329f:	e8 96 d2 ff ff       	call   8010053a <panic>
  if(log.outstanding == 0){
801032a4:	a1 dc 22 11 80       	mov    0x801122dc,%eax
801032a9:	85 c0                	test   %eax,%eax
801032ab:	75 13                	jne    801032c0 <end_op+0x57>
    do_commit = 1;
801032ad:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    log.committing = 1;
801032b4:	c7 05 e0 22 11 80 01 	movl   $0x1,0x801122e0
801032bb:	00 00 00 
801032be:	eb 0c                	jmp    801032cc <end_op+0x63>
  } else {
    // begin_op() may be waiting for log space.
    wakeup(&log);
801032c0:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801032c7:	e8 b4 18 00 00       	call   80104b80 <wakeup>
  }
  release(&log.lock);
801032cc:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801032d3:	e8 01 1b 00 00       	call   80104dd9 <release>

  if(do_commit){
801032d8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801032dc:	74 33                	je     80103311 <end_op+0xa8>
    // call commit w/o holding locks, since not allowed
    // to sleep with locks.
    commit();
801032de:	e8 de 00 00 00       	call   801033c1 <commit>
    acquire(&log.lock);
801032e3:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801032ea:	e8 88 1a 00 00       	call   80104d77 <acquire>
    log.committing = 0;
801032ef:	c7 05 e0 22 11 80 00 	movl   $0x0,0x801122e0
801032f6:	00 00 00 
    wakeup(&log);
801032f9:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80103300:	e8 7b 18 00 00       	call   80104b80 <wakeup>
    release(&log.lock);
80103305:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010330c:	e8 c8 1a 00 00       	call   80104dd9 <release>
  }
}
80103311:	c9                   	leave  
80103312:	c3                   	ret    
...
80103316:	83 ec 28             	sub    $0x28,%esp
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
80103319:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80103320:	e9 8c 00 00 00       	jmp    801033b1 <write_log+0x9e>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
80103325:	8b 15 d4 22 11 80    	mov    0x801122d4,%edx
8010332b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010332e:	01 d0                	add    %edx,%eax
80103330:	83 c0 01             	add    $0x1,%eax
80103333:	89 c2                	mov    %eax,%edx
80103335:	a1 e4 22 11 80       	mov    0x801122e4,%eax
...
801033b1:	a1 e8 22 11 80       	mov    0x801122e8,%eax
801033b6:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801033b9:	0f 8f 66 ff ff ff    	jg     80103325 <write_log+0x12>
    memmove(to->data, from->data, BSIZE);
    bwrite(to);  // write the log
    brelse(from); 
    brelse(to);
...
801033c4:	83 ec 08             	sub    $0x8,%esp
  if (log.lh.n > 0) {
801033c7:	a1 e8 22 11 80       	mov    0x801122e8,%eax
801033cc:	85 c0                	test   %eax,%eax
801033ce:	7e 1e                	jle    801033ee <commit+0x2d>
    write_log();     // Write modified blocks from cache to log
801033d0:	e8 3e ff ff ff       	call   80103313 <write_log>
    write_head();    // Write header to disk -- the real commit
801033d5:	e8 6f fd ff ff       	call   80103149 <write_head>
    install_trans(); // Now install writes to home locations
801033da:	e8 4d fc ff ff       	call   8010302c <install_trans>
    log.lh.n = 0; 
801033df:	c7 05 e8 22 11 80 00 	movl   $0x0,0x801122e8
801033e6:	00 00 00 
    write_head();    // Erase the transaction from the log
801033e9:	e8 5b fd ff ff       	call   80103149 <write_head>
  }
}
801033ee:	c9                   	leave  
801033ef:	c3                   	ret    
...
801033f3:	83 ec 28             	sub    $0x28,%esp
  int i;

  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
801033f6:	a1 e8 22 11 80       	mov    0x801122e8,%eax
801033fb:	83 f8 1d             	cmp    $0x1d,%eax
801033fe:	7f 12                	jg     80103412 <log_write+0x22>
80103400:	a1 e8 22 11 80       	mov    0x801122e8,%eax
80103405:	8b 15 d8 22 11 80    	mov    0x801122d8,%edx
8010340b:	83 ea 01             	sub    $0x1,%edx
8010340e:	39 d0                	cmp    %edx,%eax
80103410:	7c 0c                	jl     8010341e <log_write+0x2e>
    panic("too big a transaction");
80103412:	c7 04 24 bf 89 10 80 	movl   $0x801089bf,(%esp)
80103419:	e8 1c d1 ff ff       	call   8010053a <panic>
  if (log.outstanding < 1)
8010341e:	a1 dc 22 11 80       	mov    0x801122dc,%eax
80103423:	85 c0                	test   %eax,%eax
80103425:	7f 0c                	jg     80103433 <log_write+0x43>
    panic("log_write outside of trans");
80103427:	c7 04 24 d5 89 10 80 	movl   $0x801089d5,(%esp)
8010342e:	e8 07 d1 ff ff       	call   8010053a <panic>

  for (i = 0; i < log.lh.n; i++) {
80103433:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010343a:	eb 1f                	jmp    8010345b <log_write+0x6b>
    if (log.lh.sector[i] == b->sector)   // log absorbtion
8010343c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010343f:	83 c0 10             	add    $0x10,%eax
80103442:	8b 04 85 ac 22 11 80 	mov    -0x7feedd54(,%eax,4),%eax
80103449:	89 c2                	mov    %eax,%edx
8010344b:	8b 45 08             	mov    0x8(%ebp),%eax
8010344e:	8b 40 08             	mov    0x8(%eax),%eax
80103451:	39 c2                	cmp    %eax,%edx
80103453:	75 02                	jne    80103457 <log_write+0x67>
      break;
80103455:	eb 0e                	jmp    80103465 <log_write+0x75>
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
  if (log.outstanding < 1)
    panic("log_write outside of trans");
  ...
  for (i = 0; i < log.lh.n; i++) {
80103457:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010345b:	a1 e8 22 11 80       	mov    0x801122e8,%eax
80103460:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80103463:	7f d7                	jg     8010343c <log_write+0x4c>
    if (log.lh.sector[i] == b->sector)   // log absorbtion
      break;
  }
  log.lh.sector[i] = b->sector;
80103465:	8b 45 08             	mov    0x8(%ebp),%eax
80103468:	8b 40 08             	mov    0x8(%eax),%eax
8010346b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010346e:	83 c2 10             	add    $0x10,%edx
80103471:	89 04 95 ac 22 11 80 	mov    %eax,-0x7feedd54(,%edx,4)
  if (i == log.lh.n)
80103478:	a1 e8 22 11 80       	mov    0x801122e8,%eax
8010347d:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80103480:	75 0d                	jne    8010348f <log_write+0x9f>
    log.lh.n++;
80103482:	a1 e8 22 11 80       	mov    0x801122e8,%eax
80103487:	83 c0 01             	add    $0x1,%eax
8010348a:	a3 e8 22 11 80       	mov    %eax,0x801122e8
  b->flags |= B_DIRTY; // prevent eviction
8010348f:	8b 45 08             	mov    0x8(%ebp),%eax
80103492:	8b 00                	mov    (%eax),%eax
80103494:	83 c8 04             	or     $0x4,%eax
...
801034a6:	05 00 00 00 80       	add    $0x80000000,%eax
801034ab:	5d                   	pop    %ebp
801034ac:	c3                   	ret    
...
801034b0:	8b 45 08             	mov    0x8(%ebp),%eax
801034b3:	05 00 00 00 80       	add    $0x80000000,%eax
801034b8:	5d                   	pop    %ebp
801034b9:	c3                   	ret    
...
801034bd:	83 ec 10             	sub    $0x10,%esp
  uint result;
  
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
801034c0:	8b 55 08             	mov    0x8(%ebp),%edx
801034c3:	8b 45 0c             	mov    0xc(%ebp),%eax
801034c6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801034c9:	f0 87 02             	lock xchg %eax,(%edx)
801034cc:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
801034cf:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801034d2:	c9                   	leave  
801034d3:	c3                   	ret    
...
801034d7:	83 e4 f0             	and    $0xfffffff0,%esp
801034da:	83 ec 10             	sub    $0x10,%esp
  kinit1(end, P2V(4*1024*1024)); // phys page allocator
801034dd:	c7 44 24 04 00 00 40 	movl   $0x80400000,0x4(%esp)
801034e4:	80 
801034e5:	c7 04 24 7c 86 11 80 	movl   $0x8011867c,(%esp)
801034ec:	e8 c3 f4 ff ff       	call   801029b4 <kinit1>
  kvmalloc();      // kernel page table
801034f1:	e8 fc 4a 00 00       	call   80107ff2 <kvmalloc>
  mpinit();        // collect info about this machine
801034f6:	e8 46 04 00 00       	call   80103941 <mpinit>
  lapicinit();
801034fb:	e8 02 f8 ff ff       	call   80102d02 <lapicinit>
  seginit();       // set up segments
80103500:	e8 80 44 00 00       	call   80107985 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
80103505:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010350b:	0f b6 00             	movzbl (%eax),%eax
8010350e:	0f b6 c0             	movzbl %al,%eax
80103511:	89 44 24 04          	mov    %eax,0x4(%esp)
80103515:	c7 04 24 f0 89 10 80 	movl   $0x801089f0,(%esp)
8010351c:	e8 7f ce ff ff       	call   801003a0 <cprintf>
  picinit();       // interrupt controller
80103521:	e8 79 06 00 00       	call   80103b9f <picinit>
  ioapicinit();    // another interrupt controller
80103526:	e8 7f f3 ff ff       	call   801028aa <ioapicinit>
  consoleinit();   // I/O devices & their interrupts
8010352b:	e8 51 d5 ff ff       	call   80100a81 <consoleinit>
  uartinit();      // serial port
80103530:	e8 9f 37 00 00       	call   80106cd4 <uartinit>
  pinit();         // process table
80103535:	e8 6f 0b 00 00       	call   801040a9 <pinit>
  tvinit();        // trap vectors
8010353a:	e8 47 33 00 00       	call   80106886 <tvinit>
  binit();         // buffer cache
8010353f:	e8 f0 ca ff ff       	call   80100034 <binit>
  fileinit();      // file table
80103544:	e8 c1 d9 ff ff       	call   80100f0a <fileinit>
  iinit();         // inode cache
80103549:	e8 56 e0 ff ff       	call   801015a4 <iinit>
  ideinit();       // disk
8010354e:	e8 c0 ef ff ff       	call   80102513 <ideinit>
  if(!ismp)
80103553:	a1 84 23 11 80       	mov    0x80112384,%eax
80103558:	85 c0                	test   %eax,%eax
8010355a:	75 05                	jne    80103561 <main+0x8d>
    timerinit();   // uniprocessor timer
8010355c:	e8 70 32 00 00       	call   801067d1 <timerinit>
  startothers();   // start other processors
80103561:	e8 7f 00 00 00       	call   801035e5 <startothers>
  kinit2(P2V(4*1024*1024), P2V(PHYSTOP)); // must come after startothers()
80103566:	c7 44 24 04 00 00 00 	movl   $0x8e000000,0x4(%esp)
8010356d:	8e 
8010356e:	c7 04 24 00 00 40 80 	movl   $0x80400000,(%esp)
80103575:	e8 72 f4 ff ff       	call   801029ec <kinit2>
  userinit();      // first user process
8010357a:	e8 48 0c 00 00       	call   801041c7 <userinit>
  // Finish setting up this processor in mpmain.
  mpmain();
8010357f:	e8 1a 00 00 00       	call   8010359e <mpmain>
...
80103587:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010358a:	e8 7a 4a 00 00       	call   80108009 <switchkvm>
  seginit();
8010358f:	e8 f1 43 00 00       	call   80107985 <seginit>
  lapicinit();
80103594:	e8 69 f7 ff ff       	call   80102d02 <lapicinit>
  mpmain();
80103599:	e8 00 00 00 00       	call   8010359e <mpmain>
...
801035a1:	83 ec 18             	sub    $0x18,%esp
  cprintf("cpu%d: starting\n", cpu->id);
801035a4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801035aa:	0f b6 00             	movzbl (%eax),%eax
801035ad:	0f b6 c0             	movzbl %al,%eax
801035b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801035b4:	c7 04 24 07 8a 10 80 	movl   $0x80108a07,(%esp)
801035bb:	e8 e0 cd ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
801035c0:	e8 35 34 00 00       	call   801069fa <idtinit>
  xchg(&cpu->started, 1); // tell startothers() we're up
801035c5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801035cb:	05 a8 00 00 00       	add    $0xa8,%eax
801035d0:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801035d7:	00 
801035d8:	89 04 24             	mov    %eax,(%esp)
801035db:	e8 da fe ff ff       	call   801034ba <xchg>
  scheduler();     // start running processes
801035e0:	e8 14 13 00 00       	call   801048f9 <scheduler>
...
801035e9:	83 ec 24             	sub    $0x24,%esp
  char *stack;
  ...
  code = p2v(0x7000);
801035ec:	c7 04 24 00 70 00 00 	movl   $0x7000,(%esp)
801035f3:	e8 b5 fe ff ff       	call   801034ad <p2v>
801035f8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  memmove(code, _binary_entryother_start, (uint)_binary_entryother_size);
801035fb:	b8 8a 00 00 00       	mov    $0x8a,%eax
80103600:	89 44 24 08          	mov    %eax,0x8(%esp)
80103604:	c7 44 24 04 4c b5 10 	movl   $0x8010b54c,0x4(%esp)
8010360b:	80 
8010360c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010360f:	89 04 24             	mov    %eax,(%esp)
80103612:	e8 83 1a 00 00       	call   8010509a <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80103617:	c7 45 f4 a0 23 11 80 	movl   $0x801123a0,-0xc(%ebp)
8010361e:	e9 85 00 00 00       	jmp    801036a8 <startothers+0xc3>
    if(c == cpus+cpunum())  // We've started already.
80103623:	e8 33 f8 ff ff       	call   80102e5b <cpunum>
80103628:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
8010362e:	05 a0 23 11 80       	add    $0x801123a0,%eax
80103633:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80103636:	75 02                	jne    8010363a <startothers+0x55>
      continue;
80103638:	eb 67                	jmp    801036a1 <startothers+0xbc>

    // Tell entryother.S what stack to use, where to enter, and what 
    // pgdir to use. We cannot use kpgdir yet, because the AP processor
    // is running in low  memory, so we use entrypgdir for the APs too.
    stack = kalloc();
8010363a:	e8 a3 f4 ff ff       	call   80102ae2 <kalloc>
8010363f:	89 45 ec             	mov    %eax,-0x14(%ebp)
    *(void**)(code-4) = stack + KSTACKSIZE;
80103642:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103645:	83 e8 04             	sub    $0x4,%eax
80103648:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010364b:	81 c2 00 10 00 00    	add    $0x1000,%edx
80103651:	89 10                	mov    %edx,(%eax)
    *(void**)(code-8) = mpenter;
80103653:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103656:	83 e8 08             	sub    $0x8,%eax
80103659:	c7 00 84 35 10 80    	movl   $0x80103584,(%eax)
    *(int**)(code-12) = (void *) v2p(entrypgdir);
8010365f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103662:	8d 58 f4             	lea    -0xc(%eax),%ebx
80103665:	c7 04 24 00 a0 10 80 	movl   $0x8010a000,(%esp)
8010366c:	e8 2f fe ff ff       	call   801034a0 <v2p>
80103671:	89 03                	mov    %eax,(%ebx)

    lapicstartap(c->id, v2p(code));
80103673:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103676:	89 04 24             	mov    %eax,(%esp)
80103679:	e8 22 fe ff ff       	call   801034a0 <v2p>
8010367e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103681:	0f b6 12             	movzbl (%edx),%edx
80103684:	0f b6 d2             	movzbl %dl,%edx
80103687:	89 44 24 04          	mov    %eax,0x4(%esp)
8010368b:	89 14 24             	mov    %edx,(%esp)
8010368e:	e8 4a f8 ff ff       	call   80102edd <lapicstartap>

    // wait for cpu to finish mpmain()
    while(c->started == 0)
80103693:	90                   	nop
80103694:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103697:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
8010369d:	85 c0                	test   %eax,%eax
8010369f:	74 f3                	je     80103694 <startothers+0xaf>
  // The linker has placed the image of entryother.S in
  // _binary_entryother_start.
  code = p2v(0x7000);
  memmove(code, _binary_entryother_start, (uint)_binary_entryother_size);
  ...
  for(c = cpus; c < cpus+ncpu; c++){
801036a1:	81 45 f4 bc 00 00 00 	addl   $0xbc,-0xc(%ebp)
801036a8:	a1 80 29 11 80       	mov    0x80112980,%eax
801036ad:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801036b3:	05 a0 23 11 80       	add    $0x801123a0,%eax
801036b8:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801036bb:	0f 87 62 ff ff ff    	ja     80103623 <startothers+0x3e>
...
801036c1:	83 c4 24             	add    $0x24,%esp
801036c4:	5b                   	pop    %ebx
801036c5:	5d                   	pop    %ebp
801036c6:	c3                   	ret    
...
801036cd:	05 00 00 00 80       	add    $0x80000000,%eax
801036d2:	5d                   	pop    %ebp
801036d3:	c3                   	ret    
...
801036d7:	83 ec 14             	sub    $0x14,%esp
801036da:	8b 45 08             	mov    0x8(%ebp),%eax
801036dd:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801036e1:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
801036e5:	89 c2                	mov    %eax,%edx
801036e7:	ec                   	in     (%dx),%al
801036e8:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
801036eb:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
801036ef:	c9                   	leave  
801036f0:	c3                   	ret    
...
801036f7:	8b 55 08             	mov    0x8(%ebp),%edx
801036fa:	8b 45 0c             	mov    0xc(%ebp),%eax
801036fd:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80103701:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80103704:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80103708:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80103710:	89 e5                	mov    %esp,%ebp
  return bcpu-cpus;
80103712:	a1 84 b6 10 80       	mov    0x8010b684,%eax
80103717:	89 c2                	mov    %eax,%edx
80103719:	b8 a0 23 11 80       	mov    $0x801123a0,%eax
8010371e:	29 c2                	sub    %eax,%edx
80103720:	89 d0                	mov    %edx,%eax
80103722:	c1 f8 02             	sar    $0x2,%eax
80103725:	69 c0 cf 46 7d 67    	imul   $0x677d46cf,%eax,%eax
}
8010372b:	5d                   	pop    %ebp
8010372c:	c3                   	ret    
...
80103730:	83 ec 10             	sub    $0x10,%esp
  int i, sum;
  
  sum = 0;
80103733:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
  for(i=0; i<len; i++)
8010373a:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80103741:	eb 15                	jmp    80103758 <sum+0x2b>
    sum += addr[i];
80103743:	8b 55 fc             	mov    -0x4(%ebp),%edx
80103746:	8b 45 08             	mov    0x8(%ebp),%eax
80103749:	01 d0                	add    %edx,%eax
8010374b:	0f b6 00             	movzbl (%eax),%eax
8010374e:	0f b6 c0             	movzbl %al,%eax
80103751:	01 45 f8             	add    %eax,-0x8(%ebp)
sum(uchar *addr, int len)
{
  int i, sum;
  ...
  sum = 0;
  for(i=0; i<len; i++)
80103754:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80103758:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010375b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010375e:	7c e3                	jl     80103743 <sum+0x16>
    sum += addr[i];
  return sum;
...
80103771:	e8 51 ff ff ff       	call   801036c7 <p2v>
80103776:	89 45 f0             	mov    %eax,-0x10(%ebp)
  e = addr+len;
80103779:	8b 55 0c             	mov    0xc(%ebp),%edx
8010377c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010377f:	01 d0                	add    %edx,%eax
80103781:	89 45 ec             	mov    %eax,-0x14(%ebp)
  for(p = addr; p < e; p += sizeof(struct mp))
80103784:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103787:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010378a:	eb 3f                	jmp    801037cb <mpsearch1+0x66>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
8010378c:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80103793:	00 
80103794:	c7 44 24 04 18 8a 10 	movl   $0x80108a18,0x4(%esp)
8010379b:	80 
8010379c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010379f:	89 04 24             	mov    %eax,(%esp)
801037a2:	e8 9b 18 00 00       	call   80105042 <memcmp>
801037a7:	85 c0                	test   %eax,%eax
801037a9:	75 1c                	jne    801037c7 <mpsearch1+0x62>
801037ab:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
801037b2:	00 
801037b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801037b6:	89 04 24             	mov    %eax,(%esp)
801037b9:	e8 6f ff ff ff       	call   8010372d <sum>
801037be:	84 c0                	test   %al,%al
801037c0:	75 05                	jne    801037c7 <mpsearch1+0x62>
      return (struct mp*)p;
801037c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801037c5:	eb 11                	jmp    801037d8 <mpsearch1+0x73>
{
  uchar *e, *p, *addr;
  ...
  e = addr+len;
  for(p = addr; p < e; p += sizeof(struct mp))
801037c7:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801037cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801037ce:	3b 45 ec             	cmp    -0x14(%ebp),%eax
801037d1:	72 b9                	jb     8010378c <mpsearch1+0x27>
    if(memcmp(p, "_MP_", 4) == 0 && sum(p, sizeof(struct mp)) == 0)
      return (struct mp*)p;
  return 0;
...
801037dd:	83 ec 28             	sub    $0x28,%esp
  uchar *bda;
  uint p;
  struct mp *mp;

  bda = (uchar *) P2V(0x400);
801037e0:	c7 45 f4 00 04 00 80 	movl   $0x80000400,-0xc(%ebp)
  if((p = ((bda[0x0F]<<8)| bda[0x0E]) << 4)){
801037e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801037ea:	83 c0 0f             	add    $0xf,%eax
...
801037fb:	83 c0 0e             	add    $0xe,%eax
801037fe:	0f b6 00             	movzbl (%eax),%eax
80103801:	0f b6 c0             	movzbl %al,%eax
80103804:	09 d0                	or     %edx,%eax
80103806:	c1 e0 04             	shl    $0x4,%eax
80103809:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010380c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80103810:	74 21                	je     80103833 <mpsearch+0x59>
    if((mp = mpsearch1(p, 1024)))
80103812:	c7 44 24 04 00 04 00 	movl   $0x400,0x4(%esp)
80103819:	00 
8010381a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010381d:	89 04 24             	mov    %eax,(%esp)
80103820:	e8 40 ff ff ff       	call   80103765 <mpsearch1>
80103825:	89 45 ec             	mov    %eax,-0x14(%ebp)
80103828:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010382c:	74 50                	je     8010387e <mpsearch+0xa4>
      return mp;
8010382e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80103831:	eb 5f                	jmp    80103892 <mpsearch+0xb8>
  } else {
    p = ((bda[0x14]<<8)|bda[0x13])*1024;
80103833:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103836:	83 c0 14             	add    $0x14,%eax
80103839:	0f b6 00             	movzbl (%eax),%eax
8010383c:	0f b6 c0             	movzbl %al,%eax
8010383f:	c1 e0 08             	shl    $0x8,%eax
80103842:	89 c2                	mov    %eax,%edx
80103844:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103847:	83 c0 13             	add    $0x13,%eax
8010384a:	0f b6 00             	movzbl (%eax),%eax
8010384d:	0f b6 c0             	movzbl %al,%eax
80103850:	09 d0                	or     %edx,%eax
80103852:	c1 e0 0a             	shl    $0xa,%eax
80103855:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if((mp = mpsearch1(p-1024, 1024)))
80103858:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010385b:	2d 00 04 00 00       	sub    $0x400,%eax
80103860:	c7 44 24 04 00 04 00 	movl   $0x400,0x4(%esp)
80103867:	00 
80103868:	89 04 24             	mov    %eax,(%esp)
8010386b:	e8 f5 fe ff ff       	call   80103765 <mpsearch1>
80103870:	89 45 ec             	mov    %eax,-0x14(%ebp)
80103873:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80103877:	74 05                	je     8010387e <mpsearch+0xa4>
      return mp;
80103879:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010387c:	eb 14                	jmp    80103892 <mpsearch+0xb8>
  }
  return mpsearch1(0xF0000, 0x10000);
8010387e:	c7 44 24 04 00 00 01 	movl   $0x10000,0x4(%esp)
80103885:	00 
80103886:	c7 04 24 00 00 0f 00 	movl   $0xf0000,(%esp)
8010388d:	e8 d3 fe ff ff       	call   80103765 <mpsearch1>
}
80103892:	c9                   	leave  
80103893:	c3                   	ret    
...
80103897:	83 ec 28             	sub    $0x28,%esp
  struct mpconf *conf;
  struct mp *mp;

  if((mp = mpsearch()) == 0 || mp->physaddr == 0)
8010389a:	e8 3b ff ff ff       	call   801037da <mpsearch>
8010389f:	89 45 f4             	mov    %eax,-0xc(%ebp)
801038a2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801038a6:	74 0a                	je     801038b2 <mpconfig+0x1e>
801038a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801038ab:	8b 40 04             	mov    0x4(%eax),%eax
801038ae:	85 c0                	test   %eax,%eax
801038b0:	75 0a                	jne    801038bc <mpconfig+0x28>
    return 0;
801038b2:	b8 00 00 00 00       	mov    $0x0,%eax
801038b7:	e9 83 00 00 00       	jmp    8010393f <mpconfig+0xab>
  conf = (struct mpconf*) p2v((uint) mp->physaddr);
801038bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801038bf:	8b 40 04             	mov    0x4(%eax),%eax
801038c2:	89 04 24             	mov    %eax,(%esp)
801038c5:	e8 fd fd ff ff       	call   801036c7 <p2v>
801038ca:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
801038cd:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801038d4:	00 
801038d5:	c7 44 24 04 1d 8a 10 	movl   $0x80108a1d,0x4(%esp)
801038dc:	80 
801038dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801038e0:	89 04 24             	mov    %eax,(%esp)
801038e3:	e8 5a 17 00 00       	call   80105042 <memcmp>
801038e8:	85 c0                	test   %eax,%eax
801038ea:	74 07                	je     801038f3 <mpconfig+0x5f>
    return 0;
801038ec:	b8 00 00 00 00       	mov    $0x0,%eax
801038f1:	eb 4c                	jmp    8010393f <mpconfig+0xab>
  if(conf->version != 1 && conf->version != 4)
801038f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801038f6:	0f b6 40 06          	movzbl 0x6(%eax),%eax
801038fa:	3c 01                	cmp    $0x1,%al
801038fc:	74 12                	je     80103910 <mpconfig+0x7c>
801038fe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103901:	0f b6 40 06          	movzbl 0x6(%eax),%eax
80103905:	3c 04                	cmp    $0x4,%al
80103907:	74 07                	je     80103910 <mpconfig+0x7c>
    return 0;
80103909:	b8 00 00 00 00       	mov    $0x0,%eax
8010390e:	eb 2f                	jmp    8010393f <mpconfig+0xab>
  if(sum((uchar*)conf, conf->length) != 0)
80103910:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103913:	0f b7 40 04          	movzwl 0x4(%eax),%eax
...
80103924:	e8 04 fe ff ff       	call   8010372d <sum>
80103929:	84 c0                	test   %al,%al
8010392b:	74 07                	je     80103934 <mpconfig+0xa0>
    return 0;
8010392d:	b8 00 00 00 00       	mov    $0x0,%eax
80103932:	eb 0b                	jmp    8010393f <mpconfig+0xab>
  *pmp = mp;
...
80103944:	83 ec 38             	sub    $0x38,%esp
  ...
  bcpu = &cpus[0];
80103947:	c7 05 84 b6 10 80 a0 	movl   $0x801123a0,0x8010b684
8010394e:	23 11 80 
  if((conf = mpconfig(&mp)) == 0)
80103951:	8d 45 e0             	lea    -0x20(%ebp),%eax
80103954:	89 04 24             	mov    %eax,(%esp)
80103957:	e8 38 ff ff ff       	call   80103894 <mpconfig>
8010395c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010395f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80103963:	75 05                	jne    8010396a <mpinit+0x29>
    return;
80103965:	e9 9c 01 00 00       	jmp    80103b06 <mpinit+0x1c5>
  ismp = 1;
8010396a:	c7 05 84 23 11 80 01 	movl   $0x1,0x80112384
80103971:	00 00 00 
  lapic = (uint*)conf->lapicaddr;
80103974:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103977:	8b 40 24             	mov    0x24(%eax),%eax
8010397a:	a3 9c 22 11 80       	mov    %eax,0x8011229c
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
8010397f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103982:	83 c0 2c             	add    $0x2c,%eax
80103985:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103988:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010398b:	0f b7 40 04          	movzwl 0x4(%eax),%eax
8010398f:	0f b7 d0             	movzwl %ax,%edx
80103992:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103995:	01 d0                	add    %edx,%eax
80103997:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010399a:	e9 f4 00 00 00       	jmp    80103a93 <mpinit+0x152>
    switch(*p){
8010399f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039a2:	0f b6 00             	movzbl (%eax),%eax
801039a5:	0f b6 c0             	movzbl %al,%eax
801039a8:	83 f8 04             	cmp    $0x4,%eax
801039ab:	0f 87 bf 00 00 00    	ja     80103a70 <mpinit+0x12f>
801039b1:	8b 04 85 60 8a 10 80 	mov    -0x7fef75a0(,%eax,4),%eax
801039b8:	ff e0                	jmp    *%eax
    case MPPROC:
      proc = (struct mpproc*)p;
801039ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
801039bd:	89 45 e8             	mov    %eax,-0x18(%ebp)
      if(ncpu != proc->apicid){
801039c0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801039c3:	0f b6 40 01          	movzbl 0x1(%eax),%eax
801039c7:	0f b6 d0             	movzbl %al,%edx
801039ca:	a1 80 29 11 80       	mov    0x80112980,%eax
801039cf:	39 c2                	cmp    %eax,%edx
801039d1:	74 2d                	je     80103a00 <mpinit+0xbf>
        cprintf("mpinit: ncpu=%d apicid=%d\n", ncpu, proc->apicid);
801039d3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801039d6:	0f b6 40 01          	movzbl 0x1(%eax),%eax
801039da:	0f b6 d0             	movzbl %al,%edx
801039dd:	a1 80 29 11 80       	mov    0x80112980,%eax
801039e2:	89 54 24 08          	mov    %edx,0x8(%esp)
801039e6:	89 44 24 04          	mov    %eax,0x4(%esp)
801039ea:	c7 04 24 22 8a 10 80 	movl   $0x80108a22,(%esp)
801039f1:	e8 aa c9 ff ff       	call   801003a0 <cprintf>
        ismp = 0;
801039f6:	c7 05 84 23 11 80 00 	movl   $0x0,0x80112384
801039fd:	00 00 00 
      }
      if(proc->flags & MPBOOT)
80103a00:	8b 45 e8             	mov    -0x18(%ebp),%eax
80103a03:	0f b6 40 03          	movzbl 0x3(%eax),%eax
80103a07:	0f b6 c0             	movzbl %al,%eax
80103a0a:	83 e0 02             	and    $0x2,%eax
80103a0d:	85 c0                	test   %eax,%eax
80103a0f:	74 15                	je     80103a26 <mpinit+0xe5>
        bcpu = &cpus[ncpu];
80103a11:	a1 80 29 11 80       	mov    0x80112980,%eax
80103a16:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80103a1c:	05 a0 23 11 80       	add    $0x801123a0,%eax
80103a21:	a3 84 b6 10 80       	mov    %eax,0x8010b684
      cpus[ncpu].id = ncpu;
80103a26:	8b 15 80 29 11 80    	mov    0x80112980,%edx
80103a2c:	a1 80 29 11 80       	mov    0x80112980,%eax
80103a31:	69 d2 bc 00 00 00    	imul   $0xbc,%edx,%edx
80103a37:	81 c2 a0 23 11 80    	add    $0x801123a0,%edx
80103a3d:	88 02                	mov    %al,(%edx)
      ncpu++;
80103a3f:	a1 80 29 11 80       	mov    0x80112980,%eax
80103a44:	83 c0 01             	add    $0x1,%eax
80103a47:	a3 80 29 11 80       	mov    %eax,0x80112980
      p += sizeof(struct mpproc);
80103a4c:	83 45 f4 14          	addl   $0x14,-0xc(%ebp)
      continue;
80103a50:	eb 41                	jmp    80103a93 <mpinit+0x152>
    case MPIOAPIC:
...
80103a5b:	0f b6 40 01          	movzbl 0x1(%eax),%eax
80103a5f:	a2 80 23 11 80       	mov    %al,0x80112380
      p += sizeof(struct mpioapic);
80103a64:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
      continue;
80103a68:	eb 29                	jmp    80103a93 <mpinit+0x152>
    case MPBUS:
    case MPIOINTR:
    case MPLINTR:
      p += 8;
80103a6a:	83 45 f4 08          	addl   $0x8,-0xc(%ebp)
      continue;
80103a6e:	eb 23                	jmp    80103a93 <mpinit+0x152>
    default:
...
80103a7d:	c7 04 24 40 8a 10 80 	movl   $0x80108a40,(%esp)
80103a84:	e8 17 c9 ff ff       	call   801003a0 <cprintf>
      ismp = 0;
80103a89:	c7 05 84 23 11 80 00 	movl   $0x0,0x80112384
80103a90:	00 00 00 
  bcpu = &cpus[0];
  if((conf = mpconfig(&mp)) == 0)
    return;
...
80103a99:	0f 82 00 ff ff ff    	jb     8010399f <mpinit+0x5e>
    default:
      cprintf("mpinit: unknown config type %x\n", *p);
      ismp = 0;
    }
  ...
  if(!ismp){
80103a9f:	a1 84 23 11 80       	mov    0x80112384,%eax
80103aa4:	85 c0                	test   %eax,%eax
80103aa6:	75 1d                	jne    80103ac5 <mpinit+0x184>
    // Didn't like what we found; fall back to no MP.
    ncpu = 1;
80103aa8:	c7 05 80 29 11 80 01 	movl   $0x1,0x80112980
80103aaf:	00 00 00 
    lapic = 0;
80103ab2:	c7 05 9c 22 11 80 00 	movl   $0x0,0x8011229c
80103ab9:	00 00 00 
    ioapicid = 0;
80103abc:	c6 05 80 23 11 80 00 	movb   $0x0,0x80112380
    return;
80103ac3:	eb 41                	jmp    80103b06 <mpinit+0x1c5>
  }

  if(mp->imcrp){
80103ac5:	8b 45 e0             	mov    -0x20(%ebp),%eax
80103ac8:	0f b6 40 0c          	movzbl 0xc(%eax),%eax
80103acc:	84 c0                	test   %al,%al
80103ace:	74 36                	je     80103b06 <mpinit+0x1c5>
    // Bochs doesn't support IMCR, so this doesn't run on Bochs.
    // But it would on real hardware.
    outb(0x22, 0x70);   // Select IMCR
80103ad0:	c7 44 24 04 70 00 00 	movl   $0x70,0x4(%esp)
80103ad7:	00 
80103ad8:	c7 04 24 22 00 00 00 	movl   $0x22,(%esp)
80103adf:	e8 0d fc ff ff       	call   801036f1 <outb>
    outb(0x23, inb(0x23) | 1);  // Mask external interrupts.
80103ae4:	c7 04 24 23 00 00 00 	movl   $0x23,(%esp)
80103aeb:	e8 e4 fb ff ff       	call   801036d4 <inb>
80103af0:	83 c8 01             	or     $0x1,%eax
80103af3:	0f b6 c0             	movzbl %al,%eax
80103af6:	89 44 24 04          	mov    %eax,0x4(%esp)
80103afa:	c7 04 24 23 00 00 00 	movl   $0x23,(%esp)
80103b01:	e8 eb fb ff ff       	call   801036f1 <outb>
  }
}
80103b06:	c9                   	leave  
80103b07:	c3                   	ret    
...
80103b2f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  irqmask = mask;
80103b33:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103b37:	66 a3 00 b0 10 80    	mov    %ax,0x8010b000
  outb(IO_PIC1+1, mask);
80103b3d:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103b41:	0f b6 c0             	movzbl %al,%eax
80103b44:	89 44 24 04          	mov    %eax,0x4(%esp)
80103b48:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103b4f:	e8 b4 ff ff ff       	call   80103b08 <outb>
  outb(IO_PIC2+1, mask >> 8);
80103b54:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80103b58:	66 c1 e8 08          	shr    $0x8,%ax
80103b5c:	0f b6 c0             	movzbl %al,%eax
80103b5f:	89 44 24 04          	mov    %eax,0x4(%esp)
80103b63:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103b6a:	e8 99 ff ff ff       	call   80103b08 <outb>
}
80103b6f:	c9                   	leave  
80103b70:	c3                   	ret    
...
80103b7a:	ba 01 00 00 00       	mov    $0x1,%edx
80103b7f:	89 c1                	mov    %eax,%ecx
80103b81:	d3 e2                	shl    %cl,%edx
80103b83:	89 d0                	mov    %edx,%eax
80103b85:	f7 d0                	not    %eax
80103b87:	89 c2                	mov    %eax,%edx
80103b89:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103b90:	21 d0                	and    %edx,%eax
80103b92:	0f b7 c0             	movzwl %ax,%eax
80103b95:	89 04 24             	mov    %eax,(%esp)
80103b98:	e8 89 ff ff ff       	call   80103b26 <picsetmask>
}
80103b9d:	c9                   	leave  
80103b9e:	c3                   	ret    
...
80103ba2:	83 ec 08             	sub    $0x8,%esp
  // mask all interrupts
  outb(IO_PIC1+1, 0xFF);
80103ba5:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
80103bac:	00 
80103bad:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103bb4:	e8 4f ff ff ff       	call   80103b08 <outb>
  outb(IO_PIC2+1, 0xFF);
80103bb9:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
80103bc0:	00 
80103bc1:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103bc8:	e8 3b ff ff ff       	call   80103b08 <outb>
  ...
  outb(IO_PIC1, 0x11);
80103bcd:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
80103bd4:	00 
80103bd5:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103bdc:	e8 27 ff ff ff       	call   80103b08 <outb>

  // ICW2:  Vector offset
  outb(IO_PIC1+1, T_IRQ0);
80103be1:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
80103be8:	00 
80103be9:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103bf0:	e8 13 ff ff ff       	call   80103b08 <outb>

  // ICW3:  (master PIC) bit mask of IR lines connected to slaves
  //        (slave PIC) 3-bit # of slave's connection to master
  outb(IO_PIC1+1, 1<<IRQ_SLAVE);
80103bf5:	c7 44 24 04 04 00 00 	movl   $0x4,0x4(%esp)
80103bfc:	00 
80103bfd:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103c04:	e8 ff fe ff ff       	call   80103b08 <outb>
  ...
  outb(IO_PIC1+1, 0x3);
80103c09:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80103c10:	00 
80103c11:	c7 04 24 21 00 00 00 	movl   $0x21,(%esp)
80103c18:	e8 eb fe ff ff       	call   80103b08 <outb>

  // Set up slave (8259A-2)
  outb(IO_PIC2, 0x11);                  // ICW1
80103c1d:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
80103c24:	00 
80103c25:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103c2c:	e8 d7 fe ff ff       	call   80103b08 <outb>
  outb(IO_PIC2+1, T_IRQ0 + 8);      // ICW2
80103c31:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
80103c38:	00 
80103c39:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103c40:	e8 c3 fe ff ff       	call   80103b08 <outb>
  outb(IO_PIC2+1, IRQ_SLAVE);           // ICW3
80103c45:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80103c4c:	00 
80103c4d:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103c54:	e8 af fe ff ff       	call   80103b08 <outb>
  // NB Automatic EOI mode doesn't tend to work on the slave.
  // Linux source code says it's "to be investigated".
  outb(IO_PIC2+1, 0x3);                 // ICW4
80103c59:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80103c60:	00 
80103c61:	c7 04 24 a1 00 00 00 	movl   $0xa1,(%esp)
80103c68:	e8 9b fe ff ff       	call   80103b08 <outb>
...
80103c6d:	c7 44 24 04 68 00 00 	movl   $0x68,0x4(%esp)
80103c74:	00 
80103c75:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103c7c:	e8 87 fe ff ff       	call   80103b08 <outb>
  outb(IO_PIC1, 0x0a);             // read IRR by default
80103c81:	c7 44 24 04 0a 00 00 	movl   $0xa,0x4(%esp)
80103c88:	00 
80103c89:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80103c90:	e8 73 fe ff ff       	call   80103b08 <outb>

  outb(IO_PIC2, 0x68);             // OCW3
80103c95:	c7 44 24 04 68 00 00 	movl   $0x68,0x4(%esp)
80103c9c:	00 
80103c9d:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103ca4:	e8 5f fe ff ff       	call   80103b08 <outb>
  outb(IO_PIC2, 0x0a);             // OCW3
80103ca9:	c7 44 24 04 0a 00 00 	movl   $0xa,0x4(%esp)
80103cb0:	00 
80103cb1:	c7 04 24 a0 00 00 00 	movl   $0xa0,(%esp)
80103cb8:	e8 4b fe ff ff       	call   80103b08 <outb>

  if(irqmask != 0xFFFF)
80103cbd:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103cc4:	66 83 f8 ff          	cmp    $0xffff,%ax
80103cc8:	74 12                	je     80103cdc <picinit+0x13d>
    picsetmask(irqmask);
80103cca:	0f b7 05 00 b0 10 80 	movzwl 0x8010b000,%eax
80103cd1:	0f b7 c0             	movzwl %ax,%eax
80103cd4:	89 04 24             	mov    %eax,(%esp)
80103cd7:	e8 4a fe ff ff       	call   80103b26 <picsetmask>
}
80103cdc:	c9                   	leave  
80103cdd:	c3                   	ret    
...
80103ce1:	83 ec 28             	sub    $0x28,%esp
  struct pipe *p;
...
80103cee:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80103cf4:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cf7:	8b 10                	mov    (%eax),%edx
80103cf9:	8b 45 08             	mov    0x8(%ebp),%eax
80103cfc:	89 10                	mov    %edx,(%eax)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
80103cfe:	e8 23 d2 ff ff       	call   80100f26 <filealloc>
80103d03:	8b 55 08             	mov    0x8(%ebp),%edx
80103d06:	89 02                	mov    %eax,(%edx)
80103d08:	8b 45 08             	mov    0x8(%ebp),%eax
80103d0b:	8b 00                	mov    (%eax),%eax
80103d0d:	85 c0                	test   %eax,%eax
80103d0f:	0f 84 c8 00 00 00    	je     80103ddd <pipealloc+0xff>
80103d15:	e8 0c d2 ff ff       	call   80100f26 <filealloc>
80103d1a:	8b 55 0c             	mov    0xc(%ebp),%edx
80103d1d:	89 02                	mov    %eax,(%edx)
80103d1f:	8b 45 0c             	mov    0xc(%ebp),%eax
80103d22:	8b 00                	mov    (%eax),%eax
80103d24:	85 c0                	test   %eax,%eax
80103d26:	0f 84 b1 00 00 00    	je     80103ddd <pipealloc+0xff>
    goto bad;
  if((p = (struct pipe*)kalloc()) == 0)
80103d2c:	e8 b1 ed ff ff       	call   80102ae2 <kalloc>
80103d31:	89 45 f4             	mov    %eax,-0xc(%ebp)
80103d34:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80103d38:	75 05                	jne    80103d3f <pipealloc+0x61>
    goto bad;
80103d3a:	e9 9e 00 00 00       	jmp    80103ddd <pipealloc+0xff>
  p->readopen = 1;
80103d3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103d42:	c7 80 3c 02 00 00 01 	movl   $0x1,0x23c(%eax)
80103d49:	00 00 00 
  p->writeopen = 1;
80103d4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103d4f:	c7 80 40 02 00 00 01 	movl   $0x1,0x240(%eax)
80103d56:	00 00 00 
  p->nwrite = 0;
80103d59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103d5c:	c7 80 38 02 00 00 00 	movl   $0x0,0x238(%eax)
80103d63:	00 00 00 
  p->nread = 0;
80103d66:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103d69:	c7 80 34 02 00 00 00 	movl   $0x0,0x234(%eax)
80103d70:	00 00 00 
  initlock(&p->lock, "pipe");
80103d73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103d76:	c7 44 24 04 74 8a 10 	movl   $0x80108a74,0x4(%esp)
80103d7d:	80 
80103d7e:	89 04 24             	mov    %eax,(%esp)
80103d81:	e8 d0 0f 00 00       	call   80104d56 <initlock>
  (*f0)->type = FD_PIPE;
80103d86:	8b 45 08             	mov    0x8(%ebp),%eax
80103d89:	8b 00                	mov    (%eax),%eax
80103d8b:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  (*f0)->readable = 1;
80103d91:	8b 45 08             	mov    0x8(%ebp),%eax
80103d94:	8b 00                	mov    (%eax),%eax
80103d96:	c6 40 08 01          	movb   $0x1,0x8(%eax)
  (*f0)->writable = 0;
80103d9a:	8b 45 08             	mov    0x8(%ebp),%eax
80103d9d:	8b 00                	mov    (%eax),%eax
80103d9f:	c6 40 09 00          	movb   $0x0,0x9(%eax)
  (*f0)->pipe = p;
80103da3:	8b 45 08             	mov    0x8(%ebp),%eax
80103da6:	8b 00                	mov    (%eax),%eax
80103da8:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103dab:	89 50 0c             	mov    %edx,0xc(%eax)
  (*f1)->type = FD_PIPE;
80103dae:	8b 45 0c             	mov    0xc(%ebp),%eax
80103db1:	8b 00                	mov    (%eax),%eax
80103db3:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
  (*f1)->readable = 0;
80103db9:	8b 45 0c             	mov    0xc(%ebp),%eax
80103dbc:	8b 00                	mov    (%eax),%eax
80103dbe:	c6 40 08 00          	movb   $0x0,0x8(%eax)
  (*f1)->writable = 1;
80103dc2:	8b 45 0c             	mov    0xc(%ebp),%eax
80103dc5:	8b 00                	mov    (%eax),%eax
80103dc7:	c6 40 09 01          	movb   $0x1,0x9(%eax)
  (*f1)->pipe = p;
80103dcb:	8b 45 0c             	mov    0xc(%ebp),%eax
80103dce:	8b 00                	mov    (%eax),%eax
80103dd0:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103dd3:	89 50 0c             	mov    %edx,0xc(%eax)
  return 0;
80103dd6:	b8 00 00 00 00       	mov    $0x0,%eax
80103ddb:	eb 42                	jmp    80103e1f <pipealloc+0x141>

//PAGEBREAK: 20
 bad:
  if(p)
80103ddd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80103de1:	74 0b                	je     80103dee <pipealloc+0x110>
    kfree((char*)p);
80103de3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103de6:	89 04 24             	mov    %eax,(%esp)
80103de9:	e8 5b ec ff ff       	call   80102a49 <kfree>
  if(*f0)
80103dee:	8b 45 08             	mov    0x8(%ebp),%eax
80103df1:	8b 00                	mov    (%eax),%eax
80103df3:	85 c0                	test   %eax,%eax
80103df5:	74 0d                	je     80103e04 <pipealloc+0x126>
    fileclose(*f0);
80103df7:	8b 45 08             	mov    0x8(%ebp),%eax
80103dfa:	8b 00                	mov    (%eax),%eax
80103dfc:	89 04 24             	mov    %eax,(%esp)
80103dff:	e8 ca d1 ff ff       	call   80100fce <fileclose>
  if(*f1)
80103e04:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e07:	8b 00                	mov    (%eax),%eax
80103e09:	85 c0                	test   %eax,%eax
80103e0b:	74 0d                	je     80103e1a <pipealloc+0x13c>
    fileclose(*f1);
80103e0d:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e10:	8b 00                	mov    (%eax),%eax
80103e12:	89 04 24             	mov    %eax,(%esp)
80103e15:	e8 b4 d1 ff ff       	call   80100fce <fileclose>
  return -1;
80103e1a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80103e1f:	c9                   	leave  
80103e20:	c3                   	ret    
...
80103e2d:	e8 45 0f 00 00       	call   80104d77 <acquire>
  if(writable){
80103e32:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80103e36:	74 1f                	je     80103e57 <pipeclose+0x36>
    p->writeopen = 0;
80103e38:	8b 45 08             	mov    0x8(%ebp),%eax
80103e3b:	c7 80 40 02 00 00 00 	movl   $0x0,0x240(%eax)
80103e42:	00 00 00 
    wakeup(&p->nread);
80103e45:	8b 45 08             	mov    0x8(%ebp),%eax
80103e48:	05 34 02 00 00       	add    $0x234,%eax
80103e4d:	89 04 24             	mov    %eax,(%esp)
80103e50:	e8 2b 0d 00 00       	call   80104b80 <wakeup>
80103e55:	eb 1d                	jmp    80103e74 <pipeclose+0x53>
  } else {
    p->readopen = 0;
80103e57:	8b 45 08             	mov    0x8(%ebp),%eax
80103e5a:	c7 80 3c 02 00 00 00 	movl   $0x0,0x23c(%eax)
80103e61:	00 00 00 
    wakeup(&p->nwrite);
80103e64:	8b 45 08             	mov    0x8(%ebp),%eax
80103e67:	05 38 02 00 00       	add    $0x238,%eax
80103e6c:	89 04 24             	mov    %eax,(%esp)
80103e6f:	e8 0c 0d 00 00       	call   80104b80 <wakeup>
  }
  if(p->readopen == 0 && p->writeopen == 0){
80103e74:	8b 45 08             	mov    0x8(%ebp),%eax
80103e77:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
80103e7d:	85 c0                	test   %eax,%eax
80103e7f:	75 25                	jne    80103ea6 <pipeclose+0x85>
80103e81:	8b 45 08             	mov    0x8(%ebp),%eax
80103e84:	8b 80 40 02 00 00    	mov    0x240(%eax),%eax
80103e8a:	85 c0                	test   %eax,%eax
80103e8c:	75 18                	jne    80103ea6 <pipeclose+0x85>
    release(&p->lock);
80103e8e:	8b 45 08             	mov    0x8(%ebp),%eax
80103e91:	89 04 24             	mov    %eax,(%esp)
80103e94:	e8 40 0f 00 00       	call   80104dd9 <release>
    kfree((char*)p);
80103e99:	8b 45 08             	mov    0x8(%ebp),%eax
80103e9c:	89 04 24             	mov    %eax,(%esp)
80103e9f:	e8 a5 eb ff ff       	call   80102a49 <kfree>
80103ea4:	eb 0b                	jmp    80103eb1 <pipeclose+0x90>
  } else
    release(&p->lock);
80103ea6:	8b 45 08             	mov    0x8(%ebp),%eax
80103ea9:	89 04 24             	mov    %eax,(%esp)
80103eac:	e8 28 0f 00 00       	call   80104dd9 <release>
}
80103eb1:	c9                   	leave  
80103eb2:	c3                   	ret    
...
80103ebf:	e8 b3 0e 00 00       	call   80104d77 <acquire>
  for(i = 0; i < n; i++){
80103ec4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80103ecb:	e9 a6 00 00 00       	jmp    80103f76 <pipewrite+0xc3>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
80103ed0:	eb 57                	jmp    80103f29 <pipewrite+0x76>
      if(p->readopen == 0 || proc->killed){
80103ed2:	8b 45 08             	mov    0x8(%ebp),%eax
80103ed5:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
80103edb:	85 c0                	test   %eax,%eax
80103edd:	74 0d                	je     80103eec <pipewrite+0x39>
80103edf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103ee5:	8b 40 24             	mov    0x24(%eax),%eax
80103ee8:	85 c0                	test   %eax,%eax
80103eea:	74 15                	je     80103f01 <pipewrite+0x4e>
        release(&p->lock);
80103eec:	8b 45 08             	mov    0x8(%ebp),%eax
80103eef:	89 04 24             	mov    %eax,(%esp)
80103ef2:	e8 e2 0e 00 00       	call   80104dd9 <release>
        return -1;
80103ef7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103efc:	e9 9f 00 00 00       	jmp    80103fa0 <pipewrite+0xed>
      }
      wakeup(&p->nread);
80103f01:	8b 45 08             	mov    0x8(%ebp),%eax
80103f04:	05 34 02 00 00       	add    $0x234,%eax
80103f09:	89 04 24             	mov    %eax,(%esp)
80103f0c:	e8 6f 0c 00 00       	call   80104b80 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103f11:	8b 45 08             	mov    0x8(%ebp),%eax
80103f14:	8b 55 08             	mov    0x8(%ebp),%edx
80103f17:	81 c2 38 02 00 00    	add    $0x238,%edx
80103f1d:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f21:	89 14 24             	mov    %edx,(%esp)
80103f24:	e8 7b 0b 00 00       	call   80104aa4 <sleep>
{
  int i;
...
80103f2c:	8b 90 38 02 00 00    	mov    0x238(%eax),%edx
80103f32:	8b 45 08             	mov    0x8(%ebp),%eax
80103f35:	8b 80 34 02 00 00    	mov    0x234(%eax),%eax
80103f3b:	05 00 02 00 00       	add    $0x200,%eax
80103f40:	39 c2                	cmp    %eax,%edx
80103f42:	74 8e                	je     80103ed2 <pipewrite+0x1f>
        return -1;
      }
      wakeup(&p->nread);
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
...
80103f4d:	8d 48 01             	lea    0x1(%eax),%ecx
80103f50:	8b 55 08             	mov    0x8(%ebp),%edx
80103f53:	89 8a 38 02 00 00    	mov    %ecx,0x238(%edx)
80103f59:	25 ff 01 00 00       	and    $0x1ff,%eax
80103f5e:	89 c1                	mov    %eax,%ecx
80103f60:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103f63:	8b 45 0c             	mov    0xc(%ebp),%eax
80103f66:	01 d0                	add    %edx,%eax
80103f68:	0f b6 10             	movzbl (%eax),%edx
80103f6b:	8b 45 08             	mov    0x8(%ebp),%eax
80103f6e:	88 54 08 34          	mov    %dl,0x34(%eax,%ecx,1)
pipewrite(struct pipe *p, char *addr, int n)
{
  int i;
...
80103f7c:	0f 8c 4e ff ff ff    	jl     80103ed0 <pipewrite+0x1d>
      wakeup(&p->nread);
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
    }
    p->data[p->nwrite++ % PIPESIZE] = addr[i];
...
80103f85:	05 34 02 00 00       	add    $0x234,%eax
80103f8a:	89 04 24             	mov    %eax,(%esp)
80103f8d:	e8 ee 0b 00 00       	call   80104b80 <wakeup>
  release(&p->lock);
80103f92:	8b 45 08             	mov    0x8(%ebp),%eax
80103f95:	89 04 24             	mov    %eax,(%esp)
80103f98:	e8 3c 0e 00 00       	call   80104dd9 <release>
  return n;
80103f9d:	8b 45 10             	mov    0x10(%ebp),%eax
}
80103fa0:	c9                   	leave  
80103fa1:	c3                   	ret    
...
80103fa6:	83 ec 24             	sub    $0x24,%esp
  int i;

  acquire(&p->lock);
80103fa9:	8b 45 08             	mov    0x8(%ebp),%eax
80103fac:	89 04 24             	mov    %eax,(%esp)
80103faf:	e8 c3 0d 00 00       	call   80104d77 <acquire>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
80103fb4:	eb 3a                	jmp    80103ff0 <piperead+0x4e>
    if(proc->killed){
80103fb6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103fbc:	8b 40 24             	mov    0x24(%eax),%eax
80103fbf:	85 c0                	test   %eax,%eax
80103fc1:	74 15                	je     80103fd8 <piperead+0x36>
      release(&p->lock);
80103fc3:	8b 45 08             	mov    0x8(%ebp),%eax
80103fc6:	89 04 24             	mov    %eax,(%esp)
80103fc9:	e8 0b 0e 00 00       	call   80104dd9 <release>
      return -1;
80103fce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fd3:	e9 b5 00 00 00       	jmp    8010408d <piperead+0xeb>
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
80103fd8:	8b 45 08             	mov    0x8(%ebp),%eax
80103fdb:	8b 55 08             	mov    0x8(%ebp),%edx
80103fde:	81 c2 34 02 00 00    	add    $0x234,%edx
80103fe4:	89 44 24 04          	mov    %eax,0x4(%esp)
80103fe8:	89 14 24             	mov    %edx,(%esp)
80103feb:	e8 b4 0a 00 00       	call   80104aa4 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103ff3:	8b 90 34 02 00 00    	mov    0x234(%eax),%edx
80103ff9:	8b 45 08             	mov    0x8(%ebp),%eax
80103ffc:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
80104002:	39 c2                	cmp    %eax,%edx
80104004:	75 0d                	jne    80104013 <piperead+0x71>
80104006:	8b 45 08             	mov    0x8(%ebp),%eax
80104009:	8b 80 40 02 00 00    	mov    0x240(%eax),%eax
8010400f:	85 c0                	test   %eax,%eax
80104011:	75 a3                	jne    80103fb6 <piperead+0x14>
      release(&p->lock);
      return -1;
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
...
80104013:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010401a:	eb 4b                	jmp    80104067 <piperead+0xc5>
    if(p->nread == p->nwrite)
8010401c:	8b 45 08             	mov    0x8(%ebp),%eax
8010401f:	8b 90 34 02 00 00    	mov    0x234(%eax),%edx
80104025:	8b 45 08             	mov    0x8(%ebp),%eax
80104028:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
8010402e:	39 c2                	cmp    %eax,%edx
80104030:	75 02                	jne    80104034 <piperead+0x92>
      break;
80104032:	eb 3b                	jmp    8010406f <piperead+0xcd>
    addr[i] = p->data[p->nread++ % PIPESIZE];
80104034:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104037:	8b 45 0c             	mov    0xc(%ebp),%eax
8010403a:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
8010403d:	8b 45 08             	mov    0x8(%ebp),%eax
80104040:	8b 80 34 02 00 00    	mov    0x234(%eax),%eax
80104046:	8d 48 01             	lea    0x1(%eax),%ecx
80104049:	8b 55 08             	mov    0x8(%ebp),%edx
8010404c:	89 8a 34 02 00 00    	mov    %ecx,0x234(%edx)
80104052:	25 ff 01 00 00       	and    $0x1ff,%eax
80104057:	89 c2                	mov    %eax,%edx
80104059:	8b 45 08             	mov    0x8(%ebp),%eax
8010405c:	0f b6 44 10 34       	movzbl 0x34(%eax,%edx,1),%eax
80104061:	88 03                	mov    %al,(%ebx)
      release(&p->lock);
      return -1;
    }
    sleep(&p->nread, &p->lock); //DOC: piperead-sleep
...
8010406a:	3b 45 10             	cmp    0x10(%ebp),%eax
8010406d:	7c ad                	jl     8010401c <piperead+0x7a>
    if(p->nread == p->nwrite)
      break;
    addr[i] = p->data[p->nread++ % PIPESIZE];
  }
...
80104072:	05 38 02 00 00       	add    $0x238,%eax
80104077:	89 04 24             	mov    %eax,(%esp)
8010407a:	e8 01 0b 00 00       	call   80104b80 <wakeup>
  release(&p->lock);
8010407f:	8b 45 08             	mov    0x8(%ebp),%eax
80104082:	89 04 24             	mov    %eax,(%esp)
80104085:	e8 4f 0d 00 00       	call   80104dd9 <release>
  return i;
8010408a:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
8010408d:	83 c4 24             	add    $0x24,%esp
80104090:	5b                   	pop    %ebx
80104091:	5d                   	pop    %ebp
80104092:	c3                   	ret    
...
8010409b:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return eflags;
8010409e:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
801040a1:	c9                   	leave  
801040a2:	c3                   	ret    
...
801040af:	c7 44 24 04 79 8a 10 	movl   $0x80108a79,0x4(%esp)
801040b6:	80 
801040b7:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
801040be:	e8 93 0c 00 00       	call   80104d56 <initlock>
}
801040c3:	c9                   	leave  
801040c4:	c3                   	ret    
...
801040c8:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
801040cb:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
801040d2:	e8 a0 0c 00 00       	call   80104d77 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040d7:	c7 45 f4 d4 29 11 80 	movl   $0x801129d4,-0xc(%ebp)
801040de:	eb 53                	jmp    80104133 <allocproc+0x6e>
    if(p->state == UNUSED)
801040e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040e3:	8b 40 0c             	mov    0xc(%eax),%eax
801040e6:	85 c0                	test   %eax,%eax
801040e8:	75 42                	jne    8010412c <allocproc+0x67>
      goto found;
801040ea:	90                   	nop
  release(&ptable.lock);
  return 0;
...
801040ee:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
801040f5:	a1 04 b0 10 80       	mov    0x8010b004,%eax
801040fa:	8d 50 01             	lea    0x1(%eax),%edx
801040fd:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
80104103:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104106:	89 42 10             	mov    %eax,0x10(%edx)
  release(&ptable.lock);
80104109:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104110:	e8 c4 0c 00 00       	call   80104dd9 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104115:	e8 c8 e9 ff ff       	call   80102ae2 <kalloc>
8010411a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010411d:	89 42 08             	mov    %eax,0x8(%edx)
80104120:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104123:	8b 40 08             	mov    0x8(%eax),%eax
80104126:	85 c0                	test   %eax,%eax
80104128:	75 36                	jne    80104160 <allocproc+0x9b>
8010412a:	eb 23                	jmp    8010414f <allocproc+0x8a>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010412c:	81 45 f4 50 01 00 00 	addl   $0x150,-0xc(%ebp)
80104133:	81 7d f4 d4 7d 11 80 	cmpl   $0x80117dd4,-0xc(%ebp)
8010413a:	72 a4                	jb     801040e0 <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
8010413c:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104143:	e8 91 0c 00 00       	call   80104dd9 <release>
  return 0;
80104148:	b8 00 00 00 00       	mov    $0x0,%eax
8010414d:	eb 76                	jmp    801041c5 <allocproc+0x100>
  p->pid = nextpid++;
  release(&ptable.lock);
...
80104152:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
80104159:	b8 00 00 00 00       	mov    $0x0,%eax
8010415e:	eb 65                	jmp    801041c5 <allocproc+0x100>
  }
  sp = p->kstack + KSTACKSIZE;
80104160:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104163:	8b 40 08             	mov    0x8(%eax),%eax
80104166:	05 00 10 00 00       	add    $0x1000,%eax
8010416b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
8010416e:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
80104172:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104175:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104178:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
8010417b:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
8010417f:	ba 41 68 10 80       	mov    $0x80106841,%edx
80104184:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104187:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
80104189:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
8010418d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104190:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104193:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
80104196:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104199:	8b 40 1c             	mov    0x1c(%eax),%eax
8010419c:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801041a3:	00 
801041a4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801041ab:	00 
801041ac:	89 04 24             	mov    %eax,(%esp)
801041af:	e8 17 0e 00 00       	call   80104fcb <memset>
  p->context->eip = (uint)forkret;
801041b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041b7:	8b 40 1c             	mov    0x1c(%eax),%eax
801041ba:	ba 78 4a 10 80       	mov    $0x80104a78,%edx
801041bf:	89 50 10             	mov    %edx,0x10(%eax)
...
801041ca:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  extern char _binary_initcode_start[], _binary_initcode_size[];
  
  p = allocproc();
801041cd:	e8 f3 fe ff ff       	call   801040c5 <allocproc>
801041d2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801041d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041d8:	a3 88 b6 10 80       	mov    %eax,0x8010b688
  if((p->pgdir = setupkvm()) == 0)
801041dd:	e8 53 3d 00 00       	call   80107f35 <setupkvm>
801041e2:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041e5:	89 42 04             	mov    %eax,0x4(%edx)
801041e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041eb:	8b 40 04             	mov    0x4(%eax),%eax
801041ee:	85 c0                	test   %eax,%eax
801041f0:	75 0c                	jne    801041fe <userinit+0x37>
    panic("userinit: out of memory?");
801041f2:	c7 04 24 80 8a 10 80 	movl   $0x80108a80,(%esp)
801041f9:	e8 3c c3 ff ff       	call   8010053a <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801041fe:	ba 2c 00 00 00       	mov    $0x2c,%edx
80104203:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104206:	8b 40 04             	mov    0x4(%eax),%eax
80104209:	89 54 24 08          	mov    %edx,0x8(%esp)
8010420d:	c7 44 24 04 20 b5 10 	movl   $0x8010b520,0x4(%esp)
80104214:	80 
80104215:	89 04 24             	mov    %eax,(%esp)
80104218:	e8 70 3f 00 00       	call   8010818d <inituvm>
  p->sz = PGSIZE;
8010421d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104220:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104226:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104229:	8b 40 18             	mov    0x18(%eax),%eax
8010422c:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104233:	00 
80104234:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010423b:	00 
8010423c:	89 04 24             	mov    %eax,(%esp)
8010423f:	e8 87 0d 00 00       	call   80104fcb <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80104244:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104247:	8b 40 18             	mov    0x18(%eax),%eax
8010424a:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80104250:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104253:	8b 40 18             	mov    0x18(%eax),%eax
80104256:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
8010425c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010425f:	8b 40 18             	mov    0x18(%eax),%eax
80104262:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104265:	8b 52 18             	mov    0x18(%edx),%edx
80104268:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
8010426c:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80104270:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104273:	8b 40 18             	mov    0x18(%eax),%eax
80104276:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104279:	8b 52 18             	mov    0x18(%edx),%edx
8010427c:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104280:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80104284:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104287:	8b 40 18             	mov    0x18(%eax),%eax
8010428a:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80104291:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104294:	8b 40 18             	mov    0x18(%eax),%eax
80104297:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010429e:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042a1:	8b 40 18             	mov    0x18(%eax),%eax
801042a4:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
801042ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042ae:	83 c0 6c             	add    $0x6c,%eax
801042b1:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801042b8:	00 
801042b9:	c7 44 24 04 99 8a 10 	movl   $0x80108a99,0x4(%esp)
801042c0:	80 
801042c1:	89 04 24             	mov    %eax,(%esp)
801042c4:	e8 22 0f 00 00       	call   801051eb <safestrcpy>
  p->cwd = namei("/");
801042c9:	c7 04 24 a2 8a 10 80 	movl   $0x80108aa2,(%esp)
801042d0:	e8 31 e1 ff ff       	call   80102406 <namei>
801042d5:	8b 55 f4             	mov    -0xc(%ebp),%edx
801042d8:	89 42 68             	mov    %eax,0x68(%edx)
...
801042ea:	83 ec 28             	sub    $0x28,%esp
  uint sz;
...
801042fc:	7e 34                	jle    80104332 <growproc+0x4b>
...
8010431d:	e8 e1 3f 00 00       	call   80108303 <allocuvm>
80104322:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104325:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104329:	75 41                	jne    8010436c <growproc+0x85>
      return -1;
8010432b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104330:	eb 58                	jmp    8010438a <growproc+0xa3>
  } else if(n < 0){
80104332:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104336:	79 34                	jns    8010436c <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
80104338:	8b 55 08             	mov    0x8(%ebp),%edx
8010433b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010433e:	01 c2                	add    %eax,%edx
80104340:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104346:	8b 40 04             	mov    0x4(%eax),%eax
80104349:	89 54 24 08          	mov    %edx,0x8(%esp)
8010434d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104350:	89 54 24 04          	mov    %edx,0x4(%esp)
80104354:	89 04 24             	mov    %eax,(%esp)
80104357:	e8 81 40 00 00       	call   801083dd <deallocuvm>
8010435c:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010435f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104363:	75 07                	jne    8010436c <growproc+0x85>
      return -1;
80104365:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010436a:	eb 1e                	jmp    8010438a <growproc+0xa3>
  }
  proc->sz = sz;
8010436c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104372:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104375:	89 10                	mov    %edx,(%eax)
  switchuvm(proc);
80104377:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010437d:	89 04 24             	mov    %eax,(%esp)
80104380:	e8 a1 3c 00 00       	call   80108026 <switchuvm>
  return 0;
...
80104392:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
80104395:	e8 2b fd ff ff       	call   801040c5 <allocproc>
8010439a:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010439d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801043a1:	75 0a                	jne    801043ad <fork+0x21>
    return -1;
801043a3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043a8:	e9 b2 02 00 00       	jmp    8010465f <fork+0x2d3>

  if(proc->ctflag){
801043ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043b3:	8b 40 7c             	mov    0x7c(%eax),%eax
801043b6:	85 c0                	test   %eax,%eax
801043b8:	74 21                	je     801043db <fork+0x4f>

    np->pgdir = proc->pgdir;
801043ba:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043c0:	8b 50 04             	mov    0x4(%eax),%edx
801043c3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043c6:	89 50 04             	mov    %edx,0x4(%eax)
    //np->kstack = proc->cStack;
    np->type = 1;
801043c9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043cc:	c7 80 80 00 00 00 01 	movl   $0x1,0x80(%eax)
801043d3:	00 00 00 
801043d6:	e9 d9 00 00 00       	jmp    801044b4 <fork+0x128>
...
801043db:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043e1:	8b 10                	mov    (%eax),%edx
801043e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043e9:	8b 40 04             	mov    0x4(%eax),%eax
801043ec:	89 54 24 04          	mov    %edx,0x4(%esp)
801043f0:	89 04 24             	mov    %eax,(%esp)
801043f3:	e8 81 41 00 00       	call   80108579 <copyuvm>
801043f8:	8b 55 e0             	mov    -0x20(%ebp),%edx
801043fb:	89 42 04             	mov    %eax,0x4(%edx)
801043fe:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104401:	8b 40 04             	mov    0x4(%eax),%eax
80104404:	85 c0                	test   %eax,%eax
80104406:	75 2c                	jne    80104434 <fork+0xa8>
      kfree(np->kstack);
80104408:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010440b:	8b 40 08             	mov    0x8(%eax),%eax
8010440e:	89 04 24             	mov    %eax,(%esp)
80104411:	e8 33 e6 ff ff       	call   80102a49 <kfree>
      np->kstack = 0;
80104416:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104419:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
      np->state = UNUSED;
80104420:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104423:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
      return -1;
8010442a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010442f:	e9 2b 02 00 00       	jmp    8010465f <fork+0x2d3>
    }

    np->type = 0;
80104434:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104437:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
8010443e:	00 00 00 

    for(i=0;i<NMUTX;i++){
80104441:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104448:	eb 64                	jmp    801044ae <fork+0x122>
	proc->mutexlist[i].id = -1;
8010444a:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80104451:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104454:	89 d0                	mov    %edx,%eax
80104456:	01 c0                	add    %eax,%eax
80104458:	01 d0                	add    %edx,%eax
8010445a:	c1 e0 02             	shl    $0x2,%eax
8010445d:	01 c8                	add    %ecx,%eax
8010445f:	05 90 00 00 00       	add    $0x90,%eax
80104464:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
	proc->mutexlist[i].state = -1;
8010446a:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80104471:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104474:	89 d0                	mov    %edx,%eax
80104476:	01 c0                	add    %eax,%eax
80104478:	01 d0                	add    %edx,%eax
8010447a:	c1 e0 02             	shl    $0x2,%eax
8010447d:	01 c8                	add    %ecx,%eax
8010447f:	05 94 00 00 00       	add    $0x94,%eax
80104484:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
        proc->mutexlist[i].lockingthread = -1;
8010448a:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80104491:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104494:	89 d0                	mov    %edx,%eax
80104496:	01 c0                	add    %eax,%eax
80104498:	01 d0                	add    %edx,%eax
8010449a:	c1 e0 02             	shl    $0x2,%eax
8010449d:	01 c8                	add    %ecx,%eax
8010449f:	05 98 00 00 00       	add    $0x98,%eax
801044a4:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
      return -1;
    }
    ...
    for(i=0;i<NMUTX;i++){
801044aa:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801044ae:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801044b2:	7e 96                	jle    8010444a <fork+0xbe>
	proc->mutexlist[i].state = -1;
        proc->mutexlist[i].lockingthread = -1;
    }
  }
...
801044ba:	8b 10                	mov    (%eax),%edx
801044bc:	8b 45 e0             	mov    -0x20(%ebp),%eax
801044bf:	89 10                	mov    %edx,(%eax)

  if(proc->type && proc->ctflag)
801044c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044c7:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
801044cd:	85 c0                	test   %eax,%eax
801044cf:	74 1e                	je     801044ef <fork+0x163>
801044d1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044d7:	8b 40 7c             	mov    0x7c(%eax),%eax
801044da:	85 c0                	test   %eax,%eax
801044dc:	74 11                	je     801044ef <fork+0x163>
    np->parent = proc->parent;
801044de:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044e4:	8b 50 14             	mov    0x14(%eax),%edx
801044e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
801044ea:	89 50 14             	mov    %edx,0x14(%eax)
801044ed:	eb 0d                	jmp    801044fc <fork+0x170>
  else
    np->parent = proc;
801044ef:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
...
8010457c:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010457f:	89 50 44             	mov    %edx,0x44(%eax)
  proc->tcount+=1;
80104582:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104588:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010458f:	8b 92 8c 00 00 00    	mov    0x8c(%edx),%edx
80104595:	83 c2 01             	add    $0x1,%edx
80104598:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
}
...
801045a4:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
801045ab:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801045b2:	eb 3d                	jmp    801045f1 <fork+0x265>
    if(proc->ofile[i])
...
801045c6:	74 25                	je     801045ed <fork+0x261>
      np->ofile[i] = filedup(proc->ofile[i]);
801045c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045ce:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801045d1:	83 c2 08             	add    $0x8,%edx
801045d4:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801045d8:	89 04 24             	mov    %eax,(%esp)
801045db:	e8 a6 c9 ff ff       	call   80100f86 <filedup>
801045e0:	8b 55 e0             	mov    -0x20(%ebp),%edx
801045e3:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801045e6:	83 c1 08             	add    $0x8,%ecx
801045e9:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
}
  ...
  for(i = 0; i < NOFILE; i++)
801045ed:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801045f1:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801045f5:	7e bd                	jle    801045b4 <fork+0x228>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
801045f7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045fd:	8b 40 68             	mov    0x68(%eax),%eax
80104600:	89 04 24             	mov    %eax,(%esp)
80104603:	e8 21 d2 ff ff       	call   80101829 <idup>
80104608:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010460b:	89 42 68             	mov    %eax,0x68(%edx)

  safestrcpy(np->name, proc->name, sizeof(proc->name));
8010460e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104614:	8d 50 6c             	lea    0x6c(%eax),%edx
80104617:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010461a:	83 c0 6c             	add    $0x6c,%eax
8010461d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104624:	00 
80104625:	89 54 24 04          	mov    %edx,0x4(%esp)
80104629:	89 04 24             	mov    %eax,(%esp)
8010462c:	e8 ba 0b 00 00       	call   801051eb <safestrcpy>
 
  pid = np->pid;
80104631:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104634:	8b 40 10             	mov    0x10(%eax),%eax
80104637:	89 45 d8             	mov    %eax,-0x28(%ebp)

  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
8010463a:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104641:	e8 31 07 00 00       	call   80104d77 <acquire>
  np->state = RUNNABLE;
80104646:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104649:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
80104650:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104657:	e8 7d 07 00 00       	call   80104dd9 <release>

  return pid;
8010465c:	8b 45 d8             	mov    -0x28(%ebp),%eax

}
8010465f:	83 c4 2c             	add    $0x2c,%esp
80104662:	5b                   	pop    %ebx
80104663:	5e                   	pop    %esi
80104664:	5f                   	pop    %edi
80104665:	5d                   	pop    %ebp
...
8010466a:	83 ec 28             	sub    $0x28,%esp
  ...
  if(proc == initproc)
8010466d:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104674:	a1 88 b6 10 80       	mov    0x8010b688,%eax
80104679:	39 c2                	cmp    %eax,%edx
8010467b:	75 0c                	jne    80104689 <exit+0x22>
    panic("init exiting");
8010467d:	c7 04 24 a4 8a 10 80 	movl   $0x80108aa4,(%esp)
80104684:	e8 b1 be ff ff       	call   8010053a <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104689:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104690:	eb 44                	jmp    801046d6 <exit+0x6f>
    if(proc->ofile[fd]){
...
801046a4:	74 2c                	je     801046d2 <exit+0x6b>
...
801046d1:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801046d2:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801046d6:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
801046da:	7e b6                	jle    80104692 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
801046dc:	e8 04 eb ff ff       	call   801031e5 <begin_op>
  iput(proc->cwd);
801046e1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046e7:	8b 40 68             	mov    0x68(%eax),%eax
801046ea:	89 04 24             	mov    %eax,(%esp)
801046ed:	e8 1c d3 ff ff       	call   80101a0e <iput>
  end_op();
801046f2:	e8 72 eb ff ff       	call   80103269 <end_op>
  proc->cwd = 0;
801046f7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046fd:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104704:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
8010470b:	e8 67 06 00 00       	call   80104d77 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104710:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104716:	8b 40 14             	mov    0x14(%eax),%eax
80104719:	89 04 24             	mov    %eax,(%esp)
8010471c:	e8 1e 04 00 00       	call   80104b3f <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104721:	c7 45 f4 d4 29 11 80 	movl   $0x801129d4,-0xc(%ebp)
80104728:	eb 3b                	jmp    80104765 <exit+0xfe>
    if(p->parent == proc){
8010472a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010472d:	8b 50 14             	mov    0x14(%eax),%edx
80104730:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104736:	39 c2                	cmp    %eax,%edx
80104738:	75 24                	jne    8010475e <exit+0xf7>
      p->parent = initproc;
8010473a:	8b 15 88 b6 10 80    	mov    0x8010b688,%edx
...
8010474f:	75 0d                	jne    8010475e <exit+0xf7>
        wakeup1(initproc);
80104751:	a1 88 b6 10 80       	mov    0x8010b688,%eax
80104756:	89 04 24             	mov    %eax,(%esp)
80104759:	e8 e1 03 00 00       	call   80104b3f <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010475e:	81 45 f4 50 01 00 00 	addl   $0x150,-0xc(%ebp)
80104765:	81 7d f4 d4 7d 11 80 	cmpl   $0x80117dd4,-0xc(%ebp)
8010476c:	72 bc                	jb     8010472a <exit+0xc3>
        wakeup1(initproc);
    }
  }
...
80104774:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
8010477b:	e8 14 02 00 00       	call   80104994 <sched>
  panic("zombie exit");
80104780:	c7 04 24 b1 8a 10 80 	movl   $0x80108ab1,(%esp)
80104787:	e8 ae bd ff ff       	call   8010053a <panic>
...
8010478f:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  int havekids, pid;

  acquire(&ptable.lock);
80104792:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104799:	e8 d9 05 00 00       	call   80104d77 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
8010479e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047a5:	c7 45 f4 d4 29 11 80 	movl   $0x801129d4,-0xc(%ebp)
801047ac:	e9 f8 00 00 00       	jmp    801048a9 <wait+0x11d>
      if(p->parent != proc)
...
801047bf:	74 05                	je     801047c6 <wait+0x3a>
        continue;
801047c1:	e9 dc 00 00 00       	jmp    801048a2 <wait+0x116>
      
      if(tid)
801047c6:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801047ca:	74 10                	je     801047dc <wait+0x50>
	if(tid != p->pid)
801047cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047cf:	8b 40 10             	mov    0x10(%eax),%eax
801047d2:	3b 45 08             	cmp    0x8(%ebp),%eax
801047d5:	74 05                	je     801047dc <wait+0x50>
	  continue;
801047d7:	e9 c6 00 00 00       	jmp    801048a2 <wait+0x116>
     
      havekids = 1;
801047dc:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
 
      if(p->state == ZOMBIE){
801047e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047e6:	8b 40 0c             	mov    0xc(%eax),%eax
801047e9:	83 f8 05             	cmp    $0x5,%eax
801047ec:	0f 85 b0 00 00 00    	jne    801048a2 <wait+0x116>
        // Found one.
        pid = p->pid;
801047f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047f5:	8b 40 10             	mov    0x10(%eax),%eax
801047f8:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
801047fb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047fe:	8b 40 08             	mov    0x8(%eax),%eax
80104801:	89 04 24             	mov    %eax,(%esp)
80104804:	e8 40 e2 ff ff       	call   80102a49 <kfree>
        p->kstack = 0;
80104809:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010480c:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)

	if(!p->type && (p->tcount == 0))
80104813:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104816:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
8010481c:	85 c0                	test   %eax,%eax
8010481e:	75 1d                	jne    8010483d <wait+0xb1>
80104820:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104823:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80104829:	85 c0                	test   %eax,%eax
8010482b:	75 10                	jne    8010483d <wait+0xb1>
           freevm(p->pgdir);
8010482d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104830:	8b 40 04             	mov    0x4(%eax),%eax
80104833:	89 04 24             	mov    %eax,(%esp)
80104836:	e8 5e 3c 00 00       	call   80108499 <freevm>
8010483b:	eb 25                	jmp    80104862 <wait+0xd6>
	else {
	   p->pgdir = 0;
8010483d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104840:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	   p->parent->tcount-=1;
80104847:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010484a:	8b 40 14             	mov    0x14(%eax),%eax
8010484d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104850:	8b 52 14             	mov    0x14(%edx),%edx
80104853:	8b 92 8c 00 00 00    	mov    0x8c(%edx),%edx
80104859:	83 ea 01             	sub    $0x1,%edx
8010485c:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
	}

        p->state = UNUSED;
80104862:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104865:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
8010486c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010486f:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104876:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104879:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104880:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104883:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104887:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010488a:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104891:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104898:	e8 3c 05 00 00       	call   80104dd9 <release>
        return pid;
8010489d:	8b 45 ec             	mov    -0x14(%ebp),%eax
801048a0:	eb 55                	jmp    801048f7 <wait+0x16b>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048a2:	81 45 f4 50 01 00 00 	addl   $0x150,-0xc(%ebp)
801048a9:	81 7d f4 d4 7d 11 80 	cmpl   $0x80117dd4,-0xc(%ebp)
801048b0:	0f 82 fb fe ff ff    	jb     801047b1 <wait+0x25>
        return pid;
      }
    }
...
801048b6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801048ba:	74 0d                	je     801048c9 <wait+0x13d>
801048bc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048c2:	8b 40 24             	mov    0x24(%eax),%eax
801048c5:	85 c0                	test   %eax,%eax
801048c7:	74 13                	je     801048dc <wait+0x150>
      release(&ptable.lock);
801048c9:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
801048d0:	e8 04 05 00 00       	call   80104dd9 <release>
      return -1;
801048d5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801048da:	eb 1b                	jmp    801048f7 <wait+0x16b>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
801048dc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048e2:	c7 44 24 04 a0 29 11 	movl   $0x801129a0,0x4(%esp)
801048e9:	80 
801048ea:	89 04 24             	mov    %eax,(%esp)
801048ed:	e8 b2 01 00 00       	call   80104aa4 <sleep>
  }
801048f2:	e9 a7 fe ff ff       	jmp    8010479e <wait+0x12>
}
801048f7:	c9                   	leave  
801048f8:	c3                   	ret    
...
801048fc:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
801048ff:	e8 9f f7 ff ff       	call   801040a3 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104904:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
8010490b:	e8 67 04 00 00       	call   80104d77 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104910:	c7 45 f4 d4 29 11 80 	movl   $0x801129d4,-0xc(%ebp)
80104917:	eb 61                	jmp    8010497a <scheduler+0x81>
      if(p->state != RUNNABLE)
80104919:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010491c:	8b 40 0c             	mov    0xc(%eax),%eax
8010491f:	83 f8 03             	cmp    $0x3,%eax
80104922:	74 02                	je     80104926 <scheduler+0x2d>
        continue;
80104924:	eb 4d                	jmp    80104973 <scheduler+0x7a>
...
80104935:	e8 ec 36 00 00       	call   80108026 <switchuvm>
      p->state = RUNNING;
...
8010494a:	8b 40 1c             	mov    0x1c(%eax),%eax
8010494d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104954:	83 c2 04             	add    $0x4,%edx
80104957:	89 44 24 04          	mov    %eax,0x4(%esp)
8010495b:	89 14 24             	mov    %edx,(%esp)
8010495e:	e8 f9 08 00 00       	call   8010525c <swtch>
      switchkvm();
80104963:	e8 a1 36 00 00       	call   80108009 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104968:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
8010496f:	00 00 00 00 
    // Enable interrupts on this processor.
    sti();
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104973:	81 45 f4 50 01 00 00 	addl   $0x150,-0xc(%ebp)
8010497a:	81 7d f4 d4 7d 11 80 	cmpl   $0x80117dd4,-0xc(%ebp)
80104981:	72 96                	jb     80104919 <scheduler+0x20>
    ...
    release(&ptable.lock);
80104983:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
8010498a:	e8 4a 04 00 00       	call   80104dd9 <release>

  }
8010498f:	e9 6b ff ff ff       	jmp    801048ff <scheduler+0x6>
...
8010499a:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
801049a1:	e8 fb 04 00 00       	call   80104ea1 <holding>
801049a6:	85 c0                	test   %eax,%eax
801049a8:	75 0c                	jne    801049b6 <sched+0x22>
    panic("sched ptable.lock");
801049aa:	c7 04 24 bd 8a 10 80 	movl   $0x80108abd,(%esp)
801049b1:	e8 84 bb ff ff       	call   8010053a <panic>
  if(cpu->ncli != 1)
801049b6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801049bc:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801049c2:	83 f8 01             	cmp    $0x1,%eax
801049c5:	74 0c                	je     801049d3 <sched+0x3f>
    panic("sched locks");
801049c7:	c7 04 24 cf 8a 10 80 	movl   $0x80108acf,(%esp)
...
801049dc:	83 f8 04             	cmp    $0x4,%eax
801049df:	75 0c                	jne    801049ed <sched+0x59>
    panic("sched running");
801049e1:	c7 04 24 db 8a 10 80 	movl   $0x80108adb,(%esp)
801049e8:	e8 4d bb ff ff       	call   8010053a <panic>
  if(readeflags()&FL_IF)
801049ed:	e8 a1 f6 ff ff       	call   80104093 <readeflags>
801049f2:	25 00 02 00 00       	and    $0x200,%eax
801049f7:	85 c0                	test   %eax,%eax
801049f9:	74 0c                	je     80104a07 <sched+0x73>
    panic("sched interruptible");
801049fb:	c7 04 24 e9 8a 10 80 	movl   $0x80108ae9,(%esp)
80104a02:	e8 33 bb ff ff       	call   8010053a <panic>
  intena = cpu->intena;
80104a07:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a0d:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104a13:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104a16:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a1c:	8b 40 04             	mov    0x4(%eax),%eax
80104a1f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104a26:	83 c2 1c             	add    $0x1c,%edx
80104a29:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a2d:	89 14 24             	mov    %edx,(%esp)
80104a30:	e8 27 08 00 00       	call   8010525c <swtch>
  cpu->intena = intena;
80104a35:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a3b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a3e:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104a44:	c9                   	leave  
80104a45:	c3                   	ret    
...
80104a4c:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104a53:	e8 1f 03 00 00       	call   80104d77 <acquire>
  proc->state = RUNNABLE;
80104a58:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a5e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104a65:	e8 2a ff ff ff       	call   80104994 <sched>
  release(&ptable.lock);
80104a6a:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104a71:	e8 63 03 00 00       	call   80104dd9 <release>
}
80104a76:	c9                   	leave  
80104a77:	c3                   	ret    
...
80104a7b:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104a7e:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104a85:	e8 4f 03 00 00       	call   80104dd9 <release>

  if (first) {
80104a8a:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104a8f:	85 c0                	test   %eax,%eax
80104a91:	74 0f                	je     80104aa2 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104a93:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104a9a:	00 00 00 
    initlog();
80104a9d:	e8 35 e5 ff ff       	call   80102fd7 <initlog>
  }
...
80104aa7:	83 ec 18             	sub    $0x18,%esp
  if(proc == 0)
80104aaa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ab0:	85 c0                	test   %eax,%eax
80104ab2:	75 0c                	jne    80104ac0 <sleep+0x1c>
    panic("sleep");
80104ab4:	c7 04 24 fd 8a 10 80 	movl   $0x80108afd,(%esp)
80104abb:	e8 7a ba ff ff       	call   8010053a <panic>

  if(lk == 0)
80104ac0:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104ac4:	75 0c                	jne    80104ad2 <sleep+0x2e>
    panic("sleep without lk");
80104ac6:	c7 04 24 03 8b 10 80 	movl   $0x80108b03,(%esp)
80104acd:	e8 68 ba ff ff       	call   8010053a <panic>
...
80104ad2:	81 7d 0c a0 29 11 80 	cmpl   $0x801129a0,0xc(%ebp)
80104ad9:	74 17                	je     80104af2 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104adb:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104ae2:	e8 90 02 00 00       	call   80104d77 <acquire>
    release(lk);
80104ae7:	8b 45 0c             	mov    0xc(%ebp),%eax
80104aea:	89 04 24             	mov    %eax,(%esp)
80104aed:	e8 e7 02 00 00       	call   80104dd9 <release>
  }
...
80104afb:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104afe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b04:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104b0b:	e8 84 fe ff ff       	call   80104994 <sched>
...
80104b1d:	81 7d 0c a0 29 11 80 	cmpl   $0x801129a0,0xc(%ebp)
80104b24:	74 17                	je     80104b3d <sleep+0x99>
    release(&ptable.lock);
80104b26:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104b2d:	e8 a7 02 00 00       	call   80104dd9 <release>
    acquire(lk);
80104b32:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b35:	89 04 24             	mov    %eax,(%esp)
80104b38:	e8 3a 02 00 00       	call   80104d77 <acquire>
  }
}
80104b3d:	c9                   	leave  
80104b3e:	c3                   	ret    
...
80104b42:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b45:	c7 45 fc d4 29 11 80 	movl   $0x801129d4,-0x4(%ebp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b6e:	81 45 fc 50 01 00 00 	addl   $0x150,-0x4(%ebp)
80104b75:	81 7d fc d4 7d 11 80 	cmpl   $0x80117dd4,-0x4(%ebp)
...
80104b83:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104b86:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104b8d:	e8 e5 01 00 00       	call   80104d77 <acquire>
  wakeup1(chan);
80104b92:	8b 45 08             	mov    0x8(%ebp),%eax
80104b95:	89 04 24             	mov    %eax,(%esp)
80104b98:	e8 a2 ff ff ff       	call   80104b3f <wakeup1>
  release(&ptable.lock);
80104b9d:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104ba4:	e8 30 02 00 00       	call   80104dd9 <release>
}
80104ba9:	c9                   	leave  
80104baa:	c3                   	ret    
...
80104bae:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104bb1:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104bb8:	e8 ba 01 00 00       	call   80104d77 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bbd:	c7 45 f4 d4 29 11 80 	movl   $0x801129d4,-0xc(%ebp)
...
80104be9:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104bf0:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104bf7:	e8 dd 01 00 00       	call   80104dd9 <release>
      return 0;
...
kill(int pid)
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c03:	81 45 f4 50 01 00 00 	addl   $0x150,-0xc(%ebp)
80104c0a:	81 7d f4 d4 7d 11 80 	cmpl   $0x80117dd4,-0xc(%ebp)
80104c11:	72 b3                	jb     80104bc6 <kill+0x1b>
  ...
  release(&ptable.lock);
80104c13:	c7 04 24 a0 29 11 80 	movl   $0x801129a0,(%esp)
80104c1a:	e8 ba 01 00 00       	call   80104dd9 <release>
  return -1;
...
80104c29:	83 ec 58             	sub    $0x58,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c2c:	c7 45 f0 d4 29 11 80 	movl   $0x801129d4,-0x10(%ebp)
...
80104c73:	eb 07                	jmp    80104c7c <procdump+0x56>
      ...
      state = "???";
80104c75:	c7 45 ec 14 8b 10 80 	movl   $0x80108b14,-0x14(%ebp)
...
80104c97:	c7 04 24 18 8b 10 80 	movl   $0x80108b18,(%esp)
80104c9e:	e8 fd b6 ff ff       	call   801003a0 <cprintf>
    if(p->state == SLEEPING){
...
80104cc4:	e8 5f 01 00 00       	call   80104e28 <getcallerpcs>
...
80104cdd:	c7 04 24 21 8b 10 80 	movl   $0x80108b21,(%esp)
80104ce4:	e8 b7 b6 ff ff       	call   801003a0 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
...
80104cfc:	75 d4                	jne    80104cd2 <procdump+0xac>
    ...
    cprintf("\n");
80104cfe:	c7 04 24 25 8b 10 80 	movl   $0x80108b25,(%esp)
80104d05:	e8 96 b6 ff ff       	call   801003a0 <cprintf>
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d0a:	81 45 f0 50 01 00 00 	addl   $0x150,-0x10(%ebp)
80104d11:	81 7d f0 d4 7d 11 80 	cmpl   $0x80117dd4,-0x10(%ebp)
...
80104d7d:	e8 49 01 00 00       	call   80104ecb <pushcli>
  if(holding(lk))
80104d82:	8b 45 08             	mov    0x8(%ebp),%eax
80104d85:	89 04 24             	mov    %eax,(%esp)
80104d88:	e8 14 01 00 00       	call   80104ea1 <holding>
80104d8d:	85 c0                	test   %eax,%eax
80104d8f:	74 0c                	je     80104d9d <acquire+0x26>
    panic("acquire");
80104d91:	c7 04 24 51 8b 10 80 	movl   $0x80108b51,(%esp)
...
80104da1:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104da8:	00 
80104da9:	89 04 24             	mov    %eax,(%esp)
80104dac:	e8 8b ff ff ff       	call   80104d3c <xchg>
80104db1:	85 c0                	test   %eax,%eax
80104db3:	75 e9                	jne    80104d9e <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104db5:	8b 45 08             	mov    0x8(%ebp),%eax
80104db8:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
...
80104de5:	e8 b7 00 00 00       	call   80104ea1 <holding>
80104dea:	85 c0                	test   %eax,%eax
80104dec:	75 0c                	jne    80104dfa <release+0x21>
    panic("release");
80104dee:	c7 04 24 59 8b 10 80 	movl   $0x80108b59,(%esp)
80104df5:	e8 40 b7 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104dfa:	8b 45 08             	mov    0x8(%ebp),%eax
80104dfd:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104e04:	8b 45 08             	mov    0x8(%ebp),%eax
80104e07:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104e11:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104e18:	00 
80104e19:	89 04 24             	mov    %eax,(%esp)
80104e1c:	e8 1b ff ff ff       	call   80104d3c <xchg>

  popcli();
80104e21:	e8 e9 00 00 00       	call   80104f0f <popcli>
}
80104e26:	c9                   	leave  
80104e27:	c3                   	ret    
...
80104ece:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104ed1:	e8 4a fe ff ff       	call   80104d20 <readeflags>
80104ed6:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104ed9:	e8 52 fe ff ff       	call   80104d30 <cli>
  if(cpu->ncli++ == 0)
80104ede:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104ee5:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
80104eeb:	8d 48 01             	lea    0x1(%eax),%ecx
80104eee:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
80104ef4:	85 c0                	test   %eax,%eax
80104ef6:	75 15                	jne    80104f0d <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80104ef8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104efe:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104f01:	81 e2 00 02 00 00    	and    $0x200,%edx
80104f07:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104f0d:	c9                   	leave  
80104f0e:	c3                   	ret    
...
80104f12:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104f15:	e8 06 fe ff ff       	call   80104d20 <readeflags>
80104f1a:	25 00 02 00 00       	and    $0x200,%eax
80104f1f:	85 c0                	test   %eax,%eax
80104f21:	74 0c                	je     80104f2f <popcli+0x20>
    panic("popcli - interruptible");
80104f23:	c7 04 24 61 8b 10 80 	movl   $0x80108b61,(%esp)
80104f2a:	e8 0b b6 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
80104f2f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f35:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104f3b:	83 ea 01             	sub    $0x1,%edx
80104f3e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104f44:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104f4a:	85 c0                	test   %eax,%eax
80104f4c:	79 0c                	jns    80104f5a <popcli+0x4b>
    panic("popcli");
80104f4e:	c7 04 24 78 8b 10 80 	movl   $0x80108b78,(%esp)
80104f55:	e8 e0 b5 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104f5a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f60:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104f66:	85 c0                	test   %eax,%eax
80104f68:	75 15                	jne    80104f7f <popcli+0x70>
80104f6a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f70:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104f76:	85 c0                	test   %eax,%eax
80104f78:	74 05                	je     80104f7f <popcli+0x70>
    sti();
80104f7a:	e8 b7 fd ff ff       	call   80104d36 <sti>
}
80104f7f:	c9                   	leave  
80104f80:	c3                   	ret    
...
80104f89:	8b 55 10             	mov    0x10(%ebp),%edx
80104f8c:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f8f:	89 cb                	mov    %ecx,%ebx
80104f91:	89 df                	mov    %ebx,%edi
80104f93:	89 d1                	mov    %edx,%ecx
80104f95:	fc                   	cld    
80104f96:	f3 aa                	rep stos %al,%es:(%edi)
80104f98:	89 ca                	mov    %ecx,%edx
80104f9a:	89 fb                	mov    %edi,%ebx
80104f9c:	89 5d 08             	mov    %ebx,0x8(%ebp)
80104f9f:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
80104fb4:	89 cb                	mov    %ecx,%ebx
80104fb6:	89 df                	mov    %ebx,%edi
80104fb8:	89 d1                	mov    %edx,%ecx
80104fba:	fc                   	cld    
80104fbb:	f3 ab                	rep stos %eax,%es:(%edi)
80104fbd:	89 ca                	mov    %ecx,%edx
80104fbf:	89 fb                	mov    %edi,%ebx
80104fc1:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80104fd4:	83 e0 03             	and    $0x3,%eax
80104fd7:	85 c0                	test   %eax,%eax
80104fd9:	75 49                	jne    80105024 <memset+0x59>
80104fdb:	8b 45 10             	mov    0x10(%ebp),%eax
80104fde:	83 e0 03             	and    $0x3,%eax
80104fe1:	85 c0                	test   %eax,%eax
80104fe3:	75 3f                	jne    80105024 <memset+0x59>
    c &= 0xFF;
80104fe5:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104fec:	8b 45 10             	mov    0x10(%ebp),%eax
80104fef:	c1 e8 02             	shr    $0x2,%eax
80104ff2:	89 c2                	mov    %eax,%edx
80104ff4:	8b 45 0c             	mov    0xc(%ebp),%eax
80104ff7:	c1 e0 18             	shl    $0x18,%eax
80104ffa:	89 c1                	mov    %eax,%ecx
80104ffc:	8b 45 0c             	mov    0xc(%ebp),%eax
80104fff:	c1 e0 10             	shl    $0x10,%eax
80105002:	09 c1                	or     %eax,%ecx
80105004:	8b 45 0c             	mov    0xc(%ebp),%eax
80105007:	c1 e0 08             	shl    $0x8,%eax
8010500a:	09 c8                	or     %ecx,%eax
8010500c:	0b 45 0c             	or     0xc(%ebp),%eax
8010500f:	89 54 24 08          	mov    %edx,0x8(%esp)
80105013:	89 44 24 04          	mov    %eax,0x4(%esp)
80105017:	8b 45 08             	mov    0x8(%ebp),%eax
8010501a:	89 04 24             	mov    %eax,(%esp)
8010501d:	e8 84 ff ff ff       	call   80104fa6 <stosl>
80105022:	eb 19                	jmp    8010503d <memset+0x72>
  } else
    stosb(dst, c, n);
80105024:	8b 45 10             	mov    0x10(%ebp),%eax
80105027:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105038:	e8 44 ff ff ff       	call   80104f81 <stosb>
  return dst;
...
80105051:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105054:	eb 30                	jmp    80105086 <memcmp+0x44>
    if(*s1 != *s2)
80105056:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105059:	0f b6 10             	movzbl (%eax),%edx
8010505c:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010505f:	0f b6 00             	movzbl (%eax),%eax
80105062:	38 c2                	cmp    %al,%dl
80105064:	74 18                	je     8010507e <memcmp+0x3c>
      return *s1 - *s2;
80105066:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105069:	0f b6 00             	movzbl (%eax),%eax
8010506c:	0f b6 d0             	movzbl %al,%edx
8010506f:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105072:	0f b6 00             	movzbl (%eax),%eax
80105075:	0f b6 c0             	movzbl %al,%eax
80105078:	29 c2                	sub    %eax,%edx
8010507a:	89 d0                	mov    %edx,%eax
8010507c:	eb 1a                	jmp    80105098 <memcmp+0x56>
    s1++, s2++;
8010507e:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105082:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
80105089:	8d 50 ff             	lea    -0x1(%eax),%edx
8010508c:	89 55 10             	mov    %edx,0x10(%ebp)
8010508f:	85 c0                	test   %eax,%eax
80105091:	75 c3                	jne    80105056 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801050a9:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801050ac:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050af:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801050b2:	73 3d                	jae    801050f1 <memmove+0x57>
801050b4:	8b 45 10             	mov    0x10(%ebp),%eax
801050b7:	8b 55 fc             	mov    -0x4(%ebp),%edx
801050ba:	01 d0                	add    %edx,%eax
801050bc:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801050bf:	76 30                	jbe    801050f1 <memmove+0x57>
    s += n;
801050c1:	8b 45 10             	mov    0x10(%ebp),%eax
801050c4:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
801050c7:	8b 45 10             	mov    0x10(%ebp),%eax
801050ca:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
801050cd:	eb 13                	jmp    801050e2 <memmove+0x48>
      *--d = *--s;
801050cf:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
801050d3:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
801050e5:	8d 50 ff             	lea    -0x1(%eax),%edx
801050e8:	89 55 10             	mov    %edx,0x10(%ebp)
801050eb:	85 c0                	test   %eax,%eax
801050ed:	75 e0                	jne    801050cf <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801050ef:	eb 26                	jmp    80105117 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
801050f1:	eb 17                	jmp    8010510a <memmove+0x70>
      *d++ = *s++;
801050f3:	8b 45 f8             	mov    -0x8(%ebp),%eax
801050f6:	8d 50 01             	lea    0x1(%eax),%edx
801050f9:	89 55 f8             	mov    %edx,-0x8(%ebp)
801050fc:	8b 55 fc             	mov    -0x4(%ebp),%edx
801050ff:	8d 4a 01             	lea    0x1(%edx),%ecx
80105102:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105105:	0f b6 12             	movzbl (%edx),%edx
...
8010510d:	8d 50 ff             	lea    -0x1(%eax),%edx
80105110:	89 55 10             	mov    %edx,0x10(%ebp)
80105113:	85 c0                	test   %eax,%eax
80105115:	75 dc                	jne    801050f3 <memmove+0x59>
      *d++ = *s++;
...
80105125:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105136:	e8 5f ff ff ff       	call   8010509a <memmove>
}
8010513b:	c9                   	leave  
8010513c:	c3                   	ret    
...
8010513e:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105140:	eb 0c                	jmp    8010514e <strncmp+0x11>
    n--, p++, q++;
80105142:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105146:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010514a:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
8010516c:	74 d4                	je     80105142 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
8010516e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105172:	75 07                	jne    8010517b <strncmp+0x3e>
    return 0;
80105174:	b8 00 00 00 00       	mov    $0x0,%eax
80105179:	eb 16                	jmp    80105191 <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
8010517b:	8b 45 08             	mov    0x8(%ebp),%eax
8010517e:	0f b6 00             	movzbl (%eax),%eax
80105181:	0f b6 d0             	movzbl %al,%edx
80105184:	8b 45 0c             	mov    0xc(%ebp),%eax
80105187:	0f b6 00             	movzbl (%eax),%eax
8010518a:	0f b6 c0             	movzbl %al,%eax
8010518d:	29 c2                	sub    %eax,%edx
8010518f:	89 d0                	mov    %edx,%eax
}
80105191:	5d                   	pop    %ebp
80105192:	c3                   	ret    
...
801051a3:	8d 50 ff             	lea    -0x1(%eax),%edx
801051a6:	89 55 10             	mov    %edx,0x10(%ebp)
801051a9:	85 c0                	test   %eax,%eax
801051ab:	7e 1e                	jle    801051cb <strncpy+0x38>
...
801051bc:	89 4d 0c             	mov    %ecx,0xc(%ebp)
801051bf:	0f b6 12             	movzbl (%edx),%edx
801051c2:	88 10                	mov    %dl,(%eax)
801051c4:	0f b6 00             	movzbl (%eax),%eax
801051c7:	84 c0                	test   %al,%al
801051c9:	75 d5                	jne    801051a0 <strncpy+0xd>
    ;
  while(n-- > 0)
801051cb:	eb 0c                	jmp    801051d9 <strncpy+0x46>
    *s++ = 0;
801051cd:	8b 45 08             	mov    0x8(%ebp),%eax
801051d0:	8d 50 01             	lea    0x1(%eax),%edx
801051d3:	89 55 08             	mov    %edx,0x8(%ebp)
801051d6:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
801051dc:	8d 50 ff             	lea    -0x1(%eax),%edx
801051df:	89 55 10             	mov    %edx,0x10(%ebp)
801051e2:	85 c0                	test   %eax,%eax
801051e4:	7f e7                	jg     801051cd <strncpy+0x3a>
    *s++ = 0;
  return os;
...
801051f4:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
801051f7:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801051fb:	7f 05                	jg     80105202 <safestrcpy+0x17>
    return os;
801051fd:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105200:	eb 31                	jmp    80105233 <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
80105202:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105206:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010520a:	7e 1e                	jle    8010522a <safestrcpy+0x3f>
8010520c:	8b 45 08             	mov    0x8(%ebp),%eax
8010520f:	8d 50 01             	lea    0x1(%eax),%edx
80105212:	89 55 08             	mov    %edx,0x8(%ebp)
80105215:	8b 55 0c             	mov    0xc(%ebp),%edx
80105218:	8d 4a 01             	lea    0x1(%edx),%ecx
8010521b:	89 4d 0c             	mov    %ecx,0xc(%ebp)
8010521e:	0f b6 12             	movzbl (%edx),%edx
80105221:	88 10                	mov    %dl,(%eax)
80105223:	0f b6 00             	movzbl (%eax),%eax
80105226:	84 c0                	test   %al,%al
80105228:	75 d8                	jne    80105202 <safestrcpy+0x17>
    ;
  *s = 0;
8010522a:	8b 45 08             	mov    0x8(%ebp),%eax
8010522d:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105238:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
8010523b:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105242:	eb 04                	jmp    80105248 <strlen+0x13>
80105244:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105248:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010524b:	8b 45 08             	mov    0x8(%ebp),%eax
8010524e:	01 d0                	add    %edx,%eax
80105250:	0f b6 00             	movzbl (%eax),%eax
80105253:	84 c0                	test   %al,%al
80105255:	75 ed                	jne    80105244 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
8010525c:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105260:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105267:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105268:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010526a:	89 d4                	mov    %edx,%esp
...
8010527c:	3b 45 08             	cmp    0x8(%ebp),%eax
8010527f:	76 12                	jbe    80105293 <fetchint+0x22>
80105281:	8b 45 08             	mov    0x8(%ebp),%eax
80105284:	8d 50 04             	lea    0x4(%eax),%edx
80105287:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010528d:	8b 00                	mov    (%eax),%eax
8010528f:	39 c2                	cmp    %eax,%edx
80105291:	76 07                	jbe    8010529a <fetchint+0x29>
    return -1;
80105293:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105298:	eb 0f                	jmp    801052a9 <fetchint+0x38>
  *ip = *(int*)(addr);
...
801052b9:	3b 45 08             	cmp    0x8(%ebp),%eax
801052bc:	77 07                	ja     801052c5 <fetchstr+0x1a>
    return -1;
801052be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052c3:	eb 46                	jmp    8010530b <fetchstr+0x60>
  *pp = (char*)addr;
801052c5:	8b 55 08             	mov    0x8(%ebp),%edx
801052c8:	8b 45 0c             	mov    0xc(%ebp),%eax
801052cb:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
801052cd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052d3:	8b 00                	mov    (%eax),%eax
801052d5:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
801052d8:	8b 45 0c             	mov    0xc(%ebp),%eax
801052db:	8b 00                	mov    (%eax),%eax
801052dd:	89 45 fc             	mov    %eax,-0x4(%ebp)
801052e0:	eb 1c                	jmp    801052fe <fetchstr+0x53>
    if(*s == 0)
801052e2:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052e5:	0f b6 00             	movzbl (%eax),%eax
801052e8:	84 c0                	test   %al,%al
801052ea:	75 0e                	jne    801052fa <fetchstr+0x4f>
      return s - *pp;
...
801052f8:	eb 11                	jmp    8010530b <fetchstr+0x60>
...
80105301:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105304:	72 dc                	jb     801052e2 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105313:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105319:	8b 40 18             	mov    0x18(%eax),%eax
8010531c:	8b 50 44             	mov    0x44(%eax),%edx
8010531f:	8b 45 08             	mov    0x8(%ebp),%eax
80105322:	c1 e0 02             	shl    $0x2,%eax
80105325:	01 d0                	add    %edx,%eax
80105327:	8d 50 04             	lea    0x4(%eax),%edx
8010532a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010532d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105331:	89 14 24             	mov    %edx,(%esp)
80105334:	e8 38 ff ff ff       	call   80105271 <fetchint>
}
80105339:	c9                   	leave  
8010533a:	c3                   	ret    
...
8010536d:	73 16                	jae    80105385 <argptr+0x4a>
8010536f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105372:	89 c2                	mov    %eax,%edx
...
80105383:	76 07                	jbe    8010538c <argptr+0x51>
    return -1;
80105385:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010538a:	eb 0f                	jmp    8010539b <argptr+0x60>
  *pp = (char*)i;
8010538c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010538f:	89 c2                	mov    %eax,%edx
...
801053cd:	e8 d9 fe ff ff       	call   801052ab <fetchstr>
}
801053d2:	c9                   	leave  
801053d3:	c3                   	ret    
...
801053e4:	8b 40 1c             	mov    0x1c(%eax),%eax
801053e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801053ea:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801053ee:	7e 30                	jle    80105420 <syscall+0x4c>
801053f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053f3:	83 f8 21             	cmp    $0x21,%eax
801053f6:	77 28                	ja     80105420 <syscall+0x4c>
801053f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053fb:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105402:	85 c0                	test   %eax,%eax
80105404:	74 1a                	je     80105420 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105406:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010540c:	8b 58 18             	mov    0x18(%eax),%ebx
8010540f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105412:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105419:	ff d0                	call   *%eax
8010541b:	89 43 1c             	mov    %eax,0x1c(%ebx)
8010541e:	eb 3d                	jmp    8010545d <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105420:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105426:	8d 48 6c             	lea    0x6c(%eax),%ecx
80105429:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
8010542f:	8b 40 10             	mov    0x10(%eax),%eax
80105432:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105435:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105439:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010543d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105441:	c7 04 24 7f 8b 10 80 	movl   $0x80108b7f,(%esp)
80105448:	e8 53 af ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
8010544d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105453:	8b 40 18             	mov    0x18(%eax),%eax
80105456:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80105466:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
80105476:	e8 92 fe ff ff       	call   8010530d <argint>
8010547b:	85 c0                	test   %eax,%eax
8010547d:	79 07                	jns    80105486 <argfd+0x23>
    return -1;
8010547f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105484:	eb 50                	jmp    801054d6 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105486:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105489:	85 c0                	test   %eax,%eax
8010548b:	78 21                	js     801054ae <argfd+0x4b>
8010548d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105490:	83 f8 0f             	cmp    $0xf,%eax
80105493:	7f 19                	jg     801054ae <argfd+0x4b>
80105495:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010549b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010549e:	83 c2 08             	add    $0x8,%edx
801054a1:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801054a5:	89 45 f4             	mov    %eax,-0xc(%ebp)
801054a8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801054ac:	75 07                	jne    801054b5 <argfd+0x52>
    return -1;
801054ae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054b3:	eb 21                	jmp    801054d6 <argfd+0x73>
  if(pfd)
801054b5:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
801054b9:	74 08                	je     801054c3 <argfd+0x60>
    *pfd = fd;
801054bb:	8b 55 f0             	mov    -0x10(%ebp),%edx
801054be:	8b 45 0c             	mov    0xc(%ebp),%eax
801054c1:	89 10                	mov    %edx,(%eax)
  if(pf)
801054c3:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801054c7:	74 08                	je     801054d1 <argfd+0x6e>
    *pf = f;
801054c9:	8b 45 10             	mov    0x10(%ebp),%eax
801054cc:	8b 55 f4             	mov    -0xc(%ebp),%edx
801054cf:	89 10                	mov    %edx,(%eax)
  return 0;
...
801054db:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
801054de:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801054e5:	eb 30                	jmp    80105517 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
...
801054f9:	75 18                	jne    80105513 <fdalloc+0x3b>
      proc->ofile[fd] = f;
801054fb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105501:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105504:	8d 4a 08             	lea    0x8(%edx),%ecx
80105507:	8b 55 08             	mov    0x8(%ebp),%edx
8010550a:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
8010550e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105511:	eb 0f                	jmp    80105522 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
80105517:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
8010551b:	7e ca                	jle    801054e7 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105538:	00 
80105539:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105540:	e8 1e ff ff ff       	call   80105463 <argfd>
80105545:	85 c0                	test   %eax,%eax
80105547:	79 07                	jns    80105550 <sys_dup+0x2c>
    return -1;
80105549:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010554e:	eb 29                	jmp    80105579 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105550:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105553:	89 04 24             	mov    %eax,(%esp)
80105556:	e8 7d ff ff ff       	call   801054d8 <fdalloc>
8010555b:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010555e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105562:	79 07                	jns    8010556b <sys_dup+0x47>
    return -1;
80105564:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105569:	eb 0e                	jmp    80105579 <sys_dup+0x55>
  filedup(f);
8010556b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010556e:	89 04 24             	mov    %eax,(%esp)
80105571:	e8 10 ba ff ff       	call   80100f86 <filedup>
  return fd;
...
8010557e:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105588:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010558f:	00 
80105590:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105597:	e8 c7 fe ff ff       	call   80105463 <argfd>
8010559c:	85 c0                	test   %eax,%eax
8010559e:	78 35                	js     801055d5 <sys_read+0x5a>
801055a0:	8d 45 f0             	lea    -0x10(%ebp),%eax
801055a3:	89 44 24 04          	mov    %eax,0x4(%esp)
801055a7:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801055ae:	e8 5a fd ff ff       	call   8010530d <argint>
801055b3:	85 c0                	test   %eax,%eax
801055b5:	78 1e                	js     801055d5 <sys_read+0x5a>
...
801055c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801055cc:	e8 6a fd ff ff       	call   8010533b <argptr>
801055d1:	85 c0                	test   %eax,%eax
801055d3:	79 07                	jns    801055dc <sys_read+0x61>
    return -1;
801055d5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055da:	eb 19                	jmp    801055f5 <sys_read+0x7a>
  return fileread(f, p, n);
801055dc:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801055df:	8b 55 ec             	mov    -0x14(%ebp),%edx
801055e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055e5:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801055e9:	89 54 24 04          	mov    %edx,0x4(%esp)
801055ed:	89 04 24             	mov    %eax,(%esp)
801055f0:	e8 fe ba ff ff       	call   801010f3 <fileread>
}
801055f5:	c9                   	leave  
801055f6:	c3                   	ret    
...
80105613:	e8 4b fe ff ff       	call   80105463 <argfd>
80105618:	85 c0                	test   %eax,%eax
8010561a:	78 35                	js     80105651 <sys_write+0x5a>
8010561c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010561f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105623:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010562a:	e8 de fc ff ff       	call   8010530d <argint>
8010562f:	85 c0                	test   %eax,%eax
80105631:	78 1e                	js     80105651 <sys_write+0x5a>
...
80105648:	e8 ee fc ff ff       	call   8010533b <argptr>
8010564d:	85 c0                	test   %eax,%eax
8010564f:	79 07                	jns    80105658 <sys_write+0x61>
    return -1;
80105651:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105656:	eb 19                	jmp    80105671 <sys_write+0x7a>
...
8010566c:	e8 3e bb ff ff       	call   801011af <filewrite>
}
80105671:	c9                   	leave  
80105672:	c3                   	ret    
...
80105683:	89 44 24 04          	mov    %eax,0x4(%esp)
80105687:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010568e:	e8 d0 fd ff ff       	call   80105463 <argfd>
80105693:	85 c0                	test   %eax,%eax
80105695:	79 07                	jns    8010569e <sys_close+0x2b>
    return -1;
80105697:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010569c:	eb 24                	jmp    801056c2 <sys_close+0x4f>
  proc->ofile[fd] = 0;
8010569e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801056a4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801056a7:	83 c2 08             	add    $0x8,%edx
801056aa:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801056b1:	00 
  fileclose(f);
801056b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056b5:	89 04 24             	mov    %eax,(%esp)
801056b8:	e8 11 b9 ff ff       	call   80100fce <fileclose>
  return 0;
...
801056e0:	e8 7e fd ff ff       	call   80105463 <argfd>
801056e5:	85 c0                	test   %eax,%eax
801056e7:	78 1f                	js     80105708 <sys_fstat+0x44>
801056e9:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801056f0:	00 
801056f1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056f4:	89 44 24 04          	mov    %eax,0x4(%esp)
801056f8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801056ff:	e8 37 fc ff ff       	call   8010533b <argptr>
80105704:	85 c0                	test   %eax,%eax
80105706:	79 07                	jns    8010570f <sys_fstat+0x4b>
    return -1;
80105708:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010570d:	eb 12                	jmp    80105721 <sys_fstat+0x5d>
  return filestat(f, st);
8010570f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105712:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105715:	89 54 24 04          	mov    %edx,0x4(%esp)
80105719:	89 04 24             	mov    %eax,(%esp)
8010571c:	e8 83 b9 ff ff       	call   801010a4 <filestat>
}
80105721:	c9                   	leave  
80105722:	c3                   	ret    
...
80105726:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105729:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010572c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105730:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105737:	e8 61 fc ff ff       	call   8010539d <argstr>
8010573c:	85 c0                	test   %eax,%eax
8010573e:	78 17                	js     80105757 <sys_link+0x34>
80105740:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105743:	89 44 24 04          	mov    %eax,0x4(%esp)
80105747:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010574e:	e8 4a fc ff ff       	call   8010539d <argstr>
80105753:	85 c0                	test   %eax,%eax
80105755:	79 0a                	jns    80105761 <sys_link+0x3e>
    return -1;
80105757:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010575c:	e9 42 01 00 00       	jmp    801058a3 <sys_link+0x180>

  begin_op();
80105761:	e8 7f da ff ff       	call   801031e5 <begin_op>
  if((ip = namei(old)) == 0){
80105766:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105769:	89 04 24             	mov    %eax,(%esp)
8010576c:	e8 95 cc ff ff       	call   80102406 <namei>
80105771:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105774:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105778:	75 0f                	jne    80105789 <sys_link+0x66>
    end_op();
8010577a:	e8 ea da ff ff       	call   80103269 <end_op>
    return -1;
8010577f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105784:	e9 1a 01 00 00       	jmp    801058a3 <sys_link+0x180>
  }

  ilock(ip);
80105789:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010578c:	89 04 24             	mov    %eax,(%esp)
8010578f:	e8 c7 c0 ff ff       	call   8010185b <ilock>
  if(ip->type == T_DIR){
80105794:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105797:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010579b:	66 83 f8 01          	cmp    $0x1,%ax
8010579f:	75 1a                	jne    801057bb <sys_link+0x98>
    iunlockput(ip);
801057a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057a4:	89 04 24             	mov    %eax,(%esp)
801057a7:	e8 33 c3 ff ff       	call   80101adf <iunlockput>
    end_op();
801057ac:	e8 b8 da ff ff       	call   80103269 <end_op>
    return -1;
801057b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057b6:	e9 e8 00 00 00       	jmp    801058a3 <sys_link+0x180>
  }

  ip->nlink++;
801057bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057be:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801057c2:	8d 50 01             	lea    0x1(%eax),%edx
801057c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057c8:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801057cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057cf:	89 04 24             	mov    %eax,(%esp)
801057d2:	e8 c8 be ff ff       	call   8010169f <iupdate>
  iunlock(ip);
801057d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057da:	89 04 24             	mov    %eax,(%esp)
801057dd:	e8 c7 c1 ff ff       	call   801019a9 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
801057e2:	8b 45 dc             	mov    -0x24(%ebp),%eax
801057e5:	8d 55 e2             	lea    -0x1e(%ebp),%edx
801057e8:	89 54 24 04          	mov    %edx,0x4(%esp)
801057ec:	89 04 24             	mov    %eax,(%esp)
801057ef:	e8 34 cc ff ff       	call   80102428 <nameiparent>
801057f4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801057f7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801057fb:	75 02                	jne    801057ff <sys_link+0xdc>
    goto bad;
801057fd:	eb 68                	jmp    80105867 <sys_link+0x144>
  ilock(dp);
801057ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105802:	89 04 24             	mov    %eax,(%esp)
80105805:	e8 51 c0 ff ff       	call   8010185b <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
8010580a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010580d:	8b 10                	mov    (%eax),%edx
8010580f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105812:	8b 00                	mov    (%eax),%eax
80105814:	39 c2                	cmp    %eax,%edx
80105816:	75 20                	jne    80105838 <sys_link+0x115>
80105818:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010581b:	8b 40 04             	mov    0x4(%eax),%eax
8010581e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105822:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105825:	89 44 24 04          	mov    %eax,0x4(%esp)
80105829:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010582c:	89 04 24             	mov    %eax,(%esp)
8010582f:	e8 12 c9 ff ff       	call   80102146 <dirlink>
80105834:	85 c0                	test   %eax,%eax
80105836:	79 0d                	jns    80105845 <sys_link+0x122>
    iunlockput(dp);
80105838:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010583b:	89 04 24             	mov    %eax,(%esp)
8010583e:	e8 9c c2 ff ff       	call   80101adf <iunlockput>
    goto bad;
80105843:	eb 22                	jmp    80105867 <sys_link+0x144>
  }
  iunlockput(dp);
80105845:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105848:	89 04 24             	mov    %eax,(%esp)
8010584b:	e8 8f c2 ff ff       	call   80101adf <iunlockput>
  iput(ip);
80105850:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105853:	89 04 24             	mov    %eax,(%esp)
80105856:	e8 b3 c1 ff ff       	call   80101a0e <iput>

  end_op();
8010585b:	e8 09 da ff ff       	call   80103269 <end_op>

  return 0;
80105860:	b8 00 00 00 00       	mov    $0x0,%eax
80105865:	eb 3c                	jmp    801058a3 <sys_link+0x180>

bad:
  ilock(ip);
80105867:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010586a:	89 04 24             	mov    %eax,(%esp)
8010586d:	e8 e9 bf ff ff       	call   8010185b <ilock>
  ip->nlink--;
80105872:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105875:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105879:	8d 50 ff             	lea    -0x1(%eax),%edx
8010587c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010587f:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105883:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105886:	89 04 24             	mov    %eax,(%esp)
80105889:	e8 11 be ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
8010588e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105891:	89 04 24             	mov    %eax,(%esp)
80105894:	e8 46 c2 ff ff       	call   80101adf <iunlockput>
  end_op();
80105899:	e8 cb d9 ff ff       	call   80103269 <end_op>
  return -1;
...
801058a8:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801058ab:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
801058b2:	eb 4b                	jmp    801058ff <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801058b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b7:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801058be:	00 
...
801058d0:	e8 93 c4 ff ff       	call   80101d68 <readi>
801058d5:	83 f8 10             	cmp    $0x10,%eax
801058d8:	74 0c                	je     801058e6 <isdirempty+0x41>
      panic("isdirempty: readi");
801058da:	c7 04 24 9b 8b 10 80 	movl   $0x80108b9b,(%esp)
801058e1:	e8 54 ac ff ff       	call   8010053a <panic>
    if(de.inum != 0)
801058e6:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
801058ea:	66 85 c0             	test   %ax,%ax
801058ed:	74 07                	je     801058f6 <isdirempty+0x51>
      return 0;
801058ef:	b8 00 00 00 00       	mov    $0x0,%eax
801058f4:	eb 1b                	jmp    80105911 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801058f9:	83 c0 10             	add    $0x10,%eax
...
80105908:	39 c2                	cmp    %eax,%edx
8010590a:	72 a8                	jb     801058b4 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
8010590c:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105911:	c9                   	leave  
80105912:	c3                   	ret    
...
80105916:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105919:	8d 45 cc             	lea    -0x34(%ebp),%eax
8010591c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105920:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105927:	e8 71 fa ff ff       	call   8010539d <argstr>
8010592c:	85 c0                	test   %eax,%eax
8010592e:	79 0a                	jns    8010593a <sys_unlink+0x27>
    return -1;
80105930:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105935:	e9 af 01 00 00       	jmp    80105ae9 <sys_unlink+0x1d6>

  begin_op();
8010593a:	e8 a6 d8 ff ff       	call   801031e5 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
8010593f:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105942:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105945:	89 54 24 04          	mov    %edx,0x4(%esp)
80105949:	89 04 24             	mov    %eax,(%esp)
8010594c:	e8 d7 ca ff ff       	call   80102428 <nameiparent>
80105951:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105954:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105958:	75 0f                	jne    80105969 <sys_unlink+0x56>
    end_op();
8010595a:	e8 0a d9 ff ff       	call   80103269 <end_op>
    return -1;
8010595f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105964:	e9 80 01 00 00       	jmp    80105ae9 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105969:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010596c:	89 04 24             	mov    %eax,(%esp)
8010596f:	e8 e7 be ff ff       	call   8010185b <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105974:	c7 44 24 04 ad 8b 10 	movl   $0x80108bad,0x4(%esp)
8010597b:	80 
8010597c:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010597f:	89 04 24             	mov    %eax,(%esp)
80105982:	e8 d4 c6 ff ff       	call   8010205b <namecmp>
80105987:	85 c0                	test   %eax,%eax
80105989:	0f 84 45 01 00 00    	je     80105ad4 <sys_unlink+0x1c1>
8010598f:	c7 44 24 04 af 8b 10 	movl   $0x80108baf,0x4(%esp)
80105996:	80 
80105997:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010599a:	89 04 24             	mov    %eax,(%esp)
8010599d:	e8 b9 c6 ff ff       	call   8010205b <namecmp>
801059a2:	85 c0                	test   %eax,%eax
801059a4:	0f 84 2a 01 00 00    	je     80105ad4 <sys_unlink+0x1c1>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
801059aa:	8d 45 c8             	lea    -0x38(%ebp),%eax
801059ad:	89 44 24 08          	mov    %eax,0x8(%esp)
801059b1:	8d 45 d2             	lea    -0x2e(%ebp),%eax
801059b4:	89 44 24 04          	mov    %eax,0x4(%esp)
801059b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059bb:	89 04 24             	mov    %eax,(%esp)
801059be:	e8 ba c6 ff ff       	call   8010207d <dirlookup>
801059c3:	89 45 f0             	mov    %eax,-0x10(%ebp)
801059c6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801059ca:	75 05                	jne    801059d1 <sys_unlink+0xbe>
    goto bad;
801059cc:	e9 03 01 00 00       	jmp    80105ad4 <sys_unlink+0x1c1>
  ilock(ip);
801059d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059d4:	89 04 24             	mov    %eax,(%esp)
801059d7:	e8 7f be ff ff       	call   8010185b <ilock>

  if(ip->nlink < 1)
801059dc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059df:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801059e3:	66 85 c0             	test   %ax,%ax
801059e6:	7f 0c                	jg     801059f4 <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
801059e8:	c7 04 24 b2 8b 10 80 	movl   $0x80108bb2,(%esp)
801059ef:	e8 46 ab ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801059f4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059f7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801059fb:	66 83 f8 01          	cmp    $0x1,%ax
801059ff:	75 1f                	jne    80105a20 <sys_unlink+0x10d>
80105a01:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a04:	89 04 24             	mov    %eax,(%esp)
80105a07:	e8 99 fe ff ff       	call   801058a5 <isdirempty>
80105a0c:	85 c0                	test   %eax,%eax
80105a0e:	75 10                	jne    80105a20 <sys_unlink+0x10d>
    iunlockput(ip);
80105a10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a13:	89 04 24             	mov    %eax,(%esp)
80105a16:	e8 c4 c0 ff ff       	call   80101adf <iunlockput>
    goto bad;
80105a1b:	e9 b4 00 00 00       	jmp    80105ad4 <sys_unlink+0x1c1>
  }

  memset(&de, 0, sizeof(de));
80105a20:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105a27:	00 
80105a28:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a2f:	00 
80105a30:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105a33:	89 04 24             	mov    %eax,(%esp)
80105a36:	e8 90 f5 ff ff       	call   80104fcb <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105a3b:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105a3e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105a45:	00 
...
80105a57:	e8 70 c4 ff ff       	call   80101ecc <writei>
80105a5c:	83 f8 10             	cmp    $0x10,%eax
80105a5f:	74 0c                	je     80105a6d <sys_unlink+0x15a>
    panic("unlink: writei");
80105a61:	c7 04 24 c4 8b 10 80 	movl   $0x80108bc4,(%esp)
80105a68:	e8 cd aa ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105a6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a70:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105a74:	66 83 f8 01          	cmp    $0x1,%ax
80105a78:	75 1c                	jne    80105a96 <sys_unlink+0x183>
    dp->nlink--;
...
80105a91:	e8 09 bc ff ff       	call   8010169f <iupdate>
  }
  iunlockput(dp);
80105a96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a99:	89 04 24             	mov    %eax,(%esp)
80105a9c:	e8 3e c0 ff ff       	call   80101adf <iunlockput>

  ip->nlink--;
80105aa1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105aa4:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80105ab8:	e8 e2 bb ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
80105abd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ac0:	89 04 24             	mov    %eax,(%esp)
80105ac3:	e8 17 c0 ff ff       	call   80101adf <iunlockput>

  end_op();
80105ac8:	e8 9c d7 ff ff       	call   80103269 <end_op>

  return 0;
80105acd:	b8 00 00 00 00       	mov    $0x0,%eax
80105ad2:	eb 15                	jmp    80105ae9 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105ad4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ad7:	89 04 24             	mov    %eax,(%esp)
80105ada:	e8 00 c0 ff ff       	call   80101adf <iunlockput>
  end_op();
80105adf:	e8 85 d7 ff ff       	call   80103269 <end_op>
  return -1;
...
80105aee:	83 ec 48             	sub    $0x48,%esp
80105af1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105af4:	8b 55 10             	mov    0x10(%ebp),%edx
80105af7:	8b 45 14             	mov    0x14(%ebp),%eax
80105afa:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105afe:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105b02:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105b06:	8d 45 de             	lea    -0x22(%ebp),%eax
80105b09:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b0d:	8b 45 08             	mov    0x8(%ebp),%eax
80105b10:	89 04 24             	mov    %eax,(%esp)
80105b13:	e8 10 c9 ff ff       	call   80102428 <nameiparent>
80105b18:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105b1b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b1f:	75 0a                	jne    80105b2b <create+0x40>
    return 0;
80105b21:	b8 00 00 00 00       	mov    $0x0,%eax
80105b26:	e9 7e 01 00 00       	jmp    80105ca9 <create+0x1be>
  ilock(dp);
80105b2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b2e:	89 04 24             	mov    %eax,(%esp)
80105b31:	e8 25 bd ff ff       	call   8010185b <ilock>
...
80105b4a:	e8 2e c5 ff ff       	call   8010207d <dirlookup>
80105b4f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b52:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b56:	74 47                	je     80105b9f <create+0xb4>
    iunlockput(dp);
80105b58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5b:	89 04 24             	mov    %eax,(%esp)
80105b5e:	e8 7c bf ff ff       	call   80101adf <iunlockput>
    ilock(ip);
80105b63:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b66:	89 04 24             	mov    %eax,(%esp)
80105b69:	e8 ed bc ff ff       	call   8010185b <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105b6e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105b73:	75 15                	jne    80105b8a <create+0x9f>
80105b75:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b78:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b7c:	66 83 f8 02          	cmp    $0x2,%ax
80105b80:	75 08                	jne    80105b8a <create+0x9f>
      return ip;
80105b82:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b85:	e9 1f 01 00 00       	jmp    80105ca9 <create+0x1be>
    iunlockput(ip);
80105b8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b8d:	89 04 24             	mov    %eax,(%esp)
80105b90:	e8 4a bf ff ff       	call   80101adf <iunlockput>
    return 0;
80105b95:	b8 00 00 00 00       	mov    $0x0,%eax
80105b9a:	e9 0a 01 00 00       	jmp    80105ca9 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105b9f:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105ba3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ba6:	8b 00                	mov    (%eax),%eax
80105ba8:	89 54 24 04          	mov    %edx,0x4(%esp)
80105bac:	89 04 24             	mov    %eax,(%esp)
80105baf:	e8 0c ba ff ff       	call   801015c0 <ialloc>
80105bb4:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105bb7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105bbb:	75 0c                	jne    80105bc9 <create+0xde>
    panic("create: ialloc");
80105bbd:	c7 04 24 d3 8b 10 80 	movl   $0x80108bd3,(%esp)
80105bc4:	e8 71 a9 ff ff       	call   8010053a <panic>
...
80105bd7:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105bdb:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105bdf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105be2:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105be6:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105bea:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bed:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105bf3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bf6:	89 04 24             	mov    %eax,(%esp)
80105bf9:	e8 a1 ba ff ff       	call   8010169f <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105bfe:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105c03:	75 6a                	jne    80105c6f <create+0x184>
    dp->nlink++;  // for ".."
80105c05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c08:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105c0c:	8d 50 01             	lea    0x1(%eax),%edx
80105c0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c12:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105c16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c19:	89 04 24             	mov    %eax,(%esp)
80105c1c:	e8 7e ba ff ff       	call   8010169f <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105c21:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c24:	8b 40 04             	mov    0x4(%eax),%eax
80105c27:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c2b:	c7 44 24 04 ad 8b 10 	movl   $0x80108bad,0x4(%esp)
80105c32:	80 
80105c33:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c36:	89 04 24             	mov    %eax,(%esp)
80105c39:	e8 08 c5 ff ff       	call   80102146 <dirlink>
80105c3e:	85 c0                	test   %eax,%eax
80105c40:	78 21                	js     80105c63 <create+0x178>
80105c42:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c45:	8b 40 04             	mov    0x4(%eax),%eax
80105c48:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c4c:	c7 44 24 04 af 8b 10 	movl   $0x80108baf,0x4(%esp)
80105c53:	80 
80105c54:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c57:	89 04 24             	mov    %eax,(%esp)
80105c5a:	e8 e7 c4 ff ff       	call   80102146 <dirlink>
80105c5f:	85 c0                	test   %eax,%eax
80105c61:	79 0c                	jns    80105c6f <create+0x184>
      panic("create dots");
80105c63:	c7 04 24 e2 8b 10 80 	movl   $0x80108be2,(%esp)
80105c6a:	e8 cb a8 ff ff       	call   8010053a <panic>
  }
...
80105c86:	e8 bb c4 ff ff       	call   80102146 <dirlink>
80105c8b:	85 c0                	test   %eax,%eax
80105c8d:	79 0c                	jns    80105c9b <create+0x1b0>
    panic("create: dirlink");
80105c8f:	c7 04 24 ee 8b 10 80 	movl   $0x80108bee,(%esp)
80105c96:	e8 9f a8 ff ff       	call   8010053a <panic>
...
80105cb1:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105cb4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cb8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105cbf:	e8 d9 f6 ff ff       	call   8010539d <argstr>
80105cc4:	85 c0                	test   %eax,%eax
80105cc6:	78 17                	js     80105cdf <sys_open+0x34>
80105cc8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105ccb:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ccf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105cd6:	e8 32 f6 ff ff       	call   8010530d <argint>
80105cdb:	85 c0                	test   %eax,%eax
80105cdd:	79 0a                	jns    80105ce9 <sys_open+0x3e>
    return -1;
80105cdf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ce4:	e9 5c 01 00 00       	jmp    80105e45 <sys_open+0x19a>

  begin_op();
80105ce9:	e8 f7 d4 ff ff       	call   801031e5 <begin_op>

  if(omode & O_CREATE){
80105cee:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105cf1:	25 00 02 00 00       	and    $0x200,%eax
80105cf6:	85 c0                	test   %eax,%eax
80105cf8:	74 3b                	je     80105d35 <sys_open+0x8a>
    ip = create(path, T_FILE, 0, 0);
80105cfa:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105cfd:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105d04:	00 
80105d05:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105d0c:	00 
80105d0d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105d14:	00 
80105d15:	89 04 24             	mov    %eax,(%esp)
80105d18:	e8 ce fd ff ff       	call   80105aeb <create>
80105d1d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(ip == 0){
80105d20:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d24:	75 6b                	jne    80105d91 <sys_open+0xe6>
      end_op();
80105d26:	e8 3e d5 ff ff       	call   80103269 <end_op>
      return -1;
80105d2b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d30:	e9 10 01 00 00       	jmp    80105e45 <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80105d35:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105d38:	89 04 24             	mov    %eax,(%esp)
80105d3b:	e8 c6 c6 ff ff       	call   80102406 <namei>
80105d40:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d43:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d47:	75 0f                	jne    80105d58 <sys_open+0xad>
      end_op();
80105d49:	e8 1b d5 ff ff       	call   80103269 <end_op>
      return -1;
80105d4e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d53:	e9 ed 00 00 00       	jmp    80105e45 <sys_open+0x19a>
    }
    ilock(ip);
80105d58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d5b:	89 04 24             	mov    %eax,(%esp)
80105d5e:	e8 f8 ba ff ff       	call   8010185b <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105d63:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d66:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105d6a:	66 83 f8 01          	cmp    $0x1,%ax
80105d6e:	75 21                	jne    80105d91 <sys_open+0xe6>
80105d70:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d73:	85 c0                	test   %eax,%eax
80105d75:	74 1a                	je     80105d91 <sys_open+0xe6>
      iunlockput(ip);
80105d77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d7a:	89 04 24             	mov    %eax,(%esp)
80105d7d:	e8 5d bd ff ff       	call   80101adf <iunlockput>
      end_op();
80105d82:	e8 e2 d4 ff ff       	call   80103269 <end_op>
      return -1;
80105d87:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d8c:	e9 b4 00 00 00       	jmp    80105e45 <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105d91:	e8 90 b1 ff ff       	call   80100f26 <filealloc>
80105d96:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d99:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d9d:	74 14                	je     80105db3 <sys_open+0x108>
80105d9f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105da2:	89 04 24             	mov    %eax,(%esp)
80105da5:	e8 2e f7 ff ff       	call   801054d8 <fdalloc>
80105daa:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105dad:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105db1:	79 28                	jns    80105ddb <sys_open+0x130>
    if(f)
80105db3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105db7:	74 0b                	je     80105dc4 <sys_open+0x119>
      fileclose(f);
80105db9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dbc:	89 04 24             	mov    %eax,(%esp)
80105dbf:	e8 0a b2 ff ff       	call   80100fce <fileclose>
    iunlockput(ip);
80105dc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dc7:	89 04 24             	mov    %eax,(%esp)
80105dca:	e8 10 bd ff ff       	call   80101adf <iunlockput>
    end_op();
80105dcf:	e8 95 d4 ff ff       	call   80103269 <end_op>
    return -1;
80105dd4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dd9:	eb 6a                	jmp    80105e45 <sys_open+0x19a>
  }
  iunlock(ip);
80105ddb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dde:	89 04 24             	mov    %eax,(%esp)
80105de1:	e8 c3 bb ff ff       	call   801019a9 <iunlock>
  end_op();
80105de6:	e8 7e d4 ff ff       	call   80103269 <end_op>

  f->type = FD_INODE;
80105deb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dee:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105df4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105df7:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105dfa:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105dfd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e00:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105e07:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e0a:	83 e0 01             	and    $0x1,%eax
80105e0d:	85 c0                	test   %eax,%eax
80105e0f:	0f 94 c0             	sete   %al
80105e12:	89 c2                	mov    %eax,%edx
80105e14:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e17:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105e1a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e1d:	83 e0 01             	and    $0x1,%eax
80105e20:	85 c0                	test   %eax,%eax
80105e22:	75 0a                	jne    80105e2e <sys_open+0x183>
80105e24:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e27:	83 e0 02             	and    $0x2,%eax
80105e2a:	85 c0                	test   %eax,%eax
80105e2c:	74 07                	je     80105e35 <sys_open+0x18a>
80105e2e:	b8 01 00 00 00       	mov    $0x1,%eax
80105e33:	eb 05                	jmp    80105e3a <sys_open+0x18f>
80105e35:	b8 00 00 00 00       	mov    $0x0,%eax
80105e3a:	89 c2                	mov    %eax,%edx
80105e3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e3f:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105e42:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105e45:	c9                   	leave  
80105e46:	c3                   	ret    
...
80105e4a:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_op();
80105e4d:	e8 93 d3 ff ff       	call   801031e5 <begin_op>
...
80105e60:	e8 38 f5 ff ff       	call   8010539d <argstr>
80105e65:	85 c0                	test   %eax,%eax
80105e67:	78 2c                	js     80105e95 <sys_mkdir+0x4e>
80105e69:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e6c:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105e73:	00 
80105e74:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e7b:	00 
80105e7c:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105e83:	00 
80105e84:	89 04 24             	mov    %eax,(%esp)
80105e87:	e8 5f fc ff ff       	call   80105aeb <create>
80105e8c:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e8f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e93:	75 0c                	jne    80105ea1 <sys_mkdir+0x5a>
    end_op();
80105e95:	e8 cf d3 ff ff       	call   80103269 <end_op>
    return -1;
80105e9a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e9f:	eb 15                	jmp    80105eb6 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
...
80105ea7:	e8 33 bc ff ff       	call   80101adf <iunlockput>
  end_op();
80105eac:	e8 b8 d3 ff ff       	call   80103269 <end_op>
  return 0;
...
80105ebb:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_op();
80105ebe:	e8 22 d3 ff ff       	call   801031e5 <begin_op>
  if((len=argstr(0, &path)) < 0 ||
80105ec3:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105ec6:	89 44 24 04          	mov    %eax,0x4(%esp)
80105eca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ed1:	e8 c7 f4 ff ff       	call   8010539d <argstr>
80105ed6:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ed9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105edd:	78 5e                	js     80105f3d <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80105edf:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105ee2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ee6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105eed:	e8 1b f4 ff ff       	call   8010530d <argint>
  char *path;
  int len;
  int major, minor;
...
80105ef4:	78 47                	js     80105f3d <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105ef6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105ef9:	89 44 24 04          	mov    %eax,0x4(%esp)
80105efd:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105f04:	e8 04 f4 ff ff       	call   8010530d <argint>
  int len;
  int major, minor;
...
80105f0b:	78 30                	js     80105f3d <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105f0d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f10:	0f bf c8             	movswl %ax,%ecx
80105f13:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105f16:	0f bf d0             	movswl %ax,%edx
80105f19:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105f1c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105f20:	89 54 24 08          	mov    %edx,0x8(%esp)
80105f24:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105f2b:	00 
80105f2c:	89 04 24             	mov    %eax,(%esp)
80105f2f:	e8 b7 fb ff ff       	call   80105aeb <create>
80105f34:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f37:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f3b:	75 0c                	jne    80105f49 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80105f3d:	e8 27 d3 ff ff       	call   80103269 <end_op>
    return -1;
80105f42:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f47:	eb 15                	jmp    80105f5e <sys_mknod+0xa6>
  }
  iunlockput(ip);
80105f49:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f4c:	89 04 24             	mov    %eax,(%esp)
80105f4f:	e8 8b bb ff ff       	call   80101adf <iunlockput>
  end_op();
80105f54:	e8 10 d3 ff ff       	call   80103269 <end_op>
  return 0;
...
80105f63:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105f66:	e8 7a d2 ff ff       	call   801031e5 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105f6b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105f6e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f72:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f79:	e8 1f f4 ff ff       	call   8010539d <argstr>
80105f7e:	85 c0                	test   %eax,%eax
80105f80:	78 14                	js     80105f96 <sys_chdir+0x36>
80105f82:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f85:	89 04 24             	mov    %eax,(%esp)
80105f88:	e8 79 c4 ff ff       	call   80102406 <namei>
80105f8d:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f90:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f94:	75 0c                	jne    80105fa2 <sys_chdir+0x42>
    end_op();
80105f96:	e8 ce d2 ff ff       	call   80103269 <end_op>
    return -1;
80105f9b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fa0:	eb 61                	jmp    80106003 <sys_chdir+0xa3>
  }
  ilock(ip);
80105fa2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fa5:	89 04 24             	mov    %eax,(%esp)
80105fa8:	e8 ae b8 ff ff       	call   8010185b <ilock>
  if(ip->type != T_DIR){
80105fad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fb0:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105fb4:	66 83 f8 01          	cmp    $0x1,%ax
80105fb8:	74 17                	je     80105fd1 <sys_chdir+0x71>
    iunlockput(ip);
80105fba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fbd:	89 04 24             	mov    %eax,(%esp)
80105fc0:	e8 1a bb ff ff       	call   80101adf <iunlockput>
    end_op();
80105fc5:	e8 9f d2 ff ff       	call   80103269 <end_op>
    return -1;
80105fca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fcf:	eb 32                	jmp    80106003 <sys_chdir+0xa3>
  }
  iunlock(ip);
80105fd1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fd4:	89 04 24             	mov    %eax,(%esp)
80105fd7:	e8 cd b9 ff ff       	call   801019a9 <iunlock>
  iput(proc->cwd);
80105fdc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105fe2:	8b 40 68             	mov    0x68(%eax),%eax
80105fe5:	89 04 24             	mov    %eax,(%esp)
80105fe8:	e8 21 ba ff ff       	call   80101a0e <iput>
  end_op();
80105fed:	e8 77 d2 ff ff       	call   80103269 <end_op>
  proc->cwd = ip;
80105ff2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ff8:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105ffb:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106008:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
8010601c:	e8 7c f3 ff ff       	call   8010539d <argstr>
80106021:	85 c0                	test   %eax,%eax
80106023:	78 1a                	js     8010603f <sys_exec+0x3a>
80106025:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010602b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010602f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106036:	e8 d2 f2 ff ff       	call   8010530d <argint>
8010603b:	85 c0                	test   %eax,%eax
8010603d:	79 0a                	jns    80106049 <sys_exec+0x44>
    return -1;
8010603f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106044:	e9 c8 00 00 00       	jmp    80106111 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
80106049:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80106050:	00 
80106051:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106058:	00 
80106059:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010605f:	89 04 24             	mov    %eax,(%esp)
80106062:	e8 64 ef ff ff       	call   80104fcb <memset>
  for(i=0;; i++){
80106067:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
8010606e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106071:	83 f8 1f             	cmp    $0x1f,%eax
80106074:	76 0a                	jbe    80106080 <sys_exec+0x7b>
      return -1;
80106076:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010607b:	e9 91 00 00 00       	jmp    80106111 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106080:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106083:	c1 e0 02             	shl    $0x2,%eax
80106086:	89 c2                	mov    %eax,%edx
80106088:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010608e:	01 c2                	add    %eax,%edx
80106090:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106096:	89 44 24 04          	mov    %eax,0x4(%esp)
8010609a:	89 14 24             	mov    %edx,(%esp)
8010609d:	e8 cf f1 ff ff       	call   80105271 <fetchint>
801060a2:	85 c0                	test   %eax,%eax
801060a4:	79 07                	jns    801060ad <sys_exec+0xa8>
      return -1;
801060a6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060ab:	eb 64                	jmp    80106111 <sys_exec+0x10c>
    if(uarg == 0){
801060ad:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
801060b3:	85 c0                	test   %eax,%eax
801060b5:	75 26                	jne    801060dd <sys_exec+0xd8>
      argv[i] = 0;
801060b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060ba:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
801060c1:	00 00 00 00 
      break;
801060c5:	90                   	nop
    }
...
801060c9:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
801060cf:	89 54 24 04          	mov    %edx,0x4(%esp)
801060d3:	89 04 24             	mov    %eax,(%esp)
801060d6:	e8 14 aa ff ff       	call   80100aef <exec>
801060db:	eb 34                	jmp    80106111 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
801060dd:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801060e3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801060e6:	c1 e2 02             	shl    $0x2,%edx
...
801060f8:	e8 ae f1 ff ff       	call   801052ab <fetchstr>
801060fd:	85 c0                	test   %eax,%eax
801060ff:	79 07                	jns    80106108 <sys_exec+0x103>
      return -1;
80106101:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106106:	eb 09                	jmp    80106111 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106108:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
8010610c:	e9 5d ff ff ff       	jmp    8010606e <sys_exec+0x69>
  return exec(path, argv);
}
80106111:	c9                   	leave  
80106112:	c3                   	ret    
...
80106119:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80106120:	00 
80106121:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106124:	89 44 24 04          	mov    %eax,0x4(%esp)
80106128:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010612f:	e8 07 f2 ff ff       	call   8010533b <argptr>
80106134:	85 c0                	test   %eax,%eax
80106136:	79 0a                	jns    80106142 <sys_pipe+0x2f>
    return -1;
80106138:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010613d:	e9 9b 00 00 00       	jmp    801061dd <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106142:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106145:	89 44 24 04          	mov    %eax,0x4(%esp)
80106149:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010614c:	89 04 24             	mov    %eax,(%esp)
8010614f:	e8 8a db ff ff       	call   80103cde <pipealloc>
80106154:	85 c0                	test   %eax,%eax
80106156:	79 07                	jns    8010615f <sys_pipe+0x4c>
    return -1;
80106158:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010615d:	eb 7e                	jmp    801061dd <sys_pipe+0xca>
  fd0 = -1;
8010615f:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106166:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106169:	89 04 24             	mov    %eax,(%esp)
8010616c:	e8 67 f3 ff ff       	call   801054d8 <fdalloc>
80106171:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106174:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106178:	78 14                	js     8010618e <sys_pipe+0x7b>
8010617a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010617d:	89 04 24             	mov    %eax,(%esp)
80106180:	e8 53 f3 ff ff       	call   801054d8 <fdalloc>
80106185:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106188:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010618c:	79 37                	jns    801061c5 <sys_pipe+0xb2>
    if(fd0 >= 0)
8010618e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106192:	78 14                	js     801061a8 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106194:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010619a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010619d:	83 c2 08             	add    $0x8,%edx
801061a0:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801061a7:	00 
    fileclose(rf);
801061a8:	8b 45 e8             	mov    -0x18(%ebp),%eax
801061ab:	89 04 24             	mov    %eax,(%esp)
801061ae:	e8 1b ae ff ff       	call   80100fce <fileclose>
    fileclose(wf);
801061b3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801061b6:	89 04 24             	mov    %eax,(%esp)
801061b9:	e8 10 ae ff ff       	call   80100fce <fileclose>
    return -1;
801061be:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061c3:	eb 18                	jmp    801061dd <sys_pipe+0xca>
  }
  fd[0] = fd0;
801061c5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801061c8:	8b 55 f4             	mov    -0xc(%ebp),%edx
801061cb:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
801061cd:	8b 45 ec             	mov    -0x14(%ebp),%eax
801061d0:	8d 50 04             	lea    0x4(%eax),%edx
801061d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061d6:	89 02                	mov    %eax,(%edx)
  return 0;
...
801061e2:	83 ec 18             	sub    $0x18,%esp
  proc->ctflag = 0;
801061e5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801061eb:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
  return fork((char*)0, 0, 0, 0);
801061f2:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801061f9:	00 
801061fa:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106201:	00 
80106202:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106209:	00 
8010620a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106211:	e8 76 e1 ff ff       	call   8010438c <fork>
}
80106216:	c9                   	leave  
80106217:	c3                   	ret    
...
8010621b:	83 ec 08             	sub    $0x8,%esp
  exit();
8010621e:	e8 44 e4 ff ff       	call   80104667 <exit>
...
8010622d:	83 ec 18             	sub    $0x18,%esp
  return wait(0);
80106230:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106237:	e8 50 e5 ff ff       	call   8010478c <wait>
}
8010623c:	c9                   	leave  
8010623d:	c3                   	ret    
...
80106241:	83 ec 28             	sub    $0x28,%esp
  int pid;
...
80106252:	e8 b6 f0 ff ff       	call   8010530d <argint>
80106257:	85 c0                	test   %eax,%eax
80106259:	79 07                	jns    80106262 <sys_kill+0x24>
    return -1;
8010625b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106260:	eb 0b                	jmp    8010626d <sys_kill+0x2f>
  return kill(pid);
80106262:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106265:	89 04 24             	mov    %eax,(%esp)
80106268:	e8 3e e9 ff ff       	call   80104bab <kill>
}
8010626d:	c9                   	leave  
8010626e:	c3                   	ret    
...
80106291:	e8 77 f0 ff ff       	call   8010530d <argint>
80106296:	85 c0                	test   %eax,%eax
80106298:	79 07                	jns    801062a1 <sys_sbrk+0x24>
    return -1;
8010629a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010629f:	eb 24                	jmp    801062c5 <sys_sbrk+0x48>
  addr = proc->sz;
...
801062b2:	e8 30 e0 ff ff       	call   801042e7 <growproc>
801062b7:	85 c0                	test   %eax,%eax
801062b9:	79 07                	jns    801062c2 <sys_sbrk+0x45>
    return -1;
801062bb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c0:	eb 03                	jmp    801062c5 <sys_sbrk+0x48>
  return addr;
...
801062db:	e8 2d f0 ff ff       	call   8010530d <argint>
801062e0:	85 c0                	test   %eax,%eax
801062e2:	79 07                	jns    801062eb <sys_sleep+0x24>
    return -1;
801062e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062e9:	eb 6c                	jmp    80106357 <sys_sleep+0x90>
  acquire(&tickslock);
801062eb:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
801062f2:	e8 80 ea ff ff       	call   80104d77 <acquire>
  ticks0 = ticks;
801062f7:	a1 20 86 11 80       	mov    0x80118620,%eax
801062fc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801062ff:	eb 34                	jmp    80106335 <sys_sleep+0x6e>
    if(proc->killed){
80106301:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106307:	8b 40 24             	mov    0x24(%eax),%eax
8010630a:	85 c0                	test   %eax,%eax
8010630c:	74 13                	je     80106321 <sys_sleep+0x5a>
      release(&tickslock);
8010630e:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
80106315:	e8 bf ea ff ff       	call   80104dd9 <release>
      return -1;
8010631a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010631f:	eb 36                	jmp    80106357 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106321:	c7 44 24 04 e0 7d 11 	movl   $0x80117de0,0x4(%esp)
80106328:	80 
80106329:	c7 04 24 20 86 11 80 	movl   $0x80118620,(%esp)
80106330:	e8 6f e7 ff ff       	call   80104aa4 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106335:	a1 20 86 11 80       	mov    0x80118620,%eax
8010633a:	2b 45 f4             	sub    -0xc(%ebp),%eax
8010633d:	89 c2                	mov    %eax,%edx
8010633f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106342:	39 c2                	cmp    %eax,%edx
80106344:	72 bb                	jb     80106301 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106346:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
8010634d:	e8 87 ea ff ff       	call   80104dd9 <release>
  return 0;
...
8010635c:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
8010635f:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
80106366:	e8 0c ea ff ff       	call   80104d77 <acquire>
  xticks = ticks;
8010636b:	a1 20 86 11 80       	mov    0x80118620,%eax
80106370:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106373:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
8010637a:	e8 5a ea ff ff       	call   80104dd9 <release>
  return xticks;
...
8010638d:	8b 40 14             	mov    0x14(%eax),%eax
80106390:	85 c0                	test   %eax,%eax
80106392:	75 07                	jne    8010639b <sys_getppid+0x17>
		return 0;
80106394:	b8 00 00 00 00       	mov    $0x0,%eax
80106399:	eb 0c                	jmp    801063a7 <sys_getppid+0x23>
	return proc->parent->pid;
8010639b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063a1:	8b 40 14             	mov    0x14(%eax),%eax
801063a4:	8b 40 10             	mov    0x10(%eax),%eax
}
801063a7:	5d                   	pop    %ebp
801063a8:	c3                   	ret    

801063a9 <sys_kthread_create>:
...
801063ad:	83 ec 24             	sub    $0x24,%esp
	...
	int ustack = 0;
801063b0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int wrapper = 0;
801063b7:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
	int arg1 = 0;
801063be:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
	int arg2 = 0;
801063c5:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)

	argint(0, &ustack);
801063cc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801063cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801063d3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801063da:	e8 2e ef ff ff       	call   8010530d <argint>
	argint(1, &wrapper);
801063df:	8d 45 f0             	lea    -0x10(%ebp),%eax
801063e2:	89 44 24 04          	mov    %eax,0x4(%esp)
801063e6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801063ed:	e8 1b ef ff ff       	call   8010530d <argint>
	argint(2, &arg1);
801063f2:	8d 45 ec             	lea    -0x14(%ebp),%eax
801063f5:	89 44 24 04          	mov    %eax,0x4(%esp)
801063f9:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106400:	e8 08 ef ff ff       	call   8010530d <argint>
	argint(3, &arg2);
80106405:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106408:	89 44 24 04          	mov    %eax,0x4(%esp)
8010640c:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
80106413:	e8 f5 ee ff ff       	call   8010530d <argint>

	proc->ctflag = 1;
80106418:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010641e:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
	return fork((char*)ustack, (uint)wrapper, (uint)arg1, (uint)arg2);
80106425:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106428:	89 c3                	mov    %eax,%ebx
8010642a:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010642d:	89 c1                	mov    %eax,%ecx
8010642f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106432:	89 c2                	mov    %eax,%edx
80106434:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106437:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010643b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010643f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106443:	89 04 24             	mov    %eax,(%esp)
80106446:	e8 41 df ff ff       	call   8010438c <fork>
}
8010644b:	83 c4 24             	add    $0x24,%esp
8010644e:	5b                   	pop    %ebx
8010644f:	5d                   	pop    %ebp
80106450:	c3                   	ret    

80106451 <sys_kthread_join>:
...
8010646c:	e8 9c ee ff ff       	call   8010530d <argint>
	return wait(tid);
80106471:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106474:	89 04 24             	mov    %eax,(%esp)
80106477:	e8 10 e3 ff ff       	call   8010478c <wait>

}
8010647c:	c9                   	leave  
8010647d:	c3                   	ret    

8010647e <sys_kthread_mutex_init>:
...
80106485:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
	...
	for(i=0;i<NMUTX;i++){
8010648c:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80106493:	e9 ac 00 00 00       	jmp    80106544 <sys_kthread_mutex_init+0xc6>

		if(proc->mutexlist[i].id != -1){
80106498:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010649f:	8b 55 f8             	mov    -0x8(%ebp),%edx
801064a2:	89 d0                	mov    %edx,%eax
801064a4:	01 c0                	add    %eax,%eax
801064a6:	01 d0                	add    %edx,%eax
801064a8:	c1 e0 02             	shl    $0x2,%eax
801064ab:	01 c8                	add    %ecx,%eax
801064ad:	05 90 00 00 00       	add    $0x90,%eax
801064b2:	8b 00                	mov    (%eax),%eax
801064b4:	83 f8 ff             	cmp    $0xffffffff,%eax
801064b7:	0f 84 83 00 00 00    	je     80106540 <sys_kthread_mutex_init+0xc2>

			proc->mutexlist[i].id = (i+1);
801064bd:	65 8b 1d 04 00 00 00 	mov    %gs:0x4,%ebx
801064c4:	8b 45 f8             	mov    -0x8(%ebp),%eax
801064c7:	8d 48 01             	lea    0x1(%eax),%ecx
801064ca:	8b 55 f8             	mov    -0x8(%ebp),%edx
801064cd:	89 d0                	mov    %edx,%eax
801064cf:	01 c0                	add    %eax,%eax
801064d1:	01 d0                	add    %edx,%eax
801064d3:	c1 e0 02             	shl    $0x2,%eax
801064d6:	01 d8                	add    %ebx,%eax
801064d8:	05 90 00 00 00       	add    $0x90,%eax
801064dd:	89 08                	mov    %ecx,(%eax)
			proc->mutexlist[i].state = 0;
801064df:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801064e6:	8b 55 f8             	mov    -0x8(%ebp),%edx
801064e9:	89 d0                	mov    %edx,%eax
801064eb:	01 c0                	add    %eax,%eax
801064ed:	01 d0                	add    %edx,%eax
801064ef:	c1 e0 02             	shl    $0x2,%eax
801064f2:	01 c8                	add    %ecx,%eax
801064f4:	05 94 00 00 00       	add    $0x94,%eax
801064f9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			proc->mutexlist[i].lockingthread = 0;
801064ff:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106506:	8b 55 f8             	mov    -0x8(%ebp),%edx
80106509:	89 d0                	mov    %edx,%eax
8010650b:	01 c0                	add    %eax,%eax
8010650d:	01 d0                	add    %edx,%eax
8010650f:	c1 e0 02             	shl    $0x2,%eax
80106512:	01 c8                	add    %ecx,%eax
80106514:	05 98 00 00 00       	add    $0x98,%eax
80106519:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			flag = proc->mutexlist[i].id;
8010651f:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106526:	8b 55 f8             	mov    -0x8(%ebp),%edx
80106529:	89 d0                	mov    %edx,%eax
8010652b:	01 c0                	add    %eax,%eax
8010652d:	01 d0                	add    %edx,%eax
8010652f:	c1 e0 02             	shl    $0x2,%eax
80106532:	01 c8                	add    %ecx,%eax
80106534:	05 90 00 00 00       	add    $0x90,%eax
80106539:	8b 00                	mov    (%eax),%eax
8010653b:	89 45 f4             	mov    %eax,-0xc(%ebp)
			break;
8010653e:	eb 0e                	jmp    8010654e <sys_kthread_mutex_init+0xd0>
...
int sys_kthread_mutex_init(void){
	...
	for(i=0;i<NMUTX;i++){
80106540:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80106544:	83 7d f8 0f          	cmpl   $0xf,-0x8(%ebp)
80106548:	0f 8e 4a ff ff ff    	jle    80106498 <sys_kthread_mutex_init+0x1a>
			flag = proc->mutexlist[i].id;
			break;
		}
	}	
...
80106557 <sys_kthread_mutex_destroy>:
...
8010656b:	e8 9d ed ff ff       	call   8010530d <argint>

	if(proc->mutexlist[mutex-1].id != mutex)
80106570:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106577:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010657a:	8d 50 ff             	lea    -0x1(%eax),%edx
8010657d:	89 d0                	mov    %edx,%eax
8010657f:	01 c0                	add    %eax,%eax
80106581:	01 d0                	add    %edx,%eax
80106583:	c1 e0 02             	shl    $0x2,%eax
80106586:	01 c8                	add    %ecx,%eax
80106588:	05 90 00 00 00       	add    $0x90,%eax
8010658d:	8b 10                	mov    (%eax),%edx
8010658f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106592:	39 c2                	cmp    %eax,%edx
80106594:	74 07                	je     8010659d <sys_kthread_mutex_destroy+0x46>
		return -1;
80106596:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010659b:	eb 6e                	jmp    8010660b <sys_kthread_mutex_destroy+0xb4>
		
	proc->mutexlist[mutex-1].id = -1;
8010659d:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801065a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065a7:	8d 50 ff             	lea    -0x1(%eax),%edx
801065aa:	89 d0                	mov    %edx,%eax
801065ac:	01 c0                	add    %eax,%eax
801065ae:	01 d0                	add    %edx,%eax
801065b0:	c1 e0 02             	shl    $0x2,%eax
801065b3:	01 c8                	add    %ecx,%eax
801065b5:	05 90 00 00 00       	add    $0x90,%eax
801065ba:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
	proc->mutexlist[mutex-1].state = -1;
801065c0:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801065c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065ca:	8d 50 ff             	lea    -0x1(%eax),%edx
801065cd:	89 d0                	mov    %edx,%eax
801065cf:	01 c0                	add    %eax,%eax
801065d1:	01 d0                	add    %edx,%eax
801065d3:	c1 e0 02             	shl    $0x2,%eax
801065d6:	01 c8                	add    %ecx,%eax
801065d8:	05 94 00 00 00       	add    $0x94,%eax
801065dd:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
	proc->mutexlist[mutex-1].lockingthread = -1;
801065e3:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801065ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065ed:	8d 50 ff             	lea    -0x1(%eax),%edx
801065f0:	89 d0                	mov    %edx,%eax
801065f2:	01 c0                	add    %eax,%eax
801065f4:	01 d0                	add    %edx,%eax
801065f6:	c1 e0 02             	shl    $0x2,%eax
801065f9:	01 c8                	add    %ecx,%eax
801065fb:	05 98 00 00 00       	add    $0x98,%eax
80106600:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
	return 0;		
...
8010660d <sys_kthread_mutex_lock>:

int sys_kthread_mutex_lock(void){
8010660d:	55                   	push   %ebp
8010660e:	89 e5                	mov    %esp,%ebp
80106610:	53                   	push   %ebx
80106611:	83 ec 24             	sub    $0x24,%esp

	int mutex = 0;
80106614:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	argint(0, &mutex);
8010661b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010661e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106622:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106629:	e8 df ec ff ff       	call   8010530d <argint>

	if((mutex > 0) && (proc->mutexlist[mutex-1].id == mutex)){
8010662e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106631:	85 c0                	test   %eax,%eax
80106633:	0f 8e 94 00 00 00    	jle    801066cd <sys_kthread_mutex_lock+0xc0>
80106639:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106640:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106643:	8d 50 ff             	lea    -0x1(%eax),%edx
80106646:	89 d0                	mov    %edx,%eax
80106648:	01 c0                	add    %eax,%eax
8010664a:	01 d0                	add    %edx,%eax
8010664c:	c1 e0 02             	shl    $0x2,%eax
8010664f:	01 c8                	add    %ecx,%eax
80106651:	05 90 00 00 00       	add    $0x90,%eax
80106656:	8b 10                	mov    (%eax),%edx
80106658:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010665b:	39 c2                	cmp    %eax,%edx
8010665d:	75 6e                	jne    801066cd <sys_kthread_mutex_lock+0xc0>
		while(proc->mutexlist[mutex-1].state);
8010665f:	90                   	nop
80106660:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106667:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010666a:	8d 50 ff             	lea    -0x1(%eax),%edx
8010666d:	89 d0                	mov    %edx,%eax
8010666f:	01 c0                	add    %eax,%eax
80106671:	01 d0                	add    %edx,%eax
80106673:	c1 e0 02             	shl    $0x2,%eax
80106676:	01 c8                	add    %ecx,%eax
80106678:	05 94 00 00 00       	add    $0x94,%eax
8010667d:	8b 00                	mov    (%eax),%eax
8010667f:	85 c0                	test   %eax,%eax
80106681:	75 dd                	jne    80106660 <sys_kthread_mutex_lock+0x53>
		proc->mutexlist[mutex-1].state = 1;
80106683:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010668a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010668d:	8d 50 ff             	lea    -0x1(%eax),%edx
80106690:	89 d0                	mov    %edx,%eax
80106692:	01 c0                	add    %eax,%eax
80106694:	01 d0                	add    %edx,%eax
80106696:	c1 e0 02             	shl    $0x2,%eax
80106699:	01 c8                	add    %ecx,%eax
8010669b:	05 94 00 00 00       	add    $0x94,%eax
801066a0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
		proc->mutexlist[mutex-1].lockingthread = mutex;	
801066a6:	65 8b 1d 04 00 00 00 	mov    %gs:0x4,%ebx
801066ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066b0:	8d 50 ff             	lea    -0x1(%eax),%edx
801066b3:	8b 4d f4             	mov    -0xc(%ebp),%ecx
801066b6:	89 d0                	mov    %edx,%eax
801066b8:	01 c0                	add    %eax,%eax
801066ba:	01 d0                	add    %edx,%eax
801066bc:	c1 e0 02             	shl    $0x2,%eax
801066bf:	01 d8                	add    %ebx,%eax
801066c1:	05 98 00 00 00       	add    $0x98,%eax
801066c6:	89 08                	mov    %ecx,(%eax)
		return mutex;
801066c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066cb:	eb 05                	jmp    801066d2 <sys_kthread_mutex_lock+0xc5>
	}
	
	return -1;
801066cd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
801066d2:	83 c4 24             	add    $0x24,%esp
801066d5:	5b                   	pop    %ebx
801066d6:	5d                   	pop    %ebp
801066d7:	c3                   	ret    

801066d8 <sys_kthread_mutex_unlock>:

int sys_kthread_mutex_unlock(void){
801066d8:	55                   	push   %ebp
801066d9:	89 e5                	mov    %esp,%ebp
801066db:	83 ec 28             	sub    $0x28,%esp

	int mutex = 0;
801066de:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	argint(0, &mutex);
801066e5:	8d 45 f4             	lea    -0xc(%ebp),%eax
801066e8:	89 44 24 04          	mov    %eax,0x4(%esp)
801066ec:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066f3:	e8 15 ec ff ff       	call   8010530d <argint>

	if((mutex > 0) && (proc->mutexlist[mutex-1].id == mutex)){
801066f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066fb:	85 c0                	test   %eax,%eax
801066fd:	7e 71                	jle    80106770 <sys_kthread_mutex_unlock+0x98>
801066ff:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106706:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106709:	8d 50 ff             	lea    -0x1(%eax),%edx
8010670c:	89 d0                	mov    %edx,%eax
8010670e:	01 c0                	add    %eax,%eax
80106710:	01 d0                	add    %edx,%eax
80106712:	c1 e0 02             	shl    $0x2,%eax
80106715:	01 c8                	add    %ecx,%eax
80106717:	05 90 00 00 00       	add    $0x90,%eax
8010671c:	8b 10                	mov    (%eax),%edx
8010671e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106721:	39 c2                	cmp    %eax,%edx
80106723:	75 4b                	jne    80106770 <sys_kthread_mutex_unlock+0x98>
		proc->mutexlist[mutex-1].state = 0;
80106725:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010672c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010672f:	8d 50 ff             	lea    -0x1(%eax),%edx
80106732:	89 d0                	mov    %edx,%eax
80106734:	01 c0                	add    %eax,%eax
80106736:	01 d0                	add    %edx,%eax
80106738:	c1 e0 02             	shl    $0x2,%eax
8010673b:	01 c8                	add    %ecx,%eax
8010673d:	05 94 00 00 00       	add    $0x94,%eax
80106742:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		proc->mutexlist[mutex-1].lockingthread = 0;
80106748:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010674f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106752:	8d 50 ff             	lea    -0x1(%eax),%edx
80106755:	89 d0                	mov    %edx,%eax
80106757:	01 c0                	add    %eax,%eax
80106759:	01 d0                	add    %edx,%eax
8010675b:	c1 e0 02             	shl    $0x2,%eax
8010675e:	01 c8                	add    %ecx,%eax
80106760:	05 98 00 00 00       	add    $0x98,%eax
80106765:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		return mutex;
8010676b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010676e:	eb 05                	jmp    80106775 <sys_kthread_mutex_unlock+0x9d>
	}
...
80106777 <sys_kthread_cond_init>:
...
80106781 <sys_kthread_cond_destroy>:
...
8010678b <sys_kthread_cond_wait>:
...
80106795 <sys_kthread_cond_signal>:
...
8010679f <sys_kthread_cond_broadcast>:
...
801067b9:	8b 55 08             	mov    0x8(%ebp),%edx
801067bc:	8b 45 0c             	mov    0xc(%ebp),%eax
801067bf:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801067c3:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801067c6:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801067ca:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
801067d4:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
801067d7:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
801067de:	00 
801067df:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
801067e6:	e8 c8 ff ff ff       	call   801067b3 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
801067eb:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
801067f2:	00 
801067f3:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801067fa:	e8 b4 ff ff ff       	call   801067b3 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801067ff:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106806:	00 
80106807:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010680e:	e8 a0 ff ff ff       	call   801067b3 <outb>
  picenable(IRQ_TIMER);
80106813:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010681a:	e8 52 d3 ff ff       	call   80103b71 <picenable>
}
8010681f:	c9                   	leave  
80106820:	c3                   	ret    
...
8010682e:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106830:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106834:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106836:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106838:	54                   	push   %esp
  call trap
80106839:	e8 d8 01 00 00       	call   80106a16 <trap>
  addl $4, %esp
8010683e:	83 c4 04             	add    $0x4,%esp
...
80106841:	61                   	popa   
  popl %gs
80106842:	0f a9                	pop    %gs
  popl %fs
80106844:	0f a1                	pop    %fs
  popl %es
80106846:	07                   	pop    %es
  popl %ds
80106847:	1f                   	pop    %ds
...
80106855:	83 e8 01             	sub    $0x1,%eax
80106858:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010685c:	8b 45 08             	mov    0x8(%ebp),%eax
8010685f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106863:	8b 45 08             	mov    0x8(%ebp),%eax
80106866:	c1 e8 10             	shr    $0x10,%eax
80106869:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
8010686d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106870:	0f 01 18             	lidtl  (%eax)
}
80106873:	c9                   	leave  
80106874:	c3                   	ret    
...
8010687b:	0f 20 d0             	mov    %cr2,%eax
8010687e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
...
80106889:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
8010688c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106893:	e9 c3 00 00 00       	jmp    8010695b <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106898:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010689b:	8b 04 85 c8 b0 10 80 	mov    -0x7fef4f38(,%eax,4),%eax
801068a2:	89 c2                	mov    %eax,%edx
801068a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068a7:	66 89 14 c5 20 7e 11 	mov    %dx,-0x7fee81e0(,%eax,8)
801068ae:	80 
801068af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068b2:	66 c7 04 c5 22 7e 11 	movw   $0x8,-0x7fee81de(,%eax,8)
801068b9:	80 08 00 
801068bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068bf:	0f b6 14 c5 24 7e 11 	movzbl -0x7fee81dc(,%eax,8),%edx
801068c6:	80 
801068c7:	83 e2 e0             	and    $0xffffffe0,%edx
801068ca:	88 14 c5 24 7e 11 80 	mov    %dl,-0x7fee81dc(,%eax,8)
801068d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068d4:	0f b6 14 c5 24 7e 11 	movzbl -0x7fee81dc(,%eax,8),%edx
801068db:	80 
801068dc:	83 e2 1f             	and    $0x1f,%edx
801068df:	88 14 c5 24 7e 11 80 	mov    %dl,-0x7fee81dc(,%eax,8)
801068e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068e9:	0f b6 14 c5 25 7e 11 	movzbl -0x7fee81db(,%eax,8),%edx
801068f0:	80 
801068f1:	83 e2 f0             	and    $0xfffffff0,%edx
801068f4:	83 ca 0e             	or     $0xe,%edx
801068f7:	88 14 c5 25 7e 11 80 	mov    %dl,-0x7fee81db(,%eax,8)
801068fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106901:	0f b6 14 c5 25 7e 11 	movzbl -0x7fee81db(,%eax,8),%edx
80106908:	80 
80106909:	83 e2 ef             	and    $0xffffffef,%edx
8010690c:	88 14 c5 25 7e 11 80 	mov    %dl,-0x7fee81db(,%eax,8)
80106913:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106916:	0f b6 14 c5 25 7e 11 	movzbl -0x7fee81db(,%eax,8),%edx
8010691d:	80 
8010691e:	83 e2 9f             	and    $0xffffff9f,%edx
80106921:	88 14 c5 25 7e 11 80 	mov    %dl,-0x7fee81db(,%eax,8)
80106928:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010692b:	0f b6 14 c5 25 7e 11 	movzbl -0x7fee81db(,%eax,8),%edx
80106932:	80 
80106933:	83 ca 80             	or     $0xffffff80,%edx
80106936:	88 14 c5 25 7e 11 80 	mov    %dl,-0x7fee81db(,%eax,8)
8010693d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106940:	8b 04 85 c8 b0 10 80 	mov    -0x7fef4f38(,%eax,4),%eax
80106947:	c1 e8 10             	shr    $0x10,%eax
8010694a:	89 c2                	mov    %eax,%edx
8010694c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010694f:	66 89 14 c5 26 7e 11 	mov    %dx,-0x7fee81da(,%eax,8)
80106956:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106957:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010695b:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106962:	0f 8e 30 ff ff ff    	jle    80106898 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106968:	a1 c8 b1 10 80       	mov    0x8010b1c8,%eax
8010696d:	66 a3 20 80 11 80    	mov    %ax,0x80118020
80106973:	66 c7 05 22 80 11 80 	movw   $0x8,0x80118022
8010697a:	08 00 
8010697c:	0f b6 05 24 80 11 80 	movzbl 0x80118024,%eax
80106983:	83 e0 e0             	and    $0xffffffe0,%eax
80106986:	a2 24 80 11 80       	mov    %al,0x80118024
8010698b:	0f b6 05 24 80 11 80 	movzbl 0x80118024,%eax
80106992:	83 e0 1f             	and    $0x1f,%eax
80106995:	a2 24 80 11 80       	mov    %al,0x80118024
8010699a:	0f b6 05 25 80 11 80 	movzbl 0x80118025,%eax
801069a1:	83 c8 0f             	or     $0xf,%eax
801069a4:	a2 25 80 11 80       	mov    %al,0x80118025
801069a9:	0f b6 05 25 80 11 80 	movzbl 0x80118025,%eax
801069b0:	83 e0 ef             	and    $0xffffffef,%eax
801069b3:	a2 25 80 11 80       	mov    %al,0x80118025
801069b8:	0f b6 05 25 80 11 80 	movzbl 0x80118025,%eax
801069bf:	83 c8 60             	or     $0x60,%eax
801069c2:	a2 25 80 11 80       	mov    %al,0x80118025
801069c7:	0f b6 05 25 80 11 80 	movzbl 0x80118025,%eax
801069ce:	83 c8 80             	or     $0xffffff80,%eax
801069d1:	a2 25 80 11 80       	mov    %al,0x80118025
801069d6:	a1 c8 b1 10 80       	mov    0x8010b1c8,%eax
801069db:	c1 e8 10             	shr    $0x10,%eax
801069de:	66 a3 26 80 11 80    	mov    %ax,0x80118026
  
  initlock(&tickslock, "time");
801069e4:	c7 44 24 04 00 8c 10 	movl   $0x80108c00,0x4(%esp)
801069eb:	80 
801069ec:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
801069f3:	e8 5e e3 ff ff       	call   80104d56 <initlock>
}
801069f8:	c9                   	leave  
801069f9:	c3                   	ret    
...
801069fd:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106a00:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106a07:	00 
80106a08:	c7 04 24 20 7e 11 80 	movl   $0x80117e20,(%esp)
80106a0f:	e8 38 fe ff ff       	call   8010684c <lidt>
}
80106a14:	c9                   	leave  
80106a15:	c3                   	ret    
...
80106a19:	57                   	push   %edi
80106a1a:	56                   	push   %esi
80106a1b:	53                   	push   %ebx
80106a1c:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106a1f:	8b 45 08             	mov    0x8(%ebp),%eax
80106a22:	8b 40 30             	mov    0x30(%eax),%eax
80106a25:	83 f8 40             	cmp    $0x40,%eax
80106a28:	75 3f                	jne    80106a69 <trap+0x53>
    if(proc->killed)
80106a2a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a30:	8b 40 24             	mov    0x24(%eax),%eax
80106a33:	85 c0                	test   %eax,%eax
80106a35:	74 05                	je     80106a3c <trap+0x26>
      exit();
80106a37:	e8 2b dc ff ff       	call   80104667 <exit>
    proc->tf = tf;
80106a3c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a42:	8b 55 08             	mov    0x8(%ebp),%edx
80106a45:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106a48:	e8 87 e9 ff ff       	call   801053d4 <syscall>
    if(proc->killed)
80106a4d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a53:	8b 40 24             	mov    0x24(%eax),%eax
80106a56:	85 c0                	test   %eax,%eax
80106a58:	74 0a                	je     80106a64 <trap+0x4e>
      exit();
80106a5a:	e8 08 dc ff ff       	call   80104667 <exit>
    return;
80106a5f:	e9 2d 02 00 00       	jmp    80106c91 <trap+0x27b>
80106a64:	e9 28 02 00 00       	jmp    80106c91 <trap+0x27b>
  }

  switch(tf->trapno){
80106a69:	8b 45 08             	mov    0x8(%ebp),%eax
80106a6c:	8b 40 30             	mov    0x30(%eax),%eax
80106a6f:	83 e8 20             	sub    $0x20,%eax
80106a72:	83 f8 1f             	cmp    $0x1f,%eax
80106a75:	0f 87 bc 00 00 00    	ja     80106b37 <trap+0x121>
80106a7b:	8b 04 85 a8 8c 10 80 	mov    -0x7fef7358(,%eax,4),%eax
80106a82:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106a84:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106a8a:	0f b6 00             	movzbl (%eax),%eax
80106a8d:	84 c0                	test   %al,%al
80106a8f:	75 31                	jne    80106ac2 <trap+0xac>
      acquire(&tickslock);
80106a91:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
80106a98:	e8 da e2 ff ff       	call   80104d77 <acquire>
      ticks++;
80106a9d:	a1 20 86 11 80       	mov    0x80118620,%eax
80106aa2:	83 c0 01             	add    $0x1,%eax
80106aa5:	a3 20 86 11 80       	mov    %eax,0x80118620
      wakeup(&ticks);
80106aaa:	c7 04 24 20 86 11 80 	movl   $0x80118620,(%esp)
80106ab1:	e8 ca e0 ff ff       	call   80104b80 <wakeup>
      release(&tickslock);
80106ab6:	c7 04 24 e0 7d 11 80 	movl   $0x80117de0,(%esp)
80106abd:	e8 17 e3 ff ff       	call   80104dd9 <release>
    }
    lapiceoi();
80106ac2:	e8 ec c3 ff ff       	call   80102eb3 <lapiceoi>
    break;
80106ac7:	e9 41 01 00 00       	jmp    80106c0d <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106acc:	e8 0d bc ff ff       	call   801026de <ideintr>
    lapiceoi();
80106ad1:	e8 dd c3 ff ff       	call   80102eb3 <lapiceoi>
    break;
80106ad6:	e9 32 01 00 00       	jmp    80106c0d <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106adb:	e8 bf c1 ff ff       	call   80102c9f <kbdintr>
    lapiceoi();
80106ae0:	e8 ce c3 ff ff       	call   80102eb3 <lapiceoi>
    break;
80106ae5:	e9 23 01 00 00       	jmp    80106c0d <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106aea:	e8 97 03 00 00       	call   80106e86 <uartintr>
    lapiceoi();
80106aef:	e8 bf c3 ff ff       	call   80102eb3 <lapiceoi>
    break;
80106af4:	e9 14 01 00 00       	jmp    80106c0d <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106af9:	8b 45 08             	mov    0x8(%ebp),%eax
80106afc:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
80106b02:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106b06:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106b09:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106b0f:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106b12:	0f b6 c0             	movzbl %al,%eax
80106b15:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106b19:	89 54 24 08          	mov    %edx,0x8(%esp)
80106b1d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b21:	c7 04 24 08 8c 10 80 	movl   $0x80108c08,(%esp)
80106b28:	e8 73 98 ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106b2d:	e8 81 c3 ff ff       	call   80102eb3 <lapiceoi>
    break;
80106b32:	e9 d6 00 00 00       	jmp    80106c0d <trap+0x1f7>
...
80106b3f:	74 11                	je     80106b52 <trap+0x13c>
80106b41:	8b 45 08             	mov    0x8(%ebp),%eax
80106b44:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106b48:	0f b7 c0             	movzwl %ax,%eax
80106b4b:	83 e0 03             	and    $0x3,%eax
80106b4e:	85 c0                	test   %eax,%eax
80106b50:	75 46                	jne    80106b98 <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b52:	e8 1e fd ff ff       	call   80106875 <rcr2>
80106b57:	8b 55 08             	mov    0x8(%ebp),%edx
80106b5a:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106b5d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106b64:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b67:	0f b6 ca             	movzbl %dl,%ecx
80106b6a:	8b 55 08             	mov    0x8(%ebp),%edx
80106b6d:	8b 52 30             	mov    0x30(%edx),%edx
80106b70:	89 44 24 10          	mov    %eax,0x10(%esp)
80106b74:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106b78:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106b7c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b80:	c7 04 24 2c 8c 10 80 	movl   $0x80108c2c,(%esp)
80106b87:	e8 14 98 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106b8c:	c7 04 24 5e 8c 10 80 	movl   $0x80108c5e,(%esp)
80106b93:	e8 a2 99 ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106b98:	e8 d8 fc ff ff       	call   80106875 <rcr2>
80106b9d:	89 c2                	mov    %eax,%edx
80106b9f:	8b 45 08             	mov    0x8(%ebp),%eax
80106ba2:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106ba5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106bab:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106bae:	0f b6 f0             	movzbl %al,%esi
80106bb1:	8b 45 08             	mov    0x8(%ebp),%eax
80106bb4:	8b 58 34             	mov    0x34(%eax),%ebx
80106bb7:	8b 45 08             	mov    0x8(%ebp),%eax
80106bba:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106bbd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bc3:	83 c0 6c             	add    $0x6c,%eax
...
80106bc9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106bcf:	8b 40 10             	mov    0x10(%eax),%eax
80106bd2:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106bd6:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106bda:	89 74 24 14          	mov    %esi,0x14(%esp)
80106bde:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106be2:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106be6:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106be9:	89 74 24 08          	mov    %esi,0x8(%esp)
80106bed:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bf1:	c7 04 24 64 8c 10 80 	movl   $0x80108c64,(%esp)
80106bf8:	e8 a3 97 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
...
80106c0a:	eb 01                	jmp    80106c0d <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106c34:	75 05                	jne    80106c3b <trap+0x225>
    exit();
80106c36:	e8 2c da ff ff       	call   80104667 <exit>
...
80106c43:	74 1e                	je     80106c63 <trap+0x24d>
80106c45:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c4b:	8b 40 0c             	mov    0xc(%eax),%eax
80106c4e:	83 f8 04             	cmp    $0x4,%eax
80106c51:	75 10                	jne    80106c63 <trap+0x24d>
80106c53:	8b 45 08             	mov    0x8(%ebp),%eax
80106c56:	8b 40 30             	mov    0x30(%eax),%eax
80106c59:	83 f8 20             	cmp    $0x20,%eax
80106c5c:	75 05                	jne    80106c63 <trap+0x24d>
    yield();
80106c5e:	e8 e3 dd ff ff       	call   80104a46 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106c63:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c69:	85 c0                	test   %eax,%eax
80106c6b:	74 24                	je     80106c91 <trap+0x27b>
80106c6d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c73:	8b 40 24             	mov    0x24(%eax),%eax
80106c76:	85 c0                	test   %eax,%eax
80106c78:	74 17                	je     80106c91 <trap+0x27b>
80106c7a:	8b 45 08             	mov    0x8(%ebp),%eax
80106c7d:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106c81:	0f b7 c0             	movzwl %ax,%eax
80106c84:	83 e0 03             	and    $0x3,%eax
80106c87:	83 f8 03             	cmp    $0x3,%eax
80106c8a:	75 05                	jne    80106c91 <trap+0x27b>
    exit();
80106c8c:	e8 d6 d9 ff ff       	call   80104667 <exit>
}
80106c91:	83 c4 3c             	add    $0x3c,%esp
80106c94:	5b                   	pop    %ebx
80106c95:	5e                   	pop    %esi
80106c96:	5f                   	pop    %edi
80106c97:	5d                   	pop    %ebp
...
80106c9c:	83 ec 14             	sub    $0x14,%esp
80106c9f:	8b 45 08             	mov    0x8(%ebp),%eax
80106ca2:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106ca6:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106caa:	89 c2                	mov    %eax,%edx
80106cac:	ec                   	in     (%dx),%al
80106cad:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106cb0:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106cb4:	c9                   	leave  
80106cb5:	c3                   	ret    
...
80106cbc:	8b 55 08             	mov    0x8(%ebp),%edx
80106cbf:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cc2:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106cc6:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106cc9:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106ccd:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106cd1:	ee                   	out    %al,(%dx)
}
80106cd2:	c9                   	leave  
80106cd3:	c3                   	ret    
...
80106ce1:	00 
80106ce2:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106ce9:	e8 c8 ff ff ff       	call   80106cb6 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106cee:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106cf5:	00 
80106cf6:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106cfd:	e8 b4 ff ff ff       	call   80106cb6 <outb>
  outb(COM1+0, 115200/9600);
80106d02:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106d09:	00 
80106d0a:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106d11:	e8 a0 ff ff ff       	call   80106cb6 <outb>
  outb(COM1+1, 0);
80106d16:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d1d:	00 
80106d1e:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106d25:	e8 8c ff ff ff       	call   80106cb6 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106d2a:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106d31:	00 
80106d32:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106d39:	e8 78 ff ff ff       	call   80106cb6 <outb>
  outb(COM1+4, 0);
80106d3e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d45:	00 
80106d46:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106d4d:	e8 64 ff ff ff       	call   80106cb6 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106d52:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106d59:	00 
80106d5a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106d61:	e8 50 ff ff ff       	call   80106cb6 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106d66:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106d6d:	e8 27 ff ff ff       	call   80106c99 <inb>
80106d72:	3c ff                	cmp    $0xff,%al
80106d74:	75 02                	jne    80106d78 <uartinit+0xa4>
    return;
80106d76:	eb 6a                	jmp    80106de2 <uartinit+0x10e>
  uart = 1;
80106d78:	c7 05 8c b6 10 80 01 	movl   $0x1,0x8010b68c
80106d7f:	00 00 00 
...
80106d89:	e8 0b ff ff ff       	call   80106c99 <inb>
  inb(COM1+0);
80106d8e:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106d95:	e8 ff fe ff ff       	call   80106c99 <inb>
  picenable(IRQ_COM1);
80106d9a:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106da1:	e8 cb cd ff ff       	call   80103b71 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106da6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106dad:	00 
80106dae:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106db5:	e8 a3 bb ff ff       	call   8010295d <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106dba:	c7 45 f4 28 8d 10 80 	movl   $0x80108d28,-0xc(%ebp)
80106dc1:	eb 15                	jmp    80106dd8 <uartinit+0x104>
    uartputc(*p);
...
80106dcf:	e8 10 00 00 00       	call   80106de4 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106dd4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106dd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ddb:	0f b6 00             	movzbl (%eax),%eax
80106dde:	84 c0                	test   %al,%al
80106de0:	75 e1                	jne    80106dc3 <uartinit+0xef>
    uartputc(*p);
}
80106de2:	c9                   	leave  
80106de3:	c3                   	ret    
...
80106de7:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106dea:	a1 8c b6 10 80       	mov    0x8010b68c,%eax
80106def:	85 c0                	test   %eax,%eax
80106df1:	75 02                	jne    80106df5 <uartputc+0x11>
    return;
80106df3:	eb 4b                	jmp    80106e40 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106df5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106dfc:	eb 10                	jmp    80106e0e <uartputc+0x2a>
    microdelay(10);
80106dfe:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106e05:	e8 ce c0 ff ff       	call   80102ed8 <microdelay>
{
  int i;
...
80106e0e:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106e12:	7f 16                	jg     80106e2a <uartputc+0x46>
80106e14:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106e1b:	e8 79 fe ff ff       	call   80106c99 <inb>
80106e20:	0f b6 c0             	movzbl %al,%eax
80106e23:	83 e0 20             	and    $0x20,%eax
80106e26:	85 c0                	test   %eax,%eax
80106e28:	74 d4                	je     80106dfe <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106e2a:	8b 45 08             	mov    0x8(%ebp),%eax
80106e2d:	0f b6 c0             	movzbl %al,%eax
80106e30:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e34:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106e3b:	e8 76 fe ff ff       	call   80106cb6 <outb>
}
80106e40:	c9                   	leave  
80106e41:	c3                   	ret    
...
80106e45:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106e48:	a1 8c b6 10 80       	mov    0x8010b68c,%eax
80106e4d:	85 c0                	test   %eax,%eax
80106e4f:	75 07                	jne    80106e58 <uartgetc+0x16>
    return -1;
80106e51:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e56:	eb 2c                	jmp    80106e84 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106e58:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106e5f:	e8 35 fe ff ff       	call   80106c99 <inb>
80106e64:	0f b6 c0             	movzbl %al,%eax
80106e67:	83 e0 01             	and    $0x1,%eax
80106e6a:	85 c0                	test   %eax,%eax
80106e6c:	75 07                	jne    80106e75 <uartgetc+0x33>
    return -1;
80106e6e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e73:	eb 0f                	jmp    80106e84 <uartgetc+0x42>
  return inb(COM1+0);
80106e75:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106e7c:	e8 18 fe ff ff       	call   80106c99 <inb>
...
80106e8c:	c7 04 24 42 6e 10 80 	movl   $0x80106e42,(%esp)
80106e93:	e8 15 99 ff ff       	call   801007ad <consoleintr>
}
80106e98:	c9                   	leave  
80106e99:	c3                   	ret    
...
80106e9c:	6a 00                	push   $0x0
  jmp alltraps
80106e9e:	e9 7e f9 ff ff       	jmp    80106821 <alltraps>
...
80106ea3:	6a 00                	push   $0x0
  pushl $1
80106ea5:	6a 01                	push   $0x1
  jmp alltraps
80106ea7:	e9 75 f9 ff ff       	jmp    80106821 <alltraps>
...
80106eac:	6a 00                	push   $0x0
  pushl $2
80106eae:	6a 02                	push   $0x2
  jmp alltraps
80106eb0:	e9 6c f9 ff ff       	jmp    80106821 <alltraps>
...
80106eb5:	6a 00                	push   $0x0
  pushl $3
80106eb7:	6a 03                	push   $0x3
  jmp alltraps
80106eb9:	e9 63 f9 ff ff       	jmp    80106821 <alltraps>
...
80106ebe:	6a 00                	push   $0x0
  pushl $4
80106ec0:	6a 04                	push   $0x4
  jmp alltraps
80106ec2:	e9 5a f9 ff ff       	jmp    80106821 <alltraps>
...
80106ec7:	6a 00                	push   $0x0
  pushl $5
80106ec9:	6a 05                	push   $0x5
  jmp alltraps
80106ecb:	e9 51 f9 ff ff       	jmp    80106821 <alltraps>
...
80106ed0:	6a 00                	push   $0x0
  pushl $6
80106ed2:	6a 06                	push   $0x6
  jmp alltraps
80106ed4:	e9 48 f9 ff ff       	jmp    80106821 <alltraps>
...
80106ed9:	6a 00                	push   $0x0
  pushl $7
80106edb:	6a 07                	push   $0x7
  jmp alltraps
80106edd:	e9 3f f9 ff ff       	jmp    80106821 <alltraps>

80106ee2 <vector8>:
.globl vector8
vector8:
  pushl $8
80106ee2:	6a 08                	push   $0x8
  jmp alltraps
80106ee4:	e9 38 f9 ff ff       	jmp    80106821 <alltraps>
...
80106ee9:	6a 00                	push   $0x0
  pushl $9
80106eeb:	6a 09                	push   $0x9
  jmp alltraps
80106eed:	e9 2f f9 ff ff       	jmp    80106821 <alltraps>
...
80106ef2:	6a 0a                	push   $0xa
  jmp alltraps
80106ef4:	e9 28 f9 ff ff       	jmp    80106821 <alltraps>

80106ef9 <vector11>:
.globl vector11
vector11:
  pushl $11
80106ef9:	6a 0b                	push   $0xb
  jmp alltraps
80106efb:	e9 21 f9 ff ff       	jmp    80106821 <alltraps>

80106f00 <vector12>:
.globl vector12
vector12:
  pushl $12
80106f00:	6a 0c                	push   $0xc
  jmp alltraps
80106f02:	e9 1a f9 ff ff       	jmp    80106821 <alltraps>

80106f07 <vector13>:
.globl vector13
vector13:
  pushl $13
80106f07:	6a 0d                	push   $0xd
  jmp alltraps
80106f09:	e9 13 f9 ff ff       	jmp    80106821 <alltraps>

80106f0e <vector14>:
.globl vector14
vector14:
  pushl $14
80106f0e:	6a 0e                	push   $0xe
  jmp alltraps
80106f10:	e9 0c f9 ff ff       	jmp    80106821 <alltraps>
...
80106f15:	6a 00                	push   $0x0
  pushl $15
80106f17:	6a 0f                	push   $0xf
  jmp alltraps
80106f19:	e9 03 f9 ff ff       	jmp    80106821 <alltraps>
...
80106f1e:	6a 00                	push   $0x0
  pushl $16
80106f20:	6a 10                	push   $0x10
  jmp alltraps
80106f22:	e9 fa f8 ff ff       	jmp    80106821 <alltraps>

80106f27 <vector17>:
.globl vector17
vector17:
  pushl $17
80106f27:	6a 11                	push   $0x11
  jmp alltraps
80106f29:	e9 f3 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f2e:	6a 00                	push   $0x0
  pushl $18
80106f30:	6a 12                	push   $0x12
  jmp alltraps
80106f32:	e9 ea f8 ff ff       	jmp    80106821 <alltraps>
...
80106f37:	6a 00                	push   $0x0
  pushl $19
80106f39:	6a 13                	push   $0x13
  jmp alltraps
80106f3b:	e9 e1 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f40:	6a 00                	push   $0x0
  pushl $20
80106f42:	6a 14                	push   $0x14
  jmp alltraps
80106f44:	e9 d8 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f49:	6a 00                	push   $0x0
  pushl $21
80106f4b:	6a 15                	push   $0x15
  jmp alltraps
80106f4d:	e9 cf f8 ff ff       	jmp    80106821 <alltraps>
...
80106f52:	6a 00                	push   $0x0
  pushl $22
80106f54:	6a 16                	push   $0x16
  jmp alltraps
80106f56:	e9 c6 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f5b:	6a 00                	push   $0x0
  pushl $23
80106f5d:	6a 17                	push   $0x17
  jmp alltraps
80106f5f:	e9 bd f8 ff ff       	jmp    80106821 <alltraps>
...
80106f64:	6a 00                	push   $0x0
  pushl $24
80106f66:	6a 18                	push   $0x18
  jmp alltraps
80106f68:	e9 b4 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f6d:	6a 00                	push   $0x0
  pushl $25
80106f6f:	6a 19                	push   $0x19
  jmp alltraps
80106f71:	e9 ab f8 ff ff       	jmp    80106821 <alltraps>
...
80106f76:	6a 00                	push   $0x0
  pushl $26
80106f78:	6a 1a                	push   $0x1a
  jmp alltraps
80106f7a:	e9 a2 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f7f:	6a 00                	push   $0x0
  pushl $27
80106f81:	6a 1b                	push   $0x1b
  jmp alltraps
80106f83:	e9 99 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f88:	6a 00                	push   $0x0
  pushl $28
80106f8a:	6a 1c                	push   $0x1c
  jmp alltraps
80106f8c:	e9 90 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f91:	6a 00                	push   $0x0
  pushl $29
80106f93:	6a 1d                	push   $0x1d
  jmp alltraps
80106f95:	e9 87 f8 ff ff       	jmp    80106821 <alltraps>
...
80106f9a:	6a 00                	push   $0x0
  pushl $30
80106f9c:	6a 1e                	push   $0x1e
  jmp alltraps
80106f9e:	e9 7e f8 ff ff       	jmp    80106821 <alltraps>
...
80106fa3:	6a 00                	push   $0x0
  pushl $31
80106fa5:	6a 1f                	push   $0x1f
  jmp alltraps
80106fa7:	e9 75 f8 ff ff       	jmp    80106821 <alltraps>
...
80106fac:	6a 00                	push   $0x0
  pushl $32
80106fae:	6a 20                	push   $0x20
  jmp alltraps
80106fb0:	e9 6c f8 ff ff       	jmp    80106821 <alltraps>
...
80106fb5:	6a 00                	push   $0x0
  pushl $33
80106fb7:	6a 21                	push   $0x21
  jmp alltraps
80106fb9:	e9 63 f8 ff ff       	jmp    80106821 <alltraps>
...
80106fbe:	6a 00                	push   $0x0
  pushl $34
80106fc0:	6a 22                	push   $0x22
  jmp alltraps
80106fc2:	e9 5a f8 ff ff       	jmp    80106821 <alltraps>
...
80106fc7:	6a 00                	push   $0x0
  pushl $35
80106fc9:	6a 23                	push   $0x23
  jmp alltraps
80106fcb:	e9 51 f8 ff ff       	jmp    80106821 <alltraps>
...
80106fd0:	6a 00                	push   $0x0
  pushl $36
80106fd2:	6a 24                	push   $0x24
  jmp alltraps
80106fd4:	e9 48 f8 ff ff       	jmp    80106821 <alltraps>
...
80106fd9:	6a 00                	push   $0x0
  pushl $37
80106fdb:	6a 25                	push   $0x25
  jmp alltraps
80106fdd:	e9 3f f8 ff ff       	jmp    80106821 <alltraps>
...
80106fe2:	6a 00                	push   $0x0
  pushl $38
80106fe4:	6a 26                	push   $0x26
  jmp alltraps
80106fe6:	e9 36 f8 ff ff       	jmp    80106821 <alltraps>
...
80106feb:	6a 00                	push   $0x0
  pushl $39
80106fed:	6a 27                	push   $0x27
  jmp alltraps
80106fef:	e9 2d f8 ff ff       	jmp    80106821 <alltraps>
...
80106ff4:	6a 00                	push   $0x0
  pushl $40
80106ff6:	6a 28                	push   $0x28
  jmp alltraps
80106ff8:	e9 24 f8 ff ff       	jmp    80106821 <alltraps>
...
80106ffd:	6a 00                	push   $0x0
  pushl $41
80106fff:	6a 29                	push   $0x29
  jmp alltraps
80107001:	e9 1b f8 ff ff       	jmp    80106821 <alltraps>
...
80107006:	6a 00                	push   $0x0
  pushl $42
80107008:	6a 2a                	push   $0x2a
  jmp alltraps
8010700a:	e9 12 f8 ff ff       	jmp    80106821 <alltraps>
...
8010700f:	6a 00                	push   $0x0
  pushl $43
80107011:	6a 2b                	push   $0x2b
  jmp alltraps
80107013:	e9 09 f8 ff ff       	jmp    80106821 <alltraps>
...
80107018:	6a 00                	push   $0x0
  pushl $44
8010701a:	6a 2c                	push   $0x2c
  jmp alltraps
8010701c:	e9 00 f8 ff ff       	jmp    80106821 <alltraps>
...
80107021:	6a 00                	push   $0x0
  pushl $45
80107023:	6a 2d                	push   $0x2d
  jmp alltraps
80107025:	e9 f7 f7 ff ff       	jmp    80106821 <alltraps>
...
8010702a:	6a 00                	push   $0x0
  pushl $46
8010702c:	6a 2e                	push   $0x2e
  jmp alltraps
8010702e:	e9 ee f7 ff ff       	jmp    80106821 <alltraps>
...
80107033:	6a 00                	push   $0x0
  pushl $47
80107035:	6a 2f                	push   $0x2f
  jmp alltraps
80107037:	e9 e5 f7 ff ff       	jmp    80106821 <alltraps>
...
8010703c:	6a 00                	push   $0x0
  pushl $48
8010703e:	6a 30                	push   $0x30
  jmp alltraps
80107040:	e9 dc f7 ff ff       	jmp    80106821 <alltraps>
...
80107045:	6a 00                	push   $0x0
  pushl $49
80107047:	6a 31                	push   $0x31
  jmp alltraps
80107049:	e9 d3 f7 ff ff       	jmp    80106821 <alltraps>
...
8010704e:	6a 00                	push   $0x0
  pushl $50
80107050:	6a 32                	push   $0x32
  jmp alltraps
80107052:	e9 ca f7 ff ff       	jmp    80106821 <alltraps>
...
80107057:	6a 00                	push   $0x0
  pushl $51
80107059:	6a 33                	push   $0x33
  jmp alltraps
8010705b:	e9 c1 f7 ff ff       	jmp    80106821 <alltraps>
...
80107060:	6a 00                	push   $0x0
  pushl $52
80107062:	6a 34                	push   $0x34
  jmp alltraps
80107064:	e9 b8 f7 ff ff       	jmp    80106821 <alltraps>
...
80107069:	6a 00                	push   $0x0
  pushl $53
8010706b:	6a 35                	push   $0x35
  jmp alltraps
8010706d:	e9 af f7 ff ff       	jmp    80106821 <alltraps>
...
80107072:	6a 00                	push   $0x0
  pushl $54
80107074:	6a 36                	push   $0x36
  jmp alltraps
80107076:	e9 a6 f7 ff ff       	jmp    80106821 <alltraps>
...
8010707b:	6a 00                	push   $0x0
  pushl $55
8010707d:	6a 37                	push   $0x37
  jmp alltraps
8010707f:	e9 9d f7 ff ff       	jmp    80106821 <alltraps>
...
80107084:	6a 00                	push   $0x0
  pushl $56
80107086:	6a 38                	push   $0x38
  jmp alltraps
80107088:	e9 94 f7 ff ff       	jmp    80106821 <alltraps>
...
8010708d:	6a 00                	push   $0x0
  pushl $57
8010708f:	6a 39                	push   $0x39
  jmp alltraps
80107091:	e9 8b f7 ff ff       	jmp    80106821 <alltraps>
...
80107096:	6a 00                	push   $0x0
  pushl $58
80107098:	6a 3a                	push   $0x3a
  jmp alltraps
8010709a:	e9 82 f7 ff ff       	jmp    80106821 <alltraps>
...
8010709f:	6a 00                	push   $0x0
  pushl $59
801070a1:	6a 3b                	push   $0x3b
  jmp alltraps
801070a3:	e9 79 f7 ff ff       	jmp    80106821 <alltraps>
...
801070a8:	6a 00                	push   $0x0
  pushl $60
801070aa:	6a 3c                	push   $0x3c
  jmp alltraps
801070ac:	e9 70 f7 ff ff       	jmp    80106821 <alltraps>
...
801070b1:	6a 00                	push   $0x0
  pushl $61
801070b3:	6a 3d                	push   $0x3d
  jmp alltraps
801070b5:	e9 67 f7 ff ff       	jmp    80106821 <alltraps>
...
801070ba:	6a 00                	push   $0x0
  pushl $62
801070bc:	6a 3e                	push   $0x3e
  jmp alltraps
801070be:	e9 5e f7 ff ff       	jmp    80106821 <alltraps>
...
801070c3:	6a 00                	push   $0x0
  pushl $63
801070c5:	6a 3f                	push   $0x3f
  jmp alltraps
801070c7:	e9 55 f7 ff ff       	jmp    80106821 <alltraps>
...
801070cc:	6a 00                	push   $0x0
  pushl $64
801070ce:	6a 40                	push   $0x40
  jmp alltraps
801070d0:	e9 4c f7 ff ff       	jmp    80106821 <alltraps>
...
801070d5:	6a 00                	push   $0x0
  pushl $65
801070d7:	6a 41                	push   $0x41
  jmp alltraps
801070d9:	e9 43 f7 ff ff       	jmp    80106821 <alltraps>
...
801070de:	6a 00                	push   $0x0
  pushl $66
801070e0:	6a 42                	push   $0x42
  jmp alltraps
801070e2:	e9 3a f7 ff ff       	jmp    80106821 <alltraps>
...
801070e7:	6a 00                	push   $0x0
  pushl $67
801070e9:	6a 43                	push   $0x43
  jmp alltraps
801070eb:	e9 31 f7 ff ff       	jmp    80106821 <alltraps>
...
801070f0:	6a 00                	push   $0x0
  pushl $68
801070f2:	6a 44                	push   $0x44
  jmp alltraps
801070f4:	e9 28 f7 ff ff       	jmp    80106821 <alltraps>
...
801070f9:	6a 00                	push   $0x0
  pushl $69
801070fb:	6a 45                	push   $0x45
  jmp alltraps
801070fd:	e9 1f f7 ff ff       	jmp    80106821 <alltraps>
...
80107102:	6a 00                	push   $0x0
  pushl $70
80107104:	6a 46                	push   $0x46
  jmp alltraps
80107106:	e9 16 f7 ff ff       	jmp    80106821 <alltraps>
...
8010710b:	6a 00                	push   $0x0
  pushl $71
8010710d:	6a 47                	push   $0x47
  jmp alltraps
8010710f:	e9 0d f7 ff ff       	jmp    80106821 <alltraps>
...
80107114:	6a 00                	push   $0x0
  pushl $72
80107116:	6a 48                	push   $0x48
  jmp alltraps
80107118:	e9 04 f7 ff ff       	jmp    80106821 <alltraps>
...
8010711d:	6a 00                	push   $0x0
  pushl $73
8010711f:	6a 49                	push   $0x49
  jmp alltraps
80107121:	e9 fb f6 ff ff       	jmp    80106821 <alltraps>
...
80107126:	6a 00                	push   $0x0
  pushl $74
80107128:	6a 4a                	push   $0x4a
  jmp alltraps
8010712a:	e9 f2 f6 ff ff       	jmp    80106821 <alltraps>
...
8010712f:	6a 00                	push   $0x0
  pushl $75
80107131:	6a 4b                	push   $0x4b
  jmp alltraps
80107133:	e9 e9 f6 ff ff       	jmp    80106821 <alltraps>
...
80107138:	6a 00                	push   $0x0
  pushl $76
8010713a:	6a 4c                	push   $0x4c
  jmp alltraps
8010713c:	e9 e0 f6 ff ff       	jmp    80106821 <alltraps>
...
80107141:	6a 00                	push   $0x0
  pushl $77
80107143:	6a 4d                	push   $0x4d
  jmp alltraps
80107145:	e9 d7 f6 ff ff       	jmp    80106821 <alltraps>
...
8010714a:	6a 00                	push   $0x0
  pushl $78
8010714c:	6a 4e                	push   $0x4e
  jmp alltraps
8010714e:	e9 ce f6 ff ff       	jmp    80106821 <alltraps>
...
80107153:	6a 00                	push   $0x0
  pushl $79
80107155:	6a 4f                	push   $0x4f
  jmp alltraps
80107157:	e9 c5 f6 ff ff       	jmp    80106821 <alltraps>
...
8010715c:	6a 00                	push   $0x0
  pushl $80
8010715e:	6a 50                	push   $0x50
  jmp alltraps
80107160:	e9 bc f6 ff ff       	jmp    80106821 <alltraps>
...
80107165:	6a 00                	push   $0x0
  pushl $81
80107167:	6a 51                	push   $0x51
  jmp alltraps
80107169:	e9 b3 f6 ff ff       	jmp    80106821 <alltraps>
...
8010716e:	6a 00                	push   $0x0
  pushl $82
80107170:	6a 52                	push   $0x52
  jmp alltraps
80107172:	e9 aa f6 ff ff       	jmp    80106821 <alltraps>
...
80107177:	6a 00                	push   $0x0
  pushl $83
80107179:	6a 53                	push   $0x53
  jmp alltraps
8010717b:	e9 a1 f6 ff ff       	jmp    80106821 <alltraps>
...
80107180:	6a 00                	push   $0x0
  pushl $84
80107182:	6a 54                	push   $0x54
  jmp alltraps
80107184:	e9 98 f6 ff ff       	jmp    80106821 <alltraps>
...
80107189:	6a 00                	push   $0x0
  pushl $85
8010718b:	6a 55                	push   $0x55
  jmp alltraps
8010718d:	e9 8f f6 ff ff       	jmp    80106821 <alltraps>
...
80107192:	6a 00                	push   $0x0
  pushl $86
80107194:	6a 56                	push   $0x56
  jmp alltraps
80107196:	e9 86 f6 ff ff       	jmp    80106821 <alltraps>
...
8010719b:	6a 00                	push   $0x0
  pushl $87
8010719d:	6a 57                	push   $0x57
  jmp alltraps
8010719f:	e9 7d f6 ff ff       	jmp    80106821 <alltraps>
...
801071a4:	6a 00                	push   $0x0
  pushl $88
801071a6:	6a 58                	push   $0x58
  jmp alltraps
801071a8:	e9 74 f6 ff ff       	jmp    80106821 <alltraps>
...
801071ad:	6a 00                	push   $0x0
  pushl $89
801071af:	6a 59                	push   $0x59
  jmp alltraps
801071b1:	e9 6b f6 ff ff       	jmp    80106821 <alltraps>
...
801071b6:	6a 00                	push   $0x0
  pushl $90
801071b8:	6a 5a                	push   $0x5a
  jmp alltraps
801071ba:	e9 62 f6 ff ff       	jmp    80106821 <alltraps>
...
801071bf:	6a 00                	push   $0x0
  pushl $91
801071c1:	6a 5b                	push   $0x5b
  jmp alltraps
801071c3:	e9 59 f6 ff ff       	jmp    80106821 <alltraps>
...
801071c8:	6a 00                	push   $0x0
  pushl $92
801071ca:	6a 5c                	push   $0x5c
  jmp alltraps
801071cc:	e9 50 f6 ff ff       	jmp    80106821 <alltraps>
...
801071d1:	6a 00                	push   $0x0
  pushl $93
801071d3:	6a 5d                	push   $0x5d
  jmp alltraps
801071d5:	e9 47 f6 ff ff       	jmp    80106821 <alltraps>
...
801071da:	6a 00                	push   $0x0
  pushl $94
801071dc:	6a 5e                	push   $0x5e
  jmp alltraps
801071de:	e9 3e f6 ff ff       	jmp    80106821 <alltraps>
...
801071e3:	6a 00                	push   $0x0
  pushl $95
801071e5:	6a 5f                	push   $0x5f
  jmp alltraps
801071e7:	e9 35 f6 ff ff       	jmp    80106821 <alltraps>
...
801071ec:	6a 00                	push   $0x0
  pushl $96
801071ee:	6a 60                	push   $0x60
  jmp alltraps
801071f0:	e9 2c f6 ff ff       	jmp    80106821 <alltraps>
...
801071f5:	6a 00                	push   $0x0
  pushl $97
801071f7:	6a 61                	push   $0x61
  jmp alltraps
801071f9:	e9 23 f6 ff ff       	jmp    80106821 <alltraps>
...
801071fe:	6a 00                	push   $0x0
  pushl $98
80107200:	6a 62                	push   $0x62
  jmp alltraps
80107202:	e9 1a f6 ff ff       	jmp    80106821 <alltraps>
...
80107207:	6a 00                	push   $0x0
  pushl $99
80107209:	6a 63                	push   $0x63
  jmp alltraps
8010720b:	e9 11 f6 ff ff       	jmp    80106821 <alltraps>
...
80107210:	6a 00                	push   $0x0
  pushl $100
80107212:	6a 64                	push   $0x64
  jmp alltraps
80107214:	e9 08 f6 ff ff       	jmp    80106821 <alltraps>
...
80107219:	6a 00                	push   $0x0
  pushl $101
8010721b:	6a 65                	push   $0x65
  jmp alltraps
8010721d:	e9 ff f5 ff ff       	jmp    80106821 <alltraps>
...
80107222:	6a 00                	push   $0x0
  pushl $102
80107224:	6a 66                	push   $0x66
  jmp alltraps
80107226:	e9 f6 f5 ff ff       	jmp    80106821 <alltraps>
...
8010722b:	6a 00                	push   $0x0
  pushl $103
8010722d:	6a 67                	push   $0x67
  jmp alltraps
8010722f:	e9 ed f5 ff ff       	jmp    80106821 <alltraps>
...
80107234:	6a 00                	push   $0x0
  pushl $104
80107236:	6a 68                	push   $0x68
  jmp alltraps
80107238:	e9 e4 f5 ff ff       	jmp    80106821 <alltraps>
...
8010723d:	6a 00                	push   $0x0
  pushl $105
8010723f:	6a 69                	push   $0x69
  jmp alltraps
80107241:	e9 db f5 ff ff       	jmp    80106821 <alltraps>
...
80107246:	6a 00                	push   $0x0
  pushl $106
80107248:	6a 6a                	push   $0x6a
  jmp alltraps
8010724a:	e9 d2 f5 ff ff       	jmp    80106821 <alltraps>
...
8010724f:	6a 00                	push   $0x0
  pushl $107
80107251:	6a 6b                	push   $0x6b
  jmp alltraps
80107253:	e9 c9 f5 ff ff       	jmp    80106821 <alltraps>
...
80107258:	6a 00                	push   $0x0
  pushl $108
8010725a:	6a 6c                	push   $0x6c
  jmp alltraps
8010725c:	e9 c0 f5 ff ff       	jmp    80106821 <alltraps>
...
801072a9:	6a 00                	push   $0x0
  pushl $117
801072ab:	6a 75                	push   $0x75
  jmp alltraps
801072ad:	e9 6f f5 ff ff       	jmp    80106821 <alltraps>
...
801072b2:	6a 00                	push   $0x0
  pushl $118
801072b4:	6a 76                	push   $0x76
  jmp alltraps
801072b6:	e9 66 f5 ff ff       	jmp    80106821 <alltraps>
...
801072bb:	6a 00                	push   $0x0
  pushl $119
801072bd:	6a 77                	push   $0x77
  jmp alltraps
801072bf:	e9 5d f5 ff ff       	jmp    80106821 <alltraps>
...
801072c4:	6a 00                	push   $0x0
  pushl $120
801072c6:	6a 78                	push   $0x78
  jmp alltraps
801072c8:	e9 54 f5 ff ff       	jmp    80106821 <alltraps>
...
801072cd:	6a 00                	push   $0x0
  pushl $121
801072cf:	6a 79                	push   $0x79
  jmp alltraps
801072d1:	e9 4b f5 ff ff       	jmp    80106821 <alltraps>
...
801072d6:	6a 00                	push   $0x0
  pushl $122
801072d8:	6a 7a                	push   $0x7a
  jmp alltraps
801072da:	e9 42 f5 ff ff       	jmp    80106821 <alltraps>
...
801072df:	6a 00                	push   $0x0
  pushl $123
801072e1:	6a 7b                	push   $0x7b
  jmp alltraps
801072e3:	e9 39 f5 ff ff       	jmp    80106821 <alltraps>
...
801072e8:	6a 00                	push   $0x0
  pushl $124
801072ea:	6a 7c                	push   $0x7c
  jmp alltraps
801072ec:	e9 30 f5 ff ff       	jmp    80106821 <alltraps>
...
801072f1:	6a 00                	push   $0x0
  pushl $125
801072f3:	6a 7d                	push   $0x7d
  jmp alltraps
801072f5:	e9 27 f5 ff ff       	jmp    80106821 <alltraps>
...
801072fa:	6a 00                	push   $0x0
  pushl $126
801072fc:	6a 7e                	push   $0x7e
  jmp alltraps
801072fe:	e9 1e f5 ff ff       	jmp    80106821 <alltraps>
...
80107303:	6a 00                	push   $0x0
  pushl $127
80107305:	6a 7f                	push   $0x7f
  jmp alltraps
80107307:	e9 15 f5 ff ff       	jmp    80106821 <alltraps>
...
8010730c:	6a 00                	push   $0x0
  pushl $128
8010730e:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107313:	e9 09 f5 ff ff       	jmp    80106821 <alltraps>
...
80107318:	6a 00                	push   $0x0
  pushl $129
8010731a:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010731f:	e9 fd f4 ff ff       	jmp    80106821 <alltraps>
...
80107324:	6a 00                	push   $0x0
  pushl $130
80107326:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010732b:	e9 f1 f4 ff ff       	jmp    80106821 <alltraps>
...
80107330:	6a 00                	push   $0x0
  pushl $131
80107332:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107337:	e9 e5 f4 ff ff       	jmp    80106821 <alltraps>
...
8010733c:	6a 00                	push   $0x0
  pushl $132
8010733e:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107343:	e9 d9 f4 ff ff       	jmp    80106821 <alltraps>
...
80107348:	6a 00                	push   $0x0
  pushl $133
8010734a:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010734f:	e9 cd f4 ff ff       	jmp    80106821 <alltraps>
...
80107354:	6a 00                	push   $0x0
  pushl $134
80107356:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010735b:	e9 c1 f4 ff ff       	jmp    80106821 <alltraps>
...
80107360:	6a 00                	push   $0x0
  pushl $135
80107362:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107367:	e9 b5 f4 ff ff       	jmp    80106821 <alltraps>
...
8010736c:	6a 00                	push   $0x0
  pushl $136
8010736e:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107373:	e9 a9 f4 ff ff       	jmp    80106821 <alltraps>
...
80107378:	6a 00                	push   $0x0
  pushl $137
8010737a:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010737f:	e9 9d f4 ff ff       	jmp    80106821 <alltraps>
...
80107384:	6a 00                	push   $0x0
  pushl $138
80107386:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010738b:	e9 91 f4 ff ff       	jmp    80106821 <alltraps>
...
80107390:	6a 00                	push   $0x0
  pushl $139
80107392:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107397:	e9 85 f4 ff ff       	jmp    80106821 <alltraps>
...
8010739c:	6a 00                	push   $0x0
  pushl $140
8010739e:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801073a3:	e9 79 f4 ff ff       	jmp    80106821 <alltraps>
...
801073a8:	6a 00                	push   $0x0
  pushl $141
801073aa:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801073af:	e9 6d f4 ff ff       	jmp    80106821 <alltraps>
...
801073b4:	6a 00                	push   $0x0
  pushl $142
801073b6:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801073bb:	e9 61 f4 ff ff       	jmp    80106821 <alltraps>
...
801073c0:	6a 00                	push   $0x0
  pushl $143
801073c2:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801073c7:	e9 55 f4 ff ff       	jmp    80106821 <alltraps>
...
801073cc:	6a 00                	push   $0x0
  pushl $144
801073ce:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801073d3:	e9 49 f4 ff ff       	jmp    80106821 <alltraps>
...
801073d8:	6a 00                	push   $0x0
  pushl $145
801073da:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801073df:	e9 3d f4 ff ff       	jmp    80106821 <alltraps>
...
801073e4:	6a 00                	push   $0x0
  pushl $146
801073e6:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801073eb:	e9 31 f4 ff ff       	jmp    80106821 <alltraps>
...
801073f0:	6a 00                	push   $0x0
  pushl $147
801073f2:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801073f7:	e9 25 f4 ff ff       	jmp    80106821 <alltraps>
...
801073fc:	6a 00                	push   $0x0
  pushl $148
801073fe:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107403:	e9 19 f4 ff ff       	jmp    80106821 <alltraps>
...
80107408:	6a 00                	push   $0x0
  pushl $149
8010740a:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010740f:	e9 0d f4 ff ff       	jmp    80106821 <alltraps>
...
80107414:	6a 00                	push   $0x0
  pushl $150
80107416:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010741b:	e9 01 f4 ff ff       	jmp    80106821 <alltraps>
...
80107420:	6a 00                	push   $0x0
  pushl $151
80107422:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107427:	e9 f5 f3 ff ff       	jmp    80106821 <alltraps>
...
8010742c:	6a 00                	push   $0x0
  pushl $152
8010742e:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107433:	e9 e9 f3 ff ff       	jmp    80106821 <alltraps>
...
80107438:	6a 00                	push   $0x0
  pushl $153
8010743a:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010743f:	e9 dd f3 ff ff       	jmp    80106821 <alltraps>
...
80107444:	6a 00                	push   $0x0
  pushl $154
80107446:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010744b:	e9 d1 f3 ff ff       	jmp    80106821 <alltraps>
...
80107450:	6a 00                	push   $0x0
  pushl $155
80107452:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107457:	e9 c5 f3 ff ff       	jmp    80106821 <alltraps>
...
8010745c:	6a 00                	push   $0x0
  pushl $156
8010745e:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107463:	e9 b9 f3 ff ff       	jmp    80106821 <alltraps>
...
80107468:	6a 00                	push   $0x0
  pushl $157
8010746a:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010746f:	e9 ad f3 ff ff       	jmp    80106821 <alltraps>
...
80107474:	6a 00                	push   $0x0
  pushl $158
80107476:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010747b:	e9 a1 f3 ff ff       	jmp    80106821 <alltraps>
...
80107480:	6a 00                	push   $0x0
  pushl $159
80107482:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107487:	e9 95 f3 ff ff       	jmp    80106821 <alltraps>
...
8010748c:	6a 00                	push   $0x0
  pushl $160
8010748e:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107493:	e9 89 f3 ff ff       	jmp    80106821 <alltraps>
...
80107498:	6a 00                	push   $0x0
  pushl $161
8010749a:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010749f:	e9 7d f3 ff ff       	jmp    80106821 <alltraps>
...
801074a4:	6a 00                	push   $0x0
  pushl $162
801074a6:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801074ab:	e9 71 f3 ff ff       	jmp    80106821 <alltraps>
...
801074b0:	6a 00                	push   $0x0
  pushl $163
801074b2:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801074b7:	e9 65 f3 ff ff       	jmp    80106821 <alltraps>
...
801074bc:	6a 00                	push   $0x0
  pushl $164
801074be:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801074c3:	e9 59 f3 ff ff       	jmp    80106821 <alltraps>
...
801074c8:	6a 00                	push   $0x0
  pushl $165
801074ca:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801074cf:	e9 4d f3 ff ff       	jmp    80106821 <alltraps>
...
801074d4:	6a 00                	push   $0x0
  pushl $166
801074d6:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801074db:	e9 41 f3 ff ff       	jmp    80106821 <alltraps>
...
801074e0:	6a 00                	push   $0x0
  pushl $167
801074e2:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801074e7:	e9 35 f3 ff ff       	jmp    80106821 <alltraps>
...
801074ec:	6a 00                	push   $0x0
  pushl $168
801074ee:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801074f3:	e9 29 f3 ff ff       	jmp    80106821 <alltraps>
...
801074f8:	6a 00                	push   $0x0
  pushl $169
801074fa:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801074ff:	e9 1d f3 ff ff       	jmp    80106821 <alltraps>
...
80107504:	6a 00                	push   $0x0
  pushl $170
80107506:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010750b:	e9 11 f3 ff ff       	jmp    80106821 <alltraps>
...
80107510:	6a 00                	push   $0x0
  pushl $171
80107512:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107517:	e9 05 f3 ff ff       	jmp    80106821 <alltraps>
...
8010751c:	6a 00                	push   $0x0
  pushl $172
8010751e:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107523:	e9 f9 f2 ff ff       	jmp    80106821 <alltraps>
...
80107528:	6a 00                	push   $0x0
  pushl $173
8010752a:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010752f:	e9 ed f2 ff ff       	jmp    80106821 <alltraps>
...
80107534:	6a 00                	push   $0x0
  pushl $174
80107536:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010753b:	e9 e1 f2 ff ff       	jmp    80106821 <alltraps>
...
80107540:	6a 00                	push   $0x0
  pushl $175
80107542:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107547:	e9 d5 f2 ff ff       	jmp    80106821 <alltraps>
...
8010754c:	6a 00                	push   $0x0
  pushl $176
8010754e:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107553:	e9 c9 f2 ff ff       	jmp    80106821 <alltraps>
...
80107558:	6a 00                	push   $0x0
  pushl $177
8010755a:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010755f:	e9 bd f2 ff ff       	jmp    80106821 <alltraps>
...
80107564:	6a 00                	push   $0x0
  pushl $178
80107566:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010756b:	e9 b1 f2 ff ff       	jmp    80106821 <alltraps>
...
80107570:	6a 00                	push   $0x0
  pushl $179
80107572:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107577:	e9 a5 f2 ff ff       	jmp    80106821 <alltraps>
...
8010757c:	6a 00                	push   $0x0
  pushl $180
8010757e:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107583:	e9 99 f2 ff ff       	jmp    80106821 <alltraps>
...
80107588:	6a 00                	push   $0x0
  pushl $181
8010758a:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010758f:	e9 8d f2 ff ff       	jmp    80106821 <alltraps>
...
80107594:	6a 00                	push   $0x0
  pushl $182
80107596:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010759b:	e9 81 f2 ff ff       	jmp    80106821 <alltraps>
...
801075a0:	6a 00                	push   $0x0
  pushl $183
801075a2:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801075a7:	e9 75 f2 ff ff       	jmp    80106821 <alltraps>
...
801075ac:	6a 00                	push   $0x0
  pushl $184
801075ae:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801075b3:	e9 69 f2 ff ff       	jmp    80106821 <alltraps>
...
801075b8:	6a 00                	push   $0x0
  pushl $185
801075ba:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801075bf:	e9 5d f2 ff ff       	jmp    80106821 <alltraps>
...
801075c4:	6a 00                	push   $0x0
  pushl $186
801075c6:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801075cb:	e9 51 f2 ff ff       	jmp    80106821 <alltraps>
...
801075d0:	6a 00                	push   $0x0
  pushl $187
801075d2:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801075d7:	e9 45 f2 ff ff       	jmp    80106821 <alltraps>
...
801075dc:	6a 00                	push   $0x0
  pushl $188
801075de:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801075e3:	e9 39 f2 ff ff       	jmp    80106821 <alltraps>
...
801075e8:	6a 00                	push   $0x0
  pushl $189
801075ea:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801075ef:	e9 2d f2 ff ff       	jmp    80106821 <alltraps>
...
801075f4:	6a 00                	push   $0x0
  pushl $190
801075f6:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801075fb:	e9 21 f2 ff ff       	jmp    80106821 <alltraps>
...
80107600:	6a 00                	push   $0x0
  pushl $191
80107602:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107607:	e9 15 f2 ff ff       	jmp    80106821 <alltraps>
...
8010760c:	6a 00                	push   $0x0
  pushl $192
8010760e:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107613:	e9 09 f2 ff ff       	jmp    80106821 <alltraps>
...
80107618:	6a 00                	push   $0x0
  pushl $193
8010761a:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010761f:	e9 fd f1 ff ff       	jmp    80106821 <alltraps>
...
80107624:	6a 00                	push   $0x0
  pushl $194
80107626:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010762b:	e9 f1 f1 ff ff       	jmp    80106821 <alltraps>
...
80107630:	6a 00                	push   $0x0
  pushl $195
80107632:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107637:	e9 e5 f1 ff ff       	jmp    80106821 <alltraps>
...
8010763c:	6a 00                	push   $0x0
  pushl $196
8010763e:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107643:	e9 d9 f1 ff ff       	jmp    80106821 <alltraps>
...
80107648:	6a 00                	push   $0x0
  pushl $197
8010764a:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010764f:	e9 cd f1 ff ff       	jmp    80106821 <alltraps>
...
80107654:	6a 00                	push   $0x0
  pushl $198
80107656:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010765b:	e9 c1 f1 ff ff       	jmp    80106821 <alltraps>
...
80107660:	6a 00                	push   $0x0
  pushl $199
80107662:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107667:	e9 b5 f1 ff ff       	jmp    80106821 <alltraps>
...
8010766c:	6a 00                	push   $0x0
  pushl $200
8010766e:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107673:	e9 a9 f1 ff ff       	jmp    80106821 <alltraps>
...
80107678:	6a 00                	push   $0x0
  pushl $201
8010767a:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010767f:	e9 9d f1 ff ff       	jmp    80106821 <alltraps>
...
80107684:	6a 00                	push   $0x0
  pushl $202
80107686:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010768b:	e9 91 f1 ff ff       	jmp    80106821 <alltraps>
...
80107690:	6a 00                	push   $0x0
  pushl $203
80107692:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107697:	e9 85 f1 ff ff       	jmp    80106821 <alltraps>
...
8010769c:	6a 00                	push   $0x0
  pushl $204
8010769e:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801076a3:	e9 79 f1 ff ff       	jmp    80106821 <alltraps>
...
801076a8:	6a 00                	push   $0x0
  pushl $205
801076aa:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801076af:	e9 6d f1 ff ff       	jmp    80106821 <alltraps>
...
801076b4:	6a 00                	push   $0x0
  pushl $206
801076b6:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801076bb:	e9 61 f1 ff ff       	jmp    80106821 <alltraps>
...
801076c0:	6a 00                	push   $0x0
  pushl $207
801076c2:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801076c7:	e9 55 f1 ff ff       	jmp    80106821 <alltraps>
...
801076cc:	6a 00                	push   $0x0
  pushl $208
801076ce:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801076d3:	e9 49 f1 ff ff       	jmp    80106821 <alltraps>
...
801076d8:	6a 00                	push   $0x0
  pushl $209
801076da:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801076df:	e9 3d f1 ff ff       	jmp    80106821 <alltraps>
...
801076e4:	6a 00                	push   $0x0
  pushl $210
801076e6:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801076eb:	e9 31 f1 ff ff       	jmp    80106821 <alltraps>
...
801076f0:	6a 00                	push   $0x0
  pushl $211
801076f2:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801076f7:	e9 25 f1 ff ff       	jmp    80106821 <alltraps>
...
801076fc:	6a 00                	push   $0x0
  pushl $212
801076fe:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107703:	e9 19 f1 ff ff       	jmp    80106821 <alltraps>
...
80107708:	6a 00                	push   $0x0
  pushl $213
8010770a:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010770f:	e9 0d f1 ff ff       	jmp    80106821 <alltraps>
...
80107714:	6a 00                	push   $0x0
  pushl $214
80107716:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010771b:	e9 01 f1 ff ff       	jmp    80106821 <alltraps>
...
80107720:	6a 00                	push   $0x0
  pushl $215
80107722:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107727:	e9 f5 f0 ff ff       	jmp    80106821 <alltraps>
...
8010772c:	6a 00                	push   $0x0
  pushl $216
8010772e:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107733:	e9 e9 f0 ff ff       	jmp    80106821 <alltraps>
...
80107738:	6a 00                	push   $0x0
  pushl $217
8010773a:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010773f:	e9 dd f0 ff ff       	jmp    80106821 <alltraps>
...
80107744:	6a 00                	push   $0x0
  pushl $218
80107746:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010774b:	e9 d1 f0 ff ff       	jmp    80106821 <alltraps>
...
80107750:	6a 00                	push   $0x0
  pushl $219
80107752:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107757:	e9 c5 f0 ff ff       	jmp    80106821 <alltraps>
...
8010775c:	6a 00                	push   $0x0
  pushl $220
8010775e:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107763:	e9 b9 f0 ff ff       	jmp    80106821 <alltraps>
...
80107768:	6a 00                	push   $0x0
  pushl $221
8010776a:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010776f:	e9 ad f0 ff ff       	jmp    80106821 <alltraps>
...
80107774:	6a 00                	push   $0x0
  pushl $222
80107776:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010777b:	e9 a1 f0 ff ff       	jmp    80106821 <alltraps>
...
80107780:	6a 00                	push   $0x0
  pushl $223
80107782:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107787:	e9 95 f0 ff ff       	jmp    80106821 <alltraps>
...
8010778c:	6a 00                	push   $0x0
  pushl $224
8010778e:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107793:	e9 89 f0 ff ff       	jmp    80106821 <alltraps>
...
80107798:	6a 00                	push   $0x0
  pushl $225
8010779a:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010779f:	e9 7d f0 ff ff       	jmp    80106821 <alltraps>
...
801077a4:	6a 00                	push   $0x0
  pushl $226
801077a6:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801077ab:	e9 71 f0 ff ff       	jmp    80106821 <alltraps>
...
801077b0:	6a 00                	push   $0x0
  pushl $227
801077b2:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801077b7:	e9 65 f0 ff ff       	jmp    80106821 <alltraps>
...
801077bc:	6a 00                	push   $0x0
  pushl $228
801077be:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801077c3:	e9 59 f0 ff ff       	jmp    80106821 <alltraps>
...
801077c8:	6a 00                	push   $0x0
  pushl $229
801077ca:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801077cf:	e9 4d f0 ff ff       	jmp    80106821 <alltraps>
...
801077d4:	6a 00                	push   $0x0
  pushl $230
801077d6:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801077db:	e9 41 f0 ff ff       	jmp    80106821 <alltraps>
...
801077e0:	6a 00                	push   $0x0
  pushl $231
801077e2:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801077e7:	e9 35 f0 ff ff       	jmp    80106821 <alltraps>
...
801077ec:	6a 00                	push   $0x0
  pushl $232
801077ee:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801077f3:	e9 29 f0 ff ff       	jmp    80106821 <alltraps>
...
801077f8:	6a 00                	push   $0x0
  pushl $233
801077fa:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801077ff:	e9 1d f0 ff ff       	jmp    80106821 <alltraps>
...
80107804:	6a 00                	push   $0x0
  pushl $234
80107806:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010780b:	e9 11 f0 ff ff       	jmp    80106821 <alltraps>
...
80107810:	6a 00                	push   $0x0
  pushl $235
80107812:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107817:	e9 05 f0 ff ff       	jmp    80106821 <alltraps>
...
8010781c:	6a 00                	push   $0x0
  pushl $236
8010781e:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107823:	e9 f9 ef ff ff       	jmp    80106821 <alltraps>
...
80107828:	6a 00                	push   $0x0
  pushl $237
8010782a:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010782f:	e9 ed ef ff ff       	jmp    80106821 <alltraps>
...
80107834:	6a 00                	push   $0x0
  pushl $238
80107836:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010783b:	e9 e1 ef ff ff       	jmp    80106821 <alltraps>
...
80107840:	6a 00                	push   $0x0
  pushl $239
80107842:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107847:	e9 d5 ef ff ff       	jmp    80106821 <alltraps>
...
8010784c:	6a 00                	push   $0x0
  pushl $240
8010784e:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107853:	e9 c9 ef ff ff       	jmp    80106821 <alltraps>
...
80107858:	6a 00                	push   $0x0
  pushl $241
8010785a:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010785f:	e9 bd ef ff ff       	jmp    80106821 <alltraps>
...
80107864:	6a 00                	push   $0x0
  pushl $242
80107866:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010786b:	e9 b1 ef ff ff       	jmp    80106821 <alltraps>
...
80107870:	6a 00                	push   $0x0
  pushl $243
80107872:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107877:	e9 a5 ef ff ff       	jmp    80106821 <alltraps>
...
8010787c:	6a 00                	push   $0x0
  pushl $244
8010787e:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107883:	e9 99 ef ff ff       	jmp    80106821 <alltraps>
...
80107888:	6a 00                	push   $0x0
  pushl $245
8010788a:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010788f:	e9 8d ef ff ff       	jmp    80106821 <alltraps>
...
80107894:	6a 00                	push   $0x0
  pushl $246
80107896:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010789b:	e9 81 ef ff ff       	jmp    80106821 <alltraps>
...
801078a0:	6a 00                	push   $0x0
  pushl $247
801078a2:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801078a7:	e9 75 ef ff ff       	jmp    80106821 <alltraps>
...
801078ac:	6a 00                	push   $0x0
  pushl $248
801078ae:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801078b3:	e9 69 ef ff ff       	jmp    80106821 <alltraps>
...
801078b8:	6a 00                	push   $0x0
  pushl $249
801078ba:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801078bf:	e9 5d ef ff ff       	jmp    80106821 <alltraps>
...
801078c4:	6a 00                	push   $0x0
  pushl $250
801078c6:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801078cb:	e9 51 ef ff ff       	jmp    80106821 <alltraps>
...
801078d0:	6a 00                	push   $0x0
  pushl $251
801078d2:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801078d7:	e9 45 ef ff ff       	jmp    80106821 <alltraps>
...
801078dc:	6a 00                	push   $0x0
  pushl $252
801078de:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801078e3:	e9 39 ef ff ff       	jmp    80106821 <alltraps>
...
801078e8:	6a 00                	push   $0x0
  pushl $253
801078ea:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801078ef:	e9 2d ef ff ff       	jmp    80106821 <alltraps>
...
801078f4:	6a 00                	push   $0x0
  pushl $254
801078f6:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801078fb:	e9 21 ef ff ff       	jmp    80106821 <alltraps>
...
80107900:	6a 00                	push   $0x0
  pushl $255
80107902:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107907:	e9 15 ef ff ff       	jmp    80106821 <alltraps>
...
8010790f:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107912:	8b 45 0c             	mov    0xc(%ebp),%eax
80107915:	83 e8 01             	sub    $0x1,%eax
80107918:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010791c:	8b 45 08             	mov    0x8(%ebp),%eax
8010791f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107923:	8b 45 08             	mov    0x8(%ebp),%eax
80107926:	c1 e8 10             	shr    $0x10,%eax
80107929:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
8010792d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107930:	0f 01 10             	lgdtl  (%eax)
}
80107933:	c9                   	leave  
80107934:	c3                   	ret    
...
8010793e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107942:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107946:	0f 00 d8             	ltr    %ax
}
80107949:	c9                   	leave  
8010794a:	c3                   	ret    
...
8010794e:	83 ec 04             	sub    $0x4,%esp
80107951:	8b 45 08             	mov    0x8(%ebp),%eax
80107954:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107958:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010795c:	8e e8                	mov    %eax,%gs
}
8010795e:	c9                   	leave  
8010795f:	c3                   	ret    
...
80107989:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
8010798c:	e8 ca b4 ff ff       	call   80102e5b <cpunum>
80107991:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107997:	05 a0 23 11 80       	add    $0x801123a0,%eax
8010799c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010799f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079a2:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801079a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ab:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801079b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b4:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801079b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079bb:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801079bf:	83 e2 f0             	and    $0xfffffff0,%edx
801079c2:	83 ca 0a             	or     $0xa,%edx
...
80107a33:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107a37:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a3a:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107a41:	ff ff 
80107a43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a46:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107a4d:	00 00 
80107a4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a52:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
...
80107a69:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
...
80107b79:	83 ca 80             	or     $0xffffff80,%edx
...
80107b9f:	83 e2 ef             	and    $0xffffffef,%edx
...
80107bb2:	83 e2 df             	and    $0xffffffdf,%edx
...
80107be4:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107beb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bee:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107bf5:	ff ff 
80107bf7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bfa:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107c01:	00 00 
80107c03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c06:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
...
80107c1d:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107c23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c26:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
...
80107cbe:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107cc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cc8:	05 b4 00 00 00       	add    $0xb4,%eax
80107ccd:	89 c3                	mov    %eax,%ebx
80107ccf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cd2:	05 b4 00 00 00       	add    $0xb4,%eax
80107cd7:	c1 e8 10             	shr    $0x10,%eax
80107cda:	89 c1                	mov    %eax,%ecx
80107cdc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cdf:	05 b4 00 00 00       	add    $0xb4,%eax
80107ce4:	c1 e8 18             	shr    $0x18,%eax
80107ce7:	89 c2                	mov    %eax,%edx
80107ce9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cec:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107cf3:	00 00 
80107cf5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cf8:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107cff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d02:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107d08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d0b:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d12:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d15:	83 c9 02             	or     $0x2,%ecx
80107d18:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d21:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d28:	83 c9 10             	or     $0x10,%ecx
80107d2b:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d34:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d3b:	83 e1 9f             	and    $0xffffff9f,%ecx
80107d3e:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d47:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d4e:	83 c9 80             	or     $0xffffff80,%ecx
...
80107d61:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d64:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107d6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d6d:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d74:	83 e1 ef             	and    $0xffffffef,%ecx
80107d77:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107d7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d80:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d87:	83 e1 df             	and    $0xffffffdf,%ecx
80107d8a:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107d90:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d93:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d9a:	83 c9 40             	or     $0x40,%ecx
...
80107dad:	83 c9 80             	or     $0xffffff80,%ecx
80107db0:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107db6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107db9:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107dbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc2:	83 c0 70             	add    $0x70,%eax
80107dc5:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107dcc:	00 
80107dcd:	89 04 24             	mov    %eax,(%esp)
80107dd0:	e8 37 fb ff ff       	call   8010790c <lgdt>
  loadgs(SEG_KCPU << 3);
80107dd5:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107ddc:	e8 6a fb ff ff       	call   8010794b <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107de1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107de4:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107dea:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107df1:	00 00 00 00 
}
80107df5:	83 c4 24             	add    $0x24,%esp
80107df8:	5b                   	pop    %ebx
80107df9:	5d                   	pop    %ebp
80107dfa:	c3                   	ret    
...
80107dfe:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107e01:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e04:	c1 e8 16             	shr    $0x16,%eax
80107e07:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107e0e:	8b 45 08             	mov    0x8(%ebp),%eax
80107e11:	01 d0                	add    %edx,%eax
80107e13:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107e16:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e19:	8b 00                	mov    (%eax),%eax
80107e1b:	83 e0 01             	and    $0x1,%eax
80107e1e:	85 c0                	test   %eax,%eax
80107e20:	74 17                	je     80107e39 <walkpgdir+0x3e>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107e22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e25:	8b 00                	mov    (%eax),%eax
80107e27:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107e2c:	89 04 24             	mov    %eax,(%esp)
80107e2f:	e8 44 fb ff ff       	call   80107978 <p2v>
80107e34:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107e37:	eb 4b                	jmp    80107e84 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107e39:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107e3d:	74 0e                	je     80107e4d <walkpgdir+0x52>
80107e3f:	e8 9e ac ff ff       	call   80102ae2 <kalloc>
80107e44:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107e47:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107e4b:	75 07                	jne    80107e54 <walkpgdir+0x59>
      return 0;
80107e4d:	b8 00 00 00 00       	mov    $0x0,%eax
80107e52:	eb 47                	jmp    80107e9b <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107e54:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e5b:	00 
80107e5c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e63:	00 
80107e64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e67:	89 04 24             	mov    %eax,(%esp)
80107e6a:	e8 5c d1 ff ff       	call   80104fcb <memset>
...
80107e75:	e8 f1 fa ff ff       	call   8010796b <v2p>
80107e7a:	83 c8 07             	or     $0x7,%eax
80107e7d:	89 c2                	mov    %eax,%edx
80107e7f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e82:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107e84:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e87:	c1 e8 0c             	shr    $0xc,%eax
80107e8a:	25 ff 03 00 00       	and    $0x3ff,%eax
80107e8f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107ea0:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107eae:	8b 55 0c             	mov    0xc(%ebp),%edx
80107eb1:	8b 45 10             	mov    0x10(%ebp),%eax
80107eb4:	01 d0                	add    %edx,%eax
80107eb6:	83 e8 01             	sub    $0x1,%eax
80107eb9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ebe:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107ec1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107ec8:	00 
...
80107ed6:	e8 20 ff ff ff       	call   80107dfb <walkpgdir>
80107edb:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107ede:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ee2:	75 07                	jne    80107eeb <mappages+0x4e>
      return -1;
80107ee4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107ee9:	eb 48                	jmp    80107f33 <mappages+0x96>
    if(*pte & PTE_P)
80107eeb:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107eee:	8b 00                	mov    (%eax),%eax
80107ef0:	83 e0 01             	and    $0x1,%eax
80107ef3:	85 c0                	test   %eax,%eax
80107ef5:	74 0c                	je     80107f03 <mappages+0x66>
      panic("remap");
80107ef7:	c7 04 24 30 8d 10 80 	movl   $0x80108d30,(%esp)
80107efe:	e8 37 86 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80107f03:	8b 45 18             	mov    0x18(%ebp),%eax
80107f06:	0b 45 14             	or     0x14(%ebp),%eax
80107f09:	83 c8 01             	or     $0x1,%eax
80107f0c:	89 c2                	mov    %eax,%edx
80107f0e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f11:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107f13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f16:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f19:	75 08                	jne    80107f23 <mappages+0x86>
      break;
80107f1b:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
  ...
  return 0;
80107f1c:	b8 00 00 00 00       	mov    $0x0,%eax
80107f21:	eb 10                	jmp    80107f33 <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
80107f23:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107f2a:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107f31:	eb 8e                	jmp    80107ec1 <mappages+0x24>
  return 0;
}
80107f33:	c9                   	leave  
80107f34:	c3                   	ret    
...
80107f39:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107f3c:	e8 a1 ab ff ff       	call   80102ae2 <kalloc>
80107f41:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107f44:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107f48:	75 0a                	jne    80107f54 <setupkvm+0x1f>
    return 0;
80107f4a:	b8 00 00 00 00       	mov    $0x0,%eax
80107f4f:	e9 98 00 00 00       	jmp    80107fec <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107f54:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f5b:	00 
80107f5c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107f63:	00 
80107f64:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f67:	89 04 24             	mov    %eax,(%esp)
80107f6a:	e8 5c d0 ff ff       	call   80104fcb <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107f6f:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107f76:	e8 fd f9 ff ff       	call   80107978 <p2v>
80107f7b:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107f80:	76 0c                	jbe    80107f8e <setupkvm+0x59>
    panic("PHYSTOP too high");
80107f82:	c7 04 24 36 8d 10 80 	movl   $0x80108d36,(%esp)
80107f89:	e8 ac 85 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107f8e:	c7 45 f4 e0 b4 10 80 	movl   $0x8010b4e0,-0xc(%ebp)
80107f95:	eb 49                	jmp    80107fe0 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107f97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f9a:	8b 48 0c             	mov    0xc(%eax),%ecx
80107f9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa0:	8b 50 04             	mov    0x4(%eax),%edx
80107fa3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa6:	8b 58 08             	mov    0x8(%eax),%ebx
80107fa9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fac:	8b 40 04             	mov    0x4(%eax),%eax
80107faf:	29 c3                	sub    %eax,%ebx
80107fb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb4:	8b 00                	mov    (%eax),%eax
80107fb6:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107fba:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107fbe:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107fc2:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fc6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fc9:	89 04 24             	mov    %eax,(%esp)
80107fcc:	e8 cc fe ff ff       	call   80107e9d <mappages>
80107fd1:	85 c0                	test   %eax,%eax
80107fd3:	79 07                	jns    80107fdc <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107fd5:	b8 00 00 00 00       	mov    $0x0,%eax
80107fda:	eb 10                	jmp    80107fec <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
...
80107fe0:	81 7d f4 20 b5 10 80 	cmpl   $0x8010b520,-0xc(%ebp)
80107fe7:	72 ae                	jb     80107f97 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107fec:	83 c4 34             	add    $0x34,%esp
80107fef:	5b                   	pop    %ebx
80107ff0:	5d                   	pop    %ebp
80107ff1:	c3                   	ret    
...
80107ff5:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107ff8:	e8 38 ff ff ff       	call   80107f35 <setupkvm>
80107ffd:	a3 78 86 11 80       	mov    %eax,0x80118678
  switchkvm();
80108002:	e8 02 00 00 00       	call   80108009 <switchkvm>
}
80108007:	c9                   	leave  
80108008:	c3                   	ret    
...
8010800f:	a1 78 86 11 80       	mov    0x80118678,%eax
80108014:	89 04 24             	mov    %eax,(%esp)
80108017:	e8 4f f9 ff ff       	call   8010796b <v2p>
8010801c:	89 04 24             	mov    %eax,(%esp)
8010801f:	e8 3c f9 ff ff       	call   80107960 <lcr3>
}
80108024:	c9                   	leave  
80108025:	c3                   	ret    
...
8010802a:	83 ec 14             	sub    $0x14,%esp
  pushcli();
8010802d:	e8 99 ce ff ff       	call   80104ecb <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80108032:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108038:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010803f:	83 c2 08             	add    $0x8,%edx
80108042:	89 d3                	mov    %edx,%ebx
80108044:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010804b:	83 c2 08             	add    $0x8,%edx
8010804e:	c1 ea 10             	shr    $0x10,%edx
80108051:	89 d1                	mov    %edx,%ecx
80108053:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010805a:	83 c2 08             	add    $0x8,%edx
8010805d:	c1 ea 18             	shr    $0x18,%edx
80108060:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108067:	67 00 
80108069:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80108070:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108076:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010807d:	83 e1 f0             	and    $0xfffffff0,%ecx
80108080:	83 c9 09             	or     $0x9,%ecx
80108083:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108089:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108090:	83 c9 10             	or     $0x10,%ecx
80108093:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108099:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801080a0:	83 e1 9f             	and    $0xffffff9f,%ecx
801080a3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080a9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801080b0:	83 c9 80             	or     $0xffffff80,%ecx
801080b3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080b9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080c0:	83 e1 f0             	and    $0xfffffff0,%ecx
801080c3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080c9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080d0:	83 e1 ef             	and    $0xffffffef,%ecx
801080d3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080d9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080e0:	83 e1 df             	and    $0xffffffdf,%ecx
801080e3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080e9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080f0:	83 c9 40             	or     $0x40,%ecx
801080f3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080f9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108100:	83 e1 7f             	and    $0x7f,%ecx
80108103:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108109:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
...
80108147:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
8010814a:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80108151:	e8 df f7 ff ff       	call   80107935 <ltr>
  if(p->pgdir == 0)
80108156:	8b 45 08             	mov    0x8(%ebp),%eax
80108159:	8b 40 04             	mov    0x4(%eax),%eax
8010815c:	85 c0                	test   %eax,%eax
8010815e:	75 0c                	jne    8010816c <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80108160:	c7 04 24 47 8d 10 80 	movl   $0x80108d47,(%esp)
80108167:	e8 ce 83 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
8010816c:	8b 45 08             	mov    0x8(%ebp),%eax
8010816f:	8b 40 04             	mov    0x4(%eax),%eax
80108172:	89 04 24             	mov    %eax,(%esp)
80108175:	e8 f1 f7 ff ff       	call   8010796b <v2p>
8010817a:	89 04 24             	mov    %eax,(%esp)
8010817d:	e8 de f7 ff ff       	call   80107960 <lcr3>
  popcli();
80108182:	e8 88 cd ff ff       	call   80104f0f <popcli>
}
80108187:	83 c4 14             	add    $0x14,%esp
8010818a:	5b                   	pop    %ebx
8010818b:	5d                   	pop    %ebp
8010818c:	c3                   	ret    
...
80108190:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80108193:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
8010819a:	76 0c                	jbe    801081a8 <inituvm+0x1b>
    panic("inituvm: more than a page");
8010819c:	c7 04 24 5b 8d 10 80 	movl   $0x80108d5b,(%esp)
801081a3:	e8 92 83 ff ff       	call   8010053a <panic>
  mem = kalloc();
801081a8:	e8 35 a9 ff ff       	call   80102ae2 <kalloc>
...
801081c6:	e8 00 ce ff ff       	call   80104fcb <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801081cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081ce:	89 04 24             	mov    %eax,(%esp)
801081d1:	e8 95 f7 ff ff       	call   8010796b <v2p>
801081d6:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801081dd:	00 
801081de:	89 44 24 0c          	mov    %eax,0xc(%esp)
801081e2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081e9:	00 
801081ea:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801081f1:	00 
801081f2:	8b 45 08             	mov    0x8(%ebp),%eax
801081f5:	89 04 24             	mov    %eax,(%esp)
801081f8:	e8 a0 fc ff ff       	call   80107e9d <mappages>
  memmove(mem, init, sz);
801081fd:	8b 45 10             	mov    0x10(%ebp),%eax
80108200:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108211:	e8 84 ce ff ff       	call   8010509a <memmove>
}
80108216:	c9                   	leave  
80108217:	c3                   	ret    
...
8010821c:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010821f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108222:	25 ff 0f 00 00       	and    $0xfff,%eax
80108227:	85 c0                	test   %eax,%eax
80108229:	74 0c                	je     80108237 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
8010822b:	c7 04 24 78 8d 10 80 	movl   $0x80108d78,(%esp)
80108232:	e8 03 83 ff ff       	call   8010053a <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108237:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010823e:	e9 a9 00 00 00       	jmp    801082ec <loaduvm+0xd4>
...
8010825d:	e8 99 fb ff ff       	call   80107dfb <walkpgdir>
80108262:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108265:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108269:	75 0c                	jne    80108277 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010826b:	c7 04 24 9b 8d 10 80 	movl   $0x80108d9b,(%esp)
80108272:	e8 c3 82 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
...
80108287:	8b 55 18             	mov    0x18(%ebp),%edx
8010828a:	29 c2                	sub    %eax,%edx
8010828c:	89 d0                	mov    %edx,%eax
8010828e:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108293:	77 0f                	ja     801082a4 <loaduvm+0x8c>
      n = sz - i;
80108295:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108298:	8b 55 18             	mov    0x18(%ebp),%edx
8010829b:	29 c2                	sub    %eax,%edx
8010829d:	89 d0                	mov    %edx,%eax
8010829f:	89 45 f0             	mov    %eax,-0x10(%ebp)
801082a2:	eb 07                	jmp    801082ab <loaduvm+0x93>
    else
      n = PGSIZE;
801082a4:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801082ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ae:	8b 55 14             	mov    0x14(%ebp),%edx
801082b1:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801082b4:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082b7:	89 04 24             	mov    %eax,(%esp)
801082ba:	e8 b9 f6 ff ff       	call   80107978 <p2v>
801082bf:	8b 55 f0             	mov    -0x10(%ebp),%edx
801082c2:	89 54 24 0c          	mov    %edx,0xc(%esp)
801082c6:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801082ca:	89 44 24 04          	mov    %eax,0x4(%esp)
801082ce:	8b 45 10             	mov    0x10(%ebp),%eax
801082d1:	89 04 24             	mov    %eax,(%esp)
801082d4:	e8 8f 9a ff ff       	call   80101d68 <readi>
801082d9:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801082dc:	74 07                	je     801082e5 <loaduvm+0xcd>
      return -1;
801082de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801082e3:	eb 18                	jmp    801082fd <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801082e5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801082ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ef:	3b 45 18             	cmp    0x18(%ebp),%eax
801082f2:	0f 82 4b ff ff ff    	jb     80108243 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801082fd:	83 c4 24             	add    $0x24,%esp
80108300:	5b                   	pop    %ebx
80108301:	5d                   	pop    %ebp
80108302:	c3                   	ret    
...
8010830e:	79 0a                	jns    8010831a <allocuvm+0x17>
    return 0;
80108310:	b8 00 00 00 00       	mov    $0x0,%eax
80108315:	e9 c1 00 00 00       	jmp    801083db <allocuvm+0xd8>
  if(newsz < oldsz)
8010831a:	8b 45 10             	mov    0x10(%ebp),%eax
8010831d:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108320:	73 08                	jae    8010832a <allocuvm+0x27>
    return oldsz;
80108322:	8b 45 0c             	mov    0xc(%ebp),%eax
80108325:	e9 b1 00 00 00       	jmp    801083db <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
8010832a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010832d:	05 ff 0f 00 00       	add    $0xfff,%eax
80108332:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108337:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
8010833a:	e9 8d 00 00 00       	jmp    801083cc <allocuvm+0xc9>
    mem = kalloc();
8010833f:	e8 9e a7 ff ff       	call   80102ae2 <kalloc>
80108344:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108347:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010834b:	75 2c                	jne    80108379 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010834d:	c7 04 24 b9 8d 10 80 	movl   $0x80108db9,(%esp)
80108354:	e8 47 80 ff ff       	call   801003a0 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108359:	8b 45 0c             	mov    0xc(%ebp),%eax
8010835c:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010836d:	e8 6b 00 00 00       	call   801083dd <deallocuvm>
      return 0;
80108372:	b8 00 00 00 00       	mov    $0x0,%eax
80108377:	eb 62                	jmp    801083db <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108379:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108380:	00 
80108381:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108388:	00 
80108389:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010838c:	89 04 24             	mov    %eax,(%esp)
8010838f:	e8 37 cc ff ff       	call   80104fcb <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108394:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108397:	89 04 24             	mov    %eax,(%esp)
8010839a:	e8 cc f5 ff ff       	call   8010796b <v2p>
8010839f:	8b 55 f4             	mov    -0xc(%ebp),%edx
801083a2:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801083a9:	00 
801083aa:	89 44 24 0c          	mov    %eax,0xc(%esp)
801083ae:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083b5:	00 
801083b6:	89 54 24 04          	mov    %edx,0x4(%esp)
801083ba:	8b 45 08             	mov    0x8(%ebp),%eax
801083bd:	89 04 24             	mov    %eax,(%esp)
801083c0:	e8 d8 fa ff ff       	call   80107e9d <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
801083cf:	3b 45 10             	cmp    0x10(%ebp),%eax
801083d2:	0f 82 67 ff ff ff    	jb     8010833f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801083e9:	72 08                	jb     801083f3 <deallocuvm+0x16>
    return oldsz;
801083eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801083ee:	e9 a4 00 00 00       	jmp    80108497 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801083f3:	8b 45 10             	mov    0x10(%ebp),%eax
801083f6:	05 ff 0f 00 00       	add    $0xfff,%eax
801083fb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108400:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108403:	e9 80 00 00 00       	jmp    80108488 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108408:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010840b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108412:	00 
80108413:	89 44 24 04          	mov    %eax,0x4(%esp)
80108417:	8b 45 08             	mov    0x8(%ebp),%eax
8010841a:	89 04 24             	mov    %eax,(%esp)
8010841d:	e8 d9 f9 ff ff       	call   80107dfb <walkpgdir>
80108422:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108425:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108429:	75 09                	jne    80108434 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010842b:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108432:	eb 4d                	jmp    80108481 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108434:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108437:	8b 00                	mov    (%eax),%eax
80108439:	83 e0 01             	and    $0x1,%eax
8010843c:	85 c0                	test   %eax,%eax
8010843e:	74 41                	je     80108481 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108440:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108443:	8b 00                	mov    (%eax),%eax
80108445:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010844a:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
8010844d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108451:	75 0c                	jne    8010845f <deallocuvm+0x82>
        panic("kfree");
80108453:	c7 04 24 d1 8d 10 80 	movl   $0x80108dd1,(%esp)
8010845a:	e8 db 80 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
8010845f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108462:	89 04 24             	mov    %eax,(%esp)
80108465:	e8 0e f5 ff ff       	call   80107978 <p2v>
8010846a:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010846d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108470:	89 04 24             	mov    %eax,(%esp)
80108473:	e8 d1 a5 ff ff       	call   80102a49 <kfree>
      *pte = 0;
80108478:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010847b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
8010848b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010848e:	0f 82 74 ff ff ff    	jb     80108408 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
8010849c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
8010849f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801084a3:	75 0c                	jne    801084b1 <freevm+0x18>
    panic("freevm: no pgdir");
801084a5:	c7 04 24 d7 8d 10 80 	movl   $0x80108dd7,(%esp)
801084ac:	e8 89 80 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801084b1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801084b8:	00 
801084b9:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801084c0:	80 
801084c1:	8b 45 08             	mov    0x8(%ebp),%eax
801084c4:	89 04 24             	mov    %eax,(%esp)
801084c7:	e8 11 ff ff ff       	call   801083dd <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801084cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801084d3:	eb 48                	jmp    8010851d <freevm+0x84>
    if(pgdir[i] & PTE_P){
801084d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084d8:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
801084df:	8b 45 08             	mov    0x8(%ebp),%eax
801084e2:	01 d0                	add    %edx,%eax
801084e4:	8b 00                	mov    (%eax),%eax
801084e6:	83 e0 01             	and    $0x1,%eax
801084e9:	85 c0                	test   %eax,%eax
801084eb:	74 2c                	je     80108519 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801084ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801084f0:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108524:	76 af                	jbe    801084d5 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
8010852c:	e8 18 a5 ff ff       	call   80102a49 <kfree>
}
80108531:	c9                   	leave  
80108532:	c3                   	ret    
...
80108539:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108540:	00 
...
8010854e:	e8 a8 f8 ff ff       	call   80107dfb <walkpgdir>
80108553:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108556:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010855a:	75 0c                	jne    80108568 <clearpteu+0x35>
    panic("clearpteu");
8010855c:	c7 04 24 e8 8d 10 80 	movl   $0x80108de8,(%esp)
80108563:	e8 d2 7f ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108568:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010856b:	8b 00                	mov    (%eax),%eax
8010856d:	83 e0 fb             	and    $0xfffffffb,%eax
80108570:	89 c2                	mov    %eax,%edx
80108572:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108575:	89 10                	mov    %edx,(%eax)
}
80108577:	c9                   	leave  
80108578:	c3                   	ret    
...
8010857d:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108580:	e8 b0 f9 ff ff       	call   80107f35 <setupkvm>
80108585:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108588:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010858c:	75 0a                	jne    80108598 <copyuvm+0x1f>
    return 0;
8010858e:	b8 00 00 00 00       	mov    $0x0,%eax
80108593:	e9 fd 00 00 00       	jmp    80108695 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108598:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010859f:	e9 d0 00 00 00       	jmp    80108674 <copyuvm+0xfb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801085a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085a7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801085ae:	00 
801085af:	89 44 24 04          	mov    %eax,0x4(%esp)
801085b3:	8b 45 08             	mov    0x8(%ebp),%eax
801085b6:	89 04 24             	mov    %eax,(%esp)
801085b9:	e8 3d f8 ff ff       	call   80107dfb <walkpgdir>
801085be:	89 45 ec             	mov    %eax,-0x14(%ebp)
801085c1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801085c5:	75 0c                	jne    801085d3 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801085c7:	c7 04 24 f2 8d 10 80 	movl   $0x80108df2,(%esp)
801085ce:	e8 67 7f ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
801085d3:	8b 45 ec             	mov    -0x14(%ebp),%eax
801085d6:	8b 00                	mov    (%eax),%eax
801085d8:	83 e0 01             	and    $0x1,%eax
801085db:	85 c0                	test   %eax,%eax
801085dd:	75 0c                	jne    801085eb <copyuvm+0x72>
      panic("copyuvm: page not present");
801085df:	c7 04 24 0c 8e 10 80 	movl   $0x80108e0c,(%esp)
...
801085fd:	25 ff 0f 00 00       	and    $0xfff,%eax
80108602:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108605:	e8 d8 a4 ff ff       	call   80102ae2 <kalloc>
8010860a:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010860d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108611:	75 02                	jne    80108615 <copyuvm+0x9c>
      goto bad;
80108613:	eb 70                	jmp    80108685 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108615:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108618:	89 04 24             	mov    %eax,(%esp)
8010861b:	e8 58 f3 ff ff       	call   80107978 <p2v>
80108620:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108627:	00 
80108628:	89 44 24 04          	mov    %eax,0x4(%esp)
8010862c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010862f:	89 04 24             	mov    %eax,(%esp)
80108632:	e8 63 ca ff ff       	call   8010509a <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108637:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
8010863a:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010863d:	89 04 24             	mov    %eax,(%esp)
80108640:	e8 26 f3 ff ff       	call   8010796b <v2p>
80108645:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108648:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010864c:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108650:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108657:	00 
80108658:	89 54 24 04          	mov    %edx,0x4(%esp)
8010865c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010865f:	89 04 24             	mov    %eax,(%esp)
80108662:	e8 36 f8 ff ff       	call   80107e9d <mappages>
80108667:	85 c0                	test   %eax,%eax
80108669:	79 02                	jns    8010866d <copyuvm+0xf4>
      goto bad;
8010866b:	eb 18                	jmp    80108685 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010866d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108674:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108677:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010867a:	0f 82 24 ff ff ff    	jb     801085a4 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108683:	eb 10                	jmp    80108695 <copyuvm+0x11c>

bad:
  freevm(d);
80108685:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108688:	89 04 24             	mov    %eax,(%esp)
8010868b:	e8 09 fe ff ff       	call   80108499 <freevm>
  return 0;
80108690:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108695:	83 c4 44             	add    $0x44,%esp
80108698:	5b                   	pop    %ebx
80108699:	5d                   	pop    %ebp
8010869a:	c3                   	ret    
...
801086b6:	e8 40 f7 ff ff       	call   80107dfb <walkpgdir>
...
801086f1:	e8 82 f2 ff ff       	call   80107978 <p2v>
}
801086f6:	c9                   	leave  
801086f7:	c3                   	ret    
...
801086fb:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
80108701:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108704:	e9 87 00 00 00       	jmp    80108790 <copyout+0x98>
    va0 = (uint)PGROUNDDOWN(va);
80108709:	8b 45 0c             	mov    0xc(%ebp),%eax
8010870c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108711:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
80108721:	e8 75 ff ff ff       	call   8010869b <uva2ka>
80108726:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108729:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
8010872d:	75 07                	jne    80108736 <copyout+0x3e>
      return -1;
8010872f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108734:	eb 69                	jmp    8010879f <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108736:	8b 45 0c             	mov    0xc(%ebp),%eax
80108739:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010873c:	29 c2                	sub    %eax,%edx
8010873e:	89 d0                	mov    %edx,%eax
80108740:	05 00 10 00 00       	add    $0x1000,%eax
80108745:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108748:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010874b:	3b 45 14             	cmp    0x14(%ebp),%eax
8010874e:	76 06                	jbe    80108756 <copyout+0x5e>
      n = len;
80108750:	8b 45 14             	mov    0x14(%ebp),%eax
80108753:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108756:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108759:	8b 55 0c             	mov    0xc(%ebp),%edx
8010875c:	29 c2                	sub    %eax,%edx
8010875e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108761:	01 c2                	add    %eax,%edx
80108763:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108766:	89 44 24 08          	mov    %eax,0x8(%esp)
8010876a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010876d:	89 44 24 04          	mov    %eax,0x4(%esp)
80108771:	89 14 24             	mov    %edx,(%esp)
80108774:	e8 21 c9 ff ff       	call   8010509a <memmove>
    len -= n;
80108779:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010877c:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010877f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108782:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108785:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108788:	05 00 10 00 00       	add    $0x1000,%eax
8010878d:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108790:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108794:	0f 85 6f ff ff ff    	jne    80108709 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
