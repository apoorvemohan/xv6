...
80100028:	bc a0 d6 10 80       	mov    $0x8010d6a0,%esp
...
8010003a:	c7 44 24 04 4c 8c 10 	movl   $0x80108c4c,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 a0 d6 10 80 	movl   $0x8010d6a0,(%esp)
80100049:	e8 f0 40 00 00       	call   8010413e <initlock>

//PAGEBREAK!
  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
8010004e:	c7 05 b4 15 11 80 a8 	movl   $0x801115a8,0x801115b4
80100055:	15 11 80 
  bcache.head.next = &bcache.head;
80100058:	c7 05 b8 15 11 80 a8 	movl   $0x801115a8,0x801115b8
8010005f:	15 11 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
80100062:	c7 45 f4 d8 d6 10 80 	movl   $0x8010d6d8,-0xc(%ebp)
80100069:	eb 3a                	jmp    801000a5 <binit+0x71>
    b->next = bcache.head.next;
8010006b:	8b 15 b8 15 11 80    	mov    0x801115b8,%edx
80100071:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100074:	89 50 10             	mov    %edx,0x10(%eax)
    b->prev = &bcache.head;
80100077:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010007a:	c7 40 0c a8 15 11 80 	movl   $0x801115a8,0xc(%eax)
    b->dev = -1;
80100081:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100084:	c7 40 04 ff ff ff ff 	movl   $0xffffffff,0x4(%eax)
    bcache.head.next->prev = b;
8010008b:	a1 b8 15 11 80       	mov    0x801115b8,%eax
80100090:	8b 55 f4             	mov    -0xc(%ebp),%edx
80100093:	89 50 0c             	mov    %edx,0xc(%eax)
    bcache.head.next = b;
80100096:	8b 45 f4             	mov    -0xc(%ebp),%eax
80100099:	a3 b8 15 11 80       	mov    %eax,0x801115b8
...
801000a5:	81 7d f4 a8 15 11 80 	cmpl   $0x801115a8,-0xc(%ebp)
...
801000bd:	e8 9d 40 00 00       	call   8010415f <acquire>

 loop:
  // Is the sector already cached?
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000c2:	a1 b8 15 11 80       	mov    0x801115b8,%eax
...
80100104:	e8 b8 40 00 00       	call   801041c1 <release>
        return b;
...
8010011f:	e8 e3 4b 00 00       	call   80104d07 <sleep>
      goto loop;
...
8010012f:	81 7d f4 a8 15 11 80 	cmpl   $0x801115a8,-0xc(%ebp)
...
80100138:	a1 b4 15 11 80       	mov    0x801115b4,%eax
...
8010017c:	e8 40 40 00 00       	call   801041c1 <release>
      return b;
...
8010018f:	81 7d f4 a8 15 11 80 	cmpl   $0x801115a8,-0xc(%ebp)
...
80100198:	c7 04 24 53 8c 10 80 	movl   $0x80108c53,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 64 8c 10 80 	movl   $0x80108c64,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 6b 8c 10 80 	movl   $0x80108c6b,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 a0 d6 10 80 	movl   $0x8010d6a0,(%esp)
8010023c:	e8 1e 3f 00 00       	call   8010415f <acquire>
...
8010025c:	89 50 10             	mov    %edx,0x10(%eax)
  b->next = bcache.head.next;
8010025f:	8b 15 b8 15 11 80    	mov    0x801115b8,%edx
80100265:	8b 45 08             	mov    0x8(%ebp),%eax
80100268:	89 50 10             	mov    %edx,0x10(%eax)
  b->prev = &bcache.head;
8010026b:	8b 45 08             	mov    0x8(%ebp),%eax
8010026e:	c7 40 0c a8 15 11 80 	movl   $0x801115a8,0xc(%eax)
  bcache.head.next->prev = b;
80100275:	a1 b8 15 11 80       	mov    0x801115b8,%eax
8010027a:	8b 55 08             	mov    0x8(%ebp),%edx
8010027d:	89 50 0c             	mov    %edx,0xc(%eax)
  bcache.head.next = b;
80100280:	8b 45 08             	mov    0x8(%ebp),%eax
80100283:	a3 b8 15 11 80       	mov    %eax,0x801115b8
...
8010029d:	e8 41 4b 00 00       	call   80104de3 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 a0 d6 10 80 	movl   $0x8010d6a0,(%esp)
801002a9:	e8 13 3f 00 00       	call   801041c1 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003a7:	a1 38 c6 10 80       	mov    0x8010c638,%eax
...
801003bc:	e8 9e 3d 00 00       	call   8010415f <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 72 8c 10 80 	movl   $0x80108c72,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 7b 8c 10 80 	movl   $0x80108c7b,-0x14(%ebp)
      for(; *s; s++)
...
8010052d:	74 0c                	je     8010053b <cprintf+0x19a>
    release(&cons.lock);
8010052f:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80100536:	e8 86 3c 00 00       	call   801041c1 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100543:	e8 b0 fd ff ff       	call   801002f8 <cli>
  cons.locking = 0;
80100548:	c7 05 38 c6 10 80 00 	movl   $0x0,0x8010c638
8010054f:	00 00 00 
...
80100562:	c7 04 24 82 8c 10 80 	movl   $0x80108c82,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 91 8c 10 80 	movl   $0x80108c91,(%esp)
...
80100592:	e8 79 3c 00 00       	call   80104210 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 93 8c 10 80 	movl   $0x80108c93,(%esp)
...
801005c1:	c7 05 e0 c5 10 80 01 	movl   $0x1,0x8010c5e0
801005c8:	00 00 00 
  for(;;)
    ;
...
801007ba:	e8 a0 39 00 00       	call   8010415f <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 9a 46 00 00       	call   80104e89 <procdump>
      break;
801007ef:	e9 11 01 00 00       	jmp    80100905 <consoleintr+0x158>
    case C('U'):  // Kill line.
      while(input.e != input.w &&
        ...
        input.e--;
801007f4:	a1 80 18 11 80       	mov    0x80111880,%eax
801007f9:	83 e8 01             	sub    $0x1,%eax
801007fc:	a3 80 18 11 80       	mov    %eax,0x80111880
        consputc(BACKSPACE);
...
8010080d:	eb 01                	jmp    80100810 <consoleintr+0x63>
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
8010080f:	90                   	nop
80100810:	8b 15 80 18 11 80    	mov    0x80111880,%edx
80100816:	a1 7c 18 11 80       	mov    0x8011187c,%eax
8010081b:	39 c2                	cmp    %eax,%edx
8010081d:	0f 84 db 00 00 00    	je     801008fe <consoleintr+0x151>
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
80100823:	a1 80 18 11 80       	mov    0x80111880,%eax
80100828:	83 e8 01             	sub    $0x1,%eax
8010082b:	83 e0 7f             	and    $0x7f,%eax
8010082e:	0f b6 80 f8 17 11 80 	movzbl -0x7feee808(%eax),%eax
    switch(c){
    case C('P'):  // Process listing.
      procdump();
      break;
...
80100839:	e9 c0 00 00 00       	jmp    801008fe <consoleintr+0x151>
    case C('H'): case '\x7f':  // Backspace
      if(input.e != input.w){
8010083e:	8b 15 80 18 11 80    	mov    0x80111880,%edx
80100844:	a1 7c 18 11 80       	mov    0x8011187c,%eax
80100849:	39 c2                	cmp    %eax,%edx
8010084b:	0f 84 b0 00 00 00    	je     80100901 <consoleintr+0x154>
        input.e--;
80100851:	a1 80 18 11 80       	mov    0x80111880,%eax
80100856:	83 e8 01             	sub    $0x1,%eax
80100859:	a3 80 18 11 80       	mov    %eax,0x80111880
        consputc(BACKSPACE);
...
80100879:	8b 15 80 18 11 80    	mov    0x80111880,%edx
8010087f:	a1 78 18 11 80       	mov    0x80111878,%eax
...
801008a2:	a1 80 18 11 80       	mov    0x80111880,%eax
801008a7:	89 c1                	mov    %eax,%ecx
801008a9:	83 e1 7f             	and    $0x7f,%ecx
801008ac:	8b 55 f4             	mov    -0xc(%ebp),%edx
801008af:	88 91 f8 17 11 80    	mov    %dl,-0x7feee808(%ecx)
801008b5:	83 c0 01             	add    $0x1,%eax
801008b8:	a3 80 18 11 80       	mov    %eax,0x80111880
        consputc(c);
...
801008d4:	a1 80 18 11 80       	mov    0x80111880,%eax
801008d9:	8b 15 78 18 11 80    	mov    0x80111878,%edx
801008df:	83 ea 80             	sub    $0xffffff80,%edx
801008e2:	39 d0                	cmp    %edx,%eax
801008e4:	75 1e                	jne    80100904 <consoleintr+0x157>
          input.w = input.e;
801008e6:	a1 80 18 11 80       	mov    0x80111880,%eax
801008eb:	a3 7c 18 11 80       	mov    %eax,0x8011187c
          wakeup(&input.r);
801008f0:	c7 04 24 78 18 11 80 	movl   $0x80111878,(%esp)
801008f7:	e8 e7 44 00 00       	call   80104de3 <wakeup>
        }
      }
      break;
...
80100911:	0f 89 ad fe ff ff    	jns    801007c4 <consoleintr+0x17>
  ...
  release(&input.lock);
80100917:	c7 04 24 c0 17 11 80 	movl   $0x801117c0,(%esp)
8010091e:	e8 9e 38 00 00       	call   801041c1 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100939:	89 45 f4             	mov    %eax,-0xc(%ebp)
  acquire(&input.lock);
8010093c:	c7 04 24 c0 17 11 80 	movl   $0x801117c0,(%esp)
80100943:	e8 17 38 00 00       	call   8010415f <acquire>
  while(n > 0){
...
80100958:	74 21                	je     8010097b <consoleread+0x56>
        release(&input.lock);
8010095a:	c7 04 24 c0 17 11 80 	movl   $0x801117c0,(%esp)
80100961:	e8 5b 38 00 00       	call   801041c1 <release>
        ilock(ip);
...
8010097b:	c7 44 24 04 c0 17 11 	movl   $0x801117c0,0x4(%esp)
80100982:	80 
80100983:	c7 04 24 78 18 11 80 	movl   $0x80111878,(%esp)
8010098a:	e8 78 43 00 00       	call   80104d07 <sleep>
8010098f:	eb 01                	jmp    80100992 <consoleread+0x6d>
  ...
  while(n > 0){
    while(input.r == input.w){
80100991:	90                   	nop
80100992:	8b 15 78 18 11 80    	mov    0x80111878,%edx
80100998:	a1 7c 18 11 80       	mov    0x8011187c,%eax
...
801009cc:	73 2f                	jae    801009fd <consoleread+0xd8>
        ...
        input.r--;
801009ce:	a1 78 18 11 80       	mov    0x80111878,%eax
801009d3:	83 e8 01             	sub    $0x1,%eax
801009d6:	a3 78 18 11 80       	mov    %eax,0x80111878
      }
      break;
...
80100a00:	90                   	nop
  ...
  release(&input.lock);
80100a01:	c7 04 24 c0 17 11 80 	movl   $0x801117c0,(%esp)
80100a08:	e8 b4 37 00 00       	call   801041c1 <release>
  ilock(ip);
...
80100a32:	e8 8b 0f 00 00       	call   801019c2 <iunlock>
  acquire(&cons.lock);
80100a37:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80100a3e:	e8 1c 37 00 00       	call   8010415f <acquire>
  for(i = 0; i < n; i++)
...
80100a6f:	7c db                	jl     80100a4c <consolewrite+0x26>
    consputc(buf[i] & 0xff);
  release(&cons.lock);
80100a71:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80100a78:	e8 44 37 00 00       	call   801041c1 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 97 8c 10 	movl   $0x80108c97,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80100aa2:	e8 97 36 00 00       	call   8010413e <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 9f 8c 10 	movl   $0x80108c9f,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 c0 17 11 80 	movl   $0x801117c0,(%esp)
80100ab6:	e8 83 36 00 00       	call   8010413e <initlock>

  devsw[CONSOLE].write = consolewrite;
80100abb:	c7 05 4c 22 11 80 26 	movl   $0x80100a26,0x8011224c
80100ac2:	0a 10 80 
  devsw[CONSOLE].read = consoleread;
80100ac5:	c7 05 48 22 11 80 25 	movl   $0x80100925,0x80112248
80100acc:	09 10 80 
  cons.locking = 1;
80100acf:	c7 05 38 c6 10 80 01 	movl   $0x1,0x8010c638
80100ad6:	00 00 00 
...
80100b78:	0f 85 44 03 00 00    	jne    80100ec2 <exec+0x3c6>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 5e 78 00 00       	call   801083e1 <setupkvm>
...
80100c17:	e8 97 7b 00 00       	call   801087b3 <allocuvm>
...
80100c54:	e8 6b 7a 00 00       	call   801086c4 <loaduvm>
...
80100cc4:	e8 ea 7a 00 00       	call   801087b3 <allocuvm>
...
80100ce8:	e8 ea 7c 00 00       	call   801089d7 <clearpteu>
  sp = sz;
...
80100d5f:	e8 38 7e 00 00       	call   80108b9c <copyout>
...
80100dff:	e8 98 7d 00 00       	call   80108b9c <copyout>
...
80100ea8:	e8 25 76 00 00       	call   801084d2 <switchuvm>
  freevm(oldpgdir);
80100ead:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eb0:	89 04 24             	mov    %eax,(%esp)
80100eb3:	e8 91 7a 00 00       	call   80108949 <freevm>
  return 0;
...
80100eea:	e8 5a 7a 00 00       	call   80108949 <freevm>
  if(ip){
...
80100f12:	c7 44 24 04 a5 8c 10 	movl   $0x80108ca5,0x4(%esp)
80100f19:	80 
80100f1a:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100f21:	e8 18 32 00 00       	call   8010413e <initlock>
}
80100f26:	c9                   	leave  
80100f27:	c3                   	ret    
...
80100f2b:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ftable.lock);
80100f2e:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100f35:	e8 25 32 00 00       	call   8010415f <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80100f3a:	c7 45 f4 d8 18 11 80 	movl   $0x801118d8,-0xc(%ebp)
...
80100f50:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
      release(&ftable.lock);
80100f57:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100f5e:	e8 5e 32 00 00       	call   801041c1 <release>
      return f;
...
80100f6c:	81 7d f4 38 22 11 80 	cmpl   $0x80112238,-0xc(%ebp)
80100f73:	72 ce                	jb     80100f43 <filealloc+0x1b>
  ...
  release(&ftable.lock);
80100f75:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100f7c:	e8 40 32 00 00       	call   801041c1 <release>
  return 0;
...
80100f8b:	83 ec 18             	sub    $0x18,%esp
  acquire(&ftable.lock);
80100f8e:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100f95:	e8 c5 31 00 00       	call   8010415f <acquire>
  if(f->ref < 1)
...
80100fa2:	7f 0c                	jg     80100fb0 <filedup+0x28>
    panic("filedup");
80100fa4:	c7 04 24 ac 8c 10 80 	movl   $0x80108cac,(%esp)
...
80100fbc:	89 50 04             	mov    %edx,0x4(%eax)
  release(&ftable.lock);
80100fbf:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100fc6:	e8 f6 31 00 00       	call   801041c1 <release>
  return f;
...
80100fd3:	83 ec 38             	sub    $0x38,%esp
  ...
  acquire(&ftable.lock);
80100fd6:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80100fdd:	e8 7d 31 00 00       	call   8010415f <acquire>
  if(f->ref < 1)
...
80100fea:	7f 0c                	jg     80100ff8 <fileclose+0x28>
    panic("fileclose");
80100fec:	c7 04 24 b4 8c 10 80 	movl   $0x80108cb4,(%esp)
...
8010100f:	7e 11                	jle    80101022 <fileclose+0x52>
    release(&ftable.lock);
80101011:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80101018:	e8 a4 31 00 00       	call   801041c1 <release>
    return;
...
80101055:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  release(&ftable.lock);
8010105b:	c7 04 24 a0 18 11 80 	movl   $0x801118a0,(%esp)
80101062:	e8 5a 31 00 00       	call   801041c1 <release>
...
801011a1:	eb 0c                	jmp    801011af <fileread+0xba>
  ...
  panic("fileread");
801011a3:	c7 04 24 be 8c 10 80 	movl   $0x80108cbe,(%esp)
...
801012af:	c7 04 24 c7 8c 10 80 	movl   $0x80108cc7,(%esp)
...
801012e2:	eb 0c                	jmp    801012f0 <filewrite+0x13f>
  ...
  panic("filewrite");
801012e4:	c7 04 24 d7 8c 10 80 	movl   $0x80108cd7,(%esp)
...
801014d4:	0f 82 e1 fe ff ff    	jb     801013bb <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014da:	c7 04 24 e1 8c 10 80 	movl   $0x80108ce1,(%esp)
...
80101571:	c7 04 24 f7 8c 10 80 	movl   $0x80108cf7,(%esp)
...
801015c5:	c7 44 24 04 0a 8d 10 	movl   $0x80108d0a,0x4(%esp)
801015cc:	80 
801015cd:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801015d4:	e8 65 2b 00 00       	call   8010413e <initlock>
}
801015d9:	c9                   	leave  
801015da:	c3                   	ret    
...
801016a6:	0f 82 5a ff ff ff    	jb     80101606 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016ac:	c7 04 24 11 8d 10 80 	movl   $0x80108d11,(%esp)
...
80101773:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&icache.lock);
80101776:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010177d:	e8 dd 29 00 00       	call   8010415f <acquire>

  // Is the inode already cached?
  empty = 0;
80101782:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101789:	c7 45 f4 d8 22 11 80 	movl   $0x801122d8,-0xc(%ebp)
...
801017bd:	89 50 08             	mov    %edx,0x8(%eax)
      release(&icache.lock);
801017c0:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801017c7:	e8 f5 29 00 00       	call   801041c1 <release>
      return ip;
...
801017eb:	81 7d f4 78 32 11 80 	cmpl   $0x80113278,-0xc(%ebp)
...
801017fa:	c7 04 24 23 8d 10 80 	movl   $0x80108d23,(%esp)
...
8010182a:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  release(&icache.lock);
80101831:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101838:	e8 84 29 00 00       	call   801041c1 <release>
...
80101845:	83 ec 18             	sub    $0x18,%esp
  acquire(&icache.lock);
80101848:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010184f:	e8 0b 29 00 00       	call   8010415f <acquire>
  ip->ref++;
...
80101860:	89 50 08             	mov    %edx,0x8(%eax)
  release(&icache.lock);
80101863:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010186a:	e8 52 29 00 00       	call   801041c1 <release>
  return ip;
...
80101888:	7f 0c                	jg     80101896 <ilock+0x22>
    panic("ilock");
8010188a:	c7 04 24 33 8d 10 80 	movl   $0x80108d33,(%esp)
80101891:	e8 a7 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101896:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
8010189d:	e8 bd 28 00 00       	call   8010415f <acquire>
  while(ip->flags & I_BUSY)
801018a2:	eb 13                	jmp    801018b7 <ilock+0x43>
    sleep(ip, &icache.lock);
801018a4:	c7 44 24 04 a0 22 11 	movl   $0x801122a0,0x4(%esp)
801018ab:	80 
801018ac:	8b 45 08             	mov    0x8(%ebp),%eax
801018af:	89 04 24             	mov    %eax,(%esp)
801018b2:	e8 50 34 00 00       	call   80104d07 <sleep>
...
801018d2:	89 50 0c             	mov    %edx,0xc(%eax)
  release(&icache.lock);
801018d5:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801018dc:	e8 e0 28 00 00       	call   801041c1 <release>
...
801019b2:	75 0c                	jne    801019c0 <ilock+0x14c>
      panic("ilock: no type");
801019b4:	c7 04 24 39 8d 10 80 	movl   $0x80108d39,(%esp)
...
801019e3:	7f 0c                	jg     801019f1 <iunlock+0x2f>
    panic("iunlock");
801019e5:	c7 04 24 48 8d 10 80 	movl   $0x80108d48,(%esp)
801019ec:	e8 4c eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019f1:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
801019f8:	e8 62 27 00 00       	call   8010415f <acquire>
  ip->flags &= ~I_BUSY;
...
80101a14:	e8 ca 33 00 00       	call   80104de3 <wakeup>
  release(&icache.lock);
80101a19:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101a20:	e8 9c 27 00 00       	call   801041c1 <release>
}
80101a25:	c9                   	leave  
80101a26:	c3                   	ret    
...
80101a2a:	83 ec 18             	sub    $0x18,%esp
  acquire(&icache.lock);
80101a2d:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101a34:	e8 26 27 00 00       	call   8010415f <acquire>
...
80101a70:	74 0c                	je     80101a7e <iput+0x57>
      panic("iput busy");
80101a72:	c7 04 24 50 8d 10 80 	movl   $0x80108d50,(%esp)
...
80101a8c:	89 50 0c             	mov    %edx,0xc(%eax)
    release(&icache.lock);
80101a8f:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101a96:	e8 26 27 00 00       	call   801041c1 <release>
    itrunc(ip);
...
80101ab5:	e8 fe fb ff ff       	call   801016b8 <iupdate>
    acquire(&icache.lock);
80101aba:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101ac1:	e8 99 26 00 00       	call   8010415f <acquire>
    ip->flags = 0;
...
80101ad6:	e8 08 33 00 00       	call   80104de3 <wakeup>
  }
  ip->ref--;
...
80101ae7:	89 50 08             	mov    %edx,0x8(%eax)
  release(&icache.lock);
80101aea:	c7 04 24 a0 22 11 80 	movl   $0x801122a0,(%esp)
80101af1:	e8 cb 26 00 00       	call   801041c1 <release>
}
80101af6:	c9                   	leave  
80101af7:	c3                   	ret    
...
80101c06:	c7 04 24 5a 8d 10 80 	movl   $0x80108d5a,(%esp)
...
80101d9e:	98                   	cwtl   
80101d9f:	8b 04 c5 40 22 11 80 	mov    -0x7feeddc0(,%eax,8),%eax
...
80101dbb:	98                   	cwtl   
80101dbc:	8b 14 c5 40 22 11 80 	mov    -0x7feeddc0(,%eax,8),%edx
...
80101f09:	98                   	cwtl   
80101f0a:	8b 04 c5 44 22 11 80 	mov    -0x7feeddbc(,%eax,8),%eax
...
80101f26:	98                   	cwtl   
80101f27:	8b 14 c5 44 22 11 80 	mov    -0x7feeddbc(,%eax,8),%edx
...
801020a0:	c7 04 24 6d 8d 10 80 	movl   $0x80108d6d,(%esp)
...
801020dc:	74 0c                	je     801020ea <dirlookup+0x5d>
      panic("dirlink read");
801020de:	c7 04 24 7f 8d 10 80 	movl   $0x80108d7f,(%esp)
...
801021c0:	74 0c                	je     801021ce <dirlink+0x79>
      panic("dirlink read");
801021c2:	c7 04 24 7f 8d 10 80 	movl   $0x80108d7f,(%esp)
...
80102238:	74 0c                	je     80102246 <dirlink+0xf1>
    panic("dirlink");
8010223a:	c7 04 24 8c 8d 10 80 	movl   $0x80108d8c,(%esp)
...
80102538:	c7 44 24 04 94 8d 10 	movl   $0x80108d94,0x4(%esp)
8010253f:	80 
80102540:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
80102547:	e8 f2 1b 00 00       	call   8010413e <initlock>
  picenable(IRQ_IDE);
8010254c:	c7 04 24 0e 00 00 00 	movl   $0xe,(%esp)
80102553:	e8 71 16 00 00       	call   80103bc9 <picenable>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102558:	a1 c0 39 11 80       	mov    0x801139c0,%eax
...
801025a7:	74 0c                	je     801025b5 <ideinit+0x83>
      havedisk1 = 1;
801025a9:	c7 05 7c c6 10 80 01 	movl   $0x1,0x8010c67c
801025b0:	00 00 00 
      break;
...
801025e2:	75 0c                	jne    801025f0 <idestart+0x18>
    panic("idestart");
801025e4:	c7 04 24 98 8d 10 80 	movl   $0x80108d98,(%esp)
...
80102700:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&idelock);
80102703:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
8010270a:	e8 50 1a 00 00       	call   8010415f <acquire>
  if((b = idequeue) == 0){
8010270f:	a1 78 c6 10 80       	mov    0x8010c678,%eax
80102714:	89 45 f4             	mov    %eax,-0xc(%ebp)
80102717:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010271b:	75 11                	jne    8010272e <ideintr+0x31>
    release(&idelock);
8010271d:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
80102724:	e8 98 1a 00 00       	call   801041c1 <release>
...
80102734:	a3 78 c6 10 80       	mov    %eax,0x8010c678
...
80102797:	e8 47 26 00 00       	call   80104de3 <wakeup>
  
  // Start disk on next buf in queue.
  if(idequeue != 0)
8010279c:	a1 78 c6 10 80       	mov    0x8010c678,%eax
801027a1:	85 c0                	test   %eax,%eax
801027a3:	74 0d                	je     801027b2 <ideintr+0xb5>
    idestart(idequeue);
801027a5:	a1 78 c6 10 80       	mov    0x8010c678,%eax
801027aa:	89 04 24             	mov    %eax,(%esp)
801027ad:	e8 26 fe ff ff       	call   801025d8 <idestart>

  release(&idelock);
801027b2:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
801027b9:	e8 03 1a 00 00       	call   801041c1 <release>
}
801027be:	c9                   	leave  
801027bf:	c3                   	ret    
...
801027d2:	c7 04 24 a1 8d 10 80 	movl   $0x80108da1,(%esp)
...
801027eb:	c7 04 24 b5 8d 10 80 	movl   $0x80108db5,(%esp)
...
80102801:	a1 7c c6 10 80       	mov    0x8010c67c,%eax
80102806:	85 c0                	test   %eax,%eax
80102808:	75 0c                	jne    80102816 <iderw+0x56>
    panic("iderw: ide disk 1 not present");
8010280a:	c7 04 24 ca 8d 10 80 	movl   $0x80108dca,(%esp)
80102811:	e8 27 dd ff ff       	call   8010053d <panic>

  acquire(&idelock);  //DOC:acquire-lock
80102816:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
8010281d:	e8 3d 19 00 00       	call   8010415f <acquire>
...
8010282c:	c7 45 f4 78 c6 10 80 	movl   $0x8010c678,-0xc(%ebp)
...
8010284f:	89 10                	mov    %edx,(%eax)
  ...
  if(idequeue == b)
80102851:	a1 78 c6 10 80       	mov    0x8010c678,%eax
...
80102866:	eb 15                	jmp    8010287d <iderw+0xbd>
    sleep(b, &idelock);
80102868:	c7 44 24 04 40 c6 10 	movl   $0x8010c640,0x4(%esp)
8010286f:	80 
80102870:	8b 45 08             	mov    0x8(%ebp),%eax
80102873:	89 04 24             	mov    %eax,(%esp)
80102876:	e8 8c 24 00 00       	call   80104d07 <sleep>
...
80102889:	75 dd                	jne    80102868 <iderw+0xa8>
  ...
  release(&idelock);
8010288b:	c7 04 24 40 c6 10 80 	movl   $0x8010c640,(%esp)
80102892:	e8 2a 19 00 00       	call   801041c1 <release>
}
80102897:	c9                   	leave  
80102898:	c3                   	ret    
...
8010289d:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
8010289f:	a1 78 32 11 80       	mov    0x80113278,%eax
801028a4:	8b 55 08             	mov    0x8(%ebp),%edx
801028a7:	89 10                	mov    %edx,(%eax)
  return ioapic->data;
801028a9:	a1 78 32 11 80       	mov    0x80113278,%eax
...
801028b4:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
801028b6:	a1 78 32 11 80       	mov    0x80113278,%eax
801028bb:	8b 55 08             	mov    0x8(%ebp),%edx
801028be:	89 10                	mov    %edx,(%eax)
  ioapic->data = data;
801028c0:	a1 78 32 11 80       	mov    0x80113278,%eax
...
801028d0:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!ismp)
801028d3:	a1 c4 33 11 80       	mov    0x801133c4,%eax
801028d8:	85 c0                	test   %eax,%eax
801028da:	0f 84 9f 00 00 00    	je     8010297f <ioapicinit+0xb2>
    return;

  ioapic = (volatile struct ioapic*)IOAPIC;
801028e0:	c7 05 78 32 11 80 00 	movl   $0xfec00000,0x80113278
801028e7:	00 c0 fe 
...
80102985:	83 ec 08             	sub    $0x8,%esp
  if(!ismp)
80102988:	a1 c4 33 11 80       	mov    0x801133c4,%eax
...
801029e3:	c7 44 24 04 1a 8e 10 	movl   $0x80108e1a,0x4(%esp)
801029ea:	80 
801029eb:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
801029f2:	e8 47 17 00 00       	call   8010413e <initlock>
  kmem.use_lock = 0;
801029f7:	c7 05 b8 32 11 80 00 	movl   $0x0,0x801132b8
801029fe:	00 00 00 
...
80102a28:	e8 0c 00 00 00       	call   80102a39 <freerange>
  kmem.use_lock = 1;
80102a2d:	c7 05 b8 32 11 80 01 	movl   $0x1,0x801132b8
80102a34:	00 00 00 
}
80102a37:	c9                   	leave  
80102a38:	c3                   	ret    
...
80102a84:	81 7d 08 bc 66 1d 80 	cmpl   $0x801d66bc,0x8(%ebp)
...
80102a9d:	76 0c                	jbe    80102aab <kfree+0x39>
    panic("kfree");
80102a9f:	c7 04 24 1f 8e 10 80 	movl   $0x80108e1f,(%esp)
...
80102ac1:	e8 0c 25 00 00       	call   80104fd2 <memset>
  ...
  if(kmem.use_lock)
80102ac6:	a1 b8 32 11 80       	mov    0x801132b8,%eax
80102acb:	85 c0                	test   %eax,%eax
80102acd:	74 0c                	je     80102adb <kfree+0x69>
    acquire(&kmem.lock);
80102acf:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80102ad6:	e8 84 16 00 00       	call   8010415f <acquire>
  r = (struct run*)v;
80102adb:	8b 45 08             	mov    0x8(%ebp),%eax
80102ade:	89 45 f4             	mov    %eax,-0xc(%ebp)
  r->next = kmem.freelist;
80102ae1:	8b 15 bc 32 11 80    	mov    0x801132bc,%edx
80102ae7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102aea:	89 10                	mov    %edx,(%eax)
  kmem.freelist = r;
80102aec:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102aef:	a3 bc 32 11 80       	mov    %eax,0x801132bc
  if(kmem.use_lock)
80102af4:	a1 b8 32 11 80       	mov    0x801132b8,%eax
80102af9:	85 c0                	test   %eax,%eax
80102afb:	74 0c                	je     80102b09 <kfree+0x97>
    release(&kmem.lock);
80102afd:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80102b04:	e8 b8 16 00 00       	call   801041c1 <release>
}
80102b09:	c9                   	leave  
80102b0a:	c3                   	ret    
...
80102b0e:	83 ec 28             	sub    $0x28,%esp
  ...
  if(kmem.use_lock)
80102b11:	a1 b8 32 11 80       	mov    0x801132b8,%eax
80102b16:	85 c0                	test   %eax,%eax
80102b18:	74 0c                	je     80102b26 <kalloc+0x1b>
    acquire(&kmem.lock);
80102b1a:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80102b21:	e8 39 16 00 00       	call   8010415f <acquire>
  r = kmem.freelist;
80102b26:	a1 bc 32 11 80       	mov    0x801132bc,%eax
...
80102b39:	a3 bc 32 11 80       	mov    %eax,0x801132bc
  if(kmem.use_lock)
80102b3e:	a1 b8 32 11 80       	mov    0x801132b8,%eax
80102b43:	85 c0                	test   %eax,%eax
80102b45:	74 0c                	je     80102b53 <kalloc+0x48>
    release(&kmem.lock);
80102b47:	c7 04 24 80 32 11 80 	movl   $0x80113280,(%esp)
80102b4e:	e8 6e 16 00 00       	call   801041c1 <release>
  return (char*)r;
...
80102bc7:	75 17                	jne    80102be0 <kbdgetc+0x5e>
    shift |= E0ESC;
80102bc9:	a1 80 c6 10 80       	mov    0x8010c680,%eax
80102bce:	83 c8 40             	or     $0x40,%eax
80102bd1:	a3 80 c6 10 80       	mov    %eax,0x8010c680
    return 0;
...
80102bec:	a1 80 c6 10 80       	mov    0x8010c680,%eax
...
80102c1b:	a1 80 c6 10 80       	mov    0x8010c680,%eax
80102c20:	21 d0                	and    %edx,%eax
80102c22:	a3 80 c6 10 80       	mov    %eax,0x8010c680
    return 0;
80102c27:	b8 00 00 00 00       	mov    $0x0,%eax
80102c2c:	e9 a0 00 00 00       	jmp    80102cd1 <kbdgetc+0x14f>
  } else if(shift & E0ESC){
80102c31:	a1 80 c6 10 80       	mov    0x8010c680,%eax
...
80102c3d:	81 4d fc 80 00 00 00 	orl    $0x80,-0x4(%ebp)
    shift &= ~E0ESC;
80102c44:	a1 80 c6 10 80       	mov    0x8010c680,%eax
80102c49:	83 e0 bf             	and    $0xffffffbf,%eax
80102c4c:	a3 80 c6 10 80       	mov    %eax,0x8010c680
  }
...
80102c5f:	a1 80 c6 10 80       	mov    0x8010c680,%eax
80102c64:	09 d0                	or     %edx,%eax
80102c66:	a3 80 c6 10 80       	mov    %eax,0x8010c680
...
80102c79:	a1 80 c6 10 80       	mov    0x8010c680,%eax
80102c7e:	31 d0                	xor    %edx,%eax
80102c80:	a3 80 c6 10 80       	mov    %eax,0x8010c680
  c = charcode[shift & (CTL | SHIFT)][data];
80102c85:	a1 80 c6 10 80       	mov    0x8010c680,%eax
...
80102c9d:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(shift & CAPSLOCK){
80102ca0:	a1 80 c6 10 80       	mov    0x8010c680,%eax
...
80102d1c:	89 e5                	mov    %esp,%ebp
  lapic[index] = value;
80102d1e:	a1 c0 32 11 80       	mov    0x801132c0,%eax
...
80102d30:	a1 c0 32 11 80       	mov    0x801132c0,%eax
...
80102d3f:	83 ec 08             	sub    $0x8,%esp
  if(!lapic) 
80102d42:	a1 c0 32 11 80       	mov    0x801132c0,%eax
...
80102dc7:	a1 c0 32 11 80       	mov    0x801132c0,%eax
...
80102e6a:	90                   	nop
80102e6b:	a1 c0 32 11 80       	mov    0x801132c0,%eax
...
80102eab:	74 29                	je     80102ed6 <cpunum+0x3d>
    static int n;
    if(n++ == 0)
80102ead:	a1 84 c6 10 80       	mov    0x8010c684,%eax
80102eb2:	85 c0                	test   %eax,%eax
80102eb4:	0f 94 c2             	sete   %dl
80102eb7:	83 c0 01             	add    $0x1,%eax
80102eba:	a3 84 c6 10 80       	mov    %eax,0x8010c684
...
80102eca:	c7 04 24 28 8e 10 80 	movl   $0x80108e28,(%esp)
80102ed1:	e8 cb d4 ff ff       	call   801003a1 <cprintf>
        __builtin_return_address(0));
  }

  if(lapic)
80102ed6:	a1 c0 32 11 80       	mov    0x801132c0,%eax
80102edb:	85 c0                	test   %eax,%eax
80102edd:	74 0f                	je     80102eee <cpunum+0x55>
    return lapic[ID]>>24;
80102edf:	a1 c0 32 11 80       	mov    0x801132c0,%eax
...
80102ef8:	83 ec 08             	sub    $0x8,%esp
  if(lapic)
80102efb:	a1 c0 32 11 80       	mov    0x801132c0,%eax
...
80103022:	c7 44 24 04 54 8e 10 	movl   $0x80108e54,0x4(%esp)
80103029:	80 
8010302a:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
80103031:	e8 08 11 00 00       	call   8010413e <initlock>
  readsb(ROOTDEV, &sb);
...
80103055:	a3 18 33 11 80       	mov    %eax,0x80113318
  log.size = sb.nlog;
8010305a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010305d:	a3 1c 33 11 80       	mov    %eax,0x8011331c
  log.dev = ROOTDEV;
80103062:	c7 05 28 33 11 80 01 	movl   $0x1,0x80113328
80103069:	00 00 00 
  recover_from_log();
...
801030ac:	8b 04 85 f0 32 11 80 	mov    -0x7feecd10(,%eax,4),%eax
801030b3:	89 c2                	mov    %eax,%edx
801030b5:	a1 28 33 11 80       	mov    0x80113328,%eax
...
8010310e:	a1 2c 33 11 80       	mov    0x8011332c,%eax
...
80103124:	a1 18 33 11 80       	mov    0x80113318,%eax
80103129:	89 c2                	mov    %eax,%edx
8010312b:	a1 28 33 11 80       	mov    0x80113328,%eax
...
8010314d:	a3 2c 33 11 80       	mov    %eax,0x8011332c
...
8010316b:	89 04 95 f0 32 11 80 	mov    %eax,-0x7feecd10(,%edx,4)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80103176:	a1 2c 33 11 80       	mov    0x8011332c,%eax
...
80103190:	83 ec 28             	sub    $0x28,%esp
  struct buf *buf = bread(log.dev, log.start);
80103193:	a1 18 33 11 80       	mov    0x80113318,%eax
80103198:	89 c2                	mov    %eax,%edx
8010319a:	a1 28 33 11 80       	mov    0x80113328,%eax
...
801031b4:	89 45 ec             	mov    %eax,-0x14(%ebp)
  int i;
  hb->n = log.lh.n;
801031b7:	8b 15 2c 33 11 80    	mov    0x8011332c,%edx
...
801031d1:	8b 0c 85 f0 32 11 80 	mov    -0x7feecd10(,%eax,4),%ecx
...
801031e6:	a1 2c 33 11 80       	mov    0x8011332c,%eax
...
80103213:	e8 5b fe ff ff       	call   80103073 <install_trans>
  log.lh.n = 0;
80103218:	c7 05 2c 33 11 80 00 	movl   $0x0,0x8011332c
8010321f:	00 00 00 
...
8010322c:	83 ec 18             	sub    $0x18,%esp
  acquire(&log.lock);
8010322f:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
80103236:	e8 24 0f 00 00       	call   8010415f <acquire>
  while(1){
    if(log.committing){
8010323b:	a1 24 33 11 80       	mov    0x80113324,%eax
80103240:	85 c0                	test   %eax,%eax
80103242:	74 16                	je     8010325a <begin_op+0x31>
      sleep(&log, &log.lock);
80103244:	c7 44 24 04 e0 32 11 	movl   $0x801132e0,0x4(%esp)
8010324b:	80 
8010324c:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
80103253:	e8 af 1a 00 00       	call   80104d07 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
8010325a:	8b 0d 2c 33 11 80    	mov    0x8011332c,%ecx
80103260:	a1 20 33 11 80       	mov    0x80113320,%eax
...
80103276:	7e 16                	jle    8010328e <begin_op+0x65>
      ...
      sleep(&log, &log.lock);
80103278:	c7 44 24 04 e0 32 11 	movl   $0x801132e0,0x4(%esp)
8010327f:	80 
80103280:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
80103287:	e8 7b 1a 00 00       	call   80104d07 <sleep>
    } else {
      log.outstanding += 1;
      release(&log.lock);
      break;
...
8010328c:	eb ad                	jmp    8010323b <begin_op+0x12>
      ...
      log.outstanding += 1;
8010328e:	a1 20 33 11 80       	mov    0x80113320,%eax
80103293:	83 c0 01             	add    $0x1,%eax
80103296:	a3 20 33 11 80       	mov    %eax,0x80113320
      release(&log.lock);
8010329b:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
801032a2:	e8 1a 0f 00 00       	call   801041c1 <release>
      break;
801032a7:	90                   	nop
    }
  }
...
801032b0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  ...
  acquire(&log.lock);
801032b7:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
801032be:	e8 9c 0e 00 00       	call   8010415f <acquire>
  log.outstanding -= 1;
801032c3:	a1 20 33 11 80       	mov    0x80113320,%eax
801032c8:	83 e8 01             	sub    $0x1,%eax
801032cb:	a3 20 33 11 80       	mov    %eax,0x80113320
  if(log.committing)
801032d0:	a1 24 33 11 80       	mov    0x80113324,%eax
801032d5:	85 c0                	test   %eax,%eax
801032d7:	74 0c                	je     801032e5 <end_op+0x3b>
    panic("log.committing");
801032d9:	c7 04 24 58 8e 10 80 	movl   $0x80108e58,(%esp)
801032e0:	e8 58 d2 ff ff       	call   8010053d <panic>
  if(log.outstanding == 0){
801032e5:	a1 20 33 11 80       	mov    0x80113320,%eax
801032ea:	85 c0                	test   %eax,%eax
801032ec:	75 13                	jne    80103301 <end_op+0x57>
    do_commit = 1;
801032ee:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
    log.committing = 1;
801032f5:	c7 05 24 33 11 80 01 	movl   $0x1,0x80113324
801032fc:	00 00 00 
801032ff:	eb 0c                	jmp    8010330d <end_op+0x63>
  } else {
    // begin_op() may be waiting for log space.
    wakeup(&log);
80103301:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
80103308:	e8 d6 1a 00 00       	call   80104de3 <wakeup>
  }
  release(&log.lock);
8010330d:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
80103314:	e8 a8 0e 00 00       	call   801041c1 <release>
...
8010331f:	e8 db 00 00 00       	call   801033ff <commit>
    acquire(&log.lock);
80103324:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
8010332b:	e8 2f 0e 00 00       	call   8010415f <acquire>
    log.committing = 0;
80103330:	c7 05 24 33 11 80 00 	movl   $0x0,0x80113324
80103337:	00 00 00 
    wakeup(&log);
8010333a:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
80103341:	e8 9d 1a 00 00       	call   80104de3 <wakeup>
    release(&log.lock);
80103346:	c7 04 24 e0 32 11 80 	movl   $0x801132e0,(%esp)
8010334d:	e8 6f 0e 00 00       	call   801041c1 <release>
  }
}
80103352:	c9                   	leave  
80103353:	c3                   	ret    
...
8010338d:	8b 04 85 f0 32 11 80 	mov    -0x7feecd10(,%eax,4),%eax
80103394:	89 c2                	mov    %eax,%edx
80103396:	a1 28 33 11 80       	mov    0x80113328,%eax
...
801033ef:	a1 2c 33 11 80       	mov    0x8011332c,%eax
...
80103402:	83 ec 08             	sub    $0x8,%esp
  if (log.lh.n > 0) {
80103405:	a1 2c 33 11 80       	mov    0x8011332c,%eax
...
80103418:	e8 56 fc ff ff       	call   80103073 <install_trans>
    log.lh.n = 0; 
8010341d:	c7 05 2c 33 11 80 00 	movl   $0x0,0x8011332c
80103424:	00 00 00 
...
80103480:	8b 04 85 f0 32 11 80 	mov    -0x7feecd10(,%eax,4),%eax
...
80103497:	a1 2c 33 11 80       	mov    0x8011332c,%eax
...
801034b0:	89 04 95 f0 32 11 80 	mov    %eax,-0x7feecd10(,%edx,4)
  if (i == log.lh.n)
801034b7:	a1 2c 33 11 80       	mov    0x8011332c,%eax
801034bc:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801034bf:	75 0d                	jne    801034ce <log_write+0xa0>
    log.lh.n++;
801034c1:	a1 2c 33 11 80       	mov    0x8011332c,%eax
801034c6:	83 c0 01             	add    $0x1,%eax
801034c9:	a3 2c 33 11 80       	mov    %eax,0x8011332c
...
80103560:	c7 04 24 98 8e 10 80 	movl   $0x80108e98,(%esp)
...
8010357b:	e8 0c 3c 00 00       	call   8010718c <uartinit>
  pinit();         // process table
80103580:	e8 fa 0d 00 00       	call   8010437f <pinit>
  tvinit();        // trap vectors
80103585:	e8 a5 37 00 00       	call   80106d2f <tvinit>
  binit();         // buffer cache
...
80103599:	e8 94 ef ff ff       	call   80102532 <ideinit>
  if(!ismp)
8010359e:	a1 c4 33 11 80       	mov    0x801133c4,%eax
801035a3:	85 c0                	test   %eax,%eax
801035a5:	75 05                	jne    801035ac <main+0x8d>
    timerinit();   // uniprocessor timer
801035a7:	e8 c6 36 00 00       	call   80106c72 <timerinit>
...
801035c5:	e8 d3 0e 00 00       	call   8010449d <userinit>
...
801035d2:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801035d5:	e8 db 4e 00 00       	call   801084b5 <switchkvm>
  seginit();
801035da:	e8 62 48 00 00       	call   80107e41 <seginit>
  lapicinit();
...
801035ff:	c7 04 24 af 8e 10 80 	movl   $0x80108eaf,(%esp)
80103606:	e8 96 cd ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
8010360b:	e8 93 38 00 00       	call   80106ea3 <idtinit>
...
8010362b:	e8 2b 15 00 00       	call   80104b5b <scheduler>
...
8010364f:	c7 44 24 04 4c c5 10 	movl   $0x8010c54c,0x4(%esp)
80103656:	80 
...
80103662:	c7 45 f4 e0 33 11 80 	movl   $0x801133e0,-0xc(%ebp)
...
80103679:	05 e0 33 11 80       	add    $0x801133e0,%eax
...
801036ae:	c7 04 24 00 b0 10 80 	movl   $0x8010b000,(%esp)
...
801036f4:	a1 c0 39 11 80       	mov    0x801139c0,%eax
801036f9:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801036ff:	05 e0 33 11 80       	add    $0x801133e0,%eax
...
8010376a:	89 e5                	mov    %esp,%ebp
  return bcpu-cpus;
8010376c:	a1 88 c6 10 80       	mov    0x8010c688,%eax
80103771:	89 c2                	mov    %eax,%edx
80103773:	b8 e0 33 11 80       	mov    $0x801133e0,%eax
...
801037eb:	00 
801037ec:	c7 44 24 04 c0 8e 10 	movl   $0x80108ec0,0x4(%esp)
801037f3:	80 
...
8010392c:	00 
8010392d:	c7 44 24 04 c5 8e 10 	movl   $0x80108ec5,0x4(%esp)
80103934:	80 
...
8010399c:	83 ec 38             	sub    $0x38,%esp
  ...
  bcpu = &cpus[0];
8010399f:	c7 05 88 c6 10 80 e0 	movl   $0x801133e0,0x8010c688
801039a6:	33 11 80 
...
801039bb:	0f 84 9c 01 00 00    	je     80103b5d <mpinit+0x1c4>
    return;
  ismp = 1;
801039c1:	c7 05 c4 33 11 80 01 	movl   $0x1,0x801133c4
801039c8:	00 00 00 
  lapic = (uint*)conf->lapicaddr;
801039cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801039ce:	8b 40 24             	mov    0x24(%eax),%eax
801039d1:	a3 c0 32 11 80       	mov    %eax,0x801132c0
...
80103a06:	8b 04 85 08 8f 10 80 	mov    -0x7fef70f8(,%eax,4),%eax
...
80103a1f:	a1 c0 39 11 80       	mov    0x801139c0,%eax
...
80103a32:	a1 c0 39 11 80       	mov    0x801139c0,%eax
80103a37:	89 54 24 08          	mov    %edx,0x8(%esp)
80103a3b:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a3f:	c7 04 24 ca 8e 10 80 	movl   $0x80108eca,(%esp)
80103a46:	e8 56 c9 ff ff       	call   801003a1 <cprintf>
        ismp = 0;
80103a4b:	c7 05 c4 33 11 80 00 	movl   $0x0,0x801133c4
80103a52:	00 00 00 
      }
...
80103a64:	74 15                	je     80103a7b <mpinit+0xe2>
        bcpu = &cpus[ncpu];
80103a66:	a1 c0 39 11 80       	mov    0x801139c0,%eax
80103a6b:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80103a71:	05 e0 33 11 80       	add    $0x801133e0,%eax
80103a76:	a3 88 c6 10 80       	mov    %eax,0x8010c688
      cpus[ncpu].id = ncpu;
80103a7b:	8b 15 c0 39 11 80    	mov    0x801139c0,%edx
80103a81:	a1 c0 39 11 80       	mov    0x801139c0,%eax
80103a86:	69 d2 bc 00 00 00    	imul   $0xbc,%edx,%edx
80103a8c:	81 c2 e0 33 11 80    	add    $0x801133e0,%edx
80103a92:	88 02                	mov    %al,(%edx)
      ncpu++;
80103a94:	a1 c0 39 11 80       	mov    0x801139c0,%eax
80103a99:	83 c0 01             	add    $0x1,%eax
80103a9c:	a3 c0 39 11 80       	mov    %eax,0x801139c0
...
80103ab4:	a2 c0 33 11 80       	mov    %al,0x801133c0
...
80103ad2:	c7 04 24 e8 8e 10 80 	movl   $0x80108ee8,(%esp)
80103ad9:	e8 c3 c8 ff ff       	call   801003a1 <cprintf>
      ismp = 0;
80103ade:	c7 05 c4 33 11 80 00 	movl   $0x0,0x801133c4
80103ae5:	00 00 00 
  bcpu = &cpus[0];
  if((conf = mpconfig(&mp)) == 0)
    return;
...
80103aee:	0f 82 00 ff ff ff    	jb     801039f4 <mpinit+0x5b>
  ...
  if(!ismp){
80103af4:	a1 c4 33 11 80       	mov    0x801133c4,%eax
80103af9:	85 c0                	test   %eax,%eax
80103afb:	75 1d                	jne    80103b1a <mpinit+0x181>
    // Didn't like what we found; fall back to no MP.
    ncpu = 1;
80103afd:	c7 05 c0 39 11 80 01 	movl   $0x1,0x801139c0
80103b04:	00 00 00 
    lapic = 0;
80103b07:	c7 05 c0 32 11 80 00 	movl   $0x0,0x801132c0
80103b0e:	00 00 00 
    ioapicid = 0;
80103b11:	c6 05 c0 33 11 80 00 	movb   $0x0,0x801133c0
    return;
...
80103b8f:	66 a3 00 c0 10 80    	mov    %ax,0x8010c000
  outb(IO_PIC1+1, mask);
...
80103be4:	0f b7 05 00 c0 10 80 	movzwl 0x8010c000,%eax
...
80103d17:	e8 44 fe ff ff       	call   80103b60 <outb>
  ...
  if(irqmask != 0xFFFF)
80103d1c:	0f b7 05 00 c0 10 80 	movzwl 0x8010c000,%eax
80103d23:	66 83 f8 ff          	cmp    $0xffff,%ax
80103d27:	74 12                	je     80103d3b <picinit+0x13d>
    picsetmask(irqmask);
80103d29:	0f b7 05 00 c0 10 80 	movzwl 0x8010c000,%eax
...
80103da3:	c7 80 40 02 00 00 01 	movl   $0x1,0x240(%eax)
80103daa:	00 00 00 
  p->writeopen = 1;
80103dad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103db0:	c7 80 44 02 00 00 01 	movl   $0x1,0x244(%eax)
80103db7:	00 00 00 
  p->nwrite = 0;
80103dba:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103dbd:	c7 80 3c 02 00 00 00 	movl   $0x0,0x23c(%eax)
80103dc4:	00 00 00 
  p->nread = 0;
80103dc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103dca:	c7 80 38 02 00 00 00 	movl   $0x0,0x238(%eax)
80103dd1:	00 00 00 
  initlock(&p->lock, "pipe");
80103dd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103dd7:	c7 44 24 04 1c 8f 10 	movl   $0x80108f1c,0x4(%esp)
80103dde:	80 
80103ddf:	89 04 24             	mov    %eax,(%esp)
80103de2:	e8 57 03 00 00       	call   8010413e <initlock>
  (*f0)->type = FD_PIPE;
...
80103ef6:	e8 c6 02 00 00       	call   801041c1 <release>
    kfree((char*)p);
...
80103f0e:	e8 ae 02 00 00       	call   801041c1 <release>
}
80103f13:	c9                   	leave  
80103f14:	c3                   	ret    
...
80103f22:	e8 38 02 00 00       	call   8010415f <acquire>
  for(i = 0; i < n; i++){
...
80103f53:	e8 69 02 00 00       	call   801041c1 <release>
        return -1;
...
80103f90:	8b 90 3c 02 00 00    	mov    0x23c(%eax),%edx
80103f96:	8b 45 08             	mov    0x8(%ebp),%eax
80103f99:	8b 80 38 02 00 00    	mov    0x238(%eax),%eax
...
80103fab:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
...
80103fc5:	88 4c 1a 38          	mov    %cl,0x38(%edx,%ebx,1)
80103fc9:	8d 50 01             	lea    0x1(%eax),%edx
80103fcc:	8b 45 08             	mov    0x8(%ebp),%eax
80103fcf:	89 90 3c 02 00 00    	mov    %edx,0x23c(%eax)
pipewrite(struct pipe *p, char *addr, int n)
{
  int i;
...
80103fe4:	05 38 02 00 00       	add    $0x238,%eax
80103fe9:	89 04 24             	mov    %eax,(%esp)
80103fec:	e8 f2 0d 00 00       	call   80104de3 <wakeup>
  release(&p->lock);
80103ff1:	8b 45 08             	mov    0x8(%ebp),%eax
80103ff4:	89 04 24             	mov    %eax,(%esp)
80103ff7:	e8 c5 01 00 00       	call   801041c1 <release>
  return n;
...
80104012:	e8 48 01 00 00       	call   8010415f <acquire>
...
8010402c:	e8 90 01 00 00       	call   801041c1 <release>
      return -1;
...
8010404e:	e8 b4 0c 00 00       	call   80104d07 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80104056:	8b 90 38 02 00 00    	mov    0x238(%eax),%edx
8010405c:	8b 45 08             	mov    0x8(%ebp),%eax
8010405f:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
80104065:	39 c2                	cmp    %eax,%edx
80104067:	75 0d                	jne    80104076 <piperead+0x71>
80104069:	8b 45 08             	mov    0x8(%ebp),%eax
8010406c:	8b 80 44 02 00 00    	mov    0x244(%eax),%eax
...
80104082:	8b 90 38 02 00 00    	mov    0x238(%eax),%edx
80104088:	8b 45 08             	mov    0x8(%ebp),%eax
8010408b:	8b 80 3c 02 00 00    	mov    0x23c(%eax),%eax
...
801040d6:	05 3c 02 00 00       	add    $0x23c,%eax
801040db:	89 04 24             	mov    %eax,(%esp)
801040de:	e8 00 0d 00 00       	call   80104de3 <wakeup>
  release(&p->lock);
801040e3:	8b 45 08             	mov    0x8(%ebp),%eax
801040e6:	89 04 24             	mov    %eax,(%esp)
801040e9:	e8 d3 00 00 00       	call   801041c1 <release>
  return i;
...
80104123:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80104126:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
8010412b:	89 d8                	mov    %ebx,%eax
8010412d:	f0 87 02             	lock xchg %eax,(%edx)
80104130:	89 c3                	mov    %eax,%ebx
80104132:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104135:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104144:	8b 55 0c             	mov    0xc(%ebp),%edx
80104147:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
8010414a:	8b 45 08             	mov    0x8(%ebp),%eax
8010414d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
...
80104165:	e8 3d 01 00 00       	call   801042a7 <pushcli>
  if(holding(lk))
8010416a:	8b 45 08             	mov    0x8(%ebp),%eax
8010416d:	89 04 24             	mov    %eax,(%esp)
80104170:	e8 08 01 00 00       	call   8010427d <holding>
80104175:	85 c0                	test   %eax,%eax
80104177:	74 0c                	je     80104185 <acquire+0x26>
    panic("acquire");
80104179:	c7 04 24 21 8f 10 80 	movl   $0x80108f21,(%esp)
80104180:	e8 b8 c3 ff ff       	call   8010053d <panic>
...
80104189:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104190:	00 
80104191:	89 04 24             	mov    %eax,(%esp)
80104194:	e8 80 ff ff ff       	call   80104119 <xchg>
80104199:	85 c0                	test   %eax,%eax
8010419b:	75 e9                	jne    80104186 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
8010419d:	8b 45 08             	mov    0x8(%ebp),%eax
801041a0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801041a7:	89 50 08             	mov    %edx,0x8(%eax)
...
801041ba:	e8 51 00 00 00       	call   80104210 <getcallerpcs>
}
801041bf:	c9                   	leave  
801041c0:	c3                   	ret    
...
801041c4:	83 ec 18             	sub    $0x18,%esp
  if(!holding(lk))
801041c7:	8b 45 08             	mov    0x8(%ebp),%eax
801041ca:	89 04 24             	mov    %eax,(%esp)
801041cd:	e8 ab 00 00 00       	call   8010427d <holding>
801041d2:	85 c0                	test   %eax,%eax
801041d4:	75 0c                	jne    801041e2 <release+0x21>
    panic("release");
801041d6:	c7 04 24 29 8f 10 80 	movl   $0x80108f29,(%esp)
801041dd:	e8 5b c3 ff ff       	call   8010053d <panic>
...
801041ef:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104204:	e8 10 ff ff ff       	call   80104119 <xchg>

  popcli();
80104209:	e8 e1 00 00 00       	call   801042ef <popcli>
}
8010420e:	c9                   	leave  
8010420f:	c3                   	ret    
...
80104219:	83 e8 08             	sub    $0x8,%eax
8010421c:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
8010421f:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104226:	eb 32                	jmp    8010425a <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104228:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
8010422c:	74 47                	je     80104275 <getcallerpcs+0x65>
8010422e:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104235:	76 3e                	jbe    80104275 <getcallerpcs+0x65>
80104237:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
8010423b:	74 38                	je     80104275 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
8010423d:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104240:	c1 e0 02             	shl    $0x2,%eax
80104243:	03 45 0c             	add    0xc(%ebp),%eax
80104246:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104249:	8b 52 04             	mov    0x4(%edx),%edx
8010424c:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
8010424e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104251:	8b 00                	mov    (%eax),%eax
80104253:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  uint *ebp;
  int i;
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104256:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010425a:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
8010425e:	7e c8                	jle    80104228 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104260:	eb 13                	jmp    80104275 <getcallerpcs+0x65>
    pcs[i] = 0;
80104262:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104265:	c1 e0 02             	shl    $0x2,%eax
80104268:	03 45 0c             	add    0xc(%ebp),%eax
8010426b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104271:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104275:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104279:	7e e7                	jle    80104262 <getcallerpcs+0x52>
    pcs[i] = 0;
}
8010427b:	c9                   	leave  
8010427c:	c3                   	ret    
...
80104287:	74 17                	je     801042a0 <holding+0x23>
80104289:	8b 45 08             	mov    0x8(%ebp),%eax
8010428c:	8b 50 08             	mov    0x8(%eax),%edx
8010428f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104295:	39 c2                	cmp    %eax,%edx
80104297:	75 07                	jne    801042a0 <holding+0x23>
80104299:	b8 01 00 00 00       	mov    $0x1,%eax
8010429e:	eb 05                	jmp    801042a5 <holding+0x28>
...
801042aa:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
801042ad:	e8 46 fe ff ff       	call   801040f8 <readeflags>
801042b2:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
801042b5:	e8 53 fe ff ff       	call   8010410d <cli>
  if(cpu->ncli++ == 0)
801042ba:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801042c0:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801042c6:	85 d2                	test   %edx,%edx
801042c8:	0f 94 c1             	sete   %cl
801042cb:	83 c2 01             	add    $0x1,%edx
801042ce:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801042d4:	84 c9                	test   %cl,%cl
801042d6:	74 15                	je     801042ed <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
801042d8:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801042de:	8b 55 fc             	mov    -0x4(%ebp),%edx
801042e1:	81 e2 00 02 00 00    	and    $0x200,%edx
801042e7:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801042ed:	c9                   	leave  
801042ee:	c3                   	ret    
...
801042f2:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
801042f5:	e8 fe fd ff ff       	call   801040f8 <readeflags>
801042fa:	25 00 02 00 00       	and    $0x200,%eax
801042ff:	85 c0                	test   %eax,%eax
80104301:	74 0c                	je     8010430f <popcli+0x20>
    panic("popcli - interruptible");
80104303:	c7 04 24 31 8f 10 80 	movl   $0x80108f31,(%esp)
8010430a:	e8 2e c2 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
8010430f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104315:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010431b:	83 ea 01             	sub    $0x1,%edx
8010431e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104324:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010432a:	85 c0                	test   %eax,%eax
8010432c:	79 0c                	jns    8010433a <popcli+0x4b>
    panic("popcli");
8010432e:	c7 04 24 48 8f 10 80 	movl   $0x80108f48,(%esp)
80104335:	e8 03 c2 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010433a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104340:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104346:	85 c0                	test   %eax,%eax
80104348:	75 15                	jne    8010435f <popcli+0x70>
8010434a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104350:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104356:	85 c0                	test   %eax,%eax
80104358:	74 05                	je     8010435f <popcli+0x70>
    sti();
8010435a:	e8 b4 fd ff ff       	call   80104113 <sti>
}
8010435f:	c9                   	leave  
80104360:	c3                   	ret    
80104361:	00 00                	add    %al,(%eax)
	...
...
8010436b:	9c                   	pushf  
8010436c:	5b                   	pop    %ebx
8010436d:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
80104370:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104385:	c7 44 24 04 4f 8f 10 	movl   $0x80108f4f,0x4(%esp)
8010438c:	80 
8010438d:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104394:	e8 a5 fd ff ff       	call   8010413e <initlock>
}
80104399:	c9                   	leave  
8010439a:	c3                   	ret    
...
8010439e:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;
  char *sp;

  acquire(&ptable.lock);
801043a1:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
801043a8:	e8 b2 fd ff ff       	call   8010415f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043ad:	c7 45 f4 18 3a 11 80 	movl   $0x80113a18,-0xc(%ebp)
801043b4:	eb 11                	jmp    801043c7 <allocproc+0x2c>
    if(p->state == UNUSED)
801043b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043b9:	8b 40 0c             	mov    0xc(%eax),%eax
801043bc:	85 c0                	test   %eax,%eax
801043be:	74 26                	je     801043e6 <allocproc+0x4b>
{
  struct proc *p;
  char *sp;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043c0:	81 45 f4 90 30 00 00 	addl   $0x3090,-0xc(%ebp)
801043c7:	81 7d f4 18 5e 1d 80 	cmpl   $0x801d5e18,-0xc(%ebp)
801043ce:	72 e6                	jb     801043b6 <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
801043d0:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
801043d7:	e8 e5 fd ff ff       	call   801041c1 <release>
  return 0;
801043dc:	b8 00 00 00 00       	mov    $0x0,%eax
801043e1:	e9 b5 00 00 00       	jmp    8010449b <allocproc+0x100>
  char *sp;
...
801043ea:	c7 40 0c 01 00 00 00 	movl   $0x1,0xc(%eax)
  p->pid = nextpid++;
801043f1:	a1 04 c0 10 80       	mov    0x8010c004,%eax
801043f6:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043f9:	89 42 10             	mov    %eax,0x10(%edx)
801043fc:	83 c0 01             	add    $0x1,%eax
801043ff:	a3 04 c0 10 80       	mov    %eax,0x8010c004
  release(&ptable.lock);
80104404:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
8010440b:	e8 b1 fd ff ff       	call   801041c1 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80104410:	e8 f6 e6 ff ff       	call   80102b0b <kalloc>
80104415:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104418:	89 42 08             	mov    %eax,0x8(%edx)
8010441b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010441e:	8b 40 08             	mov    0x8(%eax),%eax
80104421:	85 c0                	test   %eax,%eax
80104423:	75 11                	jne    80104436 <allocproc+0x9b>
    p->state = UNUSED;
80104425:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104428:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
8010442f:	b8 00 00 00 00       	mov    $0x0,%eax
80104434:	eb 65                	jmp    8010449b <allocproc+0x100>
  }
  sp = p->kstack + KSTACKSIZE;
80104436:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104439:	8b 40 08             	mov    0x8(%eax),%eax
8010443c:	05 00 10 00 00       	add    $0x1000,%eax
80104441:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80104444:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
80104448:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010444b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010444e:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
80104451:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
80104455:	ba e4 6c 10 80       	mov    $0x80106ce4,%edx
8010445a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010445d:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
8010445f:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
80104463:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104466:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104469:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
8010446c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010446f:	8b 40 1c             	mov    0x1c(%eax),%eax
80104472:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104479:	00 
8010447a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104481:	00 
80104482:	89 04 24             	mov    %eax,(%esp)
80104485:	e8 48 0b 00 00       	call   80104fd2 <memset>
  p->context->eip = (uint)forkret;
8010448a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010448d:	8b 40 1c             	mov    0x1c(%eax),%eax
80104490:	ba db 4c 10 80       	mov    $0x80104cdb,%edx
80104495:	89 50 10             	mov    %edx,0x10(%eax)
...
801044a0:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
801044a3:	e8 f3 fe ff ff       	call   8010439b <allocproc>
801044a8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
801044ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044ae:	a3 8c c6 10 80       	mov    %eax,0x8010c68c
  if((p->pgdir = setupkvm()) == 0)
801044b3:	e8 29 3f 00 00       	call   801083e1 <setupkvm>
...
801044c6:	75 0c                	jne    801044d4 <userinit+0x37>
    panic("userinit: out of memory?");
801044c8:	c7 04 24 56 8f 10 80 	movl   $0x80108f56,(%esp)
801044cf:	e8 69 c0 ff ff       	call   8010053d <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801044d4:	ba 2c 00 00 00       	mov    $0x2c,%edx
801044d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044dc:	8b 40 04             	mov    0x4(%eax),%eax
801044df:	89 54 24 08          	mov    %edx,0x8(%esp)
801044e3:	c7 44 24 04 20 c5 10 	movl   $0x8010c520,0x4(%esp)
801044ea:	80 
801044eb:	89 04 24             	mov    %eax,(%esp)
801044ee:	e8 46 41 00 00       	call   80108639 <inituvm>
  p->sz = PGSIZE;
801044f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044f6:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
801044fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044ff:	8b 40 18             	mov    0x18(%eax),%eax
80104502:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104509:	00 
8010450a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104511:	00 
80104512:	89 04 24             	mov    %eax,(%esp)
80104515:	e8 b8 0a 00 00       	call   80104fd2 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010451a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010451d:	8b 40 18             	mov    0x18(%eax),%eax
80104520:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80104526:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104529:	8b 40 18             	mov    0x18(%eax),%eax
8010452c:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
80104532:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104535:	8b 40 18             	mov    0x18(%eax),%eax
80104538:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010453b:	8b 52 18             	mov    0x18(%edx),%edx
8010453e:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
80104542:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
...
80104556:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010455a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010455d:	8b 40 18             	mov    0x18(%eax),%eax
80104560:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
...
8010457a:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
80104581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104584:	83 c0 6c             	add    $0x6c,%eax
80104587:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010458e:	00 
8010458f:	c7 44 24 04 6f 8f 10 	movl   $0x80108f6f,0x4(%esp)
80104596:	80 
80104597:	89 04 24             	mov    %eax,(%esp)
8010459a:	e8 63 0c 00 00       	call   80105202 <safestrcpy>
  p->cwd = namei("/");
8010459f:	c7 04 24 78 8f 10 80 	movl   $0x80108f78,(%esp)
801045a6:	e8 6b de ff ff       	call   80102416 <namei>
801045ab:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045ae:	89 42 68             	mov    %eax,0x68(%edx)
...
801045cb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
801045ce:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801045d2:	7e 34                	jle    80104608 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
801045d4:	8b 45 08             	mov    0x8(%ebp),%eax
801045d7:	89 c2                	mov    %eax,%edx
801045d9:	03 55 f4             	add    -0xc(%ebp),%edx
801045dc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045e2:	8b 40 04             	mov    0x4(%eax),%eax
801045e5:	89 54 24 08          	mov    %edx,0x8(%esp)
801045e9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801045ec:	89 54 24 04          	mov    %edx,0x4(%esp)
801045f0:	89 04 24             	mov    %eax,(%esp)
801045f3:	e8 bb 41 00 00       	call   801087b3 <allocuvm>
801045f8:	89 45 f4             	mov    %eax,-0xc(%ebp)
801045fb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801045ff:	75 41                	jne    80104642 <growproc+0x85>
      return -1;
80104601:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104606:	eb 58                	jmp    80104660 <growproc+0xa3>
  } else if(n < 0){
80104608:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010460c:	79 34                	jns    80104642 <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
8010460e:	8b 45 08             	mov    0x8(%ebp),%eax
80104611:	89 c2                	mov    %eax,%edx
80104613:	03 55 f4             	add    -0xc(%ebp),%edx
80104616:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010461c:	8b 40 04             	mov    0x4(%eax),%eax
8010461f:	89 54 24 08          	mov    %edx,0x8(%esp)
80104623:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104626:	89 54 24 04          	mov    %edx,0x4(%esp)
8010462a:	89 04 24             	mov    %eax,(%esp)
8010462d:	e8 5b 42 00 00       	call   8010888d <deallocuvm>
80104632:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104635:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104639:	75 07                	jne    80104642 <growproc+0x85>
      return -1;
8010463b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104640:	eb 1e                	jmp    80104660 <growproc+0xa3>
  }
  proc->sz = sz;
...
80104656:	e8 77 3e 00 00       	call   801084d2 <switchuvm>
  return 0;
...
80104668:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
8010466b:	e8 2b fd ff ff       	call   8010439b <allocproc>
80104670:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104673:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104677:	75 0a                	jne    80104683 <fork+0x21>
    return -1;
80104679:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010467e:	e9 3c 02 00 00       	jmp    801048bf <fork+0x25d>

  if(proc->ctflag){
80104683:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104689:	8b 40 7c             	mov    0x7c(%eax),%eax
8010468c:	85 c0                	test   %eax,%eax
8010468e:	74 1e                	je     801046ae <fork+0x4c>

  	np->pgdir = proc->pgdir;
80104690:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104696:	8b 50 04             	mov    0x4(%eax),%edx
80104699:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010469c:	89 50 04             	mov    %edx,0x4(%eax)
    	np->type = 1;
8010469f:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046a2:	c7 80 80 00 00 00 01 	movl   $0x1,0x80(%eax)
801046a9:	00 00 00 
801046ac:	eb 66                	jmp    80104714 <fork+0xb2>
...
801046c6:	e8 52 43 00 00       	call   80108a1d <copyuvm>
...
801046d9:	75 2c                	jne    80104707 <fork+0xa5>
      		kfree(np->kstack);
801046db:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046de:	8b 40 08             	mov    0x8(%eax),%eax
801046e1:	89 04 24             	mov    %eax,(%esp)
801046e4:	e8 89 e3 ff ff       	call   80102a72 <kfree>
      		np->kstack = 0;
801046e9:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046ec:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
      		np->state = UNUSED;
801046f3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801046f6:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
      		return -1;
801046fd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104702:	e9 b8 01 00 00       	jmp    801048bf <fork+0x25d>
    	}

    	np->type = 0;
80104707:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010470a:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80104711:	00 00 00 
...
80104727:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
8010472d:	85 c0                	test   %eax,%eax
8010472f:	74 1e                	je     8010474f <fork+0xed>
80104731:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104737:	8b 40 7c             	mov    0x7c(%eax),%eax
8010473a:	85 c0                	test   %eax,%eax
8010473c:	74 11                	je     8010474f <fork+0xed>
    np->parent = proc->parent;
8010473e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104744:	8b 50 14             	mov    0x14(%eax),%edx
80104747:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010474a:	89 50 14             	mov    %edx,0x14(%eax)
8010474d:	eb 0d                	jmp    8010475c <fork+0xfa>
  else
    np->parent = proc;
8010474f:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104756:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104759:	89 50 14             	mov    %edx,0x14(%eax)

  *np->tf = *proc->tf;
8010475c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010475f:	8b 50 18             	mov    0x18(%eax),%edx
80104762:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104768:	8b 40 18             	mov    0x18(%eax),%eax
8010476b:	89 c3                	mov    %eax,%ebx
8010476d:	b8 13 00 00 00       	mov    $0x13,%eax
80104772:	89 d7                	mov    %edx,%edi
80104774:	89 de                	mov    %ebx,%esi
80104776:	89 c1                	mov    %eax,%ecx
80104778:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

if(proc->ctflag){
8010477a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104780:	8b 40 7c             	mov    0x7c(%eax),%eax
80104783:	85 c0                	test   %eax,%eax
80104785:	74 77                	je     801047fe <fork+0x19c>

  np->tf->eip = wrapperaddr;
80104787:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010478a:	8b 40 18             	mov    0x18(%eax),%eax
8010478d:	8b 55 0c             	mov    0xc(%ebp),%edx
80104790:	89 50 38             	mov    %edx,0x38(%eax)

  proc->ustack = ustack;
80104793:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104799:	8b 55 08             	mov    0x8(%ebp),%edx
8010479c:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)

  uint *sp = (uint*)proc->ustack;
801047a2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047a8:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801047ae:	89 45 dc             	mov    %eax,-0x24(%ebp)

  *(--sp) = arg2;
801047b1:	83 6d dc 04          	subl   $0x4,-0x24(%ebp)
801047b5:	8b 45 dc             	mov    -0x24(%ebp),%eax
801047b8:	8b 55 14             	mov    0x14(%ebp),%edx
801047bb:	89 10                	mov    %edx,(%eax)
  *(--sp) = arg1;
801047bd:	83 6d dc 04          	subl   $0x4,-0x24(%ebp)
801047c1:	8b 45 dc             	mov    -0x24(%ebp),%eax
801047c4:	8b 55 10             	mov    0x10(%ebp),%edx
801047c7:	89 10                	mov    %edx,(%eax)
  *(--sp) = 0;
801047c9:	83 6d dc 04          	subl   $0x4,-0x24(%ebp)
801047cd:	8b 45 dc             	mov    -0x24(%ebp),%eax
801047d0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)

  np->tf->esp = (uint)sp;
801047d6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047d9:	8b 40 18             	mov    0x18(%eax),%eax
801047dc:	8b 55 dc             	mov    -0x24(%ebp),%edx
801047df:	89 50 44             	mov    %edx,0x44(%eax)
  proc->tcount+=1;
801047e2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047e8:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801047ef:	8b 92 8c 00 00 00    	mov    0x8c(%edx),%edx
801047f5:	83 c2 01             	add    $0x1,%edx
801047f8:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
}
...
80104812:	eb 3d                	jmp    80104851 <fork+0x1ef>
    if(proc->ofile[i])
...
80104826:	74 25                	je     8010484d <fork+0x1eb>
...
80104838:	89 04 24             	mov    %eax,(%esp)
8010483b:	e8 48 c7 ff ff       	call   80100f88 <filedup>
80104840:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104843:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104846:	83 c1 08             	add    $0x8,%ecx
80104849:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
}
  ...
  for(i = 0; i < NOFILE; i++)
8010484d:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104851:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104855:	7e bd                	jle    80104814 <fork+0x1b2>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
80104863:	e8 da cf ff ff       	call   80101842 <idup>
80104868:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010486b:	89 42 68             	mov    %eax,0x68(%edx)
...
8010487d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104884:	00 
80104885:	89 54 24 04          	mov    %edx,0x4(%esp)
80104889:	89 04 24             	mov    %eax,(%esp)
8010488c:	e8 71 09 00 00       	call   80105202 <safestrcpy>
 
  pid = np->pid;
80104891:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104894:	8b 40 10             	mov    0x10(%eax),%eax
80104897:	89 45 d8             	mov    %eax,-0x28(%ebp)

  // lock to force the compiler to emit the np->state write last.
  acquire(&ptable.lock);
8010489a:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
801048a1:	e8 b9 f8 ff ff       	call   8010415f <acquire>
  np->state = RUNNABLE;
801048a6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801048a9:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  release(&ptable.lock);
801048b0:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
801048b7:	e8 05 f9 ff ff       	call   801041c1 <release>

  return pid;
801048bc:	8b 45 d8             	mov    -0x28(%ebp),%eax

}
801048bf:	83 c4 2c             	add    $0x2c,%esp
801048c2:	5b                   	pop    %ebx
801048c3:	5e                   	pop    %esi
801048c4:	5f                   	pop    %edi
801048c5:	5d                   	pop    %ebp
...
80104931:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104932:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104936:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
8010493a:	7e b6                	jle    801048f2 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
8010493c:	e8 e8 e8 ff ff       	call   80103229 <begin_op>
  iput(proc->cwd);
80104941:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104947:	8b 40 68             	mov    0x68(%eax),%eax
8010494a:	89 04 24             	mov    %eax,(%esp)
8010494d:	e8 d5 d0 ff ff       	call   80101a27 <iput>
  end_op();
80104952:	e8 53 e9 ff ff       	call   801032aa <end_op>
  proc->cwd = 0;
80104957:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010495d:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104964:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
8010496b:	e8 ef f7 ff ff       	call   8010415f <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104970:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104976:	8b 40 14             	mov    0x14(%eax),%eax
80104979:	89 04 24             	mov    %eax,(%esp)
8010497c:	e8 21 04 00 00       	call   80104da2 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104981:	c7 45 f4 18 3a 11 80 	movl   $0x80113a18,-0xc(%ebp)
80104988:	eb 3b                	jmp    801049c5 <exit+0xfe>
    if(p->parent == proc){
8010498a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010498d:	8b 50 14             	mov    0x14(%eax),%edx
80104990:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104996:	39 c2                	cmp    %eax,%edx
80104998:	75 24                	jne    801049be <exit+0xf7>
      p->parent = initproc;
8010499a:	8b 15 8c c6 10 80    	mov    0x8010c68c,%edx
801049a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049a3:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
801049a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049a9:	8b 40 0c             	mov    0xc(%eax),%eax
801049ac:	83 f8 05             	cmp    $0x5,%eax
801049af:	75 0d                	jne    801049be <exit+0xf7>
        wakeup1(initproc);
801049b1:	a1 8c c6 10 80       	mov    0x8010c68c,%eax
801049b6:	89 04 24             	mov    %eax,(%esp)
801049b9:	e8 e4 03 00 00       	call   80104da2 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049be:	81 45 f4 90 30 00 00 	addl   $0x3090,-0xc(%ebp)
801049c5:	81 7d f4 18 5e 1d 80 	cmpl   $0x801d5e18,-0xc(%ebp)
801049cc:	72 bc                	jb     8010498a <exit+0xc3>
        wakeup1(initproc);
    }
  }
...
801049d4:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
801049db:	e8 17 02 00 00       	call   80104bf7 <sched>
  panic("zombie exit");
801049e0:	c7 04 24 87 8f 10 80 	movl   $0x80108f87,(%esp)
801049e7:	e8 51 bb ff ff       	call   8010053d <panic>
...
801049ef:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
801049f2:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
801049f9:	e8 61 f7 ff ff       	call   8010415f <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
801049fe:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a05:	c7 45 f4 18 3a 11 80 	movl   $0x80113a18,-0xc(%ebp)
80104a0c:	e9 fa 00 00 00       	jmp    80104b0b <wait+0x11f>
      if(p->parent != proc)
...
80104a4a:	0f 85 b4 00 00 00    	jne    80104b04 <wait+0x118>
        // Found one.
        pid = p->pid;
80104a50:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a53:	8b 40 10             	mov    0x10(%eax),%eax
80104a56:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
80104a59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a5c:	8b 40 08             	mov    0x8(%eax),%eax
80104a5f:	89 04 24             	mov    %eax,(%esp)
80104a62:	e8 0b e0 ff ff       	call   80102a72 <kfree>
        p->kstack = 0;
80104a67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a6a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)

	if(!p->type && (p->tcount == 0))
80104a71:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a74:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104a7a:	85 c0                	test   %eax,%eax
80104a7c:	75 1d                	jne    80104a9b <wait+0xaf>
80104a7e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a81:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80104a87:	85 c0                	test   %eax,%eax
80104a89:	75 10                	jne    80104a9b <wait+0xaf>
           freevm(p->pgdir);
80104a8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a8e:	8b 40 04             	mov    0x4(%eax),%eax
80104a91:	89 04 24             	mov    %eax,(%esp)
80104a94:	e8 b0 3e 00 00       	call   80108949 <freevm>
80104a99:	eb 25                	jmp    80104ac0 <wait+0xd4>
	else {
	   p->pgdir = 0;
80104a9b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a9e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	   p->parent->tcount-=1;
80104aa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aa8:	8b 40 14             	mov    0x14(%eax),%eax
80104aab:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104aae:	8b 52 14             	mov    0x14(%edx),%edx
80104ab1:	8b 92 8c 00 00 00    	mov    0x8c(%edx),%edx
80104ab7:	83 ea 01             	sub    $0x1,%edx
80104aba:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
	}
...
80104ae8:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104aef:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104af6:	e8 c6 f6 ff ff       	call   801041c1 <release>
        return pid;
80104afb:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104afe:	eb 59                	jmp    80104b59 <wait+0x16d>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      if(p->parent != proc)
        continue;
80104b00:	90                   	nop
80104b01:	eb 01                	jmp    80104b04 <wait+0x118>
...
80104b03:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b04:	81 45 f4 90 30 00 00 	addl   $0x3090,-0xc(%ebp)
80104b0b:	81 7d f4 18 5e 1d 80 	cmpl   $0x801d5e18,-0xc(%ebp)
80104b12:	0f 82 f9 fe ff ff    	jb     80104a11 <wait+0x25>
        return pid;
      }
    }
...
80104b18:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104b1c:	74 0d                	je     80104b2b <wait+0x13f>
80104b1e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b24:	8b 40 24             	mov    0x24(%eax),%eax
80104b27:	85 c0                	test   %eax,%eax
80104b29:	74 13                	je     80104b3e <wait+0x152>
      release(&ptable.lock);
80104b2b:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104b32:	e8 8a f6 ff ff       	call   801041c1 <release>
      return -1;
80104b37:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b3c:	eb 1b                	jmp    80104b59 <wait+0x16d>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104b3e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b44:	c7 44 24 04 e0 39 11 	movl   $0x801139e0,0x4(%esp)
80104b4b:	80 
80104b4c:	89 04 24             	mov    %eax,(%esp)
80104b4f:	e8 b3 01 00 00       	call   80104d07 <sleep>
  }
80104b54:	e9 a5 fe ff ff       	jmp    801049fe <wait+0x12>
}
80104b59:	c9                   	leave  
80104b5a:	c3                   	ret    
...
80104b5e:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104b61:	e8 13 f8 ff ff       	call   80104379 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104b66:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104b6d:	e8 ed f5 ff ff       	call   8010415f <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b72:	c7 45 f4 18 3a 11 80 	movl   $0x80113a18,-0xc(%ebp)
80104b79:	eb 62                	jmp    80104bdd <scheduler+0x82>
      if(p->state != RUNNABLE)
80104b7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b7e:	8b 40 0c             	mov    0xc(%eax),%eax
80104b81:	83 f8 03             	cmp    $0x3,%eax
80104b84:	75 4f                	jne    80104bd5 <scheduler+0x7a>
        continue;
...
80104b95:	e8 38 39 00 00       	call   801084d2 <switchuvm>
      p->state = RUNNING;
...
80104bbe:	e8 b5 06 00 00       	call   80105278 <swtch>
      switchkvm();
80104bc3:	e8 ed 38 00 00       	call   801084b5 <switchkvm>
...
80104bd3:	eb 01                	jmp    80104bd6 <scheduler+0x7b>
...
80104bd5:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bd6:	81 45 f4 90 30 00 00 	addl   $0x3090,-0xc(%ebp)
80104bdd:	81 7d f4 18 5e 1d 80 	cmpl   $0x801d5e18,-0xc(%ebp)
80104be4:	72 95                	jb     80104b7b <scheduler+0x20>
    ...
    release(&ptable.lock);
80104be6:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104bed:	e8 cf f5 ff ff       	call   801041c1 <release>

  }
80104bf2:	e9 6a ff ff ff       	jmp    80104b61 <scheduler+0x6>
...
80104bfd:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104c04:	e8 74 f6 ff ff       	call   8010427d <holding>
80104c09:	85 c0                	test   %eax,%eax
80104c0b:	75 0c                	jne    80104c19 <sched+0x22>
    panic("sched ptable.lock");
80104c0d:	c7 04 24 93 8f 10 80 	movl   $0x80108f93,(%esp)
80104c14:	e8 24 b9 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80104c19:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c1f:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104c25:	83 f8 01             	cmp    $0x1,%eax
80104c28:	74 0c                	je     80104c36 <sched+0x3f>
    panic("sched locks");
80104c2a:	c7 04 24 a5 8f 10 80 	movl   $0x80108fa5,(%esp)
...
80104c3f:	83 f8 04             	cmp    $0x4,%eax
80104c42:	75 0c                	jne    80104c50 <sched+0x59>
    panic("sched running");
80104c44:	c7 04 24 b1 8f 10 80 	movl   $0x80108fb1,(%esp)
80104c4b:	e8 ed b8 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104c50:	e8 0f f7 ff ff       	call   80104364 <readeflags>
80104c55:	25 00 02 00 00       	and    $0x200,%eax
80104c5a:	85 c0                	test   %eax,%eax
80104c5c:	74 0c                	je     80104c6a <sched+0x73>
    panic("sched interruptible");
80104c5e:	c7 04 24 bf 8f 10 80 	movl   $0x80108fbf,(%esp)
80104c65:	e8 d3 b8 ff ff       	call   8010053d <panic>
  intena = cpu->intena;
80104c6a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c70:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104c76:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104c79:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c7f:	8b 40 04             	mov    0x4(%eax),%eax
80104c82:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104c89:	83 c2 1c             	add    $0x1c,%edx
80104c8c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c90:	89 14 24             	mov    %edx,(%esp)
80104c93:	e8 e0 05 00 00       	call   80105278 <swtch>
  cpu->intena = intena;
80104c98:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c9e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ca1:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104ca7:	c9                   	leave  
80104ca8:	c3                   	ret    
...
80104caf:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104cb6:	e8 a4 f4 ff ff       	call   8010415f <acquire>
  proc->state = RUNNABLE;
80104cbb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cc1:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104cc8:	e8 2a ff ff ff       	call   80104bf7 <sched>
  release(&ptable.lock);
80104ccd:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104cd4:	e8 e8 f4 ff ff       	call   801041c1 <release>
}
80104cd9:	c9                   	leave  
80104cda:	c3                   	ret    
...
80104cde:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104ce1:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104ce8:	e8 d4 f4 ff ff       	call   801041c1 <release>

  if (first) {
80104ced:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80104cf2:	85 c0                	test   %eax,%eax
80104cf4:	74 0f                	je     80104d05 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104cf6:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80104cfd:	00 00 00 
    initlog();
80104d00:	e8 17 e3 ff ff       	call   8010301c <initlog>
  }
...
80104d15:	75 0c                	jne    80104d23 <sleep+0x1c>
    panic("sleep");
80104d17:	c7 04 24 d3 8f 10 80 	movl   $0x80108fd3,(%esp)
80104d1e:	e8 1a b8 ff ff       	call   8010053d <panic>

  if(lk == 0)
80104d23:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104d27:	75 0c                	jne    80104d35 <sleep+0x2e>
    panic("sleep without lk");
80104d29:	c7 04 24 d9 8f 10 80 	movl   $0x80108fd9,(%esp)
...
80104d35:	81 7d 0c e0 39 11 80 	cmpl   $0x801139e0,0xc(%ebp)
80104d3c:	74 17                	je     80104d55 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104d3e:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104d45:	e8 15 f4 ff ff       	call   8010415f <acquire>
    release(lk);
80104d4a:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d4d:	89 04 24             	mov    %eax,(%esp)
80104d50:	e8 6c f4 ff ff       	call   801041c1 <release>
  }
...
80104d5e:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104d61:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d67:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104d6e:	e8 84 fe ff ff       	call   80104bf7 <sched>

  // Tidy up.
  proc->chan = 0;
80104d73:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d79:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104d80:	81 7d 0c e0 39 11 80 	cmpl   $0x801139e0,0xc(%ebp)
80104d87:	74 17                	je     80104da0 <sleep+0x99>
    release(&ptable.lock);
80104d89:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104d90:	e8 2c f4 ff ff       	call   801041c1 <release>
    acquire(lk);
80104d95:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d98:	89 04 24             	mov    %eax,(%esp)
80104d9b:	e8 bf f3 ff ff       	call   8010415f <acquire>
  }
}
80104da0:	c9                   	leave  
80104da1:	c3                   	ret    
...
80104da5:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104da8:	c7 45 fc 18 3a 11 80 	movl   $0x80113a18,-0x4(%ebp)
80104daf:	eb 27                	jmp    80104dd8 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104db1:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104db4:	8b 40 0c             	mov    0xc(%eax),%eax
80104db7:	83 f8 02             	cmp    $0x2,%eax
80104dba:	75 15                	jne    80104dd1 <wakeup1+0x2f>
80104dbc:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104dbf:	8b 40 20             	mov    0x20(%eax),%eax
80104dc2:	3b 45 08             	cmp    0x8(%ebp),%eax
80104dc5:	75 0a                	jne    80104dd1 <wakeup1+0x2f>
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104dd1:	81 45 fc 90 30 00 00 	addl   $0x3090,-0x4(%ebp)
80104dd8:	81 7d fc 18 5e 1d 80 	cmpl   $0x801d5e18,-0x4(%ebp)
80104ddf:	72 d0                	jb     80104db1 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104de1:	c9                   	leave  
...
80104de6:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104de9:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104df0:	e8 6a f3 ff ff       	call   8010415f <acquire>
  wakeup1(chan);
80104df5:	8b 45 08             	mov    0x8(%ebp),%eax
80104df8:	89 04 24             	mov    %eax,(%esp)
80104dfb:	e8 a2 ff ff ff       	call   80104da2 <wakeup1>
  release(&ptable.lock);
80104e00:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104e07:	e8 b5 f3 ff ff       	call   801041c1 <release>
}
80104e0c:	c9                   	leave  
80104e0d:	c3                   	ret    
...
80104e11:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80104e14:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104e1b:	e8 3f f3 ff ff       	call   8010415f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e20:	c7 45 f4 18 3a 11 80 	movl   $0x80113a18,-0xc(%ebp)
80104e27:	eb 44                	jmp    80104e6d <kill+0x5f>
    if(p->pid == pid){
80104e29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e2c:	8b 40 10             	mov    0x10(%eax),%eax
80104e2f:	3b 45 08             	cmp    0x8(%ebp),%eax
80104e32:	75 32                	jne    80104e66 <kill+0x58>
      p->killed = 1;
80104e34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e37:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104e3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e41:	8b 40 0c             	mov    0xc(%eax),%eax
80104e44:	83 f8 02             	cmp    $0x2,%eax
80104e47:	75 0a                	jne    80104e53 <kill+0x45>
        p->state = RUNNABLE;
80104e49:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e4c:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104e53:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104e5a:	e8 62 f3 ff ff       	call   801041c1 <release>
      return 0;
80104e5f:	b8 00 00 00 00       	mov    $0x0,%eax
80104e64:	eb 21                	jmp    80104e87 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e66:	81 45 f4 90 30 00 00 	addl   $0x3090,-0xc(%ebp)
80104e6d:	81 7d f4 18 5e 1d 80 	cmpl   $0x801d5e18,-0xc(%ebp)
80104e74:	72 b3                	jb     80104e29 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104e76:	c7 04 24 e0 39 11 80 	movl   $0x801139e0,(%esp)
80104e7d:	e8 3f f3 ff ff       	call   801041c1 <release>
  return -1;
...
80104e8c:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e8f:	c7 45 f0 18 3a 11 80 	movl   $0x80113a18,-0x10(%ebp)
80104e96:	e9 db 00 00 00       	jmp    80104f76 <procdump+0xed>
    if(p->state == UNUSED)
80104e9b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104e9e:	8b 40 0c             	mov    0xc(%eax),%eax
80104ea1:	85 c0                	test   %eax,%eax
80104ea3:	0f 84 c5 00 00 00    	je     80104f6e <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104ea9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104eac:	8b 40 0c             	mov    0xc(%eax),%eax
80104eaf:	83 f8 05             	cmp    $0x5,%eax
80104eb2:	77 23                	ja     80104ed7 <procdump+0x4e>
80104eb4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104eb7:	8b 40 0c             	mov    0xc(%eax),%eax
80104eba:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104ec1:	85 c0                	test   %eax,%eax
80104ec3:	74 12                	je     80104ed7 <procdump+0x4e>
      state = states[p->state];
80104ec5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ec8:	8b 40 0c             	mov    0xc(%eax),%eax
80104ecb:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104ed2:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104ed5:	eb 07                	jmp    80104ede <procdump+0x55>
    else
      state = "???";
80104ed7:	c7 45 ec ea 8f 10 80 	movl   $0x80108fea,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104ede:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ee1:	8d 50 6c             	lea    0x6c(%eax),%edx
80104ee4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ee7:	8b 40 10             	mov    0x10(%eax),%eax
80104eea:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104eee:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104ef1:	89 54 24 08          	mov    %edx,0x8(%esp)
80104ef5:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ef9:	c7 04 24 ee 8f 10 80 	movl   $0x80108fee,(%esp)
80104f00:	e8 9c b4 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104f05:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f08:	8b 40 0c             	mov    0xc(%eax),%eax
80104f0b:	83 f8 02             	cmp    $0x2,%eax
80104f0e:	75 50                	jne    80104f60 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104f10:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f13:	8b 40 1c             	mov    0x1c(%eax),%eax
80104f16:	8b 40 0c             	mov    0xc(%eax),%eax
80104f19:	83 c0 08             	add    $0x8,%eax
80104f1c:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104f1f:	89 54 24 04          	mov    %edx,0x4(%esp)
80104f23:	89 04 24             	mov    %eax,(%esp)
80104f26:	e8 e5 f2 ff ff       	call   80104210 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104f2b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104f32:	eb 1b                	jmp    80104f4f <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104f34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f37:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f3b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f3f:	c7 04 24 f7 8f 10 80 	movl   $0x80108ff7,(%esp)
80104f46:	e8 56 b4 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104f4b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104f4f:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104f53:	7f 0b                	jg     80104f60 <procdump+0xd7>
80104f55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f58:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104f5c:	85 c0                	test   %eax,%eax
80104f5e:	75 d4                	jne    80104f34 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104f60:	c7 04 24 fb 8f 10 80 	movl   $0x80108ffb,(%esp)
80104f67:	e8 35 b4 ff ff       	call   801003a1 <cprintf>
80104f6c:	eb 01                	jmp    80104f6f <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104f6e:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f6f:	81 45 f0 90 30 00 00 	addl   $0x3090,-0x10(%ebp)
80104f76:	81 7d f0 18 5e 1d 80 	cmpl   $0x801d5e18,-0x10(%ebp)
80104f7d:	0f 82 18 ff ff ff    	jb     80104e9b <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80105414:	83 f8 21             	cmp    $0x21,%eax
80105417:	77 28                	ja     80105441 <syscall+0x4c>
80105419:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010541c:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
...
80105433:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
...
80105462:	c7 04 24 27 90 10 80 	movl   $0x80109027,(%esp)
...
801058fa:	c7 04 24 43 90 10 80 	movl   $0x80109043,(%esp)
...
80105994:	c7 44 24 04 55 90 10 	movl   $0x80109055,0x4(%esp)
8010599b:	80 
...
801059af:	c7 44 24 04 57 90 10 	movl   $0x80109057,0x4(%esp)
801059b6:	80 
...
80105a07:	c7 04 24 5a 90 10 80 	movl   $0x8010905a,(%esp)
...
80105a7e:	74 0c                	je     80105a8c <sys_unlink+0x159>
    panic("unlink: writei");
80105a80:	c7 04 24 6c 90 10 80 	movl   $0x8010906c,(%esp)
...
80105bdb:	75 0c                	jne    80105be9 <create+0xde>
    panic("create: ialloc");
80105bdd:	c7 04 24 7b 90 10 80 	movl   $0x8010907b,(%esp)
...
80105c4b:	c7 44 24 04 55 90 10 	movl   $0x80109055,0x4(%esp)
80105c52:	80 
...
80105c6c:	c7 44 24 04 57 90 10 	movl   $0x80109057,0x4(%esp)
80105c73:	80 
...
80105c81:	79 0c                	jns    80105c8f <create+0x184>
      panic("create dots");
80105c83:	c7 04 24 8a 90 10 80 	movl   $0x8010908a,(%esp)
...
80105caf:	c7 04 24 96 90 10 80 	movl   $0x80109096,(%esp)
...
80106236:	e8 27 e4 ff ff       	call   80104662 <fork>
}
8010623b:	c9                   	leave  
8010623c:	c3                   	ret    
...
80106240:	83 ec 08             	sub    $0x8,%esp
  exit();
80106243:	e8 7f e6 ff ff       	call   801048c7 <exit>
...
8010625c:	e8 8b e7 ff ff       	call   801049ec <wait>
}
80106261:	c9                   	leave  
80106262:	c3                   	ret    
...
8010628d:	e8 7c eb ff ff       	call   80104e0e <kill>
}
80106292:	c9                   	leave  
80106293:	c3                   	ret    
...
801062d7:	e8 e1 e2 ff ff       	call   801045bd <growproc>
...
8010630e:	eb 6c                	jmp    8010637c <sys_sleep+0x90>
  acquire(&tickslock);
80106310:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
80106317:	e8 43 de ff ff       	call   8010415f <acquire>
  ticks0 = ticks;
8010631c:	a1 60 66 1d 80       	mov    0x801d6660,%eax
...
80106331:	74 13                	je     80106346 <sys_sleep+0x5a>
      release(&tickslock);
80106333:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
8010633a:	e8 82 de ff ff       	call   801041c1 <release>
      return -1;
8010633f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106344:	eb 36                	jmp    8010637c <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106346:	c7 44 24 04 20 5e 1d 	movl   $0x801d5e20,0x4(%esp)
8010634d:	80 
8010634e:	c7 04 24 60 66 1d 80 	movl   $0x801d6660,(%esp)
80106355:	e8 ad e9 ff ff       	call   80104d07 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010635a:	a1 60 66 1d 80       	mov    0x801d6660,%eax
...
80106369:	72 bb                	jb     80106326 <sys_sleep+0x3a>
  ...
  release(&tickslock);
8010636b:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
80106372:	e8 4a de ff ff       	call   801041c1 <release>
  return 0;
...
80106381:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106384:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
8010638b:	e8 cf dd ff ff       	call   8010415f <acquire>
  xticks = ticks;
80106390:	a1 60 66 1d 80       	mov    0x801d6660,%eax
80106395:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106398:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
8010639f:	e8 1d de ff ff       	call   801041c1 <release>
  return xticks;
...
8010646b:	e8 f2 e1 ff ff       	call   80104662 <fork>
}
...
8010649c:	e8 4b e5 ff ff       	call   801049ec <wait>

}
801064a1:	c9                   	leave  
801064a2:	c3                   	ret    

801064a3 <sys_kthread_mutex_init>:

int sys_kthread_mutex_init(void){
801064a3:	55                   	push   %ebp
801064a4:	89 e5                	mov    %esp,%ebp
801064a6:	53                   	push   %ebx
801064a7:	83 ec 24             	sub    $0x24,%esp

	int i;

	for(i=0;i<NMUTX;i++){
801064aa:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801064b1:	e9 b0 00 00 00       	jmp    80106566 <sys_kthread_mutex_init+0xc3>

		if(proc->mutexlist[i].lock.id == (i+1)){
801064b6:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801064bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064c0:	c1 e0 02             	shl    $0x2,%eax
801064c3:	89 c2                	mov    %eax,%edx
801064c5:	c1 e2 04             	shl    $0x4,%edx
801064c8:	29 c2                	sub    %eax,%edx
801064ca:	8d 04 11             	lea    (%ecx,%edx,1),%eax
801064cd:	05 c4 00 00 00       	add    $0xc4,%eax
801064d2:	8b 10                	mov    (%eax),%edx
801064d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064d7:	83 c0 01             	add    $0x1,%eax
801064da:	39 c2                	cmp    %eax,%edx
801064dc:	0f 85 80 00 00 00    	jne    80106562 <sys_kthread_mutex_init+0xbf>
			proc->mutexlist[i].lock.id = (i+1);
801064e2:	65 8b 1d 04 00 00 00 	mov    %gs:0x4,%ebx
801064e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064ec:	83 c0 01             	add    $0x1,%eax
801064ef:	89 c1                	mov    %eax,%ecx
801064f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064f4:	c1 e0 02             	shl    $0x2,%eax
801064f7:	89 c2                	mov    %eax,%edx
801064f9:	c1 e2 04             	shl    $0x4,%edx
801064fc:	29 c2                	sub    %eax,%edx
801064fe:	8d 04 13             	lea    (%ebx,%edx,1),%eax
80106501:	05 c4 00 00 00       	add    $0xc4,%eax
80106506:	89 08                	mov    %ecx,(%eax)
			initlock(&proc->mutexlist[i].lock, (char*)(i+1));
80106508:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010650b:	83 c0 01             	add    $0x1,%eax
8010650e:	89 c1                	mov    %eax,%ecx
80106510:	65 8b 1d 04 00 00 00 	mov    %gs:0x4,%ebx
80106517:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651a:	c1 e0 02             	shl    $0x2,%eax
8010651d:	89 c2                	mov    %eax,%edx
8010651f:	c1 e2 04             	shl    $0x4,%edx
80106522:	29 c2                	sub    %eax,%edx
80106524:	8d 82 90 00 00 00    	lea    0x90(%edx),%eax
8010652a:	01 d8                	add    %ebx,%eax
8010652c:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106530:	89 04 24             	mov    %eax,(%esp)
80106533:	e8 06 dc ff ff       	call   8010413e <initlock>
			proc->mutexlist[i].lockingthread = 0;
80106538:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010653f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106542:	c1 e0 02             	shl    $0x2,%eax
80106545:	89 c2                	mov    %eax,%edx
80106547:	c1 e2 04             	shl    $0x4,%edx
8010654a:	29 c2                	sub    %eax,%edx
8010654c:	8d 04 11             	lea    (%ecx,%edx,1),%eax
8010654f:	05 c8 00 00 00       	add    $0xc8,%eax
80106554:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			return (i+1);
8010655a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010655d:	83 c0 01             	add    $0x1,%eax
80106560:	eb 13                	jmp    80106575 <sys_kthread_mutex_init+0xd2>
...
int sys_kthread_mutex_init(void){
	...
	for(i=0;i<NMUTX;i++){
80106562:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106566:	83 7d f4 3f          	cmpl   $0x3f,-0xc(%ebp)
8010656a:	0f 8e 46 ff ff ff    	jle    801064b6 <sys_kthread_mutex_init+0x13>
			proc->mutexlist[i].lockingthread = 0;
			return (i+1);
		}
	}	
...
80106575:	83 c4 24             	add    $0x24,%esp
80106578:	5b                   	pop    %ebx
80106579:	5d                   	pop    %ebp
8010657a:	c3                   	ret    

8010657b <sys_kthread_mutex_destroy>:
...
80106584:	89 44 24 04          	mov    %eax,0x4(%esp)
80106588:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010658f:	e8 9a ed ff ff       	call   8010532e <argint>

	if((mutex <= 0) || (mutex > NMUTX) || (proc->mutexlist[mutex-1].lock.id != mutex))
80106594:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106597:	85 c0                	test   %eax,%eax
80106599:	7e 30                	jle    801065cb <sys_kthread_mutex_destroy+0x50>
8010659b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010659e:	83 f8 40             	cmp    $0x40,%eax
801065a1:	7f 28                	jg     801065cb <sys_kthread_mutex_destroy+0x50>
801065a3:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801065aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065ad:	83 e8 01             	sub    $0x1,%eax
801065b0:	c1 e0 02             	shl    $0x2,%eax
801065b3:	89 c2                	mov    %eax,%edx
801065b5:	c1 e2 04             	shl    $0x4,%edx
801065b8:	29 c2                	sub    %eax,%edx
801065ba:	8d 04 11             	lea    (%ecx,%edx,1),%eax
801065bd:	05 c4 00 00 00       	add    $0xc4,%eax
801065c2:	8b 10                	mov    (%eax),%edx
801065c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065c7:	39 c2                	cmp    %eax,%edx
801065c9:	74 07                	je     801065d2 <sys_kthread_mutex_destroy+0x57>
		return -1;
801065cb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065d0:	eb 7c                	jmp    8010664e <sys_kthread_mutex_destroy+0xd3>
		
	proc->mutexlist[mutex-1].lock.id = -1;
801065d2:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801065d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065dc:	83 e8 01             	sub    $0x1,%eax
801065df:	c1 e0 02             	shl    $0x2,%eax
801065e2:	89 c2                	mov    %eax,%edx
801065e4:	c1 e2 04             	shl    $0x4,%edx
801065e7:	29 c2                	sub    %eax,%edx
801065e9:	8d 04 11             	lea    (%ecx,%edx,1),%eax
801065ec:	05 c4 00 00 00       	add    $0xc4,%eax
801065f1:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
	initlock(&proc->mutexlist[mutex-1].lock, (char*)-1);
801065f7:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
801065fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106601:	83 e8 01             	sub    $0x1,%eax
80106604:	c1 e0 02             	shl    $0x2,%eax
80106607:	89 c2                	mov    %eax,%edx
80106609:	c1 e2 04             	shl    $0x4,%edx
8010660c:	29 c2                	sub    %eax,%edx
8010660e:	8d 82 90 00 00 00    	lea    0x90(%edx),%eax
80106614:	01 c8                	add    %ecx,%eax
80106616:	c7 44 24 04 ff ff ff 	movl   $0xffffffff,0x4(%esp)
8010661d:	ff 
8010661e:	89 04 24             	mov    %eax,(%esp)
80106621:	e8 18 db ff ff       	call   8010413e <initlock>
	proc->mutexlist[mutex-1].lockingthread = -1;
80106626:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010662d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106630:	83 e8 01             	sub    $0x1,%eax
80106633:	c1 e0 02             	shl    $0x2,%eax
80106636:	89 c2                	mov    %eax,%edx
80106638:	c1 e2 04             	shl    $0x4,%edx
8010663b:	29 c2                	sub    %eax,%edx
8010663d:	8d 04 11             	lea    (%ecx,%edx,1),%eax
80106640:	05 c8 00 00 00       	add    $0xc8,%eax
80106645:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
	return mutex;		
...
80106650 <sys_kthread_mutex_lock>:
...
80106654:	83 ec 24             	sub    $0x24,%esp
	...
	int mutex = 0;
80106657:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	argint(0, &mutex);
8010665e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106661:	89 44 24 04          	mov    %eax,0x4(%esp)
80106665:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010666c:	e8 bd ec ff ff       	call   8010532e <argint>

	if((proc->type) && (mutex > 0) && (mutex <= NMUTX) && (proc->parent->mutexlist[mutex-1].lock.id == mutex)){
80106671:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106677:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
8010667d:	85 c0                	test   %eax,%eax
8010667f:	0f 84 bd 00 00 00    	je     80106742 <sys_kthread_mutex_lock+0xf2>
80106685:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106688:	85 c0                	test   %eax,%eax
8010668a:	0f 8e b2 00 00 00    	jle    80106742 <sys_kthread_mutex_lock+0xf2>
80106690:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106693:	83 f8 40             	cmp    $0x40,%eax
80106696:	0f 8f a6 00 00 00    	jg     80106742 <sys_kthread_mutex_lock+0xf2>
8010669c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066a2:	8b 48 14             	mov    0x14(%eax),%ecx
801066a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a8:	83 e8 01             	sub    $0x1,%eax
801066ab:	c1 e0 02             	shl    $0x2,%eax
801066ae:	89 c2                	mov    %eax,%edx
801066b0:	c1 e2 04             	shl    $0x4,%edx
801066b3:	29 c2                	sub    %eax,%edx
801066b5:	8d 04 11             	lea    (%ecx,%edx,1),%eax
801066b8:	05 c4 00 00 00       	add    $0xc4,%eax
801066bd:	8b 10                	mov    (%eax),%edx
801066bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066c2:	39 c2                	cmp    %eax,%edx
801066c4:	75 7c                	jne    80106742 <sys_kthread_mutex_lock+0xf2>
		while(proc->parent->mutexlist[mutex-1].lock.locked);
801066c6:	90                   	nop
801066c7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066cd:	8b 48 14             	mov    0x14(%eax),%ecx
801066d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d3:	83 e8 01             	sub    $0x1,%eax
801066d6:	c1 e0 02             	shl    $0x2,%eax
801066d9:	89 c2                	mov    %eax,%edx
801066db:	c1 e2 04             	shl    $0x4,%edx
801066de:	29 c2                	sub    %eax,%edx
801066e0:	8d 04 11             	lea    (%ecx,%edx,1),%eax
801066e3:	05 90 00 00 00       	add    $0x90,%eax
801066e8:	8b 00                	mov    (%eax),%eax
801066ea:	85 c0                	test   %eax,%eax
801066ec:	75 d9                	jne    801066c7 <sys_kthread_mutex_lock+0x77>
		acquire(&proc->parent->mutexlist[mutex-1].lock);
801066ee:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066f4:	8b 48 14             	mov    0x14(%eax),%ecx
801066f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066fa:	83 e8 01             	sub    $0x1,%eax
801066fd:	c1 e0 02             	shl    $0x2,%eax
80106700:	89 c2                	mov    %eax,%edx
80106702:	c1 e2 04             	shl    $0x4,%edx
80106705:	29 c2                	sub    %eax,%edx
80106707:	8d 82 90 00 00 00    	lea    0x90(%edx),%eax
8010670d:	01 c8                	add    %ecx,%eax
8010670f:	89 04 24             	mov    %eax,(%esp)
80106712:	e8 48 da ff ff       	call   8010415f <acquire>
		proc->parent->mutexlist[mutex-1].lockingthread = mutex;	
80106717:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010671d:	8b 58 14             	mov    0x14(%eax),%ebx
80106720:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106723:	83 e8 01             	sub    $0x1,%eax
80106726:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80106729:	c1 e0 02             	shl    $0x2,%eax
8010672c:	89 c2                	mov    %eax,%edx
8010672e:	c1 e2 04             	shl    $0x4,%edx
80106731:	29 c2                	sub    %eax,%edx
80106733:	8d 04 13             	lea    (%ebx,%edx,1),%eax
80106736:	05 c8 00 00 00       	add    $0xc8,%eax
8010673b:	89 08                	mov    %ecx,(%eax)
		return mutex;
8010673d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106740:	eb 05                	jmp    80106747 <sys_kthread_mutex_lock+0xf7>
	}
	
	return -1;
80106742:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80106747:	83 c4 24             	add    $0x24,%esp
8010674a:	5b                   	pop    %ebx
8010674b:	5d                   	pop    %ebp
8010674c:	c3                   	ret    

8010674d <sys_kthread_mutex_unlock>:
...
80106750:	83 ec 28             	sub    $0x28,%esp
	...
	int mutex = 0;
80106753:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	argint(0, &mutex);
8010675a:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010675d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106761:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106768:	e8 c1 eb ff ff       	call   8010532e <argint>

	if((proc->type)&& (mutex > 0) && (mutex <= NMUTX) && (proc->parent->mutexlist[mutex-1].lock.id == mutex)){
8010676d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106773:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80106779:	85 c0                	test   %eax,%eax
8010677b:	0f 84 92 00 00 00    	je     80106813 <sys_kthread_mutex_unlock+0xc6>
80106781:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106784:	85 c0                	test   %eax,%eax
80106786:	0f 8e 87 00 00 00    	jle    80106813 <sys_kthread_mutex_unlock+0xc6>
8010678c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010678f:	83 f8 40             	cmp    $0x40,%eax
80106792:	7f 7f                	jg     80106813 <sys_kthread_mutex_unlock+0xc6>
80106794:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010679a:	8b 48 14             	mov    0x14(%eax),%ecx
8010679d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067a0:	83 e8 01             	sub    $0x1,%eax
801067a3:	c1 e0 02             	shl    $0x2,%eax
801067a6:	89 c2                	mov    %eax,%edx
801067a8:	c1 e2 04             	shl    $0x4,%edx
801067ab:	29 c2                	sub    %eax,%edx
801067ad:	8d 04 11             	lea    (%ecx,%edx,1),%eax
801067b0:	05 c4 00 00 00       	add    $0xc4,%eax
801067b5:	8b 10                	mov    (%eax),%edx
801067b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067ba:	39 c2                	cmp    %eax,%edx
801067bc:	75 55                	jne    80106813 <sys_kthread_mutex_unlock+0xc6>
		release(&proc->parent->mutexlist[mutex-1].lock);
801067be:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067c4:	8b 48 14             	mov    0x14(%eax),%ecx
801067c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067ca:	83 e8 01             	sub    $0x1,%eax
801067cd:	c1 e0 02             	shl    $0x2,%eax
801067d0:	89 c2                	mov    %eax,%edx
801067d2:	c1 e2 04             	shl    $0x4,%edx
801067d5:	29 c2                	sub    %eax,%edx
801067d7:	8d 82 90 00 00 00    	lea    0x90(%edx),%eax
801067dd:	01 c8                	add    %ecx,%eax
801067df:	89 04 24             	mov    %eax,(%esp)
801067e2:	e8 da d9 ff ff       	call   801041c1 <release>
		proc->parent->mutexlist[mutex-1].lockingthread = 0;
801067e7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067ed:	8b 48 14             	mov    0x14(%eax),%ecx
801067f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067f3:	83 e8 01             	sub    $0x1,%eax
801067f6:	c1 e0 02             	shl    $0x2,%eax
801067f9:	89 c2                	mov    %eax,%edx
801067fb:	c1 e2 04             	shl    $0x4,%edx
801067fe:	29 c2                	sub    %eax,%edx
80106800:	8d 04 11             	lea    (%ecx,%edx,1),%eax
80106803:	05 c8 00 00 00       	add    $0xc8,%eax
80106808:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		return mutex;
8010680e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106811:	eb 05                	jmp    80106818 <sys_kthread_mutex_unlock+0xcb>
	}
...
8010681a <sys_kthread_cond_init>:
...
8010681e:	83 ec 10             	sub    $0x10,%esp
	...
	int i, flag = -1;
80106821:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
	
	for(i=0;i<NCONDVAR;i++){
80106828:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
8010682f:	e9 88 00 00 00       	jmp    801068bc <sys_kthread_cond_init+0xa2>
		if(proc->condvarlist[i].id == -1){
80106834:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010683b:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010683e:	c1 e0 02             	shl    $0x2,%eax
80106841:	89 c1                	mov    %eax,%ecx
80106843:	c1 e1 05             	shl    $0x5,%ecx
80106846:	01 c8                	add    %ecx,%eax
80106848:	01 d0                	add    %edx,%eax
8010684a:	05 90 0f 00 00       	add    $0xf90,%eax
8010684f:	8b 00                	mov    (%eax),%eax
80106851:	83 f8 ff             	cmp    $0xffffffff,%eax
80106854:	75 62                	jne    801068b8 <sys_kthread_cond_init+0x9e>
			 flag = (i+1);
80106856:	8b 45 f8             	mov    -0x8(%ebp),%eax
80106859:	83 c0 01             	add    $0x1,%eax
8010685c:	89 45 f4             	mov    %eax,-0xc(%ebp)
			proc->condvarlist[i].id = (i+1);
8010685f:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106866:	8b 45 f8             	mov    -0x8(%ebp),%eax
80106869:	8d 50 01             	lea    0x1(%eax),%edx
8010686c:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010686f:	c1 e0 02             	shl    $0x2,%eax
80106872:	89 c3                	mov    %eax,%ebx
80106874:	c1 e3 05             	shl    $0x5,%ebx
80106877:	01 d8                	add    %ebx,%eax
80106879:	01 c8                	add    %ecx,%eax
8010687b:	05 90 0f 00 00       	add    $0xf90,%eax
80106880:	89 10                	mov    %edx,(%eax)
			int j;
			for(j=0;i<MAXTHRDS;j++)
80106882:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80106889:	eb 25                	jmp    801068b0 <sys_kthread_cond_init+0x96>
				proc->condvarlist[i].waitingthreadlist[j] = 0;
8010688b:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106892:	8b 55 f8             	mov    -0x8(%ebp),%edx
80106895:	89 d0                	mov    %edx,%eax
80106897:	c1 e0 05             	shl    $0x5,%eax
8010689a:	01 d0                	add    %edx,%eax
8010689c:	03 45 f0             	add    -0x10(%ebp),%eax
8010689f:	05 e4 03 00 00       	add    $0x3e4,%eax
801068a4:	c7 44 81 04 00 00 00 	movl   $0x0,0x4(%ecx,%eax,4)
801068ab:	00 
	for(i=0;i<NCONDVAR;i++){
		if(proc->condvarlist[i].id == -1){
			 flag = (i+1);
			...
			int j;
			for(j=0;i<MAXTHRDS;j++)
801068ac:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801068b0:	83 7d f8 1f          	cmpl   $0x1f,-0x8(%ebp)
801068b4:	7e d5                	jle    8010688b <sys_kthread_cond_init+0x71>
				proc->condvarlist[i].waitingthreadlist[j] = 0;
			break;
801068b6:	eb 0e                	jmp    801068c6 <sys_kthread_cond_init+0xac>
...
int sys_kthread_cond_init(void){
	...
	for(i=0;i<NCONDVAR;i++){
801068b8:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801068bc:	83 7d f8 3f          	cmpl   $0x3f,-0x8(%ebp)
801068c0:	0f 8e 6e ff ff ff    	jle    80106834 <sys_kthread_cond_init+0x1a>
				proc->condvarlist[i].waitingthreadlist[j] = 0;
			break;
		}
	}
...
801068cf <sys_kthread_cond_destroy>:
...
801068f4:	7e 2f                	jle    80106925 <sys_kthread_cond_destroy+0x56>
801068f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068f9:	83 f8 40             	cmp    $0x40,%eax
801068fc:	7f 27                	jg     80106925 <sys_kthread_cond_destroy+0x56>
801068fe:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106905:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106908:	83 e8 01             	sub    $0x1,%eax
8010690b:	c1 e0 02             	shl    $0x2,%eax
8010690e:	89 c1                	mov    %eax,%ecx
80106910:	c1 e1 05             	shl    $0x5,%ecx
80106913:	01 c8                	add    %ecx,%eax
80106915:	01 d0                	add    %edx,%eax
80106917:	05 90 0f 00 00       	add    $0xf90,%eax
8010691c:	8b 10                	mov    (%eax),%edx
8010691e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106921:	39 c2                	cmp    %eax,%edx
80106923:	74 07                	je     8010692c <sys_kthread_cond_destroy+0x5d>
		return -1;
80106925:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010692a:	eb 60                	jmp    8010698c <sys_kthread_cond_destroy+0xbd>

	proc->condvarlist[condvar-1].id = -1;
8010692c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106933:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106936:	83 e8 01             	sub    $0x1,%eax
80106939:	c1 e0 02             	shl    $0x2,%eax
8010693c:	89 c1                	mov    %eax,%ecx
8010693e:	c1 e1 05             	shl    $0x5,%ecx
80106941:	01 c8                	add    %ecx,%eax
80106943:	01 d0                	add    %edx,%eax
80106945:	05 90 0f 00 00       	add    $0xf90,%eax
8010694a:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
	int j;
	for(j=0;j<MAXTHRDS;j++)
80106950:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106957:	eb 28                	jmp    80106981 <sys_kthread_cond_destroy+0xb2>
		proc->condvarlist[condvar-1].waitingthreadlist[j] = -1;	
80106959:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80106960:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106963:	8d 50 ff             	lea    -0x1(%eax),%edx
80106966:	89 d0                	mov    %edx,%eax
80106968:	c1 e0 05             	shl    $0x5,%eax
8010696b:	01 d0                	add    %edx,%eax
8010696d:	03 45 f4             	add    -0xc(%ebp),%eax
80106970:	05 e4 03 00 00       	add    $0x3e4,%eax
80106975:	c7 44 81 04 ff ff ff 	movl   $0xffffffff,0x4(%ecx,%eax,4)
8010697c:	ff 
	if((condvar <= 0) || (condvar > NCONDVAR) || (proc->condvarlist[condvar-1].id != condvar))
		return -1;
...
80106981:	83 7d f4 1f          	cmpl   $0x1f,-0xc(%ebp)
80106985:	7e d2                	jle    80106959 <sys_kthread_cond_destroy+0x8a>
		proc->condvarlist[condvar-1].waitingthreadlist[j] = -1;	
...
8010698e <sys_kthread_cond_wait>:

int sys_kthread_cond_wait(void){
8010698e:	55                   	push   %ebp
8010698f:	89 e5                	mov    %esp,%ebp
80106991:	53                   	push   %ebx
80106992:	83 ec 24             	sub    $0x24,%esp

	int mutex = 0 , condvar = 0; 
80106995:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
8010699c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)

	argint(0, &condvar);
801069a3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801069a6:	89 44 24 04          	mov    %eax,0x4(%esp)
801069aa:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069b1:	e8 78 e9 ff ff       	call   8010532e <argint>
	argint(1, &mutex);
801069b6:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801069bd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801069c4:	e8 65 e9 ff ff       	call   8010532e <argint>

	if((condvar > 0) && (condvar <= NMUTX) && (mutex > 0) && (condvar <= NCONDVAR)){
801069c9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801069cc:	85 c0                	test   %eax,%eax
801069ce:	0f 8e cd 00 00 00    	jle    80106aa1 <sys_kthread_cond_wait+0x113>
801069d4:	8b 45 ec             	mov    -0x14(%ebp),%eax
801069d7:	83 f8 40             	cmp    $0x40,%eax
801069da:	0f 8f c1 00 00 00    	jg     80106aa1 <sys_kthread_cond_wait+0x113>
801069e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801069e3:	85 c0                	test   %eax,%eax
801069e5:	0f 8e b6 00 00 00    	jle    80106aa1 <sys_kthread_cond_wait+0x113>
801069eb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801069ee:	83 f8 40             	cmp    $0x40,%eax
801069f1:	0f 8f aa 00 00 00    	jg     80106aa1 <sys_kthread_cond_wait+0x113>
		int i;
		for(i=0;i<MAXTHRDS;i++){
801069f7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801069fe:	e9 94 00 00 00       	jmp    80106a97 <sys_kthread_cond_wait+0x109>
			if(proc->parent->condvarlist[condvar-1].waitingthreadlist[i] == -1){
80106a03:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a09:	8b 48 14             	mov    0x14(%eax),%ecx
80106a0c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106a0f:	8d 50 ff             	lea    -0x1(%eax),%edx
80106a12:	89 d0                	mov    %edx,%eax
80106a14:	c1 e0 05             	shl    $0x5,%eax
80106a17:	01 d0                	add    %edx,%eax
80106a19:	03 45 f4             	add    -0xc(%ebp),%eax
80106a1c:	05 e4 03 00 00       	add    $0x3e4,%eax
80106a21:	8b 44 81 04          	mov    0x4(%ecx,%eax,4),%eax
80106a25:	83 f8 ff             	cmp    $0xffffffff,%eax
80106a28:	75 69                	jne    80106a93 <sys_kthread_cond_wait+0x105>
				proc->parent->condvarlist[condvar-1].waitingthreadlist[i] = proc->pid;
80106a2a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a30:	8b 48 14             	mov    0x14(%eax),%ecx
80106a33:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106a36:	8d 50 ff             	lea    -0x1(%eax),%edx
80106a39:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a3f:	8b 58 10             	mov    0x10(%eax),%ebx
80106a42:	89 d0                	mov    %edx,%eax
80106a44:	c1 e0 05             	shl    $0x5,%eax
80106a47:	01 d0                	add    %edx,%eax
80106a49:	03 45 f4             	add    -0xc(%ebp),%eax
80106a4c:	05 e4 03 00 00       	add    $0x3e4,%eax
80106a51:	89 5c 81 04          	mov    %ebx,0x4(%ecx,%eax,4)
				sleep((void*)proc->pid, &proc->parent->mutexlist[mutex-1].lock);
80106a55:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a5b:	8b 48 14             	mov    0x14(%eax),%ecx
80106a5e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106a61:	83 e8 01             	sub    $0x1,%eax
80106a64:	c1 e0 02             	shl    $0x2,%eax
80106a67:	89 c2                	mov    %eax,%edx
80106a69:	c1 e2 04             	shl    $0x4,%edx
80106a6c:	29 c2                	sub    %eax,%edx
80106a6e:	8d 82 90 00 00 00    	lea    0x90(%edx),%eax
80106a74:	8d 14 01             	lea    (%ecx,%eax,1),%edx
80106a77:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a7d:	8b 40 10             	mov    0x10(%eax),%eax
80106a80:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a84:	89 04 24             	mov    %eax,(%esp)
80106a87:	e8 7b e2 ff ff       	call   80104d07 <sleep>
				return 0;
80106a8c:	b8 00 00 00 00       	mov    $0x0,%eax
80106a91:	eb 13                	jmp    80106aa6 <sys_kthread_cond_wait+0x118>
	argint(0, &condvar);
	argint(1, &mutex);
...
80106a97:	83 7d f4 1f          	cmpl   $0x1f,-0xc(%ebp)
80106a9b:	0f 8e 62 ff ff ff    	jle    80106a03 <sys_kthread_cond_wait+0x75>
				return 0;
			}
		}
	}
...
80106aa6:	83 c4 24             	add    $0x24,%esp
80106aa9:	5b                   	pop    %ebx
80106aaa:	5d                   	pop    %ebp
80106aab:	c3                   	ret    

80106aac <sys_kthread_cond_signal>:

int sys_kthread_cond_signal(void){
80106aac:	55                   	push   %ebp
80106aad:	89 e5                	mov    %esp,%ebp
80106aaf:	83 ec 28             	sub    $0x28,%esp

	int i, condvar = 0;
80106ab2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

	argint(0, &condvar);
80106ab9:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106abc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ac0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ac7:	e8 62 e8 ff ff       	call   8010532e <argint>

	if((condvar < 1) || (condvar > NCONDVAR))
80106acc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106acf:	85 c0                	test   %eax,%eax
80106ad1:	7e 08                	jle    80106adb <sys_kthread_cond_signal+0x2f>
80106ad3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ad6:	83 f8 40             	cmp    $0x40,%eax
80106ad9:	7e 0a                	jle    80106ae5 <sys_kthread_cond_signal+0x39>
		return -1;
80106adb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ae0:	e9 95 00 00 00       	jmp    80106b7a <sys_kthread_cond_signal+0xce>

	for(i=0;i<MAXTHRDS;i++){
80106ae5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106aec:	eb 7d                	jmp    80106b6b <sys_kthread_cond_signal+0xbf>
		if(proc->parent->condvarlist[condvar-1].waitingthreadlist[i] != -1){
80106aee:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106af4:	8b 48 14             	mov    0x14(%eax),%ecx
80106af7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106afa:	8d 50 ff             	lea    -0x1(%eax),%edx
80106afd:	89 d0                	mov    %edx,%eax
80106aff:	c1 e0 05             	shl    $0x5,%eax
80106b02:	01 d0                	add    %edx,%eax
80106b04:	03 45 f4             	add    -0xc(%ebp),%eax
80106b07:	05 e4 03 00 00       	add    $0x3e4,%eax
80106b0c:	8b 44 81 04          	mov    0x4(%ecx,%eax,4),%eax
80106b10:	83 f8 ff             	cmp    $0xffffffff,%eax
80106b13:	74 52                	je     80106b67 <sys_kthread_cond_signal+0xbb>
			proc->parent->condvarlist[condvar-1].waitingthreadlist[i] = -1;
80106b15:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106b1b:	8b 48 14             	mov    0x14(%eax),%ecx
80106b1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b21:	8d 50 ff             	lea    -0x1(%eax),%edx
80106b24:	89 d0                	mov    %edx,%eax
80106b26:	c1 e0 05             	shl    $0x5,%eax
80106b29:	01 d0                	add    %edx,%eax
80106b2b:	03 45 f4             	add    -0xc(%ebp),%eax
80106b2e:	05 e4 03 00 00       	add    $0x3e4,%eax
80106b33:	c7 44 81 04 ff ff ff 	movl   $0xffffffff,0x4(%ecx,%eax,4)
80106b3a:	ff 
			wakeup((void*)proc->parent->condvarlist[condvar-1].waitingthreadlist[i]);
80106b3b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106b41:	8b 48 14             	mov    0x14(%eax),%ecx
80106b44:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b47:	8d 50 ff             	lea    -0x1(%eax),%edx
80106b4a:	89 d0                	mov    %edx,%eax
80106b4c:	c1 e0 05             	shl    $0x5,%eax
80106b4f:	01 d0                	add    %edx,%eax
80106b51:	03 45 f4             	add    -0xc(%ebp),%eax
80106b54:	05 e4 03 00 00       	add    $0x3e4,%eax
80106b59:	8b 44 81 04          	mov    0x4(%ecx,%eax,4),%eax
80106b5d:	89 04 24             	mov    %eax,(%esp)
80106b60:	e8 7e e2 ff ff       	call   80104de3 <wakeup>
			break;
80106b65:	eb 0e                	jmp    80106b75 <sys_kthread_cond_signal+0xc9>
	argint(0, &condvar);
	...
	for(i=0;i<MAXTHRDS;i++){
80106b67:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106b6b:	83 7d f4 1f          	cmpl   $0x1f,-0xc(%ebp)
80106b6f:	0f 8e 79 ff ff ff    	jle    80106aee <sys_kthread_cond_signal+0x42>
			wakeup((void*)proc->parent->condvarlist[condvar-1].waitingthreadlist[i]);
			break;
		}
	}
	...
	return 0;
80106b75:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106b7a:	c9                   	leave  
80106b7b:	c3                   	ret    

80106b7c <sys_kthread_cond_broadcast>:
...
80106b7f:	83 ec 28             	sub    $0x28,%esp
	...
	int i, condvar = 0;
80106b82:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
	
	argint(0, &condvar);
80106b89:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106b8c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b90:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b97:	e8 92 e7 ff ff       	call   8010532e <argint>
	
	if((condvar < 1) || (condvar > NCONDVAR))
80106b9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106b9f:	85 c0                	test   %eax,%eax
80106ba1:	7e 08                	jle    80106bab <sys_kthread_cond_broadcast+0x2f>
80106ba3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106ba6:	83 f8 40             	cmp    $0x40,%eax
80106ba9:	7e 0a                	jle    80106bb5 <sys_kthread_cond_broadcast+0x39>
             return -1;
80106bab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106bb0:	e9 93 00 00 00       	jmp    80106c48 <sys_kthread_cond_broadcast+0xcc>

	for(i=0;i<MAXTHRDS;i++){
80106bb5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106bbc:	eb 7b                	jmp    80106c39 <sys_kthread_cond_broadcast+0xbd>
               	if(proc->parent->condvarlist[condvar-1].waitingthreadlist[i] != -1){
80106bbe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bc4:	8b 48 14             	mov    0x14(%eax),%ecx
80106bc7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106bca:	8d 50 ff             	lea    -0x1(%eax),%edx
80106bcd:	89 d0                	mov    %edx,%eax
80106bcf:	c1 e0 05             	shl    $0x5,%eax
80106bd2:	01 d0                	add    %edx,%eax
80106bd4:	03 45 f4             	add    -0xc(%ebp),%eax
80106bd7:	05 e4 03 00 00       	add    $0x3e4,%eax
80106bdc:	8b 44 81 04          	mov    0x4(%ecx,%eax,4),%eax
80106be0:	83 f8 ff             	cmp    $0xffffffff,%eax
80106be3:	74 50                	je     80106c35 <sys_kthread_cond_broadcast+0xb9>
                       	proc->parent->condvarlist[condvar-1].waitingthreadlist[i] = -1;
80106be5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106beb:	8b 48 14             	mov    0x14(%eax),%ecx
80106bee:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106bf1:	8d 50 ff             	lea    -0x1(%eax),%edx
80106bf4:	89 d0                	mov    %edx,%eax
80106bf6:	c1 e0 05             	shl    $0x5,%eax
80106bf9:	01 d0                	add    %edx,%eax
80106bfb:	03 45 f4             	add    -0xc(%ebp),%eax
80106bfe:	05 e4 03 00 00       	add    $0x3e4,%eax
80106c03:	c7 44 81 04 ff ff ff 	movl   $0xffffffff,0x4(%ecx,%eax,4)
80106c0a:	ff 
                       	wakeup((void*)proc->parent->condvarlist[condvar-1].waitingthreadlist[i]);
80106c0b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c11:	8b 48 14             	mov    0x14(%eax),%ecx
80106c14:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106c17:	8d 50 ff             	lea    -0x1(%eax),%edx
80106c1a:	89 d0                	mov    %edx,%eax
80106c1c:	c1 e0 05             	shl    $0x5,%eax
80106c1f:	01 d0                	add    %edx,%eax
80106c21:	03 45 f4             	add    -0xc(%ebp),%eax
80106c24:	05 e4 03 00 00       	add    $0x3e4,%eax
80106c29:	8b 44 81 04          	mov    0x4(%ecx,%eax,4),%eax
80106c2d:	89 04 24             	mov    %eax,(%esp)
80106c30:	e8 ae e1 ff ff       	call   80104de3 <wakeup>
	argint(0, &condvar);
	...
	for(i=0;i<MAXTHRDS;i++){
80106c35:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106c39:	83 7d f4 1f          	cmpl   $0x1f,-0xc(%ebp)
80106c3d:	0f 8e 7b ff ff ff    	jle    80106bbe <sys_kthread_cond_broadcast+0x42>
                       	wakeup((void*)proc->parent->condvarlist[condvar-1].waitingthreadlist[i]);
               	}
        }
...
80106cbb:	e8 09 cf ff ff       	call   80103bc9 <picenable>
}
80106cc0:	c9                   	leave  
80106cc1:	c3                   	ret    
	...
...
80106d44:	8b 04 85 c8 c0 10 80 	mov    -0x7fef3f38(,%eax,4),%eax
80106d4b:	89 c2                	mov    %eax,%edx
80106d4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d50:	66 89 14 c5 60 5e 1d 	mov    %dx,-0x7fe2a1a0(,%eax,8)
80106d57:	80 
80106d58:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d5b:	66 c7 04 c5 62 5e 1d 	movw   $0x8,-0x7fe2a19e(,%eax,8)
80106d62:	80 08 00 
80106d65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d68:	0f b6 14 c5 64 5e 1d 	movzbl -0x7fe2a19c(,%eax,8),%edx
80106d6f:	80 
80106d70:	83 e2 e0             	and    $0xffffffe0,%edx
80106d73:	88 14 c5 64 5e 1d 80 	mov    %dl,-0x7fe2a19c(,%eax,8)
80106d7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d7d:	0f b6 14 c5 64 5e 1d 	movzbl -0x7fe2a19c(,%eax,8),%edx
80106d84:	80 
80106d85:	83 e2 1f             	and    $0x1f,%edx
80106d88:	88 14 c5 64 5e 1d 80 	mov    %dl,-0x7fe2a19c(,%eax,8)
80106d8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d92:	0f b6 14 c5 65 5e 1d 	movzbl -0x7fe2a19b(,%eax,8),%edx
80106d99:	80 
80106d9a:	83 e2 f0             	and    $0xfffffff0,%edx
80106d9d:	83 ca 0e             	or     $0xe,%edx
80106da0:	88 14 c5 65 5e 1d 80 	mov    %dl,-0x7fe2a19b(,%eax,8)
80106da7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106daa:	0f b6 14 c5 65 5e 1d 	movzbl -0x7fe2a19b(,%eax,8),%edx
80106db1:	80 
80106db2:	83 e2 ef             	and    $0xffffffef,%edx
80106db5:	88 14 c5 65 5e 1d 80 	mov    %dl,-0x7fe2a19b(,%eax,8)
80106dbc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dbf:	0f b6 14 c5 65 5e 1d 	movzbl -0x7fe2a19b(,%eax,8),%edx
80106dc6:	80 
80106dc7:	83 e2 9f             	and    $0xffffff9f,%edx
80106dca:	88 14 c5 65 5e 1d 80 	mov    %dl,-0x7fe2a19b(,%eax,8)
80106dd1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dd4:	0f b6 14 c5 65 5e 1d 	movzbl -0x7fe2a19b(,%eax,8),%edx
80106ddb:	80 
80106ddc:	83 ca 80             	or     $0xffffff80,%edx
80106ddf:	88 14 c5 65 5e 1d 80 	mov    %dl,-0x7fe2a19b(,%eax,8)
80106de6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106de9:	8b 04 85 c8 c0 10 80 	mov    -0x7fef3f38(,%eax,4),%eax
80106df0:	c1 e8 10             	shr    $0x10,%eax
80106df3:	89 c2                	mov    %eax,%edx
80106df5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106df8:	66 89 14 c5 66 5e 1d 	mov    %dx,-0x7fe2a19a(,%eax,8)
80106dff:	80 
void
tvinit(void)
{
...
80106e11:	a1 c8 c1 10 80       	mov    0x8010c1c8,%eax
80106e16:	66 a3 60 60 1d 80    	mov    %ax,0x801d6060
80106e1c:	66 c7 05 62 60 1d 80 	movw   $0x8,0x801d6062
80106e23:	08 00 
80106e25:	0f b6 05 64 60 1d 80 	movzbl 0x801d6064,%eax
80106e2c:	83 e0 e0             	and    $0xffffffe0,%eax
80106e2f:	a2 64 60 1d 80       	mov    %al,0x801d6064
80106e34:	0f b6 05 64 60 1d 80 	movzbl 0x801d6064,%eax
80106e3b:	83 e0 1f             	and    $0x1f,%eax
80106e3e:	a2 64 60 1d 80       	mov    %al,0x801d6064
80106e43:	0f b6 05 65 60 1d 80 	movzbl 0x801d6065,%eax
80106e4a:	83 c8 0f             	or     $0xf,%eax
80106e4d:	a2 65 60 1d 80       	mov    %al,0x801d6065
80106e52:	0f b6 05 65 60 1d 80 	movzbl 0x801d6065,%eax
80106e59:	83 e0 ef             	and    $0xffffffef,%eax
80106e5c:	a2 65 60 1d 80       	mov    %al,0x801d6065
80106e61:	0f b6 05 65 60 1d 80 	movzbl 0x801d6065,%eax
80106e68:	83 c8 60             	or     $0x60,%eax
80106e6b:	a2 65 60 1d 80       	mov    %al,0x801d6065
80106e70:	0f b6 05 65 60 1d 80 	movzbl 0x801d6065,%eax
80106e77:	83 c8 80             	or     $0xffffff80,%eax
80106e7a:	a2 65 60 1d 80       	mov    %al,0x801d6065
80106e7f:	a1 c8 c1 10 80       	mov    0x8010c1c8,%eax
80106e84:	c1 e8 10             	shr    $0x10,%eax
80106e87:	66 a3 66 60 1d 80    	mov    %ax,0x801d6066
  
  initlock(&tickslock, "time");
80106e8d:	c7 44 24 04 a8 90 10 	movl   $0x801090a8,0x4(%esp)
80106e94:	80 
80106e95:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
80106e9c:	e8 9d d2 ff ff       	call   8010413e <initlock>
}
80106ea1:	c9                   	leave  
80106ea2:	c3                   	ret    
...
80106eb0:	00 
80106eb1:	c7 04 24 60 5e 1d 80 	movl   $0x801d5e60,(%esp)
...
80106f01:	0f 84 34 02 00 00    	je     8010713b <trap+0x27c>
      exit();
80106f07:	e8 bb d9 ff ff       	call   801048c7 <exit>
    return;
...
80106f37:	75 31                	jne    80106f6a <trap+0xab>
      acquire(&tickslock);
80106f39:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
80106f40:	e8 1a d2 ff ff       	call   8010415f <acquire>
      ticks++;
80106f45:	a1 60 66 1d 80       	mov    0x801d6660,%eax
80106f4a:	83 c0 01             	add    $0x1,%eax
80106f4d:	a3 60 66 1d 80       	mov    %eax,0x801d6660
      wakeup(&ticks);
80106f52:	c7 04 24 60 66 1d 80 	movl   $0x801d6660,(%esp)
80106f59:	e8 85 de ff ff       	call   80104de3 <wakeup>
      release(&tickslock);
80106f5e:	c7 04 24 20 5e 1d 80 	movl   $0x801d5e20,(%esp)
80106f65:	e8 57 d2 ff ff       	call   801041c1 <release>
    }
    lapiceoi();
80106f6a:	e8 86 bf ff ff       	call   80102ef5 <lapiceoi>
    break;
80106f6f:	e9 41 01 00 00       	jmp    801070b5 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106f74:	e8 84 b7 ff ff       	call   801026fd <ideintr>
    lapiceoi();
80106f79:	e8 77 bf ff ff       	call   80102ef5 <lapiceoi>
    break;
80106f7e:	e9 32 01 00 00       	jmp    801070b5 <trap+0x1f6>
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106f83:	e8 4b bd ff ff       	call   80102cd3 <kbdintr>
    lapiceoi();
80106f88:	e8 68 bf ff ff       	call   80102ef5 <lapiceoi>
    break;
...
80106f92:	e8 a9 03 00 00       	call   80107340 <uartintr>
    lapiceoi();
80106f97:	e8 59 bf ff ff       	call   80102ef5 <lapiceoi>
    break;
...
80106fd0:	e8 cc 93 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106fd5:	e8 1b bf ff ff       	call   80102ef5 <lapiceoi>
    break;
...
801070dc:	75 05                	jne    801070e3 <trap+0x224>
    exit();
801070de:	e8 e4 d7 ff ff       	call   801048c7 <exit>
...
80107104:	75 05                	jne    8010710b <trap+0x24c>
    yield();
80107106:	e8 9e db ff ff       	call   80104ca9 <yield>
...
80107132:	75 08                	jne    8010713c <trap+0x27d>
    exit();
80107134:	e8 8e d7 ff ff       	call   801048c7 <exit>
...
8010722c:	74 6c                	je     8010729a <uartinit+0x10e>
    return;
  uart = 1;
8010722e:	c7 05 90 c6 10 80 01 	movl   $0x1,0x8010c690
80107235:	00 00 00 
...
80107257:	e8 6d c9 ff ff       	call   80103bc9 <picenable>
  ioapicenable(IRQ_COM1, 0);
8010725c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107263:	00 
80107264:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010726b:	e8 12 b7 ff ff       	call   80102982 <ioapicenable>
...
801072a0:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801072a3:	a1 90 c6 10 80       	mov    0x8010c690,%eax
...
801072bc:	e8 59 bc ff ff       	call   80102f1a <microdelay>
{
  int i;
...
801072ff:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107302:	a1 90 c6 10 80       	mov    0x8010c690,%eax
...
80107e45:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107e48:	e8 4c b0 ff ff       	call   80102e99 <cpunum>
80107e4d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107e53:	05 e0 33 11 80       	add    $0x801133e0,%eax
...
801082f5:	e8 11 a8 ff ff       	call   80102b0b <kalloc>
...
80108320:	e8 ad cc ff ff       	call   80104fd2 <memset>
...
801083e8:	e8 1e a7 ff ff       	call   80102b0b <kalloc>
...
80108416:	e8 b7 cb ff ff       	call   80104fd2 <memset>
...
8010843a:	c7 45 f4 e0 c4 10 80 	movl   $0x8010c4e0,-0xc(%ebp)
...
8010848c:	81 7d f4 20 c5 10 80 	cmpl   $0x8010c520,-0xc(%ebp)
...
801084a9:	a3 b8 66 1d 80       	mov    %eax,0x801d66b8
  switchkvm();
...
801084bb:	a1 b8 66 1d 80       	mov    0x801d66b8,%eax
...
801084d6:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801084d9:	e8 c9 bd ff ff       	call   801042a7 <pushcli>
...
80108629:	e8 ee f7 ff ff       	call   80107e1c <lcr3>
  popcli();
8010862e:	e8 bc bc ff ff       	call   801042ef <popcli>
}
...
8010864f:	e8 e9 7e ff ff       	call   8010053d <panic>
  mem = kalloc();
80108654:	e8 b2 a4 ff ff       	call   80102b0b <kalloc>
...
80108672:	e8 5b c9 ff ff       	call   80104fd2 <memset>
...
801086bd:	e8 e3 c9 ff ff       	call   801050a5 <memmove>
}
801086c2:	c9                   	leave  
801086c3:	c3                   	ret    
...
80108784:	e8 e1 95 ff ff       	call   80101d6a <readi>
...
801087ea:	e9 8d 00 00 00       	jmp    8010887c <allocuvm+0xc9>
    mem = kalloc();
801087ef:	e8 17 a3 ff ff       	call   80102b0b <kalloc>
...
8010883f:	e8 8e c7 ff ff       	call   80104fd2 <memset>
...
80108923:	e8 4a a1 ff ff       	call   80102a72 <kfree>
      *pte = 0;
...
801089b8:	e8 b5 a0 ff ff       	call   80102a72 <kfree>
  uint i;
...
801089d0:	e8 9d a0 ff ff       	call   80102a72 <kfree>
}
801089d5:	c9                   	leave  
801089d6:	c3                   	ret    
...
80108a20:	53                   	push   %ebx
80108a21:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108a24:	e8 b8 f9 ff ff       	call   801083e1 <setupkvm>
80108a29:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108a2c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108a30:	75 0a                	jne    80108a3c <copyuvm+0x1f>
    return 0;
80108a32:	b8 00 00 00 00       	mov    $0x0,%eax
80108a37:	e9 fd 00 00 00       	jmp    80108b39 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108a3c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108a43:	e9 cc 00 00 00       	jmp    80108b14 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108a48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a4b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a52:	00 
80108a53:	89 44 24 04          	mov    %eax,0x4(%esp)
80108a57:	8b 45 08             	mov    0x8(%ebp),%eax
80108a5a:	89 04 24             	mov    %eax,(%esp)
80108a5d:	e8 55 f8 ff ff       	call   801082b7 <walkpgdir>
80108a62:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108a65:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108a69:	75 0c                	jne    80108a77 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108a6b:	c7 04 24 9a 92 10 80 	movl   $0x8010929a,(%esp)
80108a72:	e8 c6 7a ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108a77:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a7a:	8b 00                	mov    (%eax),%eax
80108a7c:	83 e0 01             	and    $0x1,%eax
80108a7f:	85 c0                	test   %eax,%eax
80108a81:	75 0c                	jne    80108a8f <copyuvm+0x72>
      panic("copyuvm: page not present");
80108a83:	c7 04 24 b4 92 10 80 	movl   $0x801092b4,(%esp)
...
80108aa1:	25 ff 0f 00 00       	and    $0xfff,%eax
80108aa6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108aa9:	e8 5d a0 ff ff       	call   80102b0b <kalloc>
80108aae:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108ab1:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108ab5:	74 6e                	je     80108b25 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108ab7:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108aba:	89 04 24             	mov    %eax,(%esp)
80108abd:	e8 72 f3 ff ff       	call   80107e34 <p2v>
80108ac2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108ac9:	00 
80108aca:	89 44 24 04          	mov    %eax,0x4(%esp)
80108ace:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108ad1:	89 04 24             	mov    %eax,(%esp)
80108ad4:	e8 cc c5 ff ff       	call   801050a5 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108ad9:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108adc:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108adf:	89 04 24             	mov    %eax,(%esp)
80108ae2:	e8 40 f3 ff ff       	call   80107e27 <v2p>
80108ae7:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108aea:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108aee:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108af2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108af9:	00 
80108afa:	89 54 24 04          	mov    %edx,0x4(%esp)
80108afe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b01:	89 04 24             	mov    %eax,(%esp)
80108b04:	e8 44 f8 ff ff       	call   8010834d <mappages>
80108b09:	85 c0                	test   %eax,%eax
80108b0b:	78 1b                	js     80108b28 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
...
80108b17:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108b1a:	0f 82 28 ff ff ff    	jb     80108a48 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
80108b23:	eb 14                	jmp    80108b39 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108b25:	90                   	nop
80108b26:	eb 01                	jmp    80108b29 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108b28:	90                   	nop
...
bad:
  freevm(d);
80108b29:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b2c:	89 04 24             	mov    %eax,(%esp)
80108b2f:	e8 15 fe ff ff       	call   80108949 <freevm>
  return 0;
80108b34:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108b39:	83 c4 44             	add    $0x44,%esp
80108b3c:	5b                   	pop    %ebx
80108b3d:	5d                   	pop    %ebp
80108b3e:	c3                   	ret    
...
80108b42:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
80108b50:	89 44 24 04          	mov    %eax,0x4(%esp)
80108b54:	8b 45 08             	mov    0x8(%ebp),%eax
80108b57:	89 04 24             	mov    %eax,(%esp)
80108b5a:	e8 58 f7 ff ff       	call   801082b7 <walkpgdir>
80108b5f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108b62:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b65:	8b 00                	mov    (%eax),%eax
80108b67:	83 e0 01             	and    $0x1,%eax
80108b6a:	85 c0                	test   %eax,%eax
80108b6c:	75 07                	jne    80108b75 <uva2ka+0x36>
    return 0;
80108b6e:	b8 00 00 00 00       	mov    $0x0,%eax
80108b73:	eb 25                	jmp    80108b9a <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108b75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108b78:	8b 00                	mov    (%eax),%eax
80108b7a:	83 e0 04             	and    $0x4,%eax
80108b7d:	85 c0                	test   %eax,%eax
80108b7f:	75 07                	jne    80108b88 <uva2ka+0x49>
    return 0;
80108b81:	b8 00 00 00 00       	mov    $0x0,%eax
80108b86:	eb 12                	jmp    80108b9a <uva2ka+0x5b>
...
80108b95:	e8 9a f2 ff ff       	call   80107e34 <p2v>
}
80108b9a:	c9                   	leave  
80108b9b:	c3                   	ret    
...
80108b9f:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
80108ba5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108ba8:	e9 8b 00 00 00       	jmp    80108c38 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108bad:	8b 45 0c             	mov    0xc(%ebp),%eax
80108bb0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108bb5:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108bb8:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108bbb:	89 44 24 04          	mov    %eax,0x4(%esp)
80108bbf:	8b 45 08             	mov    0x8(%ebp),%eax
80108bc2:	89 04 24             	mov    %eax,(%esp)
80108bc5:	e8 75 ff ff ff       	call   80108b3f <uva2ka>
80108bca:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108bcd:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108bd1:	75 07                	jne    80108bda <copyout+0x3e>
      return -1;
80108bd3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108bd8:	eb 6d                	jmp    80108c47 <copyout+0xab>
    n = PGSIZE - (va - va0);
80108bda:	8b 45 0c             	mov    0xc(%ebp),%eax
80108bdd:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108be0:	89 d1                	mov    %edx,%ecx
80108be2:	29 c1                	sub    %eax,%ecx
80108be4:	89 c8                	mov    %ecx,%eax
80108be6:	05 00 10 00 00       	add    $0x1000,%eax
80108beb:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108bee:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108bf1:	3b 45 14             	cmp    0x14(%ebp),%eax
80108bf4:	76 06                	jbe    80108bfc <copyout+0x60>
      n = len;
80108bf6:	8b 45 14             	mov    0x14(%ebp),%eax
80108bf9:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108bfc:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108bff:	8b 55 0c             	mov    0xc(%ebp),%edx
80108c02:	89 d1                	mov    %edx,%ecx
80108c04:	29 c1                	sub    %eax,%ecx
80108c06:	89 c8                	mov    %ecx,%eax
80108c08:	03 45 e8             	add    -0x18(%ebp),%eax
80108c0b:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108c0e:	89 54 24 08          	mov    %edx,0x8(%esp)
80108c12:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108c15:	89 54 24 04          	mov    %edx,0x4(%esp)
80108c19:	89 04 24             	mov    %eax,(%esp)
80108c1c:	e8 84 c4 ff ff       	call   801050a5 <memmove>
    len -= n;
...
80108c3c:	0f 85 6b ff ff ff    	jne    80108bad <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
