...
fmtname(char *path)
{
  ...
  5f:	c7 04 24 30 0f 00 00 	movl   $0xf30,(%esp)
  ...
  8a:	05 30 0f 00 00       	add    $0xf30,%eax
  ...
  return buf;
  a3:	b8 30 0f 00 00       	mov    $0xf30,%eax
}
...
ls(char *path)
{
  ...
  dd:	c7 44 24 04 b3 0b 00 	movl   $0xbb3,0x4(%esp)
  e4:	00 
 ...
 116:	c7 44 24 04 c7 0b 00 	movl   $0xbc7,0x4(%esp)
 11d:	00 
 ...
 181:	c7 44 24 04 db 0b 00 	movl   $0xbdb,0x4(%esp)
 188:	00 
 ...
 1af:	c7 44 24 04 e8 0b 00 	movl   $0xbe8,0x4(%esp)
 1b6:	00 
 ...
 264:	c7 44 24 04 c7 0b 00 	movl   $0xbc7,0x4(%esp)
 26b:	00 
 ...
 2ae:	c7 44 24 04 db 0b 00 	movl   $0xbdb,0x4(%esp)
 2b5:	00 
...
main(int argc, char *argv[])
{
 ...
 30f:	7f 11                	jg     322 <main+0x20>
    ls(".");
 311:	c7 04 24 fb 0b 00 00 	movl   $0xbfb,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d6:	0f b6 90 1c 0f 00 00 	movzbl 0xf1c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 835:	75 27                	jne    85e <printf+0x11f>
          s = "(null)";
 837:	c7 45 f4 fd 0b 00 00 	movl   $0xbfd,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 903:	a1 48 0f 00 00       	mov    0xf48,%eax
...
free(void *ap)
{
 ...
 9c4:	a3 48 0f 00 00       	mov    %eax,0xf48
}
 9c9:	c9                   	leave  
 9ca:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a35:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a38:	a1 48 0f 00 00       	mov    0xf48,%eax
 a3d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a40:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a44:	75 23                	jne    a69 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a46:	c7 45 f0 40 0f 00 00 	movl   $0xf40,-0x10(%ebp)
 a4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a50:	a3 48 0f 00 00       	mov    %eax,0xf48
 a55:	a1 48 0f 00 00       	mov    0xf48,%eax
 a5a:	a3 40 0f 00 00       	mov    %eax,0xf40
    base.s.size = 0;
 a5f:	c7 05 44 0f 00 00 00 	movl   $0x0,0xf44
 a66:	00 00 00 
  }
 ...
 abc:	a3 48 0f 00 00       	mov    %eax,0xf48
      return (void*)(p + 1);
 ...
 ac7:	eb 38                	jmp    b01 <malloc+0xde>
    ...
    if(p == freep)
 ac9:	a1 48 0f 00 00       	mov    0xf48,%eax
...
void parent(void) {
 ...
 b19:	c7 44 24 04 04 0c 00 	movl   $0xc04,0x4(%esp)
 b20:	00 
 ...
 b45:	c7 44 24 04 13 0c 00 	movl   $0xc13,0x4(%esp)
 b4c:	00 
 ...
 b74:	c7 44 24 04 27 0c 00 	movl   $0xc27,0x4(%esp)
 b7b:	00 
...
void ct(void){
 ...
 b91:	83 ec 18             	sub    $0x18,%esp
	...
	printf(1, "In CT: %d\n", createThread());
 b94:	e8 c7 fa ff ff       	call   660 <createThread>
 b99:	89 44 24 08          	mov    %eax,0x8(%esp)
 b9d:	c7 44 24 04 3c 0c 00 	movl   $0xc3c,0x4(%esp)
 ba4:	00 
 ba5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 bac:	e8 8e fb ff ff       	call   73f <printf>
}
 bb1:	c9                   	leave  
 bb2:	c3                   	ret    
