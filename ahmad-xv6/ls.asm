...
fmtname(char *path)
{
  ...
  5f:	c7 04 24 d8 0e 00 00 	movl   $0xed8,(%esp)
  ...
  8a:	05 d8 0e 00 00       	add    $0xed8,%eax
  ...
  return buf;
  a3:	b8 d8 0e 00 00       	mov    $0xed8,%eax
}
...
ls(char *path)
{
  ...
  dd:	c7 44 24 04 86 0b 00 	movl   $0xb86,0x4(%esp)
  e4:	00 
 ...
 116:	c7 44 24 04 9a 0b 00 	movl   $0xb9a,0x4(%esp)
 11d:	00 
 ...
 181:	c7 44 24 04 ae 0b 00 	movl   $0xbae,0x4(%esp)
 188:	00 
 ...
 1af:	c7 44 24 04 bb 0b 00 	movl   $0xbbb,0x4(%esp)
 1b6:	00 
 ...
 264:	c7 44 24 04 9a 0b 00 	movl   $0xb9a,0x4(%esp)
 26b:	00 
 ...
 2ae:	c7 44 24 04 ae 0b 00 	movl   $0xbae,0x4(%esp)
 2b5:	00 
...
main(int argc, char *argv[])
{
 ...
 30f:	7f 11                	jg     322 <main+0x20>
    ls(".");
 311:	c7 04 24 ce 0b 00 00 	movl   $0xbce,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ce:	0f b6 90 c4 0e 00 00 	movzbl 0xec4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 82d:	75 27                	jne    856 <printf+0x11f>
          s = "(null)";
 82f:	c7 45 f4 d0 0b 00 00 	movl   $0xbd0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 8fb:	a1 f0 0e 00 00       	mov    0xef0,%eax
...
free(void *ap)
{
 ...
 9bc:	a3 f0 0e 00 00       	mov    %eax,0xef0
}
 9c1:	c9                   	leave  
 9c2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a0f:	e8 d8 fe ff ff       	call   8ec <free>
  return freep;
 a14:	a1 f0 0e 00 00       	mov    0xef0,%eax
}
 a19:	c9                   	leave  
 a1a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a2d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a30:	a1 f0 0e 00 00       	mov    0xef0,%eax
 a35:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a38:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a3c:	75 23                	jne    a61 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a3e:	c7 45 f0 e8 0e 00 00 	movl   $0xee8,-0x10(%ebp)
 a45:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a48:	a3 f0 0e 00 00       	mov    %eax,0xef0
 a4d:	a1 f0 0e 00 00       	mov    0xef0,%eax
 a52:	a3 e8 0e 00 00       	mov    %eax,0xee8
    base.s.size = 0;
 a57:	c7 05 ec 0e 00 00 00 	movl   $0x0,0xeec
 a5e:	00 00 00 
  }
 ...
 ab4:	a3 f0 0e 00 00       	mov    %eax,0xef0
      return (void*)(p + 1);
 ...
 abf:	eb 38                	jmp    af9 <malloc+0xde>
    ...
    if(p == freep)
 ac1:	a1 f0 0e 00 00       	mov    0xef0,%eax
...
void parent(void) {
 ...
 aff:	53                   	push   %ebx
 b00:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 b03:	e8 a8 fa ff ff       	call   5b0 <fork>
 b08:	89 45 f4             	mov    %eax,-0xc(%ebp)
 b0b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b0f:	79 16                	jns    b27 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 b11:	c7 44 24 04 d7 0b 00 	movl   $0xbd7,0x4(%esp)
 b18:	00 
 b19:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b20:	e8 12 fc ff ff       	call   737 <printf>
 b25:	eb 59                	jmp    b80 <parent+0x84>
        }else if(retval > 0){
 b27:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b2b:	7e 2b                	jle    b58 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 b2d:	e8 06 fb ff ff       	call   638 <getpid>
 b32:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b35:	89 54 24 0c          	mov    %edx,0xc(%esp)
 b39:	89 44 24 08          	mov    %eax,0x8(%esp)
 b3d:	c7 44 24 04 e6 0b 00 	movl   $0xbe6,0x4(%esp)
 b44:	00 
 b45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b4c:	e8 e6 fb ff ff       	call   737 <printf>
                wait();
 b51:	e8 6a fa ff ff       	call   5c0 <wait>
 b56:	eb 28                	jmp    b80 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 b58:	e8 fb fa ff ff       	call   658 <getppid>
 b5d:	89 c3                	mov    %eax,%ebx
 b5f:	e8 d4 fa ff ff       	call   638 <getpid>
 b64:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 b68:	89 44 24 08          	mov    %eax,0x8(%esp)
 b6c:	c7 44 24 04 fa 0b 00 	movl   $0xbfa,0x4(%esp)
 b73:	00 
 b74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b7b:	e8 b7 fb ff ff       	call   737 <printf>
        }

}
 b80:	83 c4 24             	add    $0x24,%esp
 b83:	5b                   	pop    %ebx
 b84:	5d                   	pop    %ebp
 b85:	c3                   	ret    
