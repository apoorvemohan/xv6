...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 5c 15 00 00 	mov    0x155c(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 30 15 00 00 	movl   $0x1530,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 37 15 00 	movl   $0x1537,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 47 15 00 	movl   $0x1547,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 57 15 00 00 	movl   $0x1557,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 74 15 00 	movl   $0x1574,0x4(%esp)
     216:	00 
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 77 15 00 00 	movl   $0x1577,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2af:	0f b6 05 20 1b 00 00 	movzbl 0x1b20,%eax
     2b6:	3c 63                	cmp    $0x63,%al
     2b8:	75 5a                	jne    314 <main+0xad>
     2ba:	0f b6 05 21 1b 00 00 	movzbl 0x1b21,%eax
     2c1:	3c 64                	cmp    $0x64,%al
     2c3:	75 4f                	jne    314 <main+0xad>
     2c5:	0f b6 05 22 1b 00 00 	movzbl 0x1b22,%eax
     2cc:	3c 20                	cmp    $0x20,%al
     2ce:	75 44                	jne    314 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2d0:	c7 04 24 20 1b 00 00 	movl   $0x1b20,(%esp)
     2d7:	e8 ba 0a 00 00       	call   d96 <strlen>
     2dc:	83 e8 01             	sub    $0x1,%eax
     2df:	c6 80 20 1b 00 00 00 	movb   $0x0,0x1b20(%eax)
      if(chdir(buf+3) < 0)
     2e6:	c7 04 24 23 1b 00 00 	movl   $0x1b23,(%esp)
     2ed:	e8 de 0c 00 00       	call   fd0 <chdir>
     2f2:	85 c0                	test   %eax,%eax
     2f4:	79 42                	jns    338 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f6:	c7 44 24 08 23 1b 00 	movl   $0x1b23,0x8(%esp)
     2fd:	00 
     2fe:	c7 44 24 04 7f 15 00 	movl   $0x157f,0x4(%esp)
     305:	00 
    ...
    if(fork1() == 0)
     ...
     31b:	75 14                	jne    331 <main+0xca>
      runcmd(parsecmd(buf));
     31d:	c7 04 24 20 1b 00 00 	movl   $0x1b20,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     340:	00 
     341:	c7 04 24 20 1b 00 00 	movl   $0x1b20,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 8d 15 00 	movl   $0x158d,0x4(%esp)
     36e:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 91 15 00 00 	movl   $0x1591,(%esp)
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 fc 1a 00 00 	movl   $0x1afc,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 fc 1a 00 00 	movl   $0x1afc,(%esp)
     ...
     61e:	c7 04 24 02 1b 00 00 	movl   $0x1b02,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 fc 1a 00 00 	movl   $0x1afc,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 fc 1a 00 00 	movl   $0x1afc,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 96 15 00 	movl   $0x1596,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 97 15 00 	movl   $0x1597,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 81 09 00 00       	call   10df <printf>
    panic("syntax");
     75e:	c7 04 24 a6 15 00 00 	movl   $0x15a6,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 ad 15 00 	movl   $0x15ad,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 af 15 00 	movl   $0x15af,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 b1 15 00 	movl   $0x15b1,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 b3 15 00 00 	movl   $0x15b3,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 d0 15 00 	movl   $0x15d0,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 d3 15 00 	movl   $0x15d3,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 d5 15 00 00 	movl   $0x15d5,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 e0 15 00 	movl   $0x15e0,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 e2 15 00 00 	movl   $0x15e2,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 d3 15 00 	movl   $0x15d3,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 a6 15 00 00 	movl   $0x15a6,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 f5 15 00 00 	movl   $0x15f5,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 03 16 00 	movl   $0x1603,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 08 16 00 00 	mov    0x1608(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1076:	0f b6 90 0c 1b 00 00 	movzbl 0x1b0c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11d5:	75 27                	jne    11fe <printf+0x11f>
          s = "(null)";
    11d7:	c7 45 f4 20 16 00 00 	movl   $0x1620,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12a3:	a1 8c 1b 00 00       	mov    0x1b8c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1364:	a3 8c 1b 00 00       	mov    %eax,0x1b8c
}
    1369:	c9                   	leave  
    136a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13bc:	a1 8c 1b 00 00       	mov    0x1b8c,%eax
}
    13c1:	c9                   	leave  
    13c2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    13d8:	a1 8c 1b 00 00       	mov    0x1b8c,%eax
    13dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    13e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    13e4:	75 23                	jne    1409 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    13e6:	c7 45 f0 84 1b 00 00 	movl   $0x1b84,-0x10(%ebp)
    13ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13f0:	a3 8c 1b 00 00       	mov    %eax,0x1b8c
    13f5:	a1 8c 1b 00 00       	mov    0x1b8c,%eax
    13fa:	a3 84 1b 00 00       	mov    %eax,0x1b84
    base.s.size = 0;
    13ff:	c7 05 88 1b 00 00 00 	movl   $0x0,0x1b88
    1406:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    145c:	a3 8c 1b 00 00       	mov    %eax,0x1b8c
      return (void*)(p + 1);
    ...
    if(p == freep)
    1469:	a1 8c 1b 00 00       	mov    0x1b8c,%eax
...
void parent(void) {
	...
	int retval;
        ...
        if((retval = fork()) < 0){
    14ab:	e8 a8 fa ff ff       	call   f58 <fork>
    14b0:	89 45 f4             	mov    %eax,-0xc(%ebp)
    14b3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14b7:	79 16                	jns    14cf <parent+0x2b>
                printf(1, "FORK FAILED!!!");
    14b9:	c7 44 24 04 27 16 00 	movl   $0x1627,0x4(%esp)
    14c0:	00 
    14c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14c8:	e8 12 fc ff ff       	call   10df <printf>
    14cd:	eb 59                	jmp    1528 <parent+0x84>
        }else if(retval > 0){
    14cf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14d3:	7e 2b                	jle    1500 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
    14d5:	e8 06 fb ff ff       	call   fe0 <getpid>
    14da:	8b 55 f4             	mov    -0xc(%ebp),%edx
    14dd:	89 54 24 0c          	mov    %edx,0xc(%esp)
    14e1:	89 44 24 08          	mov    %eax,0x8(%esp)
    14e5:	c7 44 24 04 36 16 00 	movl   $0x1636,0x4(%esp)
    14ec:	00 
    14ed:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f4:	e8 e6 fb ff ff       	call   10df <printf>
                wait();
    14f9:	e8 6a fa ff ff       	call   f68 <wait>
    14fe:	eb 28                	jmp    1528 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
    1500:	e8 fb fa ff ff       	call   1000 <getppid>
    1505:	89 c3                	mov    %eax,%ebx
    1507:	e8 d4 fa ff ff       	call   fe0 <getpid>
    150c:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    1510:	89 44 24 08          	mov    %eax,0x8(%esp)
    1514:	c7 44 24 04 4a 16 00 	movl   $0x164a,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1523:	e8 b7 fb ff ff       	call   10df <printf>
        }

}
    1528:	83 c4 24             	add    $0x24,%esp
    152b:	5b                   	pop    %ebx
    152c:	5d                   	pop    %ebp
    152d:	c3                   	ret    
