...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 9c 16 00 00 	mov    0x169c(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 70 16 00 00 	movl   $0x1670,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 77 16 00 	movl   $0x1677,0x4(%esp)
      6e:	00 
      6f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      76:	e8 bc 10 00 00       	call   1137 <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 87 16 00 	movl   $0x1687,0x4(%esp)
      c1:	00 
      c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      c9:	e8 69 10 00 00       	call   1137 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 97 16 00 00 	movl   $0x1697,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 b4 16 00 	movl   $0x16b4,0x4(%esp)
     216:	00 
     217:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     21e:	e8 14 0f 00 00       	call   1137 <printf>
  memset(buf, 0, nbuf);
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 b7 16 00 00 	movl   $0x16b7,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2af:	0f b6 05 c0 1d 00 00 	movzbl 0x1dc0,%eax
     2b6:	3c 63                	cmp    $0x63,%al
     2b8:	75 5a                	jne    314 <main+0xad>
     2ba:	0f b6 05 c1 1d 00 00 	movzbl 0x1dc1,%eax
     2c1:	3c 64                	cmp    $0x64,%al
     2c3:	75 4f                	jne    314 <main+0xad>
     2c5:	0f b6 05 c2 1d 00 00 	movzbl 0x1dc2,%eax
     2cc:	3c 20                	cmp    $0x20,%al
     2ce:	75 44                	jne    314 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2d0:	c7 04 24 c0 1d 00 00 	movl   $0x1dc0,(%esp)
     2d7:	e8 ba 0a 00 00       	call   d96 <strlen>
     2dc:	83 e8 01             	sub    $0x1,%eax
     2df:	c6 80 c0 1d 00 00 00 	movb   $0x0,0x1dc0(%eax)
      if(chdir(buf+3) < 0)
     2e6:	c7 04 24 c3 1d 00 00 	movl   $0x1dc3,(%esp)
     2ed:	e8 de 0c 00 00       	call   fd0 <chdir>
     2f2:	85 c0                	test   %eax,%eax
     2f4:	79 42                	jns    338 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f6:	c7 44 24 08 c3 1d 00 	movl   $0x1dc3,0x8(%esp)
     2fd:	00 
     2fe:	c7 44 24 04 bf 16 00 	movl   $0x16bf,0x4(%esp)
     305:	00 
     306:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     30d:	e8 25 0e 00 00       	call   1137 <printf>
      continue;
    ...
    if(fork1() == 0)
     ...
     31b:	75 14                	jne    331 <main+0xca>
      runcmd(parsecmd(buf));
     31d:	c7 04 24 c0 1d 00 00 	movl   $0x1dc0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     340:	00 
     341:	c7 04 24 c0 1d 00 00 	movl   $0x1dc0,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 cd 16 00 	movl   $0x16cd,0x4(%esp)
     36e:	00 
     36f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     376:	e8 bc 0d 00 00       	call   1137 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 d1 16 00 00 	movl   $0x16d1,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b2:	e8 64 10 00 00       	call   141b <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3f0:	e8 26 10 00 00       	call   141b <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     45b:	e8 bb 0f 00 00       	call   141b <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4ab:	e8 6b 0f 00 00       	call   141b <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4fb:	e8 1b 0f 00 00       	call   141b <malloc>
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 88 1d 00 00 	movl   $0x1d88,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 88 1d 00 00 	movl   $0x1d88,(%esp)
     ...
     61e:	c7 04 24 8e 1d 00 00 	movl   $0x1d8e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 88 1d 00 00 	movl   $0x1d88,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 88 1d 00 00 	movl   $0x1d88,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 d6 16 00 	movl   $0x16d6,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 d7 16 00 	movl   $0x16d7,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 d9 09 00 00       	call   1137 <printf>
    panic("syntax");
     75e:	c7 04 24 e6 16 00 00 	movl   $0x16e6,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 ed 16 00 	movl   $0x16ed,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 ef 16 00 	movl   $0x16ef,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 f1 16 00 	movl   $0x16f1,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 f3 16 00 00 	movl   $0x16f3,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 10 17 00 	movl   $0x1710,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 13 17 00 	movl   $0x1713,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 15 17 00 00 	movl   $0x1715,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 20 17 00 	movl   $0x1720,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 22 17 00 00 	movl   $0x1722,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 13 17 00 	movl   $0x1713,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 e6 16 00 00 	movl   $0x16e6,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 35 17 00 00 	movl   $0x1735,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 43 17 00 	movl   $0x1743,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 48 17 00 00 	mov    0x1748(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
    ...
    1063:	83 ec 28             	sub    $0x28,%esp
    1066:	8b 45 0c             	mov    0xc(%ebp),%eax
    1069:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    106c:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    1073:	00 
    1074:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1077:	89 44 24 04          	mov    %eax,0x4(%esp)
    107b:	8b 45 08             	mov    0x8(%ebp),%eax
    107e:	89 04 24             	mov    %eax,(%esp)
    1081:	e8 fa fe ff ff       	call   f80 <write>
}
    1086:	c9                   	leave  
    1087:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    1095:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    1099:	74 17                	je     10b2 <printint+0x2a>
    109b:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    109f:	79 11                	jns    10b2 <printint+0x2a>
    neg = 1;
    10a1:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    10a8:	8b 45 0c             	mov    0xc(%ebp),%eax
    10ab:	f7 d8                	neg    %eax
    10ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10b0:	eb 06                	jmp    10b8 <printint+0x30>
  } else {
    x = xx;
    10b2:	8b 45 0c             	mov    0xc(%ebp),%eax
    10b5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    10b8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    10bf:	8b 4d 10             	mov    0x10(%ebp),%ecx
    10c2:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10c5:	ba 00 00 00 00       	mov    $0x0,%edx
    10ca:	f7 f1                	div    %ecx
    10cc:	89 d0                	mov    %edx,%eax
    10ce:	0f b6 90 98 1d 00 00 	movzbl 0x1d98(%eax),%edx
    10d5:	8d 45 dc             	lea    -0x24(%ebp),%eax
    10d8:	03 45 f4             	add    -0xc(%ebp),%eax
    10db:	88 10                	mov    %dl,(%eax)
    10dd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    10e1:	8b 55 10             	mov    0x10(%ebp),%edx
    10e4:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    10e7:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10ea:	ba 00 00 00 00       	mov    $0x0,%edx
    10ef:	f7 75 d4             	divl   -0x2c(%ebp)
    10f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10f5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    10f9:	75 c4                	jne    10bf <printint+0x37>
  if(neg)
    10fb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    10ff:	74 2a                	je     112b <printint+0xa3>
    buf[i++] = '-';
    1101:	8d 45 dc             	lea    -0x24(%ebp),%eax
    1104:	03 45 f4             	add    -0xc(%ebp),%eax
    1107:	c6 00 2d             	movb   $0x2d,(%eax)
    110a:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    110e:	eb 1b                	jmp    112b <printint+0xa3>
    putc(fd, buf[i]);
    1110:	8d 45 dc             	lea    -0x24(%ebp),%eax
    1113:	03 45 f4             	add    -0xc(%ebp),%eax
    ...
    1126:	e8 35 ff ff ff       	call   1060 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    1133:	79 db                	jns    1110 <printint+0x88>
    putc(fd, buf[i]);
}
    1135:	c9                   	leave  
    1136:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    113a:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    113d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1144:	8d 45 0c             	lea    0xc(%ebp),%eax
    1147:	83 c0 04             	add    $0x4,%eax
    114a:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    114d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1154:	e9 7d 01 00 00       	jmp    12d6 <printf+0x19f>
    c = fmt[i] & 0xff;
    1159:	8b 55 0c             	mov    0xc(%ebp),%edx
    115c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    115f:	01 d0                	add    %edx,%eax
    1161:	0f b6 00             	movzbl (%eax),%eax
    1164:	0f be c0             	movsbl %al,%eax
    1167:	25 ff 00 00 00       	and    $0xff,%eax
    116c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    116f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1173:	75 2c                	jne    11a1 <printf+0x6a>
      if(c == '%'){
    1175:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1179:	75 0c                	jne    1187 <printf+0x50>
        state = '%';
    117b:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1182:	e9 4b 01 00 00       	jmp    12d2 <printf+0x19b>
      } else {
        putc(fd, c);
    1187:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    118a:	0f be c0             	movsbl %al,%eax
    118d:	89 44 24 04          	mov    %eax,0x4(%esp)
    1191:	8b 45 08             	mov    0x8(%ebp),%eax
    1194:	89 04 24             	mov    %eax,(%esp)
    1197:	e8 c4 fe ff ff       	call   1060 <putc>
    119c:	e9 31 01 00 00       	jmp    12d2 <printf+0x19b>
      }
    } else if(state == '%'){
    11a1:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    11a5:	0f 85 27 01 00 00    	jne    12d2 <printf+0x19b>
      if(c == 'd'){
    11ab:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    11af:	75 2d                	jne    11de <printf+0xa7>
        printint(fd, *ap, 10, 1);
    11b1:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11b4:	8b 00                	mov    (%eax),%eax
    11b6:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    11bd:	00 
    11be:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    11c5:	00 
    11c6:	89 44 24 04          	mov    %eax,0x4(%esp)
    11ca:	8b 45 08             	mov    0x8(%ebp),%eax
    11cd:	89 04 24             	mov    %eax,(%esp)
    11d0:	e8 b3 fe ff ff       	call   1088 <printint>
        ap++;
    11d5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11d9:	e9 ed 00 00 00       	jmp    12cb <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    11de:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    11e2:	74 06                	je     11ea <printf+0xb3>
    11e4:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    11e8:	75 2d                	jne    1217 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    11ea:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11ed:	8b 00                	mov    (%eax),%eax
    11ef:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    11f6:	00 
    11f7:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    11fe:	00 
    11ff:	89 44 24 04          	mov    %eax,0x4(%esp)
    1203:	8b 45 08             	mov    0x8(%ebp),%eax
    1206:	89 04 24             	mov    %eax,(%esp)
    1209:	e8 7a fe ff ff       	call   1088 <printint>
        ap++;
    120e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1212:	e9 b4 00 00 00       	jmp    12cb <printf+0x194>
      } else if(c == 's'){
    1217:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    121b:	75 46                	jne    1263 <printf+0x12c>
        s = (char*)*ap;
    121d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1220:	8b 00                	mov    (%eax),%eax
    1222:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    1225:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    1229:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    122d:	75 27                	jne    1256 <printf+0x11f>
          s = "(null)";
    122f:	c7 45 f4 60 17 00 00 	movl   $0x1760,-0xc(%ebp)
        while(*s != 0){
    1236:	eb 1e                	jmp    1256 <printf+0x11f>
          putc(fd, *s);
    ...
    124b:	e8 10 fe ff ff       	call   1060 <putc>
          s++;
    1250:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    1254:	eb 01                	jmp    1257 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    125f:	75 d7                	jne    1238 <printf+0x101>
    1261:	eb 68                	jmp    12cb <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1263:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1267:	75 1d                	jne    1286 <printf+0x14f>
        putc(fd, *ap);
    1269:	8b 45 e8             	mov    -0x18(%ebp),%eax
    126c:	8b 00                	mov    (%eax),%eax
    126e:	0f be c0             	movsbl %al,%eax
    1271:	89 44 24 04          	mov    %eax,0x4(%esp)
    1275:	8b 45 08             	mov    0x8(%ebp),%eax
    1278:	89 04 24             	mov    %eax,(%esp)
    127b:	e8 e0 fd ff ff       	call   1060 <putc>
        ap++;
    1280:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1284:	eb 45                	jmp    12cb <printf+0x194>
      } else if(c == '%'){
    1286:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    128a:	75 17                	jne    12a3 <printf+0x16c>
        putc(fd, c);
    ...
    129c:	e8 bf fd ff ff       	call   1060 <putc>
    12a1:	eb 28                	jmp    12cb <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    12a3:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    12aa:	00 
    12ab:	8b 45 08             	mov    0x8(%ebp),%eax
    12ae:	89 04 24             	mov    %eax,(%esp)
    12b1:	e8 aa fd ff ff       	call   1060 <putc>
        putc(fd, c);
    12b6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    12b9:	0f be c0             	movsbl %al,%eax
    12bc:	89 44 24 04          	mov    %eax,0x4(%esp)
    12c0:	8b 45 08             	mov    0x8(%ebp),%eax
    12c3:	89 04 24             	mov    %eax,(%esp)
    12c6:	e8 95 fd ff ff       	call   1060 <putc>
      }
      state = 0;
    12cb:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    12d2:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    12d6:	8b 55 0c             	mov    0xc(%ebp),%edx
    12d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    12dc:	01 d0                	add    %edx,%eax
    12de:	0f b6 00             	movzbl (%eax),%eax
    12e1:	84 c0                	test   %al,%al
    12e3:	0f 85 70 fe ff ff    	jne    1159 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12fb:	a1 2c 1e 00 00       	mov    0x1e2c,%eax
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    13c9:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    13d0:	77 07                	ja     13d9 <morecore+0x16>
    nu = 4096;
    13d2:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    13d9:	8b 45 08             	mov    0x8(%ebp),%eax
    13dc:	c1 e0 03             	shl    $0x3,%eax
    13df:	89 04 24             	mov    %eax,(%esp)
    13e2:	e8 01 fc ff ff       	call   fe8 <sbrk>
    13e7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    13ea:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    13ee:	75 07                	jne    13f7 <morecore+0x34>
    return 0;
    13f0:	b8 00 00 00 00       	mov    $0x0,%eax
    13f5:	eb 22                	jmp    1419 <morecore+0x56>
  hp = (Header*)p;
    13f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13fa:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    13fd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1400:	8b 55 08             	mov    0x8(%ebp),%edx
    1403:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1406:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1409:	83 c0 08             	add    $0x8,%eax
    140c:	89 04 24             	mov    %eax,(%esp)
    140f:	e8 d8 fe ff ff       	call   12ec <free>
  return freep;
    1414:	a1 2c 1e 00 00       	mov    0x1e2c,%eax
}
    1419:	c9                   	leave  
    141a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1424:	83 c0 07             	add    $0x7,%eax
    1427:	c1 e8 03             	shr    $0x3,%eax
    142a:	83 c0 01             	add    $0x1,%eax
    142d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1430:	a1 2c 1e 00 00       	mov    0x1e2c,%eax
    1435:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1438:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    143c:	75 23                	jne    1461 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    143e:	c7 45 f0 24 1e 00 00 	movl   $0x1e24,-0x10(%ebp)
    1445:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1448:	a3 2c 1e 00 00       	mov    %eax,0x1e2c
    144d:	a1 2c 1e 00 00       	mov    0x1e2c,%eax
    1452:	a3 24 1e 00 00       	mov    %eax,0x1e24
    base.s.size = 0;
    1457:	c7 05 28 1e 00 00 00 	movl   $0x0,0x1e28
    145e:	00 00 00 
  }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14f4:	e9 70 ff ff ff       	jmp    1469 <malloc+0x4e>
}
    14f9:	c9                   	leave  
    14fa:	c3                   	ret    
    14fb:	90                   	nop
...
void wrapper(qthread_func_ptr_t func, void *arg) {
    ...
    14ff:	83 ec 18             	sub    $0x18,%esp

    func(arg);
    1502:	8b 45 0c             	mov    0xc(%ebp),%eax
    1505:	89 04 24             	mov    %eax,(%esp)
    1508:	8b 45 08             	mov    0x8(%ebp),%eax
    150b:	ff d0                	call   *%eax
    exit();
    150d:	e8 4e fa ff ff       	call   f60 <exit>

00001512 <qthread_create>:
}
...
int qthread_create(qthread_t *thread, qthread_func_ptr_t my_func, void *arg) {
    ...
    *thread = (qthread_t)malloc(sizeof(int));
    151b:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
    1522:	e8 f4 fe ff ff       	call   141b <malloc>
    1527:	89 c2                	mov    %eax,%edx
    1529:	8b 45 08             	mov    0x8(%ebp),%eax
    152c:	89 10                	mov    %edx,(%eax)
    *thread = kthread_create((int)((char*)malloc(THREADSTACKSIZE) + THREADSTACKSIZE), (int)wrapper, (int)my_func, *(int*)arg);
    152e:	8b 45 10             	mov    0x10(%ebp),%eax
    1531:	8b 38                	mov    (%eax),%edi
    1533:	8b 75 0c             	mov    0xc(%ebp),%esi
    1536:	bb fc 14 00 00       	mov    $0x14fc,%ebx
    153b:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    1542:	e8 d4 fe ff ff       	call   141b <malloc>
    1547:	05 00 10 00 00       	add    $0x1000,%eax
    154c:	89 7c 24 0c          	mov    %edi,0xc(%esp)
    1550:	89 74 24 08          	mov    %esi,0x8(%esp)
    1554:	89 5c 24 04          	mov    %ebx,0x4(%esp)
    1558:	89 04 24             	mov    %eax,(%esp)
    155b:	e8 a0 fa ff ff       	call   1000 <kthread_create>
    1560:	8b 55 08             	mov    0x8(%ebp),%edx
    1563:	89 02                	mov    %eax,(%edx)
    return *thread;
    1565:	8b 45 08             	mov    0x8(%ebp),%eax
    1568:	8b 00                	mov    (%eax),%eax
}
    156a:	83 c4 1c             	add    $0x1c,%esp
    156d:	5b                   	pop    %ebx
    156e:	5e                   	pop    %esi
    156f:	5f                   	pop    %edi
    1570:	5d                   	pop    %ebp
...
int qthread_join(qthread_t thread, void **retval){
    ...
    1585:	e8 7e fa ff ff       	call   1008 <kthread_join>
...
int qthread_mutex_init(qthread_mutex_t *mutex){
	...
	*mutex = kthread_mutex_init();
    1598:	e8 73 fa ff ff       	call   1010 <kthread_mutex_init>
    159d:	8b 55 08             	mov    0x8(%ebp),%edx
    15a0:	89 02                	mov    %eax,(%edx)
	if (*mutex > 0){
    15a2:	8b 45 08             	mov    0x8(%ebp),%eax
    15a5:	8b 00                	mov    (%eax),%eax
    15a7:	85 c0                	test   %eax,%eax
    15a9:	7e 07                	jle    15b2 <qthread_mutex_init+0x20>
		return 0;
    15ab:	b8 00 00 00 00       	mov    $0x0,%eax
    15b0:	eb 05                	jmp    15b7 <qthread_mutex_init+0x25>
	}
	return *mutex;
...
000015b9 <qthread_mutex_destroy>:
...
int qthread_mutex_destroy(qthread_mutex_t *mutex){
    ...
    15c5:	e8 4e fa ff ff       	call   1018 <kthread_mutex_destroy>
    15ca:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if (val < 0){
    15cd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    15d1:	79 07                	jns    15da <qthread_mutex_destroy+0x21>
    	return -1;
    15d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    15d8:	eb 05                	jmp    15df <qthread_mutex_destroy+0x26>
    }
    return 0;
...
000015e1 <qthread_mutex_lock>:

int qthread_mutex_lock(qthread_mutex_t *mutex){
    15e1:	55                   	push   %ebp
    15e2:	89 e5                	mov    %esp,%ebp
    15e4:	83 ec 28             	sub    $0x28,%esp
    int val = kthread_mutex_lock((int)mutex);
    15e7:	8b 45 08             	mov    0x8(%ebp),%eax
    15ea:	89 04 24             	mov    %eax,(%esp)
    15ed:	e8 2e fa ff ff       	call   1020 <kthread_mutex_lock>
    15f2:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if (val < 0){
    15f5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    15f9:	79 07                	jns    1602 <qthread_mutex_lock+0x21>
    	return -1;
    15fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1600:	eb 05                	jmp    1607 <qthread_mutex_lock+0x26>
    }
    return 0;
...
0000164f <qthread_cond_broadcast>:
