...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 88 15 00 00 	mov    0x1588(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 63 15 00 	movl   $0x1563,0x4(%esp)
      6e:	00 
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 73 15 00 	movl   $0x1573,0x4(%esp)
      c1:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 83 15 00 00 	movl   $0x1583,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 a0 15 00 	movl   $0x15a0,0x4(%esp)
     216:	00 
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 a3 15 00 00 	movl   $0x15a3,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2af:	0f b6 05 80 1b 00 00 	movzbl 0x1b80,%eax
     2b6:	3c 63                	cmp    $0x63,%al
     2b8:	75 5a                	jne    314 <main+0xad>
     2ba:	0f b6 05 81 1b 00 00 	movzbl 0x1b81,%eax
     2c1:	3c 64                	cmp    $0x64,%al
     2c3:	75 4f                	jne    314 <main+0xad>
     2c5:	0f b6 05 82 1b 00 00 	movzbl 0x1b82,%eax
     2cc:	3c 20                	cmp    $0x20,%al
     2ce:	75 44                	jne    314 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2d0:	c7 04 24 80 1b 00 00 	movl   $0x1b80,(%esp)
     2d7:	e8 ba 0a 00 00       	call   d96 <strlen>
     2dc:	83 e8 01             	sub    $0x1,%eax
     2df:	c6 80 80 1b 00 00 00 	movb   $0x0,0x1b80(%eax)
      if(chdir(buf+3) < 0)
     2e6:	c7 04 24 83 1b 00 00 	movl   $0x1b83,(%esp)
     2ed:	e8 de 0c 00 00       	call   fd0 <chdir>
     2f2:	85 c0                	test   %eax,%eax
     2f4:	79 42                	jns    338 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f6:	c7 44 24 08 83 1b 00 	movl   $0x1b83,0x8(%esp)
     2fd:	00 
     2fe:	c7 44 24 04 ab 15 00 	movl   $0x15ab,0x4(%esp)
     305:	00 
    ...
    if(fork1() == 0)
     ...
     31b:	75 14                	jne    331 <main+0xca>
      runcmd(parsecmd(buf));
     31d:	c7 04 24 80 1b 00 00 	movl   $0x1b80,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     340:	00 
     341:	c7 04 24 80 1b 00 00 	movl   $0x1b80,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 b9 15 00 	movl   $0x15b9,0x4(%esp)
     36e:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 bd 15 00 00 	movl   $0x15bd,(%esp)
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 54 1b 00 00 	movl   $0x1b54,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 54 1b 00 00 	movl   $0x1b54,(%esp)
     ...
     61e:	c7 04 24 5a 1b 00 00 	movl   $0x1b5a,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 54 1b 00 00 	movl   $0x1b54,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 54 1b 00 00 	movl   $0x1b54,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 c2 15 00 	movl   $0x15c2,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 c3 15 00 	movl   $0x15c3,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 89 09 00 00       	call   10e7 <printf>
    panic("syntax");
     75e:	c7 04 24 d2 15 00 00 	movl   $0x15d2,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 d9 15 00 	movl   $0x15d9,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 db 15 00 	movl   $0x15db,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 dd 15 00 	movl   $0x15dd,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 df 15 00 00 	movl   $0x15df,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 fc 15 00 	movl   $0x15fc,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 ff 15 00 	movl   $0x15ff,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 01 16 00 00 	movl   $0x1601,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 0c 16 00 	movl   $0x160c,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 0e 16 00 00 	movl   $0x160e,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 ff 15 00 	movl   $0x15ff,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 d2 15 00 00 	movl   $0x15d2,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 21 16 00 00 	movl   $0x1621,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 2f 16 00 	movl   $0x162f,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 34 16 00 00 	mov    0x1634(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    107e:	0f b6 90 64 1b 00 00 	movzbl 0x1b64(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11dd:	75 27                	jne    1206 <printf+0x11f>
          s = "(null)";
    11df:	c7 45 f4 4c 16 00 00 	movl   $0x164c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12ab:	a1 ec 1b 00 00       	mov    0x1bec,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    136c:	a3 ec 1b 00 00       	mov    %eax,0x1bec
}
    1371:	c9                   	leave  
    1372:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13c4:	a1 ec 1b 00 00       	mov    0x1bec,%eax
}
    13c9:	c9                   	leave  
    13ca:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    13e0:	a1 ec 1b 00 00       	mov    0x1bec,%eax
    13e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    13e8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    13ec:	75 23                	jne    1411 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    13ee:	c7 45 f0 e4 1b 00 00 	movl   $0x1be4,-0x10(%ebp)
    13f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13f8:	a3 ec 1b 00 00       	mov    %eax,0x1bec
    13fd:	a1 ec 1b 00 00       	mov    0x1bec,%eax
    1402:	a3 e4 1b 00 00       	mov    %eax,0x1be4
    base.s.size = 0;
    1407:	c7 05 e8 1b 00 00 00 	movl   $0x0,0x1be8
    140e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1464:	a3 ec 1b 00 00       	mov    %eax,0x1bec
      return (void*)(p + 1);
    ...
    if(p == freep)
    1471:	a1 ec 1b 00 00       	mov    0x1bec,%eax
...
void parent(void) {
    ...
    14c1:	c7 44 24 04 53 16 00 	movl   $0x1653,0x4(%esp)
    14c8:	00 
    ...
    14ed:	c7 44 24 04 62 16 00 	movl   $0x1662,0x4(%esp)
    14f4:	00 
    ...
    151c:	c7 44 24 04 76 16 00 	movl   $0x1676,0x4(%esp)
    1523:	00 
...
void ct(void){
	...
	printf(1, "In CT: %d\n", createThread());
    153c:	e8 c7 fa ff ff       	call   1008 <createThread>
    1541:	89 44 24 08          	mov    %eax,0x8(%esp)
    1545:	c7 44 24 04 8b 16 00 	movl   $0x168b,0x4(%esp)
    154c:	00 
    154d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1554:	e8 8e fb ff ff       	call   10e7 <printf>
}
    1559:	c9                   	leave  
    155a:	c3                   	ret    
