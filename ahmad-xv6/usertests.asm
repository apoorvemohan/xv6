...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 b0 63 00 00       	mov    0x63b0,%eax
       b:	c7 44 24 04 aa 44 00 	movl   $0x44aa,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 28 40 00 00       	call   4043 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 b5 44 00 00 	movl   $0x44b5,(%esp)
      22:	e8 05 3f 00 00       	call   3f2c <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 b0 63 00 00       	mov    0x63b0,%eax
      30:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 03 40 00 00       	call   4043 <printf>
    exit();
      40:	e8 7f 3e 00 00       	call   3ec4 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 b5 44 00 00 	movl   $0x44b5,(%esp)
      4c:	e8 e3 3e 00 00       	call   3f34 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 b0 63 00 00       	mov    0x63b0,%eax
      5a:	c7 44 24 04 cb 44 00 	movl   $0x44cb,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 d9 3f 00 00       	call   4043 <printf>
    exit();
      6a:	e8 55 3e 00 00       	call   3ec4 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 e1 44 00 00 	movl   $0x44e1,(%esp)
      76:	e8 99 3e 00 00       	call   3f14 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 b0 63 00 00       	mov    0x63b0,%eax
      84:	c7 44 24 04 ec 44 00 	movl   $0x44ec,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 af 3f 00 00       	call   4043 <printf>
    exit();
      94:	e8 2b 3e 00 00       	call   3ec4 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 06 45 00 00 	movl   $0x4506,(%esp)
      a0:	e8 8f 3e 00 00       	call   3f34 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 b0 63 00 00       	mov    0x63b0,%eax
      ae:	c7 44 24 04 08 45 00 	movl   $0x4508,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 85 3f 00 00       	call   4043 <printf>
    exit();
      be:	e8 01 3e 00 00       	call   3ec4 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 b0 63 00 00       	mov    0x63b0,%eax
      c8:	c7 44 24 04 18 45 00 	movl   $0x4518,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 6b 3f 00 00       	call   4043 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 b0 63 00 00       	mov    0x63b0,%eax
      e5:	c7 44 24 04 26 45 00 	movl   $0x4526,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 4e 3f 00 00       	call   4043 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 b0 63 00 00       	mov    0x63b0,%eax
     108:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 2b 3f 00 00       	call   4043 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 b5 44 00 00 	movl   $0x44b5,(%esp)
     12e:	e8 f9 3d 00 00       	call   3f2c <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 b0 63 00 00       	mov    0x63b0,%eax
     13c:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 f7 3e 00 00       	call   4043 <printf>
      exit();
     14c:	e8 73 3d 00 00       	call   3ec4 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 b5 44 00 00 	movl   $0x44b5,(%esp)
     158:	e8 d7 3d 00 00       	call   3f34 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 b0 63 00 00       	mov    0x63b0,%eax
     166:	c7 44 24 04 42 45 00 	movl   $0x4542,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 cd 3e 00 00       	call   4043 <printf>
      exit();
     176:	e8 49 3d 00 00       	call   3ec4 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 e1 44 00 00 	movl   $0x44e1,(%esp)
     182:	e8 8d 3d 00 00       	call   3f14 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 b0 63 00 00       	mov    0x63b0,%eax
     190:	c7 44 24 04 ec 44 00 	movl   $0x44ec,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 a3 3e 00 00       	call   4043 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 b0 63 00 00       	mov    0x63b0,%eax
     1b4:	c7 44 24 04 56 45 00 	movl   $0x4556,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 7f 3e 00 00       	call   4043 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 b0 63 00 00       	mov    0x63b0,%eax
     1d1:	c7 44 24 04 68 45 00 	movl   $0x4568,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 62 3e 00 00       	call   4043 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 77 45 00 00 	movl   $0x4577,(%esp)
     1e8:	e8 3f 3d 00 00       	call   3f2c <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 b0 63 00 00       	mov    0x63b0,%eax
     1f6:	c7 44 24 04 7d 45 00 	movl   $0x457d,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 3d 3e 00 00       	call   4043 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 b0 63 00 00       	mov    0x63b0,%eax
     21e:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 15 3e 00 00       	call   4043 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 77 45 00 00 	movl   $0x4577,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 b0 63 00 00       	mov    0x63b0,%eax
     25b:	c7 44 24 04 94 45 00 	movl   $0x4594,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 d8 3d 00 00       	call   4043 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 77 45 00 00 	movl   $0x4577,(%esp)
     288:	e8 87 3c 00 00       	call   3f14 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 b0 63 00 00       	mov    0x63b0,%eax
     296:	c7 44 24 04 b8 45 00 	movl   $0x45b8,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 9d 3d 00 00       	call   4043 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 b0 63 00 00       	mov    0x63b0,%eax
     2b5:	c7 44 24 04 c7 45 00 	movl   $0x45c7,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 7e 3d 00 00       	call   4043 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 b0 63 00 00       	mov    0x63b0,%eax
     2d2:	c7 44 24 04 d9 45 00 	movl   $0x45d9,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 61 3d 00 00       	call   4043 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 94 44 00 00 	movl   $0x4494,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 b0 63 00 00       	mov    0x63b0,%eax
     304:	c7 44 24 04 e4 45 00 	movl   $0x45e4,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 2f 3d 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 f7 45 00 00 	movl   $0x45f7,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 b0 63 00 00       	mov    0x63b0,%eax
     346:	c7 44 24 04 04 46 00 	movl   $0x4604,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 ed 3c 00 00       	call   4043 <printf>
    exit();
     356:	e8 69 3b 00 00       	call   3ec4 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 b0 63 00 00       	mov    0x63b0,%eax
     360:	c7 44 24 04 22 46 00 	movl   $0x4622,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 d3 3c 00 00       	call   4043 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 b0 63 00 00       	mov    0x63b0,%eax
     37d:	c7 44 24 04 30 46 00 	movl   $0x4630,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 b6 3c 00 00       	call   4043 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 41 46 00 00 	movl   $0x4641,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 b0 63 00 00       	mov    0x63b0,%eax
     3af:	c7 44 24 04 47 46 00 	movl   $0x4647,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 84 3c 00 00       	call   4043 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 b0 63 00 00       	mov    0x63b0,%eax
     3d0:	c7 44 24 04 62 46 00 	movl   $0x4662,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 63 3c 00 00       	call   4043 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 7e 46 00 	movl   $0x467e,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 b0 63 00 00       	mov    0x63b0,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 8c 46 00 	movl   $0x468c,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 22 3c 00 00       	call   4043 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 b0 46 00 	movl   $0x46b0,0x4(%esp)
     435:	00 
     ...
     446:	a1 b0 63 00 00       	mov    0x63b0,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 bc 46 00 	movl   $0x46bc,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 e1 3b 00 00       	call   4043 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 b0 63 00 00       	mov    0x63b0,%eax
     47a:	c7 44 24 04 e0 46 00 	movl   $0x46e0,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 b9 3b 00 00       	call   4043 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 41 46 00 00 	movl   $0x4641,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 b0 63 00 00       	mov    0x63b0,%eax
     4b7:	c7 44 24 04 eb 46 00 	movl   $0x46eb,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 7c 3b 00 00       	call   4043 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 b0 63 00 00       	mov    0x63b0,%eax
     4f5:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 3e 3b 00 00       	call   4043 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 b0 63 00 00       	mov    0x63b0,%eax
     50f:	c7 44 24 04 1f 47 00 	movl   $0x471f,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 24 3b 00 00       	call   4043 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 41 46 00 00 	movl   $0x4641,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 b0 63 00 00       	mov    0x63b0,%eax
     541:	c7 44 24 04 32 47 00 	movl   $0x4732,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 f2 3a 00 00       	call   4043 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     556:	a1 b0 63 00 00       	mov    0x63b0,%eax
     55b:	c7 44 24 04 3f 47 00 	movl   $0x473f,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 d8 3a 00 00       	call   4043 <printf>
    exit();
     56b:	e8 54 39 00 00       	call   3ec4 <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 b0 63 00 00       	mov    0x63b0,%eax
     575:	c7 44 24 04 54 47 00 	movl   $0x4754,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 be 3a 00 00       	call   4043 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 b0 63 00 00       	mov    0x63b0,%eax
     592:	c7 44 24 04 68 47 00 	movl   $0x4768,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 a1 3a 00 00       	call   4043 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 78 47 00 00 	movl   $0x4778,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 b0 63 00 00       	mov    0x63b0,%eax
     5c4:	c7 44 24 04 7c 47 00 	movl   $0x477c,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 6f 3a 00 00       	call   4043 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 b0 63 00 00       	mov    0x63b0,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 96 47 00 	movl   $0x4796,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 19 3a 00 00       	call   4043 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 78 47 00 00 	movl   $0x4778,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 b0 63 00 00       	mov    0x63b0,%eax
     66a:	c7 44 24 04 b4 47 00 	movl   $0x47b4,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 c9 39 00 00       	call   4043 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b7:	a1 b0 63 00 00       	mov    0x63b0,%eax
     6bc:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bf:	89 54 24 08          	mov    %edx,0x8(%esp)
     6c3:	c7 44 24 04 cd 47 00 	movl   $0x47cd,0x4(%esp)
     6ca:	00 
     6cb:	89 04 24             	mov    %eax,(%esp)
     6ce:	e8 70 39 00 00       	call   4043 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     74f:	c7 04 24 78 47 00 00 	movl   $0x4778,(%esp)
     756:	e8 b9 37 00 00       	call   3f14 <unlink>
     75b:	85 c0                	test   %eax,%eax
     75d:	79 1a                	jns    779 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     75f:	a1 b0 63 00 00       	mov    0x63b0,%eax
     764:	c7 44 24 04 1c 48 00 	movl   $0x481c,0x4(%esp)
     76b:	00 
     76c:	89 04 24             	mov    %eax,(%esp)
     76f:	e8 cf 38 00 00       	call   4043 <printf>
    exit();
     774:	e8 4b 37 00 00       	call   3ec4 <exit>
  }
  printf(stdout, "big files ok\n");
     779:	a1 b0 63 00 00       	mov    0x63b0,%eax
     77e:	c7 44 24 04 2f 48 00 	movl   $0x482f,0x4(%esp)
     785:	00 
     786:	89 04 24             	mov    %eax,(%esp)
     789:	e8 b5 38 00 00       	call   4043 <printf>
}
     78e:	c9                   	leave  
     78f:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     796:	a1 b0 63 00 00       	mov    0x63b0,%eax
     79b:	c7 44 24 04 40 48 00 	movl   $0x4840,0x4(%esp)
     7a2:	00 
     7a3:	89 04 24             	mov    %eax,(%esp)
     7a6:	e8 98 38 00 00       	call   4043 <printf>

  name[0] = 'a';
     7ab:	c6 05 a0 ab 00 00 61 	movb   $0x61,0xaba0
  name[2] = '\0';
     7b2:	c6 05 a2 ab 00 00 00 	movb   $0x0,0xaba2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7c8:	a2 a1 ab 00 00       	mov    %al,0xaba1
    fd = open(name, O_CREATE|O_RDWR);
     7cd:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     7d4:	00 
     7d5:	c7 04 24 a0 ab 00 00 	movl   $0xaba0,(%esp)
  ...
  name[0] = 'a';
     7f9:	c6 05 a0 ab 00 00 61 	movb   $0x61,0xaba0
  name[2] = '\0';
     800:	c6 05 a2 ab 00 00 00 	movb   $0x0,0xaba2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     816:	a2 a1 ab 00 00       	mov    %al,0xaba1
    unlink(name);
     81b:	c7 04 24 a0 ab 00 00 	movl   $0xaba0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     831:	a1 b0 63 00 00       	mov    0x63b0,%eax
     836:	c7 44 24 04 68 48 00 	movl   $0x4868,0x4(%esp)
     83d:	00 
     83e:	89 04 24             	mov    %eax,(%esp)
     841:	e8 fd 37 00 00       	call   4043 <printf>
}
     846:	c9                   	leave  
     847:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84e:	a1 b0 63 00 00       	mov    0x63b0,%eax
     853:	c7 44 24 04 8e 48 00 	movl   $0x488e,0x4(%esp)
     85a:	00 
     85b:	89 04 24             	mov    %eax,(%esp)
     85e:	e8 e0 37 00 00       	call   4043 <printf>

  if(mkdir("dir0") < 0){
     863:	c7 04 24 9a 48 00 00 	movl   $0x489a,(%esp)
     86a:	e8 bd 36 00 00       	call   3f2c <mkdir>
     86f:	85 c0                	test   %eax,%eax
     871:	79 1a                	jns    88d <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     873:	a1 b0 63 00 00       	mov    0x63b0,%eax
     878:	c7 44 24 04 bd 44 00 	movl   $0x44bd,0x4(%esp)
     87f:	00 
     880:	89 04 24             	mov    %eax,(%esp)
     883:	e8 bb 37 00 00       	call   4043 <printf>
    exit();
     888:	e8 37 36 00 00       	call   3ec4 <exit>
  }

  if(chdir("dir0") < 0){
     88d:	c7 04 24 9a 48 00 00 	movl   $0x489a,(%esp)
     894:	e8 9b 36 00 00       	call   3f34 <chdir>
     899:	85 c0                	test   %eax,%eax
     89b:	79 1a                	jns    8b7 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89d:	a1 b0 63 00 00       	mov    0x63b0,%eax
     8a2:	c7 44 24 04 9f 48 00 	movl   $0x489f,0x4(%esp)
     8a9:	00 
     8aa:	89 04 24             	mov    %eax,(%esp)
     8ad:	e8 91 37 00 00       	call   4043 <printf>
    exit();
     8b2:	e8 0d 36 00 00       	call   3ec4 <exit>
  }

  if(chdir("..") < 0){
     8b7:	c7 04 24 b2 48 00 00 	movl   $0x48b2,(%esp)
     8be:	e8 71 36 00 00       	call   3f34 <chdir>
     8c3:	85 c0                	test   %eax,%eax
     8c5:	79 1a                	jns    8e1 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c7:	a1 b0 63 00 00       	mov    0x63b0,%eax
     8cc:	c7 44 24 04 b5 48 00 	movl   $0x48b5,0x4(%esp)
     8d3:	00 
     8d4:	89 04 24             	mov    %eax,(%esp)
     8d7:	e8 67 37 00 00       	call   4043 <printf>
    exit();
     8dc:	e8 e3 35 00 00       	call   3ec4 <exit>
  }

  if(unlink("dir0") < 0){
     8e1:	c7 04 24 9a 48 00 00 	movl   $0x489a,(%esp)
     8e8:	e8 27 36 00 00       	call   3f14 <unlink>
     8ed:	85 c0                	test   %eax,%eax
     8ef:	79 1a                	jns    90b <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f1:	a1 b0 63 00 00       	mov    0x63b0,%eax
     8f6:	c7 44 24 04 c6 48 00 	movl   $0x48c6,0x4(%esp)
     8fd:	00 
     8fe:	89 04 24             	mov    %eax,(%esp)
     901:	e8 3d 37 00 00       	call   4043 <printf>
    exit();
     906:	e8 b9 35 00 00       	call   3ec4 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90b:	a1 b0 63 00 00       	mov    0x63b0,%eax
     910:	c7 44 24 04 da 48 00 	movl   $0x48da,0x4(%esp)
     917:	00 
     918:	89 04 24             	mov    %eax,(%esp)
     91b:	e8 23 37 00 00       	call   4043 <printf>
}
     920:	c9                   	leave  
     921:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     928:	a1 b0 63 00 00       	mov    0x63b0,%eax
     92d:	c7 44 24 04 e9 48 00 	movl   $0x48e9,0x4(%esp)
     934:	00 
     935:	89 04 24             	mov    %eax,(%esp)
     938:	e8 06 37 00 00       	call   4043 <printf>
  if(exec("echo", echoargv) < 0){
     93d:	c7 44 24 04 9c 63 00 	movl   $0x639c,0x4(%esp)
     944:	00 
     945:	c7 04 24 94 44 00 00 	movl   $0x4494,(%esp)
     94c:	e8 ab 35 00 00       	call   3efc <exec>
     951:	85 c0                	test   %eax,%eax
     953:	79 1a                	jns    96f <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     955:	a1 b0 63 00 00       	mov    0x63b0,%eax
     95a:	c7 44 24 04 f4 48 00 	movl   $0x48f4,0x4(%esp)
     961:	00 
     962:	89 04 24             	mov    %eax,(%esp)
     965:	e8 d9 36 00 00       	call   4043 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     986:	c7 44 24 04 06 49 00 	movl   $0x4906,0x4(%esp)
     98d:	00 
     98e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     995:	e8 a9 36 00 00       	call   4043 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9db:	81 c2 a0 8b 00 00    	add    $0x8ba0,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9fe:	00 
     9ff:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
     a06:	00 
     ...
     a16:	c7 44 24 04 15 49 00 	movl   $0x4915,0x4(%esp)
     a1d:	00 
     a1e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a25:	e8 19 36 00 00       	call   4043 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6f:	05 a0 8b 00 00       	add    $0x8ba0,%eax
     ...
     a8f:	c7 44 24 04 23 49 00 	movl   $0x4923,0x4(%esp)
     a96:	00 
     a97:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9e:	e8 a0 35 00 00       	call   4043 <printf>
          return;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ad8:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
     adf:	00 
    ...
    if(total != 5 * 1033){
     ...
     b14:	e8 2a 35 00 00       	call   4043 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2e:	c7 44 24 04 48 49 00 	movl   $0x4948,0x4(%esp)
     b35:	00 
     b36:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3d:	e8 01 35 00 00       	call   4043 <printf>
    ...
    printf(1, "fork() failed\n");
     b44:	c7 44 24 04 52 49 00 	movl   $0x4952,0x4(%esp)
     b4b:	00 
     b4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b53:	e8 eb 34 00 00       	call   4043 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b65:	c7 44 24 04 61 49 00 	movl   $0x4961,0x4(%esp)
     b6c:	00 
     b6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b74:	e8 ca 34 00 00       	call   4043 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc7:	00 
     bc8:	c7 44 24 04 6b 49 00 	movl   $0x496b,0x4(%esp)
     bcf:	00 
     ...
     bdd:	c7 44 24 04 6d 49 00 	movl   $0x496d,0x4(%esp)
     be4:	00 
     be5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bec:	e8 52 34 00 00       	call   4043 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c13:	00 
     c14:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
     c1b:	00 
    ...
    printf(1, "preempt read error");
     c29:	c7 44 24 04 81 49 00 	movl   $0x4981,0x4(%esp)
     c30:	00 
     c31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c38:	e8 06 34 00 00       	call   4043 <printf>
    return;
  ...
  printf(1, "kill... ");
     c4a:	c7 44 24 04 94 49 00 	movl   $0x4994,0x4(%esp)
     c51:	00 
     c52:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c59:	e8 e5 33 00 00       	call   4043 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c7f:	c7 44 24 04 9d 49 00 	movl   $0x499d,0x4(%esp)
     c86:	00 
     c87:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8e:	e8 b0 33 00 00       	call   4043 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca2:	c7 44 24 04 a6 49 00 	movl   $0x49a6,0x4(%esp)
     ca9:	00 
     caa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb1:	e8 8d 33 00 00       	call   4043 <printf>
}
     cb6:	c9                   	leave  
     cb7:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd3:	79 16                	jns    ceb <exitwait+0x33>
      printf(1, "fork failed\n");
     cd5:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
     cdc:	00 
     cdd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce4:	e8 5a 33 00 00       	call   4043 <printf>
      return;
    ...
    if(pid){
     ...
     cfb:	c7 44 24 04 b2 49 00 	movl   $0x49b2,0x4(%esp)
     d02:	00 
     d03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0a:	e8 34 33 00 00       	call   4043 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d20:	c7 44 24 04 c2 49 00 	movl   $0x49c2,0x4(%esp)
     d27:	00 
     d28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d2f:	e8 0f 33 00 00       	call   4043 <printf>
}
     d34:	c9                   	leave  
     d35:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3c:	c7 44 24 04 cf 49 00 	movl   $0x49cf,0x4(%esp)
     d43:	00 
     d44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4b:	e8 f3 32 00 00       	call   4043 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d88:	e8 9a 35 00 00       	call   4327 <malloc>
    ...
    while(m1){
     ...
     da6:	e8 4d 34 00 00       	call   41f8 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df6:	e8 fd 33 00 00       	call   41f8 <free>
    printf(1, "mem ok\n");
     dfb:	c7 44 24 04 f3 49 00 	movl   $0x49f3,0x4(%esp)
     e02:	00 
     e03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0a:	e8 34 32 00 00       	call   4043 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e21:	c7 44 24 04 fb 49 00 	movl   $0x49fb,0x4(%esp)
     e28:	00 
     e29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e30:	e8 0e 32 00 00       	call   4043 <printf>

  unlink("sharedfd");
     e35:	c7 04 24 0a 4a 00 00 	movl   $0x4a0a,(%esp)
     e3c:	e8 d3 30 00 00       	call   3f14 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e41:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e48:	00 
     e49:	c7 04 24 0a 4a 00 00 	movl   $0x4a0a,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5e:	c7 44 24 04 14 4a 00 	movl   $0x4a14,0x4(%esp)
     e65:	00 
     e66:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6d:	e8 d1 31 00 00       	call   4043 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed0:	c7 44 24 04 40 4a 00 	movl   $0x4a40,0x4(%esp)
     ed7:	00 
     ed8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     edf:	e8 5f 31 00 00       	call   4043 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f15:	00 
     f16:	c7 04 24 0a 4a 00 00 	movl   $0x4a0a,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2b:	c7 44 24 04 60 4a 00 	movl   $0x4a60,0x4(%esp)
     f32:	00 
     f33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3a:	e8 04 31 00 00       	call   4043 <printf>
    return;
  ...
  unlink("sharedfd");
     fb8:	c7 04 24 0a 4a 00 00 	movl   $0x4a0a,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd6:	c7 44 24 04 8b 4a 00 	movl   $0x4a8b,0x4(%esp)
     fdd:	00 
     fde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fe5:	e8 59 30 00 00       	call   4043 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ffa:	c7 44 24 04 98 4a 00 	movl   $0x4a98,0x4(%esp)
    1001:	00 
    1002:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1009:	e8 35 30 00 00       	call   4043 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    101b:	c7 45 c8 ad 4a 00 00 	movl   $0x4aad,-0x38(%ebp)
    1022:	c7 45 cc b0 4a 00 00 	movl   $0x4ab0,-0x34(%ebp)
    1029:	c7 45 d0 b3 4a 00 00 	movl   $0x4ab3,-0x30(%ebp)
    1030:	c7 45 d4 b6 4a 00 00 	movl   $0x4ab6,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    1037:	c7 44 24 04 b9 4a 00 	movl   $0x4ab9,0x4(%esp)
    103e:	00 
    103f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1046:	e8 f8 2f 00 00       	call   4043 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1078:	79 19                	jns    1093 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107a:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
    1081:	00 
    1082:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1089:	e8 b5 2f 00 00       	call   4043 <printf>
      exit();
    ...
    10b9:	c7 44 24 04 c9 4a 00 	movl   $0x4ac9,0x4(%esp)
    10c0:	00 
    10c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10c8:	e8 76 2f 00 00       	call   4043 <printf>
        exit();
    ...
    10e4:	c7 04 24 a0 8b 00 00 	movl   $0x8ba0,(%esp)
    ...
    1100:	00 
    1101:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    1108:	00 
    ...
    1127:	c7 44 24 04 d8 4a 00 	movl   $0x4ad8,0x4(%esp)
    112e:	00 
    112f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1136:	e8 08 2f 00 00       	call   4043 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11b6:	05 a0 8b 00 00       	add    $0x8ba0,%eax
    ...
    11c9:	74 19                	je     11e4 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11cb:	c7 44 24 04 e9 4a 00 	movl   $0x4ae9,0x4(%esp)
    11d2:	00 
    11d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11da:	e8 64 2e 00 00       	call   4043 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11fd:	00 
    11fe:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    1205:	00 
    ...
    1235:	c7 44 24 04 f5 4a 00 	movl   $0x4af5,0x4(%esp)
    123c:	00 
    123d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1244:	e8 fa 2d 00 00       	call   4043 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    1267:	c7 44 24 04 06 4b 00 	movl   $0x4b06,0x4(%esp)
    126e:	00 
    126f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1276:	e8 c8 2d 00 00       	call   4043 <printf>
}
    127b:	c9                   	leave  
    127c:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1283:	c7 44 24 04 14 4b 00 	movl   $0x4b14,0x4(%esp)
    128a:	00 
    128b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1292:	e8 ac 2d 00 00       	call   4043 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12af:	79 19                	jns    12ca <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b1:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
    12b8:	00 
    12b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c0:	e8 7e 2d 00 00       	call   4043 <printf>
      exit();
    ...
    1310:	79 19                	jns    132b <createdelete+0xae>
          printf(1, "create failed\n");
    1312:	c7 44 24 04 c9 4a 00 	movl   $0x4ac9,0x4(%esp)
    1319:	00 
    131a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1321:	e8 1d 2d 00 00       	call   4043 <printf>
          exit();
    ...
    1367:	c7 44 24 04 b8 45 00 	movl   $0x45b8,0x4(%esp)
    136e:	00 
    136f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1376:	e8 c8 2c 00 00       	call   4043 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1424:	c7 44 24 04 28 4b 00 	movl   $0x4b28,0x4(%esp)
    142b:	00 
    142c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1433:	e8 0b 2c 00 00       	call   4043 <printf>
        exit();
    ...
    1456:	c7 44 24 04 4c 4b 00 	movl   $0x4b4c,0x4(%esp)
    145d:	00 
    145e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1465:	e8 d9 2b 00 00       	call   4043 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14df:	c7 44 24 04 6c 4b 00 	movl   $0x4b6c,0x4(%esp)
    14e6:	00 
    14e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14ee:	e8 50 2b 00 00       	call   4043 <printf>
}
    14f3:	c9                   	leave  
    14f4:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14fb:	c7 44 24 04 7d 4b 00 	movl   $0x4b7d,0x4(%esp)
    1502:	00 
    1503:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150a:	e8 34 2b 00 00       	call   4043 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    150f:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1516:	00 
    1517:	c7 04 24 8e 4b 00 00 	movl   $0x4b8e,(%esp)
  ...
  if(fd < 0){
    ...
    152c:	c7 44 24 04 99 4b 00 	movl   $0x4b99,0x4(%esp)
    1533:	00 
    1534:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    153b:	e8 03 2b 00 00       	call   4043 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    154c:	00 
    154d:	c7 44 24 04 b3 4b 00 	movl   $0x4bb3,0x4(%esp)
    1554:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1572:	00 
    1573:	c7 04 24 8e 4b 00 00 	movl   $0x4b8e,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    160e:	00 
    160f:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    1616:	00 
    ...
    1627:	c7 44 24 04 ef 4b 00 	movl   $0x4bef,0x4(%esp)
    162e:	00 
    162f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1636:	e8 08 2a 00 00       	call   4043 <printf>
    exit();
    163b:	e8 84 28 00 00       	call   3ec4 <exit>
  }
  if(buf[0] != 'h'){
    1640:	0f b6 05 a0 8b 00 00 	movzbl 0x8ba0,%eax
    1647:	3c 68                	cmp    $0x68,%al
    1649:	74 19                	je     1664 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    164b:	c7 44 24 04 06 4c 00 	movl   $0x4c06,0x4(%esp)
    1652:	00 
    1653:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165a:	e8 e4 29 00 00       	call   4043 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    166b:	00 
    166c:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    1673:	00 
    ...
    1684:	c7 44 24 04 1d 4c 00 	movl   $0x4c1d,0x4(%esp)
    168b:	00 
    168c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1693:	e8 ab 29 00 00       	call   4043 <printf>
    exit();
  ...
  unlink("unlinkread");
    16a8:	c7 04 24 8e 4b 00 00 	movl   $0x4b8e,(%esp)
    16af:	e8 60 28 00 00       	call   3f14 <unlink>
  printf(1, "unlinkread ok\n");
    16b4:	c7 44 24 04 36 4c 00 	movl   $0x4c36,0x4(%esp)
    16bb:	00 
    16bc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c3:	e8 7b 29 00 00       	call   4043 <printf>
}
    16c8:	c9                   	leave  
    16c9:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d0:	c7 44 24 04 45 4c 00 	movl   $0x4c45,0x4(%esp)
    16d7:	00 
    16d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16df:	e8 5f 29 00 00       	call   4043 <printf>

  unlink("lf1");
    16e4:	c7 04 24 4f 4c 00 00 	movl   $0x4c4f,(%esp)
    16eb:	e8 24 28 00 00       	call   3f14 <unlink>
  unlink("lf2");
    16f0:	c7 04 24 53 4c 00 00 	movl   $0x4c53,(%esp)
    16f7:	e8 18 28 00 00       	call   3f14 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    16fc:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1703:	00 
    1704:	c7 04 24 4f 4c 00 00 	movl   $0x4c4f,(%esp)
  ...
  if(fd < 0){
    ...
    1719:	c7 44 24 04 57 4c 00 	movl   $0x4c57,0x4(%esp)
    1720:	00 
    1721:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1728:	e8 16 29 00 00       	call   4043 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1739:	00 
    173a:	c7 44 24 04 b3 4b 00 	movl   $0x4bb3,0x4(%esp)
    1741:	00 
    ...
    1752:	c7 44 24 04 6a 4c 00 	movl   $0x4c6a,0x4(%esp)
    1759:	00 
    175a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1761:	e8 dd 28 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17eb:	00 
    17ec:	c7 04 24 53 4c 00 00 	movl   $0x4c53,(%esp)
  ...
  if(fd < 0){
    ...
    1801:	c7 44 24 04 b9 4c 00 	movl   $0x4cb9,0x4(%esp)
    1808:	00 
    1809:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1810:	e8 2e 28 00 00       	call   4043 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1821:	00 
    1822:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    1829:	00 
    ...
    183a:	c7 44 24 04 ca 4c 00 	movl   $0x4cca,0x4(%esp)
    1841:	00 
    1842:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1849:	e8 f5 27 00 00       	call   4043 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    185e:	c7 44 24 04 53 4c 00 	movl   $0x4c53,0x4(%esp)
    1865:	00 
    1866:	c7 04 24 53 4c 00 00 	movl   $0x4c53,(%esp)
    186d:	e8 b2 26 00 00       	call   3f24 <link>
    1872:	85 c0                	test   %eax,%eax
    1874:	78 19                	js     188f <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1876:	c7 44 24 04 db 4c 00 	movl   $0x4cdb,0x4(%esp)
    187d:	00 
    187e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1885:	e8 b9 27 00 00       	call   4043 <printf>
    exit();
    188a:	e8 35 26 00 00       	call   3ec4 <exit>
  }

  unlink("lf2");
    188f:	c7 04 24 53 4c 00 00 	movl   $0x4c53,(%esp)
    1896:	e8 79 26 00 00       	call   3f14 <unlink>
  if(link("lf2", "lf1") >= 0){
    189b:	c7 44 24 04 4f 4c 00 	movl   $0x4c4f,0x4(%esp)
    18a2:	00 
    18a3:	c7 04 24 53 4c 00 00 	movl   $0x4c53,(%esp)
    18aa:	e8 75 26 00 00       	call   3f24 <link>
    18af:	85 c0                	test   %eax,%eax
    18b1:	78 19                	js     18cc <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b3:	c7 44 24 04 fc 4c 00 	movl   $0x4cfc,0x4(%esp)
    18ba:	00 
    18bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c2:	e8 7c 27 00 00       	call   4043 <printf>
    exit();
    18c7:	e8 f8 25 00 00       	call   3ec4 <exit>
  }

  if(link(".", "lf1") >= 0){
    18cc:	c7 44 24 04 4f 4c 00 	movl   $0x4c4f,0x4(%esp)
    18d3:	00 
    18d4:	c7 04 24 1f 4d 00 00 	movl   $0x4d1f,(%esp)
    18db:	e8 44 26 00 00       	call   3f24 <link>
    18e0:	85 c0                	test   %eax,%eax
    18e2:	78 19                	js     18fd <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e4:	c7 44 24 04 21 4d 00 	movl   $0x4d21,0x4(%esp)
    18eb:	00 
    18ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f3:	e8 4b 27 00 00       	call   4043 <printf>
    exit();
    18f8:	e8 c7 25 00 00       	call   3ec4 <exit>
  }

  printf(1, "linktest ok\n");
    18fd:	c7 44 24 04 3d 4d 00 	movl   $0x4d3d,0x4(%esp)
    1904:	00 
    1905:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190c:	e8 32 27 00 00       	call   4043 <printf>
}
    1911:	c9                   	leave  
    1912:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1919:	c7 44 24 04 4a 4d 00 	movl   $0x4d4a,0x4(%esp)
    1920:	00 
    1921:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1928:	e8 16 27 00 00       	call   4043 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    198c:	c7 04 24 5a 4d 00 00 	movl   $0x4d5a,(%esp)
    ...
    19cf:	c7 04 24 5a 4d 00 00 	movl   $0x4d5a,(%esp)
    ...
    1a00:	c7 44 24 04 5d 4d 00 	movl   $0x4d5d,0x4(%esp)
    1a07:	00 
    1a08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a0f:	e8 2f 26 00 00       	call   4043 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a64:	00 
    1a65:	c7 04 24 1f 4d 00 00 	movl   $0x4d1f,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ac6:	c7 44 24 04 79 4d 00 	movl   $0x4d79,0x4(%esp)
    1acd:	00 
    1ace:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ad5:	e8 69 25 00 00       	call   4043 <printf>
        exit();
    ...
    1af6:	c7 44 24 04 92 4d 00 	movl   $0x4d92,0x4(%esp)
    1afd:	00 
    1afe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b05:	e8 39 25 00 00       	call   4043 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b52:	c7 44 24 04 b0 4d 00 	movl   $0x4db0,0x4(%esp)
    1b59:	00 
    1b5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b61:	e8 dd 24 00 00       	call   4043 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b8c:	79 19                	jns    1ba7 <concreate+0x294>
      printf(1, "fork failed\n");
    1b8e:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
    1b95:	00 
    1b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b9d:	e8 a1 24 00 00       	call   4043 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cae:	c7 44 24 04 e1 4d 00 	movl   $0x4de1,0x4(%esp)
    1cb5:	00 
    1cb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cbd:	e8 81 23 00 00       	call   4043 <printf>
}
    1cc2:	c9                   	leave  
    1cc3:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cca:	c7 44 24 04 ef 4d 00 	movl   $0x4def,0x4(%esp)
    1cd1:	00 
    1cd2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd9:	e8 65 23 00 00       	call   4043 <printf>

  unlink("x");
    1cde:	c7 04 24 6b 49 00 00 	movl   $0x496b,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cf8:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
    1cff:	00 
    1d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d07:	e8 37 23 00 00       	call   4043 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d66:	00 
    1d67:	c7 04 24 6b 49 00 00 	movl   $0x496b,(%esp)
    ...
    1d98:	75 16                	jne    1db0 <linkunlink+0xec>
      link("cat", "x");
    1d9a:	c7 44 24 04 6b 49 00 	movl   $0x496b,0x4(%esp)
    1da1:	00 
    1da2:	c7 04 24 00 4e 00 00 	movl   $0x4e00,(%esp)
    1da9:	e8 76 21 00 00       	call   3f24 <link>
    1dae:	eb 0c                	jmp    1dbc <linkunlink+0xf8>
    } else {
      unlink("x");
    1db0:	c7 04 24 6b 49 00 00 	movl   $0x496b,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1dd5:	c7 44 24 04 04 4e 00 	movl   $0x4e04,0x4(%esp)
    1ddc:	00 
    1ddd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1de4:	e8 5a 22 00 00       	call   4043 <printf>
}
    1de9:	c9                   	leave  
    1dea:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1df6:	c7 44 24 04 13 4e 00 	movl   $0x4e13,0x4(%esp)
    1dfd:	00 
    1dfe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e05:	e8 39 22 00 00       	call   4043 <printf>
  unlink("bd");
    1e0a:	c7 04 24 20 4e 00 00 	movl   $0x4e20,(%esp)
    1e11:	e8 fe 20 00 00       	call   3f14 <unlink>

  fd = open("bd", O_CREATE);
    1e16:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e1d:	00 
    1e1e:	c7 04 24 20 4e 00 00 	movl   $0x4e20,(%esp)
  ...
  if(fd < 0){
    ...
    1e33:	c7 44 24 04 23 4e 00 	movl   $0x4e23,0x4(%esp)
    1e3a:	00 
    1e3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e42:	e8 fc 21 00 00       	call   4043 <printf>
    exit();
  ...
  unlink("bd");
    1ed1:	c7 04 24 20 4e 00 00 	movl   $0x4e20,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f29:	c7 44 24 04 4d 4e 00 	movl   $0x4e4d,0x4(%esp)
    1f30:	00 
    1f31:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f38:	e8 06 21 00 00       	call   4043 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f4f:	c7 44 24 04 62 4e 00 	movl   $0x4e62,0x4(%esp)
    1f56:	00 
    1f57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5e:	e8 e0 20 00 00       	call   4043 <printf>
}
    1f63:	c9                   	leave  
    1f64:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6b:	c7 44 24 04 6d 4e 00 	movl   $0x4e6d,0x4(%esp)
    1f72:	00 
    1f73:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7a:	e8 c4 20 00 00       	call   4043 <printf>

  unlink("ff");
    1f7f:	c7 04 24 7a 4e 00 00 	movl   $0x4e7a,(%esp)
    1f86:	e8 89 1f 00 00       	call   3f14 <unlink>
  if(mkdir("dd") != 0){
    1f8b:	c7 04 24 7d 4e 00 00 	movl   $0x4e7d,(%esp)
    1f92:	e8 95 1f 00 00       	call   3f2c <mkdir>
    1f97:	85 c0                	test   %eax,%eax
    1f99:	74 19                	je     1fb4 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9b:	c7 44 24 04 80 4e 00 	movl   $0x4e80,0x4(%esp)
    1fa2:	00 
    1fa3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1faa:	e8 94 20 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbb:	00 
    1fbc:	c7 04 24 98 4e 00 00 	movl   $0x4e98,(%esp)
  ...
  if(fd < 0){
    ...
    1fd1:	c7 44 24 04 9e 4e 00 	movl   $0x4e9e,0x4(%esp)
    1fd8:	00 
    1fd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe0:	e8 5e 20 00 00       	call   4043 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff1:	00 
    1ff2:	c7 44 24 04 7a 4e 00 	movl   $0x4e7a,0x4(%esp)
    1ff9:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2069:	00 
    206a:	c7 04 24 fc 4e 00 00 	movl   $0x4efc,(%esp)
  ...
  if(fd < 0){
    ...
    207f:	c7 44 24 04 05 4f 00 	movl   $0x4f05,0x4(%esp)
    2086:	00 
    2087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208e:	e8 b0 1f 00 00       	call   4043 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    209f:	00 
    20a0:	c7 44 24 04 1d 4f 00 	movl   $0x4f1d,0x4(%esp)
    20a7:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c5:	00 
    20c6:	c7 04 24 20 4f 00 00 	movl   $0x4f20,(%esp)
  ...
  if(fd < 0){
    ...
    20db:	c7 44 24 04 2c 4f 00 	movl   $0x4f2c,0x4(%esp)
    20e2:	00 
    20e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20ea:	e8 54 1f 00 00       	call   4043 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    20fb:	00 
    20fc:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    2103:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2118:	0f b6 05 a0 8b 00 00 	movzbl 0x8ba0,%eax
    211f:	3c 66                	cmp    $0x66,%al
    2121:	74 19                	je     213c <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    2123:	c7 44 24 04 45 4f 00 	movl   $0x4f45,0x4(%esp)
    212a:	00 
    212b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2132:	e8 0c 1f 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227d:	00 
    227e:	c7 04 24 60 4f 00 00 	movl   $0x4f60,(%esp)
  ...
  if(fd < 0){
    ...
    2293:	c7 44 24 04 2a 50 00 	movl   $0x502a,0x4(%esp)
    229a:	00 
    229b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a2:	e8 9c 1d 00 00       	call   4043 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22b3:	00 
    22b4:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    22bb:	00 
    ...
    22cc:	c7 44 24 04 42 50 00 	movl   $0x5042,0x4(%esp)
    22d3:	00 
    22d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22db:	e8 63 1d 00 00       	call   4043 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b1:	c7 44 24 04 bc 52 00 	movl   $0x52bc,0x4(%esp)
    26b8:	00 
    26b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c0:	e8 7e 19 00 00       	call   4043 <printf>

  unlink("bigwrite");
    26c5:	c7 04 24 cb 52 00 00 	movl   $0x52cb,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e4:	00 
    26e5:	c7 04 24 cb 52 00 00 	movl   $0x52cb,(%esp)
    ...
    26fa:	c7 44 24 04 d4 52 00 	movl   $0x52d4,0x4(%esp)
    2701:	00 
    2702:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2709:	e8 35 19 00 00       	call   4043 <printf>
      exit();
    ...
    2723:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    272a:	00 
    ...
    274f:	c7 44 24 04 ec 52 00 	movl   $0x52ec,0x4(%esp)
    2756:	00 
    2757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275e:	e8 e0 18 00 00       	call   4043 <printf>
        exit();
    ...
    unlink("bigwrite");
    277d:	c7 04 24 cb 52 00 00 	movl   $0x52cb,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279d:	c7 44 24 04 fe 52 00 	movl   $0x52fe,0x4(%esp)
    27a4:	00 
    27a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ac:	e8 92 18 00 00       	call   4043 <printf>
}
    27b1:	c9                   	leave  
    27b2:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27b9:	c7 44 24 04 0b 53 00 	movl   $0x530b,0x4(%esp)
    27c0:	00 
    27c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c8:	e8 76 18 00 00       	call   4043 <printf>

  unlink("bigfile");
    27cd:	c7 04 24 19 53 00 00 	movl   $0x5319,(%esp)
    27d4:	e8 3b 17 00 00       	call   3f14 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27d9:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e0:	00 
    27e1:	c7 04 24 19 53 00 00 	movl   $0x5319,(%esp)
  ...
  if(fd < 0){
    ...
    27f6:	c7 44 24 04 21 53 00 	movl   $0x5321,0x4(%esp)
    27fd:	00 
    27fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2805:	e8 39 18 00 00       	call   4043 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2827:	c7 04 24 a0 8b 00 00 	movl   $0x8ba0,(%esp)
    282e:	e8 ec 14 00 00       	call   3d1f <memset>
    if(write(fd, buf, 600) != 600){
    2833:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    283a:	00 
    283b:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    2842:	00 
    ...
    2855:	c7 44 24 04 37 53 00 	movl   $0x5337,0x4(%esp)
    285c:	00 
    285d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2864:	e8 da 17 00 00       	call   4043 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288a:	00 
    288b:	c7 04 24 19 53 00 00 	movl   $0x5319,(%esp)
  ...
  if(fd < 0){
    ...
    28a0:	c7 44 24 04 4d 53 00 	movl   $0x534d,0x4(%esp)
    28a7:	00 
    28a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28af:	e8 8f 17 00 00       	call   4043 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ce:	00 
    28cf:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    28d6:	00 
    ...
    28eb:	c7 44 24 04 62 53 00 	movl   $0x5362,0x4(%esp)
    28f2:	00 
    28f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fa:	e8 44 17 00 00       	call   4043 <printf>
      exit();
    ...
    2913:	c7 44 24 04 77 53 00 	movl   $0x5377,0x4(%esp)
    291a:	00 
    291b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2922:	e8 1c 17 00 00       	call   4043 <printf>
      exit();
    2927:	e8 98 15 00 00       	call   3ec4 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    292c:	0f b6 05 a0 8b 00 00 	movzbl 0x8ba0,%eax
    ...
    2946:	0f b6 05 cb 8c 00 00 	movzbl 0x8ccb,%eax
    ...
    2960:	c7 44 24 04 8b 53 00 	movl   $0x538b,0x4(%esp)
    2967:	00 
    2968:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    296f:	e8 cf 16 00 00       	call   4043 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    299d:	c7 44 24 04 a4 53 00 	movl   $0x53a4,0x4(%esp)
    29a4:	00 
    29a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29ac:	e8 92 16 00 00       	call   4043 <printf>
    exit();
    29b1:	e8 0e 15 00 00       	call   3ec4 <exit>
  }
  unlink("bigfile");
    29b6:	c7 04 24 19 53 00 00 	movl   $0x5319,(%esp)
    29bd:	e8 52 15 00 00       	call   3f14 <unlink>

  printf(1, "bigfile test ok\n");
    29c2:	c7 44 24 04 be 53 00 	movl   $0x53be,0x4(%esp)
    29c9:	00 
    29ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d1:	e8 6d 16 00 00       	call   4043 <printf>
}
    29d6:	c9                   	leave  
    29d7:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a4b:	00 
    2a4c:	c7 04 24 5c 54 00 00 	movl   $0x545c,(%esp)
  ...
  if(fd < 0){
    ...
    2a61:	c7 44 24 04 8c 54 00 	movl   $0x548c,0x4(%esp)
    2a68:	00 
    2a69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a70:	e8 ce 15 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a8c:	00 
    2a8d:	c7 04 24 cc 54 00 00 	movl   $0x54cc,(%esp)
  ...
  if(fd < 0){
    ...
    2aa2:	c7 44 24 04 fc 54 00 	movl   $0x54fc,0x4(%esp)
    2aa9:	00 
    2aaa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab1:	e8 8d 15 00 00       	call   4043 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cac:	c7 44 24 04 93 56 00 	movl   $0x5693,0x4(%esp)
    2cb3:	00 
    2cb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cbb:	e8 83 13 00 00       	call   4043 <printf>

  fd = open("dirfile", O_CREATE);
    2cc0:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cc7:	00 
    2cc8:	c7 04 24 a0 56 00 00 	movl   $0x56a0,(%esp)
  ...
  if(fd < 0){
    ...
    2cdd:	c7 44 24 04 a8 56 00 	movl   $0x56a8,0x4(%esp)
    2ce4:	00 
    2ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cec:	e8 52 13 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d31:	00 
    2d32:	c7 04 24 d9 56 00 00 	movl   $0x56d9,(%esp)
  ...
  if(fd >= 0){
    ...
    2d47:	c7 44 24 04 e4 56 00 	movl   $0x56e4,0x4(%esp)
    2d4e:	00 
    2d4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d56:	e8 e8 12 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d67:	00 
    2d68:	c7 04 24 d9 56 00 00 	movl   $0x56d9,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e49:	00 
    2e4a:	c7 04 24 1f 4d 00 00 	movl   $0x4d1f,(%esp)
  ...
  if(fd >= 0){
    ...
    2e5f:	c7 44 24 04 7c 57 00 	movl   $0x577c,0x4(%esp)
    2e66:	00 
    2e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e6e:	e8 d0 11 00 00       	call   4043 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eae:	c7 44 24 04 9b 57 00 	movl   $0x579b,0x4(%esp)
    2eb5:	00 
    2eb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ebd:	e8 81 11 00 00       	call   4043 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed2:	c7 44 24 04 af 57 00 	movl   $0x57af,0x4(%esp)
    2ed9:	00 
    2eda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee1:	e8 5d 11 00 00       	call   4043 <printf>
}
    2ee6:	c9                   	leave  
    2ee7:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2eee:	c7 44 24 04 bf 57 00 	movl   $0x57bf,0x4(%esp)
    2ef5:	00 
    2ef6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2efd:	e8 41 11 00 00       	call   4043 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2faf:	00 
    2fb0:	c7 04 24 ff 57 00 00 	movl   $0x57ff,(%esp)
    ...
    unlink("xx");
    2fd0:	c7 04 24 ff 57 00 00 	movl   $0x57ff,(%esp)
  ...
  chdir("/");
    2fea:	c7 04 24 06 45 00 00 	movl   $0x4506,(%esp)
    2ff1:	e8 3e 0f 00 00       	call   3f34 <chdir>
  printf(1, "empty file name OK\n");
    2ff6:	c7 44 24 04 02 58 00 	movl   $0x5802,0x4(%esp)
    2ffd:	00 
    2ffe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3005:	e8 39 10 00 00       	call   4043 <printf>
}
    300a:	c9                   	leave  
    300b:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3012:	c7 44 24 04 16 58 00 	movl   $0x5816,0x4(%esp)
    3019:	00 
    301a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3021:	e8 1d 10 00 00       	call   4043 <printf>
    ...
    3043:	e8 7c 0e 00 00       	call   3ec4 <exit>
{
  ...
  if(n == 1000){
    ...
    3061:	c7 44 24 04 24 58 00 	movl   $0x5824,0x4(%esp)
    3068:	00 
    3069:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3070:	e8 ce 0f 00 00       	call   4043 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3083:	c7 44 24 04 46 58 00 	movl   $0x5846,0x4(%esp)
    308a:	00 
    308b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3092:	e8 ac 0f 00 00       	call   4043 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b0:	c7 44 24 04 5a 58 00 	movl   $0x585a,0x4(%esp)
    30b7:	00 
    30b8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30bf:	e8 7f 0f 00 00       	call   4043 <printf>
    exit();
    30c4:	e8 fb 0d 00 00       	call   3ec4 <exit>
  }
  
  printf(1, "fork test OK\n");
    30c9:	c7 44 24 04 6d 58 00 	movl   $0x586d,0x4(%esp)
    30d0:	00 
    30d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30d8:	e8 66 0f 00 00       	call   4043 <printf>
}
    30dd:	c9                   	leave  
    30de:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30e9:	a1 b0 63 00 00       	mov    0x63b0,%eax
    30ee:	c7 44 24 04 7b 58 00 	movl   $0x587b,0x4(%esp)
    30f5:	00 
    30f6:	89 04 24             	mov    %eax,(%esp)
    30f9:	e8 45 0f 00 00       	call   4043 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    313c:	a1 b0 63 00 00       	mov    0x63b0,%eax
    ...
    3156:	c7 44 24 04 86 58 00 	movl   $0x5886,0x4(%esp)
    315d:	00 
    315e:	89 04 24             	mov    %eax,(%esp)
    3161:	e8 dd 0e 00 00       	call   4043 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    3195:	a1 b0 63 00 00       	mov    0x63b0,%eax
    319a:	c7 44 24 04 a1 58 00 	movl   $0x58a1,0x4(%esp)
    31a1:	00 
    31a2:	89 04 24             	mov    %eax,(%esp)
    31a5:	e8 99 0e 00 00       	call   4043 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31d8:	a1 b0 63 00 00       	mov    0x63b0,%eax
    31dd:	c7 44 24 04 b8 58 00 	movl   $0x58b8,0x4(%esp)
    31e4:	00 
    31e5:	89 04 24             	mov    %eax,(%esp)
    31e8:	e8 56 0e 00 00       	call   4043 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3238:	a1 b0 63 00 00       	mov    0x63b0,%eax
    323d:	c7 44 24 04 d4 58 00 	movl   $0x58d4,0x4(%esp)
    3244:	00 
    3245:	89 04 24             	mov    %eax,(%esp)
    3248:	e8 f6 0d 00 00       	call   4043 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3283:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3288:	c7 44 24 04 12 59 00 	movl   $0x5912,0x4(%esp)
    328f:	00 
    3290:	89 04 24             	mov    %eax,(%esp)
    3293:	e8 ab 0d 00 00       	call   4043 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32b9:	a1 b0 63 00 00       	mov    0x63b0,%eax
    ...
    32cc:	c7 44 24 04 30 59 00 	movl   $0x5930,0x4(%esp)
    32d3:	00 
    32d4:	89 04 24             	mov    %eax,(%esp)
    32d7:	e8 67 0d 00 00       	call   4043 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3320:	a1 b0 63 00 00       	mov    0x63b0,%eax
    ...
    3333:	c7 44 24 04 68 59 00 	movl   $0x5968,0x4(%esp)
    333a:	00 
    333b:	89 04 24             	mov    %eax,(%esp)
    333e:	e8 00 0d 00 00       	call   4043 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3352:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3357:	c7 44 24 04 90 59 00 	movl   $0x5990,0x4(%esp)
    335e:	00 
    335f:	89 04 24             	mov    %eax,(%esp)
    3362:	e8 dc 0c 00 00       	call   4043 <printf>
    exit();
  ...
  if(c != a){
    ...
    33a3:	a1 b0 63 00 00       	mov    0x63b0,%eax
    ...
    33b6:	c7 44 24 04 c0 59 00 	movl   $0x59c0,0x4(%esp)
    33bd:	00 
    33be:	89 04 24             	mov    %eax,(%esp)
    33c1:	e8 7d 0c 00 00       	call   4043 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33e8:	79 1a                	jns    3404 <sbrktest+0x325>
      printf(stdout, "fork failed\n");
    33ea:	a1 b0 63 00 00       	mov    0x63b0,%eax
    33ef:	c7 44 24 04 35 45 00 	movl   $0x4535,0x4(%esp)
    33f6:	00 
    33f7:	89 04 24             	mov    %eax,(%esp)
    33fa:	e8 44 0c 00 00       	call   4043 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346b:	c7 44 24 04 06 49 00 	movl   $0x4906,0x4(%esp)
    3472:	00 
    3473:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347a:	e8 c4 0b 00 00       	call   4043 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d0:	00 
    34d1:	c7 44 24 04 6b 49 00 	movl   $0x496b,0x4(%esp)
    34d8:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3572:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3577:	c7 44 24 04 fa 59 00 	movl   $0x59fa,0x4(%esp)
    357e:	00 
    357f:	89 04 24             	mov    %eax,(%esp)
    3582:	e8 bc 0a 00 00       	call   4043 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35ba:	a1 b0 63 00 00       	mov    0x63b0,%eax
    35bf:	c7 44 24 04 15 5a 00 	movl   $0x5a15,0x4(%esp)
    35c6:	00 
    35c7:	89 04 24             	mov    %eax,(%esp)
    35ca:	e8 74 0a 00 00       	call   4043 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3609:	a1 b0 63 00 00       	mov    0x63b0,%eax
    360e:	c7 44 24 04 23 5a 00 	movl   $0x5a23,0x4(%esp)
    3615:	00 
    3616:	89 04 24             	mov    %eax,(%esp)
    3619:	e8 25 0a 00 00       	call   4043 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    367b:	c7 04 24 32 5a 00 00 	movl   $0x5a32,(%esp)
    3682:	e8 9d 08 00 00       	call   3f24 <link>
    3687:	83 f8 ff             	cmp    $0xffffffff,%eax
    368a:	74 1a                	je     36a6 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    368c:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3691:	c7 44 24 04 3d 5a 00 	movl   $0x5a3d,0x4(%esp)
    3698:	00 
    3699:	89 04 24             	mov    %eax,(%esp)
    369c:	e8 a2 09 00 00       	call   4043 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36b9:	a1 b0 63 00 00       	mov    0x63b0,%eax
    36be:	c7 44 24 04 56 5a 00 	movl   $0x5a56,0x4(%esp)
    36c5:	00 
    36c6:	89 04 24             	mov    %eax,(%esp)
    36c9:	e8 75 09 00 00       	call   4043 <printf>
}
    36ce:	c9                   	leave  
    36cf:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36d6:	a1 b0 63 00 00       	mov    0x63b0,%eax
    36db:	c7 44 24 04 63 5a 00 	movl   $0x5a63,0x4(%esp)
    36e2:	00 
    36e3:	89 04 24             	mov    %eax,(%esp)
    36e6:	e8 58 09 00 00       	call   4043 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    36eb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    36f2:	eb 2d                	jmp    3721 <bsstest+0x51>
    if(uninit[i] != '\0'){
    36f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    36f7:	05 80 64 00 00       	add    $0x6480,%eax
    36fc:	0f b6 00             	movzbl (%eax),%eax
    36ff:	84 c0                	test   %al,%al
    3701:	74 1a                	je     371d <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    3703:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3708:	c7 44 24 04 6d 5a 00 	movl   $0x5a6d,0x4(%esp)
    370f:	00 
    3710:	89 04 24             	mov    %eax,(%esp)
    3713:	e8 2b 09 00 00       	call   4043 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    372b:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3730:	c7 44 24 04 7e 5a 00 	movl   $0x5a7e,0x4(%esp)
    3737:	00 
    3738:	89 04 24             	mov    %eax,(%esp)
    373b:	e8 03 09 00 00       	call   4043 <printf>
}
    3740:	c9                   	leave  
    3741:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3748:	c7 04 24 8b 5a 00 00 	movl   $0x5a8b,(%esp)
  ...
  if(pid == 0){
    ...
    3772:	c7 04 85 e0 63 00 00 	movl   $0x5a98,0x63e0(,%eax,4)
    3779:	98 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3785:	7e e8                	jle    376f <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    3787:	c7 05 5c 64 00 00 00 	movl   $0x0,0x645c
    378e:	00 00 00 
    printf(stdout, "bigarg test\n");
    3791:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3796:	c7 44 24 04 75 5b 00 	movl   $0x5b75,0x4(%esp)
    379d:	00 
    379e:	89 04 24             	mov    %eax,(%esp)
    37a1:	e8 9d 08 00 00       	call   4043 <printf>
    exec("echo", args);
    37a6:	c7 44 24 04 e0 63 00 	movl   $0x63e0,0x4(%esp)
    37ad:	00 
    37ae:	c7 04 24 94 44 00 00 	movl   $0x4494,(%esp)
    37b5:	e8 42 07 00 00       	call   3efc <exec>
    printf(stdout, "bigarg test ok\n");
    37ba:	a1 b0 63 00 00       	mov    0x63b0,%eax
    37bf:	c7 44 24 04 82 5b 00 	movl   $0x5b82,0x4(%esp)
    37c6:	00 
    37c7:	89 04 24             	mov    %eax,(%esp)
    37ca:	e8 74 08 00 00       	call   4043 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37cf:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37d6:	00 
    37d7:	c7 04 24 8b 5a 00 00 	movl   $0x5a8b,(%esp)
    ...
    37fc:	a1 b0 63 00 00       	mov    0x63b0,%eax
    3801:	c7 44 24 04 92 5b 00 	movl   $0x5b92,0x4(%esp)
    3808:	00 
    3809:	89 04 24             	mov    %eax,(%esp)
    380c:	e8 32 08 00 00       	call   4043 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3822:	00 
    3823:	c7 04 24 8b 5a 00 00 	movl   $0x5a8b,(%esp)
  ...
  if(fd < 0){
    ...
    3838:	a1 b0 63 00 00       	mov    0x63b0,%eax
    383d:	c7 44 24 04 ab 5b 00 	movl   $0x5bab,0x4(%esp)
    3844:	00 
    3845:	89 04 24             	mov    %eax,(%esp)
    3848:	e8 f6 07 00 00       	call   4043 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    385d:	c7 04 24 8b 5a 00 00 	movl   $0x5a8b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3879:	c7 44 24 04 c0 5b 00 	movl   $0x5bc0,0x4(%esp)
    3880:	00 
    3881:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3888:	e8 b6 07 00 00       	call   4043 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3969:	c7 44 24 04 cd 5b 00 	movl   $0x5bcd,0x4(%esp)
    3970:	00 
    3971:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3978:	e8 c6 06 00 00       	call   4043 <printf>
    ...
    39a0:	c7 44 24 04 d9 5b 00 	movl   $0x5bd9,0x4(%esp)
    39a7:	00 
    39a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39af:	e8 8f 06 00 00       	call   4043 <printf>
      break;
    ...
    39c4:	00 
    39c5:	c7 44 24 04 a0 8b 00 	movl   $0x8ba0,0x4(%esp)
    39cc:	00 
    ...
    39f8:	c7 44 24 04 e9 5b 00 	movl   $0x5be9,0x4(%esp)
    39ff:	00 
    3a00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3a07:	e8 37 06 00 00       	call   4043 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b13:	c7 44 24 04 f9 5b 00 	movl   $0x5bf9,0x4(%esp)
    3b1a:	00 
    3b1b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b22:	e8 1c 05 00 00       	call   4043 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b30:	a1 b4 63 00 00       	mov    0x63b4,%eax
    3b35:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b3b:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b40:	a3 b4 63 00 00       	mov    %eax,0x63b4
  return randstate;
    3b45:	a1 b4 63 00 00       	mov    0x63b4,%eax
}
    3b4a:	5d                   	pop    %ebp
    3b4b:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3ba1:	00 
    3ba2:	c7 04 24 23 5c 00 00 	movl   $0x5c23,(%esp)
...
putc(int fd, char c)
{
    ...
    3f6f:	83 ec 28             	sub    $0x28,%esp
    3f72:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f75:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3f78:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f7f:	00 
    3f80:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3f83:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f87:	8b 45 08             	mov    0x8(%ebp),%eax
    3f8a:	89 04 24             	mov    %eax,(%esp)
    3f8d:	e8 52 ff ff ff       	call   3ee4 <write>
}
    3f92:	c9                   	leave  
    3f93:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3f9a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3fa1:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fa5:	74 17                	je     3fbe <printint+0x2a>
    3fa7:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fab:	79 11                	jns    3fbe <printint+0x2a>
    neg = 1;
    3fad:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fb4:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fb7:	f7 d8                	neg    %eax
    3fb9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fbc:	eb 06                	jmp    3fc4 <printint+0x30>
  } else {
    x = xx;
  ...
  i = 0;
    3fc4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3fcb:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3fce:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3fd1:	ba 00 00 00 00       	mov    $0x0,%edx
    3fd6:	f7 f1                	div    %ecx
    3fd8:	89 d0                	mov    %edx,%eax
    3fda:	0f b6 90 b8 63 00 00 	movzbl 0x63b8(%eax),%edx
    3fe1:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3fe4:	03 45 f4             	add    -0xc(%ebp),%eax
    3fe7:	88 10                	mov    %dl,(%eax)
    3fe9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3fed:	8b 55 10             	mov    0x10(%ebp),%edx
    3ff0:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3ff3:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ff6:	ba 00 00 00 00       	mov    $0x0,%edx
    3ffb:	f7 75 d4             	divl   -0x2c(%ebp)
    3ffe:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4001:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4005:	75 c4                	jne    3fcb <printint+0x37>
  if(neg)
    4007:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    400b:	74 2a                	je     4037 <printint+0xa3>
    buf[i++] = '-';
    400d:	8d 45 dc             	lea    -0x24(%ebp),%eax
    4010:	03 45 f4             	add    -0xc(%ebp),%eax
    4013:	c6 00 2d             	movb   $0x2d,(%eax)
    4016:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    401a:	eb 1b                	jmp    4037 <printint+0xa3>
    putc(fd, buf[i]);
    401c:	8d 45 dc             	lea    -0x24(%ebp),%eax
    401f:	03 45 f4             	add    -0xc(%ebp),%eax
    ...
    4032:	e8 35 ff ff ff       	call   3f6c <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    403f:	79 db                	jns    401c <printint+0x88>
    putc(fd, buf[i]);
}
    4041:	c9                   	leave  
    4042:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    4046:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4049:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4050:	8d 45 0c             	lea    0xc(%ebp),%eax
    4053:	83 c0 04             	add    $0x4,%eax
    4056:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4059:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4060:	e9 7d 01 00 00       	jmp    41e2 <printf+0x19f>
    c = fmt[i] & 0xff;
    4065:	8b 55 0c             	mov    0xc(%ebp),%edx
    4068:	8b 45 f0             	mov    -0x10(%ebp),%eax
    406b:	01 d0                	add    %edx,%eax
    406d:	0f b6 00             	movzbl (%eax),%eax
    4070:	0f be c0             	movsbl %al,%eax
    4073:	25 ff 00 00 00       	and    $0xff,%eax
    4078:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    407b:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    407f:	75 2c                	jne    40ad <printf+0x6a>
      if(c == '%'){
    4081:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4085:	75 0c                	jne    4093 <printf+0x50>
        state = '%';
    4087:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    408e:	e9 4b 01 00 00       	jmp    41de <printf+0x19b>
      } else {
        putc(fd, c);
    4093:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4096:	0f be c0             	movsbl %al,%eax
    4099:	89 44 24 04          	mov    %eax,0x4(%esp)
    409d:	8b 45 08             	mov    0x8(%ebp),%eax
    40a0:	89 04 24             	mov    %eax,(%esp)
    40a3:	e8 c4 fe ff ff       	call   3f6c <putc>
    40a8:	e9 31 01 00 00       	jmp    41de <printf+0x19b>
      }
    } else if(state == '%'){
    40ad:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40b1:	0f 85 27 01 00 00    	jne    41de <printf+0x19b>
      if(c == 'd'){
    40b7:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40bb:	75 2d                	jne    40ea <printf+0xa7>
        printint(fd, *ap, 10, 1);
    40bd:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40c0:	8b 00                	mov    (%eax),%eax
    40c2:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    40c9:	00 
    40ca:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    40d1:	00 
    40d2:	89 44 24 04          	mov    %eax,0x4(%esp)
    40d6:	8b 45 08             	mov    0x8(%ebp),%eax
    40d9:	89 04 24             	mov    %eax,(%esp)
    40dc:	e8 b3 fe ff ff       	call   3f94 <printint>
        ap++;
    40e1:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    40e5:	e9 ed 00 00 00       	jmp    41d7 <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    40ea:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    40ee:	74 06                	je     40f6 <printf+0xb3>
    40f0:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    40f4:	75 2d                	jne    4123 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    40f6:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40f9:	8b 00                	mov    (%eax),%eax
    40fb:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4102:	00 
    4103:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    410a:	00 
    410b:	89 44 24 04          	mov    %eax,0x4(%esp)
    410f:	8b 45 08             	mov    0x8(%ebp),%eax
    4112:	89 04 24             	mov    %eax,(%esp)
    4115:	e8 7a fe ff ff       	call   3f94 <printint>
        ap++;
    411a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    411e:	e9 b4 00 00 00       	jmp    41d7 <printf+0x194>
      } else if(c == 's'){
    4123:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4127:	75 46                	jne    416f <printf+0x12c>
        s = (char*)*ap;
    4129:	8b 45 e8             	mov    -0x18(%ebp),%eax
    412c:	8b 00                	mov    (%eax),%eax
    412e:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4131:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4135:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4139:	75 27                	jne    4162 <printf+0x11f>
          s = "(null)";
    413b:	c7 45 f4 5e 5c 00 00 	movl   $0x5c5e,-0xc(%ebp)
        while(*s != 0){
    4142:	eb 1e                	jmp    4162 <printf+0x11f>
          putc(fd, *s);
    4144:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4147:	0f b6 00             	movzbl (%eax),%eax
    414a:	0f be c0             	movsbl %al,%eax
    414d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4151:	8b 45 08             	mov    0x8(%ebp),%eax
    4154:	89 04 24             	mov    %eax,(%esp)
    4157:	e8 10 fe ff ff       	call   3f6c <putc>
          s++;
    415c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    4160:	eb 01                	jmp    4163 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    416b:	75 d7                	jne    4144 <printf+0x101>
    416d:	eb 68                	jmp    41d7 <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    416f:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4173:	75 1d                	jne    4192 <printf+0x14f>
        putc(fd, *ap);
    4175:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4178:	8b 00                	mov    (%eax),%eax
    417a:	0f be c0             	movsbl %al,%eax
    417d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4181:	8b 45 08             	mov    0x8(%ebp),%eax
    4184:	89 04 24             	mov    %eax,(%esp)
    4187:	e8 e0 fd ff ff       	call   3f6c <putc>
        ap++;
    418c:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4190:	eb 45                	jmp    41d7 <printf+0x194>
      } else if(c == '%'){
    4192:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4196:	75 17                	jne    41af <printf+0x16c>
        putc(fd, c);
    4198:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    419b:	0f be c0             	movsbl %al,%eax
    419e:	89 44 24 04          	mov    %eax,0x4(%esp)
    41a2:	8b 45 08             	mov    0x8(%ebp),%eax
    41a5:	89 04 24             	mov    %eax,(%esp)
    41a8:	e8 bf fd ff ff       	call   3f6c <putc>
    41ad:	eb 28                	jmp    41d7 <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    41af:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    41b6:	00 
    41b7:	8b 45 08             	mov    0x8(%ebp),%eax
    41ba:	89 04 24             	mov    %eax,(%esp)
    41bd:	e8 aa fd ff ff       	call   3f6c <putc>
        putc(fd, c);
    ...
    41d2:	e8 95 fd ff ff       	call   3f6c <putc>
      }
      state = 0;
    41d7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    41de:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    41e2:	8b 55 0c             	mov    0xc(%ebp),%edx
    41e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41e8:	01 d0                	add    %edx,%eax
    41ea:	0f b6 00             	movzbl (%eax),%eax
    41ed:	84 c0                	test   %al,%al
    41ef:	0f 85 70 fe ff ff    	jne    4065 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4207:	a1 68 64 00 00       	mov    0x6468,%eax
...
free(void *ap)
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    424d:	c1 e0 03             	shl    $0x3,%eax
    4250:	89 c2                	mov    %eax,%edx
    4252:	03 55 f8             	add    -0x8(%ebp),%edx
    4255:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4258:	8b 00                	mov    (%eax),%eax
    425a:	39 c2                	cmp    %eax,%edx
    425c:	75 24                	jne    4282 <free+0x8a>
...
morecore(uint nu)
{
    ...
    42d2:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    42d5:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    42dc:	77 07                	ja     42e5 <morecore+0x16>
    nu = 4096;
    42de:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    42e5:	8b 45 08             	mov    0x8(%ebp),%eax
    42e8:	c1 e0 03             	shl    $0x3,%eax
    42eb:	89 04 24             	mov    %eax,(%esp)
    42ee:	e8 59 fc ff ff       	call   3f4c <sbrk>
    42f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    42f6:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    42fa:	75 07                	jne    4303 <morecore+0x34>
    return 0;
    42fc:	b8 00 00 00 00       	mov    $0x0,%eax
    4301:	eb 22                	jmp    4325 <morecore+0x56>
  hp = (Header*)p;
  ...
  free((void*)(hp + 1));
    ...
    431b:	e8 d8 fe ff ff       	call   41f8 <free>
  return freep;
    4320:	a1 68 64 00 00       	mov    0x6468,%eax
}
    4325:	c9                   	leave  
    4326:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    4330:	83 c0 07             	add    $0x7,%eax
    4333:	c1 e8 03             	shr    $0x3,%eax
    4336:	83 c0 01             	add    $0x1,%eax
    4339:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    433c:	a1 68 64 00 00       	mov    0x6468,%eax
    4341:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4344:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4348:	75 23                	jne    436d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    434a:	c7 45 f0 60 64 00 00 	movl   $0x6460,-0x10(%ebp)
    4351:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4354:	a3 68 64 00 00       	mov    %eax,0x6468
    4359:	a1 68 64 00 00       	mov    0x6468,%eax
    435e:	a3 60 64 00 00       	mov    %eax,0x6460
    base.s.size = 0;
    4363:	c7 05 64 64 00 00 00 	movl   $0x0,0x6464
    436a:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    436d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4370:	8b 00                	mov    (%eax),%eax
    4372:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    4375:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4378:	8b 40 04             	mov    0x4(%eax),%eax
    437b:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    437e:	72 4d                	jb     43cd <malloc+0xa6>
      if(p->s.size == nunits)
    4380:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4383:	8b 40 04             	mov    0x4(%eax),%eax
    4386:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4389:	75 0c                	jne    4397 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    438b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    438e:	8b 10                	mov    (%eax),%edx
    4390:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4393:	89 10                	mov    %edx,(%eax)
    4395:	eb 26                	jmp    43bd <malloc+0x96>
      else {
        p->s.size -= nunits;
    4397:	8b 45 f4             	mov    -0xc(%ebp),%eax
    439a:	8b 40 04             	mov    0x4(%eax),%eax
    439d:	89 c2                	mov    %eax,%edx
    439f:	2b 55 ec             	sub    -0x14(%ebp),%edx
    43a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43a5:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    43a8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43ab:	8b 40 04             	mov    0x4(%eax),%eax
    43ae:	c1 e0 03             	shl    $0x3,%eax
    43b1:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    43b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43b7:	8b 55 ec             	mov    -0x14(%ebp),%edx
    43ba:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    43bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43c0:	a3 68 64 00 00       	mov    %eax,0x6468
      return (void*)(p + 1);
    43c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43c8:	83 c0 08             	add    $0x8,%eax
    43cb:	eb 38                	jmp    4405 <malloc+0xde>
    }
    if(p == freep)
    43cd:	a1 68 64 00 00       	mov    0x6468,%eax
    43d2:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    43d5:	75 1b                	jne    43f2 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    43d7:	8b 45 ec             	mov    -0x14(%ebp),%eax
    43da:	89 04 24             	mov    %eax,(%esp)
    43dd:	e8 ed fe ff ff       	call   42cf <morecore>
    43e2:	89 45 f4             	mov    %eax,-0xc(%ebp)
    43e5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    43e9:	75 07                	jne    43f2 <malloc+0xcb>
        return 0;
    43eb:	b8 00 00 00 00       	mov    $0x0,%eax
    43f0:	eb 13                	jmp    4405 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4400:	e9 70 ff ff ff       	jmp    4375 <malloc+0x4e>
}
    4405:	c9                   	leave  
    4406:	c3                   	ret    
    4407:	90                   	nop
...
void parent(void) {
    ...
    440b:	53                   	push   %ebx
    440c:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
    440f:	e8 a8 fa ff ff       	call   3ebc <fork>
    4414:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4417:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    441b:	79 16                	jns    4433 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
    441d:	c7 44 24 04 65 5c 00 	movl   $0x5c65,0x4(%esp)
    4424:	00 
    4425:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    442c:	e8 12 fc ff ff       	call   4043 <printf>
    4431:	eb 59                	jmp    448c <parent+0x84>
        }else if(retval > 0){
    4433:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4437:	7e 2b                	jle    4464 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
    4439:	e8 06 fb ff ff       	call   3f44 <getpid>
    443e:	8b 55 f4             	mov    -0xc(%ebp),%edx
    4441:	89 54 24 0c          	mov    %edx,0xc(%esp)
    4445:	89 44 24 08          	mov    %eax,0x8(%esp)
    4449:	c7 44 24 04 74 5c 00 	movl   $0x5c74,0x4(%esp)
    4450:	00 
    4451:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4458:	e8 e6 fb ff ff       	call   4043 <printf>
                wait();
    445d:	e8 6a fa ff ff       	call   3ecc <wait>
    4462:	eb 28                	jmp    448c <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
    4464:	e8 fb fa ff ff       	call   3f64 <getppid>
    4469:	89 c3                	mov    %eax,%ebx
    446b:	e8 d4 fa ff ff       	call   3f44 <getpid>
    4470:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    4474:	89 44 24 08          	mov    %eax,0x8(%esp)
    4478:	c7 44 24 04 88 5c 00 	movl   $0x5c88,0x4(%esp)
    447f:	00 
    4480:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4487:	e8 b7 fb ff ff       	call   4043 <printf>
        }

}
    448c:	83 c4 24             	add    $0x24,%esp
    448f:	5b                   	pop    %ebx
    4490:	5d                   	pop    %ebp
    4491:	c3                   	ret    
