...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3fe2:	0f b6 90 b8 63 00 00 	movzbl 0x63b8(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4141:	75 27                	jne    416a <printf+0x11f>
          s = "(null)";
    4143:	c7 45 f4 5e 5c 00 00 	movl   $0x5c5e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    420f:	a1 68 64 00 00       	mov    0x6468,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    42d0:	a3 68 64 00 00       	mov    %eax,0x6468
}
    42d5:	c9                   	leave  
    42d6:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    4328:	a1 68 64 00 00       	mov    0x6468,%eax
}
    432d:	c9                   	leave  
    432e:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    4344:	a1 68 64 00 00       	mov    0x6468,%eax
    4349:	89 45 f0             	mov    %eax,-0x10(%ebp)
    434c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4350:	75 23                	jne    4375 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4352:	c7 45 f0 60 64 00 00 	movl   $0x6460,-0x10(%ebp)
    4359:	8b 45 f0             	mov    -0x10(%ebp),%eax
    435c:	a3 68 64 00 00       	mov    %eax,0x6468
    4361:	a1 68 64 00 00       	mov    0x6468,%eax
    4366:	a3 60 64 00 00       	mov    %eax,0x6460
    base.s.size = 0;
    436b:	c7 05 64 64 00 00 00 	movl   $0x0,0x6464
    4372:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43c8:	a3 68 64 00 00       	mov    %eax,0x6468
      return (void*)(p + 1);
    ...
    if(p == freep)
    43d5:	a1 68 64 00 00       	mov    0x6468,%eax
...
void *wrapper(qthread_func_ptr_t func, void *arg) {
    ...
    4413:	83 ec 18             	sub    $0x18,%esp
    func(arg);
    4416:	8b 45 0c             	mov    0xc(%ebp),%eax
    4419:	89 04 24             	mov    %eax,(%esp)
    441c:	8b 45 08             	mov    0x8(%ebp),%eax
    441f:	ff d0                	call   *%eax
    exit();
    4421:	e8 9e fa ff ff       	call   3ec4 <exit>

00004426 <qthread_create>:

}

int qthread_create(qthread_t *thread, qthread_func_ptr_t my_func, void *arg) {
    4426:	55                   	push   %ebp
    4427:	89 e5                	mov    %esp,%ebp
    4429:	83 ec 28             	sub    $0x28,%esp

    int SP = (int)malloc(THREADSTACKSIZE);
    442c:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    4433:	e8 f7 fe ff ff       	call   432f <malloc>
    4438:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int t_id = kthread_create(SP,(int)wrapper,(int)my_func,(int)arg);
    443b:	8b 4d 10             	mov    0x10(%ebp),%ecx
    443e:	8b 55 0c             	mov    0xc(%ebp),%edx
    4441:	b8 10 44 00 00       	mov    $0x4410,%eax
    4446:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
    444a:	89 54 24 08          	mov    %edx,0x8(%esp)
    444e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4452:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4455:	89 04 24             	mov    %eax,(%esp)
    4458:	e8 07 fb ff ff       	call   3f64 <kthread_create>
    445d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    (*thread)->tid = t_id;
    4460:	8b 45 08             	mov    0x8(%ebp),%eax
    4463:	8b 00                	mov    (%eax),%eax
    4465:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
int qthread_join(qthread_t thread, void **retval){
    ...
    447d:	89 54 24 04          	mov    %edx,0x4(%esp)
    4481:	89 04 24             	mov    %eax,(%esp)
    4484:	e8 e3 fa ff ff       	call   3f6c <kthread_join>
    4489:	89 45 f4             	mov    %eax,-0xc(%ebp)
    return val;
