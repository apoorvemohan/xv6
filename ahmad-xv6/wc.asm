...
wc(int fd, char *name)
{
  ...
  54:	c7 04 24 f6 09 00 00 	movl   $0x9f6,(%esp)
  ...
  b8:	c7 44 24 04 fc 09 00 	movl   $0x9fc,0x4(%esp)
  bf:	00 
  ...
  ed:	c7 44 24 04 0c 0a 00 	movl   $0xa0c,0x4(%esp)
  f4:	00 
...
main(int argc, char *argv[])
{
 ...
 110:	7f 19                	jg     12b <main+0x28>
    wc(0, "");
 112:	c7 44 24 04 19 0a 00 	movl   $0xa19,0x4(%esp)
 119:	00 
 ...
 16c:	c7 44 24 04 1a 0a 00 	movl   $0xa1a,0x4(%esp)
 173:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 53e:	0f b6 90 f0 0c 00 00 	movzbl 0xcf0(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 69d:	75 27                	jne    6c6 <printf+0x11f>
          s = "(null)";
 69f:	c7 45 f4 2e 0a 00 00 	movl   $0xa2e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 76b:	a1 28 0d 00 00       	mov    0xd28,%eax
...
free(void *ap)
{
 ...
 82c:	a3 28 0d 00 00       	mov    %eax,0xd28
}
 831:	c9                   	leave  
 832:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 87f:	e8 d8 fe ff ff       	call   75c <free>
  return freep;
 884:	a1 28 0d 00 00       	mov    0xd28,%eax
}
 889:	c9                   	leave  
 88a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 89d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8a0:	a1 28 0d 00 00       	mov    0xd28,%eax
 8a5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8a8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8ac:	75 23                	jne    8d1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8ae:	c7 45 f0 20 0d 00 00 	movl   $0xd20,-0x10(%ebp)
 8b5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8b8:	a3 28 0d 00 00       	mov    %eax,0xd28
 8bd:	a1 28 0d 00 00       	mov    0xd28,%eax
 8c2:	a3 20 0d 00 00       	mov    %eax,0xd20
    base.s.size = 0;
 8c7:	c7 05 24 0d 00 00 00 	movl   $0x0,0xd24
 8ce:	00 00 00 
  }
 ...
 924:	a3 28 0d 00 00       	mov    %eax,0xd28
      return (void*)(p + 1);
 ...
 92f:	eb 38                	jmp    969 <malloc+0xde>
    ...
    if(p == freep)
 931:	a1 28 0d 00 00       	mov    0xd28,%eax
...
void parent(void) {
 ...
 96f:	53                   	push   %ebx
 970:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 973:	e8 a8 fa ff ff       	call   420 <fork>
 978:	89 45 f4             	mov    %eax,-0xc(%ebp)
 97b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 97f:	79 16                	jns    997 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 981:	c7 44 24 04 35 0a 00 	movl   $0xa35,0x4(%esp)
 988:	00 
 989:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 990:	e8 12 fc ff ff       	call   5a7 <printf>
 995:	eb 59                	jmp    9f0 <parent+0x84>
        }else if(retval > 0){
 997:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 99b:	7e 2b                	jle    9c8 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 99d:	e8 06 fb ff ff       	call   4a8 <getpid>
 9a2:	8b 55 f4             	mov    -0xc(%ebp),%edx
 9a5:	89 54 24 0c          	mov    %edx,0xc(%esp)
 9a9:	89 44 24 08          	mov    %eax,0x8(%esp)
 9ad:	c7 44 24 04 44 0a 00 	movl   $0xa44,0x4(%esp)
 9b4:	00 
 9b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 9bc:	e8 e6 fb ff ff       	call   5a7 <printf>
                wait();
 9c1:	e8 6a fa ff ff       	call   430 <wait>
 9c6:	eb 28                	jmp    9f0 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 9c8:	e8 fb fa ff ff       	call   4c8 <getppid>
 9cd:	89 c3                	mov    %eax,%ebx
 9cf:	e8 d4 fa ff ff       	call   4a8 <getpid>
 9d4:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 9d8:	89 44 24 08          	mov    %eax,0x8(%esp)
 9dc:	c7 44 24 04 58 0a 00 	movl   $0xa58,0x4(%esp)
 9e3:	00 
 9e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 9eb:	e8 b7 fb ff ff       	call   5a7 <printf>
        }

}
 9f0:	83 c4 24             	add    $0x24,%esp
 9f3:	5b                   	pop    %ebx
 9f4:	5d                   	pop    %ebp
 9f5:	c3                   	ret    
