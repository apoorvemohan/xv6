...
main(int argc, char *argv[])
{
  ...
  2c:	c7 44 24 04 e6 09 00 	movl   $0x9e6,0x4(%esp)
  33:	00 
  ...
  92:	c7 44 24 04 f9 09 00 	movl   $0x9f9,0x4(%esp)
  99:	00 
...
//    printf(fd, "%d\n", i);
 ...
 126:	e8 15 03 00 00       	call   440 <close>
  ...
  printf(1, "read\n");
 12b:	c7 44 24 04 03 0a 00 	movl   $0xa03,0x4(%esp)
 132:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 52e:	0f b6 90 a8 0c 00 00 	movzbl 0xca8(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 68d:	75 27                	jne    6b6 <printf+0x11f>
          s = "(null)";
 68f:	c7 45 f4 09 0a 00 00 	movl   $0xa09,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 75b:	a1 c4 0c 00 00       	mov    0xcc4,%eax
...
free(void *ap)
{
 ...
 81c:	a3 c4 0c 00 00       	mov    %eax,0xcc4
}
 821:	c9                   	leave  
 822:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 86f:	e8 d8 fe ff ff       	call   74c <free>
  return freep;
 874:	a1 c4 0c 00 00       	mov    0xcc4,%eax
}
 879:	c9                   	leave  
 87a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 88d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 890:	a1 c4 0c 00 00       	mov    0xcc4,%eax
 895:	89 45 f0             	mov    %eax,-0x10(%ebp)
 898:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 89c:	75 23                	jne    8c1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 89e:	c7 45 f0 bc 0c 00 00 	movl   $0xcbc,-0x10(%ebp)
 8a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8a8:	a3 c4 0c 00 00       	mov    %eax,0xcc4
 8ad:	a1 c4 0c 00 00       	mov    0xcc4,%eax
 8b2:	a3 bc 0c 00 00       	mov    %eax,0xcbc
    base.s.size = 0;
 8b7:	c7 05 c0 0c 00 00 00 	movl   $0x0,0xcc0
 8be:	00 00 00 
  }
 ...
 914:	a3 c4 0c 00 00       	mov    %eax,0xcc4
      return (void*)(p + 1);
 ...
 91f:	eb 38                	jmp    959 <malloc+0xde>
    ...
    if(p == freep)
 921:	a1 c4 0c 00 00       	mov    0xcc4,%eax
...
void parent(void) {
 ...
 95f:	53                   	push   %ebx
 960:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 963:	e8 a8 fa ff ff       	call   410 <fork>
 968:	89 45 f4             	mov    %eax,-0xc(%ebp)
 96b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 96f:	79 16                	jns    987 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 971:	c7 44 24 04 10 0a 00 	movl   $0xa10,0x4(%esp)
 978:	00 
 979:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 980:	e8 12 fc ff ff       	call   597 <printf>
 985:	eb 59                	jmp    9e0 <parent+0x84>
        }else if(retval > 0){
 987:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 98b:	7e 2b                	jle    9b8 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 98d:	e8 06 fb ff ff       	call   498 <getpid>
 992:	8b 55 f4             	mov    -0xc(%ebp),%edx
 995:	89 54 24 0c          	mov    %edx,0xc(%esp)
 999:	89 44 24 08          	mov    %eax,0x8(%esp)
 99d:	c7 44 24 04 1f 0a 00 	movl   $0xa1f,0x4(%esp)
 9a4:	00 
 9a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 9ac:	e8 e6 fb ff ff       	call   597 <printf>
                wait();
 9b1:	e8 6a fa ff ff       	call   420 <wait>
 9b6:	eb 28                	jmp    9e0 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 9b8:	e8 fb fa ff ff       	call   4b8 <getppid>
 9bd:	89 c3                	mov    %eax,%ebx
 9bf:	e8 d4 fa ff ff       	call   498 <getpid>
 9c4:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 9c8:	89 44 24 08          	mov    %eax,0x8(%esp)
 9cc:	c7 44 24 04 33 0a 00 	movl   $0xa33,0x4(%esp)
 9d3:	00 
 9d4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 9db:	e8 b7 fb ff ff       	call   597 <printf>
        }

}
 9e0:	83 c4 24             	add    $0x24,%esp
 9e3:	5b                   	pop    %ebx
 9e4:	5d                   	pop    %ebp
 9e5:	c3                   	ret    
