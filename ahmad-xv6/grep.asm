...
main(int argc, char *argv[])
{
 ...
 119:	c7 44 24 04 b0 0b 00 	movl   $0xbb0,0x4(%esp)
 120:	00 
 ...
 19c:	c7 44 24 04 d0 0b 00 	movl   $0xbd0,0x4(%esp)
 1a3:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d2:	0f b6 90 30 0f 00 00 	movzbl 0xf30(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 831:	75 27                	jne    85a <printf+0x11f>
          s = "(null)";
 833:	c7 45 f4 e6 0b 00 00 	movl   $0xbe6,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 8ff:	a1 68 0f 00 00       	mov    0xf68,%eax
...
free(void *ap)
{
 ...
 9c0:	a3 68 0f 00 00       	mov    %eax,0xf68
}
 9c5:	c9                   	leave  
 9c6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a13:	e8 d8 fe ff ff       	call   8f0 <free>
  return freep;
 a18:	a1 68 0f 00 00       	mov    0xf68,%eax
}
 a1d:	c9                   	leave  
 a1e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a42:	c7 45 f0 60 0f 00 00 	movl   $0xf60,-0x10(%ebp)
 a49:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a4c:	a3 68 0f 00 00       	mov    %eax,0xf68
 a51:	a1 68 0f 00 00       	mov    0xf68,%eax
 a56:	a3 60 0f 00 00       	mov    %eax,0xf60
    base.s.size = 0;
 a5b:	c7 05 64 0f 00 00 00 	movl   $0x0,0xf64
 a62:	00 00 00 
  }
 ...
 ac3:	eb 38                	jmp    afd <malloc+0xde>
    ...
    if(p == freep)
 ac5:	a1 68 0f 00 00       	mov    0xf68,%eax
...
void parent(void) {
 ...
 b15:	c7 44 24 04 ed 0b 00 	movl   $0xbed,0x4(%esp)
 b1c:	00 
 ...
 b41:	c7 44 24 04 fc 0b 00 	movl   $0xbfc,0x4(%esp)
 b48:	00 
 ...
 b70:	c7 44 24 04 10 0c 00 	movl   $0xc10,0x4(%esp)
 b77:	00 
...
void ct(void){
 ...
 b8d:	83 ec 18             	sub    $0x18,%esp
	...
	printf(1, "In CT: %d\n", createThread());
 b90:	e8 c7 fa ff ff       	call   65c <createThread>
 b95:	89 44 24 08          	mov    %eax,0x8(%esp)
 b99:	c7 44 24 04 25 0c 00 	movl   $0xc25,0x4(%esp)
 ba0:	00 
 ba1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 ba8:	e8 8e fb ff ff       	call   73b <printf>
}
 bad:	c9                   	leave  
 bae:	c3                   	ret    
