...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ca:	0f b6 90 dc 0e 00 00 	movzbl 0xedc(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 829:	75 27                	jne    852 <printf+0x11f>
          s = "(null)";
 82b:	c7 45 f4 ba 0b 00 00 	movl   $0xbba,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 9b8:	a3 08 0f 00 00       	mov    %eax,0xf08
}
 9bd:	c9                   	leave  
 9be:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a0b:	e8 d8 fe ff ff       	call   8e8 <free>
  return freep;
 a10:	a1 08 0f 00 00       	mov    0xf08,%eax
}
 a15:	c9                   	leave  
 a16:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a29:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a2c:	a1 08 0f 00 00       	mov    0xf08,%eax
 a31:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a34:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a38:	75 23                	jne    a5d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a3a:	c7 45 f0 00 0f 00 00 	movl   $0xf00,-0x10(%ebp)
 a41:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a44:	a3 08 0f 00 00       	mov    %eax,0xf08
 a49:	a1 08 0f 00 00       	mov    0xf08,%eax
 a4e:	a3 00 0f 00 00       	mov    %eax,0xf00
    base.s.size = 0;
 a53:	c7 05 04 0f 00 00 00 	movl   $0x0,0xf04
 a5a:	00 00 00 
  }
 ...
 abb:	eb 38                	jmp    af5 <malloc+0xde>
    ...
    if(p == freep)
 abd:	a1 08 0f 00 00       	mov    0xf08,%eax
...
void parent(void) {
 ...
 afb:	53                   	push   %ebx
 afc:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 aff:	e8 a8 fa ff ff       	call   5ac <fork>
 b04:	89 45 f4             	mov    %eax,-0xc(%ebp)
 b07:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b0b:	79 16                	jns    b23 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 b0d:	c7 44 24 04 c1 0b 00 	movl   $0xbc1,0x4(%esp)
 b14:	00 
 b15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b1c:	e8 12 fc ff ff       	call   733 <printf>
 b21:	eb 59                	jmp    b7c <parent+0x84>
        }else if(retval > 0){
 b23:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b27:	7e 2b                	jle    b54 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 b29:	e8 06 fb ff ff       	call   634 <getpid>
 b2e:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b31:	89 54 24 0c          	mov    %edx,0xc(%esp)
 b35:	89 44 24 08          	mov    %eax,0x8(%esp)
 b39:	c7 44 24 04 d0 0b 00 	movl   $0xbd0,0x4(%esp)
 b40:	00 
 b41:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b48:	e8 e6 fb ff ff       	call   733 <printf>
                wait();
 b4d:	e8 6a fa ff ff       	call   5bc <wait>
 b52:	eb 28                	jmp    b7c <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 b54:	e8 fb fa ff ff       	call   654 <getppid>
 b59:	89 c3                	mov    %eax,%ebx
 b5b:	e8 d4 fa ff ff       	call   634 <getpid>
 b60:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 b64:	89 44 24 08          	mov    %eax,0x8(%esp)
 b68:	c7 44 24 04 e4 0b 00 	movl   $0xbe4,0x4(%esp)
 b6f:	00 
 b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b77:	e8 b7 fb ff ff       	call   733 <printf>
        }
