...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39e:	0f b6 90 f8 0a 00 00 	movzbl 0xaf8(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 4fd:	75 27                	jne    526 <printf+0x11f>
          s = "(null)";
 4ff:	c7 45 f4 56 08 00 00 	movl   $0x856,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5cb:	a1 14 0b 00 00       	mov    0xb14,%eax
...
free(void *ap)
{
 ...
 68c:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 691:	c9                   	leave  
 692:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6df:	e8 d8 fe ff ff       	call   5bc <free>
  return freep;
 6e4:	a1 14 0b 00 00       	mov    0xb14,%eax
}
 6e9:	c9                   	leave  
 6ea:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 6fd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 700:	a1 14 0b 00 00       	mov    0xb14,%eax
 705:	89 45 f0             	mov    %eax,-0x10(%ebp)
 708:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 70c:	75 23                	jne    731 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 70e:	c7 45 f0 0c 0b 00 00 	movl   $0xb0c,-0x10(%ebp)
 715:	8b 45 f0             	mov    -0x10(%ebp),%eax
 718:	a3 14 0b 00 00       	mov    %eax,0xb14
 71d:	a1 14 0b 00 00       	mov    0xb14,%eax
 722:	a3 0c 0b 00 00       	mov    %eax,0xb0c
    base.s.size = 0;
 727:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 72e:	00 00 00 
  }
 ...
 784:	a3 14 0b 00 00       	mov    %eax,0xb14
      return (void*)(p + 1);
 ...
 78f:	eb 38                	jmp    7c9 <malloc+0xde>
    ...
    if(p == freep)
 791:	a1 14 0b 00 00       	mov    0xb14,%eax
...
void parent(void) {
 ...
 7cf:	53                   	push   %ebx
 7d0:	83 ec 24             	sub    $0x24,%esp

	int retval;

        if((retval = fork()) < 0){
 7d3:	e8 a8 fa ff ff       	call   280 <fork>
 7d8:	89 45 f4             	mov    %eax,-0xc(%ebp)
 7db:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 7df:	79 16                	jns    7f7 <parent+0x2b>
                printf(1, "FORK FAILED!!!");
 7e1:	c7 44 24 04 5d 08 00 	movl   $0x85d,0x4(%esp)
 7e8:	00 
 7e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 7f0:	e8 12 fc ff ff       	call   407 <printf>
 7f5:	eb 59                	jmp    850 <parent+0x84>
        }else if(retval > 0){
 7f7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 7fb:	7e 2b                	jle    828 <parent+0x5c>
                printf(1, "Me: %d MyChild: %d\n", getpid(), retval);
 7fd:	e8 06 fb ff ff       	call   308 <getpid>
 802:	8b 55 f4             	mov    -0xc(%ebp),%edx
 805:	89 54 24 0c          	mov    %edx,0xc(%esp)
 809:	89 44 24 08          	mov    %eax,0x8(%esp)
 80d:	c7 44 24 04 6c 08 00 	movl   $0x86c,0x4(%esp)
 814:	00 
 815:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 81c:	e8 e6 fb ff ff       	call   407 <printf>
                wait();
 821:	e8 6a fa ff ff       	call   290 <wait>
 826:	eb 28                	jmp    850 <parent+0x84>
        } else {
                printf(1, "Me: %d MyParent: %d\n", getpid(), getppid());
 828:	e8 fb fa ff ff       	call   328 <getppid>
 82d:	89 c3                	mov    %eax,%ebx
 82f:	e8 d4 fa ff ff       	call   308 <getpid>
 834:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 838:	89 44 24 08          	mov    %eax,0x8(%esp)
 83c:	c7 44 24 04 80 08 00 	movl   $0x880,0x4(%esp)
 843:	00 
 844:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 84b:	e8 b7 fb ff ff       	call   407 <printf>
        }

}
 850:	83 c4 24             	add    $0x24,%esp
 853:	5b                   	pop    %ebx
 854:	5d                   	pop    %ebp
 855:	c3                   	ret    
