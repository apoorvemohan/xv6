...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 b6 08 00 	movl   $0x8b6,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 ca 08 00 	movl   $0x8ca,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fe:	0f b6 90 84 0b 00 00 	movzbl 0xb84(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 55d:	75 27                	jne    586 <printf+0x11f>
          s = "(null)";
 55f:	c7 45 f4 e3 08 00 00 	movl   $0x8e3,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62b:	a1 a0 0b 00 00       	mov    0xba0,%eax
...
free(void *ap)
{
 ...
 6ec:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 6f1:	c9                   	leave  
 6f2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73f:	e8 d8 fe ff ff       	call   61c <free>
  return freep;
 744:	a1 a0 0b 00 00       	mov    0xba0,%eax
}
 749:	c9                   	leave  
 74a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 75d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 760:	a1 a0 0b 00 00       	mov    0xba0,%eax
 765:	89 45 f0             	mov    %eax,-0x10(%ebp)
 768:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 76c:	75 23                	jne    791 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76e:	c7 45 f0 98 0b 00 00 	movl   $0xb98,-0x10(%ebp)
 775:	8b 45 f0             	mov    -0x10(%ebp),%eax
 778:	a3 a0 0b 00 00       	mov    %eax,0xba0
 77d:	a1 a0 0b 00 00       	mov    0xba0,%eax
 782:	a3 98 0b 00 00       	mov    %eax,0xb98
    base.s.size = 0;
 787:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 78e:	00 00 00 
  }
 ...
 7e4:	a3 a0 0b 00 00       	mov    %eax,0xba0
      return (void*)(p + 1);
 ...
 7ef:	eb 38                	jmp    829 <malloc+0xde>
    ...
    if(p == freep)
 7f1:	a1 a0 0b 00 00       	mov    0xba0,%eax
