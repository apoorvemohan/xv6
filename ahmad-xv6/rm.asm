...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 09 0a 00 	movl   $0xa09,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 456:	0f b6 90 10 0e 00 00 	movzbl 0xe10(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5b5:	75 27                	jne    5de <printf+0x11f>
          s = "(null)";
 5b7:	c7 45 f4 22 0a 00 00 	movl   $0xa22,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 683:	a1 2c 0e 00 00       	mov    0xe2c,%eax
...
free(void *ap)
{
 ...
 744:	a3 2c 0e 00 00       	mov    %eax,0xe2c
}
 749:	c9                   	leave  
 74a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 797:	e8 d8 fe ff ff       	call   674 <free>
  return freep;
 79c:	a1 2c 0e 00 00       	mov    0xe2c,%eax
}
 7a1:	c9                   	leave  
 7a2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7b5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7b8:	a1 2c 0e 00 00       	mov    0xe2c,%eax
 7bd:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7c0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7c4:	75 23                	jne    7e9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7c6:	c7 45 f0 24 0e 00 00 	movl   $0xe24,-0x10(%ebp)
 7cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7d0:	a3 2c 0e 00 00       	mov    %eax,0xe2c
 7d5:	a1 2c 0e 00 00       	mov    0xe2c,%eax
 7da:	a3 24 0e 00 00       	mov    %eax,0xe24
    base.s.size = 0;
 7df:	c7 05 28 0e 00 00 00 	movl   $0x0,0xe28
 7e6:	00 00 00 
  }
 ...
 83c:	a3 2c 0e 00 00       	mov    %eax,0xe2c
      return (void*)(p + 1);
