...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 c9 08 00 	movl   $0x8c9,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	0f b6 90 84 0b 00 00 	movzbl 0xb84(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 565:	75 27                	jne    58e <printf+0x11f>
          s = "(null)";
 567:	c7 45 f4 e2 08 00 00 	movl   $0x8e2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 633:	a1 a0 0b 00 00       	mov    0xba0,%eax
...
free(void *ap)
{
 ...
 6f4:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 6f9:	c9                   	leave  
 6fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 747:	e8 d8 fe ff ff       	call   624 <free>
  return freep;
 74c:	a1 a0 0b 00 00       	mov    0xba0,%eax
}
 751:	c9                   	leave  
 752:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 765:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 768:	a1 a0 0b 00 00       	mov    0xba0,%eax
 76d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 770:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 774:	75 23                	jne    799 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 776:	c7 45 f0 98 0b 00 00 	movl   $0xb98,-0x10(%ebp)
 77d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 780:	a3 a0 0b 00 00       	mov    %eax,0xba0
 785:	a1 a0 0b 00 00       	mov    0xba0,%eax
 78a:	a3 98 0b 00 00       	mov    %eax,0xb98
    base.s.size = 0;
 78f:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 796:	00 00 00 
  }
 ...
 7ec:	a3 a0 0b 00 00       	mov    %eax,0xba0
      return (void*)(p + 1);
 ...
 7f7:	eb 38                	jmp    831 <malloc+0xde>
    ...
    if(p == freep)
 7f9:	a1 a0 0b 00 00       	mov    0xba0,%eax
