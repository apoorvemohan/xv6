...
writetest1(void)
{
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6b7:	a1 c8 62 00 00       	mov    0x62c8,%eax
     6bc:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bf:	89 54 24 08          	mov    %edx,0x8(%esp)
     6c3:	c7 44 24 04 41 47 00 	movl   $0x4741,0x4(%esp)
     6ca:	00 
     ...
     6e1:	a1 c8 62 00 00       	mov    0x62c8,%eax
     6e6:	8b 55 f4             	mov    -0xc(%ebp),%edx
     6e9:	89 54 24 08          	mov    %edx,0x8(%esp)
     6ed:	c7 44 24 04 5e 47 00 	movl   $0x475e,0x4(%esp)
     6f4:	00 
  ...
  if(unlink("big") < 0){
     74f:	c7 04 24 ec 46 00 00 	movl   $0x46ec,(%esp)
     756:	e8 b9 37 00 00       	call   3f14 <unlink>
     75b:	85 c0                	test   %eax,%eax
     75d:	79 1a                	jns    779 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     75f:	a1 c8 62 00 00       	mov    0x62c8,%eax
     764:	c7 44 24 04 90 47 00 	movl   $0x4790,0x4(%esp)
     76b:	00 
  ...
  printf(stdout, "big files ok\n");
     779:	a1 c8 62 00 00       	mov    0x62c8,%eax
     77e:	c7 44 24 04 a3 47 00 	movl   $0x47a3,0x4(%esp)
     785:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     796:	a1 c8 62 00 00       	mov    0x62c8,%eax
     79b:	c7 44 24 04 b4 47 00 	movl   $0x47b4,0x4(%esp)
     7a2:	00 
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     831:	a1 c8 62 00 00       	mov    0x62c8,%eax
     836:	c7 44 24 04 dc 47 00 	movl   $0x47dc,0x4(%esp)
     83d:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     84e:	a1 c8 62 00 00       	mov    0x62c8,%eax
     853:	c7 44 24 04 02 48 00 	movl   $0x4802,0x4(%esp)
     85a:	00 
     85b:	89 04 24             	mov    %eax,(%esp)
     85e:	e8 e0 37 00 00       	call   4043 <printf>

  if(mkdir("dir0") < 0){
     863:	c7 04 24 0e 48 00 00 	movl   $0x480e,(%esp)
     86a:	e8 bd 36 00 00       	call   3f2c <mkdir>
     86f:	85 c0                	test   %eax,%eax
     871:	79 1a                	jns    88d <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     873:	a1 c8 62 00 00       	mov    0x62c8,%eax
     878:	c7 44 24 04 31 44 00 	movl   $0x4431,0x4(%esp)
     87f:	00 
  ...
  if(chdir("dir0") < 0){
     88d:	c7 04 24 0e 48 00 00 	movl   $0x480e,(%esp)
     894:	e8 9b 36 00 00       	call   3f34 <chdir>
     899:	85 c0                	test   %eax,%eax
     89b:	79 1a                	jns    8b7 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89d:	a1 c8 62 00 00       	mov    0x62c8,%eax
     8a2:	c7 44 24 04 13 48 00 	movl   $0x4813,0x4(%esp)
     8a9:	00 
  ...
  if(chdir("..") < 0){
     8b7:	c7 04 24 26 48 00 00 	movl   $0x4826,(%esp)
     8be:	e8 71 36 00 00       	call   3f34 <chdir>
     8c3:	85 c0                	test   %eax,%eax
     8c5:	79 1a                	jns    8e1 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c7:	a1 c8 62 00 00       	mov    0x62c8,%eax
     8cc:	c7 44 24 04 29 48 00 	movl   $0x4829,0x4(%esp)
     8d3:	00 
  ...
  if(unlink("dir0") < 0){
     8e1:	c7 04 24 0e 48 00 00 	movl   $0x480e,(%esp)
     8e8:	e8 27 36 00 00       	call   3f14 <unlink>
     8ed:	85 c0                	test   %eax,%eax
     8ef:	79 1a                	jns    90b <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f1:	a1 c8 62 00 00       	mov    0x62c8,%eax
     8f6:	c7 44 24 04 3a 48 00 	movl   $0x483a,0x4(%esp)
     8fd:	00 
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     910:	c7 44 24 04 4e 48 00 	movl   $0x484e,0x4(%esp)
     917:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     928:	a1 c8 62 00 00       	mov    0x62c8,%eax
     92d:	c7 44 24 04 5d 48 00 	movl   $0x485d,0x4(%esp)
     934:	00 
     935:	89 04 24             	mov    %eax,(%esp)
     938:	e8 06 37 00 00       	call   4043 <printf>
  if(exec("echo", echoargv) < 0){
     93d:	c7 44 24 04 b4 62 00 	movl   $0x62b4,0x4(%esp)
     944:	00 
     945:	c7 04 24 08 44 00 00 	movl   $0x4408,(%esp)
    ...
    printf(stdout, "exec echo failed\n");
     ...
     95a:	c7 44 24 04 68 48 00 	movl   $0x4868,0x4(%esp)
     961:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     986:	c7 44 24 04 7a 48 00 	movl   $0x487a,0x4(%esp)
     98d:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a16:	c7 44 24 04 89 48 00 	movl   $0x4889,0x4(%esp)
     a1d:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a8f:	c7 44 24 04 97 48 00 	movl   $0x4897,0x4(%esp)
     a96:	00 
    ...
    if(total != 5 * 1033){
     ...
     b05:	c7 44 24 04 a5 48 00 	movl   $0x48a5,0x4(%esp)
     b0c:	00 
  ...
  printf(1, "pipe1 ok\n");
     b2e:	c7 44 24 04 bc 48 00 	movl   $0x48bc,0x4(%esp)
     b35:	00 
    ...
    printf(1, "fork() failed\n");
     b44:	c7 44 24 04 c6 48 00 	movl   $0x48c6,0x4(%esp)
     b4b:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b65:	c7 44 24 04 d5 48 00 	movl   $0x48d5,0x4(%esp)
     b6c:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc7:	00 
     bc8:	c7 44 24 04 df 48 00 	movl   $0x48df,0x4(%esp)
     bcf:	00 
     ...
     bdd:	c7 44 24 04 e1 48 00 	movl   $0x48e1,0x4(%esp)
     be4:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c29:	c7 44 24 04 f5 48 00 	movl   $0x48f5,0x4(%esp)
     c30:	00 
  ...
  printf(1, "kill... ");
     c4a:	c7 44 24 04 08 49 00 	movl   $0x4908,0x4(%esp)
     c51:	00 
  ...
  printf(1, "wait... ");
     c7f:	c7 44 24 04 11 49 00 	movl   $0x4911,0x4(%esp)
     c86:	00 
  ...
  printf(1, "preempt ok\n");
     ca2:	c7 44 24 04 1a 49 00 	movl   $0x491a,0x4(%esp)
     ca9:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd3:	79 16                	jns    ceb <exitwait+0x33>
      printf(1, "fork failed\n");
     cd5:	c7 44 24 04 a9 44 00 	movl   $0x44a9,0x4(%esp)
     cdc:	00 
    ...
    if(pid){
     ...
     cfb:	c7 44 24 04 26 49 00 	movl   $0x4926,0x4(%esp)
     d02:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d20:	c7 44 24 04 36 49 00 	movl   $0x4936,0x4(%esp)
     d27:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3c:	c7 44 24 04 43 49 00 	movl   $0x4943,0x4(%esp)
     d43:	00 
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     dcc:	c7 44 24 04 4d 49 00 	movl   $0x494d,0x4(%esp)
     dd3:	00 
    ...
    printf(1, "mem ok\n");
     dfb:	c7 44 24 04 67 49 00 	movl   $0x4967,0x4(%esp)
     e02:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5e:	c7 44 24 04 88 49 00 	movl   $0x4988,0x4(%esp)
     e65:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed0:	c7 44 24 04 b4 49 00 	movl   $0x49b4,0x4(%esp)
     ed7:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     f15:	00 
     f16:	c7 04 24 7e 49 00 00 	movl   $0x497e,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2b:	c7 44 24 04 d4 49 00 	movl   $0x49d4,0x4(%esp)
     f32:	00 
  ...
  unlink("sharedfd");
     fb8:	c7 04 24 7e 49 00 00 	movl   $0x497e,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fd6:	c7 44 24 04 ff 49 00 	movl   $0x49ff,0x4(%esp)
     fdd:	00 
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     ffa:	c7 44 24 04 0c 4a 00 	movl   $0x4a0c,0x4(%esp)
    1001:	00 
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    101b:	c7 45 c8 21 4a 00 00 	movl   $0x4a21,-0x38(%ebp)
    1022:	c7 45 cc 24 4a 00 00 	movl   $0x4a24,-0x34(%ebp)
    1029:	c7 45 d0 27 4a 00 00 	movl   $0x4a27,-0x30(%ebp)
    1030:	c7 45 d4 2a 4a 00 00 	movl   $0x4a2a,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    1037:	c7 44 24 04 2d 4a 00 	movl   $0x4a2d,0x4(%esp)
    103e:	00 
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1078:	79 19                	jns    1093 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107a:	c7 44 24 04 a9 44 00 	movl   $0x44a9,0x4(%esp)
    1081:	00 
    ...
    10b9:	c7 44 24 04 3d 4a 00 	movl   $0x4a3d,0x4(%esp)
    10c0:	00 
    ...
    1127:	c7 44 24 04 4c 4a 00 	movl   $0x4a4c,0x4(%esp)
    112e:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    11c9:	74 19                	je     11e4 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11cb:	c7 44 24 04 5d 4a 00 	movl   $0x4a5d,0x4(%esp)
    11d2:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    1235:	c7 44 24 04 69 4a 00 	movl   $0x4a69,0x4(%esp)
    123c:	00 
  ...
  printf(1, "fourfiles ok\n");
    1267:	c7 44 24 04 7a 4a 00 	movl   $0x4a7a,0x4(%esp)
    126e:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1283:	c7 44 24 04 88 4a 00 	movl   $0x4a88,0x4(%esp)
    128a:	00 
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12af:	79 19                	jns    12ca <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b1:	c7 44 24 04 a9 44 00 	movl   $0x44a9,0x4(%esp)
    12b8:	00 
    ...
    1310:	79 19                	jns    132b <createdelete+0xae>
          printf(1, "create failed\n");
    1312:	c7 44 24 04 3d 4a 00 	movl   $0x4a3d,0x4(%esp)
    1319:	00 
    ...
    1367:	c7 44 24 04 2c 45 00 	movl   $0x452c,0x4(%esp)
    136e:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    1424:	c7 44 24 04 9c 4a 00 	movl   $0x4a9c,0x4(%esp)
    142b:	00 
    ...
    1456:	c7 44 24 04 c0 4a 00 	movl   $0x4ac0,0x4(%esp)
    145d:	00 
  ...
  printf(1, "createdelete ok\n");
    14df:	c7 44 24 04 e0 4a 00 	movl   $0x4ae0,0x4(%esp)
    14e6:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    14fb:	c7 44 24 04 f1 4a 00 	movl   $0x4af1,0x4(%esp)
    1502:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1516:	00 
    1517:	c7 04 24 02 4b 00 00 	movl   $0x4b02,(%esp)
  ...
  if(fd < 0){
    ...
    152c:	c7 44 24 04 0d 4b 00 	movl   $0x4b0d,0x4(%esp)
    1533:	00 
  ...
  write(fd, "hello", 5);
    ...
    154c:	00 
    154d:	c7 44 24 04 27 4b 00 	movl   $0x4b27,0x4(%esp)
    1554:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1572:	00 
    1573:	c7 04 24 02 4b 00 00 	movl   $0x4b02,(%esp)
  ...
  if(fd < 0){
    ...
    1588:	c7 44 24 04 2d 4b 00 	movl   $0x4b2d,0x4(%esp)
    158f:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1627:	c7 44 24 04 63 4b 00 	movl   $0x4b63,0x4(%esp)
    162e:	00 
  ...
  if(buf[0] != 'h'){
    ...
    164b:	c7 44 24 04 7a 4b 00 	movl   $0x4b7a,0x4(%esp)
    1652:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1684:	c7 44 24 04 91 4b 00 	movl   $0x4b91,0x4(%esp)
    168b:	00 
  ...
  unlink("unlinkread");
    16a8:	c7 04 24 02 4b 00 00 	movl   $0x4b02,(%esp)
    16af:	e8 60 28 00 00       	call   3f14 <unlink>
  printf(1, "unlinkread ok\n");
    16b4:	c7 44 24 04 aa 4b 00 	movl   $0x4baa,0x4(%esp)
    16bb:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    1719:	c7 44 24 04 cb 4b 00 	movl   $0x4bcb,0x4(%esp)
    1720:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1739:	00 
    173a:	c7 44 24 04 27 4b 00 	movl   $0x4b27,0x4(%esp)
    1741:	00 
    ...
    1752:	c7 44 24 04 de 4b 00 	movl   $0x4bde,0x4(%esp)
    1759:	00 
  ...
  if(link("lf1", "lf2") < 0){
    1776:	c7 44 24 04 c7 4b 00 	movl   $0x4bc7,0x4(%esp)
    177d:	00 
    177e:	c7 04 24 c3 4b 00 00 	movl   $0x4bc3,(%esp)
    1785:	e8 9a 27 00 00       	call   3f24 <link>
    178a:	85 c0                	test   %eax,%eax
    178c:	79 19                	jns    17a7 <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    178e:	c7 44 24 04 f0 4b 00 	movl   $0x4bf0,0x4(%esp)
    1795:	00 
  ...
  fd = open("lf2", 0);
    ...
    17eb:	00 
    17ec:	c7 04 24 c7 4b 00 00 	movl   $0x4bc7,(%esp)
  ...
  if(fd < 0){
    ...
    1801:	c7 44 24 04 2d 4c 00 	movl   $0x4c2d,0x4(%esp)
    1808:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183a:	c7 44 24 04 3e 4c 00 	movl   $0x4c3e,0x4(%esp)
    1841:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    185e:	c7 44 24 04 c7 4b 00 	movl   $0x4bc7,0x4(%esp)
    1865:	00 
    1866:	c7 04 24 c7 4b 00 00 	movl   $0x4bc7,(%esp)
    186d:	e8 b2 26 00 00       	call   3f24 <link>
    1872:	85 c0                	test   %eax,%eax
    1874:	78 19                	js     188f <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1876:	c7 44 24 04 4f 4c 00 	movl   $0x4c4f,0x4(%esp)
    187d:	00 
  ...
  unlink("lf2");
    188f:	c7 04 24 c7 4b 00 00 	movl   $0x4bc7,(%esp)
    1896:	e8 79 26 00 00       	call   3f14 <unlink>
  if(link("lf2", "lf1") >= 0){
    189b:	c7 44 24 04 c3 4b 00 	movl   $0x4bc3,0x4(%esp)
    18a2:	00 
    18a3:	c7 04 24 c7 4b 00 00 	movl   $0x4bc7,(%esp)
    18aa:	e8 75 26 00 00       	call   3f24 <link>
    18af:	85 c0                	test   %eax,%eax
    18b1:	78 19                	js     18cc <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b3:	c7 44 24 04 70 4c 00 	movl   $0x4c70,0x4(%esp)
    18ba:	00 
  ...
  if(link(".", "lf1") >= 0){
    18cc:	c7 44 24 04 c3 4b 00 	movl   $0x4bc3,0x4(%esp)
    18d3:	00 
    18d4:	c7 04 24 93 4c 00 00 	movl   $0x4c93,(%esp)
    18db:	e8 44 26 00 00       	call   3f24 <link>
    18e0:	85 c0                	test   %eax,%eax
    18e2:	78 19                	js     18fd <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e4:	c7 44 24 04 95 4c 00 	movl   $0x4c95,0x4(%esp)
    18eb:	00 
  ...
  printf(1, "linktest ok\n");
    18fd:	c7 44 24 04 b1 4c 00 	movl   $0x4cb1,0x4(%esp)
    1904:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1919:	c7 44 24 04 be 4c 00 	movl   $0x4cbe,0x4(%esp)
    1920:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    198c:	c7 04 24 ce 4c 00 00 	movl   $0x4cce,(%esp)
    ...
    19cf:	c7 04 24 ce 4c 00 00 	movl   $0x4cce,(%esp)
    ...
    1a00:	c7 44 24 04 d1 4c 00 	movl   $0x4cd1,0x4(%esp)
    1a07:	00 
  ...
  fd = open(".", 0);
    ...
    1a64:	00 
    1a65:	c7 04 24 93 4c 00 00 	movl   $0x4c93,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ac6:	c7 44 24 04 ed 4c 00 	movl   $0x4ced,0x4(%esp)
    1acd:	00 
    ...
    1af6:	c7 44 24 04 06 4d 00 	movl   $0x4d06,0x4(%esp)
    1afd:	00 
  ...
  if(n != 40){
    ...
    1b52:	c7 44 24 04 24 4d 00 	movl   $0x4d24,0x4(%esp)
    1b59:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    1b8c:	79 19                	jns    1ba7 <concreate+0x294>
      printf(1, "fork failed\n");
    1b8e:	c7 44 24 04 a9 44 00 	movl   $0x44a9,0x4(%esp)
    1b95:	00 
  ...
  printf(1, "concreate ok\n");
    1cae:	c7 44 24 04 55 4d 00 	movl   $0x4d55,0x4(%esp)
    1cb5:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cca:	c7 44 24 04 63 4d 00 	movl   $0x4d63,0x4(%esp)
    1cd1:	00 
    1cd2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd9:	e8 65 23 00 00       	call   4043 <printf>

  unlink("x");
    1cde:	c7 04 24 df 48 00 00 	movl   $0x48df,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cf8:	c7 44 24 04 a9 44 00 	movl   $0x44a9,0x4(%esp)
    1cff:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1d66:	00 
    1d67:	c7 04 24 df 48 00 00 	movl   $0x48df,(%esp)
    ...
    1d98:	75 16                	jne    1db0 <linkunlink+0xec>
      link("cat", "x");
    1d9a:	c7 44 24 04 df 48 00 	movl   $0x48df,0x4(%esp)
    1da1:	00 
    1da2:	c7 04 24 74 4d 00 00 	movl   $0x4d74,(%esp)
    1da9:	e8 76 21 00 00       	call   3f24 <link>
    1dae:	eb 0c                	jmp    1dbc <linkunlink+0xf8>
    } else {
      unlink("x");
    1db0:	c7 04 24 df 48 00 00 	movl   $0x48df,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1dd5:	c7 44 24 04 78 4d 00 	movl   $0x4d78,0x4(%esp)
    1ddc:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    1e33:	c7 44 24 04 97 4d 00 	movl   $0x4d97,0x4(%esp)
    1e3a:	00 
  ...
  unlink("bd");
    1ed1:	c7 04 24 94 4d 00 00 	movl   $0x4d94,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f29:	c7 44 24 04 c1 4d 00 	movl   $0x4dc1,0x4(%esp)
    1f30:	00 
  ...
  printf(1, "bigdir ok\n");
    1f4f:	c7 44 24 04 d6 4d 00 	movl   $0x4dd6,0x4(%esp)
    1f56:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbb:	00 
    1fbc:	c7 04 24 0c 4e 00 00 	movl   $0x4e0c,(%esp)
  ...
  if(fd < 0){
    ...
    1fd1:	c7 44 24 04 12 4e 00 	movl   $0x4e12,0x4(%esp)
    1fd8:	00 
  ...
  write(fd, "ff", 2);
    ...
    1ff1:	00 
    1ff2:	c7 44 24 04 ee 4d 00 	movl   $0x4dee,0x4(%esp)
    1ff9:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2069:	00 
    206a:	c7 04 24 70 4e 00 00 	movl   $0x4e70,(%esp)
  ...
  if(fd < 0){
    ...
    207f:	c7 44 24 04 79 4e 00 	movl   $0x4e79,0x4(%esp)
    2086:	00 
  ...
  write(fd, "FF", 2);
    ...
    209f:	00 
    20a0:	c7 44 24 04 91 4e 00 	movl   $0x4e91,0x4(%esp)
    20a7:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c5:	00 
    20c6:	c7 04 24 94 4e 00 00 	movl   $0x4e94,(%esp)
  ...
  if(fd < 0){
    ...
    20db:	c7 44 24 04 a0 4e 00 	movl   $0x4ea0,0x4(%esp)
    20e2:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2123:	c7 44 24 04 b9 4e 00 	movl   $0x4eb9,0x4(%esp)
    212a:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2147:	c7 44 24 04 d4 4e 00 	movl   $0x4ed4,0x4(%esp)
    214e:	00 
    214f:	c7 04 24 70 4e 00 00 	movl   $0x4e70,(%esp)
    2156:	e8 c9 1d 00 00       	call   3f24 <link>
    215b:	85 c0                	test   %eax,%eax
    215d:	74 19                	je     2178 <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    215f:	c7 44 24 04 e0 4e 00 	movl   $0x4ee0,0x4(%esp)
    2166:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227d:	00 
    227e:	c7 04 24 d4 4e 00 00 	movl   $0x4ed4,(%esp)
  ...
  if(fd < 0){
    ...
    2293:	c7 44 24 04 9e 4f 00 	movl   $0x4f9e,0x4(%esp)
    229a:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cc:	c7 44 24 04 b6 4f 00 	movl   $0x4fb6,0x4(%esp)
    22d3:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2416:	c7 44 24 04 8d 50 00 	movl   $0x508d,0x4(%esp)
    241d:	00 
    241e:	c7 04 24 f9 4f 00 00 	movl   $0x4ff9,(%esp)
    2425:	e8 fa 1a 00 00       	call   3f24 <link>
    242a:	85 c0                	test   %eax,%eax
    242c:	75 19                	jne    2447 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    242e:	c7 44 24 04 98 50 00 	movl   $0x5098,0x4(%esp)
    2435:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2447:	c7 44 24 04 8d 50 00 	movl   $0x508d,0x4(%esp)
    244e:	00 
    244f:	c7 04 24 1e 50 00 00 	movl   $0x501e,(%esp)
    2456:	e8 c9 1a 00 00       	call   3f24 <link>
    245b:	85 c0                	test   %eax,%eax
    245d:	75 19                	jne    2478 <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    245f:	c7 44 24 04 bc 50 00 	movl   $0x50bc,0x4(%esp)
    2466:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2478:	c7 44 24 04 d4 4e 00 	movl   $0x4ed4,0x4(%esp)
    247f:	00 
    2480:	c7 04 24 0c 4e 00 00 	movl   $0x4e0c,(%esp)
    2487:	e8 98 1a 00 00       	call   3f24 <link>
    248c:	85 c0                	test   %eax,%eax
    248e:	75 19                	jne    24a9 <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2490:	c7 44 24 04 e0 50 00 	movl   $0x50e0,0x4(%esp)
    2497:	00 
  ...
  printf(1, "subdir ok\n");
    2695:	c7 44 24 04 25 52 00 	movl   $0x5225,0x4(%esp)
    269c:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b1:	c7 44 24 04 30 52 00 	movl   $0x5230,0x4(%esp)
    26b8:	00 
    26b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c0:	e8 7e 19 00 00       	call   4043 <printf>

  unlink("bigwrite");
    26c5:	c7 04 24 3f 52 00 00 	movl   $0x523f,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e4:	00 
    26e5:	c7 04 24 3f 52 00 00 	movl   $0x523f,(%esp)
    ...
    26fa:	c7 44 24 04 48 52 00 	movl   $0x5248,0x4(%esp)
    2701:	00 
    ...
    274f:	c7 44 24 04 60 52 00 	movl   $0x5260,0x4(%esp)
    2756:	00 
    ...
    unlink("bigwrite");
    277d:	c7 04 24 3f 52 00 00 	movl   $0x523f,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279d:	c7 44 24 04 72 52 00 	movl   $0x5272,0x4(%esp)
    27a4:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    27f6:	c7 44 24 04 95 52 00 	movl   $0x5295,0x4(%esp)
    27fd:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    2855:	c7 44 24 04 ab 52 00 	movl   $0x52ab,0x4(%esp)
    285c:	00 
  ...
  fd = open("bigfile", 0);
    ...
    288a:	00 
    288b:	c7 04 24 8d 52 00 00 	movl   $0x528d,(%esp)
  ...
  if(fd < 0){
    ...
    28a0:	c7 44 24 04 c1 52 00 	movl   $0x52c1,0x4(%esp)
    28a7:	00 
  ...
  for(i = 0; ; i++){
    ...
    28eb:	c7 44 24 04 d6 52 00 	movl   $0x52d6,0x4(%esp)
    28f2:	00 
    ...
    2913:	c7 44 24 04 eb 52 00 	movl   $0x52eb,0x4(%esp)
    291a:	00 
    ...
    2960:	c7 44 24 04 ff 52 00 	movl   $0x52ff,0x4(%esp)
    2967:	00 
  ...
  if(total != 20*600){
    ...
    299d:	c7 44 24 04 18 53 00 	movl   $0x5318,0x4(%esp)
    29a4:	00 
  ...
  unlink("bigfile");
    29b6:	c7 04 24 8d 52 00 00 	movl   $0x528d,(%esp)
    29bd:	e8 52 15 00 00       	call   3f14 <unlink>

  printf(1, "bigfile test ok\n");
    29c2:	c7 44 24 04 32 53 00 	movl   $0x5332,0x4(%esp)
    29c9:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a4b:	00 
    2a4c:	c7 04 24 d0 53 00 00 	movl   $0x53d0,(%esp)
  ...
  if(fd < 0){
    ...
    2a61:	c7 44 24 04 00 54 00 	movl   $0x5400,0x4(%esp)
    2a68:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a8c:	00 
    2a8d:	c7 04 24 40 54 00 00 	movl   $0x5440,(%esp)
  ...
  if(fd < 0){
    ...
    2aa2:	c7 44 24 04 70 54 00 	movl   $0x5470,0x4(%esp)
    2aa9:	00 
  ...
  printf(1, "fourteen ok\n");
    2b18:	c7 44 24 04 49 55 00 	movl   $0x5549,0x4(%esp)
    2b1f:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    2c90:	c7 44 24 04 fd 55 00 	movl   $0x55fd,0x4(%esp)
    2c97:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cac:	c7 44 24 04 07 56 00 	movl   $0x5607,0x4(%esp)
    2cb3:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2cc7:	00 
    2cc8:	c7 04 24 14 56 00 00 	movl   $0x5614,(%esp)
  ...
  if(fd < 0){
    ...
    2cdd:	c7 44 24 04 1c 56 00 	movl   $0x561c,0x4(%esp)
    2ce4:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d31:	00 
    2d32:	c7 04 24 4d 56 00 00 	movl   $0x564d,(%esp)
  ...
  if(fd >= 0){
    ...
    2d47:	c7 44 24 04 58 56 00 	movl   $0x5658,0x4(%esp)
    2d4e:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d67:	00 
    2d68:	c7 04 24 4d 56 00 00 	movl   $0x564d,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2d7d:	c7 44 24 04 58 56 00 	movl   $0x5658,0x4(%esp)
    2d84:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    2de8:	c7 44 24 04 4d 56 00 	movl   $0x564d,0x4(%esp)
    2def:	00 
    2df0:	c7 04 24 b1 56 00 00 	movl   $0x56b1,(%esp)
    2df7:	e8 28 11 00 00       	call   3f24 <link>
    2dfc:	85 c0                	test   %eax,%eax
    2dfe:	75 19                	jne    2e19 <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2e00:	c7 44 24 04 b8 56 00 	movl   $0x56b8,0x4(%esp)
    2e07:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    2e49:	00 
    2e4a:	c7 04 24 93 4c 00 00 	movl   $0x4c93,(%esp)
  ...
  if(fd >= 0){
    ...
    2e5f:	c7 44 24 04 f0 56 00 	movl   $0x56f0,0x4(%esp)
    2e66:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eae:	c7 44 24 04 0f 57 00 	movl   $0x570f,0x4(%esp)
    2eb5:	00 
  ...
  printf(1, "dir vs file OK\n");
    2ed2:	c7 44 24 04 23 57 00 	movl   $0x5723,0x4(%esp)
    2ed9:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2eee:	c7 44 24 04 33 57 00 	movl   $0x5733,0x4(%esp)
    2ef5:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    2f60:	c7 04 24 72 57 00 00 	movl   $0x5772,(%esp)
    2f67:	e8 c0 0f 00 00       	call   3f2c <mkdir>
    link("README", "");
    2f6c:	c7 44 24 04 72 57 00 	movl   $0x5772,0x4(%esp)
    2f73:	00 
    2f74:	c7 04 24 b1 56 00 00 	movl   $0x56b1,(%esp)
    2f7b:	e8 a4 0f 00 00       	call   3f24 <link>
    fd = open("", O_CREATE);
    2f80:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2f87:	00 
    2f88:	c7 04 24 72 57 00 00 	movl   $0x5772,(%esp)
    ...
    2faf:	00 
    2fb0:	c7 04 24 73 57 00 00 	movl   $0x5773,(%esp)
    ...
    unlink("xx");
    2fd0:	c7 04 24 73 57 00 00 	movl   $0x5773,(%esp)
  ...
  chdir("/");
    2fea:	c7 04 24 7a 44 00 00 	movl   $0x447a,(%esp)
    2ff1:	e8 3e 0f 00 00       	call   3f34 <chdir>
  printf(1, "empty file name OK\n");
    2ff6:	c7 44 24 04 76 57 00 	movl   $0x5776,0x4(%esp)
    2ffd:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3012:	c7 44 24 04 8a 57 00 	movl   $0x578a,0x4(%esp)
    3019:	00 
    ...
    3043:	e8 7c 0e 00 00       	call   3ec4 <exit>
{
  ...
  if(n == 1000){
    ...
    3061:	c7 44 24 04 98 57 00 	movl   $0x5798,0x4(%esp)
    3068:	00 
  ...
  for(; n > 0; n--){
    ...
    3083:	c7 44 24 04 ba 57 00 	movl   $0x57ba,0x4(%esp)
    308a:	00 
  ...
  if(wait() != -1){
    ...
    30b0:	c7 44 24 04 ce 57 00 	movl   $0x57ce,0x4(%esp)
    30b7:	00 
  ...
  printf(1, "fork test OK\n");
    30c9:	c7 44 24 04 e1 57 00 	movl   $0x57e1,0x4(%esp)
    30d0:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30e9:	a1 c8 62 00 00       	mov    0x62c8,%eax
    30ee:	c7 44 24 04 ef 57 00 	movl   $0x57ef,0x4(%esp)
    30f5:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    313c:	a1 c8 62 00 00       	mov    0x62c8,%eax
    ...
    3156:	c7 44 24 04 fa 57 00 	movl   $0x57fa,0x4(%esp)
    315d:	00 
  ...
  if(pid < 0){
    ...
    3195:	a1 c8 62 00 00       	mov    0x62c8,%eax
    319a:	c7 44 24 04 15 58 00 	movl   $0x5815,0x4(%esp)
    31a1:	00 
  ...
  if(c != a + 1){
    ...
    31d8:	a1 c8 62 00 00       	mov    0x62c8,%eax
    31dd:	c7 44 24 04 2c 58 00 	movl   $0x582c,0x4(%esp)
    31e4:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3238:	a1 c8 62 00 00       	mov    0x62c8,%eax
    323d:	c7 44 24 04 48 58 00 	movl   $0x5848,0x4(%esp)
    3244:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3283:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3288:	c7 44 24 04 86 58 00 	movl   $0x5886,0x4(%esp)
    328f:	00 
  ...
  if(c != a - 4096){
    ...
    32b9:	a1 c8 62 00 00       	mov    0x62c8,%eax
    ...
    32cc:	c7 44 24 04 a4 58 00 	movl   $0x58a4,0x4(%esp)
    32d3:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3320:	a1 c8 62 00 00       	mov    0x62c8,%eax
    ...
    3333:	c7 44 24 04 dc 58 00 	movl   $0x58dc,0x4(%esp)
    333a:	00 
  ...
  if(*lastaddr == 99){
    ...
    3352:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3357:	c7 44 24 04 04 59 00 	movl   $0x5904,0x4(%esp)
    335e:	00 
  ...
  if(c != a){
    ...
    33a3:	a1 c8 62 00 00       	mov    0x62c8,%eax
    ...
    33b6:	c7 44 24 04 34 59 00 	movl   $0x5934,0x4(%esp)
    33bd:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33e8:	79 1a                	jns    3404 <sbrktest+0x325>
      printf(stdout, "fork failed\n");
    33ea:	a1 c8 62 00 00       	mov    0x62c8,%eax
    33ef:	c7 44 24 04 a9 44 00 	movl   $0x44a9,0x4(%esp)
    33f6:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346b:	c7 44 24 04 7a 48 00 	movl   $0x487a,0x4(%esp)
    3472:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d0:	00 
    34d1:	c7 44 24 04 df 48 00 	movl   $0x48df,0x4(%esp)
    34d8:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3572:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3577:	c7 44 24 04 6e 59 00 	movl   $0x596e,0x4(%esp)
    357e:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    35ba:	a1 c8 62 00 00       	mov    0x62c8,%eax
    35bf:	c7 44 24 04 89 59 00 	movl   $0x5989,0x4(%esp)
    35c6:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3609:	a1 c8 62 00 00       	mov    0x62c8,%eax
    360e:	c7 44 24 04 97 59 00 	movl   $0x5997,0x4(%esp)
    3615:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    367b:	c7 04 24 a6 59 00 00 	movl   $0x59a6,(%esp)
    3682:	e8 9d 08 00 00       	call   3f24 <link>
    3687:	83 f8 ff             	cmp    $0xffffffff,%eax
    368a:	74 1a                	je     36a6 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    368c:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3691:	c7 44 24 04 b1 59 00 	movl   $0x59b1,0x4(%esp)
    3698:	00 
  ...
  printf(stdout, "validate ok\n");
    36b9:	a1 c8 62 00 00       	mov    0x62c8,%eax
    36be:	c7 44 24 04 ca 59 00 	movl   $0x59ca,0x4(%esp)
    36c5:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36d6:	a1 c8 62 00 00       	mov    0x62c8,%eax
    36db:	c7 44 24 04 d7 59 00 	movl   $0x59d7,0x4(%esp)
    36e2:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3703:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3708:	c7 44 24 04 e1 59 00 	movl   $0x59e1,0x4(%esp)
    370f:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    372b:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3730:	c7 44 24 04 f2 59 00 	movl   $0x59f2,0x4(%esp)
    3737:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3748:	c7 04 24 ff 59 00 00 	movl   $0x59ff,(%esp)
  ...
  if(pid == 0){
    ...
    3772:	c7 04 85 00 63 00 00 	movl   $0x5a0c,0x6300(,%eax,4)
    3779:	0c 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3791:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3796:	c7 44 24 04 e9 5a 00 	movl   $0x5ae9,0x4(%esp)
    379d:	00 
    ...
    37ad:	00 
    37ae:	c7 04 24 08 44 00 00 	movl   $0x4408,(%esp)
    37b5:	e8 42 07 00 00       	call   3efc <exec>
    printf(stdout, "bigarg test ok\n");
    37ba:	a1 c8 62 00 00       	mov    0x62c8,%eax
    37bf:	c7 44 24 04 f6 5a 00 	movl   $0x5af6,0x4(%esp)
    37c6:	00 
    ...
    37d6:	00 
    37d7:	c7 04 24 ff 59 00 00 	movl   $0x59ff,(%esp)
    ...
    37fc:	a1 c8 62 00 00       	mov    0x62c8,%eax
    3801:	c7 44 24 04 06 5b 00 	movl   $0x5b06,0x4(%esp)
    3808:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    3822:	00 
    3823:	c7 04 24 ff 59 00 00 	movl   $0x59ff,(%esp)
  ...
  if(fd < 0){
    ...
    3838:	a1 c8 62 00 00       	mov    0x62c8,%eax
    383d:	c7 44 24 04 1f 5b 00 	movl   $0x5b1f,0x4(%esp)
    3844:	00 
  ...
  unlink("bigarg-ok");
    385d:	c7 04 24 ff 59 00 00 	movl   $0x59ff,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3879:	c7 44 24 04 34 5b 00 	movl   $0x5b34,0x4(%esp)
    3880:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3969:	c7 44 24 04 41 5b 00 	movl   $0x5b41,0x4(%esp)
    3970:	00 
    ...
    39a0:	c7 44 24 04 4d 5b 00 	movl   $0x5b4d,0x4(%esp)
    39a7:	00 
    ...
    39f8:	c7 44 24 04 5d 5b 00 	movl   $0x5b5d,0x4(%esp)
    39ff:	00 
  ...
  printf(1, "fsfull test finished\n");
    3b13:	c7 44 24 04 6d 5b 00 	movl   $0x5b6d,0x4(%esp)
    3b1a:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b30:	a1 cc 62 00 00       	mov    0x62cc,%eax
    3b35:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b3b:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b40:	a3 cc 62 00 00       	mov    %eax,0x62cc
  return randstate;
    3b45:	a1 cc 62 00 00       	mov    0x62cc,%eax
}
    3b4a:	5d                   	pop    %ebp
    3b4b:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    3b55:	c7 44 24 04 83 5b 00 	movl   $0x5b83,0x4(%esp)
    3b5c:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3ba1:	00 
    3ba2:	c7 04 24 97 5b 00 00 	movl   $0x5b97,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3fda:	0f b6 90 d0 62 00 00 	movzbl 0x62d0(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4139:	75 27                	jne    4162 <printf+0x11f>
          s = "(null)";
    413b:	c7 45 f4 d2 5b 00 00 	movl   $0x5bd2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  freep = p;
    ...
    42c8:	a3 88 63 00 00       	mov    %eax,0x6388
}
    42cd:	c9                   	leave  
    42ce:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    4320:	a1 88 63 00 00       	mov    0x6388,%eax
}
    4325:	c9                   	leave  
    4326:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    433c:	a1 88 63 00 00       	mov    0x6388,%eax
    4341:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4344:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4348:	75 23                	jne    436d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    434a:	c7 45 f0 80 63 00 00 	movl   $0x6380,-0x10(%ebp)
    4351:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4354:	a3 88 63 00 00       	mov    %eax,0x6388
    4359:	a1 88 63 00 00       	mov    0x6388,%eax
    435e:	a3 80 63 00 00       	mov    %eax,0x6380
    base.s.size = 0;
    4363:	c7 05 84 63 00 00 00 	movl   $0x0,0x6384
    436a:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43c0:	a3 88 63 00 00       	mov    %eax,0x6388
      return (void*)(p + 1);
    ...
    if(p == freep)
    43cd:	a1 88 63 00 00       	mov    0x6388,%eax
